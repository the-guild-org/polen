...
import { execNodeScript } from "../../scripts/lib/exec-utils.js";
...
export default async ({ exec, core }) => {
  ...
  try {
    ...
    if (mode === "trunk") {
      ...
      const trunkDeployments = await execNodeScript(
        exec,
        "./.github/scripts/tools/get-trunk-deployments.js",
        ["./gh-pages"],
      );

      // Get dist-tags info from gh-pages directory
      const distTags = await execNodeScript(
        exec,
        "./.github/scripts/tools/get-dist-tags.js",
        ["./gh-pages"],
      );
    ...
    const prDeployments = await execNodeScript(
      exec,
      "./.github/scripts/tools/get-pr-deployments.js",
    );
