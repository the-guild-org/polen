/* eslint-disable */
import type {  ConditionalValue, Nested  } from './conditions.d.ts';
import type {  AtRule, Globals, PropertiesFallback  } from './csstype.d.ts';
import type {  SystemProperties, CssVarProperties  } from './style-props.d.ts';
