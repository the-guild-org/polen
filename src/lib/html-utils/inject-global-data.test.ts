...
// dprint-ignore
Test.Table.suite<{ globalName: string; data: any; shouldThrow?: boolean; expectedContains?: string[]; expectedNotContains?: string[] }>('createGlobalDataScript', [
...
// dprint-ignore
Test.Table.suite<{ globalName: string; data: any; initCode?: string; expectedContains?: string[]; exactMatch?: string }>('createGlobalDataScriptWithInit', [
...
// dprint-ignore
Test.Table.suite<{ globalName: string; data: any; initCode?: string; expectedContains: string[] }>('injectGlobalDataIntoHTML', [
