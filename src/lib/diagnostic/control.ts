 ...
 */
export const DiagnosticControl = S.Struct({
  /**
...
export type DiagnosticControl = S.Schema.Type<typeof DiagnosticControl>
...
export const getPhaseSettings = (
  control: DiagnosticControl | boolean | undefined,
  phase: 'dev' | 'build',
  defaults: {
    enabled: boolean
    severity: Severity
