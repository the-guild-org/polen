var e = `Beancount`,
  t = [`beancount`],
  n = `beancount`,
  r = [{ comment: `Comments`, match: `;.*`, name: `comment.line.beancount` }, {
    ...
    patterns: [{ include: `#comments` }, { include: `#illegal` }],
  }, {
    begin: `^\\s*(include)\\s+(\\".*\\")`,
    beginCaptures: { 1: { name: `support.function.beancount` }, 2: { name: `string.quoted.double.beancount` } },
    ...
    patterns: [{ include: `#comments` }, { include: `#meta` }, { include: `#account` }, { include: `#commodity` }, {
      match: `\\,`,
    ...
    name: `meta.directive.dated.beancount`,
    patterns: [{ include: `#comments` }, { include: `#meta` }, { include: `#string` }, { include: `#illegal` }],
  }, {
    ...
    name: `meta.directive.dated.beancount`,
    patterns: [{ include: `#comments` }, { include: `#meta` }, { include: `#commodity` }, { include: `#illegal` }],
  }, {
    ...
    name: `meta.directive.dated.beancount`,
    patterns: [{ include: `#comments` }, { include: `#meta` }, { include: `#account` }, { include: `#string` }, {
      include: `#illegal`,
    }],
  }, {
    ...
    name: `meta.directive.dated.beancount`,
    patterns: [{ include: `#comments` }, { include: `#meta` }, { include: `#commodity` }, { include: `#amount` }, {
      include: `#illegal`,
    }],
  }, {
    ...
    name: `meta.directive.dated.beancount`,
    patterns: [{ include: `#comments` }, { include: `#meta` }, { include: `#account` }, { include: `#amount` }, {
      include: `#illegal`,
    }],
  }, {
    ...
    patterns: [{ include: `#comments` }, { include: `#posting` }, { include: `#meta` }, { include: `#tag` }, {
      include: `#link`,
    }, { include: `#illegal` }],
  }],
  i = {
    account: {
      begin: `([A-Z][a-z]+)(:)`,
      beginCaptures: { 1: { name: `variable.language.beancount` }, 2: { name: `punctuation.separator.beancount` } },
      end: `\\s`,
      name: `meta.account.beancount`,
      patterns: [{
        begin: `(\\S+)([:]?)`,
        beginCaptures: {
          1: { name: `variable.other.account.beancount` },
          2: { name: `punctuation.separator.beancount` },
        },
        comment: `Sub accounts`,
        end: `([:]?)|(\\s)`,
        patterns: [{ include: `$self` }, { include: `#illegal` }],
      }],
    },
    amount: {
      captures: {
        ...
        3: { name: `entity.name.type.commodity.beancount` },
      },
    ...
    bool: {
      captures: {
        0: { name: `constant.language.bool.beancount` },
        2: { name: `constant.numeric.currency.beancount` },
        3: { name: `entity.name.type.commodity.beancount` },
      },
      match: `TRUE|FALSE`,
    },
    comments: { captures: { 1: { name: `comment.line.beancount` } }, match: `(;.*)$` },
    commodity: { match: `([A-Z][A-Z0-9\\'\\.\\_\\-]{0,22}[A-Z0-9])`, name: `entity.name.type.commodity.beancount` },
    cost: {
      begin: `\\{\\{?`,
      beginCaptures: { 0: { name: `keyword.operator.assignment.beancount` } },
      end: `\\}\\}?`,
      endCaptures: { 0: { name: `keyword.operator.assignment.beancount` } },
      name: `meta.cost.beancount`,
      patterns: [{ include: `#amount` }, { include: `#date` }, {
        match: `\\,`,
        name: `punctuation.separator.beancount`,
      }, { include: `#illegal` }],
    },
    ...
    flag: { match: `(?<=\\s)([*!&#?%PSTCURM])(?=\\s+)`, name: `keyword.other.beancount` },
    illegal: { match: `[^\\s]`, name: `invalid.illegal.unrecognized.beancount` },
    link: {
      captures: { 1: { name: `keyword.operator.link.beancount` }, 2: { name: `markup.underline.link.beancount` } },
      match: `(\\^)([A-Za-z0-9\\-_/.]+)`,
    },
    meta: {
    ...
    price: {
      ...
      patterns: [{ include: `#amount` }, { include: `#illegal` }],
    },
    string: {
      begin: `\\"`,
      end: `\\"`,
      name: `string.quoted.double.beancount`,
      patterns: [{ match: `\\\\.`, name: `constant.character.escape.beancount` }],
    },
    tag: {
      captures: { 1: { name: `keyword.operator.tag.beancount` }, 2: { name: `entity.name.tag.beancount` } },
      match: `(#)([A-Za-z0-9\\-_/.]+)`,
    },
  },
  a = `text.beancount`,
