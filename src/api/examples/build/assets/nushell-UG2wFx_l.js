var e = `nushell`,
  ...
  r = {
    binary: {
      begin: `\\b(0x)(\\[)`,
      beginCaptures: { 1: { name: `constant.numeric.nushell` }, 2: { name: `meta.brace.square.begin.nushell` } },
      end: `\\]`,
    ...
    'braced-expression': {
      begin: `\\{`,
      beginCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.nushell` } },
      end: `\\}`,
      endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.nushell` } },
      ...
      patterns: [
        ...
        {
          captures: { 1: { name: `variable.other.nushell` }, 2: { name: `keyword.control.nushell` } },
          match: `(\\w+)\\s*(:)\\s*`,
        },
        {
          captures: {
    ...
    command: {
      ...
      beginCaptures: {
        ...
        2: {
          patterns: [{ include: `#control-keywords` }, {
            ...
            captures: { 1: { name: `keyword.other.builtin.nushell` }, 2: { patterns: [{ include: `#value` }] } },
            ...
            captures: { 1: { name: `entity.name.type.external.nushell` }, 2: { patterns: [{ include: `#value` }] } },
            match: `([\\w.]+(?:-[\\w.!]+)*)(?: (.*))?`,
          }, { include: `#value` }],
        },
      },
      ...
      patterns: [{ include: `#parameters` }, { include: `#spread` }, { include: `#value` }],
    },
    comment: { match: `(#.*)$`, name: `comment.nushell` },
    'constant-keywords': { match: `\\b(?:true|false|null)\\b`, name: `constant.language.nushell` },
    'constant-value': {
      patterns: [{ include: `#constant-keywords` }, { include: `#datetime` }, { include: `#numbers` }, {
    ...
    extern: {
      ...
      beginCaptures: { 1: { name: `entity.name.function.nushell` }, 2: { name: `entity.name.type.nushell` } },
      end: `(?<=\\])`,
    ...
    function: {
      ...
      patterns: [{ include: `#function-parameters` }, { include: `#function-body` }, { include: `#function-inout` }],
    },
    'function-body': {
      begin: `\\{`,
      beginCaptures: { 0: { name: `punctuation.definition.function.begin.nushell` } },
      end: `\\}`,
      endCaptures: { 0: { name: `punctuation.definition.function.end.nushell` } },
    ...
    'function-inout': {
      patterns: [{ include: `#types` }, { match: `->`, name: `keyword.operator.nushell` }, {
    ...
    'function-multiple-inout': {
      ...
      patterns: [{ include: `#types` }, {
        ...
        match: `\\s*(,)\\s*`,
      }, { captures: { 1: { name: `keyword.operator.nushell` } }, match: `\\s+(->)\\s+` }],
    },
    'function-parameter': {
      patterns: [
        {
        ...
        { begin: `@(?="|')`, end: `(?<="|')`, patterns: [{ include: `#string` }] },
        {
          begin: `=\\s*`,
          end: `(?=(?:\\s+-{0,2}[\\w-]+)|(?:\\s*(?:,|\\]|\\||#|$)))`,
    ...
    'internal-variables': { match: `\\$(?:nu|env)\\b`, name: `variable.language.nushell` },
    keyword: { match: `(?:def(?:-env)?)`, name: `keyword.other.nushell` },
    module: {
      begin: `((?:export\\s+)?module)\\s+([\\w\\-]+)\\s*\\{`,
      beginCaptures: { 1: { name: `entity.name.function.nushell` }, 2: { name: `entity.name.namespace.nushell` } },
      end: `\\}`,
    ...
    'numbers-hexa': { match: `(?<![\\w-])0x[0-9a-fA-F]+(?![\\w.])`, name: `constant.numeric.nushell` },
    operators: {
      patterns: [{ include: `#operators-word` }, { include: `#operators-symbols` }, { include: `#ranges` }],
    },
    'operators-symbols': {
      match: `(?<= )(?:(?:\\+|\\-|\\*|\\/)=?|\\/\\/|\\*\\*|!=|[<>=]=?|[!=]~|\\+\\+=?)(?= |$)`,
      name: `keyword.control.nushell`,
    ...
    'pre-command': {
      begin: `(\\w+)(=)`,
      beginCaptures: { 1: { name: `variable.other.nushell` }, 2: { patterns: [{ include: `#operators` }] } },
      end: `(?=\\s+)`,
      patterns: [{ include: `#value` }],
    },
    ...
    'string-bare': { match: `[^$\\[{("',|#\\s|][^\\[\\]{}()"'\\s#,|]*`, name: `string.bare.nushell` },
    'string-double-quote': {
      begin: `"`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.nushell` } },
      end: `"`,
    ...
    'string-escape': { match: `\\\\(?:[bfrnt\\\\'"/]|u[0-9a-fA-F]{4})`, name: `constant.character.escape.nushell` },
    'string-interpolated-double': {
      ...
      patterns: [{ match: `\\\\[()]`, name: `constant.character.escape.nushell` }, { include: `#string-escape` }, {
    ...
    table: {
      ...
      patterns: [{ include: `#spread` }, { include: `#value` }, { match: `,`, name: `punctuation.separator.nushell` }],
    },
    types: {
      patterns: [{
        begin: `\\b(list)\\s*<`,
    ...
    'use-module': {
      ...
      }, { captures: { 0: { name: `entity.name.function.nushell` } }, match: `^\\s*(?:export )?use\\b` }],
    },
    value: {
      patterns: [
        { include: `#variables` },
    ...
    'variable-fields': { match: `(?<=\\)|\\}|\\])(?:\\.(?:[\\w-]+|"[\\w\\- ]+"))+`, name: `variable.other.nushell` },
    variables: {
      captures: {
        1: { patterns: [{ include: `#internal-variables` }, { match: `\\$.+`, name: `variable.other.nushell` }] },
        2: { name: `variable.other.nushell` },
      },
