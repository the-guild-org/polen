  ...
  n = [
    ...
    { include: `#comments` },
    {
      captures: {
        ...
        2: {
          ...
          patterns: [{ match: `\\\\`, name: `punctuation.separator.inheritance.php` }],
        },
      },
    ...
    },
    {
      ...
      patterns: [{ include: `#comments` }, {
        captures: { 0: { patterns: [{ match: `\\\\`, name: `punctuation.separator.inheritance.php` }] } },
        match: `(?i)[a-z0-9_\\x{7f}-\\x{10ffff}\\\\]+`,
        name: `entity.name.type.namespace.php`,
      }, {
        begin: `{`,
        beginCaptures: { 0: { name: `punctuation.definition.namespace.begin.bracket.curly.php` } },
        end: `}|(?=\\?>)`,
        endCaptures: { 0: { name: `punctuation.definition.namespace.end.bracket.curly.php` } },
        patterns: [{ include: `$self` }],
      }, { match: `[^\\s]+`, name: `invalid.illegal.identifier.php` }],
    },
    { match: `\\s+(?=use\\b)` },
    {
      begin: `(?i)\\buse\\b`,
      beginCaptures: { 0: { name: `keyword.other.use.php` } },
      end: `(?<=})|(?=;)|(?=\\?>)`,
      name: `meta.use.php`,
      patterns: [{ match: `\\b(const|function)\\b`, name: 'storage.type.${1:/downcase}.php' }, {
        begin: `{`,
        beginCaptures: { 0: { name: `punctuation.definition.use.begin.bracket.curly.php` } },
        end: `}`,
        endCaptures: { 0: { name: `punctuation.definition.use.end.bracket.curly.php` } },
        patterns: [
          ...
          },
          {
            captures: {
              ...
              2: {
                ...
                }, { match: `.+`, name: `entity.other.alias.php` }],
              },
            },
            match: `(?xi)
\\b(as)
\\s+([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)`,
          ...
          {
            captures: { 1: { name: `keyword.other.use-insteadof.php` }, 2: { name: `support.class.php` } },
...
\\b(trait)\\s+([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)`,
      beginCaptures: { 1: { name: `storage.type.trait.php` }, 2: { name: `entity.name.type.trait.php` } },
      end: `}|(?=\\?>)`,
      endCaptures: { 0: { name: `punctuation.definition.trait.end.bracket.curly.php` } },
      name: `meta.trait.php`,
      patterns: [{ include: `#comments` }, {
        begin: `{`,
        beginCaptures: { 0: { name: `punctuation.definition.trait.begin.bracket.curly.php` } },
...
\\b(interface)\\s+([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)`,
      beginCaptures: { 1: { name: `storage.type.interface.php` }, 2: { name: `entity.name.type.interface.php` } },
      end: `}|(?=\\?>)`,
      endCaptures: { 0: { name: `punctuation.definition.interface.end.bracket.curly.php` } },
      name: `meta.interface.php`,
      patterns: [{ include: `#comments` }, { include: `#interface-extends` }, {
        begin: `{`,
        beginCaptures: { 0: { name: `punctuation.definition.interface.begin.bracket.curly.php` } },
        contentName: `meta.interface.body.php`,
        end: `(?=}|\\?>)`,
        patterns: [{ include: `#class-constant` }, { include: `$self` }],
      }],
    },
    {
      begin: `(?ix)
...
(?: \\s* (:) \\s* (int | string) \\b )?`,
      beginCaptures: {
        ...
        3: { name: `keyword.operator.return-value.php` },
        4: { name: `keyword.other.type.php` },
      },
      end: `}|(?=\\?>)`,
      endCaptures: { 0: { name: `punctuation.definition.enum.end.bracket.curly.php` } },
      name: `meta.enum.php`,
      patterns: [{ include: `#comments` }, { include: `#class-implements` }, {
        begin: `{`,
        beginCaptures: { 0: { name: `punctuation.definition.enum.begin.bracket.curly.php` } },
        contentName: `meta.enum.body.php`,
        end: `(?=}|\\?>)`,
        patterns: [
          {
            captures: { 1: { name: `storage.modifier.php` }, 2: { name: `constant.enum.php` } },
...
|\\b(new)\\b\\s*(\\#\\[.*\\])?\\s*(?:(readonly)\\s+)?\\b(class)\\b
      ...
      beginCaptures: {
        1: {
          patterns: [{ match: `final|abstract`, name: 'storage.modifier.${0:/downcase}.php' }, {
            match: `readonly`,
            name: `storage.modifier.php`,
          }],
        },
        ...
        4: { name: `keyword.other.new.php` },
        5: { patterns: [{ include: `#attribute` }] },
        6: { name: `storage.modifier.php` },
        7: { name: `storage.type.class.php` },
      },
      end: `}|(?=\\?>)`,
      endCaptures: { 0: { name: `punctuation.definition.class.end.bracket.curly.php` } },
      name: `meta.class.php`,
      patterns: [
        {
          begin: `(?<=class)\\s*(\\()`,
          beginCaptures: { 1: { name: `punctuation.definition.arguments.begin.bracket.round.php` } },
          end: `\\)|(?=\\?>)`,
          endCaptures: { 0: { name: `punctuation.definition.arguments.end.bracket.round.php` } },
          name: `meta.function-call.php`,
          patterns: [{ include: `#named-arguments` }, { include: `$self` }],
        },
        { include: `#comments` },
        ...
        {
          begin: `{`,
          beginCaptures: { 0: { name: `punctuation.definition.class.begin.bracket.curly.php` } },
    ...
    { captures: { 1: { name: `keyword.control.yield-from.php` } }, match: `\\s*\\b(yield\\s+from)\\b` },
    {
      captures: { 1: { name: 'keyword.control.${1:/downcase}.php' } },
      match: `(?x)
\\b(
...
for(each)?|if|return|switch|use|while|yield
    ...
    },
    {
      ...
      beginCaptures: {
        ...
        2: { name: `punctuation.definition.parameters.begin.bracket.round.php` },
      },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.parameters.end.bracket.round.php` } },
      name: `meta.catch.php`,
      patterns: [{
        captures: {
          1: {
            patterns: [{ match: `\\|`, name: `punctuation.separator.delimiter.php` }, {
              begin: `(?i)(?=[\\\\a-z_\\x{7f}-\\x{10ffff}])`,
              end: `(?xi)
( [a-z_\\x{7f}-\\x{10ffff}] [a-z0-9_\\x{7f}-\\x{10ffff}]* )
(?![a-z0-9_\\x{7f}-\\x{10ffff}\\\\])`,
              endCaptures: { 1: { name: `support.class.exception.php` } },
...
((\\$+)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)?`,
    ...
    { match: `\\b(catch|try|throw|exception|finally)\\b`, name: `keyword.control.exception.php` },
    {
      ...
      patterns: [{ include: `#comments` }, {
        ...
        captures: { 1: { name: `keyword.operator.return-value.php` }, 2: { patterns: [{ include: `#php-types` }] } },
        match: `(?xi)
(:)\\s*
(
...
(?=\\s*(?:{|/[/*]|\\#|$))`,
    ...
    },
    {
      ...
      endCaptures: { 0: { name: `punctuation.definition.arrow.php` } },
      name: `meta.function.closure.php`,
      patterns: [{
        begin: `(?:(&)\\s*)?(\\()`,
        beginCaptures: {
...
\\s*(\\()`,
      beginCaptures: {
        1: { patterns: [{ match: `final|abstract|public|private|protected`, name: `storage.modifier.php` }] },
        2: { name: `storage.type.function.php` },
        3: { name: `support.function.constructor.php` },
        4: { name: `punctuation.definition.parameters.begin.bracket.round.php` },
      },
      contentName: `meta.function.parameters.php`,
      end: `(?xi)
(\\)) \\s* ( : \\s*
...
(?=\\s*(?:{|/[/*]|\\#|$|;))`,
      endCaptures: {
        1: { name: `punctuation.definition.parameters.end.bracket.round.php` },
        2: { name: `invalid.illegal.return-type.php` },
      },
      name: `meta.function.php`,
      patterns: [{ include: `#comments` }, { match: `,`, name: `punctuation.separator.delimiter.php` }, {
        begin: `(?xi)
...
((?:(&)\\s*)?(\\$)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)`,
        beginCaptures: {
          1: { patterns: [{ match: `public|private|protected|readonly`, name: `storage.modifier.php` }] },
          2: { patterns: [{ include: `#php-types` }] },
          3: { name: `variable.other.php` },
          4: { name: `storage.modifier.reference.php` },
          5: { name: `punctuation.definition.variable.php` },
        },
        end: `(?=\\s*(?:,|\\)|/[/*]|\\#))`,
        name: `meta.function.parameter.promoted-property.php`,
        patterns: [{
          begin: `=`,
          beginCaptures: { 0: { name: `keyword.operator.assignment.php` } },
          end: `(?=\\s*(?:,|\\)|/[/*]|\\#))`,
...
\\s*(\\()`,
      beginCaptures: {
        1: { patterns: [{ match: `final|abstract|public|private|protected|static`, name: `storage.modifier.php` }] },
        2: { name: `storage.type.function.php` },
        3: { name: `support.function.magic.php` },
        4: { name: `storage.modifier.reference.php` },
        5: { name: `entity.name.function.php` },
        6: { name: `punctuation.definition.parameters.begin.bracket.round.php` },
      },
      contentName: `meta.function.parameters.php`,
      end: `(?xi)
(\\)) (?: \\s* (:) \\s* (
...
(?=\\s*(?:{|/[/*]|\\#|$|;))`,
      endCaptures: {
        1: { name: `punctuation.definition.parameters.end.bracket.round.php` },
        2: { name: `keyword.operator.return-value.php` },
        3: {
          patterns: [{ match: `\\b(static)\\b`, name: `storage.type.php` }, {
            match: `\\b(never)\\b`,
    ...
    {
      captures: {
        1: { patterns: [{ match: `public|private|protected|static|readonly`, name: `storage.modifier.php` }] },
        2: { patterns: [{ include: `#php-types` }] },
        3: { name: `variable.other.php` },
...
\\s+ ((\\$)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)`,
    ...
    { include: `#strings` },
    {
      captures: {
        ...
        2: { name: `punctuation.definition.array.begin.bracket.round.php` },
        3: { name: `punctuation.definition.array.end.bracket.round.php` },
      },
      match: `(array)(\\()(\\))`,
    ...
    },
    {
      ...
      endCaptures: { 0: { name: `punctuation.definition.array.end.bracket.round.php` } },
      name: `meta.array.php`,
      patterns: [{ include: `$self` }],
    },
    {
      captures: {
        1: { name: `punctuation.definition.storage-type.begin.bracket.round.php` },
        2: { name: `storage.type.php` },
        3: { name: `punctuation.definition.storage-type.end.bracket.round.php` },
      },
      match: `(?i)(\\()\\s*(array|real|double|float|int(?:eger)?|bool(?:ean)?|string|object|binary|unset)\\s*(\\))`,
    },
    {
      match:
        `(?i)\\b(array|real|double|float|int(eger)?|bool(ean)?|string|class|var|function|interface|trait|parent|self|object|mixed)\\b`,
      name: `storage.type.php`,
    },
    { match: `(?i)\\b(global|abstract|const|final|private|protected|public|static)\\b`, name: `storage.modifier.php` },
    { include: `#object` },
    { match: `;`, name: `punctuation.terminator.expression.php` },
    { match: `:`, name: `punctuation.terminator.statement.php` },
    { include: `#heredoc` },
    { include: `#numbers` },
    { match: `(?i)\\bclone\\b`, name: `keyword.other.clone.php` },
    { match: `\\.\\.\\.`, name: `keyword.operator.spread.php` },
    ...
    { match: `<=>|<=|>=|<|>`, name: `keyword.operator.comparison.php` },
    { match: `\\-\\-|\\+\\+`, name: `keyword.operator.increment-decrement.php` },
    { match: `\\-|\\+|\\*\\*?|/|%`, name: `keyword.operator.arithmetic.php` },
    { match: `(?i)(!|&&|\\|\\|)|\\b(and|or|xor|as)\\b`, name: `keyword.operator.logical.php` },
    ...
    {
      captures: { 1: { name: `keyword.control.goto.php` }, 2: { name: `support.other.php` } },
    ...
    {
      begin: `{`,
      beginCaptures: { 0: { name: `punctuation.definition.begin.bracket.curly.php` } },
      end: `}|(?=\\?>)`,
      endCaptures: { 0: { name: `punctuation.definition.end.bracket.curly.php` } },
      patterns: [{ include: `$self` }],
    },
    {
      begin: `\\[`,
    ...
    {
      begin: `\\(`,
      beginCaptures: { 0: { name: `punctuation.definition.begin.bracket.round.php` } },
      end: `\\)|(?=\\?>)`,
      endCaptures: { 0: { name: `punctuation.definition.end.bracket.round.php` } },
      patterns: [{ include: `$self` }],
    },
    { include: `#constants` },
    ...
    attribute: {
      ...
      patterns: [{ match: `,`, name: `punctuation.separator.delimiter.php` }, {
        ...
        beginCaptures: {
          ...
          2: { name: `punctuation.definition.arguments.begin.bracket.round.php` },
        },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.arguments.end.bracket.round.php` } },
        patterns: [{ include: `#named-arguments` }, { include: `$self` }],
...
( [a-z_\\x{7f}-\\x{10ffff}] [a-z0-9_\\x{7f}-\\x{10ffff}]* )?
(?![a-z0-9_\\x{7f}-\\x{10ffff}\\\\])`,
        endCaptures: { 1: { name: `support.attribute.php` } },
        patterns: [{ include: `#namespace` }],
      }, {
...
\\b`,
    ...
    'class-constant': {
      patterns: [{
        captures: { 1: { name: `storage.modifier.php` }, 2: { name: `constant.other.php` } },
    ...
    'class-extends': {
      patterns: [{
        ...
        patterns: [{ include: `#comments` }, { include: `#inheritance-single` }],
      }],
    },
    'class-implements': {
      patterns: [{
        ...
        patterns: [{ include: `#comments` }, { match: `,`, name: `punctuation.separator.classes.php` }, {
...
(?![a-z0-9_\\x{7f}-\\x{10ffff}\\\\])`,
    ...
    comments: {
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.comment.php` } },
        ...
        begin: `(^\\s+)?(?=//)`,
        beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.php` } },
        end: `(?!\\G)`,
        patterns: [{
          begin: `//`,
          beginCaptures: { 0: { name: `punctuation.definition.comment.php` } },
...
\\b`,
      ...
      }, { match: `(?i)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*`, name: `constant.other.php` }],
    },
    'function-call': {
      patterns: [{
        begin: `(?x)
...
(?:\\\\[a-zA-Z_\\x{7f}-\\x{10ffff}][a-zA-Z0-9_\\x{7f}-\\x{10ffff}]*)+
        ...
        begin:
          `(\\\\)?(?<![a-zA-Z0-9_\\x{7f}-\\x{10ffff}])([a-zA-Z_\\x{7f}-\\x{10ffff}][a-zA-Z0-9_\\x{7f}-\\x{10ffff}]*)\\s*(\\()`,
        beginCaptures: {
          1: { patterns: [{ include: `#namespace` }] },
          2: {
            patterns: [{ include: `#support` }, {
              match: `(?i)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*`,
              name: `entity.name.function.php`,
            }],
          },
          3: { name: `punctuation.definition.arguments.begin.bracket.round.php` },
        },
        end: `\\)|(?=\\?>)`,
        endCaptures: { 0: { name: `punctuation.definition.arguments.end.bracket.round.php` } },
        name: `meta.function-call.php`,
        patterns: [{ include: `#named-arguments` }, { include: `$self` }],
      }, { match: `(?i)\\b(print|echo)\\b`, name: `support.function.construct.output.php` }],
    },
    'function-parameters': {
      patterns: [{ include: `#attribute` }, { include: `#comments` }, {
        ...
        captures: {
          1: { patterns: [{ include: `#php-types` }] },
          2: { name: `variable.other.php` },
          3: { name: `storage.modifier.reference.php` },
          4: { name: `keyword.operator.variadic.php` },
          5: { name: `punctuation.definition.variable.php` },
        },
        match: `(?xi)
(?: (
...
\\s*(=)\\s*`,
    ...
    heredoc: {
      patterns: [{
        ...
        patterns: [{ include: `#nowdoc_interior` }],
      }],
    },
    heredoc_interior: {
      patterns: [{
        ...
        beginCaptures: {
          ...
          5: { name: `invalid.illegal.trailing-whitespace.php` },
        },
        ...
        patterns: [{ include: `#interpolation` }, { include: `text.html.basic` }],
      }, {
        begin: `(<<<)\\s*("?)(XML)(\\2)(\\s*)$`,
        beginCaptures: {
          0: { name: `punctuation.section.embedded.begin.php` },
        ...
        patterns: [{ include: `#interpolation` }, { include: `text.xml` }],
      }, {
        begin: `(<<<)\\s*("?)([DS]QL)(\\2)(\\s*)$`,
        beginCaptures: {
          0: { name: `punctuation.section.embedded.begin.php` },
        ...
        patterns: [{ include: `#interpolation` }, { include: `source.sql` }],
      }, {
        ...
        patterns: [{ include: `#interpolation` }, { include: `source.js` }],
      }, {
        begin: `(<<<)\\s*("?)(JSON)(\\2)(\\s*)$`,
        beginCaptures: {
          0: { name: `punctuation.section.embedded.begin.php` },
        ...
        patterns: [{ include: `#interpolation` }, { include: `source.json` }],
      }, {
        begin: `(<<<)\\s*("?)(CSS)(\\2)(\\s*)$`,
        beginCaptures: {
          0: { name: `punctuation.section.embedded.begin.php` },
        ...
        patterns: [{ include: `#interpolation` }, { include: `source.css` }],
      }, {
        begin: `(<<<)\\s*("?)(REGEXP?)(\\2)(\\s*)$`,
        beginCaptures: {
          0: { name: `punctuation.section.embedded.begin.php` },
        ...
        patterns: [
          ...
          { match: `(\\\\){1,2}[.$^\\[\\]{}]`, name: `constant.character.escape.regex.php` },
          {
            captures: {
          ...
          { match: `[$^+*]`, name: `keyword.operator.regexp.php` },
          {
            ...
            beginCaptures: { 1: { name: `punctuation.definition.comment.php` } },
            end: `$`,
            endCaptures: { 0: { name: `punctuation.definition.comment.php` } },
            name: `comment.line.number-sign.php`,
          },
    ...
    instantiation: {
      ...
      patterns: [{ match: `(?i)(parent|static|self)(?![a-z0-9_\\x{7f}-\\x{10ffff}])`, name: `storage.type.php` }, {
        include: `#class-name`,
    ...
    interpolation: {
      patterns: [
        { match: `\\\\[0-7]{1,3}`, name: `constant.character.escape.octal.php` },
        { match: `\\\\x[0-9A-Fa-f]{1,2}`, name: `constant.character.escape.hex.php` },
        { match: `\\\\u{[0-9A-Fa-f]+}`, name: `constant.character.escape.unicode.php` },
        { match: `\\\\[nrtvef$\\\\]`, name: `constant.character.escape.php` },
        {
          begin: `{(?=\\$.*?})`,
    ...
    interpolation_double_quoted: {
      patterns: [{ match: `\\\\"`, name: `constant.character.escape.php` }, { include: `#interpolation` }],
    },
    'invoke-call': {
      captures: { 1: { name: `variable.other.php` }, 2: { name: `punctuation.definition.variable.php` } },
      match: `(?i)((\\$+)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)(?=\\s*\\()`,
      name: `meta.function-call.invoke.php`,
    },
    match_statement: {
      patterns: [{ match: `\\s+(?=match\\b)` }, {
        begin: `\\bmatch\\b`,
        beginCaptures: { 0: { name: `keyword.control.match.php` } },
        end: `}|(?=\\?>)`,
        endCaptures: { 0: { name: `punctuation.definition.section.match-block.end.bracket.curly.php` } },
        name: `meta.match-statement.php`,
        patterns: [{
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.definition.match-expression.begin.bracket.round.php` } },
          end: `\\)|(?=\\?>)`,
          endCaptures: { 0: { name: `punctuation.definition.match-expression.end.bracket.round.php` } },
          patterns: [{ include: `$self` }],
        }, {
          begin: `{`,
          beginCaptures: { 0: { name: `punctuation.definition.section.match-block.begin.bracket.curly.php` } },
          end: `(?=}|\\?>)`,
          patterns: [{ match: `=>`, name: `keyword.definition.arrow.php` }, { include: `$self` }],
        }],
      }],
    },
    'named-arguments': {
      captures: { 1: { name: `entity.name.variable.parameter.php` }, 2: { name: `punctuation.separator.colon.php` } },
      match: `(?i)(?<=^|\\(|,)\\s*([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)\\s*(:)(?!:)`,
    },
    namespace: {
    ...
    nowdoc_interior: {
      patterns: [{
        ...
        beginCaptures: {
          0: { name: `punctuation.section.embedded.begin.php` },
          1: { name: `punctuation.definition.string.php` },
          2: { name: `keyword.operator.nowdoc.php` },
          3: { name: `invalid.illegal.trailing-whitespace.php` },
        },
        contentName: `text.html`,
        end: `^\\s*(\\2)(?![A-Za-z0-9_\\x{7f}-\\x{10ffff}])`,
        endCaptures: {
          0: { name: `punctuation.section.embedded.end.php` },
          1: { name: `keyword.operator.nowdoc.php` },
        },
        name: `meta.embedded.html`,
        ...
        endCaptures: { 1: { name: `keyword.operator.nowdoc.php` } },
      }],
    },
    null_coalescing: { match: `\\?\\?`, name: `keyword.operator.null-coalescing.php` },
    numbers: {
      patterns: [
        { match: `0[xX][0-9a-fA-F]+(?:_[0-9a-fA-F]+)*`, name: `constant.numeric.hex.php` },
        { match: `0[bB][01]+(?:_[01]+)*`, name: `constant.numeric.binary.php` },
        { match: `0[oO][0-7]+(?:_[0-7]+)*`, name: `constant.numeric.octal.php` },
        { match: `0(?:_?[0-7]+)+`, name: `constant.numeric.octal.php` },
        {
          captures: {
            1: { name: `punctuation.separator.decimal.period.php` },
            2: { name: `punctuation.separator.decimal.period.php` },
          },
          match: `(?x)
(?:
...
[0-9]+(?:_[0-9]+)*[eE][+-]?[0-9]+(?:_[0-9]+)*
        ...
        { match: `0|[1-9](?:_?[0-9]+)*`, name: `constant.numeric.decimal.php` },
      ],
    },
    object: {
      patterns: [{
        ...
        beginCaptures: {
          1: { name: `keyword.operator.class.php` },
          2: { name: `entity.name.function.php` },
          3: { name: `punctuation.definition.arguments.begin.bracket.round.php` },
        },
        end: `\\)|(?=\\?>)`,
        endCaptures: { 0: { name: `punctuation.definition.arguments.end.bracket.round.php` } },
...
(::)\\s*([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)?
          ...
          endCaptures: { 1: { name: `keyword.operator.class.php` }, 2: { name: `constant.other.class.php` } },
    ...
    'php-types': {
      patterns: [
        { match: `\\?`, name: `keyword.operator.nullable-type.php` },
        { match: `[|&]`, name: `punctuation.separator.delimiter.php` },
        {
          match: `(?i)\\b(null|int|float|bool|string|array|object|callable|iterable|true|false|mixed|void)\\b`,
          name: `keyword.other.type.php`,
        },
        { match: `(?i)\\b(parent|self)\\b`, name: `storage.type.php` },
        { match: `\\(`, name: `punctuation.definition.type.begin.bracket.round.php` },
        { match: `\\)`, name: `punctuation.definition.type.end.bracket.round.php` },
        { include: `#class-name` },
      ],
    },
    php_doc: {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.other.phpdoc.php` }, 2: { name: `markup.underline.link.php` } },
          match: `(@xlink)\\s+(.+)\\s*$`,
        },
        {
          begin:
            `(@(?:global|param|property(-(read|write))?|return|throws|var))\\s+(?=[?A-Za-z_\\x{7f}-\\x{10ffff}\\\\]|\\()`,
          beginCaptures: { 1: { name: `keyword.other.phpdoc.php` } },
          contentName: `meta.other.type.phpdoc.php`,
          end: `(?=\\s|\\*/)`,
          patterns: [{ include: `#php_doc_types_array_multiple` }, { include: `#php_doc_types_array_single` }, {
...
|array|resource|void|null|callback|false|true|self|static)\\b`,
      ...
      match:
        `(?i)\\??[a-z_\\x{7f}-\\x{10ffff}\\\\][a-z0-9_\\x{7f}-\\x{10ffff}\\\\]*([|&]\\??[a-z_\\x{7f}-\\x{10ffff}\\\\][a-z0-9_\\x{7f}-\\x{10ffff}\\\\]*)*`,
    },
    php_doc_types_array_multiple: {
      begin: `\\(`,
      beginCaptures: { 0: { name: `punctuation.definition.type.begin.bracket.round.phpdoc.php` } },
      end: `(\\))(\\[\\])|(?=\\*/)`,
      endCaptures: {
        1: { name: `punctuation.definition.type.end.bracket.round.phpdoc.php` },
        2: { name: `keyword.other.array.phpdoc.php` },
      },
      patterns: [{ include: `#php_doc_types_array_multiple` }, { include: `#php_doc_types_array_single` }, {
        include: `#php_doc_types`,
      }, { match: `[|&]`, name: `punctuation.separator.delimiter.php` }],
    ...
    php_doc_types_array_single: {
      captures: { 1: { patterns: [{ include: `#php_doc_types` }] }, 2: { name: `keyword.other.array.phpdoc.php` } },
      match: `(?i)([a-z_\\x{7f}-\\x{10ffff}\\\\][a-z0-9_\\x{7f}-\\x{10ffff}\\\\]*)(\\[\\])`,
    },
    'regex-double-quoted': {
      begin: `"/(?=(\\\\.|[^"/])++/[imsxeADSUXu]*")`,
      ...
      patterns: [{ match: `(\\\\){1,2}[.$^\\[\\]{}]`, name: `constant.character.escape.regex.php` }, {
        ...
        name: `string.regexp.character-class.php`,
        patterns: [{ include: `#interpolation_double_quoted` }],
      }, { match: `[$^+*]`, name: `keyword.operator.regexp.php` }],
    },
    'regex-single-quoted': {
      begin: `'/(?=(\\\\(?:\\\\(?:\\\\[\\\\']?|[^'])|.)|[^'/])++/[imsxeADSUXu]*')`,
    ...
    'scope-resolution': {
      patterns: [{
        captures: {
          1: {
            patterns: [{ match: `\\b(self|static|parent)\\b`, name: `storage.type.php` }, { include: `#class-name` }, {
              include: `#variable-name`,
            }],
          },
        },
        ...
        captures: { 1: { name: `keyword.operator.class.php` }, 2: { name: `keyword.other.class.php` } },
        match: `(?i)(::)\\s*(class)\\b`,
      }, {
        captures: {
          1: { name: `keyword.operator.class.php` },
          2: { name: `variable.other.class.php` },
          3: { name: `punctuation.definition.variable.php` },
          4: { name: `constant.other.class.php` },
        },
        match: `(?xi)
(::)\\s*
(?:
...
([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)
    ...
    single_quote_regex_escape: { match: `\\\\(?:\\\\(?:\\\\[\\\\']?|[^'])|.)`, name: `constant.character.escape.php` },
    'sql-string-double-quoted': {
      ...
      patterns: [
        ...
        { match: `'(?=((\\\\')|[^'"])*("|$))`, name: `string.quoted.single.unclosed.sql` },
        { match: '`(?=((\\\\`)|[^`"])*("|$))', name: `string.quoted.other.backtick.unclosed.sql` },
        {
          begin: `'`,
          end: `'`,
    ...
    'sql-string-single-quoted': {
      ...
      patterns: [
        ...
        { match: `\\\\[\\\\'\`"]`, name: `constant.character.escape.php` },
        { match: "`(?=((\\\\`)|[^`'])*('|$))", name: `string.quoted.other.backtick.unclosed.sql` },
        { match: `"(?=((\\\\")|[^"'])*('|$))`, name: `string.quoted.double.unclosed.sql` },
        { include: `source.sql` },
      ],
    },
    'string-backtick': {
...
php_(check_syntax|strip_whitespace)|pack|eval|exit|get_browser
        ...
        { match: `(?i)\\bbc(scale|sub|sqrt|comp|div|pow(mod)?|add|mod|mul)\\b`, name: `support.function.bcmath.php` },
...
pow|eqv|fix|and|add|abs|round|get_type|xor|mod|mul)
        ...
        { match: `(?i)\\b(isset|unset|eval|empty|list)\\b`, name: `support.function.construct.php` },
        { match: `(?i)\\b(print|echo)\\b`, name: `support.function.construct.output.php` },
        {
...
broker_(set_ordering|init|dict_exists|describe|free(_dict)?|list_dicts|request_(pwl_)?dict|get_error)
        ...
        { match: `(?i)\\b(split(i)?|sql_regcase|ereg(i)?(_replace)?)\\b`, name: `support.function.ereg.php` },
        {
          match:
        ...
        {
          match:
            `(?i)\\b(shell_exec|system|passthru|proc_(nice|close|terminate|open|get_status)|escapeshell(arg|cmd)|exec)\\b`,
...
rename|rewind|read(file|link)|realpath(_cache_(get|size))?|rmdir|glob|move_uploaded_file|mkdir|basename
        ...
        { match: `(?i)\\bfastcgi_finish_request\\b`, name: `support.function.fpm.php` },
        {
          match:
...
msgfmt_(set_pattern|create|(format|parse)(_message)?|get_(pattern|error_(code|message)|locale))
        ...
        { match: `(?i)\\bjson_(decode|encode|last_error(_msg)?)\\b`, name: `support.function.json.php` },
        {
          match: `(?xi)\\b
ldap_(
...
mod_(add|del|replace)
        ...
        { match: `(?i)\\b(ezmlm_hash|mail)\\b`, name: `support.function.mail.php` },
        {
          match: `(?xi)\\b
(
...
mdecrypt_generic
        ...
        { match: `(?i)\\bmemcache_debug\\b`, name: `support.function.memcache.php` },
        {
...
master_query|bind_(param|result)|begin_transaction
        ...
        { match: `(?i)\\bmysqlnd_memcache_(set|get_config)\\b`, name: `support.function.mysqlnd-memcache.php` },
        {
          match:
...
get(servby(name|port)|host(name|by(name(l)?|addr))|protoby(name|number)|mxrr)
        ...
        { match: `(?i)\\bnsapi_(virtual|response_headers|request_headers)\\b`, name: `support.function.nsapi.php` },
        {
          match: `(?xi)\\b
(
...
get_(status|contents|clean|flush|length|level))
        ...
        { match: `(?i)\\bpassword_(hash|needs_rehash|verify|get_info)\\b`, name: `support.function.password.php` },
        {
          match: `(?xi)\\b
pcntl_(
...
lo_(seek|close|create|tell|truncate|import|open|unlink|export|write|read(_all)?)|
        ...
        { match: `(?i)\\bdom_import_simplexml\\b`, name: `support.function.php_dom.php` },
        {
          match: `(?xi)\\b
ftp_(
...
get_last_error|mknod|mkfifo
        ...
        { match: `(?i)\\bset(thread|proc)title\\b`, name: `support.function.proctitle.php` },
        {
          match: `(?xi)\\b
pspell_(
...
config_(save_repl|create|ignore|(data|dict)_dir|personal|runtogether|repl|mode)|add_to_(session|personal)
        ...
        { match: `(?i)\\brecode(_(string|file))?\\b`, name: `support.function.recode.php` },
        {
          match:
...
regenerate_id|get_cookie_params|module_name
        ...
        { match: `(?i)\\bshmop_(size|close|open|delete|write|read)\\b`, name: `support.function.shmop.php` },
        { match: `(?i)\\bsimplexml_(import_dom|load_(string|file))\\b`, name: `support.function.simplexml.php` },
        {
          match: `(?xi)\\b
(
...
snmp[23]_(set|walk|real_walk|get(next)?)
        ...
        { match: `(?i)\\b(is_soap_fault|use_soap_error_handler)\\b`, name: `support.function.soap.php` },
        {
          match: `(?xi)\\b
socket_(
...
affected_rows|result|get_last_message|min_(client|error|message|server)_severity
        ...
        { match: `(?i)\\b(taint|is_tainted|untaint)\\b`, name: `support.function.taint.php` },
        {
          match: `(?xi)\\b
(
...
ob_tidyhandler
        ...
        { match: `(?i)\\btoken_(name|get_all)\\b`, name: `support.function.tokenizer.php` },
        {
          match: `(?xi)\\b
trader_(
...
unset|unserialize|print_r|empty|var_(dump|export)|gettype|get_(defined_vars|resource_type)
        ...
        { match: `(?i)\\bxhprof_(sample_)?(disable|enable)\\b`, name: `support.function.xhprof.php` },
        {
          match: `(?xi)
\\b
(
...
write|rewind|read|getc|getss?)
    ...
    switch_statement: {
      patterns: [{ match: `\\s+(?=switch\\b)` }, {
        begin: `\\bswitch\\b(?!\\s*\\(.*\\)\\s*:)`,
        beginCaptures: { 0: { name: `keyword.control.switch.php` } },
        end: `}|(?=\\?>)`,
        endCaptures: { 0: { name: `punctuation.definition.section.switch-block.end.bracket.curly.php` } },
        name: `meta.switch-statement.php`,
        patterns: [{
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.definition.switch-expression.begin.bracket.round.php` } },
          end: `\\)|(?=\\?>)`,
          endCaptures: { 0: { name: `punctuation.definition.switch-expression.end.bracket.round.php` } },
          patterns: [{ include: `$self` }],
        }, {
          begin: `{`,
          beginCaptures: { 0: { name: `punctuation.definition.section.switch-block.begin.bracket.curly.php` } },
          end: `(?=}|\\?>)`,
          patterns: [{ include: `$self` }],
        }],
      }],
    ...
    ternary_expression: {
      begin: `\\?`,
      beginCaptures: { 0: { name: `keyword.operator.ternary.php` } },
      end: `(?<!:):(?!:)`,
      endCaptures: { 0: { name: `keyword.operator.ternary.php` } },
      patterns: [{
        captures: { 1: { patterns: [{ include: `$self` }] } },
        match: `(?i)^\\s*([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)\\s*(?=:(?!:))`,
      }, { include: `$self` }],
    },
    ternary_shorthand: { match: `\\?:`, name: `keyword.operator.ternary.php` },
    'use-inner': {
      patterns: [
        { include: `#comments` },
        {
          begin: `(?i)\\b(as)\\s+`,
          beginCaptures: { 1: { name: `keyword.other.use-as.php` } },
          end: `(?i)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*`,
          endCaptures: { 0: { name: `entity.other.alias.php` } },
        },
        { include: `#class-name` },
        { match: `,`, name: `punctuation.separator.delimiter.php` },
      ],
    ...
    'variable-name': {
      patterns: [{ include: `#var_global` }, { include: `#var_global_safer` }, {
        captures: {
          1: { name: `variable.other.php` },
          2: { name: `punctuation.definition.variable.php` },
...
(\\[)(?:(\\d+)|((\\$)\\g<name>)|([a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*))(\\])
    ...
    variables: {
      patterns: [{ include: `#var_language` }, { include: `#var_global` }, { include: `#var_global_safer` }, {
        include: `#var_basic`,
      }, {
        begin: '\\${(?=.*?})',
        beginCaptures: { 0: { name: `punctuation.definition.variable.php` } },
  ...
  i = `source.php`,
  a = { displayName: `PHP`, name: `php`, patterns: n, repository: r, scopeName: i }
