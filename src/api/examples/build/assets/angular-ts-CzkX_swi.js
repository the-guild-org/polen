var e = `Angular TypeScript`,
  ...
  r = {
    ...
    'arrow-function': {
      patterns: [{
        captures: { 1: { name: `storage.modifier.async.ts` }, 2: { name: `variable.parameter.ts` } },
        match:
...
\\s*=>
    ...
    'class-declaration-or-expression-patterns': {
      patterns: [
        ...
        { captures: { 0: { name: `entity.name.type.class.ts` } }, match: `[_$[:alpha:]][_$[:alnum:]]*` },
    ...
    'class-or-interface-heritage': {
      ...
      patterns: [
        ...
        { captures: { 1: { name: `entity.other.inherited-class.ts` } }, match: `([_$[:alpha:]][_$[:alnum:]]*)` },
    ...
    'control-statement': {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.control.loop.ts` }, 2: { name: `entity.name.label.ts` } },
          match:
...
((?:[^@\\s*/]|\\*[^/])+)`,
        },
        {
          ...
          }, { captures: { 0: { name: `source.embedded.ts` } }, match: `[^\\s@*](?:[^*]|\\*[^/])*` }],
        },
        {
          captures: {
            1: { name: `storage.type.class.jsdoc` },
...
[^{}@\\s*] | \\*[^/]
    ...
    'export-declaration': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.control.export.ts` }, 2: { name: `keyword.control.type.ts` } },
        end:
          `(?=$|;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b))`,
        name: `meta.export.ts`,
...
\\s*=>
    ...
    'expression-operators': {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.control.flow.ts` }, 2: { name: `keyword.generator.asterisk.ts` } },
          match:
        ...
        },
        {
          ...
          beginCaptures: { 1: { name: `keyword.control.as.ts` }, 2: { name: `keyword.control.satisfies.ts` } },
          end:
            `(?=^|[;),}\\]:?\\-\\+\\>]|\\|\\||\\&\\&|\\!\\=\\=|$|((?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(as|satisfies)\\s+)|(\\s+\\<))`,
          patterns: [{ include: `#type` }],
        },
        { match: `\\.\\.\\.`, name: `keyword.operator.spread.ts` },
        { match: `\\*=|(?<!\\()/=|%=|\\+=|\\-=`, name: `keyword.operator.assignment.compound.ts` },
        { match: `\\&=|\\^=|<<=|>>=|>>>=|\\|=`, name: `keyword.operator.assignment.compound.bitwise.ts` },
...
\\s*=>
        ...
        { match: `\\#?[_$[:alpha:]][_$[:alnum:]]*`, name: `meta.definition.property.ts variable.object.property.ts` },
    ...
    'for-loop': {
      ...
      patterns: [{ include: `#comment` }, { match: `await`, name: `keyword.control.loop.ts` }, {
        begin: `\\(`,
    ...
    'function-call-optionals': {
      patterns: [{ match: `\\?\\.`, name: `meta.function-call.ts punctuation.accessor.optional.ts` }, {
        match: `\\!`,
...
\\s*=>
        ...
        { match: `([[:upper:]][_$[:digit:][:upper:]]*)(?![_$[:alnum:]])`, name: `variable.other.constant.ts` },
        { match: `[_$[:alpha:]][_$[:alnum:]]*`, name: `variable.other.readwrite.ts` },
      ],
    },
    'if-statement': {
      patterns: [{
        ...
        patterns: [{ include: `#comment` }, {
          begin: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(if)\\s*(\\()`,
          beginCaptures: { 1: { name: `keyword.control.conditional.ts` }, 2: { name: `meta.brace.round.ts` } },
          end: `\\)`,
          endCaptures: { 0: { name: `meta.brace.round.ts` } },
          patterns: [{ include: `#expression` }],
        }, {
          ...
          endCaptures: { 1: { name: `punctuation.definition.string.end.ts` }, 2: { name: `keyword.other.ts` } },
    ...
    'import-export-clause': {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.control.type.ts` }, 2: { name: `variable.other.readwrite.alias.ts` } },
    ...
    'indexer-declaration': {
      ...
      endCaptures: { 1: { name: `meta.brace.square.ts` }, 2: { name: `keyword.operator.optional.ts` } },
    ...
    'interface-declaration': {
      ...
      patterns: [
        { include: `#comment` },
        { include: `#class-or-interface-heritage` },
        { captures: { 0: { name: `entity.name.type.interface.ts` } }, match: `[_$[:alpha:]][_$[:alnum:]]*` },
        { include: `#type-parameters` },
        { include: `#class-or-interface-body` },
      ],
    },
    ...
    label: {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `entity.name.label.ts` }, 2: { name: `punctuation.separator.label.ts` } },
        end: `(?<=\\})`,
        patterns: [{ include: `#decl-block` }],
      }, {
        captures: { 1: { name: `entity.name.label.ts` }, 2: { name: `punctuation.separator.label.ts` } },
        match: `([_$[:alpha:]][_$[:alnum:]]*)\\s*(:)`,
      }],
    },
    literal: {
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
    ...
    'namespace-declaration': {
      ...
      patterns: [
        { include: `#comment` },
        { include: `#string` },
        { match: `([_$[:alpha:]][_$[:alnum:]]*)`, name: `entity.name.type.module.ts` },
...
(\\#?[_$[:alpha:]][_$[:alnum:]]*)
        ...
        captures: { 1: { name: `variable.other.constant.object.ts` }, 2: { name: `variable.other.object.ts` } },
        match: `(?x)(?:
([[:upper:]][_$[:digit:][:upper:]]*) |
([_$[:alpha:]][_$[:alnum:]]*)
)(?=\\s*\\??\\.\\s*\\#?[_$[:alpha:]][_$[:alnum:]]*)`,
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
        ...
        {
          captures: { 0: { name: `meta.object-literal.key.ts` }, 1: { name: `constant.numeric.decimal.ts` } },
          match: `(?![_$[:alpha:]])([[:digit:]]+)\\s*(?=(\\/\\*([^\\*]|(\\*[^\\/]))*\\*\\/\\s*)*:)`,
          name: `meta.object.member.ts`,
        },
        {
          captures: { 0: { name: `meta.object-literal.key.ts` }, 1: { name: `entity.name.function.ts` } },
          match:
        ...
        },
        {
          ...
          patterns: [
            ...
            },
            {
              ...
              beginCaptures: { 1: { name: `storage.modifier.async.ts` }, 2: { name: `meta.brace.round.ts` } },
              end: `\\)`,
              endCaptures: { 0: { name: `meta.brace.round.ts` } },
              patterns: [{ include: `#expression-inside-possibly-arrow-parens` }],
            },
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
    ...
    'punctuation-accessor': {
      captures: { 1: { name: `punctuation.accessor.ts` }, 2: { name: `punctuation.accessor.optional.ts` } },
      match: `(?:(\\.)|(\\?\\.(?!\\s*[[:digit:]])))`,
    },
    'punctuation-comma': { match: `,`, name: `punctuation.separator.comma.ts` },
    'punctuation-semicolon': { match: `;`, name: `punctuation.terminator.statement.ts` },
    'qstring-double': {
      begin: `"`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.ts` } },
      end: `(")|((?:[^\\\\\\n])$)`,
      endCaptures: { 1: { name: `punctuation.definition.string.end.ts` }, 2: { name: `invalid.illegal.newline.ts` } },
...
(?:(EPSILON|MAX_SAFE_INTEGER|MAX_VALUE|MIN_SAFE_INTEGER|MIN_VALUE|NEGATIVE_INFINITY|POSITIVE_INFINITY)\\b(?!\\$)))`,
    ...
    'switch-statement': {
      ...
      patterns: [{ include: `#comment` }, {
        ...
        beginCaptures: { 1: { name: `keyword.control.switch.ts` }, 2: { name: `meta.brace.round.ts` } },
        end: `\\)`,
        endCaptures: { 0: { name: `meta.brace.round.ts` } },
    ...
    'type-alias-declaration': {
      ...
      patterns: [{ include: `#comment` }, { include: `#type-parameters` }, {
        ...
        beginCaptures: { 1: { name: `keyword.operator.assignment.ts` }, 2: { name: `keyword.control.intrinsic.ts` } },
        end:
          `(?=\\}|;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b))`,
        patterns: [{ include: `#type` }],
      }, {
    ...
    'type-fn-type-parameters': {
      patterns: [{
        ...
        begin: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:(abstract)\\s+)?(new)\\b\\s*(?=\\()`,
        beginCaptures: { 1: { name: `storage.modifier.ts` }, 2: { name: `keyword.control.new.ts` } },
        end: `(?<=\\))`,
...
([)]\\s*=>)
    ...
    'type-operators': {
      patterns: [
        ...
        { begin: `[&|]`, beginCaptures: { 0: { name: `keyword.operator.type.ts` } }, end: `(?=\\S)` },
        {
