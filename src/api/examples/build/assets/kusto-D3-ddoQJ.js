var e = `Kusto`,
  ...
  r = [
    ...
    {
      captures: { 1: { name: `support.function.kusto` }, 2: { patterns: [{ include: `#Strings` }] } },
    ...
    },
    {
      ...
      match:
        `\\b(binary_and|binary_or|binary_shift_left|binary_shift_right|binary_xor)(?:\\s*\\(\\s*(\\w+)\\s*,\\s*(\\w+)\\s*\\))?(?!\\w)`,
      name: `meta.scalar.bitwise.kusto`,
    },
    {
      captures: { 1: { name: `support.function.kusto` }, 2: { patterns: [{ include: `#Numeric` }] } },
    ...
    },
    {
      captures: {
        1: { name: `support.function.kusto` },
        2: {
          patterns: [{ include: `#DateTimeTimeSpanDataTypes` }, { include: `#TimeSpanLiterals` }, {
    ...
    },
    {
      captures: {
        ...
        3: { patterns: [{ include: `#TimeSpanLiterals` }, { include: `#Numeric` }] },
      },
    ...
    {
      comment:
        `User-defined functions: https://docs.microsoft.com/en-us/azure/kusto/query/functions/user-defined-functions`,
    ...
    { match: `\\b(function)\\b`, name: `storage.type.kusto` },
    {
    ...
    {
      captures: { 1: { name: `keyword.other.query.kusto` }, 2: { name: `variable.other.kusto` } },
    ...
    {
      captures: { 1: { name: `keyword.other.query.kusto` }, 2: { name: `keyword.other.operator.kusto` } },
    ...
    {
      captures: { 1: { name: `keyword.other.query.kusto` }, 2: { name: `entity.name.function.kusto` } },
    ...
    {
      captures: {
        1: { name: `keyword.other.query.kusto` },
        2: { name: `keyword.other.operator.kusto` },
        3: { name: `variable.other.column.kusto` },
      },
    ...
    },
    {
      captures: {
        1: { name: `keyword.other.query.kusto` },
        2: { name: `variable.other.column.kusto` },
        3: { name: `keyword.other.operator.kusto` },
        4: {
          patterns: [{ include: `#TimeSpanLiterals` }, { include: `#DateTimeTimeSpanFunctions` }, {
            include: `#Numeric`,
          }],
        },
        5: { name: `keyword.other.operator.kusto` },
        6: {
          patterns: [{ include: `#TimeSpanLiterals` }, { include: `#DateTimeTimeSpanFunctions` }, {
            include: `#Numeric`,
          }],
        },
        7: { name: `keyword.other.operator.kusto` },
        8: {
          patterns: [{ include: `#TimeSpanLiterals` }, { include: `#DateTimeTimeSpanFunctions` }, {
            include: `#Numeric`,
          }],
      ...
      match:
        `\\b(range)\\s+(\\w+)\\s+(from)\\s+(\\w+(?:\\(\\w*\\))?)\\s+(to)\\s+(\\w+(?:\\(\\w*\\))?)\\s+(step)\\s+(\\w+(?:\\(\\w*\\))?)\\b`,
      name: `meta.query.range.kusto`,
    },
    {
      captures: { 1: { name: `keyword.other.query.kusto` }, 2: { patterns: [{ include: `#Numeric` }] } },
    ...
    },
    {
      captures: {
        ...
        2: { patterns: [{ include: `#Numeric` }] },
        3: { name: `keyword.other.operator.kusto` },
        4: { name: `variable.other.column.kusto` },
      },
    ...
    },
    {
      captures: {
        ...
        4: { name: `variable.other.column.kusto` },
        5: { name: `keyword.other.operator.kusto` },
        6: { name: `variable.other.column.kusto` },
      },
    ...
    {
      match:
        `\\b(anomalychart|areachart|barchart|card|columnchart|ladderchart|linechart|piechart|pivotchart|scatterchart|stackedareachart|timechart|timepivot)\\b`,
      name: `support.function.kusto`,
    },
    { include: `#Strings` },
    { match: `\\{.*?\\}`, name: `string.other.kusto` },
    { comment: `Comments`, match: `//.*`, name: `comment.line.kusto` },
    { include: `#TimeSpanLiterals` },
    { include: `#DateTimeTimeSpanFunctions` },
    { include: `#DateTimeTimeSpanDataTypes` },
    { include: `#Numeric` },
    { match: `\\b(true|false|null)\\b`, name: `constant.language.kusto` },
    {
      comment: `Deprecated functions`,
      match:
        `\\b(anyif|any|array_strcat|base64_decodestring|base64_encodestring|make_dictionary|makelist|makeset|mvexpand|todynamic|parse_json|replace|weekofyear)(?=\\W*\\(|\\b)`,
      name: `invalid.deprecated.kusto`,
    },
  ],
  i = {
    DateTimeTimeSpanDataTypes: { patterns: [{ match: `\\b(datetime|timespan|time)\\b`, name: `storage.type.kusto` }] },
    DateTimeTimeSpanFunctions: {
      patterns: [{
        captures: {
          1: { name: `support.function.kusto` },
          2: { patterns: [{ include: `#DateTimeTimeSpanDataTypes` }] },
    ...
    Strings: {
      patterns: [{
        begin: `([@h]?")`,
        beginCaptures: { 1: { name: `punctuation.definition.string.kusto` } },
        comment: `https://learn.microsoft.com/en-us/azure/data-explorer/kusto/query/scalar-data-types/string`,
        end: `"`,
        endCaptures: { 0: { name: `punctuation.definition.string.kusto` } },
        ...
        beginCaptures: { 1: { name: `punctuation.definition.string.kusto` } },
        comment:
          `https://learn.microsoft.com/en-us/azure/data-explorer/kusto/query/scalar-data-types/string#multi-line-string-literals`,
        end: '```',
        endCaptures: { 0: { name: `punctuation.definition.string.kusto` } },
    ...
    TimeSpanLiterals: {
      patterns: [{
        comment:
          `timespan literals: https://docs.microsoft.com/en-us/azure/kusto/query/scalar-data-types/timespan#timespan-literals`,
