var e = `Typst`,
  ...
  r = {
    arguments: {
      patterns: [{ match: `\\b[[:alpha:]_][[:alnum:]_-]*(?=:)`, name: `variable.parameter.typst` }, {
        include: `#code`,
      }],
    },
    code: {
...
`,
        ...
        { match: `\\b(for|while|break|continue)\\b`, name: `keyword.control.loop.typst` },
        { match: `\\b(import|include|export)\\b`, name: `keyword.control.import.typst` },
        ...
        { match: `\\b[[:alpha:]_][[:alnum:]_-]*\\b`, name: `variable.other.typst` },
        {
          begin: `\\(`,
          captures: { 0: { name: `punctuation.definition.group.typst` } },
          end: `\\)|(?=;)`,
...
`,
    ...
    constants: {
      patterns: [
        ...
        { match: `\\b(\\d*)?\\.?\\d+([eE][+-]?\\d+)?(mm|pt|cm|in|em)\\b`, name: `constant.numeric.length.typst` },
        { match: `\\b(\\d*)?\\.?\\d+([eE][+-]?\\d+)?(rad|deg)\\b`, name: `constant.numeric.angle.typst` },
        { match: `\\b(\\d*)?\\.?\\d+([eE][+-]?\\d+)?%`, name: `constant.numeric.percentage.typst` },
        { match: `\\b(\\d*)?\\.?\\d+([eE][+-]?\\d+)?fr`, name: `constant.numeric.fr.typst` },
        { match: `\\b\\d+\\b`, name: `constant.numeric.integer.typst` },
        { match: `\\b(\\d*)?\\.?\\d+([eE][+-]?\\d+)?\\b`, name: `constant.numeric.float.typst` },
        {
          begin: `"`,
...
|(?=\\])`,
        ...
        { match: `https?://[0-9a-zA-Z~/%#&=',;\\.\\+\\?]*`, name: `markup.underline.link.typst` },
        {
          begin: '`{3,}',
...
|(?=<)`,
        ...
        { match: `^\\s*-\\s+`, name: `punctuation.definition.list.unnumbered.typst` },
        { match: `^\\s*([0-9]*\\.|\\+)\\s+`, name: `punctuation.definition.list.numbered.typst` },
        {
          captures: {
        ...
        },
        {
          ...
          beginCaptures: { 0: { name: `keyword.other.typst` }, 1: { name: `punctuation.definition.keyword.typst` } },
          end: `
|(;)|(?=])`,
...
|(;)|(?=])`,
        ...
        { begin: `#`, end: `\\s`, name: `meta.block.content.typst`, patterns: [{ include: `#code` }] },
      ],
    },
  },
  i = `source.typst`,
