var e = `C++`,
  ...
  r = {
    access_control_keywords: {
      captures: {
        ...
        2: {
          patterns: [{
            captures: {
              1: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
              2: { name: `comment.block.cpp` },
              3: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
            },
            match: `\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+`,
          }],
        },
    ...
    alignas_attribute: {
      begin: `alignas\\(`,
      beginCaptures: { 0: { name: `punctuation.section.attribute.begin.cpp` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.attribute.end.cpp` } },
      ...
      patterns: [
        { include: `#attributes_context` },
        {
          ...
          endCaptures: {},
          patterns: [{ include: `#attributes_context` }, { include: `#string_context` }, {
            include: `#ever_present_context`,
          }],
        },
        {
          captures: { 1: { name: `keyword.other.using.directive.cpp` }, 2: { name: `entity.name.namespace.cpp` } },
          match:
            `(using)\\s+((?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w))`,
        },
        { match: `,`, name: `punctuation.separator.attribute.cpp` },
        { match: `:`, name: `punctuation.accessor.attribute.cpp` },
        {
          match:
            `(?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w)(?=::)`,
    ...
    alignas_operator: {
      ...
      beginCaptures: {
        1: { name: `keyword.operator.functionlike.cpp keyword.operator.alignas.cpp` },
        2: { patterns: [{ include: `#inline_comment` }] },
        3: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        4: { name: `comment.block.cpp` },
        5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        6: { name: `punctuation.section.arguments.begin.bracket.round.operator.alignas.cpp` },
      },
      contentName: `meta.arguments.operator.alignas`,
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.operator.alignas.cpp` } },
      patterns: [{ include: `#evaluation_context` }],
    },
    alignof_operator: {
      begin:
        `((?<!\\w)alignof(?!\\w))((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))(\\()`,
      beginCaptures: {
        1: { name: `keyword.operator.functionlike.cpp keyword.operator.alignof.cpp` },
        2: { patterns: [{ include: `#inline_comment` }] },
        3: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        4: { name: `comment.block.cpp` },
        5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        6: { name: `punctuation.section.arguments.begin.bracket.round.operator.alignof.cpp` },
      },
      contentName: `meta.arguments.operator.alignof`,
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.operator.alignof.cpp` } },
      patterns: [{ include: `#evaluation_context` }],
    },
    assembly: {
      begin: `(\\b(?:__asm__|asm)\\b)(?:\\s+)?((?:volatile)?)`,
      beginCaptures: { 1: { name: `storage.type.asm.cpp` }, 2: { name: `storage.modifier.cpp` } },
      end: `(?!\\G)`,
      endCaptures: {},
      name: `meta.asm.cpp`,
      patterns: [
        {
          captures: {
            1: { patterns: [{ include: `#inline_comment` }] },
            2: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
            3: { name: `comment.block.cpp` },
            4: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
          },
          match:
            `^((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))(?:\\n|$)`,
        },
        { include: `#comments` },
        {
          begin:
            `((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))\\(`,
          beginCaptures: {
            0: { name: `punctuation.section.parens.begin.bracket.round.assembly.cpp` },
            1: { patterns: [{ include: `#inline_comment` }] },
            2: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
            3: { name: `comment.block.cpp` },
            4: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
          ...
          endCaptures: { 0: { name: `punctuation.section.parens.end.bracket.round.assembly.cpp` } },
          patterns: [
            {
              begin: `(R?)(")`,
              beginCaptures: {
                1: { name: `meta.encoding.cpp` },
                2: { name: `punctuation.definition.string.begin.assembly.cpp` },
              },
              contentName: `meta.embedded.assembly`,
              end: `"`,
              endCaptures: { 0: { name: `punctuation.definition.string.end.assembly.cpp` } },
            ...
            {
              begin: `\\(`,
              beginCaptures: { 0: { name: `punctuation.section.parens.begin.bracket.round.assembly.inner.cpp` } },
              end: `\\)`,
              endCaptures: { 0: { name: `punctuation.section.parens.end.bracket.round.assembly.inner.cpp` } },
              patterns: [{ include: `#evaluation_context` }],
            },
            {
              captures: {
                ...
                7: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
                8: { name: `comment.block.cpp` },
                9: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
              },
              match:
                `\\[((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))((?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*)((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))\\]`,
            },
            { match: `:`, name: `punctuation.separator.delimiter.colon.assembly.cpp` },
            { include: `#comments` },
          ],
        },
      ],
    },
    assignment_operator: { match: `\\=`, name: `keyword.operator.assignment.cpp` },
    attributes_context: {
      patterns: [{ include: `#cpp_attributes` }, { include: `#gcc_attributes` }, { include: `#ms_attributes` }, {
...
U[a-fA-F0-9]{,8} )`,
    ...
    block_comment: {
      begin: `\\s*+(\\/\\*)`,
      beginCaptures: { 1: { name: `punctuation.definition.comment.begin.cpp` } },
      end: `\\*\\/`,
      endCaptures: { 0: { name: `punctuation.definition.comment.end.cpp` } },
    ...
    builtin_storage_type_initilizer: {
      ...
      beginCaptures: {
        1: { name: `storage.type.primitive.cpp storage.type.built-in.primitive.cpp` },
        2: { name: `storage.type.cpp storage.type.built-in.cpp` },
        3: { name: `support.type.posix-reserved.pthread.cpp support.type.built-in.posix-reserved.pthread.cpp` },
        4: { name: `support.type.posix-reserved.cpp support.type.built-in.posix-reserved.cpp` },
        5: { name: `punctuation.section.arguments.begin.bracket.round.initializer.cpp` },
      },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.initializer.cpp` } },
      patterns: [{ include: `#evaluation_context` }],
    },
    case_statement: {
      begin:
    ...
    class_block: {
      ...
      beginCaptures: {
        ...
        4: { name: `comment.block.cpp` },
        5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        6: { patterns: [{ include: `#attributes_context` }, { include: `#number_literal` }] },
        7: { patterns: [{ include: `#inline_comment` }] },
        8: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        9: { name: `comment.block.cpp` },
        10: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        11: {
          patterns: [
            {
              captures: {
            ...
            },
            {
              ...
              match:
                `((?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w))((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))(?:((?<!\\w)final(?!\\w))((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z)))?(?=:|{|$)`,
            },
            { match: `DLLEXPORT`, name: `entity.name.other.preprocessor.macro.predefined.DLLEXPORT.cpp` },
            {
              match:
        ...
        13: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        14: { name: `comment.block.cpp` },
        15: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        16: { patterns: [{ include: `#inline_comment` }] },
        17: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        18: { name: `comment.block.cpp` },
        19: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.class.cpp` } },
        name: `meta.head.class.cpp`,
        patterns: [{ include: `#ever_present_context` }, { include: `#inheritance_context` }, {
        ...
        endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.class.cpp` } },
    ...
    comma: { match: `,`, name: `punctuation.separator.delimiter.comma.cpp` },
    comma_in_template_argument: { match: `,`, name: `punctuation.separator.delimiter.comma.template.argument.cpp` },
    comments: {
      patterns: [
        {
          begin: `^(?:\\s+)?+(\\/\\/[!\\/]+)`,
          beginCaptures: { 1: { name: `punctuation.definition.comment.documentation.cpp` } },
          end: `(?<=\\n)(?<!\\\\\\n)`,
          endCaptures: {},
          ...
          patterns: [{ include: `#line_continuation_character` }, {
            ...
            captures: { 1: { name: `storage.type.class.doxygen.cpp` }, 2: { name: `markup.italic.doxygen.cpp` } },
            match: `((?<=[\\s*!\\/])[\\\\@](?:a|em|e))\\s+(\\S+)`,
          }, {
            captures: { 1: { name: `storage.type.class.doxygen.cpp` }, 2: { name: `markup.bold.doxygen.cpp` } },
            match: `((?<=[\\s*!\\/])[\\\\@]b)\\s+(\\S+)`,
          }, {
            captures: { 1: { name: `storage.type.class.doxygen.cpp` }, 2: { name: `markup.inline.raw.string.cpp` } },
            match: `((?<=[\\s*!\\/])[\\\\@](?:c|p))\\s+(\\S+)`,
          }, {
            match:
            ...
            captures: {
              ...
              2: { patterns: [{ match: `in|out`, name: `keyword.other.parameter.direction.$0.cpp` }] },
              3: {
                patterns: [{
                  match:
                    `(?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w)`,
                  name: `variable.parameter.cpp`,
                }, { match: `,`, name: `punctuation.cpp` }],
              },
              4: { name: `variable.parameter.cpp` },
              5: { name: `punctuation.cpp` },
              6: { name: `variable.parameter.cpp` },
            },
            match:
              `((?<=[\\s*!\\/])[\\\\@]param)(?:\\s*\\[((?:,?(?:\\s+)?(?:in|out)(?:\\s+)?)+)\\])?(\\s+((?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w))(?:(,)(?:\\s+)?((?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w)))*)`,
          }, {
            match:
              `(?<=[\\s*!\\/])[\\\\@](?:arg|attention|author|authors|brief|bug|copyright|date|deprecated|details|exception|invariant|li|note|par|paragraph|param|post|pre|remark|remarks|result|return|returns|retval|sa|see|short|since|test|throw|throws|todo|tparam|version|warning|xrefitem)\\b(?:\\{[^}]*\\})?`,
            name: `storage.type.class.doxygen.cpp`,
          }, {
            match:
              `(?<=[\\s*!\\/])[\\\\@](?:code|cond|docbookonly|dot|htmlonly|internal|latexonly|link|manonly|msc|parblock|rtfonly|secreflist|startuml|verbatim|xmlonly|endcode|endcond|enddocbookonly|enddot|endhtmlonly|endinternal|endlatexonly|endlink|endmanonly|endmsc|endparblock|endrtfonly|endsecreflist|enduml|endverbatim|endxmlonly)\\b(?:\\{[^}]*\\})?`,
            name: `storage.type.class.doxygen.cpp`,
          }, { match: `(?:\\b[A-Z]+:|@[a-z_]+:)`, name: `storage.type.class.gtkdoc.cpp` }],
        },
        {
          captures: {
            1: { name: `punctuation.definition.comment.begin.documentation.cpp` },
            2: {
              patterns: [{
                match:
                  `(?<=[\\s*!\\/])[\\\\@](?:callergraph|callgraph|else|endif|f\\$|f\\[|f\\]|hidecallergraph|hidecallgraph|hiderefby|hiderefs|hideinitializer|htmlinclude|n|nosubgrouping|private|privatesection|protected|protectedsection|public|publicsection|pure|showinitializer|showrefby|showrefs|tableofcontents|\\$|\\#|<|>|%|"|\\.|=|::|\\||\\-\\-|\\-\\-\\-)\\b(?:\\{[^}]*\\})?`,
            ...
            3: { name: `punctuation.definition.comment.end.documentation.cpp` },
          },
          match: `(\\/\\*[!*]+(?=\\s))(.+)([!*]*\\*\\/)`,
        ...
        {
          begin: `(?:\\s+)?+\\/\\*[!*]+(?:(?:\\n|$)|(?=\\s))`,
          beginCaptures: { 0: { name: `punctuation.definition.comment.begin.documentation.cpp` } },
          end: `[!*]*\\*\\/`,
          endCaptures: { 0: { name: `punctuation.definition.comment.end.documentation.cpp` } },
          name: `comment.block.documentation.cpp`,
          patterns: [{
            match:
              `(?<=[\\s*!\\/])[\\\\@](?:callergraph|callgraph|else|endif|f\\$|f\\[|f\\]|hidecallergraph|hidecallgraph|hiderefby|hiderefs|hideinitializer|htmlinclude|n|nosubgrouping|private|privatesection|protected|protectedsection|public|publicsection|pure|showinitializer|showrefby|showrefs|tableofcontents|\\$|\\#|<|>|%|"|\\.|=|::|\\||\\-\\-|\\-\\-\\-)\\b(?:\\{[^}]*\\})?`,
    ...
    constructor_inline: {
      ...
      beginCaptures: {
        0: { name: `meta.head.function.definition.special.constructor.cpp` },
        1: { patterns: [{ include: `#inline_comment` }] },
        2: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        3: { name: `comment.block.cpp` },
        4: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        ...
        8: { name: `comment.block.cpp` },
        9: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        10: { name: `storage.type.modifier.calling-convention.cpp` },
        11: { patterns: [{ include: `#inline_comment` }] },
        12: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        13: { name: `comment.block.cpp` },
        14: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        15: { name: `entity.name.function.constructor.cpp entity.name.function.definition.special.constructor.cpp` },
      },
      end: `(?:(?<=\\}|%>|\\?\\?>)|(?=[;>\\[\\]=]))`,
      endCaptures: {},
      ...
      patterns: [{
        ...
        endCaptures: {
          0: { name: `punctuation.section.block.begin.bracket.curly.function.definition.special.constructor.cpp` },
        },
        ...
        patterns: [
          { include: `#ever_present_context` },
          {
            captures: {
              ...
              4: { name: `comment.block.cpp` },
              5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
              6: { name: `keyword.other.default.function.cpp keyword.other.default.constructor.cpp` },
              7: { name: `keyword.other.delete.function.cpp keyword.other.delete.constructor.cpp` },
            },
            match:
              `(\\=)((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))(?:(default)|(delete))`,
          },
          ...
          {
            begin: `:`,
            beginCaptures: { 0: { name: `punctuation.separator.initializers.cpp` } },
            end: `(?=\\{)`,
            endCaptures: {},
            patterns: [
              {
                begin:
                  `((?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w))(((?<!<)<(?!<)(?:(?:(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/)))|(?:"(?:[^"]*|\\\\")")|(?:'(?:[^']*|\\\\')')|\\g<3>|(?:(?:[^'"<>\\/]|\\/[^*])++))*>)\\s*+)?(\\()`,
                beginCaptures: {
                  1: { name: `entity.name.function.call.initializer.cpp` },
                  2: { name: `meta.template.call.cpp`, patterns: [{ include: `#template_call_range` }] },
                  3: {},
                  4: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
                  5: { name: `comment.block.cpp` },
                  6: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
                  7: { name: `punctuation.section.arguments.begin.bracket.round.function.call.initializer.cpp` },
                },
                contentName: `meta.parameter.initialization`,
                end: `\\)`,
                endCaptures: {
                  0: { name: `punctuation.section.arguments.end.bracket.round.function.call.initializer.cpp` },
                },
                patterns: [{ include: `#evaluation_context` }],
              },
              {
                ...
                beginCaptures: {
                  1: { name: `entity.name.function.call.initializer.cpp` },
                  2: { name: `punctuation.section.arguments.begin.bracket.round.function.call.initializer.cpp` },
                },
                contentName: `meta.parameter.initialization`,
                end: `\\}`,
                endCaptures: {
              ...
              { match: `,`, name: `punctuation.separator.delimiter.comma.cpp` },
              { include: `#comments` },
            ],
          },
          {
            begin: `\\(`,
            beginCaptures: {
              0: { name: `punctuation.section.parameters.begin.bracket.round.special.constructor.cpp` },
            },
            contentName: `meta.function.definition.parameters.special.constructor`,
            end: `\\)`,
            endCaptures: { 0: { name: `punctuation.section.parameters.end.bracket.round.special.constructor.cpp` } },
            patterns: [{ include: `#function_parameter_context` }, { include: `#evaluation_context` }],
          },
        ...
        endCaptures: {
          0: { name: `punctuation.section.block.end.bracket.curly.function.definition.special.constructor.cpp` },
        },
    ...
    constructor_root: {
      ...
      beginCaptures: {
        ...
        16: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        17: { name: `comment.block.cpp` },
        18: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        19: { patterns: [{ include: `#inline_comment` }] },
        20: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        21: { name: `comment.block.cpp` },
        22: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
      },
      end: `(?:(?<=\\}|%>|\\?\\?>)|(?=[;>\\[\\]=]))`,
      endCaptures: {},
      name: `meta.function.definition.special.constructor.cpp`,
      ...
      beginCaptures: {
        1: {
          ...
          patterns: [
            ...
            { match: `(?<!\\w)(?:(?:struct)|(?:class)|(?:union)|(?:enum))(?!\\w)`, name: `storage.type.$0.cpp` },
            { include: `#attributes_context` },
        ...
        2: { patterns: [{ include: `#attributes_context` }, { include: `#number_literal` }] },
        ...
        15: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        16: { name: `comment.block.cpp` },
        17: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        18: {},
        19: { patterns: [{ include: `#inline_comment` }] },
        20: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        21: { name: `comment.block.cpp` },
        22: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        23: { name: `punctuation.section.arguments.begin.bracket.curly.initializer.cpp` },
      },
      end: `\\}`,
      endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.curly.initializer.cpp` } },
      name: `meta.initialization.cpp`,
      patterns: [{ include: `#evaluation_context` }, { include: `#comma` }],
    },
          ...
          patterns: [{
            ...
            patterns: [{
              captures: {
                ...
                3: { name: `punctuation.separator.constant.numeric.cpp` },
                ...
                6: { name: `punctuation.separator.constant.numeric.cpp` },
                7: { name: `keyword.other.unit.exponent.hexadecimal.cpp` },
                8: { name: `keyword.operator.plus.exponent.hexadecimal.cpp` },
                9: { name: `keyword.operator.minus.exponent.hexadecimal.cpp` },
                10: {
                ...
                11: {
                  name:
                    `keyword.other.suffix.literal.built-in.floating-point.cpp keyword.other.unit.suffix.floating-point.cpp`,
                },
              },
              match:
                `(\\G0[xX])([0-9a-fA-F](?:[0-9a-fA-F]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)?((?:(?<=[0-9a-fA-F])\\.|\\.(?=[0-9a-fA-F])))([0-9a-fA-F](?:[0-9a-fA-F]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)?(?:(?<!')([pP])(\\+?)(\\-?)([0-9](?:[0-9]|(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))*))?([lLfF](?!\\w))?$`,
            }, {
              captures: {
                1: {
                ...
                2: { name: `punctuation.separator.constant.numeric.cpp` },
                ...
                5: { name: `punctuation.separator.constant.numeric.cpp` },
                6: { name: `keyword.other.unit.exponent.decimal.cpp` },
                7: { name: `keyword.operator.plus.exponent.decimal.cpp` },
                8: { name: `keyword.operator.minus.exponent.decimal.cpp` },
                9: {
              ...
              match:
                `\\G(?=[0-9.])(?!0[xXbB])([0-9](?:[0-9]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)?((?:(?<=[0-9])\\.|\\.(?=[0-9])))([0-9](?:[0-9]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)?(?:(?<!')([eE])(\\+?)(\\-?)([0-9](?:[0-9]|(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))*))?([lLfF](?!\\w))?$`,
            }, {
              captures: {
                ...
                3: { name: `punctuation.separator.constant.numeric.cpp` },
                4: { name: `keyword.other.suffix.literal.built-in.integer.cpp keyword.other.unit.suffix.integer.cpp` },
              },
              match:
                `(\\G0[bB])([01](?:[01]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)((?:[uU]|(?:[uU]ll?)|(?:[uU]LL?)|(?:ll?[uU]?)|(?:LL?[uU]?)|[fF])(?!\\w))?$`,
            }, {
              captures: {
              ...
              match:
                `(\\G0)((?:[0-7]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))+)((?:[uU]|(?:[uU]ll?)|(?:[uU]LL?)|(?:ll?[uU]?)|(?:LL?[uU]?)|[fF])(?!\\w))?$`,
            }, {
              captures: {
                1: { name: `keyword.other.unit.hexadecimal.cpp` },
                2: {
                ...
                3: { name: `punctuation.separator.constant.numeric.cpp` },
                4: { name: `keyword.other.unit.exponent.hexadecimal.cpp` },
                5: { name: `keyword.operator.plus.exponent.hexadecimal.cpp` },
                6: { name: `keyword.operator.minus.exponent.hexadecimal.cpp` },
                7: {
                  name: `constant.numeric.exponent.hexadecimal.cpp`,
                  patterns: [{
                    match: `(?<=[0-9a-fA-F])'(?=[0-9a-fA-F])`,
                ...
                8: { name: `keyword.other.suffix.literal.built-in.integer.cpp keyword.other.unit.suffix.integer.cpp` },
              },
              match:
                `(\\G0[xX])([0-9a-fA-F](?:[0-9a-fA-F]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)(?:(?<!')([pP])(\\+?)(\\-?)([0-9](?:[0-9]|(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))*))?((?:[uU]|(?:[uU]ll?)|(?:[uU]LL?)|(?:ll?[uU]?)|(?:LL?[uU]?)|[fF])(?!\\w))?$`,
            }, {
              captures: {
                1: {
                  name: `constant.numeric.decimal.cpp`,
                ...
                7: { name: `keyword.other.suffix.literal.built-in.integer.cpp keyword.other.unit.suffix.integer.cpp` },
              },
              match:
                `\\G(?=[0-9.])(?!0[xXbB])([0-9](?:[0-9]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)(?:(?<!')([eE])(\\+?)(\\-?)([0-9](?:[0-9]|(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))*))?((?:[uU]|(?:[uU]ll?)|(?:[uU]LL?)|(?:ll?[uU]?)|(?:LL?[uU]?)|[fF])(?!\\w))?$`,
            }, { match: `(?:(?:[0-9a-zA-Z_\\.]|')|(?<=[eEpP])[+-])+`, name: `invalid.illegal.constant.numeric.cpp` }],
          }],
        },
      },
    ...
    decltype: {
      ...
      beginCaptures: {
        1: { name: `keyword.operator.functionlike.cpp keyword.other.decltype.cpp storage.type.decltype.cpp` },
        2: { patterns: [{ include: `#inline_comment` }] },
        3: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        4: { name: `comment.block.cpp` },
        5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        6: { name: `punctuation.section.arguments.begin.bracket.round.decltype.cpp` },
      },
      contentName: `meta.arguments.decltype`,
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.decltype.cpp` } },
      patterns: [{ include: `#evaluation_context` }],
    },
    decltype_specifier: {
      begin:
    ...
    default_statement: {
      ...
      endCaptures: { 0: { name: `punctuation.separator.colon.case.default.cpp` } },
      name: `meta.conditional.case.cpp`,
      patterns: [{ include: `#evaluation_context` }],
    },
    destructor_inline: {
      begin:
        `^((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))((?:__cdecl|__clrcall|__stdcall|__fastcall|__thiscall|__vectorcall)?)((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))((?:(?:(?:constexpr)|(?:consteval)|(?:explicit)|(?:mutable)|(?:virtual)|(?:inline)|(?:friend))((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z)))*)(~(?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w)(?=\\())`,
      beginCaptures: {
        0: { name: `meta.head.function.definition.special.member.destructor.cpp` },
        1: { patterns: [{ include: `#inline_comment` }] },
        2: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        3: { name: `comment.block.cpp` },
        4: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        ...
        8: { name: `comment.block.cpp` },
        9: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        10: { patterns: [{ include: `#functional_specifiers_pre_parameters` }] },
        11: { patterns: [{ include: `#inline_comment` }] },
        12: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        13: { name: `comment.block.cpp` },
        14: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
      ...
      patterns: [{
        ...
        patterns: [
          { include: `#ever_present_context` },
          {
            captures: {
              ...
              6: {
                name:
                  `keyword.other.default.function.cpp keyword.other.default.constructor.cpp keyword.other.default.destructor.cpp`,
              },
              7: {
                name:
                  `keyword.other.delete.function.cpp keyword.other.delete.constructor.cpp keyword.other.delete.destructor.cpp`,
              },
            },
            match:
              `(\\=)((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))(?:(default)|(delete))`,
          },
          {
            begin: `\\(`,
            beginCaptures: {
              0: { name: `punctuation.section.parameters.begin.bracket.round.special.member.destructor.cpp` },
            },
            contentName: `meta.function.definition.parameters.special.member.destructor`,
            end: `\\)`,
            endCaptures: {
              0: { name: `punctuation.section.parameters.end.bracket.round.special.member.destructor.cpp` },
            },
            patterns: [],
          },
          { include: `#qualifiers_and_specifiers_post_parameters` },
        ...
        endCaptures: {
          0: { name: `punctuation.section.block.end.bracket.curly.function.definition.special.member.destructor.cpp` },
        },
    ...
    destructor_root: {
      ...
      beginCaptures: {
        ...
        24: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        25: { name: `comment.block.cpp` },
        26: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
      },
      end: `(?:(?<=\\}|%>|\\?\\?>)|(?=[;>\\[\\]=]))`,
      endCaptures: {},
      name: `meta.function.definition.special.member.destructor.cpp`,
    ...
    diagnostic: {
      ...
      patterns: [{ include: `#comments` }, {
        ...
        endCaptures: { 1: { name: `punctuation.definition.string.end.cpp` } },
        name: `string.quoted.double.cpp`,
        patterns: [{ include: `#line_continuation_character` }],
      }, {
        begin: `'`,
        ...
        patterns: [{ include: `#line_continuation_character` }, { include: `#comments` }],
      }],
    },
    emacs_file_banner: {
      captures: {
    ...
    empty_square_brackets: { match: `(?<!delete)\\[(?:\\s+)?\\]`, name: `storage.modifier.array.bracket.square` },
    enum_block: {
      begin:
      ...
      beginCaptures: {
        ...
        3: { patterns: [{ include: `#attributes_context` }, { include: `#number_literal` }] },
        4: { name: `entity.name.type.enum.cpp` },
        5: { name: `punctuation.separator.colon.type-specifier.cpp` },
        6: { patterns: [{ include: `#scope_resolution_inner_generated` }] },
        7: { name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.cpp` },
        ...
        14: { name: `comment.block.cpp` },
        15: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        16: { name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.cpp` },
        17: { name: `storage.type.integral.$17.cpp` },
      },
      end: `(?:(?:(?<=\\}|%>|\\?\\?>)(?:\\s+)?(;)|(;))|(?=[;>\\[\\]=]))`,
      endCaptures: {
        1: { name: `punctuation.terminator.statement.cpp` },
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.enum.cpp` } },
        ...
        endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.enum.cpp` } },
        name: `meta.body.enum.cpp`,
        patterns: [{ include: `#ever_present_context` }, { include: `#enumerator_list` }, { include: `#comments` }, {
          include: `#comma`,
        }, { include: `#semicolon` }],
      }, {
        begin: `(?<=\\}|%>|\\?\\?>)[\\s]*`,
    ...
    enumerator_list: {
      captures: {
        ...
        5: { patterns: [{ include: `#comma` }, { include: `#semicolon` }] },
      },
      match:
        `((?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w))(?:\\s+)?((?:(?:(?:\\[\\[.*?\\]\\]|__attribute(?:__)?\\s*\\(\\s*\\(.*?\\)\\s*\\))|__declspec\\(.*?\\))|alignas\\(.*?\\))(?!\\)))?(?:\\s+)?(?:(\\=)(?:\\s+)?(.+?)(?:\\s+)?)?(?:(?:((?:[,;](?!')|\\n))|(?=\\}[^']))|(?=(?:\\/\\/|\\/\\*)))`,
    ...
    extern_block: {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.extern.cpp` } },
        ...
        endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.extern.cpp` } },
    ...
    function_call: {
      ...
      beginCaptures: {
        ...
        13: { name: `comment.block.cpp` },
        14: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        15: { name: `punctuation.section.arguments.begin.bracket.round.function.call.cpp` },
      },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.function.call.cpp` } },
      patterns: [{ include: `#evaluation_context` }],
    },
    function_definition: {
      begin:
      ...
      beginCaptures: {
        ...
        7: {
          patterns: [{
            ...
            match:
              `((?<!\\w)(?:(?:(?:constexpr)|(?:consteval)|(?:explicit)|(?:mutable)|(?:virtual)|(?:inline)|(?:friend))|(?:(?:thread_local)|(?:volatile)|(?:register)|(?:restrict)|(?:static)|(?:extern)|(?:const)))(?!\\w))((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))`,
          }],
        },
        8: { name: `storage.modifier.$8.cpp` },
        9: { patterns: [{ include: `#inline_comment` }] },
        10: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        11: { name: `comment.block.cpp` },
        12: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        13: {
          name: `meta.qualified_type.cpp`,
          patterns: [
            {
        ...
        14: { patterns: [{ include: `#attributes_context` }, { include: `#number_literal` }] },
        15: { patterns: [{ include: `#inline_comment` }] },
        16: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        17: { name: `comment.block.cpp` },
        18: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        ...
        27: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        28: { name: `comment.block.cpp` },
        29: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        30: {},
        31: {
          patterns: [{ match: `\\*`, name: `storage.modifier.pointer.cpp` }, {
            captures: {
        ...
        33: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        34: { name: `comment.block.cpp` },
        35: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        36: { patterns: [{ include: `#inline_comment` }] },
        37: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        38: { name: `comment.block.cpp` },
        39: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        40: { patterns: [{ include: `#inline_comment` }] },
        41: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        42: { name: `comment.block.cpp` },
        43: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        44: { name: `storage.type.modifier.calling-convention.cpp` },
        45: { patterns: [{ include: `#inline_comment` }] },
        46: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        47: { name: `comment.block.cpp` },
        48: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        49: { patterns: [{ include: `#scope_resolution_function_definition_inner_generated` }] },
        50: {
          name:
            `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.function.definition.cpp`,
        },
        51: { patterns: [{ include: `#template_call_range` }] },
        52: {},
        53: { name: `entity.name.function.definition.cpp` },
        54: { patterns: [{ include: `#inline_comment` }] },
        55: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        56: { name: `comment.block.cpp` },
        57: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
      },
      end: `(?:(?<=\\}|%>|\\?\\?>)|(?=[;>\\[\\]=]))`,
      endCaptures: {},
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.function.definition.cpp` } },
        name: `meta.head.function.definition.cpp`,
        patterns: [{ include: `#ever_present_context` }, {
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.section.parameters.begin.bracket.round.cpp` } },
          contentName: `meta.function.definition.parameters`,
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.section.parameters.end.bracket.round.cpp` } },
          patterns: [{ include: `#ever_present_context` }, { include: `#parameter_or_maybe_value` }, {
            include: `#comma`,
          }, { include: `#evaluation_context` }],
        }, {
          captures: {
            1: { name: `punctuation.definition.function.return-type.cpp` },
            2: { patterns: [{ include: `#inline_comment` }] },
            3: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
            4: { name: `comment.block.cpp` },
            5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
            ...
            7: { patterns: [{ include: `#attributes_context` }, { include: `#number_literal` }] },
            8: { patterns: [{ include: `#inline_comment` }] },
            9: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
            10: { name: `comment.block.cpp` },
            11: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
            12: { patterns: [{ include: `#inline_comment` }] },
            13: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
            14: { name: `comment.block.cpp` },
            15: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        ...
        endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.function.definition.cpp` } },
    ...
    function_parameter_context: {
      patterns: [{ include: `#ever_present_context` }, { include: `#parameter` }, { include: `#comma` }],
    },
    function_pointer: {
      begin:
      ...
      beginCaptures: {
        ...
        20: { patterns: [{ include: `#inline_comment` }] },
        21: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        22: { name: `comment.block.cpp` },
        23: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        24: { patterns: [{ include: `#inline_comment` }] },
        25: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        26: { name: `comment.block.cpp` },
        27: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        28: { patterns: [{ include: `#inline_comment` }] },
        29: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        30: { name: `comment.block.cpp` },
        31: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        32: { name: `punctuation.section.parens.begin.bracket.round.function.pointer.cpp` },
        33: { name: `punctuation.definition.function.pointer.dereference.cpp` },
        ...
        38: { name: `punctuation.section.parens.end.bracket.round.function.pointer.cpp` },
        39: { name: `punctuation.section.parameters.begin.bracket.round.function.pointer.cpp` },
      },
      end:
        `(\\))((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))(?=[{=,);>]|\\n)(?!\\()`,
      endCaptures: {
        1: { name: `punctuation.section.parameters.end.bracket.round.function.pointer.cpp` },
        2: { patterns: [{ include: `#inline_comment` }] },
        3: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        4: { name: `comment.block.cpp` },
        5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
    ...
    functional_specifiers_pre_parameters: {
      match:
        `(?<!\\w)(?:(?:constexpr)|(?:consteval)|(?:explicit)|(?:mutable)|(?:virtual)|(?:inline)|(?:friend))(?!\\w)`,
    ...
    goto_statement: {
      captures: {
        ...
        3: { name: `keyword.control.goto.cpp` },
        ...
        6: { name: `entity.name.label.call.cpp` },
      },
      match:
    ...
    inheritance_context: {
      patterns: [
        { include: `#ever_present_context` },
        { match: `,`, name: `punctuation.separator.delimiter.comma.inheritance.cpp` },
        {
          match: `(?<!\\w)(?:(?:protected)|(?:private)|(?:public))(?!\\w)`,
          name: `storage.type.modifier.access.$0.cpp`,
        },
        { match: `(?<!\\w)virtual(?!\\w)`, name: `storage.type.modifier.virtual.cpp` },
        {
          captures: {
            1: {
              name: `meta.qualified_type.cpp`,
    ...
    invalid_comment_end: { match: `\\*\\/`, name: `invalid.illegal.unexpected.punctuation.definition.comment.end.cpp` },
    label: {
      captures: {
        1: { patterns: [{ include: `#inline_comment` }] },
        2: {
    ...
    lambdas: {
      ...
      beginCaptures: {
        ...
        2: {
          ...
          patterns: [{ include: `#the_this_keyword` }, {
            ...
            match:
              `((?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*)((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))(?:(?:(?=\\]|\\z|$)|(,))|(\\=))`,
          }, { include: `#evaluation_context` }],
        },
        3: {},
        4: { name: `punctuation.definition.capture.end.lambda.cpp` },
        5: { patterns: [{ include: `#inline_comment` }] },
        6: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
      ...
      patterns: [{
        begin: `\\(`,
        beginCaptures: { 0: { name: `punctuation.definition.parameters.begin.lambda.cpp` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.parameters.end.lambda.cpp` } },
        ...
        begin: `->`,
        beginCaptures: { 0: { name: `punctuation.definition.lambda.return-type.cpp` } },
        end: `(?=\\{)`,
        endCaptures: {},
        patterns: [{ include: `#comments` }, { match: `\\S+`, name: `storage.type.return-type.lambda.cpp` }],
      }, {
        begin: `\\{`,
        beginCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.lambda.cpp` } },
        end: `\\}`,
        endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.lambda.cpp` } },
    ...
    line: {
      ...
      patterns: [{ include: `#string_context` }, { include: `#preprocessor_number_literal` }, {
        include: `#line_continuation_character`,
      }],
    },
    line_comment: {
      begin: `\\s*+(\\/\\/)`,
      beginCaptures: { 1: { name: `punctuation.definition.comment.cpp` } },
      end: `(?<!\\\\)(?:(?=\\n)|(?<=^\\n|[^\\\\]\\n)(?=$))`,
      endCaptures: {},
      name: `comment.line.double-slash.cpp`,
      patterns: [{ include: `#line_continuation_character` }],
    },
    line_continuation_character: { match: `\\\\\\n`, name: `constant.character.escape.line-continuation.cpp` },
    macro: {
      begin:
      ...
      patterns: [
        {
          captures: {
            1: { name: `punctuation.definition.parameters.begin.preprocessor.cpp` },
            2: {
              name: `meta.function.preprocessor.parameters.cpp`,
              patterns: [
                {
                  captures: { 1: { name: `variable.parameter.preprocessor.cpp` } },
                  match:
                    `(?<=[(,])(?:\\s+)?((?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*)(?:\\s+)?`,
                },
                { match: `,`, name: `punctuation.separator.parameters.cpp` },
                { match: `\\.\\.\\.`, name: `punctuation.vararg-ellipses.variable.parameter.preprocessor.cpp` },
              ],
            },
            3: { name: `punctuation.definition.parameters.end.preprocessor.cpp` },
          },
          match: `\\G(?:\\s+)?(\\()([^\\(]*)(\\))`,
        },
    ...
    macro_argument: {
      match:
        `##?(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w)`,
      name: `variable.other.macro.argument.cpp`,
    },
    macro_context: { patterns: [{ include: `source.cpp.embedded.macro` }] },
    macro_name: {
      match:
        `(?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w)`,
    ...
    method_access: {
      ...
      beginCaptures: {
        ...
        11: { name: `punctuation.section.arguments.begin.bracket.round.function.member.cpp` },
      },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.function.member.cpp` } },
      patterns: [{ include: `#evaluation_context` }],
    },
    misc_keywords: {
      captures: {
    ...
    namespace_alias: {
      captures: {
        1: { name: `keyword.other.namespace.alias.cpp storage.type.namespace.alias.cpp` },
        2: { name: `entity.name.namespace.alias.cpp` },
        3: { name: `keyword.operator.assignment.cpp` },
        4: { name: `meta.declaration.namespace.alias.value.cpp` },
        5: { patterns: [{ include: `#scope_resolution_namespace_alias_inner_generated` }] },
        6: {
    ...
    namespace_block: {
      ...
      beginCaptures: {
        ...
        1: { name: `keyword.other.namespace.definition.cpp storage.type.namespace.definition.cpp` },
      },
      end: `(?:(?<=\\}|%>|\\?\\?>)|(?=[;>\\[\\]=]))`,
      endCaptures: {},
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.namespace.cpp` } },
        name: `meta.head.namespace.cpp`,
        patterns: [{ include: `#ever_present_context` }, { include: `#attributes_context` }, {
          captures: {
            1: { patterns: [{ include: `#scope_resolution_namespace_block_inner_generated` }] },
            2: {
              name:
                `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.namespace.block.cpp`,
            },
            3: { patterns: [{ include: `#template_call_range` }] },
            4: {},
            5: { name: `entity.name.namespace.cpp` },
            6: { name: `punctuation.separator.scope-resolution.namespace.block.cpp` },
        ...
        endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.namespace.cpp` } },
    ...
    noexcept_operator: {
      begin:
        `((?<!\\w)noexcept(?!\\w))((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))(\\()`,
      beginCaptures: {
        1: { name: `keyword.operator.functionlike.cpp keyword.operator.noexcept.cpp` },
        2: { patterns: [{ include: `#inline_comment` }] },
        3: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        4: { name: `comment.block.cpp` },
        5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        6: { name: `punctuation.section.arguments.begin.bracket.round.operator.noexcept.cpp` },
      },
      contentName: `meta.arguments.operator.noexcept`,
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.operator.noexcept.cpp` } },
      patterns: [{ include: `#evaluation_context` }],
    },
    number_literal: {
      captures: {
        0: {
          patterns: [{
            ...
            patterns: [{
              ...
              match:
                `(\\G0[xX])([0-9a-fA-F](?:[0-9a-fA-F]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)?((?:(?<=[0-9a-fA-F])\\.|\\.(?=[0-9a-fA-F])))([0-9a-fA-F](?:[0-9a-fA-F]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)?(?:(?<!')([pP])(\\+?)(\\-?)([0-9](?:[0-9]|(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))*))?([lLfF](?!\\w))?((?:\\w(?<![0-9a-fA-FpP])\\w*)?$)`,
            }, {
              captures: {
                1: {
                  name: `constant.numeric.decimal.cpp`,
              ...
              match:
                `\\G(?=[0-9.])(?!0[xXbB])([0-9](?:[0-9]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)?((?:(?<=[0-9])\\.|\\.(?=[0-9])))([0-9](?:[0-9]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)?(?:(?<!')([eE])(\\+?)(\\-?)([0-9](?:[0-9]|(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))*))?([lLfF](?!\\w))?((?:\\w(?<![0-9eE])\\w*)?$)`,
            }, {
              captures: {
                1: { name: `keyword.other.unit.binary.cpp` },
                2: {
              ...
              match:
                `(\\G0[bB])([01](?:[01]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)((?:[uU]|(?:[uU]ll?)|(?:[uU]LL?)|(?:ll?[uU]?)|(?:LL?[uU]?)|[fF])(?!\\w))?((?:\\w(?<![0-9])\\w*)?$)`,
            }, {
              captures: {
                1: { name: `keyword.other.unit.octal.cpp` },
                2: {
              ...
              match:
                `(\\G0)((?:[0-7]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))+)((?:[uU]|(?:[uU]ll?)|(?:[uU]LL?)|(?:ll?[uU]?)|(?:LL?[uU]?)|[fF])(?!\\w))?((?:\\w(?<![0-9])\\w*)?$)`,
            }, {
              captures: {
                1: { name: `keyword.other.unit.hexadecimal.cpp` },
                2: {
              ...
              match:
                `(\\G0[xX])([0-9a-fA-F](?:[0-9a-fA-F]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)(?:(?<!')([pP])(\\+?)(\\-?)([0-9](?:[0-9]|(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))*))?((?:[uU]|(?:[uU]ll?)|(?:[uU]LL?)|(?:ll?[uU]?)|(?:LL?[uU]?)|[fF])(?!\\w))?((?:\\w(?<![0-9a-fA-FpP])\\w*)?$)`,
            }, {
              captures: {
                1: {
                  name: `constant.numeric.decimal.cpp`,
              ...
              match:
                `\\G(?=[0-9.])(?!0[xXbB])([0-9](?:[0-9]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F])))*)(?:(?<!')([eE])(\\+?)(\\-?)([0-9](?:[0-9]|(?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))*))?((?:[uU]|(?:[uU]ll?)|(?:[uU]LL?)|(?:ll?[uU]?)|(?:LL?[uU]?)|[fF])(?!\\w))?((?:\\w(?<![0-9eE])\\w*)?$)`,
            }, { match: `(?:(?:[0-9a-zA-Z_\\.]|')|(?<=[eEpP])[+-])+`, name: `invalid.illegal.constant.numeric.cpp` }],
          }],
        },
      },
    ...
    operator_overload: {
      ...
      beginCaptures: {
        0: { name: `meta.head.function.definition.special.operator-overload.cpp` },
        1: { patterns: [{ include: `#inline_comment` }] },
        2: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        3: { name: `comment.block.cpp` },
        4: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        ...
        17: {},
        18: { patterns: [{ include: `#inline_comment` }] },
        19: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        20: { name: `comment.block.cpp` },
        21: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        22: {},
        23: {
          patterns: [{ match: `\\*`, name: `storage.modifier.pointer.cpp` }, {
            captures: {
        ...
        38: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        39: { name: `comment.block.cpp` },
        40: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        41: { patterns: [{ include: `#inline_comment` }] },
        42: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        43: { name: `comment.block.cpp` },
        44: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        45: {
          patterns: [{
            match: `::`,
        ...
        50: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        51: { name: `comment.block.cpp` },
        52: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        53: {
          patterns: [{
            match: `::`,
            name:
              `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.operator-overload.cpp`,
          }, {
            match:
              `(?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w)`,
        ...
        58: {
          patterns: [{ match: `\\*`, name: `entity.name.operator.type.pointer.cpp` }, {
            captures: {
              1: { patterns: [{ include: `#inline_comment` }] },
              2: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
              3: { name: `comment.block.cpp` },
            ...
            match:
              `(?:\\&((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))){2,}\\&`,
            name: `invalid.illegal.reference-type.cpp`,
          }, { match: `\\&`, name: `entity.name.operator.type.reference.cpp` }],
        },
        59: { patterns: [{ include: `#inline_comment` }] },
        60: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        61: { name: `comment.block.cpp` },
        62: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        63: { patterns: [{ include: `#inline_comment` }] },
        64: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        65: { name: `comment.block.cpp` },
        66: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        67: { patterns: [{ include: `#inline_comment` }] },
        68: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        69: { name: `comment.block.cpp` },
        70: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        ...
        74: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        75: { name: `comment.block.cpp` },
        76: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        77: { name: `entity.name.operator.custom-literal.cpp` },
        78: { patterns: [{ include: `#inline_comment` }] },
        79: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        80: { name: `comment.block.cpp` },
        81: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
      },
      end: `(?:(?<=\\}|%>|\\?\\?>)|(?=[;>\\[\\]=]))`,
      endCaptures: {},
      ...
      patterns: [{
        ...
        patterns: [
          ...
          { include: `#template_call_range` },
          {
            begin: `\\(`,
            beginCaptures: {
              0: { name: `punctuation.section.parameters.begin.bracket.round.special.operator-overload.cpp` },
            },
            contentName: `meta.function.definition.parameters.special.operator-overload`,
            end: `\\)`,
            endCaptures: {
              0: { name: `punctuation.section.parameters.end.bracket.round.special.operator-overload.cpp` },
            },
            patterns: [{ include: `#function_parameter_context` }, { include: `#evaluation_context` }],
          },
          { include: `#qualifiers_and_specifiers_post_parameters` },
          {
            captures: {
              ...
              4: { name: `comment.block.cpp` },
              5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
              6: { name: `keyword.other.default.function.cpp` },
              7: { name: `keyword.other.delete.function.cpp` },
            },
            match:
              `(\\=)((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))(?:(default)|(delete))`,
          },
        ...
        endCaptures: {
          0: { name: `punctuation.section.block.end.bracket.curly.function.definition.special.operator-overload.cpp` },
        },
    ...
    operators: {
      patterns: [
        {
          begin:
            `((?<!\\w)sizeof(?!\\w))((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))(\\()`,
          beginCaptures: {
            1: { name: `keyword.operator.functionlike.cpp keyword.operator.sizeof.cpp` },
            2: { patterns: [{ include: `#inline_comment` }] },
            3: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
            4: { name: `comment.block.cpp` },
            5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
            6: { name: `punctuation.section.arguments.begin.bracket.round.operator.sizeof.cpp` },
          },
          contentName: `meta.arguments.operator.sizeof`,
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.operator.sizeof.cpp` } },
          patterns: [{ include: `#evaluation_context` }],
        },
        {
          begin:
        ...
        },
        {
          ...
          beginCaptures: {
            1: { name: `keyword.operator.functionlike.cpp keyword.operator.typeid.cpp` },
            2: { patterns: [{ include: `#inline_comment` }] },
            3: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
            4: { name: `comment.block.cpp` },
            5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
            6: { name: `punctuation.section.arguments.begin.bracket.round.operator.typeid.cpp` },
          },
          contentName: `meta.arguments.operator.typeid`,
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.operator.typeid.cpp` } },
          patterns: [{ include: `#evaluation_context` }],
        },
        {
          begin:
        ...
        },
        {
          begin:
            `(\\bsizeof\\.\\.\\.)((?:(?:(?:\\s*+(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/))\\s*+)+)|(?:\\s++)|(?<=\\W)|(?=\\W)|^|(?:\\n?$)|\\A|\\Z))(\\()`,
          beginCaptures: {
            1: { name: `keyword.operator.functionlike.cpp keyword.operator.sizeof.variadic.cpp` },
            2: { patterns: [{ include: `#inline_comment` }] },
            3: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
            4: { name: `comment.block.cpp` },
            5: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
            6: { name: `punctuation.section.arguments.begin.bracket.round.operator.sizeof.variadic.cpp` },
          },
          contentName: `meta.arguments.operator.sizeof.variadic`,
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.operator.sizeof.variadic.cpp` } },
          patterns: [{ include: `#evaluation_context` }],
        },
        { match: `--`, name: `keyword.operator.decrement.cpp` },
        { match: `\\+\\+`, name: `keyword.operator.increment.cpp` },
        { match: `%=|\\+=|-=|\\*=|(?<!\\()\\/=`, name: `keyword.operator.assignment.compound.cpp` },
        { match: `&=|\\^=|<<=|>>=|\\|=`, name: `keyword.operator.assignment.compound.bitwise.cpp` },
        ...
        { match: `&|\\||\\^|~`, name: `keyword.operator.bitwise.cpp` },
        { include: `#assignment_operator` },
        { match: `%|\\*|\\/|-|\\+`, name: `keyword.operator.arithmetic.cpp` },
    ...
    parameter: {
      ...
      endCaptures: { 1: { name: `punctuation.separator.delimiter.comma.cpp` } },
      ...
      patterns: [
        ...
        { include: `#vararg_ellipses` },
        {
          captures: {
            ...
            9: { name: `comment.block.cpp` },
            10: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
            11: { name: `storage.type.primitive.cpp storage.type.built-in.primitive.cpp` },
            12: { name: `storage.type.cpp storage.type.built-in.cpp` },
            13: { name: `support.type.posix-reserved.pthread.cpp support.type.built-in.posix-reserved.pthread.cpp` },
            14: { name: `support.type.posix-reserved.cpp support.type.built-in.posix-reserved.cpp` },
        ...
        { match: `(?:(?:struct)|(?:class)|(?:union)|(?:enum))`, name: `storage.type.$0.cpp` },
        {
          begin: `(?<==)`,
          beginCaptures: {},
          end: `(?:(?=\\))|(,))`,
        ...
        {
          begin: `\\[`,
          beginCaptures: { 0: { name: `punctuation.definition.begin.bracket.square.array.type.cpp` } },
          end: `\\]`,
          endCaptures: { 0: { name: `punctuation.definition.end.bracket.square.array.type.cpp` } },
          name: `meta.bracket.square.array.cpp`,
          patterns: [{ include: `#evaluation_context` }],
        },
        {
          match:
            `(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*\\b(?<!\\Wstruct|^struct|\\Wclass|^class|\\Wunion|^union|\\Wenum|^enum)`,
    ...
    parentheses: {
      begin: `\\(`,
      beginCaptures: { 0: { name: `punctuation.section.parens.begin.bracket.round.cpp` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.parens.end.bracket.round.cpp` } },
      name: `meta.parens.cpp`,
      patterns: [{ include: `#over_qualified_types` }, {
        match: `(?<!:):(?!:)`,
    ...
    pragma: {
      ...
      patterns: [
        { include: `#comments` },
        { include: `#string_context` },
        { match: `[a-zA-Z_$][\\w\\-$]*`, name: `entity.other.attribute-name.pragma.preprocessor.cpp` },
    ...
    predefined_macros: {
      patterns: [{
        captures: { 1: { name: `entity.name.other.preprocessor.macro.predefined.$1.cpp` } },
        match:
      ...
      }, { match: `\\b__([A-Z_]+)__\\b`, name: `entity.name.other.preprocessor.macro.predefined.probably.$1.cpp` }],
    },
    ...
    preprocessor_conditional_defined: {
      ...
      endCaptures: { 0: { name: `punctuation.section.parens.control.defined.cpp` } },
    ...
    qualified_type: {
      captures: {
        ...
        1: { patterns: [{ include: `#attributes_context` }, { include: `#number_literal` }] },
        2: { patterns: [{ include: `#inline_comment` }] },
        3: {
          patterns: [{
            captures: {
        ...
        1: {
          patterns: [{
            captures: {
              ...
              3: { name: `comment.block.cpp` },
              4: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
              5: { name: `storage.modifier.specifier.functional.post-parameters.$5.cpp` },
            },
            match:
    ...
    scope_resolution: {
      captures: {
        0: { patterns: [{ include: `#scope_resolution_inner_generated` }] },
        1: { name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.cpp` },
    ...
    scope_resolution_function_call: {
      captures: {
        0: { patterns: [{ include: `#scope_resolution_function_call_inner_generated` }] },
        1: {
          name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.function.call.cpp`,
        },
        2: { patterns: [{ include: `#template_call_range` }] },
    ...
    scope_resolution_function_call_inner_generated: {
      captures: {
        ...
        6: { name: `meta.template.call.cpp`, patterns: [{ include: `#template_call_range` }] },
        7: {},
        8: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        9: { name: `comment.block.cpp` },
        10: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
    ...
    scope_resolution_function_definition: {
      captures: {
        0: { patterns: [{ include: `#scope_resolution_function_definition_inner_generated` }] },
        1: {
          name:
            `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.function.definition.cpp`,
        },
    ...
    scope_resolution_function_definition_inner_generated: {
      captures: {
        1: { patterns: [{ include: `#scope_resolution_function_definition_inner_generated` }] },
        2: {
          name:
            `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.function.definition.cpp`,
        },
    ...
    scope_resolution_function_definition_operator_overload: {
      captures: {
        0: { patterns: [{ include: `#scope_resolution_function_definition_operator_overload_inner_generated` }] },
        1: {
          name:
            `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.function.definition.operator-overload.cpp`,
        },
        2: { patterns: [{ include: `#template_call_range` }] },
      },
      match:
    ...
    scope_resolution_function_definition_operator_overload_inner_generated: {
      captures: {
        1: { patterns: [{ include: `#scope_resolution_function_definition_operator_overload_inner_generated` }] },
        2: {
          name:
            `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.function.definition.operator-overload.cpp`,
        },
        3: { patterns: [{ include: `#template_call_range` }] },
        4: {},
        5: { name: `entity.name.scope-resolution.function.definition.operator-overload.cpp` },
        6: { name: `meta.template.call.cpp`, patterns: [{ include: `#template_call_range` }] },
        7: {},
        8: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        9: { name: `comment.block.cpp` },
    ...
    scope_resolution_inner_generated: {
      captures: {
        1: { patterns: [{ include: `#scope_resolution_inner_generated` }] },
        2: { name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.cpp` },
        3: { patterns: [{ include: `#template_call_range` }] },
        4: {},
        ...
        9: { name: `comment.block.cpp` },
        10: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        11: { name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.cpp` },
      },
      match:
        `((::)?(?:(?!\\b(?:__has_cpp_attribute|reinterpret_cast|atomic_noexcept|atomic_commit|atomic_cancel|__has_include|thread_local|dynamic_cast|synchronized|static_cast|const_cast|consteval|co_return|protected|constinit|constexpr|co_return|consteval|namespace|constexpr|constexpr|co_await|explicit|volatile|noexcept|co_yield|noexcept|noexcept|requires|typename|decltype|operator|template|continue|co_await|co_yield|volatile|register|restrict|reflexpr|mutable|alignof|include|private|defined|typedef|_Pragma|__asm__|concept|mutable|warning|default|virtual|alignas|public|sizeof|delete|not_eq|bitand|and_eq|xor_eq|typeid|switch|return|struct|static|extern|inline|friend|ifndef|define|pragma|export|import|module|catch|throw|const|or_eq|compl|while|ifdef|const|bitor|union|class|undef|error|break|using|endif|goto|line|enum|this|case|else|elif|else|not|try|for|asm|and|xor|new|do|if|or|if)\\b)(?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w)\\s*+(((?<!<)<(?!<)(?:(?:\\/\\*(?:[^\\*]++|\\*+(?!\\/))*+\\*\\/)|(?:"(?:[^"]*|\\\\")")|(?:'(?:[^']*|\\\\')')|\\g<7>|(?:(?:[^'"<>\\/]|\\/[^*])++))*>)\\s*+)?::)*\\s*+)((?!\\b(?:__has_cpp_attribute|reinterpret_cast|atomic_noexcept|atomic_commit|atomic_cancel|__has_include|thread_local|dynamic_cast|synchronized|static_cast|const_cast|consteval|co_return|protected|constinit|constexpr|co_return|consteval|namespace|constexpr|constexpr|co_await|explicit|volatile|noexcept|co_yield|noexcept|noexcept|requires|typename|decltype|operator|template|continue|co_await|co_yield|volatile|register|restrict|reflexpr|mutable|alignof|include|private|defined|typedef|_Pragma|__asm__|concept|mutable|warning|default|virtual|alignas|public|sizeof|delete|not_eq|bitand|and_eq|xor_eq|typeid|switch|return|struct|static|extern|inline|friend|ifndef|define|pragma|export|import|module|catch|throw|const|or_eq|compl|while|ifdef|const|bitor|union|class|undef|error|break|using|endif|goto|line|enum|this|case|else|elif|else|not|try|for|asm|and|xor|new|do|if|or|if)\\b)(?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w))\\s*+(((?<!<)<(?!<)(?:(?:(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/)))|(?:"(?:[^"]*|\\\\")")|(?:'(?:[^']*|\\\\')')|\\g<7>|(?:(?:[^'"<>\\/]|\\/[^*])++))*>)\\s*+)?(::)`,
    },
    scope_resolution_namespace_alias: {
      captures: {
        0: { patterns: [{ include: `#scope_resolution_namespace_alias_inner_generated` }] },
        1: {
          name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.namespace.alias.cpp`,
        },
        2: { patterns: [{ include: `#template_call_range` }] },
    ...
    scope_resolution_namespace_alias_inner_generated: {
      captures: {
        1: { patterns: [{ include: `#scope_resolution_namespace_alias_inner_generated` }] },
        2: {
          name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.namespace.alias.cpp`,
        },
        3: { patterns: [{ include: `#template_call_range` }] },
    ...
    scope_resolution_namespace_block: {
      captures: {
        0: { patterns: [{ include: `#scope_resolution_namespace_block_inner_generated` }] },
        1: {
    ...
    scope_resolution_parameter: {
      captures: {
        0: { patterns: [{ include: `#scope_resolution_parameter_inner_generated` }] },
        1: { name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.parameter.cpp` },
        2: { patterns: [{ include: `#template_call_range` }] },
      },
      match:
        `(::)?(?:(?!\\b(?:__has_cpp_attribute|reinterpret_cast|atomic_noexcept|atomic_commit|atomic_cancel|__has_include|thread_local|dynamic_cast|synchronized|static_cast|const_cast|consteval|co_return|protected|constinit|constexpr|co_return|consteval|namespace|constexpr|constexpr|co_await|explicit|volatile|noexcept|co_yield|noexcept|noexcept|requires|typename|decltype|operator|template|continue|co_await|co_yield|volatile|register|restrict|reflexpr|mutable|alignof|include|private|defined|typedef|_Pragma|__asm__|concept|mutable|warning|default|virtual|alignas|public|sizeof|delete|not_eq|bitand|and_eq|xor_eq|typeid|switch|return|struct|static|extern|inline|friend|ifndef|define|pragma|export|import|module|catch|throw|const|or_eq|compl|while|ifdef|const|bitor|union|class|undef|error|break|using|endif|goto|line|enum|this|case|else|elif|else|not|try|for|asm|and|xor|new|do|if|or|if)\\b)(?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w)\\s*+(((?<!<)<(?!<)(?:(?:\\/\\*(?:[^\\*]++|\\*+(?!\\/))*+\\*\\/)|(?:"(?:[^"]*|\\\\")")|(?:'(?:[^']*|\\\\')')|\\g<3>|(?:(?:[^'"<>\\/]|\\/[^*])++))*>)\\s*+)?::)*\\s*+`,
    ...
    scope_resolution_parameter_inner_generated: {
      captures: {
        1: { patterns: [{ include: `#scope_resolution_parameter_inner_generated` }] },
        2: { name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.parameter.cpp` },
        3: { patterns: [{ include: `#template_call_range` }] },
        4: {},
        ...
        9: { name: `comment.block.cpp` },
        10: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        11: { name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.parameter.cpp` },
      },
      match:
        `((::)?(?:(?!\\b(?:__has_cpp_attribute|reinterpret_cast|atomic_noexcept|atomic_commit|atomic_cancel|__has_include|thread_local|dynamic_cast|synchronized|static_cast|const_cast|consteval|co_return|protected|constinit|constexpr|co_return|consteval|namespace|constexpr|constexpr|co_await|explicit|volatile|noexcept|co_yield|noexcept|noexcept|requires|typename|decltype|operator|template|continue|co_await|co_yield|volatile|register|restrict|reflexpr|mutable|alignof|include|private|defined|typedef|_Pragma|__asm__|concept|mutable|warning|default|virtual|alignas|public|sizeof|delete|not_eq|bitand|and_eq|xor_eq|typeid|switch|return|struct|static|extern|inline|friend|ifndef|define|pragma|export|import|module|catch|throw|const|or_eq|compl|while|ifdef|const|bitor|union|class|undef|error|break|using|endif|goto|line|enum|this|case|else|elif|else|not|try|for|asm|and|xor|new|do|if|or|if)\\b)(?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w)\\s*+(((?<!<)<(?!<)(?:(?:\\/\\*(?:[^\\*]++|\\*+(?!\\/))*+\\*\\/)|(?:"(?:[^"]*|\\\\")")|(?:'(?:[^']*|\\\\')')|\\g<7>|(?:(?:[^'"<>\\/]|\\/[^*])++))*>)\\s*+)?::)*\\s*+)((?!\\b(?:__has_cpp_attribute|reinterpret_cast|atomic_noexcept|atomic_commit|atomic_cancel|__has_include|thread_local|dynamic_cast|synchronized|static_cast|const_cast|consteval|co_return|protected|constinit|constexpr|co_return|consteval|namespace|constexpr|constexpr|co_await|explicit|volatile|noexcept|co_yield|noexcept|noexcept|requires|typename|decltype|operator|template|continue|co_await|co_yield|volatile|register|restrict|reflexpr|mutable|alignof|include|private|defined|typedef|_Pragma|__asm__|concept|mutable|warning|default|virtual|alignas|public|sizeof|delete|not_eq|bitand|and_eq|xor_eq|typeid|switch|return|struct|static|extern|inline|friend|ifndef|define|pragma|export|import|module|catch|throw|const|or_eq|compl|while|ifdef|const|bitor|union|class|undef|error|break|using|endif|goto|line|enum|this|case|else|elif|else|not|try|for|asm|and|xor|new|do|if|or|if)\\b)(?<!\\w)(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*(?!\\w))\\s*+(((?<!<)<(?!<)(?:(?:(\\/\\*)((?:[^\\*]++|\\*+(?!\\/))*+(\\*\\/)))|(?:"(?:[^"]*|\\\\")")|(?:'(?:[^']*|\\\\')')|\\g<7>|(?:(?:[^'"<>\\/]|\\/[^*])++))*>)\\s*+)?(::)`,
    },
    scope_resolution_template_call: {
      captures: {
        0: { patterns: [{ include: `#scope_resolution_template_call_inner_generated` }] },
        1: {
    ...
    scope_resolution_template_call_inner_generated: {
      captures: {
        1: { patterns: [{ include: `#scope_resolution_template_call_inner_generated` }] },
        2: {
          name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.template.call.cpp`,
        },
        3: { patterns: [{ include: `#template_call_range` }] },
    ...
    scope_resolution_template_definition: {
      captures: {
        0: { patterns: [{ include: `#scope_resolution_template_definition_inner_generated` }] },
        1: {
          name:
            `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.template.definition.cpp`,
        },
        2: { patterns: [{ include: `#template_call_range` }] },
      },
      match:
    ...
    scope_resolution_template_definition_inner_generated: {
      captures: {
        1: { patterns: [{ include: `#scope_resolution_template_definition_inner_generated` }] },
        2: {
          name:
            `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.template.definition.cpp`,
        },
    ...
    single_line_macro: {
      captures: {
        0: { patterns: [{ include: `#macro` }, { include: `#comments` }] },
        1: { patterns: [{ include: `#inline_comment` }] },
        2: {
          patterns: [{
            captures: {
    ...
    square_brackets: {
      ...
      endCaptures: { 0: { name: `punctuation.definition.end.bracket.square` } },
    ...
    static_assert: {
      ...
      beginCaptures: {
        ...
        8: { name: `comment.block.cpp` },
        9: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        10: { name: `punctuation.section.arguments.begin.bracket.round.static_assert.cpp` },
      },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.static_assert.cpp` } },
      patterns: [{
        begin: `(,)(?:\\s+)?(?=(?:L|u8|u|U(?:\\s+)?\\")?)`,
        beginCaptures: { 1: { name: `punctuation.separator.delimiter.comma.cpp` } },
        end: `(?=\\))`,
        endCaptures: {},
    ...
    storage_types: {
      patterns: [{ include: `#storage_specifiers` }, { include: `#inline_builtin_storage_type` }, {
        include: `#decltype`,
      }, { include: `#typename` }],
    },
    string_context: {
      patterns: [{
        begin: `((?:u|u8|U|L)?)"`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.cpp` }, 1: { name: `meta.encoding.cpp` } },
        end:
          `(")(?:((?:[a-zA-Z]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*)|(_(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*))?`,
        endCaptures: {
          1: { name: `punctuation.definition.string.end.cpp` },
          2: { name: `keyword.other.suffix.literal.user-defined.reserved.string.cpp` },
          3: { name: `keyword.other.suffix.literal.user-defined.string.cpp` },
        },
        name: `string.quoted.double.cpp`,
        patterns: [
          { match: `(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8})`, name: `constant.character.escape.cpp` },
        ...
        endCaptures: {
          1: { name: `punctuation.definition.string.end.cpp` },
          2: { name: `keyword.other.suffix.literal.user-defined.reserved.character.cpp` },
          3: { name: `keyword.other.suffix.literal.user-defined.character.cpp` },
        },
        name: `string.quoted.single.cpp`,
        patterns: [
          {
        ...
        beginCaptures: {
          ...
          `(\\)\\2(\\3)")(?:((?:[a-zA-Z]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*)|(_(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*))?`,
        endCaptures: {
          1: { name: `punctuation.definition.string.end` },
          2: { name: `invalid.illegal.delimiter-too-long` },
          3: { name: `keyword.other.suffix.literal.user-defined.reserved.string.cpp` },
          4: { name: `keyword.other.suffix.literal.user-defined.string.cpp` },
        },
...
[diouxXDOUeEfFgGaACcSspn%]`,
    ...
    struct_block: {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.struct.cpp` } },
        ...
        endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.struct.cpp` } },
    ...
    switch_conditional_parentheses: {
      ...
      beginCaptures: {
        ...
        3: { name: `comment.block.cpp` },
        4: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
        5: { name: `punctuation.section.parens.begin.bracket.round.conditional.switch.cpp` },
      },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.parens.end.bracket.round.conditional.switch.cpp` } },
    ...
    switch_statement: {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.switch.cpp` } },
        name: `meta.head.switch.cpp`,
        patterns: [{ include: `#switch_conditional_parentheses` }, { include: `$self` }],
      }, {
        begin: `(?<=\\{|<%|\\?\\?<)`,
        beginCaptures: {},
        end: `\\}|%>|\\?\\?>`,
        endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.switch.cpp` } },
        name: `meta.body.switch.cpp`,
        patterns: [{ include: `#default_statement` }, { include: `#case_statement` }, { include: `$self` }],
      }, {
        begin: `(?<=\\}|%>|\\?\\?>)[\\s]*`,
        beginCaptures: {},
        end: `[\\s]*(?=;)`,
    ...
    template_argument_defaulted: {
      captures: {
        1: { name: `storage.type.template.argument.$1.cpp` },
        2: { name: `entity.name.type.template.cpp` },
        3: { name: `keyword.operator.assignment.cpp` },
      },
      match:
        `(?<=<|,)(?:\\s+)?((?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*)\\s+((?:(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*)?)(?:\\s+)?(\\=)`,
    },
    ...
    template_definition: {
      ...
      beginCaptures: {
        1: { name: `storage.type.template.cpp` },
        2: { name: `punctuation.section.angle-brackets.begin.template.definition.cpp` },
      },
      end: `>`,
      endCaptures: { 0: { name: `punctuation.section.angle-brackets.end.template.definition.cpp` } },
    ...
    template_definition_argument: {
      captures: {
        ...
        6: { name: `storage.type.template.argument.$6.cpp` },
        7: { name: `punctuation.vararg-ellipses.template.definition.cpp` },
        8: { name: `entity.name.type.template.cpp` },
        9: { name: `storage.type.template.cpp` },
        10: { name: `punctuation.section.angle-brackets.begin.template.definition.cpp` },
        11: { name: `storage.type.template.argument.$11.cpp` },
        12: { name: `entity.name.type.template.cpp` },
        13: { name: `punctuation.section.angle-brackets.end.template.definition.cpp` },
        14: { name: `storage.type.template.argument.$14.cpp` },
        15: { name: `entity.name.type.template.cpp` },
        16: { name: `keyword.operator.assignment.cpp` },
        17: { name: `punctuation.separator.delimiter.comma.template.argument.cpp` },
      },
      match:
    ...
    template_explicit_instantiation: {
      captures: { 1: { name: `storage.modifier.specifier.extern.cpp` }, 2: { name: `storage.type.template.cpp` } },
    ...
    template_isolated_definition: {
      captures: {
        1: { name: `storage.type.template.cpp` },
        2: { name: `punctuation.section.angle-brackets.begin.template.definition.cpp` },
        3: { name: `meta.template.definition.cpp`, patterns: [{ include: `#template_definition_context` }] },
        4: { name: `punctuation.section.angle-brackets.end.template.definition.cpp` },
      },
    ...
    type_alias: {
      captures: {
        ...
        3: { patterns: [{ include: `#attributes_context` }, { include: `#number_literal` }] },
        4: { name: `keyword.operator.assignment.cpp` },
        5: { name: `keyword.other.typename.cpp` },
        6: { patterns: [{ include: `#storage_specifiers` }] },
        7: {
          patterns: [{
            captures: {
              1: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
        ...
        9: { patterns: [{ include: `#attributes_context` }, { include: `#number_literal` }] },
        10: { patterns: [{ include: `#inline_comment` }] },
        11: {
          patterns: [{
            captures: {
        ...
        20: { name: `meta.declaration.type.alias.value.unknown.cpp`, patterns: [{ include: `#evaluation_context` }] },
        21: {
          patterns: [{ match: `\\*`, name: `storage.modifier.pointer.cpp` }, {
            captures: {
              1: { patterns: [{ include: `#inline_comment` }] },
    ...
    type_casting_operators: {
      captures: {
        ...
        3: { name: `keyword.operator.wordlike.cpp keyword.operator.cast.$3.cpp` },
      },
      match:
        ...
        patterns: [{
          ...
          patterns: [{
            captures: {
              ...
              9: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
              10: { patterns: [{ include: `#inline_comment` }] },
              11: { name: `comment.block.cpp punctuation.definition.comment.begin.cpp` },
              12: { name: `comment.block.cpp` },
              13: { name: `comment.block.cpp punctuation.definition.comment.end.cpp` },
    ...
    typedef_function_pointer: {
      begin:
        `((?<!\\w)typedef(?!\\w))(?:\\s+)?(?=.*\\(\\*\\s*(?:[a-zA-Z_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))(?:[a-zA-Z0-9_]|(?:\\\\u[0-9a-fA-F]{4}|\\\\U[0-9a-fA-F]{8}))*\\s*\\))`,
      beginCaptures: { 1: { name: `keyword.other.typedef.cpp` } },
      end: `(?<=;)`,
      endCaptures: {},
      patterns: [{
        ...
        beginCaptures: {
          ...
          32: { name: `punctuation.section.parens.begin.bracket.round.function.pointer.cpp` },
          33: { name: `punctuation.definition.function.pointer.dereference.cpp` },
          34: { name: `entity.name.type.alias.cpp entity.name.type.pointer.function.cpp` },
          35: { name: `punctuation.definition.begin.bracket.square.cpp` },
          36: { patterns: [{ include: `#evaluation_context` }] },
          37: { name: `punctuation.definition.end.bracket.square.cpp` },
          38: { name: `punctuation.section.parens.end.bracket.round.function.pointer.cpp` },
    ...
    typedef_union: {
      ...
      patterns: [{
        ...
        patterns: [{
          ...
          endCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.union.cpp` } },
          ...
          endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.union.cpp` } },
    ...
    using_namespace: {
      ...
      beginCaptures: {
        1: { name: `keyword.other.using.directive.cpp` },
        2: { name: `keyword.other.namespace.directive.cpp storage.type.namespace.directive.cpp` },
        3: { patterns: [{ include: `#scope_resolution_namespace_using_inner_generated` }] },
        4: {
          name: `punctuation.separator.namespace.access.cpp punctuation.separator.scope-resolution.namespace.using.cpp`,
        },
    ...
    vararg_ellipses: { match: `(?<!\\.)\\.\\.\\.(?!\\.)`, name: `punctuation.vararg-ellipses.cpp` },
    wordlike_operators: {
      patterns: [{
        match:
          `(?<!\\w)(?:(?:noexcept)|(?:xor_eq)|(?:and_eq)|(?:delete)|(?:not_eq)|(?:bitand)|(?:bitor)|(?:compl)|(?:or_eq)|(?:not)|(?:xor)|(?:new)|(?:and)|(?:or))(?!\\w)`,
        name: `keyword.operator.wordlike.cpp keyword.operator.$0.cpp`,
      }],
    },
  },
  i = `source.cpp`,
  a = { displayName: `C++`, name: `cpp`, patterns: n, repository: r, scopeName: i }
