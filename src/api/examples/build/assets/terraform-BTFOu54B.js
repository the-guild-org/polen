var e = `Terraform`,
  t = [`tf`, `tfvars`],
  n = `terraform`,
  r = [{ include: `#comments` }, { include: `#attribute_definition` }, { include: `#block` }, {
    include: `#expressions`,
  }],
  i = {
    attribute_access: {
      ...
      endCaptures: {
        0: {
          ...
          }, { comment: `Optional attribute index`, match: `\\d+`, name: `constant.numeric.integer.hcl` }],
        },
      },
    },
    ...
    block: {
      ...
      beginCaptures: {
        ...
        2: { patterns: [{ comment: `Block label`, match: `[\\"\\-\\w]+`, name: `variable.other.enummember.hcl` }] },
      ...
      name: `meta.block.hcl`,
      patterns: [{ include: `#comments` }, { include: `#attribute_definition` }, { include: `#block` }, {
        include: `#expressions`,
      }],
    },
    block_inline_comments: {
      ...
      comment:
        `Inline comments start with the /* sequence and end with the */ sequence, and may have any characters within except the ending sequence. An inline comment is considered equivalent to a whitespace sequence`,
      end: `\\*/`,
    ...
    brackets: {
      ...
      patterns: [
        { comment: `Splat operator`, match: `\\*`, name: `keyword.operator.splat.hcl` },
        { include: `#comma` },
        { include: `#comments` },
    ...
    comma: { comment: `Commas - used in certain expressions`, match: `\\,`, name: `punctuation.separator.hcl` },
    comments: {
      patterns: [{ include: `#hash_line_comments` }, { include: `#double_slash_line_comments` }, {
    ...
    double_slash_line_comments: {
      ...
      captures: { 0: { name: `punctuation.definition.comment.hcl` } },
      comment:
        `Line comments start with // sequence and end with the next newline sequence. A line comment is considered equivalent to a newline sequence`,
      end: `$\\n?`,
    ...
    for_expression_body: {
      patterns: [
        { comment: `in keyword`, match: `\\bin\\b`, name: `keyword.operator.word.hcl` },
        { comment: `if keyword`, match: `\\bif\\b`, name: `keyword.control.conditional.hcl` },
    ...
    functions: {
      ...
      patterns: [{ include: `#comments` }, { include: `#expressions` }, { include: `#comma` }],
    },
    hash_line_comments: {
      begin: `#`,
      captures: { 0: { name: `punctuation.definition.comment.hcl` } },
    ...
    heredoc: {
      begin: `(\\<\\<\\-?)\\s*(\\w+)\\s*$`,
      beginCaptures: { 1: { name: `keyword.operator.heredoc.hcl` }, 2: { name: `keyword.control.heredoc.hcl` } },
    ...
    inline_for_expression: {
      captures: {
        1: { name: `keyword.control.hcl` },
        2: { patterns: [{ match: `\\=\\>`, name: `storage.type.function.hcl` }, { include: `#for_expression_body` }] },
      },
      match: `(for)\\b(.*)\\n`,
    },
    inline_if_expression: {
      ...
      patterns: [{ include: `#expressions` }, { include: `#comments` }, { include: `#comma` }, {
        include: `#local_identifiers`,
      }],
    },
    language_constants: {
    ...
    numeric_literals: {
      patterns: [{
        ...
        match: `\\b\\d+(\\.)\\d+(?:([Ee][+-]?)\\d+)?\\b`,
        name: `constant.numeric.float.hcl`,
      }, { comment: `Integers`, match: `\\b\\d+\\b`, name: `constant.numeric.integer.hcl` }],
    },
    object_for_expression: {
      begin: `(\\{)\\s?(for)\\b`,
      beginCaptures: { 1: { name: `punctuation.section.braces.begin.hcl` }, 2: { name: `keyword.control.hcl` } },
      end: `\\}`,
      endCaptures: { 0: { name: `punctuation.section.braces.end.hcl` } },
      patterns: [{ match: `\\=\\>`, name: `storage.type.function.hcl` }, { include: `#for_expression_body` }],
    },
    object_key_values: {
      patterns: [
        { include: `#comments` },
    ...
    objects: {
      ...
      patterns: [{ include: `#comments` }, { include: `#objects` }, { include: `#inline_for_expression` }, {
        include: `#inline_if_expression`,
      }, {
        captures: {
        ...
        endCaptures: { 1: { name: `punctuation.section.parens.end.hcl` }, 2: { name: `keyword.operator.hcl` } },
        name: `meta.mapping.key.hcl`,
        patterns: [{ include: `#named_value_references` }, { include: `#attribute_access` }],
    ...
    string_interpolation: {
      ...
      patterns: [
        { comment: `Trim left whitespace`, match: `\\~\\s`, name: `keyword.operator.template.left.trim.hcl` },
        { comment: `Trim right whitespace`, match: `\\s\\~`, name: `keyword.operator.template.right.trim.hcl` },
        {
    ...
    tuple_for_expression: {
      begin: `(\\[)\\s?(for)\\b`,
      beginCaptures: { 1: { name: `punctuation.section.brackets.begin.hcl` }, 2: { name: `keyword.control.hcl` } },
      end: `\\]`,
      endCaptures: { 0: { name: `punctuation.section.brackets.end.hcl` } },
      patterns: [{ include: `#for_expression_body` }],
    },
  },
  a = `source.hcl.terraform`,
