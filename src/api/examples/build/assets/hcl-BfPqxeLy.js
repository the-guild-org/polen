var e = `HashiCorp HCL`,
  ...
  i = {
    ...
    block: {
      ...
      name: `meta.block.hcl`,
      patterns: [{ include: `#comments` }, { include: `#attribute_definition` }, { include: `#expressions` }, {
        include: `#block`,
      }],
    },
    ...
    functions: {
      ...
      beginCaptures: {
        1: {
          ...
          }, { match: `\\b[[:alpha:]][\\w_-]*\\b`, name: `support.function.builtin.hcl` }],
        },
    ...
    objects: {
      ...
      patterns: [{ include: `#comments` }, { include: `#objects` }, { include: `#inline_for_expression` }, {
        ...
        patterns: [{ include: `#attribute_access` }, { include: `#attribute_splat` }],
  ...
  a = `source.hcl`,
  o = { displayName: e, fileTypes: t, name: `hcl`, patterns: r, repository: i, scopeName: a }
