var e = `Ruby Haml`,
  ...
  a = [
    ...
    { begin: `^(\\s*):javascript`, end: `^(?!\\1\\s+|$\\n*)`, name: `js.haml`, patterns: [{ include: `source.js` }] },
    {
      begin: `^(\\s*)%script`,
      end: `^(?!\\1\\s+|$\\n*)`,
      name: `js.inline.haml`,
    ...
    },
    {
      ...
      patterns: [
        ...
        { captures: { 1: { name: `entity.other.attribute-name.id` } }, match: `(#[\\w-]+)`, name: `meta.selector.css` },
        {
          begin: `(?<!\\#)\\{(?=.*(,|(do)|\\{|\\}|\\||(\\#.*)|\\R)\\s*)`,
          end: `\\s*\\}(?!\\s*\\,)(?!\\s*\\|)(?!\\#\\{.*\\})`,
          name: `meta.section.attributes.haml`,
          patterns: [{ include: `source.ruby` }, { include: `#continuation` }, { include: `#rubyline` }],
        },
        {
          begin: `\\(`,
          end: `\\)`,
    ...
    {
      begin: `^(\\s*)(:ruby)`,
      beginCaptures: { 2: { name: `keyword.control.filter.haml` } },
      end: `(?m:(?<=\\n)(?!\\1\\s+|$\\n*))`,
      name: `source.ruby.embedded.filter.haml`,
      patterns: [{ include: `source.ruby` }],
    },
    ...
    { captures: { 1: { name: `meta.escape.haml` } }, match: `^\\s*(\\.)` },
    {
      ...
      patterns: [{ include: `#interpolated_ruby_line` }, { include: `#rubyline` }],
    },
    {
      begin: `^(\\s*)(:php)`,
  ...
  o = {
    ...
    interpolated_ruby: {
      patterns: [{
        ...
        name: `source.ruby.embedded.source`,
        patterns: [{ include: `#nest_curly_and_self` }, { include: `source.ruby` }],
      }, { include: `#variables` }],
    },
    interpolated_ruby_line: {
      ...
      patterns: [{ include: `#interpolated_ruby` }, { include: `source.ruby#escaped_char` }],
    },
    nest_curly_and_self: {
      patterns: [{
        begin: `\\{`,
    ...
    rubyline: {
      ...
      endCaptures: { 1: { name: `source.ruby.embedded.html` }, 2: { name: `keyword.control.ruby.start-block` } },
      ...
      patterns: [
        ...
        { captures: { 1: { name: `storage.type.function.php` } }, match: `\\s+(function\\s*)((?=\\())` },
        { captures: { 1: { name: `keyword.control.php` } }, match: `\\s+(use\\s*)((?=\\())` },
        { match: `(\\||,|<|do|\\{)\\s*(\\#.*)?$\\n*`, name: `source.ruby`, patterns: [{ include: `#rubyline` }] },
        {
