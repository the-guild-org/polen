var e = `SCSS`,
  ...
  r = {
    at_rule_at_root: {
      ...
      patterns: [{ include: `#function_attributes` }, { include: `#functions` }, { include: `#selectors` }],
    },
    at_rule_charset: {
      begin: `\\s*((@)charset\\b)\\s*`,
      captures: {
      ...
      patterns: [{ include: `#variable` }, { include: `#string_single` }, { include: `#string_double` }],
    },
    at_rule_content: {
      begin: `\\s*((@)content\\b)\\s*`,
      ...
      patterns: [{ include: `#variable` }, { include: `#selectors` }, { include: `#property_values` }],
    },
    at_rule_each: {
      begin: `\\s*((@)each\\b)\\s*`,
      captures: { 1: { name: `keyword.control.each.scss` }, 2: { name: `punctuation.definition.keyword.scss` } },
      end: `\\s*((?=}))`,
      name: `meta.at-rule.each.scss`,
      patterns: [{ match: `\\b(in|,)\\b`, name: `keyword.control.operator` }, { include: `#variable` }, {
        include: `#property_values`,
      }, { include: `$self` }],
    },
    at_rule_else: {
      begin: `\\s*((@)else(\\s*(if)?))\\s*`,
      captures: { 1: { name: `keyword.control.else.scss` }, 2: { name: `punctuation.definition.keyword.scss` } },
      end: `\\s*(?={)`,
      name: `meta.at-rule.else.scss`,
      patterns: [{ include: `#conditional_operators` }, { include: `#variable` }, { include: `#property_values` }],
    },
    at_rule_extend: {
      begin: `\\s*((@)extend\\b)\\s*`,
      captures: {
    ...
    at_rule_for: {
      begin: `\\s*((@)for\\b)\\s*`,
      captures: { 1: { name: `keyword.control.for.scss` }, 2: { name: `punctuation.definition.keyword.scss` } },
      end: `\\s*(?={)`,
      name: `meta.at-rule.for.scss`,
      patterns: [
        { match: `(==|!=|<=|>=|<|>|from|to|through)`, name: `keyword.control.operator` },
        { include: `#variable` },
        { include: `#property_values` },
        { include: `$self` },
      ],
    ...
    at_rule_if: {
      begin: `\\s*((@)if\\b)\\s*`,
      captures: { 1: { name: `keyword.control.if.scss` }, 2: { name: `punctuation.definition.keyword.scss` } },
      end: `\\s*(?={)`,
    ...
    at_rule_include: {
      patterns: [{
        ...
        beginCaptures: {
          ...
          3: { name: `entity.name.function.scss` },
          4: { name: `punctuation.definition.parameters.begin.bracket.round.scss` },
        },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.parameters.end.bracket.round.scss` } },
    ...
    at_rule_keyframes: {
      ...
      patterns: [{
        ...
        begin: `(?<=@keyframes)\\s+(")`,
        beginCaptures: { 1: { name: `punctuation.definition.string.begin.scss` } },
        ...
        patterns: [{ match: `\\\\(\\h{1,6}|.)`, name: `constant.character.escape.scss` }, {
        ...
        begin: `{`,
        beginCaptures: { 0: { name: `punctuation.section.keyframes.begin.scss` } },
        end: `}`,
        endCaptures: { 0: { name: `punctuation.section.keyframes.end.scss` } },
        patterns: [
          { match: `\\b(?:(?:100|[1-9]\\d|\\d)%|from|to)(?=\\s*{)`, name: `entity.other.attribute-name.scss` },
          { include: `#flow_control` },
          { include: `#interpolation` },
          { include: `#property_list` },
          { include: `#rules` },
    ...
    at_rule_media: {
      patterns: [{
        ...
        patterns: [
          ...
          {
            begin: `\\(`,
            beginCaptures: { 0: { name: `punctuation.definition.media-query.begin.bracket.round.scss` } },
            end: `\\)`,
            endCaptures: { 0: { name: `punctuation.definition.media-query.end.bracket.round.scss` } },
            name: `meta.property-list.media-query.scss`,
            patterns: [{
              begin: `(?<![-a-z])(?=[-a-z])`,
              end: `$|(?![-a-z])`,
              name: `meta.property-name.media-query.scss`,
              patterns: [{ include: `source.css#media-features` }, { include: `source.css#property-names` }],
            }, {
              begin: `(:)\\s*(?!(\\s*{))`,
    ...
    at_rule_mixin: {
      patterns: [{
        ...
        beginCaptures: {
          ...
          2: { name: `punctuation.definition.parameters.begin.bracket.round.scss` },
        },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.parameters.end.bracket.round.scss` } },
    ...
    at_rule_namespace: {
      patterns: [{
        ...
        patterns: [{ include: `#property_values` }, { include: `#string_single` }, { include: `#string_double` }],
      }, {
        begin: `(?<=@namespace)\\s+([\\w-]*)`,
        captures: { 1: { name: `entity.name.namespace-prefix.scss` } },
        end: `(?=;|$)`,
        name: `meta.at-rule.namespace.scss`,
        patterns: [{ include: `#variables` }, { include: `#property_values` }, { include: `#string_single` }, {
          include: `#string_double`,
        }],
      }, {
        captures: {
    ...
    at_rule_return: {
      begin: `\\s*((@)(return)\\b)`,
      captures: { 1: { name: `keyword.control.return.scss` }, 2: { name: `punctuation.definition.keyword.scss` } },
      end: `\\s*((?=;))`,
    ...
    at_rule_supports: {
      ...
      patterns: [{ include: `#logical_operators` }, { include: `#properties` }, {
        match: `\\(`,
        name: `punctuation.definition.condition.begin.bracket.round.scss`,
      }, { match: `\\)`, name: `punctuation.definition.condition.end.bracket.round.scss` }],
    },
    at_rule_use: {
      begin: `\\s*((@)use\\b)\\s*`,
      captures: { 1: { name: `keyword.control.at-rule.use.scss` }, 2: { name: `punctuation.definition.keyword.scss` } },
      end: `\\s*(?=;)`,
      ...
      patterns: [
        ...
        {
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.definition.parameters.begin.bracket.round.scss` } },
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.definition.parameters.end.bracket.round.scss` } },
          patterns: [{ include: `#function_attributes` }],
        },
    ...
    at_rule_warn: {
      ...
      captures: { 1: { name: `keyword.control.warn.scss` }, 2: { name: `punctuation.definition.keyword.scss` } },
      end: `\\s*(?=;)`,
      name: `meta.at-rule.warn.scss`,
      patterns: [{ include: `#variable` }, { include: `#string_double` }, { include: `#string_single` }],
    },
    at_rule_while: {
      begin: `\\s*((@)while\\b)\\s*`,
      captures: { 1: { name: `keyword.control.while.scss` }, 2: { name: `punctuation.definition.keyword.scss` } },
      end: `\\s*(?=})`,
    ...
    comparison_operators: { match: `==|!=|<=|>=|<|>`, name: `keyword.operator.comparison.scss` },
    conditional_operators: { patterns: [{ include: `#comparison_operators` }, { include: `#logical_operators` }] },
    ...
    constant_important: { match: `!important`, name: `keyword.other.important.scss` },
    constant_mathematical_symbols: { match: `\\b(\\+|-|\\*|/)\\b`, name: `support.constant.mathematical-symbols.scss` },
    constant_optional: { match: `!optional`, name: `keyword.other.optional.scss` },
    constant_sass_functions: {
      ...
      beginCaptures: { 1: { name: `support.function.misc.scss` }, 2: { name: `punctuation.section.function.scss` } },
      end: `(\\))`,
      endCaptures: { 1: { name: `punctuation.section.function.scss` } },
      patterns: [{ include: `#parameters` }],
    },
    ...
    function_attributes: {
      patterns: [{ match: `:`, name: `punctuation.separator.key-value.scss` }, { include: `#general` }, {
        include: `#property_values`,
    ...
    general: {
      patterns: [{ include: `#variable` }, { include: `#comment_docblock` }, { include: `#comment_block` }, {
        include: `#comment_line`,
      }],
    },
    interpolation: {
      begin: `#{`,
      beginCaptures: { 0: { name: `punctuation.definition.interpolation.begin.bracket.curly.scss` } },
      end: `}`,
      endCaptures: { 0: { name: `punctuation.definition.interpolation.end.bracket.curly.scss` } },
      name: `variable.interpolation.scss`,
      patterns: [{ include: `#variable` }, { include: `#property_values` }],
    },
    logical_operators: { match: `\\b(not|or|and)\\b`, name: `keyword.operator.logical.scss` },
    map: {
      begin: `\\(`,
      beginCaptures: { 0: { name: `punctuation.definition.map.begin.bracket.round.scss` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.map.end.bracket.round.scss` } },
      ...
      patterns: [
        ...
        { include: `#comment_line` },
        {
          captures: { 1: { name: `support.type.map.key.scss` }, 2: { name: `punctuation.separator.key-value.scss` } },
          match: `\\b([\\w-]+)\\s*(:)`,
        },
    ...
    parameters: {
      patterns: [
        ...
        {
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.definition.begin.bracket.round.scss` } },
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.definition.end.bracket.round.scss` } },
          patterns: [{ include: `#function_attributes` }],
        },
        { include: `#property_values` },
        { include: `#comment_block` },
...
| /\\*
    ...
    properties: {
      patterns: [{
        ...
        patterns: [{ include: `source.css#property-names` }, { include: `#at_rule_include` }],
      }, {
        begin: `(:)\\s*(?!(\\s*{))`,
        beginCaptures: { 1: { name: `punctuation.separator.key-value.scss` } },
    ...
    property_list: {
      begin: `{`,
      beginCaptures: { 0: { name: `punctuation.section.property-list.begin.bracket.curly.scss` } },
      end: `}`,
      endCaptures: { 0: { name: `punctuation.section.property-list.end.bracket.curly.scss` } },
      name: `meta.property-list.scss`,
      patterns: [{ include: `#flow_control` }, { include: `#rules` }, { include: `#properties` }, { include: `$self` }],
    },
    property_values: {
      patterns: [
        { include: `#string_single` },
    ...
    selector_attribute: {
      captures: {
        1: { name: `punctuation.definition.attribute-selector.begin.bracket.square.scss` },
        2: {
        ...
        13: { name: `punctuation.definition.attribute-selector.end.bracket.square.scss` },
      },
      match: `(?xi)
(\\[)
\\s*
...
| /\\*
      ...
      patterns: [
        {
          ...
          beginCaptures: {
            ...
            3: { name: `punctuation.definition.pseudo-class.begin.bracket.round.css` },
          },
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.definition.pseudo-class.end.bracket.round.css` } },
          patterns: [{ include: `#interpolation` }, { match: `\\d+`, name: `constant.numeric.css` }, {
    ...
    string_double: {
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.scss` } },
      name: `string.quoted.double.scss`,
      patterns: [{ match: `\\\\(\\h{1,6}|.)`, name: `constant.character.escape.scss` }, { include: `#interpolation` }],
    },
    string_single: {
      begin: `'`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.scss` } },
    ...
    variable: { patterns: [{ include: `#variables` }, { include: `#interpolation` }] },
    variable_setting: {
      begin: `(?=\\$[\\w-]+\\s*:)`,
      contentName: `meta.definition.variable.scss`,
      end: `;`,
      endCaptures: { 0: { name: `punctuation.terminator.rule.scss` } },
      patterns: [{ match: `\\$[\\w-]+(?=\\s*:)`, name: `variable.scss` }, {
        begin: `:`,
