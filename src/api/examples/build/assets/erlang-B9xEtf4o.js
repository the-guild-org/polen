var e = `Erlang`,
  ...
  i = {
    atom: {
      patterns: [{
        begin: `(')`,
        beginCaptures: { 1: { name: `punctuation.definition.symbol.begin.erlang` } },
        end: `(')`,
      ...
      }, { match: `[a-z][a-zA-Z\\d@_]*+`, name: `constant.other.symbol.unquoted.erlang` }],
    },
    'behaviour-directive': {
      captures: {
        ...
        4: { name: `entity.name.type.class.behaviour.definition.erlang` },
    ...
    binary: {
      begin: `(<<)`,
      beginCaptures: { 1: { name: `punctuation.definition.binary.begin.erlang` } },
      end: `(>>)`,
    ...
    comment: {
      begin: `(^[ \\t]+)?(?=%)`,
      beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.erlang` } },
      end: `(?!\\G)`,
      patterns: [{
        begin: `%`,
        beginCaptures: { 0: { name: `punctuation.definition.comment.erlang` } },
        end: `\\n`,
        ...
        patterns: [
          {
            ...
            patterns: [{ match: `,`, name: `punctuation.separator.parameters.erlang` }, {
              include: `#everything-else`,
            }],
          },
          { match: `\\|\\||\\||:|;|,|\\.|->`, name: `punctuation.separator.define.erlang` },
          { include: `#everything-else` },
        ],
      }],
    },
    ...
    docstring: {
      begin: `(?<!")((["]{3,})\\s*)(\\S.*)?$`,
      beginCaptures: {
        1: { name: `meta.string.quoted.triple.begin.erlang` },
        2: { name: `punctuation.definition.string.begin.erlang` },
        3: { name: `invalid.illegal.string.erlang` },
      },
      comment:
    ...
    expression: {
      patterns: [{
        ...
        patterns: [{ include: `#internal-expression-punctuation` }, { include: `#everything-else` }],
      }, {
        begin: `\\b(case)\\b`,
        ...
        captures: {
          ...
          5: { name: `variable.other.erlang` },
          6: { name: `punctuation.separator.module-function.erlang` },
          8: { name: `entity.name.function.erlang` },
          9: { name: `variable.other.erlang` },
          10: { name: `punctuation.separator.function-arity.erlang` },
        },
        comment:
          `Implicit function expression with optional module qualifier when both module and function can be atom or variable`,
        match:
          `\\b(fun)\\s+((([a-z][a-zA-Z\\d@_]*+)|(_[a-zA-Z\\d@_]++|[A-Z][a-zA-Z\\d@_]*+))\\s*+(:)\\s*+)?(([a-z][a-zA-Z\\d@_]*+|'[^']*+')|(_[a-zA-Z\\d@_]++|[A-Z][a-zA-Z\\d@_]*+))\\s*(/)`,
        ...
        beginCaptures: {
          ...
          4: { name: `variable.other.erlang` },
          5: { name: `punctuation.separator.module-function.erlang` },
        },
        comment:
          `Implicit function expression with module qualifier when module can be atom or variable and function can by anything`,
        end: `(/)`,
        endCaptures: { 1: { name: `punctuation.separator.function-arity.erlang` } },
        name: `meta.expression.fun.implicit.erlang`,
        patterns: [{ include: `#everything-else` }],
      }, {
        begin: `\\b(fun)\\s+(?!\\()`,
        ...
        endCaptures: { 1: { name: `punctuation.definition.parameters.end.erlang` } },
        patterns: [{ include: `#everything-else` }],
      }, {
        begin: `\\b(fun)\\b`,
        beginCaptures: { 1: { name: `keyword.control.fun.erlang` } },
        ...
        begin: `\\b(maybe)\\b`,
        beginCaptures: { 1: { name: `keyword.control.maybe.erlang` } },
        end: `\\b(end)\\b`,
        endCaptures: { 1: { name: `keyword.control.end.erlang` } },
    ...
    function: {
      ...
      patterns: [{
        ...
        endCaptures: { 1: { name: `punctuation.separator.clauses.erlang` } },
        patterns: [{ include: `#parenthesized-expression` }, { include: `#internal-function-parts` }],
      }, { include: `#everything-else` }],
    },
    'function-call': {
      begin:
        `(?=([a-z][a-zA-Z\\d@_]*+|'[^']*+'|_[a-zA-Z\\d@_]++|[A-Z][a-zA-Z\\d@_]*+)\\s*+(\\(|:\\s*+([a-z][a-zA-Z\\d@_]*+|'[^']*+'|_[a-zA-Z\\d@_]++|[A-Z][a-zA-Z\\d@_]*+)\\s*+\\())`,
      end: `(\\))`,
      endCaptures: { 1: { name: `punctuation.definition.parameters.end.erlang` } },
      ...
      patterns: [{
        ...
        patterns: [{ match: `,`, name: `punctuation.separator.parameters.erlang` }, { include: `#everything-else` }],
      }, {
        begin:
          `((([a-z][a-zA-Z\\d@_]*+|'[^']*+')|(_[a-zA-Z\\d@_]++|[A-Z][a-zA-Z\\d@_]*+))\\s*+(:)\\s*+)?(([a-z][a-zA-Z\\d@_]*+|'[^']*+')|(_[a-zA-Z\\d@_]++|[A-Z][a-zA-Z\\d@_]*+))\\s*+(\\()`,
        beginCaptures: {
          ...
          4: { name: `variable.other.erlang` },
          5: { name: `punctuation.separator.module-function.erlang` },
          7: { name: `entity.name.function.erlang` },
          8: { name: `variable.other.erlang` },
          9: { name: `punctuation.definition.parameters.begin.erlang` },
        },
        end: `(?=\\))`,
        patterns: [{ match: `,`, name: `punctuation.separator.parameters.erlang` }, { include: `#everything-else` }],
      }],
      ...
      patterns: [
        {
          ...
          endCaptures: { 1: { name: `punctuation.separator.clause-head-body.erlang` } },
          patterns: [
            {
              begin: `(\\()`,
              beginCaptures: { 1: { name: `punctuation.definition.parameters.begin.erlang` } },
              end: `(\\))`,
              endCaptures: { 1: { name: `punctuation.definition.parameters.end.erlang` } },
              patterns: [{ match: `,`, name: `punctuation.separator.parameters.erlang` }, {
                include: `#everything-else`,
    ...
    'internal-record-body': {
      begin: `(\\{)`,
      beginCaptures: { 1: { name: `punctuation.definition.class.record.begin.erlang` } },
      end: `(\\})`,
      endCaptures: { 1: { name: `punctuation.definition.class.record.end.erlang` } },
      ...
      patterns: [{
        ...
        endCaptures: { 1: { name: `punctuation.separator.class.record.erlang` } },
        patterns: [{ include: `#everything-else` }],
      }, { include: `#everything-else` }],
    },
    'internal-string-body': {
      patterns: [
        ...
        {
          captures: { 1: { name: `punctuation.definition.placeholder.erlang` } },
    ...
    'internal-type-specifiers': {
      ...
      patterns: [{
        captures: {
          ...
          5: { name: `punctuation.separator.unit-specifiers.erlang` },
          6: { name: `constant.numeric.integer.decimal.erlang` },
          7: { name: `punctuation.separator.type-specifiers.erlang` },
        },
        match:
          `(integer|float|binary|bytes|bitstring|bits|utf8|utf16|utf32)|(signed|unsigned)|(big|little|native)|(unit)(:)(\\d++)|(-)`,
      }],
    },
    keyword: {
    ...
    'language-constant': { match: `\\b(false|true|undefined)\\b`, name: `constant.language` },
    list: {
      begin: `(\\[)`,
      beginCaptures: { 1: { name: `punctuation.definition.list.begin.erlang` } },
      end: `(\\])`,
      ...
      patterns: [{ match: `\\||\\|\\||,`, name: `punctuation.separator.list.erlang` }, { include: `#everything-else` }],
    },
    'macro-directive': {
      patterns: [{
        captures: {
    ...
    'macro-usage': {
      captures: { 1: { name: `keyword.operator.macro.erlang` }, 2: { name: `entity.name.function.macro.erlang` } },
      match: `(\\?\\??)\\s*+([a-zA-Z\\d@_]++)`,
      ...
      patterns: [
        {
          captures: {
            ...
            2: { name: `punctuation.separator.float-exponent.erlang` },
          },
          match: `\\d++(\\.)\\d++([eE][\\+\\-]?\\d++)?`,
        ...
        { match: `\\d++#([\\da-zA-Z]++_)*[\\da-zA-Z]++`, name: `invalid.illegal.integer.erlang` },
        { match: `(\\d++_)*\\d++`, name: `constant.numeric.integer.decimal.erlang` },
      ],
    },
    'parenthesized-expression': {
      begin: `(\\()`,
      beginCaptures: { 1: { name: `punctuation.section.expression.begin.erlang` } },
      end: `(\\))`,
    ...
    'record-directive': {
      ...
      patterns: [{ include: `#internal-record-body` }, { include: `#comment` }],
    },
    'record-usage': {
      patterns: [{
        captures: {
    ...
    string: {
      begin: `(")`,
      beginCaptures: { 1: { name: `punctuation.definition.string.begin.erlang` } },
      end: `(")`,
      endCaptures: { 1: { name: `punctuation.definition.string.end.erlang` } },
    ...
    tuple: {
      ...
      patterns: [{ match: `,`, name: `punctuation.separator.tuple.erlang` }, { include: `#everything-else` }],
    },
    variable: {
      captures: { 1: { name: `variable.other.erlang` }, 2: { name: `variable.language.omitted.erlang` } },
