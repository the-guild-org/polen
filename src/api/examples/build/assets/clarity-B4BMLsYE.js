var e = `Clarity`,
  ...
  r = {
    ...
    comment: { match: `(?x) (?<=^|[()\\[\\]{}",'\`;\\s]) (;) .* $`, name: `comment.line.semicolon.clarity` },
    'data-type': {
      patterns: [
        { include: `#comment` },
        { comment: `numerics`, match: `\\b(uint|int)\\b`, name: `entity.name.type.numeric.clarity` },
        { comment: `principal`, match: `\\b(principal)\\b`, name: `entity.name.type.principal.clarity` },
        { comment: `bool`, match: `\\b(bool)\\b`, name: `entity.name.type.bool.clarity` },
        {
          captures: {
        ...
        },
        {
          ...
          name: `meta.tuple-def`,
          patterns: [{ match: `([a-zA-Z][\\w\\?\\!\\-]*)(?=:)`, name: `entity.name.tag.tuple-data-type-key.clarity` }, {
            include: `#data-type`,
          }],
        },
      ],
    ...
    'define-function': {
      ...
      patterns: [{ include: `#expression` }, {
        ...
        endCaptures: { 1: { name: `punctuation.function-signature.end.clarity` } },
        ...
        patterns: [{
          ...
          endCaptures: { 1: { name: `punctuation.function-argument.end.clarity` } },
    ...
    'define-non-fungible-token': {
      ...
      endCaptures: { 1: { name: `punctuation.define-non-fungible-token.end.clarity` } },
    ...
    expression: {
      patterns: [{ include: `#comment` }, { include: `#keyword` }, { include: `#literal` }, { include: `#let-func` }, {
      ...
      patterns: [{ include: `#expression` }, { include: `#user-func` }, {
        ...
        patterns: [{
          ...
          beginCaptures: {
            ...
            2: { name: `entity.name.let-local-var-name.clarity variable.parameter.clarity` },
          },
          end: `(\\))`,
    ...
    literal: {
      ...
      repository: {
        'bool-literal': { match: `(?<!\\S)(?!-)\\b(true|false)\\b(?!\\s*-)`, name: `constant.language.bool.clarity` },
        'list-literal': {
          begin: `(?x) (\\() \\s* (list) \\s+`,
          beginCaptures: {
          ...
          endCaptures: { 1: { names: `punctuation.list.end.clarity` } },
          name: `meta.list`,
          patterns: [{ include: `#expression` }, { include: `#user-func` }],
        },
        'number-literal': {
        ...
        'optional-literal': {
          patterns: [{ match: `(?<!\\S)(?!-)\\b(none)\\b(?!\\s*-)`, name: `constant.language.none.clarity` }, {
            begin: `(?x) (\\() \\s* (some) \\s+`,
            beginCaptures: {
        ...
        'string-literal': {
          patterns: [{
            ...
            patterns: [{ match: `\\\\.`, name: `constant.character.escape.quote` }],
          }],
        },
        'tuple-literal': {
          begin: `(\\{)`,
          ...
          name: `meta.tuple`,
          patterns: [{ match: `([a-zA-Z][\\w\\?\\!\\-]*)(?=:)`, name: `entity.name.tag.tuple-key.clarity` }, {
            include: `#expression`,
          }, { include: `#user-func` }],
        },
      },
