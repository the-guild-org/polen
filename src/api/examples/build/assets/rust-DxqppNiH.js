var e = `Rust`,
  ...
  n = [
    ...
    {
      captures: { 1: { name: `storage.type.rust` }, 2: { name: `entity.name.module.rust` } },
      comment: `modules`,
      match: `(mod)\\s+((?:r#(?!crate|[Ss]elf|super))?[a-z][A-Za-z0-9_]*)`,
    },
    {
      begin: `\\b(extern)\\s+(crate)`,
      beginCaptures: { 1: { name: `storage.type.rust` }, 2: { name: `keyword.other.crate.rust` } },
      comment: `external crate imports`,
      end: `;`,
      endCaptures: { 0: { name: `punctuation.semi.rust` } },
      name: `meta.import.rust`,
      patterns: [{ include: `#block-comments` }, { include: `#comments` }, { include: `#keywords` }, {
        include: `#punctuation`,
      }],
    },
    {
  ...
  r = {
    ...
    'block-comments': {
      patterns: [{ comment: `empty block comments`, match: `/\\*\\*/`, name: `comment.block.rust` }, {
        begin: `/\\*\\*`,
    ...
    constants: {
      patterns: [
        { comment: `ALL CAPS constants`, match: `\\b[A-Z]{2}[A-Z0-9_]*\\b`, name: `constant.other.caps.rust` },
        {
        ...
        { comment: `booleans`, match: `\\b(true|false)\\b`, name: `constant.language.bool.rust` },
      ],
    },
    escapes: {
      captures: {
    ...
    functions: {
      patterns: [{
        captures: { 1: { name: `keyword.other.rust` }, 2: { name: `punctuation.brackets.round.rust` } },
        ...
        beginCaptures: { 1: { name: `entity.name.function.rust` }, 2: { name: `punctuation.brackets.round.rust` } },
    ...
    gtypes: {
      patterns: [{ comment: `option types`, match: `\\b(Some|None)\\b`, name: `entity.name.type.option.rust` }, {
    ...
    keywords: {
      patterns: [
        ...
        { comment: `const keyword`, match: `\\b(const)\\b`, name: `storage.modifier.rust` },
        { comment: `type keyword`, match: `\\b(type)\\b`, name: `keyword.declaration.type.rust storage.type.rust` },
        { comment: `enum keyword`, match: `\\b(enum)\\b`, name: `keyword.declaration.enum.rust storage.type.rust` },
        { comment: `trait keyword`, match: `\\b(trait)\\b`, name: `keyword.declaration.trait.rust storage.type.rust` },
        {
          comment: `struct keyword`,
          match: `\\b(struct)\\b`,
          name: `keyword.declaration.struct.rust storage.type.rust`,
        },
        { comment: `storage modifiers`, match: `\\b(abstract|static)\\b`, name: `storage.modifier.rust` },
        {
        ...
        { comment: `fn`, match: `\\bfn\\b`, name: `keyword.other.fn.rust` },
        { comment: `crate`, match: `\\bcrate\\b`, name: `keyword.other.crate.rust` },
        { comment: `mut`, match: `\\bmut\\b`, name: `storage.modifier.mut.rust` },
        {
          comment: `logical operators`,
          match: `(\\^|\\||\\|\\||&&|<<|>>|!)(?!=)`,
          name: `keyword.operator.logical.rust`,
        },
        { comment: `logical AND, borrow references`, match: `&(?![&=])`, name: `keyword.operator.borrow.and.rust` },
        {
          comment: `assignment operators`,
          match: `(\\+=|-=|\\*=|/=|%=|\\^=|&=|\\|=|<<=|>>=)`,
          name: `keyword.operator.assignment.rust`,
        },
        { comment: `single equal`, match: `(?<![<>])=(?!=|>)`, name: `keyword.operator.assignment.equal.rust` },
        {
        ...
        { comment: `namespace operator`, match: `::`, name: `keyword.operator.namespace.rust` },
        {
          captures: { 1: { name: `keyword.operator.dereference.rust` } },
          comment: `dereference asterisk`,
          match: `(\\*)(?=\\w+)`,
        },
        { comment: `subpattern binding`, match: `@`, name: `keyword.operator.subpattern.rust` },
        { comment: `dot access`, match: `\\.(?!\\.)`, name: `keyword.operator.access.dot.rust` },
        { comment: `ranges, range patterns`, match: `\\.{2}(=|\\.)?`, name: `keyword.operator.range.rust` },
        { comment: `colon`, match: `:(?!:)`, name: `keyword.operator.key-value.rust` },
        { comment: `dashrocket, skinny arrow`, match: `->`, name: `keyword.operator.arrow.skinny.rust` },
        { comment: `hashrocket, fat arrow`, match: `=>`, name: `keyword.operator.arrow.fat.rust` },
        { comment: `dollar macros`, match: `\\$`, name: `keyword.operator.macro.dollar.rust` },
        {
    ...
    lvariables: {
      patterns: [{ comment: `self`, match: `\\b[Ss]elf\\b`, name: `variable.language.self.rust` }, {
        comment: `super`,
        match: `\\bsuper\\b`,
    ...
    macros: {
      patterns: [{
        captures: { 2: { name: `entity.name.function.macro.rust` }, 3: { name: `entity.name.type.macro.rust` } },
        comment: `macros`,
    ...
    namespaces: {
      patterns: [{
        captures: { 1: { name: `entity.name.namespace.rust` }, 2: { name: `keyword.operator.namespace.rust` } },
    ...
    punctuation: {
      patterns: [
        { comment: `comma`, match: `,`, name: `punctuation.comma.rust` },
        { comment: `curly braces`, match: `[{}]`, name: `punctuation.brackets.curly.rust` },
        { comment: `parentheses, round brackets`, match: `[()]`, name: `punctuation.brackets.round.rust` },
        { comment: `semicolon`, match: `;`, name: `punctuation.semi.rust` },
        { comment: `square brackets`, match: `[\\[\\]]`, name: `punctuation.brackets.square.rust` },
        { comment: `angle brackets`, match: `(?<!=)[<>]`, name: `punctuation.brackets.angle.rust` },
      ],
    },
    strings: {
      patterns: [{
        ...
        begin: `(b)?(')`,
        beginCaptures: { 1: { name: `string.quoted.byte.raw.rust` }, 2: { name: `punctuation.definition.char.rust` } },
    ...
    types: {
      patterns: [
        ...
        },
        {
          ...
          beginCaptures: { 1: { name: `entity.name.type.rust` }, 2: { name: `punctuation.brackets.angle.rust` } },
        ...
        { comment: `primitive types`, match: `\\b(bool|char|str)\\b`, name: `entity.name.type.primitive.rust` },
        {
          captures: {
        ...
        { comment: `types`, match: `\\b_?[A-Z][A-Za-z0-9_]*\\b(?!!)`, name: `entity.name.type.rust` },
      ],
    },
    variables: {
      patterns: [{
