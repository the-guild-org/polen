var e = `HTML`,
  ...
  i = {
      ...
      patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{
            ...
            patterns: [{
              ...
              endCaptures: { 0: { name: `punctuation.definition.string.end.html` }, 1: { name: `source.css` } },
        ...
        patterns: [{
          ...
          patterns: [{
            ...
            patterns: [{
              captures: { 0: { name: `source.js` }, 1: { patterns: [{ include: `source.js` }] } },
              match: `(([^\\s"'=<>\`/]|/(?!>))+)`,
              name: `string.unquoted.html`,
            }, {
              begin: `"`,
              ...
              endCaptures: { 0: { name: `punctuation.definition.string.end.html` }, 1: { name: `source.js` } },
              name: `string.quoted.double.html`,
              patterns: [
        ...
        beginCaptures: { 0: { name: `invalid.deprecated.entity.other.attribute-name.html` } },
        ...
        patterns: [{ include: `#attribute-interior` }],
      }, { match: `[^\\s>]+`, name: `invalid.illegal.character-not-allowed-here.html` }],
    },
    'attribute-interior': {
      patterns: [{
        begin: `=`,
        ...
        patterns: [{ match: `([^\\s"'=<>\`/]|/(?!>))+`, name: `string.unquoted.html` }, {
          begin: `"`,
          beginCaptures: { 0: { name: `punctuation.definition.string.begin.html` } },
          end: `"`,
    ...
    comment: {
      ...
      patterns: [{ match: `\\G-?>`, name: `invalid.illegal.characters-not-allowed-here.html` }, {
        match: `<!--(?!>)|<!-(?=-->)`,
        name: `invalid.illegal.characters-not-allowed-here.html`,
      }, { match: `--!>`, name: `invalid.illegal.characters-not-allowed-here.html` }],
    },
    'core-minus-invalid': {
    ...
    doctype: {
      ...
      patterns: [{ match: `\\G(?i:DOCTYPE)`, name: `entity.name.tag.html` }, {
        begin: `"`,
        end: `"`,
        name: `string.quoted.double.html`,
    ...
    entities: {
      patterns: [{
        captures: {
          ...
          912: { name: `punctuation.definition.entity.html` },
        },
...
`,
      ...
      }, { match: `&(?=[a-zA-Z0-9]+;)`, name: `invalid.illegal.ambiguous-ampersand.html` }],
    },
    math: {
      patterns: [{
        begin: `(?i)(<)(math)(?=\\s|/?>)(?:(([^"'>]|"[^"]*"|'[^']*')*)(>))?`,
        beginCaptures: {
          0: { name: `meta.tag.structure.$2.start.html` },
        ...
        endCaptures: {
          0: { name: `meta.tag.structure.$2.end.html` },
          1: { name: `punctuation.definition.tag.begin.html` },
          2: { name: `entity.name.tag.html` },
      ...
      repository: {
        ...
        tags: {
          patterns: [{ include: `#comment` }, { include: `#cdata` }, {
            captures: {
              0: { name: `meta.tag.structure.math.$2.void.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            begin:
              `(?i)(<)(annotation|annotation-xml|semantics|menclose|merror|mfenced|mfrac|mpadded|mphantom|mroot|mrow|msqrt|mstyle|mmultiscripts|mover|mprescripts|msub|msubsup|msup|munder|munderover|none|mlabeledtr|mtable|mtd|mtr|mlongdiv|mscarries|mscarry|msgroup|msline|msrow|mstack|maction)(?=\\s|/?>)(?:(([^"'>]|"[^"]*"|'[^']*')*)(>))?`,
            beginCaptures: {
              0: { name: `meta.tag.structure.math.$2.start.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            endCaptures: {
              0: { name: `meta.tag.structure.math.$2.end.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `punctuation.definition.tag.end.html` },
            ...
            captures: {
              0: { name: `meta.tag.inline.math.$2.void.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            begin:
              `(?i)(<)(mi|mn|mo|ms|mspace|mtext|maligngroup|malignmark)(?=\\s|/?>)(?:(([^"'>]|"[^"]*"|'[^']*')*)(>))?`,
            beginCaptures: {
              0: { name: `meta.tag.inline.math.$2.start.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            endCaptures: {
              0: { name: `meta.tag.inline.math.$2.end.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `punctuation.definition.tag.end.html` },
              4: { name: `punctuation.definition.tag.end.html` },
            ...
            captures: {
              0: { name: `meta.tag.object.math.$2.void.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            begin: `(?i)(<)(mglyph)(?=\\s|/?>)(?:(([^"'>]|"[^"]*"|'[^']*')*)(>))?`,
            beginCaptures: {
              0: { name: `meta.tag.object.math.$2.start.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            endCaptures: {
              0: { name: `meta.tag.object.math.$2.end.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `punctuation.definition.tag.end.html` },
              4: { name: `punctuation.definition.tag.end.html` },
            ...
            captures: {
              0: { name: `meta.tag.other.invalid.void.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
            ...
            begin: `(?i)(<)((\\w[^\\s>]*))(?=\\s|/?>)(?:(([^"'>]|"[^"]*"|'[^']*')*)(>))?`,
            beginCaptures: {
              0: { name: `meta.tag.other.invalid.start.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `invalid.illegal.unrecognized-tag.html` },
              4: { patterns: [{ include: `#attribute` }] },
            ...
            endCaptures: {
              0: { name: `meta.tag.other.invalid.end.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `invalid.illegal.unrecognized-tag.html` },
              4: { name: `punctuation.definition.tag.end.html` },
    ...
    svg: {
      ...
      repository: {
        ...
        tags: {
          patterns: [{ include: `#comment` }, { include: `#cdata` }, {
            captures: {
              0: { name: `meta.tag.metadata.svg.$2.void.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            begin:
              `(?i)(<)(color-profile|desc|metadata|script|style|title)(?=\\s|/?>)(?:(([^"'>]|"[^"]*"|'[^']*')*)(>))?`,
            beginCaptures: {
              0: { name: `meta.tag.metadata.svg.$2.start.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            endCaptures: {
              0: { name: `meta.tag.metadata.svg.$2.end.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `punctuation.definition.tag.end.html` },
              4: { name: `punctuation.definition.tag.end.html` },
            ...
            captures: {
              0: { name: `meta.tag.structure.svg.$2.void.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            begin:
              `(?i)(<)(animateMotion|clipPath|defs|feComponentTransfer|feDiffuseLighting|feMerge|feSpecularLighting|filter|g|hatch|linearGradient|marker|mask|mesh|meshgradient|meshpatch|meshrow|pattern|radialGradient|switch|text|textPath)(?=\\s|/?>)(?:(([^"'>]|"[^"]*"|'[^']*')*)(>))?`,
            beginCaptures: {
              0: { name: `meta.tag.structure.svg.$2.start.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            endCaptures: {
              0: { name: `meta.tag.structure.svg.$2.end.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `punctuation.definition.tag.end.html` },
              4: { name: `punctuation.definition.tag.end.html` },
            ...
            captures: {
              0: { name: `meta.tag.inline.svg.$2.void.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            begin:
              `(?i)(<)(a|animate|discard|feBlend|feColorMatrix|feComposite|feConvolveMatrix|feDisplacementMap|feDistantLight|feDropShadow|feFlood|feFuncA|feFuncB|feFuncG|feFuncR|feGaussianBlur|feMergeNode|feMorphology|feOffset|fePointLight|feSpotLight|feTile|feTurbulence|hatchPath|mpath|set|solidcolor|stop|tspan)(?=\\s|/?>)(?:(([^"'>]|"[^"]*"|'[^']*')*)(>))?`,
            beginCaptures: {
              0: { name: `meta.tag.inline.svg.$2.start.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            endCaptures: {
              0: { name: `meta.tag.inline.svg.$2.end.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `punctuation.definition.tag.end.html` },
              4: { name: `punctuation.definition.tag.end.html` },
            ...
            captures: {
              0: { name: `meta.tag.object.svg.$2.void.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            beginCaptures: {
              0: { name: `meta.tag.object.svg.$2.start.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { patterns: [{ include: `#attribute` }] },
              5: { name: `punctuation.definition.tag.end.html` },
            ...
            endCaptures: {
              0: { name: `meta.tag.object.svg.$2.end.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `punctuation.definition.tag.end.html` },
              4: { name: `punctuation.definition.tag.end.html` },
            ...
            captures: {
              0: { name: `meta.tag.other.svg.$2.void.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `invalid.deprecated.html` },
              4: { patterns: [{ include: `#attribute` }] },
              6: { name: `punctuation.definition.tag.end.html` },
            },
            match:
            ...
            begin:
              `(?i)(<)((altGlyph|altGlyphDef|altGlyphItem|animateColor|animateTransform|cursor|font|font-face|font-face-format|font-face-name|font-face-src|font-face-uri|glyph|glyphRef|hkern|missing-glyph|tref|vkern))(?=\\s|/?>)(?:(([^"'>]|"[^"]*"|'[^']*')*)(>))?`,
            beginCaptures: {
              0: { name: `meta.tag.other.svg.$2.start.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `invalid.deprecated.html` },
              4: { patterns: [{ include: `#attribute` }] },
            ...
            endCaptures: {
              0: { name: `meta.tag.other.svg.$2.end.html` },
              1: { name: `punctuation.definition.tag.begin.html` },
              2: { name: `entity.name.tag.html` },
              3: { name: `invalid.deprecated.html` },
              4: { name: `punctuation.definition.tag.end.html` },
...
[\\s"'>]
                ...
                patterns: [{
                  ...
                  name: `meta.tag.metadata.script.start.html`,
                  patterns: [{ include: `#attribute` }],
                }, { begin: `(?!\\G)`, end: `(?=</(?i:script))`, name: `source.unknown` }],
              }],
            }],
          }],
        },
        ...
        },
        {
          ...
          beginCaptures: {
            1: { name: `punctuation.definition.tag.begin.html` },
            2: { name: `entity.name.tag.html` },
            3: { name: `invalid.illegal.no-longer-supported.html` },
          },
          end: `>`,
          endCaptures: { 0: { name: `punctuation.definition.tag.end.html` } },
    ...
    'xml-processing': {
      begin: `(<\\?)(xml)`,
      captures: { 1: { name: `punctuation.definition.tag.html` }, 2: { name: `entity.name.tag.html` } },
      end: `(\\?>)`,
