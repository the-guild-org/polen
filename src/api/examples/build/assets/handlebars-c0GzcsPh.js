  ...
  r = {
    block_comments: {
      patterns: [{
        ...
        patterns: [{ match: `@\\w*`, name: `keyword.annotation.handlebars` }, { include: `#comments` }],
      }, {
        begin: `<!--`,
        captures: { 0: { name: `punctuation.definition.comment.html` } },
        end: `-{2,3}\\s*>`,
        name: `comment.block.html`,
        patterns: [{ match: `--`, name: `invalid.illegal.bad-comments-or-CDATA.html` }],
      }],
    },
    block_helper: {
      begin:
      ...
      beginCaptures: {
        ...
        3: { name: `support.constant.handlebars keyword.control` },
        4: { name: `variable.parameter.handlebars` },
        5: { name: `support.constant.handlebars` },
        6: { name: `variable.parameter.handlebars` },
        7: { name: `support.constant.handlebars` },
      },
      end: `(~?\\}\\})`,
      endCaptures: { 1: { name: `support.constant.handlebars` } },
      name: `meta.function.block.start.handlebars`,
      patterns: [{ include: `#string` }, { include: `#handlebars_attribute` }],
    },
    comments: {
      patterns: [{
        begin: `\\{\\{!`,
    ...
    else_token: {
      ...
      beginCaptures: {
        1: { name: `support.constant.handlebars` },
        2: { name: `support.constant.handlebars keyword.control` },
        3: { name: `support.constant.handlebars` },
        4: { name: `variable.parameter.handlebars` },
      },
      end: `(~?\\}\\}\\}*)`,
      endCaptures: { 1: { name: `support.constant.handlebars` } },
    ...
    extends: {
      patterns: [{
        begin: `(\\{\\{!<)\\s([-a-zA-Z0-9_\\./]+)`,
        beginCaptures: { 1: { name: `support.function.handlebars` }, 2: { name: `support.class.handlebars` } },
        end: `(\\}\\})`,
        endCaptures: { 1: { name: `support.function.handlebars` } },
        name: `meta.preprocessor.handlebars`,
      }],
    },
    handlebars_attribute: {
      patterns: [{ include: `#handlebars_attribute_name` }, { include: `#handlebars_attribute_value` }],
    },
    ...
    html_tags: {
      patterns: [
        ...
        },
        {
          ...
          captures: { 1: { name: `punctuation.definition.tag.html` }, 2: { name: `entity.name.tag.block.any.html` } },
          end: `(>)`,
        ...
        },
        {
          ...
          captures: { 1: { name: `punctuation.definition.tag.html` }, 2: { name: `entity.name.tag.inline.any.html` } },
          end: `((?: ?/)?>)`,
        ...
        {
          begin: `(</?)([a-zA-Z0-9:-]+)`,
          captures: { 1: { name: `punctuation.definition.tag.html` }, 2: { name: `entity.name.tag.other.html` } },
          end: `(>)`,
        ...
        {
          begin: `(</?)([a-zA-Z0-9{}:-]+)`,
          captures: { 1: { name: `punctuation.definition.tag.html` }, 2: { name: `entity.name.tag.tokenised.html` } },
          end: `(>)`,
    ...
    partial_and_var: {
      begin: `(\\{\\{~?\\{*(>|!<)*)\\s*(@?[-a-zA-Z0-9$_\\./]+)*`,
      beginCaptures: { 1: { name: `support.constant.handlebars` }, 3: { name: `variable.parameter.handlebars` } },
      end: `(~?\\}\\}\\}*)`,
      endCaptures: { 1: { name: `support.constant.handlebars` } },
      name: `meta.function.inline.other.handlebars`,
      patterns: [{ include: `#string` }, { include: `#handlebars_attribute` }],
    },
    string: { patterns: [{ include: `#string-single-quoted` }, { include: `#string-double-quoted` }] },
