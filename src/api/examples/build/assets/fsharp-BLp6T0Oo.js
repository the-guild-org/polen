var e = `F#`,
  ...
  r = {
    abstract_definition: {
      ...
      patterns: [{ include: `#comments` }, { include: `#common_declaration` }, {
        captures: {
    ...
    anonymous_record_declaration: {
      ...
      patterns: [
        { captures: { 1: { name: `keyword.symbol.fsharp` } }, match: "[[:alpha:]0-9'`^_ ]+(:)" },
        { captures: { 1: { name: `entity.name.type.fsharp` } }, match: "([[:alpha:]0-9'`^_ ]+)" },
    ...
    comments: {
      patterns: [{
        ...
        patterns: [{
          comments:
            `Capture // when inside of (* *) like that the rule which capture comments starting by // is not trigger. See https://github.com/ionide/ionide-fsgrammar/issues/155`,
          match: `//`,
    ...
    common_binding_definition: {
      patterns: [
        ...
        { include: `#attributes` },
        {
          ...
          endCaptures: { 1: { name: `keyword.symbol.fsharp` } },
          patterns: [{ captures: { 1: { name: `entity.name.type.fsharp` } }, match: `(\\^[[:alpha:]0-9'._]+)` }, {
            include: `#variables`,
          }, { include: `#keywords` }],
        },
        {
          begin: `(:)\\s*(\\()`,
          beginCaptures: { 1: { name: `keyword.symbol.fsharp` }, 2: { name: `keyword.symbol.fsharp` } },
          end: "(\\)\\s*(([?[:alpha:]0-9'`^._ ]*)))",
          endCaptures: { 1: { name: `keyword.symbol.fsharp` }, 2: { name: `entity.name.type.fsharp` } },
        ...
        },
        {
          ...
          endCaptures: { 1: { name: `keyword.symbol.fsharp` } },
          patterns: [{ match: `\\b(and|when|or)\\b`, name: `keyword.fsharp` }, {
            captures: { 1: { name: `entity.name.type.fsharp` } },
            comment:
              `Because we first capture the keywords, we can capture what looks like a word and assume it's an entity definition`,
            match: `([[:alpha:]0-9'^._]+)`,
          }, { match: `(\\(|\\))`, name: `keyword.symbol.fsharp` }],
        },
        {
          captures: { 1: { name: `keyword.symbol.fsharp` }, 2: { name: `entity.name.type.fsharp` } },
          match: "(:)\\s*([?[:alpha:]0-9'`^._ ]+)",
        },
        {
          captures: {
        ...
        {
          begin: "(\\*)(\\s*([?[:alpha:]0-9'`^._ ]+))*",
          beginCaptures: { 1: { name: `keyword.symbol.fsharp` }, 2: { name: `entity.name.type.fsharp` } },
          end: `(?==)|(?=\\))`,
          endCaptures: { 1: { name: `keyword.symbol.fsharp` } },
          patterns: [{ include: `#tuple_signature` }],
        },
    ...
    common_declaration: {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.symbol.arrow.fsharp` }, 2: { name: `entity.name.type.fsharp` } },
    ...
    definition: {
      patterns: [{
        ...
        endCaptures: { 2: { name: `keyword.fsharp` }, 3: { name: `keyword.symbol.fsharp` } },
        name: `binding.fsharp`,
        ...
        begin: `\\b(new)\\b\\s+(\\()`,
        beginCaptures: { 1: { name: `keyword.fsharp` }, 2: { name: `keyword.symbol.fsharp` } },
        end: `(\\))`,
        endCaptures: { 1: { name: `keyword.symbol.fsharp` } },
        name: `binding.fsharp`,
        patterns: [{ include: `#common_binding_definition` }],
    ...
    modules: {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.fsharp` }, 2: { name: `entity.name.section.fsharp` } },
        end: `(\\s|$)`,
      ...
      patterns: [{
        ...
        patterns: [
          { include: `#comments` },
          {
            ...
            beginCaptures: { 3: { name: `keyword.fsharp` }, 4: { name: `keyword.symbol.fsharp` } },
            end: `$|(;|\\})`,
            endCaptures: { 1: { name: `keyword.symbol.fsharp` } },
            patterns: [{ include: `#comments` }, {
              captures: { 1: { name: `entity.name.type.fsharp` } },
    ...
    record_signature: {
      patterns: [{
        captures: { 1: { name: `keyword.symbol.fsharp` }, 2: { name: `variable.parameter.fsharp` } },
        match: "[[:alpha:]0-9'`^_ ]+(=)([[:alpha:]0-9'`^_ ]+)",
      }, {
        begin: `({)`,
        beginCaptures: { 1: { name: `keyword.symbol.fsharp` } },
    ...
    records: {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.fsharp` }, 2: { name: `storage.modifier.fsharp` } },
        ...
        patterns: [
          ...
          },
          {
            ...
            patterns: [{
              ...
              endCaptures: { 1: { name: `keyword.symbol.fsharp` } },
              patterns: [{ captures: { 1: { name: `keyword.fsharp` } }, match: `(static member|member|new)` }, {
          ...
          { captures: { 1: { name: `storage.modifier.fsharp` } }, match: `\\s*(private|internal|public)` },
          {
            begin: `(\\()`,
            beginCaptures: { 1: { name: `keyword.symbol.fsharp` } },
            end: `\\s*(?=(=)|[\\n=]|(\\(\\))|(as))`,
    ...
    strings: {
      patterns: [{
        ...
        patterns: [{ match: `"(")`, name: `constant.character.string.escape.fsharp` }],
      }, {
        begin: `(?=[^\\\\])(""")`,
        beginCaptures: { 1: { name: `punctuation.definition.string.begin.fsharp` } },
        end: `(""")`,
        ...
        patterns: [{ match: `\\\\$[ \\t]*`, name: `punctuation.separator.string.ignore-eol.fsharp` }, {
          match:
    ...
    variables: {
      patterns: [{ match: `\\(\\)`, name: `keyword.symbol.fsharp` }, {
        captures: { 1: { name: `keyword.symbol.fsharp` }, 2: { name: `variable.parameter.fsharp` } },
  ...
  i = `source.fsharp`,
  a = { displayName: `F#`, name: t, patterns: n, repository: r, scopeName: i }
