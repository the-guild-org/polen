var e = `AppleScript`,
  t = [`applescript`, `scpt`, `script editor`],
  n = `^#!.*(osascript)`,
  r = `applescript`,
  i = [{ include: `#blocks` }, { include: `#inline` }],
  a = {
    'attributes.considering-ignoring': {
      patterns: [{ match: `,`, name: `punctuation.separator.array.attributes.applescript` }, {
        match: `\\b(and)\\b`,
      ...
      }, { match: `\\b(?i:application\\s+responses)\\b`, name: `constant.other.attributes.application.applescript` }],
    },
    blocks: {
      patterns: [
        {
...
`,
    ...
    'blocks.other': {
      patterns: [{
        ...
        patterns: [
          ...
          { match: `\\b(else\\s+if)\\b`, name: `keyword.control.else-if.applescript` },
    ...
    'blocks.repeat': {
      patterns: [{
        ...
        patterns: [{ match: `\\b(from|to|by)\\b`, name: `keyword.control.modifier.range.applescript` }, {
          match: `\\b(in)\\b`,
        ...
        patterns: [{ match: `\\b(times)\\b`, name: `keyword.control.times.applescript` }, { include: `$self` }],
      }],
    },
    'blocks.statement': {
      patterns: [{
        ...
        patterns: [{ match: `:`, name: `punctuation.separator.key-value.property.applescript` }, {
          include: `#inline`,
        }],
      }, {
        ...
        patterns: [{ match: `,`, name: `punctuation.separator.variables.local.applescript` }, {
          match: `\\b\\w+`,
        ...
        patterns: [{ match: `,`, name: `punctuation.separator.variables.global.applescript` }, {
          match: `\\b\\w+`,
        ...
        patterns: [
          { match: `\\b(number|partial|from|to)\\b`, name: `keyword.control.exception.modifier.applescript` },
          { include: `#inline` },
        ],
      }, {
    ...
    'blocks.tell': {
      patterns: [{
        ...
        patterns: [{ include: `#textmate` }, { include: `#standard-suite` }, { include: `$self` }],
      }, {
        ...
        patterns: [{ include: `#finder` }, { include: `#standard-suite` }, { include: `$self` }],
      }, {
        ...
        patterns: [{ include: `#system-events` }, { include: `#standard-suite` }, { include: `$self` }],
      }, {
        ...
        patterns: [{ include: `#itunes` }, { include: `#standard-suite` }, { include: `$self` }],
      }, {
    ...
    'built-in.constant': {
      patterns: [
        ...
        { match: `\\b(?i:null|missing\\s+value)\\b`, name: `constant.language.null.applescript` },
        { match: `-?\\b\\d+((\\.(\\d+\\b)?)?(?i:e\\+?\\d*\\b)?|\\b)`, name: `constant.numeric.applescript` },
        { match: `\\b(?i:space|tab|return|linefeed|quote)\\b`, name: `constant.other.text.applescript` },
        {
          match:
    ...
    'built-in.keyword': {
      patterns: [
        { match: `(&|\\*|\\+|-|/|÷|\\^)`, name: `keyword.operator.arithmetic.applescript` },
        { match: `(=|≠|>|<|≥|>=|≤|<=)`, name: `keyword.operator.comparison.applescript` },
        {
          match: `(?ix)\\b
...
\\b`,
        ...
        { match: `\\b(?i:continue|return|exit(\\s+repeat)?)\\b`, name: `keyword.control.loop.applescript` },
        {
          match:
    ...
    'built-in.punctuation': {
      patterns: [{ match: `¬`, name: `punctuation.separator.continuation.line.applescript` }, {
        comment: `the : in property assignments`,
        match: `:`,
        name: `punctuation.separator.key-value.property.applescript`,
      }, { comment: `the parentheses in groups`, match: `[()]`, name: `punctuation.section.group.applescript` }],
    },
    'built-in.support': {
      patterns: [
        {
        ...
        { match: `\\b(?i:get|run)\\b`, name: `support.function.built-in.applescript` },
        {
          match: `\\b(?i:anything|data|text|upper\\s+case|propert(y|ies))\\b`,
          name: `support.class.built-in.applescript`,
        },
        { match: `\\b(?i:alias|class)(es)?\\b`, name: `support.class.built-in.applescript` },
        {
          match:
...
\\b`,
        ...
        { match: `\\b(?i:seconds|minutes|hours|days)\\b`, name: `support.class.built-in.time.applescript` },
      ],
    },
    comments: {
      patterns: [{
        ...
        begin: `(^[ \\t]+)?(?=#)`,
        beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.applescript` } },
        end: `(?!\\G)`,
        patterns: [{
          begin: `#`,
          beginCaptures: { 0: { name: `punctuation.definition.comment.applescript` } },
          end: `\\n`,
          name: `comment.line.number-sign.applescript`,
        }],
      }, {
    ...
    'comments.nested': {
      patterns: [{
        begin: `\\(\\*`,
        beginCaptures: { 0: { name: `punctuation.definition.comment.begin.applescript` } },
        end: `\\*\\)`,
        endCaptures: { 0: { name: `punctuation.definition.comment.end.applescript` } },
        name: `comment.block.applescript`,
        patterns: [{ include: `#comments.nested` }],
      }],
    },
    'data-structures': {
      patterns: [{
        begin: `\\{`,
        beginCaptures: { 0: { name: `punctuation.definition.array.begin.applescript` } },
        comment: `We cannot necessarily distinguish "records" from "arrays", and so this could be either.`,
        end: `\\}`,
        endCaptures: { 0: { name: `punctuation.definition.array.end.applescript` } },
        ...
        patterns: [{ match: `\\\\.`, name: `constant.character.escape.applescript` }],
      }, {
        begin: `(")`,
        captures: { 1: { name: `punctuation.definition.string.applescript` } },
        end: `(")`,
    ...
    inline: {
      patterns: [{ include: `#comments` }, { include: `#data-structures` }, { include: `#built-in` }, {
    ...
    'standard-suite': {
      patterns: [
        { match: `\\b(colors?|documents?|items?|windows?)\\b`, name: `support.class.standard-suite.applescript` },
        {
        ...
        { match: `\\b(name|frontmost|version)\\b`, name: `support.constant.standard-suite.applescript` },
        { match: `\\b(selection)\\b`, name: `support.variable.standard-suite.applescript` },
        {
    ...
    standardadditions: {
      patterns: [
        { match: `\\b((alert|dialog) reply)\\b`, name: `support.class.standardadditions.user-interaction.applescript` },
        { match: `\\b(file information)\\b`, name: `support.class.standardadditions.file.applescript` },
        {
    ...
    'system-events': {
      patterns: [
        { match: `\\b(audio (data|file))\\b`, name: `support.class.system-events.audio-file.applescript` },
        {
          match:
        ...
        { match: `\\b(delete|open|move)\\b`, name: `support.function.system-events.disk-folder-file.applescript` },
        { match: `\\b(folder actions?|scripts?)\\b`, name: `support.class.system-events.folder-actions.applescript` },
        {
        ...
        { match: `\\b(movie data|movie file)\\b`, name: `support.class.system-events.movie-file.applescript` },
        { match: `\\b(log out|restart|shut down|sleep)\\b`, name: `support.function.system-events.power.applescript` },
        {
          match:
        ...
        { match: `\\b(property list (file|item))\\b`, name: `support.class.system-events.property-list.applescript` },
        {
        ...
        { match: `\\b(XML (attribute|data|element|file)s?)\\b`, name: `support.class.system-events.xml.applescript` },
        { match: `\\b(print settings|users?|login items?)\\b`, name: `support.class.sytem-events.other.applescript` },
      ],
    },
    textmate: {
      patterns: [{ match: `\\b(print settings)\\b`, name: `support.class.textmate.applescript` }, {
        match: `\\b(get url|insert|reload bundles)\\b`,
        name: `support.function.textmate.applescript`,
      }],
    },
  },
  o = `source.applescript`,
  s = { displayName: e, fileTypes: t, firstLineMatch: n, name: r, patterns: i, repository: a, scopeName: o }
export {
  a as repository,
  e as displayName,
  i as patterns,
