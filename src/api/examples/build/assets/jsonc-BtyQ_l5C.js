var e = `JSON with Comments`,
  ...
  r = {
    array: {
      ...
      patterns: [{ include: `#value` }, { match: `,`, name: `punctuation.separator.array.json.comments` }, {
        match: `[^\\s\\]]`,
    ...
    constant: { match: `\\b(?:true|false|null)\\b`, name: `constant.language.json.comments` },
    number: {
      match: `(?x)
-?
(?:
...
\\d+
    ...
    object: {
      ...
      }, { match: `[^\\s\\}]`, name: `invalid.illegal.expected-dictionary-separator.json.comments` }],
    },
    objectkey: {
      begin: `"`,
...
[0-9a-fA-F]{4})`,
      ...
      }, { match: `\\\\.`, name: `invalid.illegal.unrecognized-string-escape.json.comments` }],
    },
    value: {
