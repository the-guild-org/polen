var e = `Less`,
  ...
  r = {
    'angle-type': {
      captures: { 1: { name: `keyword.other.unit.less` } },
      match: `(?i:[-+]?(?:(?:\\d*\\.\\d+(?:[eE](?:[-+]?\\d+))*)|(?:[-+]?\\d+))(deg|grad|rad|turn))\\b`,
      name: `constant.numeric.less`,
    },
    'arbitrary-repetition': {
      captures: { 1: { name: `punctuation.definition.arbitrary-repetition.less` } },
      match: `\\s*(?:(,))`,
    },
    'at-charset': {
      begin: `\\s*((@)charset\\b)\\s*`,
    ...
    'at-counter-style': {
      begin:
        `\\s*((@)counter-style\\b)\\s+(?:(?i:\\b(decimal|none)\\b)|(-?(?:[[_a-zA-Z][^\\x{00}-\\x{7F}]]|(?:\\\\\\h{1,6}[\\s\\t\\n\\f]?|\\\\[^\\n\\f\\h]))(?:[[-\\w][^\\x{00}-\\x{7F}]]|(?:\\\\\\h{1,6}[\\s\\t\\n\\f]?|\\\\[^\\n\\f\\h]))*))\\s*(?=\\{|$)`,
      captures: {
      ...
      endCaptures: { 1: { name: `punctuation.definition.block.begin.less` } },
      name: `meta.at-rule.counter-style.less`,
      patterns: [{ include: `#comment-block` }, { include: `#rule-list` }],
    },
    'at-custom-media': {
      begin: `(?=\\s*@custom-media\\b)`,
      end: `\\s*(?=;)`,
      name: `meta.at-rule.custom-media.less`,
      patterns: [{ captures: { 0: { name: `punctuation.section.property-list.less` } }, match: `\\s*;` }, {
        captures: {
    ...
    'at-font-face': {
      ...
      endCaptures: { 1: { name: `punctuation.definition.block.end.less` } },
    ...
    'at-import': {
      ...
      endCaptures: { 0: { name: `punctuation.terminator.rule.less` } },
      name: `meta.at-rule.import.less`,
      patterns: [{ include: `#url-function` }, { include: `#less-variables` }, {
        begin: `(?<=(["'])|(["']\\)))\\s*`,
        end: `\\s*(?=\\;)`,
        patterns: [{ include: `#media-query` }],
      }, {
        begin: `\\(`,
        beginCaptures: { 0: { name: `punctuation.definition.group.begin.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
    ...
    'at-keyframes': {
      ...
      patterns: [{
        begin: `\\s*(\\{)`,
        beginCaptures: { 1: { name: `punctuation.definition.block.begin.less` } },
        end: `(?=\\})`,
        patterns: [{
          captures: {
        ...
        patterns: [{ include: `#keyframe-name` }, { include: `#arbitrary-repetition` }],
      }],
    },
    'at-media': {
      begin: `(?=\\s*@media\\b)`,
      ...
      patterns: [{
        ...
        patterns: [{ include: `#rule-list-body` }, { include: `$self` }],
      }],
    },
    'at-namespace': {
      begin: `\\s*((@)namespace)\\s+`,
      ...
      patterns: [{ include: `#url-function` }, { include: `#literal-string` }, {
        match:
    ...
    'at-supports': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#at-supports-operators` }, { include: `#at-supports-parens` }],
      }, {
        begin: `\\s*(\\{)`,
        beginCaptures: { 1: { name: `punctuation.section.property-list.begin.less` } },
        end: `(?=\\})`,
        patterns: [{ include: `#rule-list-body` }, { include: `$self` }],
      }],
    },
    'at-supports-operators': { match: `\\b(?:and|or|not)\\b`, name: `keyword.operator.logic.less` },
    'at-supports-parens': {
      begin: `\\(`,
      beginCaptures: { 0: { name: `punctuation.definition.group.begin.less` } },
      end: `\\)`,
    ...
    'at-viewport': {
      ...
      endCaptures: { 0: { name: `punctuation.definition.block.end.less` } },
      name: `meta.at-rule.viewport.less`,
      patterns: [{
        begin: `\\{`,
        captures: { 0: { name: `punctuation.definition.block.begin.less` } },
        end: `(?=\\})`,
        name: `meta.block.less`,
        patterns: [{ include: `#rule-list-body` }],
      }],
    },
    'attr-function': {
      begin: `\\b(attr)(?=\\()`,
      beginCaptures: { 1: { name: `support.function.filter.less` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
      ...
      patterns: [{
        ...
        patterns: [{ include: `#qualified-name` }, { include: `#literal-string` }, {
          begin:
            `(-?(?:[[_a-zA-Z][^\\x{00}-\\x{7F}]]|(?:\\\\\\h{1,6}[\\s\\t\\n\\f]?|\\\\[^\\n\\f\\h]))(?:[[-\\w][^\\x{00}-\\x{7F}]]|(?:\\\\\\h{1,6}[\\s\\t\\n\\f]?|\\\\[^\\n\\f\\h]))*)`,
          end: `(?=\\))`,
          ...
          patterns: [
            {
              match:
                `(?x)\\b((?i:em|ex|ch|rem)|(?i:vw|vh|vmin|vmax)|(?i:cm|mm|q|in|pt|pc|px|fr)|(?i:deg|grad|rad|turn)|(?i:s|ms)|(?i:Hz|kHz)|(?i:dpi|dpcm|dppx))\\b`,
    ...
    'calc-function': {
      begin: `\\b(calc)(?=\\()`,
      beginCaptures: { 1: { name: `support.function.calc.less` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
      name: `meta.function-call.less`,
      patterns: [{
    ...
    'color-adjuster-operators': { match: `[\\-\\+*](?=\\s+)`, name: `keyword.operator.less` },
    'color-functions': {
      patterns: [{
        begin: `\\b(rgba?)(?=\\()`,
        beginCaptures: { 1: { name: `support.function.color.less` } },
        comment: `rgb(), rgba()`,
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        ...
        patterns: [{
          ...
          patterns: [{ include: `#color-values` }, { include: `#comma-delimiter` }],
        }],
      }, { include: `#less-color-functions` }],
    },
    'color-values': {
      patterns: [{ include: `#color-functions` }, { include: `#less-functions` }, { include: `#less-variables` }, {
        include: `#var-function`,
      }, {
        match:
        ...
        captures: { 1: { name: `punctuation.definition.constant.less` } },
        match: `(#)(\\h{3}|\\h{4}|\\h{6}|\\h{8})\\b`,
        name: `constant.other.color.rgb-value.less`,
      }, { include: `#relative-color` }],
    },
    'comma-delimiter': { captures: { 1: { name: `punctuation.separator.less` } }, match: `\\s*(,)\\s*` },
    'comment-block': {
      patterns: [{
        begin: `/\\*`,
        captures: { 0: { name: `punctuation.definition.comment.less` } },
        end: `\\*/`,
        name: `comment.block.less`,
      }, { include: `#comment-line` }],
    },
    'comment-line': {
      captures: { 1: { name: `punctuation.definition.comment.less` } },
      match: `(//).*$\\n?`,
    ...
    'counter-functions': {
      patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{ include: `#less-strings` }, { include: `#less-variables` }, { include: `#var-function` }, {
            match:
            ...
            patterns: [{ include: `#comma-delimiter` }, {
              match:
                `\\b((?xi:arabic-indic|armenian|bengali|cambodian|circle|cjk-decimal|cjk-earthly-branch|cjk-heavenly-stem|decimal-leading-zero|decimal|devanagari|disclosure-closed|disclosure-open|disc|ethiopic-numeric|georgian|gujarati|gurmukhi|hebrew|hiragana-iroha|hiragana|japanese-formal|japanese-informal|kannada|katakana-iroha|katakana|khmer|korean-hangul-formal|korean-hanja-formal|korean-hanja-informal|lao|lower-alpha|lower-armenian|lower-greek|lower-latin|lower-roman|malayalam|mongolian|myanmar|oriya|persian|simp-chinese-formal|simp-chinese-informal|square|tamil|telugu|thai|tibetan|trad-chinese-formal|trad-chinese-informal|upper-alpha|upper-armenian|upper-latin|upper-roman)|none)\\b`,
    ...
    'cross-fade-function': {
      patterns: [{
        begin: `\\b(cross-fade)(?=\\()`,
        beginCaptures: { 1: { name: `support.function.image.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
    ...
    'cubic-bezier-function': {
      ...
      beginCaptures: {
        1: { name: `support.function.timing.less` },
    ...
    dimensions: {
      patterns: [{ include: `#angle-type` }, { include: `#frequency-type` }, { include: `#time-type` }, {
        include: `#length-type`,
    ...
    'filter-function': {
      ...
      patterns: [{
        ...
        name: `meta.group.less`,
        patterns: [{ include: `#comma-delimiter` }, { include: `#image-type` }, { include: `#literal-string` }, {
          include: `#filter-functions`,
        }],
      }],
    },
    'filter-functions': {
      patterns: [{ include: `#less-functions` }, {
        begin: `\\b(blur)(?=\\()`,
        beginCaptures: { 1: { name: `support.function.filter.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        ...
        patterns: [{
          ...
          patterns: [{ include: `#percentage-type` }, { include: `#number-type` }, { include: `#less-functions` }],
        }],
      }, {
        begin: `\\b(drop-shadow)(?=\\()`,
        beginCaptures: { 1: { name: `support.function.filter.less` } },
        ...
        patterns: [{
          ...
          patterns: [{ include: `#length-type` }, { include: `#color-values` }],
        }],
      }, {
        begin: `\\b(hue-rotate)(?=\\()`,
        beginCaptures: { 1: { name: `support.function.filter.less` } },
        ...
        patterns: [{
          ...
          patterns: [{ include: `#angle-type` }],
        }],
      }],
    },
    'fit-content-function': {
      begin: `\\b(fit-content)(?=\\()`,
      beginCaptures: { 1: { name: `support.function.grid.less` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
      name: `meta.function-call.less`,
      patterns: [{
        ...
        patterns: [{ include: `#less-variables` }, { include: `#var-function` }, { include: `#calc-function` }, {
          include: `#length-type`,
        }, { include: `#percentage-type` }],
      }],
    },
    'format-function': {
      patterns: [{
        begin: `\\b(format)(?=\\()`,
        beginCaptures: { 0: { name: `support.function.format.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
    ...
    'gradient-functions': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `support.function.gradient.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [
            ...
            { include: `#length-type` },
            { include: `#comma-delimiter` },
            { match: `\\bto\\b`, name: `keyword.other.less` },
            { match: `\\b(top|right|bottom|left)\\b`, name: `support.constant.property-value.less` },
          ],
        }],
      }, {
        ...
        patterns: [{
          ...
          patterns: [
            ...
            { include: `#length-type` },
            { include: `#comma-delimiter` },
            { match: `\\b(at|circle|ellipse)\\b`, name: `keyword.other.less` },
            {
    ...
    'grid-repeat-function': {
      ...
      patterns: [{
        ...
        patterns: [
          ...
          { match: `\\b(auto-(fill|fit))\\b`, name: `support.keyword.repetitions.less` },
          { match: `\\b(((max|min)-content)|auto)\\b`, name: `support.constant.property-value.less` },
        ],
      }],
    },
    'image-function': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#image-type` }, { include: `#literal-string` }, { include: `#color-values` }, {
          include: `#comma-delimiter`,
        }, { include: `#unquoted-string` }],
      }],
    },
    'image-type': {
      patterns: [{ include: `#cross-fade-function` }, { include: `#gradient-functions` }, {
        include: `#image-function`,
      }, { include: `#url-function` }],
    },
    important: {
      captures: { 1: { name: `punctuation.separator.less` } },
      match: `(\\!)\\s*important`,
      name: `keyword.other.important.less`,
    },
    'integer-type': { match: `(?:[-+]?\\d+)`, name: `constant.numeric.less` },
    'keyframe-name': {
      begin:
        `\\s*(-?(?:[_a-z]|[^\\x{00}-\\x{7F}]|(?:(:?\\\\[0-9a-f]{1,6}(\\r\\n|[\\s\\t\\r\\n\\f])?)|\\\\[^\\r\\n\\f0-9a-f]))(?:[_a-z0-9-]|[^\\x{00}-\\x{7F}]|(?:(:?\\\\[0-9a-f]{1,6}(\\r\\n|[\\t\\r\\n\\f])?)|\\\\[^\\r\\n\\f0-9a-f]))*)?`,
      beginCaptures: { 1: { name: `variable.other.constant.animation-name.less` } },
      end: `\\s*(?:(,)|(?=[{;]))`,
      endCaptures: { 1: { name: `punctuation.definition.arbitrary-repetition.less` } },
    },
    'length-type': {
      captures: { 1: { name: `keyword.other.unit.less` } },
      match:
        `0|(?i:[-+]?(?:(?:\\d*\\.\\d+(?:[eE](?:[-+]?\\d+))*)|(?:[-+]?\\d+))(em|ex|ch|rem|vw|vh|vmin|vmax|(c|m)?m|q|in|pt|pc|px|fr))\\b`,
      name: `constant.numeric.less`,
    },
    'less-boolean-function': {
      begin: `\\b(boolean)(?=\\()`,
      beginCaptures: { 1: { name: `support.function.boolean.less` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
      name: `meta.function-call.less`,
      patterns: [{
    ...
    'less-color-blend-functions': {
      patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{ include: `#less-variables` }, { include: `#var-function` }, { include: `#comma-delimiter` }, {
            include: `#color-values`,
          }],
        }],
      }],
    ...
    'less-color-channel-functions': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `support.function.color-definition.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
    ...
    'less-color-definition-functions': {
      patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{ include: `#less-variables` }, { include: `#var-function` }, { include: `#color-values` }],
        }],
      }, {
        begin: `\\b(hsva?)(?=\\()`,
        beginCaptures: { 1: { name: `support.function.color.less` } },
    ...
    'less-color-functions': {
      patterns: [{ include: `#less-color-blend-functions` }, { include: `#less-color-channel-functions` }, {
    ...
    'less-color-operation-functions': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `support.function.color-operation.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [{ include: `#color-values` }, { include: `#comma-delimiter` }, { include: `#percentage-type` }],
        }],
      }, {
        begin: `\\b(spin)(?=\\()`,
        beginCaptures: { 1: { name: `support.function.color-operation.less` } },
        ...
        patterns: [{
          ...
          patterns: [{ include: `#color-values` }, { include: `#comma-delimiter` }, { include: `#number-type` }],
        }],
      }, {
        ...
        patterns: [{
          ...
          patterns: [{ include: `#color-values` }, { include: `#comma-delimiter` }, { include: `#less-math` }, {
            include: `#percentage-type`,
          }],
        }],
      }],
    ...
    'less-extend': {
      ...
      patterns: [{
        ...
        patterns: [{ match: `\\ball\\b`, name: `constant.language.all.less` }, { include: `#selectors` }],
      }],
    },
    'less-functions': {
      patterns: [
    ...
    'less-if-function': {
      begin: `\\b(if)(?=\\()`,
      beginCaptures: { 1: { name: `support.function.if.less` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
      name: `meta.function-call.less`,
      patterns: [{
        ...
        patterns: [{ include: `#less-mixin-guards` }, { include: `#comma-delimiter` }, { include: `#property-values` }],
      }],
    },
    'less-list-functions': {
      patterns: [{
        begin: `\\b(length)(?=\\()\\b`,
        beginCaptures: { 1: { name: `support.function.length.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [{ include: `#property-values` }, { include: `#comma-delimiter` }],
        }],
      }, {
        begin: `\\b(extract)(?=\\()\\b`,
        beginCaptures: { 1: { name: `support.function.extract.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [{ include: `#property-values` }, { include: `#comma-delimiter` }, { include: `#integer-type` }],
        }],
      }, {
        begin: `\\b(range)(?=\\()\\b`,
        beginCaptures: { 1: { name: `support.function.range.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
    ...
    'less-logical-comparisons': {
      patterns: [
        { captures: { 1: { name: `keyword.operator.logical.less` } }, match: `\\s*(=|((<|>)=?))\\s*` },
        {
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.definition.group.begin.less` } },
          end: `\\)`,
        ...
        { match: `\\btrue|false\\b`, name: `constant.language.less` },
        { match: `,`, name: `punctuation.separator.less` },
    ...
    'less-math': {
      patterns: [
        { match: `[-\\+\\*\\/]`, name: `keyword.operator.arithmetic.less` },
        {
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.definition.group.begin.less` } },
          end: `\\)`,
    ...
    'less-math-functions': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `support.function.math.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [{ include: `#less-variables` }, { include: `#numeric-values` }],
        }],
      }, {
        captures: {
        ...
        patterns: [{
          ...
          patterns: [{ include: `#less-variables` }, { include: `#numeric-values` }, { include: `#comma-delimiter` }],
        }],
      }],
    },
    'less-misc-functions': {
      patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{ include: `#literal-string` }, { include: `#unquoted-string` }],
        }],
      }, {
        begin: `\\b(convert|unit)(?=\\()`,
        beginCaptures: { 1: { name: `support.function.convert.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [
            ...
            { include: `#literal-string` },
            { include: `#comma-delimiter` },
            { match: `((c|m)?m|in|p(t|c|x)|m?s|g?rad|deg|turn|%|r?em|ex|ch)`, name: `keyword.other.unit.less` },
          ],
        }],
      }, {
        begin: `\\b(data-uri)(?=\\()`,
        beginCaptures: { 1: { name: `support.function.data-uri.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [{ include: `#less-variables` }, { include: `#literal-string` }, {
            captures: { 1: { name: `punctuation.separator.less` } },
            match: `\\s*(?:(,))`,
          }],
        }],
        ...
        begin: `\\b(get-unit)(?=\\()`,
        beginCaptures: { 1: { name: `support.function.get-unit.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [{ include: `#dimensions` }],
        }],
      }, {
        begin: `\\b(svg-gradient)(?=\\()`,
        beginCaptures: { 1: { name: `support.function.svg-gradient.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [
            ...
            { include: `#length-type` },
            { match: `\\bto\\b`, name: `keyword.other.less` },
            { match: `\\b(top|right|bottom|left|center)\\b`, name: `support.constant.property-value.less` },
            { match: `\\b(at|circle|ellipse)\\b`, name: `keyword.other.less` },
          ],
        }],
      }],
    ...
    'less-mixin-guards': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.operator.logical.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        patterns: [{
          begin: `\\(`,
    ...
    'less-namespace-accessors': {
      patterns: [{
        ...
        begin: `(\\()`,
        beginCaptures: { 1: { name: `punctuation.definition.group.begin.less` } },
        end: `(\\))`,
        endCaptures: {
        ...
        patterns: [
          { include: `#less-variable-assignment` },
          { include: `#comma-delimiter` },
          { captures: { 1: { name: `punctuation.terminator.rule.less` } }, match: `\\s*(;)|(?=[})])` },
          { include: `#property-values` },
          { include: `#rule-list-body` },
        ],
      }],
    ...
    'less-number-units': {
      patterns: [{ match: `\\b((c|m)?m|in|p(t|c)|m?s|g?rad|deg|turn)\\b`, name: `keyword.other.unit.less` }, {
    ...
    'less-string-functions': {
      patterns: [{
        begin: `\\b(e(scape)?)(?=\\()\\b`,
        beginCaptures: { 1: { name: `support.function.escape.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [{ include: `#less-variables` }, { include: `#comma-delimiter` }, { include: `#literal-string` }, {
            include: `#unquoted-string`,
          }],
        }],
      }, {
        begin: `\\s*(%)(?=\\()\\s*`,
        beginCaptures: { 1: { name: `support.function.format.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
        ...
        begin: `\\b(replace)(?=\\()\\b`,
        beginCaptures: { 1: { name: `support.function.replace.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
    ...
    'less-type-functions': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `support.function.type.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{ include: `#less-variables` }],
        }],
      }],
    },
    'less-variable-assignment': {
      patterns: [{
        ...
        endCaptures: { 1: { name: `punctuation.terminator.rule.less` }, 2: { name: `keyword.operator.spread.less` } },
        name: `meta.property-value.less`,
        patterns: [
          {
            captures: { 1: { name: `punctuation.separator.key-value.less` }, 4: { name: `meta.property-value.less` } },
            match: `(((\\+_?)?):)([\\s\\t]*)`,
          },
          { include: `#property-values` },
          { include: `#comma-delimiter` },
    ...
    'less-variable-comparison': {
      patterns: [{
        ...
        endCaptures: { 1: { name: `punctuation.terminator.rule.less` } },
        patterns: [
          { captures: { 1: { name: `keyword.operator.logical.less` } }, match: `\\s*(=|((<|>)=?))\\s*` },
          { match: `\\btrue\\b`, name: `constant.language.less` },
          { include: `#property-values` },
          { include: `#selectors` },
          { include: `#unquoted-string` },
          { match: `,`, name: `punctuation.separator.less` },
    ...
    'less-variables': {
      captures: { 1: { name: `punctuation.definition.variable.less` }, 2: { name: `support.other.variable.less` } },
      match: `\\s*(@@?)([-\\w]+)`,
      name: `variable.other.readwrite.less`,
    },
    'literal-string': {
      patterns: [{
        begin: `'`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.less` } },
        end: `(')|(\\n)`,
        endCaptures: {
          1: { name: `punctuation.definition.string.end.less` },
          2: { name: `invalid.illegal.newline.less` },
    ...
    'local-function': {
      begin: `\\b(local)(?=\\()`,
      beginCaptures: { 0: { name: `support.function.font-face.less` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
      name: `meta.function-call.less`,
      patterns: [{
        ...
        patterns: [{ include: `#unquoted-string` }],
      }],
    },
    'media-query': {
      begin: `\\s*(only|not)?\\s*(all|aural|braille|embossed|handheld|print|projection|screen|tty|tv)?`,
      beginCaptures: { 1: { name: `keyword.operator.logic.media.less` }, 2: { name: `support.constant.media.less` } },
      end: `\\s*(?:(,)|(?=[{;]))`,
      endCaptures: { 1: { name: `punctuation.definition.arbitrary-repetition.less` } },
      patterns: [{ include: `#less-variables` }, { include: `#custom-property-name` }, {
        begin: `\\s*(and)?\\s*(\\()\\s*`,
        beginCaptures: {
        ...
        patterns: [
          {
            begin:
              `((-webkit-|-o-)?((min|max)-)?(-moz-)?(((device-)?(height|width|aspect-ratio|pixel-ratio))|(color(-index)?)|monochrome|resolution))|grid|scan|orientation\\s*(?=[:)])`,
            beginCaptures: {
            ...
            endCaptures: { 1: { name: `punctuation.separator.key-value.less` } },
          },
          { match: `\\b(portrait|landscape|progressive|interlace)`, name: `support.constant.property-value.less` },
          {
            captures: {
    ...
    'media-query-list': { begin: `\\s*(?=[^{;])`, end: `\\s*(?=[{;])`, patterns: [{ include: `#media-query` }] },
    'minmax-function': {
      begin: `\\b(minmax)(?=\\()`,
      beginCaptures: { 1: { name: `support.function.grid.less` } },
      end: `\\)`,
      ...
      patterns: [{
        ...
        patterns: [{ include: `#less-variables` }, { include: `#var-function` }, { include: `#length-type` }, {
          include: `#comma-delimiter`,
        }, { match: `\\b(max-content|min-content)\\b`, name: `support.constant.property-value.less` }],
      }],
    },
    'number-type': {
      match: `[-+]?(?:(?:\\d*\\.\\d+(?:[eE](?:[-+]?\\d+))*)|(?:[-+]?\\d+))`,
    ...
    'numeric-values': {
      patterns: [{ include: `#dimensions` }, { include: `#percentage-type` }, { include: `#number-type` }],
    },
    'percentage-type': {
      captures: { 1: { name: `keyword.other.unit.less` } },
      match: `[-+]?(?:(?:\\d*\\.\\d+(?:[eE](?:[-+]?\\d+))*)|(?:[-+]?\\d+))(%)`,
...
|((?xi:arabic-indic|armenian|bengali|cambodian|circle|cjk-decimal|cjk-earthly-branch|cjk-heavenly-stem|decimal-leading-zero|decimal|devanagari|disclosure-closed|disclosure-open|disc|ethiopic-numeric|georgian|gujarati|gurmukhi|hebrew|hiragana-iroha|hiragana|japanese-formal|japanese-informal|kannada|katakana-iroha|katakana|khmer|korean-hangul-formal|korean-hanja-formal|korean-hanja-informal|lao|lower-alpha|lower-armenian|lower-greek|lower-latin|lower-roman|malayalam|mongolian|myanmar|oriya|persian|simp-chinese-formal|simp-chinese-informal|square|tamil|telugu|thai|tibetan|trad-chinese-formal|trad-chinese-informal|upper-alpha|upper-armenian|upper-latin|upper-roman)))\\b`,
    ...
    'pseudo-classes': {
      patterns: [{
        begin: `(:)(dir|lang)(?=\\()`,
        captures: { 1: { name: `punctuation.definition.entity.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        ...
        patterns: [{
          ...
          name: `meta.group.less`,
          patterns: [
            { match: `\\b(even|odd)\\b`, name: `keyword.other.pseudo-class.less` },
            {
              captures: { 1: { name: `keyword.other.unit.less` } },
              match: `(?:[-+]?(?:\\d+)?(n)(\\s*[-+]\\s*\\d+)?|[-+]?\\s*\\d+)`,
              name: `constant.numeric.less`,
        ...
        match:
          `(:)(active|any|checked|default|disabled|empty|enabled|first(-(child|of-type))?|fullscreen|focus|host|hover|indeterminate|in-range|invalid|last-(child|of-type)|left|link|only-(child|of-type)|optional|out-of-range|read-(only|write)|required|right|root|scope|target|valid|visited)`,
        name: `meta.function-call.less`,
      }],
    },
    'pseudo-elements': {
      patterns: [{
        ...
        match:
          `(?:(:{1,2})(?:before|after|first-line|first-letter)|(::)(-(?:moz|ms|webkit)-)?(?:(-?(?:[[-\\w][^\\x{00}-\\x{7F}]]|(?:\\\\\\h{1,6}[\\s\\t\\n\\f]?|\\\\[^\\n\\f\\h]))(?:[[-\\w][^\\x{00}-\\x{7F}]]|(?:\\\\\\h{1,6}[\\s\\t\\n\\f]?|\\\\[^\\n\\f\\h]))*)))\\b`,
    ...
    'relative-color': {
      patterns: [{ match: `from`, name: `keyword.other.less` }, {
        match: `\\b[hslawbch]\\b`,
    ...
    'rule-list': {
      patterns: [{
        begin: `\\{`,
        beginCaptures: { 0: { name: `punctuation.definition.block.begin.less` } },
        end: `(?=\\s*\\})`,
        name: `meta.property-list.less`,
        patterns: [{ captures: { 1: { name: `punctuation.terminator.rule.less` } }, match: `\\s*(;)|(?=[})])` }, {
          include: `#rule-list-body`,
        }, { include: `#less-extend` }],
      }],
    },
    'rule-list-body': {
      patterns: [
        ...
        { include: `#less-variable-interpolation` },
        {
          ...
          patterns: [{ include: `#vendor-prefix` }, { include: `#custom-property-name` }, {
            include: `#filter-function`,
          }, {
            begin: `\\b(border((-(bottom|top)-(left|right))|((-(start|end)){2}))?-radius|(border-image(?!-)))\\b`,
            beginCaptures: { 0: { name: `support.type.property-name.less` } },
            comment: `border-radius and border-image properties utilize a slash as a separator`,
            end: `\\s*(;)|(?=[})])`,
            endCaptures: { 1: { name: `punctuation.terminator.rule.less` } },
            patterns: [{
              begin: `(((\\+_?)?):)(?=[\\s\\t]*)`,
              beginCaptures: { 1: { name: `punctuation.separator.key-value.less` } },
              contentName: `meta.property-value.less`,
              end: `(?=\\s*(;)|(?=[})]))`,
              patterns: [{ include: `#value-separator` }, { include: `#property-values` }],
            }],
          }, {
            captures: {
            ...
            beginCaptures: { 1: { name: `support.type.property-name.less` } },
            end: `\\s*(;)|(?=[})])`,
            endCaptures: { 1: { name: `punctuation.terminator.rule.less` } },
            patterns: [{
              begin: `(((\\+_?)?):)(?=[\\s\\t]*)`,
            ...
            patterns: [
              ...
              { match: `\\b(inherit|initial|unset|none)\\b`, name: `meta.property-value.less` },
              { include: `#filter-functions` },
            ],
          }, {
    ...
    'scroll-function': {
      begin: `\\b(scroll)(\\()`,
      beginCaptures: {
        1: { name: `support.function.scroll.less` },
        2: { name: `punctuation.definition.group.begin.less` },
      },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
      name: `meta.function-call.less`,
      patterns: [
        { match: `root|nearest|self`, name: `support.constant.scroller.less` },
        { match: `block|inline|x|y`, name: `support.constant.axis.less` },
        { include: `#less-variables` },
        { include: `#var-function` },
      ],
    },
    selector: {
      patterns: [{
        ...
        patterns: [{ include: `#comment-line` }, { include: `#selectors` }, { include: `#less-namespace-accessors` }, {
          include: `#less-variable-interpolation`,
        }, { include: `#important` }],
      }],
    },
    selectors: {
      patterns: [
        ...
        },
        {
          ...
          patterns: [{ include: `#less-variable-interpolation` }, { include: `#selectors` }],
        },
        { include: `#pseudo-elements` },
        { include: `#pseudo-classes` },
        { include: `#less-extend` },
        { match: `(?!\\+_?:)(?:>{1,3}|[~+])(?![>~+;}])`, name: `punctuation.separator.combinator.less` },
        { match: `((?:>{1,3}|[~+])){2,}`, name: `invalid.illegal.combinator.less` },
        { match: `\\/deep\\/`, name: `invalid.illegal.combinator.less` },
        {
          begin: `\\[`,
          captures: { 0: { name: `punctuation.definition.entity.less` } },
          end: `\\]`,
          name: `meta.attribute-selector.less`,
          patterns: [{ include: `#less-variable-interpolation` }, { include: `#qualified-name` }, {
            match:
              `(-?(?:[[_a-zA-Z][^\\x{00}-\\x{7F}]]|(?:\\\\\\h{1,6}[\\s\\t\\n\\f]?|\\\\[^\\n\\f\\h]))(?:[[-\\w][^\\x{00}-\\x{7F}]]|(?:\\\\\\h{1,6}[\\s\\t\\n\\f]?|\\\\[^\\n\\f\\h]))*)`,
            name: `entity.other.attribute-name.less`,
          }, {
            begin: `\\s*([~*|^$]?=)\\s*`,
            captures: { 1: { name: `keyword.operator.attribute-selector.less` } },
            end: `(?=(\\s|\\]))`,
            patterns: [
              { include: `#less-variable-interpolation` },
              { match: `[^\\s\\]\\['"]`, name: `string.unquoted.less` },
              { include: `#literal-string` },
              { captures: { 1: { name: `keyword.other.less` } }, match: `(?:\\s+([iI]))?` },
              { match: `\\]`, name: `punctuation.definition.entity.less` },
            ],
          }],
        },
        { include: `#arbitrary-repetition` },
        { match: `\\*`, name: `entity.name.tag.wildcard.less` },
      ],
    },
    'shape-functions': {
      patterns: [{
        begin: `\\b(rect)(?=\\()`,
        beginCaptures: { 0: { name: `support.function.shape.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [
            { match: `\\bauto\\b`, name: `support.constant.property-value.less` },
            { include: `#length-type` },
            { include: `#comma-delimiter` },
          ],
        }],
        ...
        patterns: [{
          ...
          patterns: [{ match: `\\bround\\b`, name: `keyword.other.less` }, { include: `#length-type` }, {
            include: `#percentage-type`,
          }],
        }],
      }, {
        ...
        patterns: [{
          ...
          patterns: [
            { match: `\\bat\\b`, name: `keyword.other.less` },
            {
        ...
        patterns: [{
          ...
          patterns: [{ match: `\\b(nonzero|evenodd)\\b`, name: `support.constant.property-value.less` }, {
            include: `#length-type`,
          }, { include: `#percentage-type` }],
        }],
      }],
    ...
    'steps-function': {
      ...
      name: `meta.function-call.less`,
      patterns: [
        { match: `jump-start|jump-end|jump-none|jump-both|start|end`, name: `support.constant.step-position.less` },
        { include: `#comma-delimiter` },
        { include: `#integer-type` },
        { include: `#less-variables` },
        { include: `#var-function` },
    ...
    'string-content': {
      ...
      }, { match: `\\\\(\\h{1,6}|.)`, name: `constant.character.escape.less` }],
    },
    'symbols-function': {
      begin: `\\b(symbols)(?=\\()`,
      beginCaptures: { 1: { name: `support.function.counter.less` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
      name: `meta.function-call.less`,
      patterns: [{
        ...
        patterns: [
          { match: `\\b(cyclic|numeric|alphabetic|symbolic|fixed)\\b`, name: `support.constant.symbol-type.less` },
          { include: `#comma-delimiter` },
          { include: `#literal-string` },
          { include: `#image-type` },
        ],
    ...
    'transform-functions': {
      patterns: [{
        ...
        beginCaptures: { 0: { name: `support.function.transform.less` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
        name: `meta.function-call.less`,
        patterns: [{
          ...
          patterns: [{ include: `#comma-delimiter` }, { include: `#number-type` }, { include: `#less-variables` }, {
            include: `#var-function`,
          }],
        }],
      }, {
        ...
        patterns: [{
          ...
          patterns: [{ include: `#percentage-type` }, { include: `#length-type` }, { include: `#number-type` }, {
            include: `#less-variables`,
          }, { include: `#var-function` }],
        }],
      }, {
        ...
        patterns: [{
          ...
          patterns: [{ include: `#angle-type` }, { include: `#less-variables` }, { include: `#calc-function` }, {
            include: `#var-function`,
          }],
        }],
      }, {
        ...
        patterns: [{
          ...
          patterns: [{ include: `#comma-delimiter` }, { include: `#angle-type` }, { include: `#less-variables` }, {
            include: `#calc-function`,
          }, { include: `#var-function` }],
        }],
      }, {
        ...
        patterns: [{
          ...
          patterns: [{ include: `#length-type` }, { include: `#less-variables` }, { include: `#calc-function` }, {
            include: `#var-function`,
          }],
        }],
      }, {
    ...
    'unquoted-string': { match: `[^\\s'"]`, name: `string.unquoted.less` },
    'url-function': {
      begin: `\\b(url)(?=\\()`,
      beginCaptures: { 1: { name: `support.function.url.less` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
      name: `meta.function-call.less`,
      patterns: [{
        ...
        patterns: [{ include: `#less-variables` }, { include: `#literal-string` }, { include: `#unquoted-string` }, {
          include: `#var-function`,
        }],
      }],
    },
    'value-separator': { captures: { 1: { name: `punctuation.separator.less` } }, match: `\\s*(/)\\s*` },
    'var-function': {
      begin: `\\b(var)(?=\\()`,
      beginCaptures: { 1: { name: `support.function.var.less` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
      name: `meta.function-call.less`,
      patterns: [{
        ...
        patterns: [{ include: `#comma-delimiter` }, { include: `#custom-property-name` }, {
          include: `#less-variables`,
        }, { include: `#property-values` }],
      }],
    },
    'vendor-prefix': { match: `-(?:webkit|moz(-osx)?|ms|o)-`, name: `support.type.vendor-prefix.less` },
    'view-function': {
      begin: `\\b(view)(?=\\()`,
      beginCaptures: { 1: { name: `support.function.view.less` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.group.end.less` } },
      name: `meta.function-call.less`,
      patterns: [{
        ...
        patterns: [
          { match: `block|inline|x|y|auto`, name: `support.constant.property-value.less` },
          { include: `#length-type` },
          { include: `#percentage-type` },
          { include: `#less-variables` },
          { include: `#var-function` },
