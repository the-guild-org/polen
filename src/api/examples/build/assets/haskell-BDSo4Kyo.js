var e = `Haskell`,
  ...
  r = [
    ...
    { match: `(?<!@|#)-\\}`, name: `invalid` },
    {
      captures: { 1: { name: `punctuation.paren.haskell` }, 2: { name: `punctuation.paren.haskell` } },
      match: `(\\()\\s*(\\))`,
    ...
    },
    {
      captures: {
        ...
        2: { name: `keyword.operator.hash.haskell` },
        3: { name: `keyword.operator.hash.haskell` },
    ...
    {
      captures: { 1: { name: `punctuation.bracket.haskell` }, 2: { name: `punctuation.bracket.haskell` } },
      match: `(\\[)\\s*(\\])`,
      name: `constant.language.empty-list.haskell`,
    },
    {
      begin: `(\\b(?<!')(module)|^(signature))(\\b(?!'))`,
      beginCaptures: { 2: { name: `keyword.other.module.haskell` }, 3: { name: `keyword.other.signature.haskell` } },
      end: `(?=\\b(?<!')where\\b(?!'))`,
      name: `meta.declaration.module.haskell`,
      patterns: [{ include: `#comment_like` }, { include: `#module_name` }, { include: `#module_exports` }, {
        match: `[a-z]+`,
        name: `invalid`,
      }],
    },
...
(?![\\p{S}\\p{P}&&[^(),;\\[\\]{}\`_"']]).*$)
      ...
      patterns: [{ include: `#comment_like` }, { include: `#where` }, { include: `#type_signature` }],
    },
    {
      begin: `(?x)
...
(?<!')\\b(where)
\\s*(\\{)(?!-)`,
          beginCaptures: { 1: { name: `keyword.other.where.haskell` }, 2: { name: `punctuation.brace.haskell` } },
          end: `(\\})`,
          endCaptures: { 1: { name: `punctuation.brace.haskell` } },
          patterns: [{ include: `#comment_like` }, { include: `#gadt_constructor` }, {
            match: `;`,
            name: `punctuation.semicolon.haskell`,
          }],
        },
        { match: `\\b(?<!')(where)\\b(?!')`, name: `keyword.other.where.haskell` },
        { include: `#deriving` },
...
`,
    ...
    {
      begin: `^\\s*(pattern)\\b(?!')`,
      captures: { 1: { name: `keyword.other.pattern.haskell` } },
      end: `(?x)
(?=\\}|;)
|^(?!
\\1\\s+\\S
...
| {-
      ...
      beginCaptures: {
        ...
        4: { patterns: [{ include: `#comment_like` }, { include: `#where` }, { include: `#type_signature` }] },
      },
      end: `(?x)
(?=\\}|;)
|^(?!
...
`,
    ...
    {
      begin: `^(\\s*)(instance)(\\b(?!'))`,
      beginCaptures: { 2: { name: `keyword.other.instance.haskell` } },
      end: `(?x)
...
`,
    ...
    {
      begin: `^(\\s*)(import)(\\b(?!'))`,
      beginCaptures: { 2: { name: `keyword.other.import.haskell` } },
      end: `(?x)
...
`,
      ...
      patterns: [
        { include: `#comment_like` },
        { include: `#where` },
        { captures: { 1: { name: `keyword.other.$1.haskell` } }, match: `(qualified|as|hiding)` },
        { include: `#module_name` },
    ...
    { include: `#keyword` },
    {
      captures: {
        ...
        2: { patterns: [{ include: `#comment_like` }, { include: `#integer_literals` }, { include: `#infix_op` }] },
      },
      match: `^\\s*(infix[lr]?)\\s+(.*)`,
    ...
    {
      begin: `(\\()(#)\\s`,
      beginCaptures: { 1: { name: `punctuation.paren.haskell` }, 2: { name: `keyword.operator.hash.haskell` } },
      end: `(#)(\\))`,
      endCaptures: { 1: { name: `keyword.operator.hash.haskell` }, 2: { name: `punctuation.paren.haskell` } },
      patterns: [{ include: `#comma` }, { include: `$self` }],
    },
    {
      begin: `(\\()`,
      beginCaptures: { 1: { name: `punctuation.paren.haskell` } },
      end: `(\\))`,
      endCaptures: { 1: { name: `punctuation.paren.haskell` } },
      patterns: [{ include: `#comma` }, { include: `$self` }],
    },
    { include: `#quasi_quote` },
    {
      begin: `(\\[)`,
      beginCaptures: { 1: { name: `punctuation.bracket.haskell` } },
      end: `(\\])`,
...
(?:(=)|(\\|))
(?![\\p{S}\\p{P}&&[^(),;\\[\\]\`{}_"']])`,
        beginCaptures: { 1: { name: `keyword.operator.eq.haskell` }, 2: { name: `keyword.operator.pipe.haskell` } },
        end: `(?x)
(?:\\G|^)\\s*
(?:
...
(\\()\\s*(:[\\p{S}\\p{P}&&[^(),;\\[\\]\`{}_"']]*)\\s*(\\))`,
        ...
        patterns: [{ include: `#comment_like` }, { include: `#deriving` }, { include: `#record_decl` }, {
          include: `#forall`,
        }, { include: `#context` }],
      }],
    },
...
`,
    ...
    comma: { match: `,`, name: `punctuation.separator.comma.haskell` },
    comment_like: { patterns: [{ include: `#cpp` }, { include: `#pragma` }, { include: `#comments` }] },
    comments: {
      patterns: [{
        begin: `^(\\s*)(--\\s[\\|\\$])`,
        beginCaptures: { 2: { name: `punctuation.whitespace.comment.leading.haskell` } },
        end: `(?=^(?!\\1--+(?![\\p{S}\\p{P}&&[^(),;\\[\\]\`{}_"']])))`,
        name: `comment.block.documentation.haskell`,
      }, {
        begin: `(^[ \\t]+)?(--\\s[\\^\\*])`,
        beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.haskell` } },
        end: `\\n`,
        ...
        patterns: [{
          begin: `--`,
          beginCaptures: { 0: { name: `punctuation.definition.comment.haskell` } },
          end: `\\n`,
    ...
    context: {
      captures: {
        1: { patterns: [{ include: `#comment_like` }, { include: `#type_signature` }] },
        2: { name: `keyword.operator.big-arrow.haskell` },
      },
      match: `(?x)
(.*)
(?<![\\p{S}\\p{P}&&[^(),;\\[\\]\`{}_"']])
    ...
    deriving: {
      patterns: [{
        ...
        beginCaptures: {
          ...
          3: { name: `keyword.other.deriving.strategy.$3.haskell` },
        },
        end: `(?x)
...
(?![\\p{S}\\p{P}&&[^(),;\\[\\]{}\`_"']]).*$)
        ...
        patterns: [{ include: `#comment_like` }, {
          ...
          captures: { 1: { name: `keyword.other.deriving.strategy.$1.haskell` } },
...
`,
        name: `meta.deriving.haskell`,
      }, { match: `(?<!')\\b(via)\\b(?!')`, name: `keyword.other.deriving.strategy.via.haskell` }],
    },
    double_colon: {
      captures: { 1: { name: `keyword.operator.double-colon.haskell` } },
      match: `\\s*(::|∷)(?![\\p{S}\\p{P}&&[^(),;\\[\\]\`{}_"']])\\s*`,
    },
    export_constructs: {
      patterns: [
        ...
        {
          begin: `\\b(?<!')(pattern)\\b(?!')`,
          beginCaptures: { 1: { name: `keyword.other.pattern.haskell` } },
          end: `(?x)
...
| (\\()\\s*(:[\\p{S}\\p{P}&&[^(),;\\[\\]\`{}_"']]+)\\s*(\\))`,
        ...
        {
          begin: `\\b(?<!')(type)\\b(?!')`,
          beginCaptures: { 1: { name: `keyword.other.type.haskell` } },
          end: `(?x)
...
| (\\()\\s*([\\p{S}\\p{P}&&[^(),;\\[\\]\`{}_"']]+)\\s*(\\))`,
        ...
        { match: `(?<!')\\b[\\p{Ll}_][\\p{Ll}_\\p{Lu}\\p{Lt}\\p{Nd}']*`, name: `entity.name.function.haskell` },
        { match: `(?<!')\\b[\\p{Lu}\\p{Lt}][\\p{Ll}_\\p{Lu}\\p{Lt}\\p{Nd}']*`, name: `storage.type.haskell` },
    ...
    ffi: {
      ...
      beginCaptures: { 2: { name: `keyword.other.foreign.haskell` }, 3: { name: `keyword.other.$3.haskell` } },
      end: `(?x)
(?=\\}|;)
|^(?!
\\1\\s+\\S
...
`,
      ...
      patterns: [
        { include: `#comment_like` },
        {
          captures: { 1: { name: `keyword.other.calling-convention.$1.haskell` } },
        ...
        },
        {
          ...
          patterns: [{ include: `#comment_like` }, {
            captures: {
              ...
              2: { name: `entity.name.foreign.haskell`, patterns: [{ include: `#string_literal` }] },
              3: { name: `entity.name.function.haskell` },
              4: { name: `entity.name.function.infix.haskell` },
            },
            match: `(?x)
...
`,
            ...
            captures: { 0: { name: `entity.name.foreign.haskell`, patterns: [{ include: `#string_literal` }] } },
            match: `(?x)
"(?:\\\\"|[^"])*"`,
          }, {
            captures: {
              ...
              2: { name: `punctuation.paren.haskell` },
              3: { name: `entity.name.function.infix.haskell` },
              4: { name: `punctuation.paren.haskell` },
            },
            match: `(?x)
(?:\\b(?<!'')([\\p{Ll}_][\\p{Ll}_\\p{Lu}\\p{Lt}\\p{Nd}']*)\\b(?!'))
...
`,
    ...
    float_literals: {
      captures: {
        1: { name: `constant.numeric.floating.decimal.haskell` },
        2: { name: `constant.numeric.floating.hexadecimal.haskell` },
      },
...
|0[xX]_*[0-9a-fA-F][_0-9a-fA-F]*[pP][-+]?[0-9][_0-9]*
    ...
    forall: {
      begin: `\\b(?<!')(forall|∀)\\b(?!')`,
      beginCaptures: { 1: { name: `keyword.other.forall.haskell` } },
      end: `(\\.)|(->|→)`,
      endCaptures: { 1: { name: `keyword.operator.period.haskell` }, 2: { name: `keyword.operator.arrow.haskell` } },
      patterns: [{ include: `#comment_like` }, { include: `#type_variable` }, { include: `#type_signature` }],
    },
    fun_decl: {
      begin: `(?x)^(\\s*)
(?<fn>
...
`,
        patterns: [{ include: `#comment_like` }, { include: `#deriving` }, { include: `#double_colon` }, {
          include: `#record_decl`,
        }, { include: `#type_signature` }],
      }, {
        begin: `(?x)
    ...
    infix_op: {
      patterns: [{
        captures: {
          ...
          3: { name: `keyword.operator.infix.haskell` },
        },
        comment:
...
`,
    ...
    inline_phase: {
      begin: `\\[`,
      beginCaptures: { 0: { name: `punctuation.bracket.haskell` } },
      end: `\\]`,
      endCaptures: { 0: { name: `punctuation.bracket.haskell` } },
      name: `meta.inlining-phase.haskell`,
      patterns: [{ match: `~`, name: `punctuation.tilde.haskell` }, { include: `#integer_literals` }, {
        match: `\\w*`,
        name: `invalid`,
      }],
    },
    integer_literals: {
      captures: {
        1: { name: `constant.numeric.integral.decimal.haskell` },
        2: { name: `constant.numeric.integral.hexadecimal.haskell` },
        3: { name: `constant.numeric.integral.octal.haskell` },
        4: { name: `constant.numeric.integral.binary.haskell` },
      },
      match: `(?x)
\\b(?<!')
(?:
...
\\b(?!')`,
    ...
    keyword: {
      captures: { 1: { name: `keyword.other.$1.haskell` }, 2: { name: `keyword.control.$2.haskell` } },
...
\\s*(\\{)(?!-)`,
      beginCaptures: {
        1: { name: `keyword.other.$1.haskell` },
        2: { name: `keyword.control.of.haskell` },
        3: { name: `punctuation.brace.haskell` },
      },
      end: `(\\})`,
      endCaptures: { 1: { name: `punctuation.brace.haskell` } },
      patterns: [{ include: `$self` }, { match: `;`, name: `punctuation.semicolon.haskell` }],
    },
    liquid_haskell: {
      begin: `\\{-@`,
      end: `@-\\}`,
    ...
    module_exports: {
      applyEndPatternLast: 1,
      begin: `\\(`,
      beginCaptures: { 0: { name: `punctuation.paren.haskell` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.paren.haskell` } },
      name: `meta.declaration.exports.haskell`,
      patterns: [
        { include: `#comment_like` },
        { captures: { 1: { name: `keyword.other.module.haskell` } }, match: `\\b(?<!')(module)\\b(?!')` },
        { include: `#comma` },
        { include: `#export_constructs` },
        {
          ...
          endCaptures: { 0: { name: `punctuation.paren.haskell` } },
          patterns: [{ include: `#comment_like` }, { include: `#record_wildcard` }, { include: `#export_constructs` }, {
            include: `#comma`,
          }],
        },
      ],
    ...
    numeric_literals: { patterns: [{ include: `#float_literals` }, { include: `#integer_literals` }] },
    overloaded_label: {
      patterns: [{
        captures: {
          1: { name: `keyword.operator.prefix.hash.haskell` },
...
|[\\p{Ll}_\\p{Lu}\\p{Lt}\\p{Nd}'\\.]+
    ...
    pragma: {
      ...
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.other.preprocessor.pragma.haskell` } },
        end: `(?=#-\\})`,
        patterns: [{
          match: `(?x)
(?:No)?
(?:AutoDeriveTypeable|DatatypeContexts|DoRec|IncoherentInstances|MonadFailDesugaring|MonoPatBinds|NullaryTypeClasses|OverlappingInstances|PatternSignatures|RecordPuns|RelaxedPolyRec)`,
          ...
          captures: { 1: { name: `keyword.other.preprocessor.extension.haskell` } },
          match: `(?x)
(
(?:No)?
...
(instance)\\b(?!')`,
        beginCaptures: {
          1: { name: `keyword.other.preprocessor.pragma.haskell` },
          2: { patterns: [{ include: `#inline_phase` }] },
          3: { name: `keyword.other.instance.haskell` },
        },
        end: `(?=#-\\})`,
        patterns: [{ include: `#type_signature` }],
...
\\s*`,
        beginCaptures: {
          1: { name: `keyword.other.preprocessor.pragma.haskell` },
          2: { name: `keyword.other.preprocessor.pragma.haskell` },
          3: { patterns: [{ include: `#inline_phase` }] },
        },
        end: `(?=#-\\})`,
        patterns: [{ include: `$self` }],
      }, {
...
(\\|\\|?)`,
        ...
        endCaptures: { 0: { name: `keyword.operator.quasi-quotation.end.haskell` } },
...
(\\|\\|?)`,
        beginCaptures: {
          ...
          4: { name: `entity.name.quasi-quoter.haskell`, patterns: [{ include: `#qualifier` }] },
    ...
    record: {
      begin: `({)(?!-)`,
      beginCaptures: { 1: { name: `punctuation.brace.haskell` } },
      end: `(?<!-)(})`,
      endCaptures: { 1: { name: `punctuation.brace.haskell` } },
...
`,
      beginCaptures: {
        1: { name: `variable.other.member.definition.haskell` },
        2: { name: `punctuation.paren.haskell` },
        3: { name: `variable.other.member.definition.haskell` },
        4: { name: `punctuation.paren.haskell` },
      },
      end: `(,)|(?=})`,
      endCaptures: { 1: { name: `punctuation.comma.haskell` } },
      patterns: [{ include: `#comment_like` }, { include: `#comma` }, { include: `#double_colon` }, {
        include: `#type_signature`,
...
`,
        beginCaptures: {
          1: { name: `variable.other.member.haskell`, patterns: [{ include: `#qualifier` }] },
          2: { name: `punctuation.paren.haskell` },
          3: { name: `variable.other.member.haskell` },
          4: { name: `punctuation.paren.haskell` },
        },
        end: `(,)|(?=})`,
        endCaptures: { 1: { name: `punctuation.comma.haskell` } },
        patterns: [{ include: `#comment_like` }, { include: `#comma` }, { include: `$self` }],
      }, { include: `#record_wildcard` }],
    },
    record_wildcard: {
      captures: { 1: { name: `variable.other.member.wildcard.haskell` } },
      match: `(?x)
(?<![\\p{S}\\p{P}&&[^(),;\\[\\]\`{}_"']])
(\\.\\.)
(?![\\p{S}\\p{P}&&[^(),;\\[\\]\`{}_"']])`,
    ...
    reserved_symbol: {
      patterns: [{
        captures: {
          1: { name: `keyword.operator.double-dot.haskell` },
          2: { name: `keyword.operator.colon.haskell` },
          3: { name: `keyword.operator.eq.haskell` },
          4: { name: `keyword.operator.lambda.haskell` },
          5: { name: `keyword.operator.pipe.haskell` },
          6: { name: `keyword.operator.arrow.left.haskell` },
          7: { name: `keyword.operator.arrow.haskell` },
          8: { name: `keyword.operator.arrow.left.tail.haskell` },
...
(?![\\p{S}\\p{P}&&[^(),;\\[\\]\`{}_"'']])`,
        ...
        captures: { 1: { name: `keyword.operator.postfix.hash.haskell` } },
        match: `(?x)
(?<=[\\p{Ll}_\\p{Lu}\\p{Lt}\\p{Nd}\\p{S}\\p{P}&&[^\\#,;\\[\`{]])
(\\#+)
(?![\\p{Ll}_\\p{Lu}\\p{Lt}\\p{Nd}\\p{S}\\p{P}&&[^),;\\]\`}]])`,
      }, {
        captures: { 1: { name: `keyword.operator.infix.tight.at.haskell` } },
        match: `(?x)
(?<=[\\p{Ll}_\\p{Lu}\\p{Lt}\\p{Nd}\\)\\}\\]])
(@)
(?=[\\p{Ll}_\\p{Lu}\\p{Lt}\\p{Nd}\\(\\[\\{])`,
...
(?=[\\p{Ll}_\\p{Lu}\\p{Lt}\\p{Nd}\\(\\{\\[])`,
    ...
    role_annotation: {
      patterns: [{
        ...
        beginCaptures: { 2: { name: `keyword.other.type.haskell` }, 3: { name: `keyword.other.role.haskell` } },
        end: `(?x)
(?=\\}|;)
|^(?!
\\1\\s+\\S
...
(?![\\p{S}\\p{P}&&[^(),;\\[\\]{}\`_"']]).*$)
        ...
        patterns: [{ include: `#comment_like` }, { include: `#type_constructor` }, {
          captures: { 1: { name: `keyword.other.role.$1.haskell` } },
    ...
    start_type_signature: {
      patterns: [{
        begin: `^(\\s*)(::|∷)(?![\\p{S}\\p{P}&&[^\\(,;\\[\`{_"']])\\s*`,
        beginCaptures: { 2: { name: `keyword.operator.double-colon.haskell` } },
        end: `(?x)
...
(?![\\p{S}\\p{P}&&[^(),;\\[\\]{}\`_"']]).*$)
        ...
        beginCaptures: { 1: { name: `keyword.operator.double-colon.haskell` } },
        end: `(?x)
...
|$
    ...
    string_literal: {
      ...
      patterns: [
        ...
        { match: `\\\\o[0-7]+|\\\\x[0-9A-Fa-f]+|\\\\[0-9]+`, name: `constant.character.escape.octal.haskell` },
        { match: `\\\\\\^[A-Z@\\[\\]\\\\\\^_]`, name: `constant.character.escape.control.haskell` },
        {
          begin: `\\\\\\s`,
          beginCaptures: { 0: { name: `constant.character.escape.begin.haskell` } },
          end: `\\\\`,
          endCaptures: { 0: { name: `constant.character.escape.end.haskell` } },
          patterns: [{ match: `\\S+`, name: `invalid.illegal.character-not-allowed-here.haskell` }],
        },
      ],
    },
    type_application: {
      patterns: [{
        begin: `(?<=[\\s,;\\[\\]{}"])(@)(')?(\\()`,
        beginCaptures: {
          1: { name: `keyword.operator.prefix.at.haskell` },
        ...
        begin: `(?<=[\\s,;\\[\\]{}"])(@)(?=\\")`,
        beginCaptures: { 1: { name: `keyword.operator.prefix.at.haskell` } },
        end: `(?<=\\")`,
        name: `meta.type-application.haskell`,
        patterns: [{ include: `#string_literal` }],
      }, {
...
(\`)`,
    ...
    type_signature: {
      patterns: [
        ...
        { match: `(::|∷)(?![\\p{S}\\p{P}&&[^(),;\\[\\]\`{}_"']])`, name: `keyword.operator.double-colon.haskell` },
        { include: `#forall` },
        { match: `=>|⇒`, name: `keyword.operator.big-arrow.haskell` },
        { include: `#string_literal` },
        { match: `'[^']'`, name: `invalid` },
        { include: `#type_application` },
        { include: `#reserved_symbol` },
