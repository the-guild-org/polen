  ...
  r = {
    array: {
      patterns: [{
        ...
        endCaptures: { 1: { name: `meta.bracket.julia` }, 2: { name: `keyword.operator.transpose.julia` } },
        name: `meta.array.julia`,
        patterns: [{ match: `\\bbegin\\b`, name: `constant.numeric.julia` }, {
          match: `\\bend\\b`,
    ...
    comment_block: {
      patterns: [{
        begin: `#=`,
        beginCaptures: { 0: { name: `punctuation.definition.comment.begin.julia` } },
        end: `=#`,
    ...
    comment_tags: {
      patterns: [
        ...
        { match: `\\bCHANGED\\b`, name: `keyword.other.comment-annotation.julia` },
    ...
    for_block: {
      ...
      patterns: [{
        ...
        patterns: [{ match: `\\bouter\\b`, name: `keyword.other.julia` }, { include: `$self` }],
      }],
    },
    function_call: {
      patterns: [{
        ...
        endCaptures: { 0: { name: `meta.bracket.julia` }, 1: { name: `keyword.operator.transposed-func.julia` } },
        patterns: [{ include: `#self_no_for_block` }],
      }],
    },
    function_decl: {
      patterns: [{
        captures: { 1: { name: `entity.name.function.julia` }, 2: { name: `support.type.julia` } },
...
Negative lookahead ensures we don't have another equal sign (not \`==\`)`,
    ...
    keyword: {
      patterns: [
        ...
        { match: `\\b(?<![:_])(?:global|local|const)\\b`, name: `keyword.storage.modifier.julia` },
        { match: `\\b(?<![:_])(?:export)\\b`, name: `keyword.control.export.julia` },
        { match: `^(?:public)\\b`, name: `keyword.control.public.julia` },
        { match: `\\b(?<![:_])(?:import)\\b`, name: `keyword.control.import.julia` },
        { match: `\\b(?<![:_])(?:using)\\b`, name: `keyword.control.using.julia` },
        { match: `(?<=\\S\\s+)\\b(as)\\b(?=\\s+\\S)`, name: `keyword.control.as.julia` },
        {
          match:
            `(@(\\.|(?:[[:alpha:]_\\p{Lu}\\p{Ll}\\p{Lt}\\p{Lm}\\p{Lo}\\p{Nl}\\p{Sc}⅀-⅄∿⊾⊿⊤⊥∂∅-∇∎∏∐∑∞∟∫-∳⋀-⋃◸-◿♯⟘⟙⟀⟁⦰-⦴⨀-⨆⨉-⨖⨛⨜𝛁𝛛𝛻𝜕𝜵𝝏𝝯𝞉𝞩𝟃ⁱ-⁾₁-₎∠-∢⦛-⦯℘℮゛-゜𝟎-𝟡]|[^\\P{So}←-⇿])(?:[[:word:]_!\\p{Lu}\\p{Ll}\\p{Lt}\\p{Lm}\\p{Lo}\\p{Nl}\\p{Sc}⅀-⅄∿⊾⊿⊤⊥∂∅-∇∎∏∐∑∞∟∫-∳⋀-⋃◸-◿♯⟘⟙⟀⟁⦰-⦴⨀-⨆⨉-⨖⨛⨜𝛁𝛛𝛻𝜕𝜵𝝏𝝯𝞉𝞩𝟃ⁱ-⁾₁-₎∠-∢⦛-⦯℘℮゛-゜𝟎-𝟡]|[^\\P{Mn}-¡]|[^\\P{Mc}-¡]|[^\\P{Nd}-¡]|[^\\P{Pc}-¡]|[^\\P{Sk}-¡]|[^\\P{Me}-¡]|[^\\P{No}-¡]|[′-‷⁗]|[^\\P{So}←-⇿])*))`,
    ...
    number: {
      patterns: [{
        captures: { 1: { name: `constant.numeric.julia` }, 2: { name: `keyword.operator.conjugate-number.julia` } },
        match:
      ...
      }, { match: `\\btrue\\b|\\bfalse\\b|\\bnothing\\b|\\bmissing\\b`, name: `constant.language.julia` }],
    },
    operator: {
      patterns: [
        {
        ...
        { match: `(?:<<|>>>|>>|\\.>>>|\\.>>|\\.<<)`, name: `keyword.operator.shift.julia` },
        {
          captures: {
        ...
        { match: `(?<=\\s)(?:\\?)(?=\\s)`, name: `keyword.operator.ternary.julia` },
        { match: `(?<=\\s)(?:\\:)(?=\\s)`, name: `keyword.operator.ternary.julia` },
        {
          match:
        ...
        { match: `(?<=[[:word:]⁺-ₜ!′∇\\)\\]\\}])(?::)`, name: `keyword.operator.range.julia` },
        { match: `(?:\\|>)`, name: `keyword.operator.applies.julia` },
        { match: `(?:\\||\\.\\||\\&|\\.\\&|~|¬|\\.~|⊻|\\.⊻)`, name: `keyword.operator.bitwise.julia` },
        {
          match:
            `\\.?(?:\\+\\+|\\-\\-|\\+|\\-|−|¦|\\||⊕|⊖|⊞|⊟|∪|∨|⊔|±|∓|∔|∸|≏|⊎|⊻|⊽|⋎|⋓|⟇|⧺|⧻|⨈|⨢|⨣|⨤|⨥|⨦|⨧|⨨|⨩|⨪|⨫|⨬|⨭|⨮|⨹|⨺|⩁|⩂|⩅|⩊|⩌|⩏|⩐|⩒|⩔|⩖|⩗|⩛|⩝|⩡|⩢|⩣|\\*|//?|⌿|÷|%|&|·|·|⋅|∘|×|\\\\|∩|∧|⊗|⊘|⊙|⊚|⊛|⊠|⊡|⊓|∗|∙|∤|⅋|≀|⊼|⋄|⋆|⋇|⋉|⋊|⋋|⋌|⋏|⋒|⟑|⦸|⦼|⦾|⦿|⧶|⧷|⨇|⨰|⨱|⨲|⨳|⨴|⨵|⨶|⨷|⨸|⨻|⨼|⨽|⩀|⩃|⩄|⩋|⩍|⩎|⩑|⩓|⩕|⩘|⩚|⩜|⩞|⩟|⩠|⫛|⊍|▷|⨝|⟕|⟖|⟗|⨟|\\^|↑|↓|⇵|⟰|⟱|⤈|⤉|⤊|⤋|⤒|⤓|⥉|⥌|⥍|⥏|⥑|⥔|⥕|⥘|⥙|⥜|⥝|⥠|⥡|⥣|⥥|⥮|⥯|￪|￬|√|∛|∜|⋆|±|∓)`,
        ...
        { match: `(?:::|(?<=\\s)isa(?=\\s))`, name: `keyword.operator.isa.julia` },
        { match: `(?:(?<=\\s)in(?=\\s))`, name: `keyword.operator.relation.in.julia` },
        { match: `(?:\\.(?=(?:@|_|\\p{L}))|\\.\\.+|…|⁝|⋮|⋱|⋰|⋯)`, name: `keyword.operator.dots.julia` },
        ...
        {
          captures: { 1: { name: `bracket.end.julia` }, 2: { name: `keyword.operator.transposed-matrix.julia` } },
          match: `(\\])((?:'|(?:\\.'))*\\.?')`,
        },
        {
          captures: { 1: { name: `bracket.end.julia` }, 2: { name: `keyword.operator.transposed-parens.julia` } },
          match: `(\\))((?:'|(?:\\.'))*\\.?')`,
        },
      ],
    },
    ...
    punctuation: {
      patterns: [{ match: `,`, name: `punctuation.separator.comma.julia` }, {
        match: `;`,
    ...
    self_no_for_block: {
      comment:
        `Same as $self, but does not contain #for_block. 'outer' is not valid in some contexts (e.g. generators, comprehensions, indexing), so use this when matching those in begin/end patterns. Keep this up-to-date with $self!`,
      patterns: [
        { include: `#operator` },
        { include: `#array` },
        { include: `#string` },
    ...
    string: {
      patterns: [{
        ...
        patterns: [{ include: `#string_escaped_char` }, { include: `#string_dollar_sign_interpolate` }],
      }, {
        begin: `(i?cxx)(""")`,
        beginCaptures: {
          1: { name: `support.function.macro.julia` },
        ...
        patterns: [{ include: `source.cpp#root_context` }, { include: `#string_dollar_sign_interpolate` }],
      }, {
        begin: `(py)(""")`,
        beginCaptures: {
          1: { name: `support.function.macro.julia` },
        ...
        patterns: [{ include: `source.python` }, { include: `#string_dollar_sign_interpolate` }],
      }, {
        begin: `(js)(""")`,
        beginCaptures: {
          1: { name: `support.function.macro.julia` },
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.julia` } },
        name: `embed.js.julia`,
        patterns: [{ include: `source.js` }, { include: `#string_dollar_sign_interpolate` }],
      }, {
        begin: `(R)(""")`,
        beginCaptures: {
          1: { name: `support.function.macro.julia` },
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.julia` } },
        name: `embed.R.julia`,
        patterns: [{ include: `source.r` }, { include: `#string_dollar_sign_interpolate` }],
      }, {
        begin: `(raw)(""")`,
        beginCaptures: {
          1: { name: `support.function.macro.julia` },
        ...
        patterns: [{ include: `source.sql` }, { include: `#string_dollar_sign_interpolate` }],
      }, {
        begin: `var"""`,
        end: `"""`,
...
their own line in the void`,
        ...
        begin: `"""`,
        beginCaptures: { 0: { name: `punctuation.definition.string.multiline.begin.julia` } },
        comment: `multi-line string with triple double quotes`,
        end: `"""`,
        endCaptures: { 0: { name: `punctuation.definition.string.multiline.end.julia` } },
        ...
        begin: `r"""`,
        beginCaptures: { 0: { name: `punctuation.definition.string.regexp.begin.julia` } },
        end: `(""")([imsx]{0,4})?`,
        endCaptures: {
