var e = `R`,
  ...
  r = {
    brackets: {
      patterns: [{
        begin: `\\(`,
        beginCaptures: { 0: { name: `punctuation.section.parens.begin.r` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.section.parens.end.r` } },
        patterns: [{ include: `source.r` }],
      }, {
        begin: `\\[(?!\\[)`,
        beginCaptures: { 0: { name: `punctuation.section.brackets.single.begin.r` } },
        end: `\\]`,
        endCaptures: { 0: { name: `punctuation.section.brackets.single.end.r` } },
        patterns: [{ include: `source.r` }],
      }, {
        begin: `\\[\\[`,
        beginCaptures: { 0: { name: `punctuation.section.brackets.double.begin.r` } },
        contentName: `meta.item-access.arguments.r`,
        end: `\\]\\]`,
        endCaptures: { 0: { name: `punctuation.section.brackets.double.end.r` } },
        patterns: [{ include: `source.r` }],
      }, {
        begin: `\\{`,
        beginCaptures: { 0: { name: `punctuation.section.braces.begin.r` } },
        end: `\\}`,
        endCaptures: { 0: { name: `punctuation.section.braces.end.r` } },
        patterns: [{ include: `source.r` }],
      }],
    },
    'builtin-functions': {
      patterns: [{
        captures: { 1: { name: `support.function.r` } },
        match:
    ...
    constants: {
      patterns: [
        { match: `\\b(pi|letters|LETTERS|month\\.abb|month\\.name)\\b`, name: `support.constant.misc.r` },
        {
          match: `\\b(TRUE|FALSE|NULL|NA|NA_integer_|NA_real_|NA_complex_|NA_character_|Inf|NaN)\\b`,
          name: `constant.language.r`,
        },
        { match: `\\b0(x|X)[0-9a-fA-F]+i\\b`, name: `constant.numeric.imaginary.hexadecimal.r` },
        { match: `\\b[0-9]+\\.?[0-9]*(?:(e|E)(\\+|-)?[0-9]+)?i\\b`, name: `constant.numeric.imaginary.decimal.r` },
        { match: `\\.[0-9]+(?:(e|E)(\\+|-)?[0-9]+)?i\\b`, name: `constant.numeric.imaginary.decimal.r` },
        { match: `\\b0(x|X)[0-9a-fA-F]+L\\b`, name: `constant.numeric.integer.hexadecimal.r` },
        { match: `\\b(?:[0-9]+\\.?[0-9]*)(?:(e|E)(\\+|-)?[0-9]+)?L\\b`, name: `constant.numeric.integer.decimal.r` },
        { match: `\\b0(x|X)[0-9a-fA-F]+\\b`, name: `constant.numeric.float.hexadecimal.r` },
        { match: `\\b[0-9]+\\.?[0-9]*(?:(e|E)(\\+|-)?[0-9]+)?\\b`, name: `constant.numeric.float.decimal.r` },
        { match: `\\.[0-9]+(?:(e|E)(\\+|-)?[0-9]+)?\\b`, name: `constant.numeric.float.decimal.r` },
      ],
    },
    'function-calls': {
      begin: '(?:\\b|(?=\\.))((?:[a-zA-Z._][\\w.]*|`[^`]+`))\\s*(\\()',
      beginCaptures: { 1: { name: `variable.function.r` }, 2: { name: `punctuation.section.parens.begin.r` } },
      contentName: `meta.function-call.arguments.r`,
      end: `(\\))`,
      endCaptures: { 1: { name: `punctuation.section.parens.end.r` } },
    ...
    'function-declarations': {
      patterns: [{
        ...
        match:
          '((?:`[^`\\\\]*(?:\\\\.[^`\\\\]*)*`)|(?:[[:alpha:].][[:alnum:]._]*))\\s*(<?<-|=(?!=))\\s*(function|\\\\)(?!\\w)',
        name: `meta.function.r`,
        patterns: [{ include: `#lambda-functions` }],
      }],
    },
    'function-parameters': {
      patterns: [
        { contentName: `meta.function-call.parameters.r`, name: `meta.function-call.r` },
        { match: '(?:[a-zA-Z._][\\w.]*|`[^`]+`)(?=\\s[^=])', name: `variable.other.r` },
        { begin: `(?==)`, end: `(?=[,)])`, patterns: [{ include: `source.r` }] },
        { match: `,`, name: `punctuation.separator.parameters.r` },
        { include: `source.r` },
      ],
    },
    'general-variables': {
      patterns: [
        {
          captures: { 1: { name: `variable.parameter.r` }, 2: { name: `keyword.operator.assignment.r` } },
        ...
        { match: `\\b([\\d_][[:alnum:]._]+)\\b`, name: `invalid.illegal.variable.other.r` },
        { match: `\\b([[:alnum:]_]+)(?=::)`, name: `entity.namespace.r` },
        { match: `\\b([[:alnum:]._]+)\\b`, name: `variable.other.r` },
        { match: '(`[^`]+`)', name: `variable.other.r` },
      ],
    },
    keywords: {
      patterns: [
        { match: `\\b(break|next|repeat|else|in)\\b`, name: `keyword.control.r` },
        { match: `\\b(ifelse|if|for|return|switch|while|invisible)\\b(?=\\s*\\()`, name: `keyword.control.r` },
        { match: `(\\-|\\+|\\*|\\/|%\\/%|%%|%\\*%|%o%|%x%|\\^)`, name: `keyword.operator.arithmetic.r` },
        { match: `(:=|<-|<<-|->|->>)`, name: `keyword.operator.assignment.r` },
        { match: `(==|<=|>=|!=|<>|<|>|%in%)`, name: `keyword.operator.comparison.r` },
        { match: `(!|&{1,2}|[|]{1,2})`, name: `keyword.operator.logical.r` },
        { match: `(\\|>)`, name: `keyword.operator.pipe.r` },
        {
    ...
    'lambda-functions': {
      patterns: [{
        begin: `\\b(function)\\s*(\\()`,
        beginCaptures: { 1: { name: `keyword.control.r` }, 2: { name: `punctuation.section.parens.begin.r` } },
        contentName: `meta.function.parameters.r`,
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.section.parens.end.r` } },
        name: `meta.function.r`,
        patterns: [{ include: `#comments` }, { match: '(?:[a-zA-Z._][\\w.]*|`[^`]+`)', name: `variable.other.r` }, {
          begin: `(?==)`,
          end: `(?=[,)])`,
          patterns: [{ include: `source.r` }],
        }, { match: `,`, name: `punctuation.separator.parameters.r` }],
    ...
    roxygen: {
      patterns: [{
        begin: `^\\s*(#')\\s*`,
        beginCaptures: { 1: { name: `punctuation.definition.comment.r` } },
        end: `$\\n?`,
        name: `comment.line.roxygen.r`,
        patterns: [{
          captures: { 1: { name: `keyword.other.r` }, 2: { name: `variable.parameter.r` } },
          match: '(@param)\\s*((?:[a-zA-Z._][\\w.]*|`[^`]+`))',
        }, { match: `@[a-zA-Z0-9]+`, name: `keyword.other.r` }],
      }],
    },
    'storage-type': {
      patterns: [{
    ...
    strings: {
      patterns: [{
        begin: `[rR]"(-*)\\[`,
        beginCaptures: { 0: { name: `punctuation.definition.string.raw.begin.r` } },
        end: `\\]\\1"`,
        endCaptures: { 0: { name: `punctuation.definition.string.raw.end.r` } },
  ...
  i = `source.r`,
  a = { displayName: `R`, name: `r`, patterns: n, repository: r, scopeName: i }
