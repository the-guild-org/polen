var e = `Wikitext`,
  t = `wikitext`,
  n = [{ include: `#wikitext` }, { include: `text.html.basic` }],
  r = {
    wikitext: {
      patterns: [
        { include: `#signature` },
      ...
      repository: {
        argument: {
          ...
          patterns: [{
            captures: { 1: { name: `variable.other.wikitext` }, 2: { name: `keyword.operator.wikitext` } },
            match: `(?:^|\\G)([^#:\\|\\[\\]\\{\\}\\|]*)(\\|)`,
          }, { include: `$self` }],
        },
        break: { match: `^-{4,}`, name: `markup.changed.wikitext` },
        convert: {
          begin: `(-\\{(?!\\{))([a-zA-Z](\\|))?`,
          captures: {
            1: { name: `punctuation.definition.tag.template.wikitext` },
            2: { name: `entity.name.function.type.wikitext` },
          ...
          patterns: [{ include: `$self` }, {
            captures: {
              ...
              3: { name: `string.unquoted.text.wikitext`, patterns: [{ include: `$self` }] },
        ...
        'extension-comments': {
          begin: `(<%--)\\s*(\\[)([A-Z_]*)(\\])`,
          beginCaptures: {
            1: { name: `punctuation.definition.comment.extension.wikitext` },
            2: { name: `punctuation.definition.tag.extension.wikitext` },
            3: { name: `storage.type.extension.wikitext` },
            4: { name: `punctuation.definition.tag.extension.wikitext` },
          },
          end: `(\\[)([A-Z_]*)(\\])\\s*(--%>)`,
          endCaptures: {
            1: { name: `punctuation.definition.tag.extension.wikitext` },
            2: { name: `storage.type.extension.wikitext` },
            3: { name: `punctuation.definition.tag.extension.wikitext` },
            4: { name: `punctuation.definition.comment.extension.wikitext` },
          },
          name: `comment.block.documentation.special.extension.wikitext`,
          patterns: [{
            captures: {
              0: { name: `meta.object.member.extension.wikitext` },
              1: { name: `meta.object-literal.key.extension.wikitext` },
              2: { name: `punctuation.separator.dictionary.key-value.extension.wikitext` },
              3: { name: `punctuation.definition.string.begin.extension.wikitext` },
              4: { name: `string.quoted.other.extension.wikitext` },
              5: { name: `punctuation.definition.string.end.extension.wikitext` },
            },
            match: `(\\w*)\\s*(=)\\s*(#)(.*?)(#)`,
          }],
        },
        'external-link': {
          patterns: [{
            captures: {
              ...
              3: { name: `string.other.link.external.title.wikitext`, patterns: [{ include: `$self` }] },
            ...
            captures: {
              1: { name: `punctuation.definition.tag.link.external.wikitext` },
              2: { name: `invalid.illegal.bad-url.wikitext` },
              3: { name: `string.other.link.external.title.wikitext`, patterns: [{ include: `$self` }] },
              4: { name: `punctuation.definition.tag.link.external.wikitext` },
            },
            match: `(\\[)([\\w.-]+(?:\\.[\\w\\.-]+)+[\\w\\-\\.~:\\/?#%@!\\$&'\\(\\)\\*\\+,;=.]+)\\s*?([^\\]]*)(\\])`,
        ...
        'font-style': {
          ...
          repository: {
            bold: {
              ...
              patterns: [{ include: `#italic` }, { include: `$self` }],
            },
            italic: {
              begin: `('')`,
              end: `((?=[^'])|(?=''))''((?=[^'])|(?=''))|$`,
              name: `markup.italic.wikitext`,
              patterns: [{ include: `#bold` }, { include: `$self` }],
            },
          },
        },
        heading: {
          captures: { 2: { name: `string.quoted.other.heading.wikitext`, patterns: [{ include: `$self` }] } },
          match: `^(={1,6})\\s*(.+?)\\s*(\\1)$`,
        ...
        'internal-link': {
          ...
          patterns: [{ include: `$self` }, {
            captures: {
              ...
              5: { name: `entity.other.attribute-name.localname.wikitext` },
            },
            match: `(\\|)|(?:\\s*)(?:([-\\w.]+)((:)))?([-\\w.:]+)\\s*(=)`,
          }],
        },
        list: {
          ...
          patterns: [{
            captures: { 1: { name: `punctuation.definition.list.begin.markdown.wikitext` } },
            match: `^([#*;:]+)`,
          }],
        },
        'magic-words': {
          patterns: [{ include: `#behavior-switches` }, { include: `#outdated-behavior-switches` }, {
            include: `#variables`,
          }],
          repository: {
            'behavior-switches': {
...
(?i)
  ...
  (\\}\\})`,
                ...
                { match: `RFC\\s+[0-9]+`, name: `constant.language.variables.rfc.wikitext` },
                { match: `PMID\\s+[0-9]+`, name: `constant.language.variables.pmid.wikitext` },
              ],
            },
          },
        },
        redirect: {
          patterns: [{
            captures: {
              ...
              4: null,
              5: { name: `entity.other.attribute-name.wikitext` },
              6: { name: `invalid.deprecated.ineffective.wikitext` },
              7: { name: `punctuation.definition.tag.link.internal.end.wikitext` },
            },
            match:
              `(?i)(^\\s*?#REDIRECT)\\s*(\\[\\[)(([^#:\\|\\[\\]\\{\\}]*?:)*)?([^\\|\\[\\]]*)?(\\|[^\\[\\]]*?)?(\\]\\])`,
          }],
        },
        signature: { patterns: [{ match: `~{3,5}`, name: `keyword.other.signature.wikitext` }] },
        table: {
          patterns: [{
            begin: `^\\s*(\\{\\|)(.*)$`,
            captures: {
              1: { name: `punctuation.definition.tag.table.wikitext` },
              2: { patterns: [{ include: `text.html.basic#attribute` }] },
            },
            end: `^\\s*(\\|\\})`,
            name: `meta.tag.block.table.wikitext`,
            patterns: [{ include: `$self` }, {
              begin: `^\\s*(\\|-)\\s*`,
              beginCaptures: { 1: { name: `punctuation.definition.tag.begin.wikitext` } },
              end: `$`,
              name: `meta.tag.block.table-row.wikitext`,
              patterns: [{ include: `$self` }, { include: `text.html.basic#attribute` }, {
                match: `\\|.*`,
              ...
              beginCaptures: {
                ...
                2: null,
                3: { patterns: [{ include: `$self` }, { include: `text.html.basic#attribute` }] },
                4: { name: `punctuation.definition.tag.wikitext` },
                5: { name: `markup.bold.style.wikitext` },
              },
              end: `$`,
              ...
              patterns: [{
                captures: {
                  1: { name: `punctuation.definition.tag.begin.wikitext` },
                  3: { patterns: [{ include: `text.html.basic#attribute` }, { include: `$self` }] },
                  4: { name: `punctuation.definition.tag.wikitext` },
                  5: { name: `markup.bold.style.wikitext` },
                },
                match: `(!!)(([^\\[]*?)(\\|))?(.*?)(?=(!!)|$)`,
              ...
              captures: {
                1: { name: `punctuation.definition.tag.begin.wikitext` },
                2: { name: `string.unquoted.caption.wikitext` },
              },
              end: `$`,
              match: `^\\s*(\\|\\+)(.*?)$`,
              ...
              begin: `^\\s*(\\|)`,
              beginCaptures: { 1: { name: `punctuation.definition.tag.wikitext` } },
              end: `$`,
              patterns: [{ include: `$self` }, { match: `\\|\\|`, name: `keyword.operator.wikitext` }],
            }],
          }],
        },
        template: {
          ...
          captures: {
            ...
            4: { name: `punctuation.separator.namespace.wikitext` },
            5: { name: `entity.name.function.wikitext` },
            7: { name: `punctuation.separator.namespace.wikitext` },
            8: { name: `entity.name.tag.local-name.wikitext` },
          },
          end: `(\\}\\})`,
          patterns: [{ include: `$self` }, { match: `(\\|)`, name: `keyword.operator.wikitext` }, {
            captures: {
              1: { name: `entity.other.attribute-name.namespace.wikitext` },
              2: { name: `punctuation.separator.namespace.wikitext` },
              3: { name: `entity.other.attribute-name.local-name.wikitext` },
              4: { name: `keyword.operator.equal.wikitext` },
            },
            match: `(?<=\\|)\\s*(?:([-\\w.]+)(:))?([-\\w\\s\\.:]+)\\s*(=)`,
          }],
        },
        wikixml: {
          ...
          repository: {
            jsonin: {
              ...
              beginCaptures: {
                0: { name: `meta.tag.metadata.start.wikitext` },
                1: { name: `punctuation.definition.tag.begin.wikitext` },
              ...
              endCaptures: {
                0: { name: `meta.tag.metadata.end.wikitext` },
                1: { name: `punctuation.definition.tag.begin.wikitext` },
                2: { name: `entity.name.tag.wikitext` },
            ...
            nowiki: {
              begin: `(?i)(<)(nowiki)(\\s+[^>]+)?\\s*(>)`,
              beginCaptures: {
                0: { name: `meta.tag.metadata.nowiki.start.wikitext` },
                1: { name: `punctuation.definition.tag.begin.wikitext` },
                2: { name: `entity.name.tag.wikitext` },
                3: { patterns: [{ include: `text.html.basic#attribute` }, { include: `$self` }] },
                4: { name: `punctuation.definition.tag.end.wikitext` },
              ...
              endCaptures: {
                0: { name: `meta.tag.metadata.nowiki.end.wikitext` },
                1: { name: `punctuation.definition.tag.begin.wikitext` },
                2: { name: `entity.name.tag.wikitext` },
                3: { name: `punctuation.definition.tag.end.wikitext` },
              },
            ...
            ref: {
              begin: `(?i)(<)(ref)(\\s+[^>]+)?\\s*(>)`,
              beginCaptures: {
                0: { name: `meta.tag.metadata.ref.start.wikitext` },
                1: { name: `punctuation.definition.tag.begin.wikitext` },
                2: { name: `entity.name.tag.wikitext` },
                3: { patterns: [{ include: `text.html.basic#attribute` }, { include: `$self` }] },
                4: { name: `punctuation.definition.tag.end.wikitext` },
              ...
              endCaptures: {
                0: { name: `meta.tag.metadata.ref.end.wikitext` },
                1: { name: `punctuation.definition.tag.begin.wikitext` },
                2: { name: `entity.name.tag.wikitext` },
                3: { name: `punctuation.definition.tag.end.wikitext` },
              },
            ...
            'syntax-highlight': {
              ...
              repository: {
                'hl-bat': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(['"]?)(?:batch|bat|dosbatch|winbatch)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-bibtex': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:bibtex|bib)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-clojure': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:clojure|clj)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-coffee': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:coffeescript|coffee-script|coffee)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-cpp': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:cpp|c\\+\\+)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-csharp': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:csharp|c#|cs)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-diff': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:diff|udiff)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-dockerfile': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:docker|dockerfile)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-elixir': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:elixir|ex|exs)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-erlang': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)erlang\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-fsharp': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:fsharp|f#)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-go': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:go|golang)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-groovy': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)groovy\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-handlebars': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)handlebars\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-ini': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:ini|cfg|dosini)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-js': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:javascript|js)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-json': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:"json"|'json'|"json-object"|'json-object'))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-julia': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:"julia"|'julia'|"jl"|'jl'))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-latex': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:tex|latex)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-makefile': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:make|makefile|mf|bsdmake)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-markdown': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:markdown|md)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-objc': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:"objective-c"|'objective-c'|"objectivec"|'objectivec'|"obj-c"|'obj-c'|"objc"|'objc'))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-perl': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:perl|ple)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-perl6': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:"perl6"|'perl6'|"pl6"|'pl6'|"raku"|'raku'))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-php': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:php|php3|php4|php5)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-powershell': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:"powershell"|'powershell'|"pwsh"|'pwsh'|"posh"|'posh'|"ps1"|'ps1'|"psm1"|'psm1'))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-pug': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:pug|jade)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-python': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:"python"|'python'|"py"|'py'|"sage"|'sage'|"python3"|'python3'|"py3"|'py3'))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-r': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:splus|s|r)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-ruby': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:ruby|rb|duby)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-rust': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:"rust"|'rust'|"rs"|'rs'))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-scala': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:"scala"|'scala'))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-shell': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:"bash"|'bash'|"sh"|'sh'|"ksh"|'ksh'|"zsh"|'zsh'|"shell"|'shell'))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-swift': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:"swift"|'swift'))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-ts': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:"typescript"|'typescript'|"ts"|'ts'))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
                ...
                'hl-vb-net': {
                  begin:
                    `(?i)(<)(syntaxhighlight)((?:\\s+[^>]+)?(?:\\s+lang=(?:(['"]?)(?:vb\\.net|vbnet|lobas|oobas|sobas)\\4))(?:\\s+[^>]+)?)\\s*(>)`,
                  beginCaptures: {
                    0: { name: `meta.tag.metadata.start.wikitext` },
                    1: { name: `punctuation.definition.tag.begin.wikitext` },
                    2: { name: `entity.name.tag.wikitext` },
