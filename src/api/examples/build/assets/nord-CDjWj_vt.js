var e = `nord`,
  ...
  i = [
    { settings: { foreground: `#d8dee9ff`, background: `#2e3440ff` } },
    { scope: `emphasis`, settings: { fontStyle: `italic` } },
    { scope: `strong`, settings: { fontStyle: `bold` } },
    { name: `Comment`, scope: `comment`, settings: { foreground: `#616E88` } },
    { name: `Constant Character`, scope: `constant.character`, settings: { foreground: `#EBCB8B` } },
    { name: `Constant Character Escape`, scope: `constant.character.escape`, settings: { foreground: `#EBCB8B` } },
    { name: `Constant Language`, scope: `constant.language`, settings: { foreground: `#81A1C1` } },
    { name: `Constant Numeric`, scope: `constant.numeric`, settings: { foreground: `#B48EAD` } },
    { name: `Constant Regexp`, scope: `constant.regexp`, settings: { foreground: `#EBCB8B` } },
    {
      name: `Entity Name Class/Type`,
      scope: [`entity.name.class`, `entity.name.type.class`],
      settings: { foreground: `#8FBCBB` },
    },
    { name: `Entity Name Function`, scope: `entity.name.function`, settings: { foreground: `#88C0D0` } },
    { name: `Entity Name Tag`, scope: `entity.name.tag`, settings: { foreground: `#81A1C1` } },
    { name: `Entity Other Attribute Name`, scope: `entity.other.attribute-name`, settings: { foreground: `#8FBCBB` } },
    {
      name: `Entity Other Inherited Class`,
      scope: `entity.other.inherited-class`,
      settings: { fontStyle: `bold`, foreground: `#8FBCBB` },
    },
    {
      name: `Invalid Deprecated`,
      scope: `invalid.deprecated`,
      settings: { foreground: `#D8DEE9`, background: `#EBCB8B` },
    },
    { name: `Invalid Illegal`, scope: `invalid.illegal`, settings: { foreground: `#D8DEE9`, background: `#BF616A` } },
    { name: `Keyword`, scope: `keyword`, settings: { foreground: `#81A1C1` } },
    { name: `Keyword Operator`, scope: `keyword.operator`, settings: { foreground: `#81A1C1` } },
    { name: `Keyword Other New`, scope: `keyword.other.new`, settings: { foreground: `#81A1C1` } },
    { name: `Markup Bold`, scope: `markup.bold`, settings: { fontStyle: `bold` } },
    { name: `Markup Changed`, scope: `markup.changed`, settings: { foreground: `#EBCB8B` } },
    { name: `Markup Deleted`, scope: `markup.deleted`, settings: { foreground: `#BF616A` } },
    { name: `Markup Inserted`, scope: `markup.inserted`, settings: { foreground: `#A3BE8C` } },
    { name: `Meta Preprocessor`, scope: `meta.preprocessor`, settings: { foreground: `#5E81AC` } },
    { name: `Punctuation`, scope: `punctuation`, settings: { foreground: `#ECEFF4` } },
    {
      ...
      settings: { foreground: `#ECEFF4` },
    },
    { name: `Punctuation Definition Tag`, scope: `punctuation.definition.tag`, settings: { foreground: `#81A1C1` } },
    {
      ...
      settings: { foreground: `#616E88` },
    },
    { name: `Punctuation Section`, scope: `punctuation.section`, settings: { foreground: `#ECEFF4` } },
    {
      name: `Punctuation Section Embedded`,
      scope: [`punctuation.section.embedded.begin`, `punctuation.section.embedded.end`],
      settings: { foreground: `#81A1C1` },
    },
    { name: `Punctuation Terminator`, scope: `punctuation.terminator`, settings: { foreground: `#81A1C1` } },
    { name: `Punctuation Variable`, scope: `punctuation.definition.variable`, settings: { foreground: `#81A1C1` } },
    { name: `Storage`, scope: `storage`, settings: { foreground: `#81A1C1` } },
    { name: `String`, scope: `string`, settings: { foreground: `#A3BE8C` } },
    { name: `String Regexp`, scope: `string.regexp`, settings: { foreground: `#EBCB8B` } },
    { name: `Support Class`, scope: `support.class`, settings: { foreground: `#8FBCBB` } },
    { name: `Support Constant`, scope: `support.constant`, settings: { foreground: `#81A1C1` } },
    { name: `Support Function`, scope: `support.function`, settings: { foreground: `#88C0D0` } },
    { name: `Support Function Construct`, scope: `support.function.construct`, settings: { foreground: `#81A1C1` } },
    { name: `Support Type`, scope: `support.type`, settings: { foreground: `#8FBCBB` } },
    { name: `Support Type Exception`, scope: `support.type.exception`, settings: { foreground: `#8FBCBB` } },
    { name: `Token Debug`, scope: `token.debug-token`, settings: { foreground: `#b48ead` } },
    { name: `Token Error`, scope: `token.error-token`, settings: { foreground: `#bf616a` } },
    { name: `Token Info`, scope: `token.info-token`, settings: { foreground: `#88c0d0` } },
    { name: `Token Warning`, scope: `token.warn-token`, settings: { foreground: `#ebcb8b` } },
    { name: `Variable`, scope: `variable.other`, settings: { foreground: `#D8DEE9` } },
    { name: `Variable Language`, scope: `variable.language`, settings: { foreground: `#81A1C1` } },
    { name: `Variable Parameter`, scope: `variable.parameter`, settings: { foreground: `#D8DEE9` } },
    {
    ...
    },
    {
      ...
      settings: { foreground: `#D8DEE9`, fontStyle: `bold` },
    },
    {
    ...
    { name: `[Java] Storage Type`, scope: `source.java storage.type`, settings: { foreground: `#8FBCBB` } },
    {
    ...
    { name: `[Markdown] Markup Heading`, scope: `markup.heading`, settings: { foreground: `#88C0D0` } },
    {
    ...
    { name: `[Markdown] Markup Italic`, scope: `text.html.markdown markup.italic`, settings: { fontStyle: `italic` } },
    {
    ...
    { name: `[Python] Support Type`, scope: `source.python support.type`, settings: { foreground: `#88C0D0` } },
    {
    ...
    { name: `[Rust] Entity types`, scope: `source.rust entity.name.type`, settings: { foreground: `#8FBCBB` } },
    {
      name: `[Rust] Macro`,
      scope: `source.rust meta.macro entity.name.function`,
      settings: { fontStyle: `bold`, foreground: `#88C0D0` },
    },
    {
    ...
    { name: `[Rust] Traits`, scope: `source.rust entity.name.type.trait`, settings: { fontStyle: `bold` } },
    {
    ...
    { name: `[YAML] Entity Name Tag`, scope: `source.yaml entity.name.tag`, settings: { foreground: `#8FBCBB` } },
  ],
  a = { name: e, type: t, semanticHighlighting: !0, colors: r, tokenColors: i }
export { a as default, e as name, i as tokenColors, n as semanticHighlighting, r as colors, t as type }
