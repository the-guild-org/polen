var e = `Splunk Query Language`,
  ...
  r = [
    ...
    { comment: `Splunk Macro Names`, match: '(?<=\\`)[\\w]+(?=\\(|\\`)', name: `entity.name.function.splunk_search` },
    { comment: `Digits`, match: `\\b(\\d+)\\b`, name: `constant.numeric.splunk_search` },
    {
      comment: `Escape Characters`,
      match: `(\\\\\\\\|\\\\\\||\\\\\\*|\\\\\\=)`,
      name: `contant.character.escape.splunk_search`,
    },
    { comment: `Splunk Operators`, match: `(\\|,)`, name: `keyword.operator.splunk_search` },
    {
    ...
    { comment: `Comparison or assignment`, match: `=`, name: `keyword.operator.splunk_search` },
    { begin: `(?<!\\\\)"`, end: `(?<!\\\\)"`, name: `string.quoted.double.splunk_search` },
    { begin: `(?<!\\\\)'`, end: `(?<!\\\\)'`, name: `string.quoted.single.splunk_search` },
    { begin: `query=\\"`, end: `(?<!\\\\)"`, name: `meta.embedded.block.sql` },
    { begin: '(?<!\\\\)```', end: '(?<!\\\\)```', name: `comment.block.splunk_search` },
    { begin: '`comment\\(', end: '\\)`', name: `comment.block.splunk_search` },
  ],
  i = `source.splunk_search`,
