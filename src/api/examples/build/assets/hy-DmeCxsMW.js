var e = `Hy`,
  ...
  r = {
    ...
    comment: { patterns: [{ match: `(;).*$`, name: `comment.line.hy` }] },
    constants: {
      patterns: [{
        match:
          `(?<=[\\{\\[\\(\\s])([0-9]+(\\.[0-9]+)?|(#x)[0-9a-fA-F]+|(#o)[0-7]+|(#b)[01]+)(?=[\\s;()'",\\[\\]\\{\\}])`,
  ...
  i = `source.hy`,
  a = { displayName: `Hy`, name: `hy`, patterns: n, repository: r, scopeName: i }
