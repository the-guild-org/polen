var e = `vscode://schemas/color-theme`,
  t = `dracula-soft`,
  n = `Zeno Rocha`,
  r = [`Derek P Sifford <dereksifford@gmail.com>`],
  i = `theme.dracula`,
  a = !0,
  o = {
    base: [
  ...
  c = [
    ...
    { scope: [`header`], settings: { foreground: `#bf9eee` } },
    { scope: [`meta.diff`, `meta.diff.header`], settings: { foreground: `#7b7f8b` } },
    { scope: [`markup.inserted`], settings: { foreground: `#62e884` } },
    { scope: [`markup.deleted`], settings: { foreground: `#ee6666` } },
    { scope: [`markup.changed`], settings: { foreground: `#FFB86C` } },
    { scope: [`invalid`], settings: { foreground: `#ee6666`, fontStyle: `underline italic` } },
    { scope: [`invalid.deprecated`], settings: { foreground: `#f6f6f4`, fontStyle: `underline italic` } },
    { scope: [`entity.name.filename`], settings: { foreground: `#e7ee98` } },
    { scope: [`markup.error`], settings: { foreground: `#ee6666` } },
    { name: `Underlined markup`, scope: [`markup.underline`], settings: { fontStyle: `underline` } },
    { name: `Bold markup`, scope: [`markup.bold`], settings: { fontStyle: `bold`, foreground: `#FFB86C` } },
    { name: `Markup headings`, scope: [`markup.heading`], settings: { fontStyle: `bold`, foreground: `#bf9eee` } },
    { name: `Markup italic`, scope: [`markup.italic`], settings: { foreground: `#e7ee98`, fontStyle: `italic` } },
    {
    ...
    },
    {
      ...
      settings: { foreground: `#f286c4` },
    },
    {
      name: `Blockquotes (prose)`,
      scope: [`entity.name.directive.restructuredtext`, `markup.quote`],
      settings: { foreground: `#e7ee98`, fontStyle: `italic` },
    },
    { name: `Horizontal rule (prose)`, scope: [`meta.separator.markdown`], settings: { foreground: `#7b7f8b` } },
    {
      name: `Code blocks`,
      scope: [
    ...
    },
    {
      ...
      settings: { foreground: `#bf9eee`, fontStyle: `italic` },
    },
    {
      name: `Inherited classes`,
      scope: [`entity.other.inherited-class`],
      settings: { fontStyle: `italic`, foreground: `#97e1f1` },
    },
    {
      name: `Comments`,
      scope: [`comment`, `punctuation.definition.comment`, `unused.comment`, `wildcard.comment`],
      settings: { foreground: `#7b7f8b` },
    },
    {
    ...
    },
    {
      ...
      settings: { foreground: `#97e1f1`, fontStyle: `italic` },
    },
    {
    ...
    { name: `Constants`, scope: [`constant`, `variable.other.constant`], settings: { foreground: `#bf9eee` } },
    {
      name: `Constant escape sequences`,
      scope: [`constant.character.escape`, `constant.character.string.escape`, `constant.regexp`],
      settings: { foreground: `#f286c4` },
    },
    { name: `HTML tags`, scope: [`entity.name.tag`], settings: { foreground: `#f286c4` } },
    {
    ...
    },
    {
      ...
      settings: { foreground: `#62e884`, fontStyle: `italic` },
    },
    {
      name: `Function names`,
      scope: [
    ...
    { name: `Decorator Objects`, scope: [`meta.decorator variable.other.object`], settings: { foreground: `#62e884` } },
    { name: `Keywords`, scope: [`keyword`, `punctuation.definition.keyword`], settings: { foreground: `#f286c4` } },
    { name: `Keyword "new"`, scope: [`keyword.control.new`, `keyword.operator.new`], settings: { fontStyle: `bold` } },
    { name: `Generic selectors (CSS/SCSS/Less/Stylus)`, scope: [`meta.selector`], settings: { foreground: `#f286c4` } },
    { name: `Language Built-ins`, scope: [`support`], settings: { fontStyle: `italic`, foreground: `#97e1f1` } },
    {
      name: `Built-in magic functions and constants`,
      scope: [`support.function.magic`, `support.variable`, `variable.other.predefined`],
      settings: { fontStyle: `regular`, foreground: `#bf9eee` },
    },
    {
    ...
    },
    {
      ...
      settings: { fontStyle: `italic underline`, foreground: `#62e884` },
    },
    {
      name: `Storage`,
      scope: [
      ...
      settings: { fontStyle: `regular`, foreground: `#f286c4` },
    },
    {
      name: `Types`,
      scope: [
    ...
    { name: `Modifiers`, scope: [`storage.modifier`], settings: { foreground: `#f286c4` } },
    {
      name: `RegExp string`,
      scope: [
        `string.regexp`,
    ...
    { name: `Capture groups`, scope: [`punctuation.definition.group.regexp`], settings: { foreground: `#FFB86C` } },
    {
      name: `Assertion operators`,
      scope: [`punctuation.definition.group.assertion.regexp`, `keyword.operator.negation.regexp`],
      settings: { foreground: `#ee6666` },
    },
    { name: `Positive lookaheads`, scope: [`meta.assertion.look-ahead.regexp`], settings: { foreground: `#62e884` } },
    { name: `Strings`, scope: [`string`], settings: { foreground: `#e7ee98` } },
    {
      name: `String quotes (temporary vscode fix)`,
      scope: [`punctuation.definition.string.begin`, `punctuation.definition.string.end`],
      settings: { foreground: `#dee492` },
    },
    {
    ...
    },
    {
      ...
      settings: { fontStyle: `normal`, foreground: `#f6f6f4` },
    },
    { name: `GraphQL keys`, scope: [`meta.selectionset.graphql variable`], settings: { foreground: `#e7ee98` } },
    {
    ...
    },
    {
      ...
      settings: { fontStyle: `normal`, foreground: `#bf9eee` },
    },
    {
    ...
    { name: `Haskell Pragmas`, scope: [`meta.preprocessor.haskell`], settings: { foreground: `#7b7f8b` } },
    { name: `Log file error`, scope: [`log.error`], settings: { foreground: `#ee6666`, fontStyle: `bold` } },
    { name: `Log file warning`, scope: [`log.warning`], settings: { foreground: `#e7ee98`, fontStyle: `bold` } },
  ],
  l = {
    $schema: e,
    name: t,
