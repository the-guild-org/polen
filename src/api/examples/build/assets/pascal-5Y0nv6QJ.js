var e = `Pascal`,
  ...
  r = [
    ...
    },
    {
      ...
      patterns: [{ match: `''`, name: `constant.character.escape.apostrophe.pascal` }],
    },
    { match: `\\#\\d+`, name: `string.other.pascal` },
  ],
  i = `source.pascal`,
