var e = `Java`,
  ...
  n = [
    {
      begin: `\\b(package)\\b\\s*`,
      beginCaptures: { 1: { name: `keyword.other.package.java` } },
      ...
      patterns: [
        { include: `#comments` },
        { match: `(?<=\\.)\\s*\\.|\\.(?=\\s*;)`, name: `invalid.illegal.character_not_allowed_here.java` },
        { match: `(?<!_)_(?=\\s*(\\.|;))|\\b\\d+|-+`, name: `invalid.illegal.character_not_allowed_here.java` },
        { match: `[A-Z]+`, name: `invalid.deprecated.package_name_not_lowercase.java` },
        {
          match: `(?x)\\b(?<!\\$)
...
true|false|null)\\b`,
    ...
    },
    {
      ...
      beginCaptures: { 1: { name: `keyword.other.import.java` }, 2: { name: `storage.modifier.java` } },
...
true|false|null)\\b`,
        ...
        { match: `\\.`, name: `punctuation.separator.java` },
        { match: `\\*`, name: `variable.language.wildcard.java` },
      ],
    },
  ...
  r = {
    'all-types': {
      patterns: [{ include: `#primitive-arrays` }, { include: `#primitive-types` }, { include: `#object-types` }],
    },
    annotations: {
      patterns: [{
        begin: `((@)\\s*([^\\s(]+))(\\()`,
        beginCaptures: {
          ...
          4: { name: `punctuation.definition.annotation-arguments.begin.bracket.round.java` },
        },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.annotation-arguments.end.bracket.round.java` } },
        name: `meta.declaration.annotation.java`,
        patterns: [{
          captures: { 1: { name: `constant.other.key.java` }, 2: { name: `keyword.operator.assignment.java` } },
          match: `(\\w*)\\s*(=)`,
        }, { include: `#code` }],
      }, {
        captures: {
    ...
    'anonymous-block-and-instance-initializer': {
      begin: `{`,
      beginCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.java` } },
      end: `}`,
      endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.java` } },
    ...
    'anonymous-classes-and-new': {
      ...
      patterns: [{ include: `#comments` }, { include: `#function-call` }, { include: `#all-types` }, {
        begin: `(?<=\\))`,
        end: `(?=;|\\)|\\]|\\.|,|\\?|:|}|\\+|\\-|\\*|\\/(?!\\/|\\*)|%|!|&|\\||\\^|=)`,
        patterns: [{ include: `#comments` }, {
          begin: `{`,
          beginCaptures: { 0: { name: `punctuation.section.inner-class.begin.bracket.curly.java` } },
          end: `}`,
          endCaptures: { 0: { name: `punctuation.section.inner-class.end.bracket.curly.java` } },
        ...
        patterns: [{ include: `#comments` }, {
          begin: `{`,
          beginCaptures: { 0: { name: `punctuation.section.array-initializer.begin.bracket.curly.java` } },
          end: `}`,
          endCaptures: { 0: { name: `punctuation.section.array-initializer.end.bracket.curly.java` } },
    ...
    assertions: {
      patterns: [{
        ...
        patterns: [{ match: `:`, name: `keyword.operator.assert.expression-separator.java` }, { include: `#code` }],
      }],
    },
    class: {
      begin: `(?=\\w?[\\w\\s-]*\\b(?:class|(?<!@)interface|enum)\\s+[\\w$]+)`,
      end: `}`,
      endCaptures: { 0: { name: `punctuation.section.class.end.bracket.curly.java` } },
      name: `meta.class.java`,
      patterns: [{ include: `#storage-modifiers` }, { include: `#generics` }, { include: `#comments` }, {
        captures: { 1: { name: `storage.modifier.java` }, 2: { name: `entity.name.type.class.java` } },
        ...
        patterns: [{ include: `#object-types-inherited` }, { include: `#comments` }],
      }, {
        begin: `(implements)\\s`,
        ...
        begin: `(permits)\\s`,
        beginCaptures: { 1: { name: `storage.modifier.permits.java` } },
        end: `(?=\\s*extends|implements|\\{)`,
        name: `meta.definition.class.permits.classes.java`,
        patterns: [{ include: `#object-types-inherited` }, { include: `#comments` }],
      }, {
        begin: `{`,
        beginCaptures: { 0: { name: `punctuation.section.class.begin.bracket.curly.java` } },
    ...
    'class-fields-and-methods': {
      patterns: [{ begin: `(?=\\=)`, end: `(?=;)`, patterns: [{ include: `#code` }] }, { include: `#methods` }],
    },
    code: {
      patterns: [
        { include: `#annotations` },
    ...
    'comments-inline': {
      patterns: [{
        ...
        begin: `(^[ \\t]+)?(?=//)`,
        beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.java` } },
        end: `(?!\\G)`,
        patterns: [{
          begin: `//`,
    ...
    'comments-javadoc': {
      patterns: [{
        ...
        patterns: [{
          ...
          captures: { 1: { name: `keyword.other.documentation.javadoc.java` }, 2: { name: `variable.parameter.java` } },
          match: `(@param)\\s+(\\S+)`,
        }, {
          captures: {
    ...
    'constants-and-special-vars': {
      patterns: [{ match: `\\b(true|false|null)\\b`, name: `constant.language.java` }, {
        match: `\\bthis\\b`,
    ...
    enums: {
      ...
      beginCaptures: {
        1: { patterns: [{ include: `#storage-modifiers` }] },
        2: { name: `storage.modifier.java` },
        3: { name: `entity.name.type.enum.java` },
      },
      end: `}`,
      endCaptures: { 0: { name: `punctuation.section.enum.end.bracket.curly.java` } },
      name: `meta.enum.java`,
      patterns: [{
        begin: `\\b(extends)\\b`,
        beginCaptures: { 1: { name: `storage.modifier.extends.java` } },
        end: `(?={|\\bimplements\\b)`,
        name: `meta.definition.class.inherited.classes.java`,
        patterns: [{ include: `#object-types-inherited` }, { include: `#comments` }],
      }, {
        ...
        begin: `{`,
        beginCaptures: { 0: { name: `punctuation.section.enum.begin.bracket.curly.java` } },
        end: `(?=})`,
        patterns: [{
          begin: `(?<={)`,
          end: `(?=;|})`,
          patterns: [{ include: `#comments-javadoc` }, { include: `#comments` }, {
            begin: `\\b(\\w+)\\b`,
            beginCaptures: { 1: { name: `constant.other.enum.java` } },
            end: `(,)|(?=;|})`,
            endCaptures: { 1: { name: `punctuation.separator.delimiter.java` } },
            patterns: [{ include: `#comments-javadoc` }, { include: `#comments` }, {
              begin: `\\(`,
    ...
    'function-call': {
      ...
      endCaptures: { 0: { name: `punctuation.definition.parameters.end.bracket.round.java` } },
      name: `meta.function-call.java`,
      patterns: [{ include: `#code` }],
    },
    generics: {
      begin: `<`,
      beginCaptures: { 0: { name: `punctuation.bracket.angle.java` } },
      end: `>`,
      endCaptures: { 0: { name: `punctuation.bracket.angle.java` } },
      patterns: [
        { match: `\\b(extends|super)\\b`, name: `storage.modifier.$1.java` },
        { captures: { 1: { name: `storage.type.java` } }, match: `(?<!\\.)([a-zA-Z$_][a-zA-Z0-9$_]*)(?=\\s*<)` },
        { include: `#primitive-arrays` },
        { match: `[a-zA-Z$_][a-zA-Z0-9$_]*`, name: `storage.type.generic.java` },
        { match: `\\?`, name: `storage.type.generic.wildcard.java` },
        { match: `&`, name: `punctuation.separator.types.java` },
        { match: `,`, name: `punctuation.separator.delimiter.java` },
        { match: `\\.`, name: `punctuation.separator.period.java` },
        { include: `#parens` },
        { include: `#generics` },
    ...
    keywords: {
      patterns: [
        ...
        { match: `((&|\\^|\\||<<|>>>?)=)`, name: `keyword.operator.assignment.bitwise.java` },
        { match: `(===?|!=|<=|>=|<>|<|>)`, name: `keyword.operator.comparison.java` },
        { match: `([+*/%-]=)`, name: `keyword.operator.assignment.arithmetic.java` },
        { match: `(=)`, name: `keyword.operator.assignment.java` },
        { match: `(\\-\\-|\\+\\+)`, name: `keyword.operator.increment-decrement.java` },
    ...
    'lambda-expression': { patterns: [{ match: `->`, name: `storage.type.function.arrow.java` }] },
    'member-variables': {
      begin: `(?=private|protected|public|native|synchronized|abstract|threadsafe|transient|static|final)`,
      end: `(?=\\=|;)`,
      patterns: [{ include: `#storage-modifiers` }, { include: `#variables` }, { include: `#primitive-arrays` }, {
    ...
    methods: {
      ...
      endCaptures: { 1: { name: `punctuation.section.method.end.bracket.curly.java` } },
      ...
      patterns: [
        { include: `#storage-modifiers` },
        {
          ...
          patterns: [{ include: `#parameters` }, { include: `#parens` }, { include: `#comments` }],
        },
        { include: `#generics` },
        {
          begin: `(?=\\w.*\\s+\\w+\\s*\\()`,
          ...
          patterns: [{ include: `#all-types` }, { include: `#parens` }, { include: `#comments` }],
        },
        { include: `#throws` },
        {
          begin: `{`,
          beginCaptures: { 0: { name: `punctuation.section.method.begin.bracket.curly.java` } },
    ...
    module: {
      ...
      beginCaptures: {
        ...
        3: { name: `storage.modifier.java` },
        4: { name: `entity.name.type.module.java` },
      },
      end: `}`,
      endCaptures: { 0: { name: `punctuation.section.module.end.bracket.curly.java` } },
      name: `meta.module.java`,
      patterns: [{
        begin: `{`,
        beginCaptures: { 0: { name: `punctuation.section.module.begin.bracket.curly.java` } },
        contentName: `meta.module.body.java`,
        end: `(?=})`,
        patterns: [{ include: `#comments` }, { include: `#comments-javadoc` }, {
...
\\b(?!\\$)`,
        ...
        { match: `\\b(?<!\\$)0(b|B)[01]([01_]*[01])?[Ll]?\\b(?!\\$)`, name: `constant.numeric.binary.java` },
        { match: `\\b(?<!\\$)0[0-7]([0-7_]*[0-7])?[Ll]?\\b(?!\\$)`, name: `constant.numeric.octal.java` },
        {
          match: `(?x)
(?<!\\$)
(
...
(?!\\$)`,
    ...
    'object-types': {
      patterns: [{ include: `#generics` }, {
        ...
        beginCaptures: {
          1: {
            patterns: [{ match: `[A-Za-z_]\\w*`, name: `storage.type.java` }, {
              match: `\\.`,
    ...
    objects: { match: `(?<![\\w$])[a-zA-Z_$][\\w$]*(?=\\s*\\.\\s*[\\w$]+)`, name: `variable.other.object.java` },
    parameters: {
      patterns: [
        ...
        { match: `,`, name: `punctuation.separator.delimiter.java` },
        { match: `\\.\\.\\.`, name: `punctuation.definition.parameters.varargs.java` },
      ],
    },
    parens: {
      patterns: [{
    ...
    properties: {
      patterns: [{
        captures: { 1: { name: `punctuation.separator.period.java` }, 2: { name: `keyword.control.new.java` } },
        match: `(\\.)\\s*(new)`,
      }, {
        captures: {
          1: { name: `punctuation.separator.period.java` },
        ...
        captures: { 1: { name: `punctuation.separator.period.java` }, 2: { name: `invalid.illegal.identifier.java` } },
        match: `(\\.)\\s*([0-9][\\w$]*)`,
      }],
    },
    record: {
      ...
      patterns: [{ include: `#storage-modifiers` }, { include: `#generics` }, { include: `#comments` }, {
        ...
        beginCaptures: {
          ...
          4: { name: `punctuation.definition.parameters.begin.bracket.round.java` },
        },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.parameters.end.bracket.round.java` } },
    ...
    'static-initializer': {
      patterns: [{ include: `#anonymous-block-and-instance-initializer` }, {
        match: `static`,
    ...
    'storage-modifiers': {
      match:
        `\\b(public|private|protected|static|final|native|synchronized|abstract|threadsafe|transient|volatile|default|strictfp|sealed|non-sealed)\\b`,
      name: `storage.modifier.java`,
    },
    strings: {
      patterns: [{
    ...
    throws: {
      ...
      patterns: [{ match: `,`, name: `punctuation.separator.delimiter.java` }, {
    ...
    'try-catch-finally': {
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.section.try.end.bracket.curly.java` } },
        name: `meta.try.java`,
        patterns: [{
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.section.try.resources.begin.bracket.round.java` } },
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.section.try.resources.end.bracket.round.java` } },
          name: `meta.try.resources.java`,
          patterns: [{ include: `#code` }],
        }, {
          begin: `{`,
          beginCaptures: { 0: { name: `punctuation.section.try.begin.bracket.curly.java` } },
        ...
        endCaptures: { 0: { name: `punctuation.section.catch.end.bracket.curly.java` } },
        name: `meta.catch.java`,
        patterns: [{ include: `#comments` }, {
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.definition.parameters.begin.bracket.round.java` } },
          contentName: `meta.catch.parameters.java`,
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.definition.parameters.end.bracket.round.java` } },
          patterns: [{ include: `#comments` }, { include: `#storage-modifiers` }, {
          ...
          begin: `{`,
          beginCaptures: { 0: { name: `punctuation.section.catch.begin.bracket.curly.java` } },
        ...
        endCaptures: { 0: { name: `punctuation.section.finally.end.bracket.curly.java` } },
        name: `meta.finally.java`,
        patterns: [{
          begin: `{`,
          beginCaptures: { 0: { name: `punctuation.section.finally.begin.bracket.curly.java` } },
...
\\s*(=|:|;)
    ...
    'variables-local': {
      ...
      patterns: [{ match: `\\bvar\\b`, name: `storage.type.local.java` }, {
        captures: { 1: { name: `variable.other.definition.java` } },
        match: `([A-Za-z$_][\\w$]*)(?=\\s*(\\[\\])*\\s*(=|:|;))`,
      }, { include: `#code` }],
    },
