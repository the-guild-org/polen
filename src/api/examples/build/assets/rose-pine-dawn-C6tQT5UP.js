var e = `rose-pine-dawn`,
  ...
  r = [
    ...
    { scope: [`constant`], settings: { foreground: `#286983` } },
    {
      scope: [`constant.numeric`, `constant.language`, `constant.charcter.escape`],
      settings: { foreground: `#d7827e` },
    },
    { scope: [`entity.name`], settings: { foreground: `#d7827e` } },
    {
      ...
      settings: { foreground: `#56949f` },
    },
    {
      scope: [`entity.other.attribute-name`, `entity.other.inherited-class`],
      settings: { foreground: `#907aa9`, fontStyle: `italic` },
    },
    { scope: [`invalid`], settings: { foreground: `#b4637a` } },
    { scope: [`invalid.deprecated`], settings: { foreground: `#797593` } },
    { scope: [`keyword`], settings: { foreground: `#286983` } },
    { scope: [`markup.inserted.diff`], settings: { foreground: `#56949f` } },
    { scope: [`markup.deleted.diff`], settings: { foreground: `#b4637a` } },
    { scope: [`meta.diff.range`], settings: { foreground: `#907aa9` } },
    { scope: [`meta.tag`, `meta.brace`], settings: { foreground: `#575279` } },
    { scope: [`meta.import`, `meta.export`], settings: { foreground: `#286983` } },
    { scope: `meta.directive.vue`, settings: { foreground: `#907aa9`, fontStyle: `italic` } },
    { scope: `meta.property-name.css`, settings: { foreground: `#56949f` } },
    { scope: `meta.property-value.css`, settings: { foreground: `#ea9d34` } },
    { scope: `meta.tag.other.html`, settings: { foreground: `#797593` } },
    { scope: [`punctuation`], settings: { foreground: `#797593` } },
    { scope: [`punctuation.accessor`], settings: { foreground: `#286983` } },
    { scope: [`punctuation.definition.string`], settings: { foreground: `#ea9d34` } },
    { scope: [`punctuation.definition.tag`], settings: { foreground: `#9893a5` } },
    { scope: [`storage.type`, `storage.modifier`], settings: { foreground: `#286983` } },
    { scope: [`string`], settings: { foreground: `#ea9d34` } },
    { scope: [`support`], settings: { foreground: `#56949f` } },
    { scope: [`support.constant`], settings: { foreground: `#ea9d34` } },
    { scope: [`support.function`], settings: { foreground: `#b4637a`, fontStyle: `italic` } },
    { scope: [`variable`], settings: { foreground: `#d7827e`, fontStyle: `italic` } },
    {
      scope: [`variable.other`, `variable.language`, `variable.function`, `variable.argument`],
      settings: { foreground: `#575279` },
    },
    { scope: [`variable.parameter`], settings: { foreground: `#907aa9` } },
  ],
