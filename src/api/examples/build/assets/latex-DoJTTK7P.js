var e = `LaTeX`,
  ...
  n = [
    {
      comment:
        'This scope identifies partially typed commands such as `\\tab`. We use this to trigger “Command Completion” only when it makes sense.',
    ...
    },
    {
      ...
      patterns: [{ include: `#multiline-optional-arg` }, {
        begin: `((?:\\G|(?<=\\]))\\{)`,
        beginCaptures: { 0: { name: `punctuation.definition.arguments.begin.latex` } },
    ...
    },
    {
      ...
      beginCaptures: {
        ...
        2: { name: `punctuation.definition.function.latex` },
        4: { patterns: [{ include: `#optional-arg-bracket` }] },
        5: { name: `punctuation.definition.arguments.begin.latex` },
      },
      ...
      patterns: [{ include: `text.tex#braces` }, { include: `$self` }],
    },
    {
      begin: `((?:\\s*)\\\\begin\\{songs\\}\\{.*\\})`,
      captures: { 1: { patterns: [{ include: `#begin-env-tokenizer` }] } },
      ...
      patterns: [
        ...
        { match: `\\^`, name: `meta.chord.block.latex support.class.chord.block.environment.latex` },
        { include: `$self` },
      ],
    },
    {
      begin: `(?:^\\s*)?\\\\begin\\{(lstlisting|minted|pyglist)\\}(?=\\[|\\{)`,
      captures: { 0: { patterns: [{ include: `#begin-env-tokenizer` }] } },
      end: `\\\\end\\{\\1\\}`,
      patterns: [{ include: `#multiline-optional-arg-no-highlight` }, {
        begin: `(?:\\G|(?<=\\]))(\\{)((?:asy|asymptote))(\\})`,
        beginCaptures: {
          1: { name: `punctuation.definition.arguments.begin.latex` },
          2: { name: `variable.parameter.function.latex` },
          3: { name: `punctuation.definition.arguments.end.latex` },
        },
        contentName: `source.asy`,
        end: `^\\s*(?=\\\\end\\{(?:minted|lstlisting|pyglist)\\})`,
        patterns: [{ include: `source.asy` }],
      }, {
        begin: `(?:\\G|(?<=\\]))(\\{)((?:bash))(\\})`,
        beginCaptures: {
          1: { name: `punctuation.definition.arguments.begin.latex` },
    ...
    },
    {
      ...
      patterns: [{ include: `#multiline-optional-arg-no-highlight` }, {
        begin: `(?:\\G|(?<=\\]))(\\{)`,
        beginCaptures: { 1: { name: `punctuation.definition.arguments.begin.latex` } },
        ...
        patterns: [{ include: `source.asymptote` }],
      }],
    },
    {
    ...
    {
      begin:
        `\\s*\\\\begin\\{(?:jlcode|jlverbatim|jlblock|jlconcode|jlconsole|jlconverbatim)\\*?\\}(?:\\[[a-zA-Z0-9_-]*\\])?(?=\\[|\\{|\\s*$)`,
      captures: { 0: { patterns: [{ include: `#begin-env-tokenizer` }] } },
    ...
    {
      begin:
        `\\s*\\\\begin\\{(?:juliacode|juliaverbatim|juliablock|juliaconcode|juliaconsole|juliaconverbatim)\\*?\\}(?:\\[[a-zA-Z0-9_-]*\\])?(?=\\[|\\{|\\s*$)`,
      captures: { 0: { patterns: [{ include: `#begin-env-tokenizer` }] } },
      ...
      patterns: [{ include: `#multiline-optional-arg-no-highlight` }, {
        ...
        contentName: `source.julia`,
          ...
          `^\\s*(?=\\\\end\\{(?:juliacode|juliaverbatim|juliablock|juliaconcode|juliaconsole|juliaconverbatim)\\*?\\})`,
        patterns: [{ include: `source.julia` }],
      }],
    },
    {
    ...
    {
      begin:
        `\\s*\\\\begin\\{(?:pycode|pyverbatim|pyblock|pyconcode|pyconsole|pyconverbatim)\\*?\\}(?:\\[[a-zA-Z0-9_-]*\\])?(?=\\[|\\{|\\s*$)`,
      captures: { 0: { patterns: [{ include: `#begin-env-tokenizer` }] } },
    ...
    {
      begin:
        `\\s*\\\\begin\\{(?:pylabcode|pylabverbatim|pylabblock|pylabconcode|pylabconsole|pylabconverbatim)\\*?\\}(?:\\[[a-zA-Z0-9_-]*\\])?(?=\\[|\\{|\\s*$)`,
      captures: { 0: { patterns: [{ include: `#begin-env-tokenizer` }] } },
      ...
      patterns: [{ include: `#multiline-optional-arg-no-highlight` }, {
        ...
        contentName: `source.python`,
          ...
          `^\\s*(?=\\\\end\\{(?:pylabcode|pylabverbatim|pylabblock|pylabconcode|pylabconsole|pylabconverbatim)\\*?\\})`,
        patterns: [{ include: `source.python` }],
      }],
    },
    {
      begin:
        `\\s*\\\\begin\\{(?:sageblock|sagesilent|sageverbatim|sageexample|sagecommandline|python|pythonq|pythonrepl)\\*?\\}(?:\\[[a-zA-Z0-9_-]*\\])?(?=\\[|\\{|\\s*$)`,
      captures: { 0: { patterns: [{ include: `#begin-env-tokenizer` }] } },
      end:
        `\\s*\\\\end\\{(?:sageblock|sagesilent|sageverbatim|sageexample|sagecommandline|python|pythonq|pythonrepl)\\*?\\}`,
      patterns: [{ include: `#multiline-optional-arg-no-highlight` }, {
        begin: `(?:\\G|(?<=\\]))(\\{)`,
        beginCaptures: { 1: { name: `punctuation.definition.arguments.begin.latex` } },
        contentName: `variable.parameter.function.latex`,
    ...
    {
      begin:
        `\\s*\\\\begin\\{(?:sympycode|sympyverbatim|sympyblock|sympyconcode|sympyconsole|sympyconverbatim)\\*?\\}(?:\\[[a-zA-Z0-9_-]*\\])?(?=\\[|\\{|\\s*$)`,
      captures: { 0: { patterns: [{ include: `#begin-env-tokenizer` }] } },
      ...
      patterns: [{ include: `#multiline-optional-arg-no-highlight` }, {
        ...
        contentName: `source.python`,
          ...
          `^\\s*(?=\\\\end\\{(?:sympycode|sympyverbatim|sympyblock|sympyconcode|sympyconsole|sympyconverbatim)\\*?\\})`,
        patterns: [{ include: `source.python` }],
      }],
    },
    {
    ...
    {
      begin:
        `((?:^\\s*)?\\\\begin\\{((?:RobExt)?(?:CacheMeCode|PlaceholderPathFromCode\\*?|PlaceholderFromCode\\*?|SetPlaceholderCode\\*?))\\})(?:\\[[^\\]]*\\]){,2}(?=\\{)`,
      captures: { 1: { patterns: [{ include: `#begin-env-tokenizer` }] } },
      end: `(\\\\end\\{\\2\\})`,
      patterns: [{
        ...
        beginCaptures: { 1: { name: `punctuation.definition.arguments.begin.latex` } },
          ...
          `(?=\\\\end\\{(?:RobExt)?(?:CacheMeCode|PlaceholderPathFromCode\\*?|PlaceholderFromCode\\*?|SetPlaceholderCode\\*?)\\})`,
        patterns: [{
          begin: `\\G`,
          end: `(\\})\\s*$`,
          endCaptures: { 1: { name: `punctuation.definition.arguments.end.latex` } },
          ...
          contentName: `source.asy`,
            ...
            `^\\s*(?=\\\\end\\{(?:RobExt)?(?:CacheMeCode|PlaceholderPathFromCode\\*?|PlaceholderFromCode\\*?|SetPlaceholderCode\\*?)\\})`,
          patterns: [{ include: `source.asy` }],
        }],
      }, {
    ...
    },
    {
      ...
      captures: {
        ...
        2: { name: `punctuation.definition.function.latex` },
        3: { patterns: [{ include: `#optional-arg-bracket` }] },
        4: { name: `variable.parameter.function.latex` },
        5: { patterns: [{ include: `#optional-arg-bracket` }] },
        6: { name: `punctuation.definition.arguments.begin.latex` },
      },
      end: `\\s*(\\};)`,
      patterns: [{
        begin: `%`,
        beginCaptures: { 0: { name: `punctuation.definition.comment.latex` } },
        end: `$\\n?`,
    ...
    },
    {
      ...
      beginCaptures: { 1: { name: `support.function.url.latex` } },
      ...
      patterns: [{ include: `#multiline-optional-arg-no-highlight` }, {
        ...
        beginCaptures: {
          1: { name: `punctuation.definition.arguments.begin.latex` },
          2: { name: `markup.underline.link.latex` },
          3: { name: `punctuation.definition.arguments.end.latex` },
    ...
    {
      begin:
        `(?:\\s*)((\\\\)begin)(\\{)((?:\\+?array|equation|(?:IEEE)?eqnarray|multline|align|aligned|alignat|alignedat|flalign|flaligned|flalignat|split|gather|gathered|\\+?cases|(?:display)?math|\\+?[a-zA-Z]*matrix|[pbBvV]?NiceMatrix|[pbBvV]?NiceArray|(?:(?:arg)?(?:mini|maxi)))(?:\\*|!)?)(\\})(\\s*\\n)?`,
      captures: {
        1: { name: `support.function.be.latex` },
        2: { name: `punctuation.definition.function.latex` },
        3: { name: `punctuation.definition.arguments.begin.latex` },
      ...
      patterns: [
        { match: `(?<!\\\\)&`, name: `keyword.control.equation.align.latex` },
        { match: `\\\\\\\\`, name: `keyword.control.equation.newline.latex` },
    ...
    {
      begin:
        `(\\s*\\\\begin\\{(tabular[xy*]?|xltabular|longtable|(?:long)?tabu|(?:long|tall)?tblr|NiceTabular[X*]?|booktabs)\\}(\\s*\\n)?)`,
      captures: { 1: { patterns: [{ include: `#begin-env-tokenizer` }] } },
      contentName: `meta.data.environment.tabular.latex`,
      end: `(\\s*\\\\end\\{(\\2)\\}(?:\\s*\\n)?)`,
      name: `meta.function.environment.tabular.latex`,
      patterns: [{ match: `(?<!\\\\)&`, name: `keyword.control.table.cell.latex` }, {
        match: `\\\\\\\\`,
    ...
    },
    {
      ...
      patterns: [{ include: `text.tex.markdown_latex_combined` }],
    },
    {
      begin: `(\\s*\\\\begin\\{(\\w+\\*?)\\})`,
      captures: { 1: { patterns: [{ include: `#begin-env-tokenizer` }] } },
    ...
    {
      captures: {
        1: { name: `storage.type.function.latex` },
        2: { name: `punctuation.definition.function.latex` },
        3: { name: `punctuation.definition.begin.latex` },
        4: { name: `support.function.general.latex` },
        5: { name: `punctuation.definition.function.latex` },
        6: { name: `punctuation.definition.end.latex` },
      },
    ...
    },
    {
      ...
      beginCaptures: {
        ...
        2: { name: `punctuation.definition.function.latex` },
        3: { patterns: [{ include: `#optional-arg-bracket` }] },
        4: { name: `punctuation.definition.marginpar.begin.latex` },
      },
...
Put specific matches for particular LaTeX keyword.functions before the last two more general functions`,
    ...
    {
      captures: { 0: { name: `keyword.other.item.latex` }, 1: { name: `punctuation.definition.keyword.latex` } },
      match: `(\\\\)item\\b`,
      name: `meta.scope.item.latex`,
    },
    {
      begin:
        `((\\\\)(?:[aA]uto|foot|full|no|ref|short|[tT]ext|[pP]aren|[sS]mart)?[cC]ite(?:al)?(?:p|s|t|author|year(?:par)?|title)?[ANP]*\\*?)((?:(?:\\([^\\)]*\\)){0,2}(?:\\[[^\\]]*\\]){0,2}\\{[\\p{Alphabetic}\\p{Number}_:.-]*\\})*)(<[^\\]<>]*>)?((?:\\[[^\\]]*\\])*)(\\{)`,
      captures: {
        1: { name: `keyword.control.cite.latex` },
        2: { name: `punctuation.definition.keyword.latex` },
        3: { patterns: [{ include: `#autocites-arg` }] },
        4: { patterns: [{ include: `#optional-arg-angle-no-highlight` }] },
        5: { patterns: [{ include: `#optional-arg-bracket-no-highlight` }] },
        6: { name: `punctuation.definition.arguments.begin.latex` },
      },
      end: `\\}`,
      endCaptures: { 0: { name: `punctuation.definition.arguments.end.latex` } },
      ...
      patterns: [{
        captures: { 1: { name: `comment.line.percentage.tex` }, 2: { name: `punctuation.definition.comment.tex` } },
        match: `((%).*)$`,
      }, { match: `[\\p{Alphabetic}\\p{Number}:.-]+`, name: `constant.other.reference.citation.latex` }],
    },
    {
      begin: `((\\\\)bibentry)(\\{)`,
      captures: {
      ...
      endCaptures: { 0: { name: `punctuation.definition.arguments.end.latex` } },
      name: `meta.citation.latex`,
      patterns: [{ match: `[\\p{Alphabetic}\\p{Number}:.]+`, name: `constant.other.reference.citation.latex` }],
    },
    {
      begin: `((\\\\)(?:\\w*[rR]ef\\*?))(?:\\[[^\\]]*\\])?(\\{)`,
      beginCaptures: {
      ...
      patterns: [{ match: `[\\p{Alphabetic}\\p{Number}\\.,:/*!^_-]`, name: `constant.other.reference.label.latex` }],
    },
    { include: `#definition-label` },
    {
    ...
    },
    {
      captures: {
        ...
        4: { name: `punctuation.definition.arguments.begin.latex` },
        5: { name: `punctuation.definition.arguments.end.latex` },
        6: { name: `punctuation.definition.verb.latex` },
        7: { name: `markup.raw.verb.latex` },
        8: { name: `punctuation.definition.verb.latex` },
        9: { name: `punctuation.definition.verb.latex` },
        10: { name: `markup.raw.verb.latex` },
        11: { name: `punctuation.definition.verb.latex` },
      },
      match:
        `((\\\\)(?:mint|mintinline))((?:\\[[^\\[]*?\\])?)(\\{)[a-zA-Z]*(\\})(?:(?:([^a-zA-Z\\{])(.*?)(\\6))|(?:(\\{)(.*?)(\\})))`,
      name: `meta.function.verb.latex`,
    },
    {
      captures: {
        ...
        3: { patterns: [{ include: `#optional-arg-bracket` }] },
        4: { name: `punctuation.definition.verb.latex` },
        5: { name: `markup.raw.verb.latex` },
        6: { name: `punctuation.definition.verb.latex` },
        7: { name: `punctuation.definition.verb.latex` },
        8: { name: `markup.raw.verb.latex` },
        9: { name: `punctuation.definition.verb.latex` },
      },
    ...
    },
    {
      captures: {
        ...
        3: { patterns: [{ include: `#optional-arg-bracket` }] },
        4: { name: `punctuation.definition.verb.latex` },
        5: { name: `source.python`, patterns: [{ include: `source.python` }] },
        6: { name: `punctuation.definition.verb.latex` },
        7: { name: `punctuation.definition.verb.latex` },
        8: { name: `source.python`, patterns: [{ include: `source.python` }] },
        9: { name: `punctuation.definition.verb.latex` },
      },
      match:
        `((\\\\)(?:(?:py|pycon|pylab|pylabcon|sympy|sympycon)[cv]?|pyq|pycq|pyif))((?:\\[[^\\[]*?\\])?)(?:(?:([^a-zA-Z\\{])(.*?)(\\4))|(?:(\\{)(.*?)(\\})))`,
      name: `meta.function.verb.latex`,
    },
    {
      captures: {
        ...
        3: { patterns: [{ include: `#optional-arg-bracket` }] },
        4: { name: `punctuation.definition.verb.latex` },
        5: { name: `source.julia`, patterns: [{ include: `source.julia` }] },
        6: { name: `punctuation.definition.verb.latex` },
        7: { name: `punctuation.definition.verb.latex` },
        8: { name: `source.julia`, patterns: [{ include: `source.julia` }] },
        9: { name: `punctuation.definition.verb.latex` },
      },
    ...
    { match: `\\\\(?:newline|pagebreak|clearpage|linebreak|pause)(?:\\b)`, name: `keyword.control.layout.latex` },
    {
      begin: `\\\\\\(`,
    ...
    },
    {
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.latex` } },
      name: `meta.math.block.latex support.class.math.block.environment.latex`,
      patterns: [{ match: `\\\\\\$`, name: `constant.character.escape.latex` }, { include: `text.tex#math` }, {
        include: `$self`,
      }],
    },
    {
    ...
    {
      captures: { 1: { name: `punctuation.definition.variable.latex` } },
  ...
  r = {
    'autocites-arg': {
      patterns: [{
        captures: {
          1: { patterns: [{ include: `#optional-arg-parenthesis-no-highlight` }] },
          2: { patterns: [{ include: `#optional-arg-bracket-no-highlight` }] },
          3: { name: `punctuation.definition.arguments.begin.latex` },
          4: { name: `constant.other.reference.citation.latex` },
          5: { name: `punctuation.definition.arguments.end.latex` },
          6: { patterns: [{ include: `#autocites-arg` }] },
        },
    ...
    'begin-env-tokenizer': {
      captures: {
        ...
        10: { name: `variable.parameter.function.latex` },
        11: { name: `punctuation.definition.arguments.end.latex` },
      },
    ...
    'multiline-optional-arg': {
      begin: `\\G\\[`,
      beginCaptures: { 0: { name: `punctuation.definition.arguments.optional.begin.latex` } },
      contentName: `variable.parameter.function.latex`,
      end: `\\]`,
      endCaptures: { 0: { name: `punctuation.definition.arguments.optional.end.latex` } },
    ...
    'optional-arg-angle-no-highlight': {
      patterns: [{
        captures: {
          1: { name: `punctuation.definition.arguments.optional.begin.latex` },
          2: { name: `punctuation.definition.arguments.optional.end.latex` },
        },
        match: `(<)[^<]*?(>)`,
        name: `meta.parameter.optional.latex`,
      }],
    ...
    'optional-arg-bracket': {
      patterns: [{
        captures: {
          1: { name: `punctuation.definition.arguments.optional.begin.latex` },
          2: { name: `variable.parameter.function.latex` },
          3: { name: `punctuation.definition.arguments.optional.end.latex` },
        },
        match: `(\\[)([^\\[]*?)(\\])`,
        name: `meta.parameter.optional.latex`,
      }],
