var e = `Dart`,
  ...
  n = [
    { match: `^(#!.*)$`, name: `meta.preprocessor.script.dart` },
    {
      ...
      }, { match: `\\b(if)\\b`, name: `keyword.control.dart` }],
    },
    { include: `#comments` },
    { include: `#punctuation` },
    { include: `#annotations` },
  ...
  r = {
    annotations: { patterns: [{ match: `@[a-zA-Z]+`, name: `storage.type.annotation.dart` }] },
    'class-identifier': {
      patterns: [{ match: `(?<!\\$)\\b(bool|num|int|double|dynamic)\\b(?!\\$)`, name: `support.class.dart` }, {
        match: `(?<!\\$)\\bvoid\\b(?!\\$)`,
    ...
    'comments-doc-oldschool': {
      patterns: [{
        ...
        name: `comment.block.documentation.dart`,
        patterns: [{ include: `#comments-doc-oldschool` }, { include: `#comments-block` }, { include: `#dartdoc` }],
      }],
    },
    'comments-inline': {
      patterns: [{ include: `#comments-block` }, {
    ...
    'constants-and-special-vars': {
      patterns: [
        { match: `(?<!\\$)\\b(true|false|null)\\b(?!\\$)`, name: `constant.language.dart` },
        { match: `(?<!\\$)\\b(this|super|augmented)\\b(?!\\$)`, name: `variable.language.dart` },
        {
    ...
    dartdoc: {
      patterns: [
        { captures: { 0: { name: `variable.name.source.dart` } }, match: `(\\[.*?\\])` },
        { captures: { 0: { name: `variable.name.source.dart` } }, match: `^ {4,}(?![ \\*]).*` },
        { begin: '```.*?$', contentName: `variable.other.source.dart`, end: '```' },
        { captures: { 0: { name: `variable.other.source.dart` } }, match: '(`[^`]+?`)' },
        { captures: { 2: { name: `variable.other.source.dart` } }, match: `(\\* ((    ).*))$` },
      ],
    },
    expression: {
      patterns: [{ include: `#constants-and-special-vars` }, { include: `#strings` }, {
        match: `[a-zA-Z0-9_]+`,
    ...
    'function-identifier': {
      patterns: [{
        captures: { 1: { name: `entity.name.function.dart` }, 2: { patterns: [{ include: `#type-args` }] } },
        match: `([_$]*[a-z][a-zA-Z0-9_$]*)(<(?:[a-zA-Z0-9_$<>?]|,\\s*|\\s+extends\\s+)+>)?[!?]?\\(`,
      }],
    },
    keywords: {
      patterns: [
        { match: `(?<!\\$)\\bas\\b(?!\\$)`, name: `keyword.cast.dart` },
        {
        ...
        { match: `(?<!\\$)\\b(sync(\\*)?|async(\\*)?|await|yield(\\*)?)\\b(?!\\$)`, name: `keyword.control.dart` },
        { match: `(?<!\\$)\\bassert\\b(?!\\$)`, name: `keyword.control.dart` },
        { match: `(?<!\\$)\\b(new)\\b(?!\\$)`, name: `keyword.control.new.dart` },
        { match: `(?<!\\$)\\b(return)\\b(?!\\$)`, name: `keyword.control.return.dart` },
        {
          match:
        ...
        { match: `(?<!\\$)\\b(?:void|var)\\b(?!\\$)`, name: `storage.type.primitive.dart` },
      ],
    },
    operators: {
      patterns: [
        ...
        { match: `((&|\\^|\\||<<|>>>?)=)`, name: `keyword.operator.assignment.bitwise.dart` },
        { match: `(=>)`, name: `keyword.operator.closure.dart` },
        { match: `(==|!=|<=?|>=?)`, name: `keyword.operator.comparison.dart` },
        { match: `(([+*/%-]|\\~)=)`, name: `keyword.operator.assignment.arithmetic.dart` },
        { match: `(=)`, name: `keyword.operator.assignment.dart` },
        { match: `(\\-\\-|\\+\\+)`, name: `keyword.operator.increment-decrement.dart` },
        { match: `(\\-|\\+|\\*|\\/|\\~\\/|%)`, name: `keyword.operator.arithmetic.dart` },
        { match: `(!|&&|\\|\\|)`, name: `keyword.operator.logical.dart` },
      ],
    },
    punctuation: {
      patterns: [{ match: `,`, name: `punctuation.comma.dart` }, { match: `;`, name: `punctuation.terminator.dart` }, {
        match: `\\.`,
    ...
    'string-interp': {
      patterns: [
        ...
        { begin: `\\$\\{`, end: `\\}`, name: `meta.embedded.expression.dart`, patterns: [{ include: `#expression` }] },
    ...
    strings: {
      patterns: [
        ...
        { begin: `r"""`, end: `"""(?!")`, name: `string.quoted.triple.double.dart` },
        { begin: `r'''`, end: `'''(?!')`, name: `string.quoted.triple.single.dart` },
        {
          begin: `(?<!\\|r)"`,
          end: `"`,
          name: `string.interpolated.double.dart`,
          patterns: [{ match: `\\n`, name: `invalid.string.newline` }, { include: `#string-interp` }],
        },
        {
          begin: `r"`,
          end: `"`,
    ...
    'type-args': {
      ...
      patterns: [{ include: `#class-identifier` }, { match: `,` }, {
        match: `extends`,
        name: `keyword.declaration.dart`,
      }, { include: `#comments` }],
    },
