var e = `min-light`,
  ...
  r = [
    ...
    { scope: [`string`, `markup.fenced_code`, `markup.inline`], settings: { foreground: `#2b5581` } },
    { scope: [`comment`, `string.quoted.docstring.multi`], settings: { foreground: `#c2c3c5` } },
    {
      scope: [
        `constant.numeric`,
        `constant.language`,
    ...
    { scope: [`strong`, `markup.heading.markdown`, `markup.bold.markdown`], settings: { foreground: `#6f42c1` } },
    {
      scope: [
