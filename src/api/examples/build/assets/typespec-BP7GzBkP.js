  ...
  i = {
    'alias-id': {
      ...
      beginCaptures: { 1: { name: `keyword.operator.assignment.tsp` } },
        ...
        `(?=,|;|@|\\)|\\}|\\b(?:extern)\\b|\\b(?:namespace|model|op|using|import|enum|alias|union|interface|dec|fn)\\b)`,
      name: `meta.alias-id.typespec`,
      patterns: [{ include: `#expression` }],
    },
    'alias-statement': {
      begin: '\\b(alias)\\b\\s+(\\b[_$[:alpha:]][_$[:alnum:]]*\\b|`(?:[^`\\\\]|\\\\.)*`)\\s*',
      beginCaptures: { 1: { name: `keyword.other.tsp` }, 2: { name: `entity.name.type.tsp` } },
      end:
        `(?=,|;|@|\\)|\\}|\\b(?:extern)\\b|\\b(?:namespace|model|op|using|import|enum|alias|union|interface|dec|fn)\\b)`,
    ...
    'augment-decorator-statement': {
      ...
      beginCaptures: { 1: { name: `entity.name.tag.tsp` }, 2: { name: `entity.name.tag.tsp` } },
      end:
        `(?=[_$[:alpha:]])|(?=,|;|@|\\)|\\}|\\b(?:extern)\\b|\\b(?:namespace|model|op|using|import|enum|alias|union|interface|dec|fn)\\b)`,
    ...
    'boolean-literal': { match: `\\b(true|false)\\b`, name: `constant.language.tsp` },
    callExpression: {
      begin: `(\\b[_$[:alpha:]](?:[_$[:alnum:]]|\\.[_$[:alpha:]])*\\b)\\s*(\\()`,
      beginCaptures: { 1: { name: `entity.name.function.tsp` }, 2: { name: `punctuation.parenthesis.open.tsp` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.parenthesis.close.tsp` } },
      name: `meta.callExpression.typespec`,
      patterns: [{ include: `#token` }, { include: `#expression` }, { include: `#punctuation-comma` }],
    },
    'const-statement': {
      begin: '\\b(const)\\b\\s+(\\b[_$[:alpha:]][_$[:alnum:]]*\\b|`(?:[^`\\\\]|\\\\.)*`)',
      beginCaptures: { 1: { name: `keyword.other.tsp` }, 2: { name: `variable.name.tsp` } },
      end:
        `(?=,|;|@|\\)|\\}|\\b(?:extern)\\b|\\b(?:namespace|model|op|using|import|enum|alias|union|interface|dec|fn)\\b)`,
      name: `meta.const-statement.typespec`,
      patterns: [{ include: `#type-annotation` }, { include: `#operator-assignment` }, { include: `#expression` }],
    },
    decorator: {
      begin: `((@)\\b[_$[:alpha:]](?:[_$[:alnum:]]|\\.[_$[:alpha:]])*\\b)`,
      beginCaptures: { 1: { name: `entity.name.tag.tsp` }, 2: { name: `entity.name.tag.tsp` } },
    ...
    directive: {
      ...
      patterns: [{ include: `#string-literal` }, { include: `#identifier-expression` }],
    },
    'doc-comment': {
      begin: `/\\*\\*`,
    ...
    'doc-comment-block': {
      patterns: [{ include: `#doc-comment-param` }, { include: `#doc-comment-return-tag` }, {
    ...
    'doc-comment-return-tag': {
      captures: { 1: { name: `keyword.tag.tspdoc` }, 2: { name: `keyword.tag.tspdoc` } },
      match: `(?x)((@)(?:returns))\\b`,
      name: `comment.block.tsp`,
    },
    'doc-comment-unknown-tag': {
      captures: { 1: { name: `entity.name.tag.tsp` }, 2: { name: `entity.name.tag.tsp` } },
    ...
    'else-expression': {
      ...
      patterns: [{ include: `#projection-expression` }, { include: `#projection-body` }],
    },
    'else-if-expression': {
      begin: `\\b(else)\\s+(if)\\b`,
      beginCaptures: { 1: { name: `keyword.other.tsp` }, 2: { name: `keyword.other.tsp` } },
      end:
        `((?<=\\})|(?=,|;|@|\\)|\\}|\\b(?:extern)\\b|\\b(?:namespace|model|op|using|import|enum|alias|union|interface|dec|fn)\\b))`,
    ...
    'enum-body': {
      ...
      patterns: [{ include: `#enum-member` }, { include: `#token` }, { include: `#directive` }, {
        include: `#decorator`,
      }, { include: `#punctuation-comma` }],
    },
    'enum-member': {
      begin: '(?:(\\b[_$[:alpha:]][_$[:alnum:]]*\\b|`(?:[^`\\\\]|\\\\.)*`)\\s*(:?))',
      beginCaptures: { 1: { name: `variable.name.tsp` }, 2: { name: `keyword.operator.type.annotation.tsp` } },
      end:
        `(?=,|;|@|\\)|\\}|\\b(?:extern)\\b|\\b(?:namespace|model|op|using|import|enum|alias|union|interface|dec|fn)\\b)`,
    ...
    'function-declaration-statement': {
      ...
      patterns: [{ include: `#token` }, { include: `#operation-parameters` }, { include: `#type-annotation` }],
    },
    ...
    'interface-body': {
      ...
      patterns: [{ include: `#token` }, { include: `#directive` }, { include: `#decorator` }, {
    ...
    'interface-member': {
      ...
      beginCaptures: { 1: { name: `keyword.other.tsp` }, 2: { name: `entity.name.function.tsp` } },
      end:
        `(?=,|;|@|\\)|\\}|\\b(?:extern)\\b|\\b(?:namespace|model|op|using|import|enum|alias|union|interface|dec|fn)\\b)`,
    ...
    'interface-statement': {
      ...
      patterns: [{ include: `#token` }, { include: `#type-parameters` }, { include: `#interface-heritage` }, {
    ...
    'model-property': {
      ...
      beginCaptures: { 1: { name: `variable.name.tsp` }, 2: { name: `string.quoted.double.tsp` } },
      end:
        `(?=,|;|@|\\)|\\}|\\b(?:extern)\\b|\\b(?:namespace|model|op|using|import|enum|alias|union|interface|dec|fn)\\b)`,
      name: `meta.model-property.typespec`,
      patterns: [{ include: `#token` }, { include: `#type-annotation` }, { include: `#operator-assignment` }, {
        include: `#expression`,
      }],
    },
    'model-statement': {
      ...
      patterns: [{ include: `#token` }, { include: `#type-parameters` }, { include: `#model-heritage` }, {
        include: `#expression`,
      }],
    },
    'namespace-body': {
    ...
    'namespace-name': {
      ...
      patterns: [{ include: `#identifier-expression` }, { include: `#punctuation-accessor` }],
    },
    'namespace-statement': {
      begin: `\\b(namespace)\\b`,
      beginCaptures: { 1: { name: `keyword.other.tsp` } },
      ...
      patterns: [{ include: `#token` }, { include: `#namespace-name` }, { include: `#namespace-body` }],
    },
    'numeric-literal': {
      match:
    ...
    'object-literal': {
      ...
      patterns: [{ include: `#token` }, { include: `#object-literal-property` }, { include: `#directive` }, {
        include: `#spread-operator`,
      }, { include: `#punctuation-comma` }],
    },
    ...
    'operation-parameters': {
      ...
      patterns: [{ include: `#token` }, { include: `#decorator` }, { include: `#model-property` }, {
        include: `#spread-operator`,
      }, { include: `#punctuation-comma` }],
    },
    'operation-signature': {
      patterns: [{ include: `#type-parameters` }, { include: `#operation-heritage` }, {
    ...
    'operator-assignment': { match: `=`, name: `keyword.operator.assignment.tsp` },
    ...
    projection: {
      ...
      patterns: [{ include: `#projection-parameters` }, { include: `#projection-body` }],
    },
    'projection-body': {
      begin: `\\{`,
      beginCaptures: { 0: { name: `punctuation.curlybrace.open.tsp` } },
      ...
      patterns: [{ include: `#projection-expression` }, { include: `#punctuation-semicolon` }],
    },
    'projection-expression': {
      patterns: [{ include: `#else-if-expression` }, { include: `#if-expression` }, { include: `#else-expression` }, {
    ...
    'punctuation-semicolon': { match: `;`, name: `punctuation.terminator.statement.tsp` },
    'scalar-body': {
      begin: `\\{`,
      beginCaptures: { 0: { name: `punctuation.curlybrace.open.tsp` } },
      end: `\\}`,
      ...
      patterns: [{ include: `#token` }, { include: `#directive` }, { include: `#scalar-constructor` }, {
        include: `#punctuation-semicolon`,
      }],
    },
    'scalar-constructor': {
    ...
    'scalar-statement': {
      ...
      patterns: [{ include: `#token` }, { include: `#type-parameters` }, { include: `#scalar-extends` }, {
        include: `#scalar-body`,
      }],
    },
    'spread-operator': {
    ...
    'string-literal': {
      ...
      patterns: [{ include: `#template-expression` }, { include: `#escape-character` }],
    },
    'template-expression': {
      begin: `\\$\\{`,
      beginCaptures: { 0: { name: `punctuation.definition.template-expression.begin.tsp` } },
      end: `\\}`,
      endCaptures: { 0: { name: `punctuation.definition.template-expression.end.tsp` } },
    ...
    'type-argument': {
      begin: '(?:(\\b[_$[:alpha:]][_$[:alnum:]]*\\b|`(?:[^`\\\\]|\\\\.)*`)\\s*(=))',
      beginCaptures: { 1: { name: `entity.name.type.tsp` }, 2: { name: `keyword.operator.assignment.tsp` } },
      end: `=`,
    ...
    'type-arguments': {
      begin: `<`,
      beginCaptures: { 0: { name: `punctuation.definition.typeparameters.begin.tsp` } },
      end: `>`,
      endCaptures: { 0: { name: `punctuation.definition.typeparameters.end.tsp` } },
      name: `meta.type-arguments.typespec`,
      patterns: [{ include: `#type-argument` }, { include: `#expression` }, { include: `#punctuation-comma` }],
    },
    'type-parameter': {
      begin: '(\\b[_$[:alpha:]][_$[:alnum:]]*\\b|`(?:[^`\\\\]|\\\\.)*`)',
      ...
      patterns: [{ include: `#token` }, { include: `#type-parameter-constraint` }, {
    ...
    'using-statement': {
      ...
      patterns: [{ include: `#token` }, { include: `#identifier-expression` }, { include: `#punctuation-accessor` }],
    },
    valueof: {
      begin: `\\b(valueof)`,
      beginCaptures: { 1: { name: `keyword.other.tsp` } },
