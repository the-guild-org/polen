var e = `ZenScript`,
  ...
  i = {
    ...
    class: {
      captures: { 1: { name: `storage.type.zenscript` }, 2: { name: `entity.name.type.class.zenscript` } },
      comment: `class`,
      match: `(zenClass)\\s+(\\w+)`,
    ...
    functions: {
      captures: { 0: { name: `storage.type.function.zenscript` }, 1: { name: `entity.name.function.zenscript` } },
      comment: `functions`,
    ...
    keywords: {
      patterns: [
        ...
        { comment: `annotation keywords`, match: `\\b(Native|Precondition)\\b`, name: `entity.other.attribute-name` },
        { comment: `language keywords`, match: `\\b(null|true|false)\\b`, name: `constant.language` },
      ],
    },
    operators: {
      patterns: [{
      ...
      }, { comment: `colons`, match: `\\b(;|:)\\b`, name: `keyword.control` }],
    },
    quotes: {
      patterns: [{
        begin: `"`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.zenscript` } },
        end: `"`,
        endCaptures: { 0: { name: `punctuation.definition.string.end.zenscript` } },
        name: `string.quoted.double.zenscript`,
        patterns: [{ match: `\\\\.`, name: `constant.character.escape.zenscript` }],
      }, {
        begin: `'`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.zenscript` } },
        end: `'`,
    ...
    var: { comment: `var`, match: `\\b(val|var)\\b`, name: `storage.type` },
  },
  a = `source.zenscript`,
