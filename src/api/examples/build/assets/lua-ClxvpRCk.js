var e = `Lua`,
  ...
  n = [
    {
      ...
      beginCaptures: { 1: { name: `keyword.local.lua` }, 2: { name: `keyword.control.lua` } },
      end: `(?<=[\\)\\-{}\\[\\]"'])`,
      ...
      patterns: [
        ...
        {
          begin: `(\\()`,
          beginCaptures: { 1: { name: `punctuation.definition.parameters.begin.lua` } },
          end: `(\\))|(?=[\\-\\.{}\\[\\]"'])`,
          endCaptures: { 1: { name: `punctuation.definition.parameters.finish.lua` } },
          name: `meta.parameter.lua`,
          patterns: [
            { include: `#comment` },
            { match: `[a-zA-Z_][a-zA-Z0-9_]*`, name: `variable.parameter.function.lua` },
        ...
        { match: `\\b([a-zA-Z_][a-zA-Z0-9_]*)\\b\\s*(?=:)`, name: `entity.name.class.lua` },
        { match: `\\b([a-zA-Z_][a-zA-Z0-9_]*)\\b`, name: `entity.name.function.lua` },
      ],
    },
    {
    ...
    { match: `(?<![\\w\\d.])0[xX][0-9A-Fa-f]+(?![pPeE.0-9])`, name: `constant.numeric.integer.hexadecimal.lua` },
    { match: `(?<![\\w\\d.])\\d+(\\.\\d*)?([eE]-?\\d*)?`, name: `constant.numeric.float.lua` },
    { match: `(?<![\\w\\d.])\\.\\d+([eE]-?\\d*)?`, name: `constant.numeric.float.lua` },
    { match: `(?<![\\w\\d.])\\d+(?![pPeE.0-9])`, name: `constant.numeric.integer.lua` },
    { include: `#string` },
    {
    ...
    { include: `#comment` },
    {
      captures: { 1: { name: `keyword.control.goto.lua` }, 2: { name: `string.tag.lua` } },
    ...
    { captures: { 0: { name: `storage.type.attribute.lua` } }, match: `<\\s*(const|close)\\s*>` },
    { match: `\\<[a-zA-Z_\\*][a-zA-Z0-9_\\.\\*\\-]*\\>`, name: `storage.type.generic.lua` },
    {
    ...
    { match: `(?<![^.]\\.|:)\\b(async)\\b(?!\\s*=(?!=))`, name: `entity.name.tag.lua` },
    {
      match:
    ...
    { match: `\\b([a-zA-Z_][a-zA-Z0-9_]*)\\b(?=\\s*(?:[({"']|\\[\\[))`, name: `support.function.any-method.lua` },
    { match: `\\b([a-zA-Z_][a-zA-Z0-9_]*)\\b(?=\\s*\\??:)`, name: `entity.name.class.lua` },
    {
      match: `(?<=[^.]\\.|:)\\b([a-zA-Z_][a-zA-Z0-9_]*)\\b(?!\\s*=\\s*\\b(function)\\b)`,
      name: `entity.other.attribute.lua`,
    },
    { match: `\\b([a-zA-Z_][a-zA-Z0-9_]*)\\b(?!\\s*=\\s*\\b(function)\\b)`, name: `variable.other.lua` },
    { match: `\\b([a-zA-Z_][a-zA-Z0-9_]*)\\b(?=\\s*=\\s*\\b(function)\\b)`, name: `entity.name.function.lua` },
    { match: `\\+|-|%|#|\\*|\\/|\\^|==?|~=|!=|<=?|>=?|(?<!\\.)\\.{2}(?!\\.)`, name: `keyword.operator.lua` },
  ],
  r = {
    comment: {
      patterns: [{
        begin: `(^[ \\t]+)?(?=--)`,
        beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.lua` } },
        end: `(?!\\G)((?!^)[ \\t]+\\n)?`,
        endCaptures: { 1: { name: `punctuation.whitespace.comment.trailing.lua` } },
        patterns: [{
          begin: `--\\[(=*)\\[@@@`,
          beginCaptures: { 0: { name: `punctuation.definition.comment.begin.lua` } },
          end: `(--)?\\]\\1\\]`,
      ...
      patterns: [
        {
          ...
          patterns: [{ match: `\\b([a-zA-Z_\\*][a-zA-Z0-9_\\.\\*\\-]*)`, name: `support.class.lua` }, {
            match: `:|,`,
        ...
        },
        {
          ...
          beginCaptures: { 1: { name: `storage.type.annotation.lua` }, 2: { name: `support.function.library.lua` } },
          end: `(?=[\\n@#])`,
          patterns: [{ include: `#emmydoc.type` }],
        },
        {
          ...
          patterns: [{
            ...
            patterns: [{ include: `#emmydoc.type` }, { match: `([+-|])`, name: `keyword.operator.lua` }],
          }],
        },
        {
          begin: `(?<=---)[ \\t]*@param`,
          ...
          patterns: [{
            ...
            beginCaptures: { 1: { name: `entity.name.variable.lua` }, 2: { name: `keyword.operator.lua` } },
            end: `(?=[\\n#])`,
            patterns: [{ include: `#emmydoc.type` }],
          }],
        },
        {
          ...
          patterns: [{ match: `\\?`, name: `keyword.operator.lua` }, { include: `#emmydoc.type` }],
        },
        {
          begin: `(?<=---)[ \\t]*@field`,
          beginCaptures: { 0: { name: `storage.type.annotation.lua` } },
          ...
          patterns: [{
            begin: `(\\b([a-zA-Z_][a-zA-Z0-9_]*)\\b|(\\[))(\\??)`,
            beginCaptures: { 2: { name: `entity.name.variable.lua` }, 3: { name: `keyword.operator.lua` } },
            end: `(?=[\\n#])`,
            patterns: [{ include: `#string` }, { include: `#emmydoc.type` }, {
              match: `\\]`,
              name: `keyword.operator.lua`,
            }],
          }],
        ...
        },
        {
          ...
          patterns: [{ match: `\\b(5\\.1|5\\.2|5\\.3|5\\.4|JIT)\\b`, name: `support.class.lua` }, {
            match: `,|\\>|\\<`,
            name: `keyword.operator.lua`,
          }],
        },
        ...
        },
        {
          ...
          patterns: [{
            begin: `([a-zA-Z_\\-0-9]+)[ \\t]*(:)?`,
            beginCaptures: { 1: { name: `keyword.other.unit` }, 2: { name: `keyword.operator.unit` } },
            end: `(?=\\n)`,
            patterns: [{ match: `\\b([a-zA-Z_\\*][a-zA-Z0-9_\\-]*)`, name: `support.class.lua` }, {
              match: `,`,
              name: `keyword.operator.lua`,
        ...
        { match: `(?<=---)[ \\t]*@(async|nodiscard)`, name: `storage.type.annotation.lua` },
        {
          begin: `(?<=---)\\|\\s*[\\>\\+]?`,
          beginCaptures: { 0: { name: `storage.type.annotation.lua` } },
          end: `(?=[\\n@#])`,
    ...
    'emmydoc.type': {
      patterns: [
        ...
        { match: '[\\{\\}\\:\\,\\?\\|\\`][ \\t]*', name: `keyword.operator.lua` },
        {
          ...
          patterns: [{ match: `([a-zA-Z0-9_\\.\\*\\[\\]\\<\\>\\,\\-]+)(?<!,)[ \\t]*`, name: `support.type.lua` }, {
            match: `(\\.\\.\\.)[ \\t]*`,
            name: `constant.language.lua`,
          }, { include: `#string` }],
        },
    ...
    escaped_char: {
      patterns: [
        ...
        { match: `\\\\x[0-9A-Fa-f][0-9A-Fa-f]`, name: `constant.character.escape.byte.lua` },
        { match: `\\\\u\\{[0-9A-Fa-f]+\\}`, name: `constant.character.escape.unicode.lua` },
        { match: `\\\\.`, name: `invalid.illegal.character.escape.lua` },
      ],
    },
    ldoc_tag: {
      captures: { 1: { name: `punctuation.definition.block.tag.ldoc` }, 2: { name: `storage.type.class.ldoc` } },
      match:
  ...
  i = `source.lua`,
  a = { displayName: `Lua`, name: `lua`, patterns: n, repository: r, scopeName: i }
