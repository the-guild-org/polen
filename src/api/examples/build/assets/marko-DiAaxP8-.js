var e = `Marko`,
  ...
  r = [{
    begin: `^\\s*(style)\\s+(\\{)`,
    beginCaptures: { 1: { name: `storage.type.marko.css` }, 2: { name: `punctuation.section.scope.begin.marko.css` } },
  ...
  i = {
      ...
      patterns: [
        {
          ...
          patterns: [{ include: `#html-args-or-method` }, {
            applyEndPatternLast: 1,
            begin: `\\s*(:?=)\\s*`,
    ...
    'concise-html-line': {
      captures: {
        ...
        2: {
          patterns: [{ include: `#html-comments` }, { include: `#tag-html` }, { match: `\\\\.`, name: `string` }, {
            include: `#placeholder`,
          }, { match: `.+?`, name: `string` }],
        },
      },
    ...
    'concise-open-tag-content': {
      patterns: [{ include: `#tag-before-attrs` }, {
        begin: `\\s*\\[`,
      ...
      patterns: [
        ...
        { include: `#tag-html` },
        {
          ...
          patterns: [{
            ...
            patterns: [{ include: `#concise-open-tag-content` }, { include: `#concise-style-block-less` }, {
            ...
            patterns: [{ include: `#concise-open-tag-content` }, { include: `#concise-style-block-scss` }, {
            ...
            patterns: [{ include: `#concise-open-tag-content` }, { include: `#concise-style-block` }, {
            ...
            patterns: [{ include: `#concise-open-tag-content` }, { include: `#concise-script-block` }, {
            ...
            patterns: [{ include: `#concise-open-tag-content` }, { include: `#content-concise-mode` }],
            while: `(?=^\\1\\s+(\\S|$))`,
          }],
        },
        { include: `#invalid` },
    ...
    'html-args-or-method': {
      patterns: [{ include: `#javascript-args` }, {
        begin: `(?<=\\))\\s*(?=\\{)`,
    ...
    invalid: { match: `[^\\s]`, name: `invalid.illegal.character-not-allowed-here.marko` },
    'javascript-args': {
      begin: `(?=\\()`,
    ...
    'javascript-comments': {
      patterns: [{ include: `#javascript-comment-multiline` }, { include: `#javascript-comment-line` }],
    },
    'javascript-enclosed': {
...
[-+*%](?!-)
    ...
    'javascript-expression': {
      patterns: [{ include: `#javascript-enclosed` }, {
        captures: { 0: { patterns: [{ include: `source.js` }] } },
        comment: `Match identifiers and member expressions`,
        match: `[0-9a-zA-Z$_.]+`,
      }],
    },
    'javascript-statement': { patterns: [{ include: `#javascript-enclosed` }, { include: `source.js` }] },
    'open-tag-content': {
      patterns: [{ include: `#tag-before-attrs` }, {
        begin: `(?= )`,
    ...
    'tag-before-attrs': {
      ...
      patterns: [{ include: `#tag-name` }, {
        ...
        endCaptures: { 0: { name: `punctuation.section.scope.end.marko` } },
        patterns: [{ include: `source.js#function-parameters-body` }, { include: `source.js` }],
    ...
    'tag-html': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#open-tag-content` }, {
          begin: `>`,
          beginCaptures: { 0: { name: `punctuation.definition.tag.end.marko` } },
    ...
    'tag-name': {
      patterns: [{
        ...
        captures: {
          ...
          3: {
            patterns: [
              { comment: `Core tag.`, match: `(attrs|return|import)(?=\\b)`, name: `support.type.builtin.marko` },
              {
                comment: `Core tag.`,
                match: `(for|if|while|else-if|else|macro|tag|await|let|const|effect|set|get|id|lifecycle)(?=\\b)`,
                name: `support.function.marko`,
              },
              { comment: `Attribute tag.`, match: `@.+`, name: `entity.other.attribute-name.marko` },
              { comment: `Native or userland tag.`, match: `.+`, name: `entity.name.tag.marko` },
            ],
          },
        },
