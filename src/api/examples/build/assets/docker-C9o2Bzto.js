var e = `Dockerfile`,
  ...
  n = [{
    ...
    captures: { 1: { name: `keyword.control.dockerfile` }, 2: { name: `keyword.other.special-method.dockerfile` } },
    match:
    ...
    captures: { 1: { name: `keyword.operator.dockerfile` }, 2: { name: `keyword.other.special-method.dockerfile` } },
