var e = `github-light`,
  ...
  n = !0,
  r = [
    { scope: [`comment`, `punctuation.definition.comment`, `string.comment`], settings: { foreground: `#6e7781` } },
    {
      scope: [
        `constant`,
    ...
    { scope: [`entity.name`, `meta.export.default`, `meta.definition.variable`], settings: { foreground: `#953800` } },
    {
      scope: [
    ...
    { scope: [`entity.name.tag`, `support.class.component`], settings: { foreground: `#116329` } },
    { scope: `keyword`, settings: { foreground: `#cf222e` } },
    { scope: [`storage`, `storage.type`], settings: { foreground: `#cf222e` } },
    {
      scope: [`storage.modifier.package`, `storage.modifier.import`, `storage.type.java`],
      settings: { foreground: `#24292f` },
    },
    { scope: [`string`, `string punctuation.section.embedded source`], settings: { foreground: `#0a3069` } },
    { scope: `support`, settings: { foreground: `#0550ae` } },
    { scope: `meta.property-name`, settings: { foreground: `#0550ae` } },
    { scope: `variable`, settings: { foreground: `#953800` } },
    { scope: `variable.other`, settings: { foreground: `#24292f` } },
    { scope: `invalid.broken`, settings: { fontStyle: `italic`, foreground: `#82071e` } },
    { scope: `invalid.deprecated`, settings: { fontStyle: `italic`, foreground: `#82071e` } },
    { scope: `invalid.illegal`, settings: { fontStyle: `italic`, foreground: `#82071e` } },
    { scope: `invalid.unimplemented`, settings: { fontStyle: `italic`, foreground: `#82071e` } },
    {
      scope: `carriage-return`,
      settings: { fontStyle: `italic underline`, background: `#cf222e`, foreground: `#f6f8fa`, content: `^M` },
    },
    { scope: `message.error`, settings: { foreground: `#82071e` } },
    { scope: `string variable`, settings: { foreground: `#0550ae` } },
    { scope: [`source.regexp`, `string.regexp`], settings: { foreground: `#0a3069` } },
    {
      scope: [
    ...
    { scope: `string.regexp constant.character.escape`, settings: { fontStyle: `bold`, foreground: `#116329` } },
    { scope: `support.constant`, settings: { foreground: `#0550ae` } },
    { scope: `support.variable`, settings: { foreground: `#0550ae` } },
    { scope: `support.type.property-name.json`, settings: { foreground: `#116329` } },
    { scope: `meta.module-reference`, settings: { foreground: `#0550ae` } },
    { scope: `punctuation.definition.list.begin.markdown`, settings: { foreground: `#953800` } },
    { scope: [`markup.heading`, `markup.heading entity.name`], settings: { fontStyle: `bold`, foreground: `#0550ae` } },
    { scope: `markup.quote`, settings: { foreground: `#116329` } },
    { scope: `markup.italic`, settings: { fontStyle: `italic`, foreground: `#24292f` } },
    { scope: `markup.bold`, settings: { fontStyle: `bold`, foreground: `#24292f` } },
    { scope: [`markup.underline`], settings: { fontStyle: `underline` } },
    { scope: [`markup.strikethrough`], settings: { fontStyle: `strikethrough` } },
    { scope: `markup.inline.raw`, settings: { foreground: `#0550ae` } },
    {
      scope: [`markup.deleted`, `meta.diff.header.from-file`, `punctuation.definition.deleted`],
      settings: { background: `#ffebe9`, foreground: `#82071e` },
    },
    { scope: [`punctuation.section.embedded`], settings: { foreground: `#cf222e` } },
    {
      scope: [`markup.inserted`, `meta.diff.header.to-file`, `punctuation.definition.inserted`],
      settings: { background: `#dafbe1`, foreground: `#116329` },
    },
    {
      scope: [`markup.changed`, `punctuation.definition.changed`],
      settings: { background: `#ffd8b5`, foreground: `#953800` },
    },
    { scope: [`markup.ignored`, `markup.untracked`], settings: { foreground: `#eaeef2`, background: `#0550ae` } },
    { scope: `meta.diff.range`, settings: { foreground: `#8250df`, fontStyle: `bold` } },
    { scope: `meta.diff.header`, settings: { foreground: `#0550ae` } },
    { scope: `meta.separator`, settings: { fontStyle: `bold`, foreground: `#0550ae` } },
    { scope: `meta.output`, settings: { foreground: `#0550ae` } },
    {
      scope: [
    ...
    { scope: `brackethighlighter.unmatched`, settings: { foreground: `#82071e` } },
    {
      scope: [`constant.other.reference.link`, `string.other.link`],
      settings: { foreground: `#0a3069`, fontStyle: `underline` },
    },
  ],
  i = { name: e, colors: t, semanticHighlighting: !0, tokenColors: r }
export { e as name, i as default, n as semanticHighlighting, r as tokenColors, t as colors }
