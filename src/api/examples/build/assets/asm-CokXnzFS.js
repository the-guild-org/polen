var e = `Assembly`,
  ...
  i = {
    comments: {
      patterns: [{ match: `(;|(^|\\s)#\\s).*$`, name: `comment.line` }, {
        begin: `/\\*`,
        end: `\\*/`,
        name: `comment.block`,
      }, { begin: `^\\s*[\\#%]\\s*if\\s+0\\b`, end: `^\\s*[\\#%]\\s*endif\\b`, name: `comment.preprocessor` }],
    },
    constants: {
      patterns: [
        {
        ...
        { match: `(?i)(?:\\$[0-9]\\_?(?:[[:xdigit:]][[:xdigit:]_]*)?)\\b`, name: `constant.numeric.hex.asm.x86_64` },
        {
    ...
    entities: {
      patterns: [
        { match: `((section|segment)\\s+)?\\.((ro)?data|bss|text)`, name: `entity.name.section` },
        { match: `^\\.?(globa?l|extern|required)\\b`, name: `entity.directive` },
        { match: `(\\$\\w+)\\b`, name: `text.variable` },
        {
          captures: {
            1: { name: `punctuation.separator.asm.x86_64 storage.modifier.asm.x86_64` },
            2: { name: `entity.name.function.special.asm.x86_64` },
            3: { name: `punctuation.separator.asm.x86_64` },
          },
        ...
        },
        {
          captures: {
            1: { name: `punctuation.separator.asm.x86_64 storage.modifier.asm.x86_64` },
            2: { name: `entity.name.function.asm.x86_64` },
            3: { name: `punctuation.separator.asm.x86_64` },
          },
        ...
        },
        {
          captures: {
            1: { name: `punctuation.separator.asm.x86_64 storage.modifier.asm.x86_64` },
            2: { name: `invalid.illegal.entity.name.function.asm.x86_64` },
            3: { name: `punctuation.separator.asm.x86_64` },
          },
          match: `(?:(\\.)?|\\b)([0-9$@~](?:[[:alnum:]_$#@~.?]*))(?:(\\:))`,
    ...
    'mnemonics-avx': {
      patterns: [
        {
          match:
            `(?i)\\b(v((test|permil|maskmov)p[ds]|zero(all|upper)|(perm2|insert|extract|broadcast)f128|broadcasts[ds]))\\b`,
        ...
        { match: `(?i)\\b(v((andn?|x?or)p[ds]))\\b`, name: `keyword.operator.word.mnemonic.avx.promoted.logical` },
        {
        ...
        {
          match:
            `(?i)\\b(vp((abs|sign|(max|min)[su])[bdw]|(add|sub)([bdqw]|u?s[bw])|avg[bw]|extr[bdqw]|madd(wd|ubsw)|mul(hu?w|hrsw|l[dw]|u?dq)|sadbw))\\b`,
        ...
        { match: `(?i)\\b(vblendv?p[ds])\\b`, name: `keyword.operator.word.mnemonic.avx.promoted.packed-blending` },
        { match: `(?i)\\b(vp(test|alignr))\\b`, name: `keyword.operator.word.mnemonic.avx.promoted.packed-other` },
        {
    ...
    'mnemonics-avx2': {
      patterns: [
        ...
        { match: `(?i)\\b(vpbroadcast[bdqw])\\b`, name: `keyword.operator.word.mnemonic.avx2.promoted.packed` },
        { match: `(?i)\\b(vp(blendd|s[lr]lv[dq]|sravd))\\b`, name: `keyword.operator.word.mnemonic.avx2.blend` },
        {
    ...
    'mnemonics-avx512-opmask': {
      ...
      }, { match: `(?i)\\bkunpck(bw|wd|dq)\\b`, name: `keyword.operator.word.mnemonic.avx512.opmask.unpack` }],
    },
    'mnemonics-avx512bw': {
      patterns: [
        { match: `(?i)\\bv(dbpsadbw|movdqu(8|16))\\b`, name: `keyword.operator.word.mnemonic.avx512.bw.dbpsad` },
        { match: `(?i)\\bvp(blendm|cmpu?|movm2)[bw]\\b`, name: `keyword.operator.word.mnemonic.avx512.bw.pblend` },
        { match: `(?i)\\bvperm(w|i2[bw])\\b`, name: `keyword.operator.word.mnemonic.avx512.bw.perpmi2` },
        { match: `(?i)\\bvp(mov([bw]2m|u?swb))\\b`, name: `keyword.operator.word.mnemonic.avx512.bw.pmov` },
        { match: `(?i)\\bvp(s(ll|ra|rl)vw|testn?m[bw])\\b`, name: `keyword.operator.word.mnemonic.avx512.bw.psll` },
        {
    ...
    'mnemonics-avx512dq': {
      ...
      }, { match: `(?i)\\bvp(mov(m2[dq]|b2d|q2m)|mullq)\\b`, name: `keyword.operator.word.mnemonic.avx512.dq.pmov` }],
    },
    'mnemonics-avx512er': {
      patterns: [{
    ...
    'mnemonics-avx512f': {
      patterns: [
        ...
        { match: `(?i)\\bv(cvtt?[ps][ds]2u(dq|si))\\b`, name: `keyword.operator.word.mnemonic.avx512.f.cvtt` },
        { match: `(?i)\\bv(cvt((q|ud)q2p|usi2s)[ds])\\b`, name: `keyword.operator.word.mnemonic.avx512.f.cvt` },
        {
        ...
        { match: `(?i)\\bvpsravq\\b`, name: `keyword.operator.word.mnemonic.avx512.f.sravq` },
        {
    ...
    'mnemonics-avx512fp16': {
      patterns: [
        {
          match:
            `(?i)\\bv((add|cmp|div|fc?(madd|mul)c|fpclass|get(exp|mant)|mul|rcp|reduce|(rnd)?scale|r?sqrt|sub)[ps]h|u?comish)\\b`,
          name: `keyword.operator.word.mnemonic.avx512.fp16.add`,
        },
        { match: `(?i)\\bvcvt(u?([dq]q|w)|pd)2ph\\b`, name: `keyword.operator.word.mnemonic.avx512.fp16.cvtx2ph` },
        { match: `(?i)\\bvcvtph2(u?([dq]q|w)|pd)\\b`, name: `keyword.operator.word.mnemonic.avx512.fp16.cvtph2x` },
        { match: `(?i)\\bvcvt(ph2psx|ps2phx)\\b`, name: `keyword.operator.word.mnemonic.avx512.fp16.cvtx` },
        { match: `(?i)\\bvcvt(s[dsi]|usi)2sh\\b`, name: `keyword.operator.word.mnemonic.avx512.fp16.cvtx2sh` },
        { match: `(?i)\\bvcvtsh2(s[dsi]|usi)\\b`, name: `keyword.operator.word.mnemonic.avx512.fp16.cvtsh2x` },
        {
        ...
        { match: `(?i)\\bv((min|max)ph|mov(sh|w))\\b`, name: `keyword.operator.word.mnemonic.avx512.fp16.max` },
      ],
    },
    'mnemonics-avx512pf': {
      patterns: [{
    ...
    'mnemonics-cet': {
      ...
      }, { match: `(?i)\\bendbranch\\b`, name: `keyword.operator.word.mnemonic.cet.misc` }],
    },
    'mnemonics-esi': { patterns: [{ match: `(?i)\\benqcmds?\\b`, name: `keyword.operator.word.mnemonic.esi` }] },
    'mnemonics-fpu': {
      patterns: [
        { match: `(?i)\\b(fcmov(n?([beu]|be)))\\b`, name: `keyword.operator.word.mnemonic.fpu.data-transfer.mov` },
        {
        ...
        { match: `(?i)\\b(f(u?com[ip]?p?|icomp?|tst|xam))\\b`, name: `keyword.operator.word.mnemonic.fpu.comparison` },
        {
          match: `(?i)\\b(f(sin|cos|sincos|pa?tan|2xm1|yl2x(p1)?))\\b`,
          name: `keyword.operator.word.mnemonic.fpu.transcendental`,
        },
        { match: `(?i)\\b(fld(1|z|pi|l2[et]|l[ng]2))\\b`, name: `keyword.operator.word.mnemonic.fpu.load-constants` },
        {
        ...
        { match: `(?i)\\b(fx(save|rstor)(64)?)\\b`, name: `keyword.operator.word.mnemonic.fpu.state-management` },
      ],
    },
    'mnemonics-future-intel': { patterns: [{ include: `#mnemonics-future-intel-apx` }] },
    'mnemonics-future-intel-apx': {
      patterns: [
        ...
        { match: `(?i)\\b(cfcmovn?([bl]e?|[opsz]))\\b`, name: `keyword.operator.word.mnemonic.apx.cfcmov` },
        { match: `(?i)\\b(cmpn?([bl]e?|[opsz])xadd)\\b`, name: `keyword.operator.word.mnemonic.apx.cmpxadd` },
        { match: `(?i)\\b(jmpabs|(push|pop)2p?)\\b`, name: `keyword.operator.word.mnemonic.apx.other` },
      ],
    },
    'mnemonics-general-purpose': {
      patterns: [
        ...
        { match: `(?i)\\b(and|x?or|not)\\b`, name: `keyword.operator.word.mnemonic.general-purpose.logical` },
        {
        ...
        { match: `(?i)\\b((in|out)(s[bdw]?)?)\\b`, name: `keyword.operator.word.mnemonic.general-purpose.io` },
        {
          match: `(?i)\\b((st|cl)[cdi]|cmc|[ls]ahf|(push|pop)f[dq]?)\\b`,
          name: `keyword.operator.word.mnemonic.general-purpose.flag-control`,
        },
        { match: `(?i)\\b(l[defgs]s)\\b`, name: `keyword.operator.word.mnemonic.general-purpose.segment-registers` },
        {
        ...
        { match: `(?i)\\b(rdrand|rdseed)\\b`, name: `keyword.operator.word.mnemonic.general-purpose.rng` },
        {
    ...
    'mnemonics-intel-isa-xeon-phi': {
      patterns: [{ match: `(?i)\\bv(4fn?(madd)[ps]s|p4dpwssds?)\\b`, name: `keyword.operator.word.mnemonic.xeon-phi` }],
    },
    'mnemonics-intel-manual-listing': {
      patterns: [
        { match: `(?i)\\bcvtt?pd1pi\\b`, name: `keyword.operator.word.mnemonic.other.c` },
        { match: `(?i)\\bv?gf2p8(affine(inv)?q|mul)b\\b`, name: `keyword.operator.word.mnemonic.other.g` },
        { match: `(?i)\\bhreset\\b`, name: `keyword.operator.word.mnemonic.other.h` },
        { match: `(?i)\\bincssp[dq]\\b`, name: `keyword.operator.word.mnemonic.other.i` },
        { match: `(?i)\\bmovdir(i|64b)\\b`, name: `keyword.operator.word.mnemonic.other.m` },
        {
          match: `(?i)\\bp((abs|(max|min)[su]?|mull|sra)q|config|twrite)\\b`,
          name: `keyword.operator.word.mnemonic.other.p`,
        },
        { match: `(?i)\\brd(pid|ssp[dq])\\b`, name: `keyword.operator.word.mnemonic.other.r` },
        { match: `(?i)\\bserialize\\b`, name: `keyword.operator.word.mnemonic.other.s` },
        { match: `(?i)\\btpause\\b`, name: `keyword.operator.word.mnemonic.other.t` },
        { match: `(?i)\\bu(monitor|mwait)\\b`, name: `keyword.operator.word.mnemonic.other.u` },
        { match: `(?i)\\bvbroadcast[fi](32x[248]|64x[24])\\b`, name: `keyword.operator.word.mnemonic.other.vb` },
        { match: `(?i)\\bv(compressw|cvtne2?ps2bf16)\\b`, name: `keyword.operator.word.mnemonic.other.vc` },
        { match: `(?i)\\bvdpbf16ps\\b`, name: `keyword.operator.word.mnemonic.other.vd` },
        { match: `(?i)\\bvextract[fi]32x8\\b`, name: `keyword.operator.word.mnemonic.other.ve` },
        { match: `(?i)\\bv(insert([fi]32x8|i(32|64)x4))\\b`, name: `keyword.operator.word.mnemonic.other.vi` },
        { match: `(?i)\\bv(maskmov|(max|min)sh)\\b`, name: `keyword.operator.word.mnemonic.other.vm` },
        { match: `(?i)\\bvp((2intersect|andn?)[dq]|absq)\\b`, name: `keyword.operator.word.mnemonic.other.vpa` },
        { match: `(?i)\\bvpbroadcasti32x4\\b`, name: `keyword.operator.word.mnemonic.other.vpb` },
        { match: `(?i)\\bvpcompress[bw]\\b`, name: `keyword.operator.word.mnemonic.other.vpc` },
        { match: `(?i)\\bvp(dp(bu|ws)sds?)\\b`, name: `keyword.operator.word.mnemonic.other.vpd` },
        {
        ...
        { match: `(?i)\\b(vpopcnt[bdqw]|vpor[dq])\\b`, name: `keyword.operator.word.mnemonic.other.vpo` },
        { match: `(?i)\\bvprorv[dq]\\b`, name: `keyword.operator.word.mnemonic.other.vpr` },
        { match: `(?i)\\bvp(sh[lr]dv?[dqw]|shufbitqmb|shufps)\\b`, name: `keyword.operator.word.mnemonic.other.vps` },
        { match: `(?i)\\bvpternlog[dq]\\b`, name: `keyword.operator.word.mnemonic.other.vpt` },
        { match: `(?i)\\bvpxor[dq]\\b`, name: `keyword.operator.word.mnemonic.other.vpx` },
        { match: `(?i)\\bv(scalef[ps][dhs]|scatter[dq]p[ds])\\b`, name: `keyword.operator.word.mnemonic.other.vs` },
        { match: `(?i)\\b(wbnoinvd|wru?ss[dq])\\b`, name: `keyword.operator.word.mnemonic.other.w` },
      ],
    },
    'mnemonics-invalid': { patterns: [{ include: `#mnemonics-invalid-amd-sse5` }] },
    'mnemonics-invalid-amd-sse5': {
      patterns: [{
        ...
        match:
          `(?i)\\b(fn?m((add|sub)[ps][ds])|ph(addu?(b[dqw]|w[dq]|dq)|sub(bw|dq|wd))|pma(css?(d(d|q[hl])|w[dw])|dcss?wd))\\b`,
    ...
    'mnemonics-mmx': {
      patterns: [
        { match: `(?i)\\b(mov[dq])\\b`, name: `keyword.operator.word.mnemonic.mmx.data-transfer` },
        {
        ...
        { match: `(?i)\\b(pcmp((eq|gt)[bdw]))\\b`, name: `keyword.operator.word.mnemonic.mmx.comparison` },
        { match: `(?i)\\b(pandn?|px?or)\\b`, name: `keyword.operator.word.mnemonic.mmx.logical` },
        { match: `(?i)\\b(ps([rl]l[dwq]|raw|rad))\\b`, name: `keyword.operator.word.mnemonic.mmx.shift-and-rotate` },
        { match: `(?i)\\b(emms)\\b`, name: `keyword.operator.word.mnemonic.mmx.state-management` },
      ],
    },
    'mnemonics-mpx': {
      patterns: [{ match: `(?i)\\b(bnd(mk|c[lnu]|mov|ldx|stx))\\b`, name: `keyword.operator.word.mnemonic.mpx` }],
    },
    'mnemonics-pseudo-ops': {
      patterns: [
        ...
        {
          match:
            `(?i)\\b(vcmp(eq(_(os|uq|us))?|neq(_(oq|os|us))?|[gl][et](_oq)?|n[gl][et](_uq)?|(un)?ord(_s)?|false(_os)?|true(_us)?)[ps][ds])\\b`,
          name: `keyword.operator.word.pseudo-mnemonic.avx.promoted.comparison`,
        },
        { match: `(?i)\\bvp(cmpn?(eq|le|lt))\\b`, name: `keyword.operator.word.pseudo-mnemonic.avx512.compare` },
        {
    ...
    'mnemonics-sgx': {
      patterns: [
        { match: `(?i)\\bencl[su]\\b`, name: `keyword.operator.word.mnemonic.sgx` },
        {
        ...
        { match: `(?i)\\be(enter|exit|getkey|report|resume)\\b`, name: `support.constant.sgx1.user` },
        { match: `(?i)\\be(aug|mod(pr|t))\\b`, name: `support.constant.sgx2.supervisor` },
        { match: `(?i)\\be(accept(copy)?|modpe)\\b`, name: `support.constant.sgx2.user` },
      ],
    },
    'mnemonics-sha': {
      patterns: [{
    ...
    'mnemonics-smx': {
      patterns: [{ match: `(?i)\\b(getsec)\\b`, name: `keyword.operator.word.mnemonic.smx.getsec` }, {
    ...
    'mnemonics-sse': {
      patterns: [
        { match: `(?i)\\b(mov(([ahlu]|hl|lh|msk)ps|ss))\\b`, name: `keyword.operator.word.mnemonic.sse.data-transfer` },
        {
          match: `(?i)\\b((add|div|max|min|mul|rcp|r?sqrt|sub)[ps]s)\\b`,
          name: `keyword.operator.word.mnemonic.sse.packed-arithmetic`,
        },
        { match: `(?i)\\b(cmp[ps]s|u?comiss)\\b`, name: `keyword.operator.word.mnemonic.sse.comparison` },
        { match: `(?i)\\b((andn?|x?or)ps)\\b`, name: `keyword.operator.word.mnemonic.sse.logical` },
        { match: `(?i)\\b((shuf|unpck[hl])ps)\\b`, name: `keyword.operator.word.mnemonic.sse.shuffle-and-unpack` },
        {
          match: `(?i)\\b(cvt(pi2ps|si2ss|ps2pi|tps2pi|ss2si|tss2si))\\b`,
          name: `keyword.operator.word.mnemonic.sse.conversion`,
        },
        { match: `(?i)\\b((ld|st)mxcsr)\\b`, name: `keyword.operator.word.mnemonic.sse.state-management` },
        {
        ...
        { match: `(?i)\\b(prefetch(nta|t[0-2]|w(t1)?))\\b`, name: `keyword.operator.word.mnemonic.sse.prefetch` },
      ],
    },
    'mnemonics-sse2': {
      patterns: [
        { match: `(?i)\\b(mov([auhl]|msk)pd)\\b`, name: `keyword.operator.word.mnemonic.sse2.data-transfer` },
        {
          match: `(?i)\\b((add|div|max|min|mul|sub|sqrt)[ps]d)\\b`,
          name: `keyword.operator.word.mnemonic.sse2.packed-arithmetic`,
        },
        { match: `(?i)\\b((andn?|x?or)pd)\\b`, name: `keyword.operator.word.mnemonic.sse2.logical` },
        { match: `(?i)\\b((cmpp|u?comis)d)\\b`, name: `keyword.operator.word.mnemonic.sse2.compare` },
        { match: `(?i)\\b((shuf|unpck[hl])pd)\\b`, name: `keyword.operator.word.mnemonic.sse2.shuffle-and-unpack` },
        {
        ...
        { match: `(?i)\\b(mov(dq[au]|q2dq|dq2q))\\b`, name: `keyword.operator.word.mnemonic.sse2.simd-integer.mov` },
        {
    ...
    'mnemonics-sse4': {
      patterns: [
        { match: `(?i)\\b(pmul(ld|dq)|dpp[ds])\\b`, name: `keyword.operator.word.mnemonic.sse4.1.arithmetic` },
        { match: `(?i)\\b(movntdqa)\\b`, name: `keyword.operator.word.mnemonic.sse4.1.load-hint` },
        {
          match: `(?i)\\b(blendv?p[ds]|pblend(vb|w))\\b`,
          name: `keyword.operator.word.mnemonic.sse4.1.packed-blending`,
        },
        { match: `(?i)\\b(p(min|max)(u[dw]|s[bd]))\\b`, name: `keyword.operator.word.mnemonic.sse4.1.packed-integer` },
        { match: `(?i)\\b(round[ps][sd])\\b`, name: `keyword.operator.word.mnemonic.sse4.1.packed-floating-point` },
        {
          match: `(?i)\\b((extract|insert)ps|p((ins|ext)(r[bdq])))\\b`,
          name: `keyword.operator.word.mnemonic.sse4.1.insertion-and-extraction`,
        },
        { match: `(?i)\\b(pmov([sz]x(b[dqw]|dq|wd|wq)))\\b`, name: `keyword.operator.word.mnemonic.sse4.1.conversion` },
        {
          match: `(?i)\\b(mpsadbw|phminposuw|ptest|pcmpeqq|packusdw)\\b`,
          name: `keyword.operator.word.mnemonic.sse4.1.other`,
        },
        { match: `(?i)\\b(pcmp([ei]str[im]|gtq))\\b`, name: `keyword.operator.word.mnemonic.sse4.2` },
      ],
    },
    'mnemonics-supplemental-amd': {
      patterns: [
        ...
        { match: `(?i)\\b(movnts[ds])\\b`, name: `keyword.operator.word.mnemonic.supplemental.amd.memory-management` },
        {
          match: `(?i)\\b(prefetch|clzero)\\b`,
          name: `keyword.operator.word.mnemonic.supplemental.amd.cache-management`,
        },
        { match: `(?i)\\b((extr|insert)q)\\b`, name: `keyword.operator.word.mnemonic.supplemental.amd.sse4.a` },
        {
        ...
        { match: `(?i)\\b(femms)\\b`, name: `keyword.operator.word.mnemonic.supplemental.amd.3dnow` },
        {
          match:
            `(?i)\\b(p(avgusb|(f2i|i2f)[dw]|mulhrw|swapd)|pf((p?n)?acc|add|max|min|mul|rcp(it[12])?|rsqit1|rsqrt|subr?))\\b`,
    ...
    'mnemonics-supplemental-via': {
      patterns: [{ match: `(?i)\\b(montmul)\\b`, name: `keyword.operator.word.mnemonic.supplemental.via` }, {
    ...
    'mnemonics-uirq': {
      patterns: [{ match: `(?i)\\b((cl|st|test)ui|senduipi|uiret)\\b`, name: `keyword.operator.word.mnemonic.uirq` }],
    },
    ...
    preprocessor: {
      patterns: [{
        ...
        begin:
          `^\\s*[%#]\\s*(i?x?define|defined|elif(def)?|else|i[fs]n?(?:def|macro|ctx|idni?|id|num|str|token|empty|env)?|line|(i|end|uni?)?macro|pragma|endif)\\b`,
        ...
        begin:
          `^\\s*[#%]\\s*(assign|strlen|substr|(end|exit)?rep|push|pop|rotate|use|ifusing|ifusable|def(?:ailas|str|tok)|undef(?:alias)?)\\b`,
    ...
    'preprocessor-functions': {
      patterns: [{
        begin:
          `((%)(?:(abs|cond|count|eval|isn?(?:def|macro|ctx|idni?|id|num|str|token|empty|env)?|num|sel|str(?:cat|len)?|substr|tok)\\s*(\\()))`,
        captures: { 3: { name: `support.function.preprocessor.asm.x86_64` } },
        end: `(\\))|$`,
        name: `meta.preprocessor.function.asm.x86_64`,
        patterns: [{ include: `#preprocessor-functions` }],
      }],
    },
    registers: {
      patterns: [
        ...
        { match: `(?i)\\b(?:[cdefgs]s)\\b`, name: `constant.language.register.segment.asm.x86_64` },
        { match: `(?i)\\b(?:[er]?flags)\\b`, name: `constant.language.register.flags.asm.x86_64` },
        { match: `(?i)\\b(?:[er]?ip)\\b`, name: `constant.language.register.instruction-pointer.asm.x86_64` },
        { match: `(?i)\\b(?:cr[02-4])\\b`, name: `constant.language.register.control.asm.x86_64` },
        { match: `(?i)\\b(?:(?:mm|st|fpr)[0-7])\\b`, name: `constant.language.register.mmx.asm.x86_64` },
        { match: `(?i)\\b(?:[xy]mm(?:[0-9]|1[0-5])|mxcsr)\\b`, name: `constant.language.register.sse_avx.asm.x86_64` },
        { match: `(?i)\\b(?:zmm(?:[12]?[0-9]|30|31))\\b`, name: `constant.language.register.avx512.asm.x86_64` },
        {
          match: `(?i)\\b(?:bnd(?:[0-3]|cfg[su]|status))\\b`,
          name: `constant.language.register.memory-protection.asm.x86_64`,
        },
        { match: `(?i)\\b(?:(?:[gil]dt)r?|tr)\\b`, name: `constant.language.register.system-table-pointer.asm.x86_64` },
        { match: `(?i)\\b(?:dr[0-367])\\b`, name: `constant.language.register.debug.asm.x86_64` },
        {
    ...
    strings: {
      patterns: [{
        begin: `"`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.asm` } },
        end: `"`,
        endCaptures: { 0: { name: `punctuation.definition.string.end.asm` } },
    ...
    support: {
      patterns: [
        ...
        { match: `(?i)\\b(?:incbin|equ|times|dup)\\b`, name: `support.function.asm.x86_64` },
        { match: `(?i)\\b(?:strict|nosplit|near|far|abs|rel)\\b`, name: `storage.modifier.asm.x86_64` },
        { match: `(?i)\\b(?:[ao](?:16|32|64))\\b`, name: `storage.modifier.prefix.asm.x86_64` },
        {
          match: `(?i)\\b(?:rep(?:n?[ez])?|lock|xacquire|xrelease|(?:no)?bnd)\\b`,
          name: `storage.modifier.prefix.asm.x86_64`,
        },
        { captures: { 1: { name: `storage.modifier.prefix.vex.asm.x86_64` } }, match: `{(vex[23]?|evex|rex)}` },
        { captures: { 1: { name: `storage.modifier.opmask.asm.x86_64` } }, match: `{(k[1-7])}` },
        { captures: { 1: { name: `storage.modifier.precision.asm.x86_64` } }, match: `{(1to(?:8|16))}` },
        { captures: { 1: { name: `storage.modifier.rounding.asm.x86_64` } }, match: `{(z|(?:r[nudz]-)?sae)}` },
        {
        ...
        {
          match:
            `\\b__\\?(?:utf(?:(?:16|32)(?:[lb]e)?)|float(?:8|16|32|64|80[me]|128[lh])|bfloat16|Infinity|[QS]?NaN)\\?__\\b`,
        ...
        { match: `\\b___\\?NASM_PATCHLEVEL\\?__\\b`, name: `support.function.asm.x86_64` },
        { match: `\\b__\\?(?:FILE|LINE|BITS|OUTPUT_FORMAT|DEBUG_FORMAT)\\?__\\b`, name: `support.function.asm.x86_64` },
        {
          match: `\\b__\\?(?:(?:UTC_)?(?:DATE|TIME)(?:_NUM)?|POSIX_TIME)\\?__\\b`,
          name: `support.function.asm.x86_64`,
        },
        { match: `\\b__\\?USE_(?:\\w+)\\?__\\b`, name: `support.function.asm.x86_64` },
        { match: `\\b__\\?PASS\\?__\\b`, name: `invalid.deprecated.support.constant.altreg.asm.x86_64` },
        { match: `\\b__\\?ALIGNMODE\\?__\\b`, name: `support.constant.smartalign.asm.x86_64` },
        { match: `\\b__\\?ALIGN_(\\w+)\\?__\\b`, name: `support.function.smartalign.asm.x86_64` },
        {
          match: `\\b__NASM_(?:MAJOR|(?:SUB)?MINOR|SNAPSHOT|VER(?:SION_ID)?)__\\b`,
          name: `support.function.asm.x86_64`,
        },
        { match: `\\b___NASM_PATCHLEVEL__\\b`, name: `support.function.asm.x86_64` },
        { match: `\\b__(?:FILE|LINE|BITS|OUTPUT_FORMAT|DEBUG_FORMAT)__\\b`, name: `support.function.asm.x86_64` },
        { match: `\\b__(?:(?:UTC_)?(?:DATE|TIME)(?:_NUM)?|POSIX_TIME)__\\b`, name: `support.function.asm.x86_64` },
        { match: `\\b__USE_(?:\\w+)__\\b`, name: `support.function.asm.x86_64` },
        { match: `\\b__PASS__\\b`, name: `invalid.deprecated.support.constant.altreg.asm.x86_64` },
        { match: `\\b__ALIGNMODE__\\b`, name: `support.constant.smartalign.asm.x86_64` },
        { match: `\\b__ALIGN_(\\w+)__\\b`, name: `support.function.smartalign.asm.x86_64` },
        { match: `\\b(?:Inf|[QS]?NaN)\\b`, name: `support.constant.fp.asm.x86_64` },
        { match: `\\b(?:float(?:8|16|32|64|80[me]|128[lh]))\\b`, name: `support.function.fp.asm.x86_64` },
        { match: `(?i)\\bilog2(?:[ewfc]|[fc]w)?\\b`, name: `support.function.ifunc.asm.x86_64` },
      ],
    },
  },
  a = `source.asm.x86_64`,
  o = { displayName: e, fileTypes: t, name: `asm`, patterns: r, repository: i, scopeName: a }
