var e = `WebAssembly`,
  ...
  r = {
    comments: {
      patterns: [{
        captures: { 1: { name: `punctuation.definition.comment.wat` } },
        comment: `Line comment`,
        match: `(;;).*$`,
        name: `comment.line.wat`,
      }, {
        begin: `\\(;`,
        beginCaptures: { 0: { name: `punctuation.definition.comment.wat` } },
        comment: `Block comment`,
        end: `;\\)`,
        endCaptures: { 0: { name: `punctuation.definition.comment.wat` } },
    ...
    constants: {
      patterns: [{
        ...
        patterns: [{
          captures: { 1: { name: `support.type.wat` } },
        ...
        patterns: [
          ...
          { comment: `Floating point infinity`, match: `[+-]?\\binf\\b`, name: `constant.numeric.float.wat` },
          {
    ...
    instructions: {
      patterns: [{
        ...
        patterns: [{
          captures: { 1: { name: `support.class.wat` } },
        ...
        patterns: [{
          ...
          match:
            `\\b(i8x16)\\.(?:shuffle|swizzle|splat|replace_lane|add|sub|mul|neg|shl|shr_[su]|eq|ne|lt_[su]|le_[su]|gt_[su]|ge_[su]|min_[su]|max_[su]|any_true|all_true|extract_lane_[su]|add_saturate_[su]|sub_saturate_[su]|avgr_u|narrow_i16x8_[su])\\b`,
          name: `keyword.operator.word.wat`,
        }, {
          captures: { 1: { name: `support.class.wat` } },
          comment: `Vector instruction (i16x8) [simd]`,
          match:
            `\\b(i16x8)\\.(?:splat|replace_lane|add|sub|mul|neg|shl|shr_[su]|eq|ne|lt_[su]|le_[su]|gt_[su]|ge_[su]|min_[su]|max_[su]|any_true|all_true|extract_lane_[su]|add_saturate_[su]|sub_saturate_[su]|avgr_u|load8x8_[su]|narrow_i32x4_[su]|widen_(low|high)_i8x16_[su])\\b`,
          name: `keyword.operator.word.wat`,
        }, {
          captures: { 1: { name: `support.class.wat` } },
          comment: `Vector instruction (i32x4) [simd]`,
          match:
            `\\b(i32x4)\\.(?:splat|replace_lane|add|sub|mul|neg|shl|shr_[su]|eq|ne|lt_[su]|le_[su]|gt_[su]|ge_[su]|min_[su]|max_[su]|any_true|all_true|extract_lane|load16x4_[su]|trunc_sat_f32x4_[su]|widen_(low|high)_i16x8_[su])\\b`,
          name: `keyword.operator.word.wat`,
        }, {
          captures: { 1: { name: `support.class.wat` } },
          ...
          match:
            `\\b(f32x4)\\.(?:splat|replace_lane|add|sub|mul|neg|extract_lane|eq|ne|lt|le|gt|ge|abs|min|max|div|sqrt|convert_i32x4_[su])\\b`,
          name: `keyword.operator.word.wat`,
        }, {
          captures: { 1: { name: `support.class.wat` } },
          comment: `Vector instruction (f64x2) [simd]`,
          match:
            `\\b(f64x2)\\.(?:splat|replace_lane|add|sub|mul|neg|extract_lane|eq|ne|lt|le|gt|ge|abs|min|max|div|sqrt)\\b`,
          name: `keyword.operator.word.wat`,
        }, {
          captures: { 1: { name: `support.class.wat` } },
        ...
        patterns: [{
          captures: {
            ...
            2: { name: `support.class.wat` },
            3: { name: `support.class.wat` },
            4: { name: `support.class.wat` },
          },
          comment: `Atomic instruction (i32) [threads]`,
          match:
            `\\b(i32)\\.(atomic)\\.(?:load(?:8_u|16_u)?|store(?:8|16)?|wait|(rmw)\\.(?:add|sub|and|or|xor|xchg|cmpxchg)|(rmw8|rmw16)\\.(?:add_u|sub_u|and_u|or_u|xor_u|xchg_u|cmpxchg_u))\\b`,
          name: `keyword.operator.word.wat`,
        }, {
          captures: {
            1: { name: `support.class.wat` },
          ...
          match:
            `\\b(i64)\\.(atomic)\\.(?:load(?:8_u|16_u|32_u)?|store(?:8|16|32)?|wait|(rmw)\\.(?:add|sub|and|or|xor|xchg|cmpxchg)|(rmw8|rmw16|rmw32)\\.(?:add_u|sub_u|and_u|or_u|xor_u|xchg_u|cmpxchg_u))\\b`,
          name: `keyword.operator.word.wat`,
        }, {
          captures: { 1: { name: `support.class.wat` } },
          ...
          name: `keyword.operator.word.wat`,
        }, { comment: `Shared modifier [threads]`, match: `\\bshared\\b`, name: `storage.modifier.wat` }],
      }, {
        ...
        patterns: [{
          ...
          name: `keyword.control.wat`,
        }, { comment: `Module element [exception-handling]`, match: `(?<=\\()event\\b`, name: `storage.type.wat` }],
      }, {
        ...
        comment: `MVP`,
        patterns: [{
          captures: { 1: { name: `support.class.type.wat` } },
          ...
          match:
            `\\b(i32|i64)\\.(const|eqz|eq|ne|lt_[su]|gt_[su]|le_[su]|ge_[su]|clz|ctz|popcnt|add|sub|mul|div_[su]|rem_[su]|and|or|xor|shl|shr_[su]|rotl|rotr)\\b`,
          name: `keyword.operator.word.wat`,
        }, {
          captures: { 1: { name: `support.class.type.wat` } },
          comment: `Numeric instruction (f32/f64) [mvp]`,
          match:
            `\\b(f32|f64)\\.(const|eq|ne|lt|gt|le|ge|abs|neg|ceil|floor|trunc|nearest|sqrt|add|sub|mul|div|min|max|copysign)\\b`,
          name: `keyword.operator.word.wat`,
        }, {
          captures: { 1: { name: `support.class.type.wat` } },
        ...
        patterns: [{
          ...
          match:
            `\\b(array)\\.(?:new_canon|new_canon_default|get|get_s|get_u|set|len|new_canon_fixed|new_canon_data|new_canon_elem)\\b`,
          name: `keyword.operator.word.wat`,
        }, {
          captures: { 1: { name: `support.class.wat` } },
    ...
    invalid: { patterns: [{ match: `[^\\s()]+`, name: `invalid.wat` }] },
    modules: {
      patterns: [{
        comment: `Bulk memory operations`,
        patterns: [{
          captures: { 1: { name: `storage.modifier.wat` } },
        ...
        patterns: [{
          ...
          captures: { 1: { name: `entity.name.function.wat` } },
          comment: `Function name [mvp]`,
          match: "(?<=\\(func|\\(start|call|return_call|ref\\.func)\\s+(\\$[0-9A-Za-z!#$%&'*+\\-./:<=>?@\\\\^_`|~]*)",
        }, {
          begin: "\\)\\s+(\\$[0-9A-Za-z!#$%&'*+\\-./:<=>?@\\\\^_`|~]*)",
          beginCaptures: { 1: { name: `entity.name.function.wat` } },
          ...
          captures: { 1: { name: `support.type.function.wat` } },
    ...
    strings: {
      ...
      patterns: [{ match: `\\\\(n|t|\\\\|'|"|[0-9a-fA-F]{2})`, name: `constant.character.escape.wat` }],
    },
    types: {
      patterns: [{
        comment: `Fixed-width SIMD`,
        patterns: [{ comment: `Type name [simd]`, match: `\\bv128\\b(?!\\.)`, name: `entity.name.type.wat` }],
      }, {
        comment: `Reference types`,
        patterns: [{
          comment: `Type name [reference-types]`,
        ...
        patterns: [{
          ...
          match:
            `\\b(?:i8|i16|ref|funcref|externref|anyref|eqref|i31ref|nullfuncref|nullexternref|structref|arrayref|nullref)\\b(?!\\.)`,
          name: `entity.name.type.wat`,
        }],
      }, {
