var e = `TSX`,
  ...
  r = {
    ...
    'arrow-function': {
      patterns: [{
        captures: { 1: { name: `storage.modifier.async.tsx` }, 2: { name: `variable.parameter.tsx` } },
        match:
...
\\s*=>
    ...
    'class-declaration-or-expression-patterns': {
      patterns: [
        ...
        { captures: { 0: { name: `entity.name.type.class.tsx` } }, match: `[_$[:alpha:]][_$[:alnum:]]*` },
    ...
    'class-expression': {
      ...
      beginCaptures: { 1: { name: `storage.modifier.tsx` }, 2: { name: `storage.type.class.tsx` } },
      end: `(?<=\\})`,
      name: `meta.class.tsx`,
      patterns: [{ include: `#class-declaration-or-expression-patterns` }],
    },
    ...
    'class-or-interface-heritage': {
      ...
      patterns: [
        ...
        { captures: { 1: { name: `entity.other.inherited-class.tsx` } }, match: `([_$[:alpha:]][_$[:alnum:]]*)` },
    ...
    'control-statement': {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.control.loop.tsx` }, 2: { name: `entity.name.label.tsx` } },
          match:
    ...
    'destructuring-parameter-rest': {
      captures: { 1: { name: `keyword.operator.rest.tsx` }, 2: { name: `variable.parameter.tsx` } },
...
((?:[^@\\s*/]|\\*[^/])+)`,
        },
        {
          ...
          }, { captures: { 0: { name: `source.embedded.tsx` } }, match: `[^\\s@*](?:[^*]|\\*[^/])*` }],
        },
        {
          captures: {
            1: { name: `storage.type.class.jsdoc` },
...
[^{}@\\s*] | \\*[^/]
    ...
    'export-declaration': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.control.export.tsx` }, 2: { name: `keyword.control.type.tsx` } },
        end:
          `(?=$|;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b))`,
...
\\s*=>
    ...
    'expression-operators': {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.control.flow.tsx` }, 2: { name: `keyword.generator.asterisk.tsx` } },
          match:
        ...
        {
          captures: { 1: { name: `keyword.control.as.tsx` }, 2: { name: `storage.modifier.tsx` } },
          match: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(as)\\s+(const)(?=\\s*($|[;,:})\\]]))`,
        },
        {
          begin: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:(as)|(satisfies))\\s+`,
          beginCaptures: { 1: { name: `keyword.control.as.tsx` }, 2: { name: `keyword.control.satisfies.tsx` } },
          end:
            `(?=^|[;),}\\]:?\\-\\+\\>]|\\|\\||\\&\\&|\\!\\=\\=|$|((?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(as|satisfies)\\s+)|(\\s+\\<))`,
          patterns: [{ include: `#type` }],
        },
        { match: `\\.\\.\\.`, name: `keyword.operator.spread.tsx` },
        { match: `\\*=|(?<!\\()/=|%=|\\+=|\\-=`, name: `keyword.operator.assignment.compound.tsx` },
        { match: `\\&=|\\^=|<<=|>>=|>>>=|\\|=`, name: `keyword.operator.assignment.compound.bitwise.tsx` },
...
\\s*=>
        ...
        { match: `\\#?[_$[:alpha:]][_$[:alnum:]]*`, name: `meta.definition.property.tsx variable.object.property.tsx` },
    ...
    'for-loop': {
      ...
      patterns: [{ include: `#comment` }, { match: `await`, name: `keyword.control.loop.tsx` }, {
        begin: `\\(`,
    ...
    'function-call-optionals': {
      patterns: [{ match: `\\?\\.`, name: `meta.function-call.tsx punctuation.accessor.optional.tsx` }, {
        match: `\\!`,
...
\\s*=>
        ...
        { match: `([[:upper:]][_$[:digit:][:upper:]]*)(?![_$[:alnum:]])`, name: `variable.other.constant.tsx` },
        { match: `[_$[:alpha:]][_$[:alnum:]]*`, name: `variable.other.readwrite.tsx` },
      ],
    },
    'if-statement': {
      patterns: [{
        ...
        patterns: [{ include: `#comment` }, {
          begin: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(if)\\s*(\\()`,
          beginCaptures: { 1: { name: `keyword.control.conditional.tsx` }, 2: { name: `meta.brace.round.tsx` } },
          end: `\\)`,
          endCaptures: { 0: { name: `meta.brace.round.tsx` } },
          patterns: [{ include: `#expression` }],
        }, {
          ...
          endCaptures: { 1: { name: `punctuation.definition.string.end.tsx` }, 2: { name: `keyword.other.tsx` } },
    ...
    'import-export-clause': {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.control.type.tsx` }, 2: { name: `variable.other.readwrite.alias.tsx` } },
    ...
    'indexer-declaration': {
      ...
      endCaptures: { 1: { name: `meta.brace.square.tsx` }, 2: { name: `keyword.operator.optional.tsx` } },
    ...
    'interface-declaration': {
      ...
      patterns: [
        { include: `#comment` },
        { include: `#class-or-interface-heritage` },
        { captures: { 0: { name: `entity.name.type.interface.tsx` } }, match: `[_$[:alpha:]][_$[:alnum:]]*` },
        { include: `#type-parameters` },
        { include: `#class-or-interface-body` },
      ],
    },
...
(?=\\s|=|/?>|/\\*|//)`,
    ...
    'jsx-tag-attributes-illegal': { match: `\\S+`, name: `invalid.illegal.attribute.tsx` },
...
(?=(<)\\s*(?:([_$[:alpha:]][-_$[:alnum:].]*)(?<!\\.|-)(:))?((?:[a-z][a-z0-9]*|([_$[:alpha:]][-_$[:alnum:].]*))(?<!\\.|-))(?=((<\\s*)|(\\s+))(?!\\?)|\\/?>))`,
    ...
    label: {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `entity.name.label.tsx` }, 2: { name: `punctuation.separator.label.tsx` } },
        end: `(?<=\\})`,
        patterns: [{ include: `#decl-block` }],
      }, {
        captures: { 1: { name: `entity.name.label.tsx` }, 2: { name: `punctuation.separator.label.tsx` } },
        match: `([_$[:alpha:]][_$[:alnum:]]*)\\s*(:)`,
      }],
    },
    literal: {
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
    ...
    'namespace-declaration': {
      ...
      patterns: [
        { include: `#comment` },
        { include: `#string` },
        { match: `([_$[:alpha:]][_$[:alnum:]]*)`, name: `entity.name.type.module.tsx` },
...
(\\#?[_$[:alpha:]][_$[:alnum:]]*)
        ...
        captures: { 1: { name: `variable.other.constant.object.tsx` }, 2: { name: `variable.other.object.tsx` } },
        match: `(?x)(?:
([[:upper:]][_$[:digit:][:upper:]]*) |
([_$[:alpha:]][_$[:alnum:]]*)
)(?=\\s*\\??\\.\\s*\\#?[_$[:alpha:]][_$[:alnum:]]*)`,
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
        ...
        {
          captures: { 0: { name: `meta.object-literal.key.tsx` }, 1: { name: `constant.numeric.decimal.tsx` } },
          match: `(?![_$[:alpha:]])([[:digit:]]+)\\s*(?=(\\/\\*([^\\*]|(\\*[^\\/]))*\\*\\/\\s*)*:)`,
          name: `meta.object.member.tsx`,
        },
        {
          captures: { 0: { name: `meta.object-literal.key.tsx` }, 1: { name: `entity.name.function.tsx` } },
          match:
        ...
        },
        {
          ...
          patterns: [
            ...
            },
            {
              ...
              beginCaptures: { 1: { name: `storage.modifier.async.tsx` }, 2: { name: `meta.brace.round.tsx` } },
              end: `\\)`,
              endCaptures: { 0: { name: `meta.brace.round.tsx` } },
              patterns: [{ include: `#expression-inside-possibly-arrow-parens` }],
            },
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
    ...
    'punctuation-accessor': {
      captures: { 1: { name: `punctuation.accessor.tsx` }, 2: { name: `punctuation.accessor.optional.tsx` } },
      match: `(?:(\\.)|(\\?\\.(?!\\s*[[:digit:]])))`,
    },
    'punctuation-comma': { match: `,`, name: `punctuation.separator.comma.tsx` },
    'punctuation-semicolon': { match: `;`, name: `punctuation.terminator.statement.tsx` },
    'qstring-double': {
      begin: `"`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.tsx` } },
      end: `(")|((?:[^\\\\\\n])$)`,
      endCaptures: { 1: { name: `punctuation.definition.string.end.tsx` }, 2: { name: `invalid.illegal.newline.tsx` } },
      name: `string.quoted.double.tsx`,
...
(?:(EPSILON|MAX_SAFE_INTEGER|MAX_VALUE|MIN_SAFE_INTEGER|MIN_VALUE|NEGATIVE_INFINITY|POSITIVE_INFINITY)\\b(?!\\$)))`,
    ...
    'switch-statement': {
      ...
      patterns: [{ include: `#comment` }, {
        ...
        beginCaptures: { 1: { name: `keyword.control.switch.tsx` }, 2: { name: `meta.brace.round.tsx` } },
        end: `\\)`,
        endCaptures: { 0: { name: `meta.brace.round.tsx` } },
    ...
    'type-alias-declaration': {
      ...
      patterns: [{ include: `#comment` }, { include: `#type-parameters` }, {
        ...
        beginCaptures: { 1: { name: `keyword.operator.assignment.tsx` }, 2: { name: `keyword.control.intrinsic.tsx` } },
        end:
          `(?=\\}|;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b))`,
        patterns: [{ include: `#type` }],
      }, {
    ...
    'type-fn-type-parameters': {
      patterns: [{
        ...
        begin: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:(abstract)\\s+)?(new)\\b\\s*(?=\\()`,
        beginCaptures: { 1: { name: `storage.modifier.tsx` }, 2: { name: `keyword.control.new.tsx` } },
        end: `(?<=\\))`,
...
([)]\\s*=>)
    ...
    'type-operators': {
      patterns: [
        ...
        { begin: `[&|]`, beginCaptures: { 0: { name: `keyword.operator.type.tsx` } }, end: `(?=\\S)` },
        {
...
\\s*=>
        ...
        beginCaptures: {
          1: { name: `meta.definition.variable.tsx variable.other.constant.tsx entity.name.function.tsx` },
        },
        end:
...
\\s*=>
  ...
  i = `source.tsx`,
  a = { displayName: `TSX`, name: `tsx`, patterns: n, repository: r, scopeName: i }
