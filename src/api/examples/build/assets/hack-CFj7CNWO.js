var e = `Hack`,
  ...
  r = `(\\*/|^\\s*\\}|^HTML;)`,
  i = `hack`,
  a = [{ include: `text.html.basic` }, { include: `#language` }],
  o = {
    attributes: {
      patterns: [{
        begin: `(<<)(?!<)`,
...
is generated and the constant is assumed to have the value of its name.`,
    ...
    'function-arguments': {
      patterns: [{ include: `#comments` }, { include: `#attributes` }, { include: `#type-annotation` }, {
        begin: `(?xi)((\\$+)[a-z_\\x{7f}-\\x{ff}][a-z0-9_\\x{7f}-\\x{ff}]*)  # The variable name`,
        beginCaptures: { 1: { name: `variable.other.php` }, 2: { name: `punctuation.definition.variable.php` } },
        end: `(?xi)
\\s*(?=,|\\)|$)`,
        patterns: [{
          begin: `(=)`,
    ...
    'function-call': {
      patterns: [
        ...
        { match: `(?i)\\b(print|echo)\\b`, name: `support.function.construct.php` },
        {
          ...
          patterns: [
            { match: `(?i)\\b(isset|unset|e(val|mpty)|list)(?=\\s*\\()`, name: `support.function.construct.php` },
            { include: `#support` },
    ...
    'function-return-type': {
      patterns: [{
        ...
        patterns: [{ include: `#comments` }, { include: `#type-annotation` }, { include: `#class-name` }],
      }],
    },
    generics: {
      patterns: [{
        ...
        patterns: [{ include: `#comments` }, { include: `#generics` }, {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#comments` }, {
          ...
          patterns: [
            ...
            { include: `#class-builtin` },
            { include: `#namespace` },
            { match: `(?i)[a-z_][a-z_0-9]*`, name: `entity.other.inherited-class.php` },
          ],
        }],
      }],
    },
    ...
    interface: {
      ...
      beginCaptures: { 1: { name: `storage.modifier.php` }, 2: { name: `storage.type.interface.php` } },
      end: `(?=[;{])`,
      name: `meta.interface.php`,
      patterns: [
        { include: `#comments` },
        { captures: { 1: { name: `storage.modifier.extends.php` } }, match: `\\b(extends)\\b` },
        { include: `#generics` },
        { include: `#namespace` },
    ...
    language: {
      patterns: [
        { include: `#comments` },
        { begin: `(?=^\\s*<<)`, end: `(?<=>>)`, patterns: [{ include: `#attributes` }] },
        { include: `#xhp` },
        { include: `#interface` },
        {
          begin: `(?xi)
...
([a-z0-9_]+)`,
        ...
        },
        {
          ...
          patterns: [{ match: `\\b(extends)\\b`, name: `storage.modifier.extends.php` }, {
            include: `#type-annotation`,
          }],
        },
        {
        ...
        },
        {
          ...
          name: `meta.trait.php`,
          patterns: [{ include: `#comments` }, { include: `#generics` }, { include: `#implements` }],
        },
        {
        ...
        },
        {
          ...
          beginCaptures: { 1: { name: `keyword.other.module.php` }, 2: { name: `entity.name.type.module.php` } },
          end: `$|(?=[\\s;])`,
...
(?=,|;|$)
            ...
            endCaptures: { 1: { name: `keyword.other.use-as.php` }, 2: { name: `support.other.namespace.use-as.php` } },
            patterns: [{ include: `#class-builtin` }, {
              begin: `(?i)\\s*(?=[\\\\a-z_0-9])`,
              end: `$|(?=[\\s,;])`,
        ...
        },
        {
          ...
          beginCaptures: {
            1: { patterns: [{ match: `final|abstract|public|internal`, name: `storage.modifier.php` }] },
...
((\\$+)[a-z_\\x{7f}-\\x{10ffff}][a-z0-9_\\x{7f}-\\x{10ffff}]*)`,
        ...
        { match: `\\b(catch|try|throw|exception|finally)\\b`, name: `keyword.control.exception.php` },
        {
          ...
          beginCaptures: { 1: { name: `storage.modifier.php` }, 2: { name: `storage.type.function.php` } },
          end: `\\{|\\)`,
...
([a-zA-Z0-9_]+)
          ...
          patterns: [{ include: `#generics` }, {
            ...
            begin: `(\\))`,
            beginCaptures: { 1: { name: `punctuation.definition.parameters.end.php` } },
            end: `(?=[{;])`,
...
([a-zA-Z_\\x{7f}-\\x{ff}][a-zA-Z0-9_\\x{7f}-\\x{ff}]*)
          ...
          patterns: [{ match: `(self|static|parent)\\b`, name: `support.type.php` }, { include: `#class-name` }, {
            include: `#variable-name`,
          }],
        },
        { include: `#variables` },
    ...
    'literal-collections': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `support.class.php` }, 2: { name: `punctuation.section.array.begin.php` } },
        end: `(})`,
    ...
    namespace: {
      ...
      patterns: [{ match: `(?i)[a-z0-9_]+(?=\\\\)`, name: `entity.name.type.namespace.php` }, {
        captures: { 1: { name: `punctuation.separator.inheritance.php` } },
        match: `(?i)(\\\\)`,
      }],
    },
...
Sample case: $sql = "SELECT * FROM bar WHERE foo = '" . $variable . "'"`,
    ...
    support: {
      patterns: [
        ...
        { match: `(?i)\\bbc(s(cale|ub|qrt)|comp|div|pow(mod)?|add|m(od|ul))\\b`, name: `support.function.bcmath.php` },
        {
        ...
        { match: `(?i)\\b(s(plit(i)?|ql_regcase)|ereg(i(_replace)?|_replace)?)\\b`, name: `support.function.ereg.php` },
        {
          match:
        ...
        { match: `(?i)\\bjson_(decode|encode|last_error)\\b`, name: `support.function.json.php` },
        {
          match:
        ...
        { match: `(?i)\\bbson_(decode|encode)\\b`, name: `support.function.mongo.php` },
        {
          match:
        ...
        { match: `(?i)\\bnsapi_(virtual|re(sponse_headers|quest_headers))\\b`, name: `support.function.nsapi.php` },
        {
          match:
        ...
        { match: `(?i)\\bset(threadtitle|proctitle)\\b`, name: `support.function.proctitle.php` },
        {
          match:
        ...
        { match: `(?i)\\bxhprof_(sample_(disable|enable)|disable|enable)\\b`, name: `support.function.xhprof.php` },
        {
          match:
    ...
    'type-annotation': {
      ...
      patterns: [
        ...
        },
        {
          ...
          patterns: [{ include: `#type-annotation` }, { include: `#strings` }, { include: `#constants` }],
        },
...
((\\$\\{)(?<name>[a-zA-Z_\\x{7f}-\\x{ff}][a-zA-Z0-9_\\x{7f}-\\x{ff}]*)(\\}))`,
    ...
    variables: {
      patterns: [{ include: `#var_global` }, { include: `#var_global_safer` }, { include: `#var_basic` }, {
        begin: `(\\$\\{)(?=.*?\\})`,
    ...
    'xhp-entities': {
      ...
      }, { comment: `Entity with & and invalid name`, match: `&\\S*;`, name: `invalid.illegal.bad-ampersand.xhp` }],
    },
    'xhp-evaluated-code': {
      begin: `{`,
    ...
    'xhp-html-comments': {
      ...
      patterns: [{ match: `--(?!-*\\s*>)`, name: `invalid.illegal.bad-comments-or-CDATA.html` }],
    },
    ...
    'xhp-tag-element-name': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `punctuation.definition.tag.xhp` }, 2: { name: `entity.name.tag.open.xhp` } },
        ...
        patterns: [{ include: `#xhp-tag-termination` }, { include: `#xhp-html-comments` }, {
    ...
    'xhp-tag-termination': {
      patterns: [{
        begin: `(?<!--)(>)`,
        beginCaptures: { 0: { name: `punctuation.definition.tag.xhp` }, 1: { name: `XHPStartTagEnd` } },
        comment: `uses non consuming search for </ in </tag>`,
        end: `(</)`,
        endCaptures: { 0: { name: `punctuation.definition.tag.xhp` }, 1: { name: `XHPEndTagStart` } },
        patterns: [
          { include: `#xhp-evaluated-code` },
