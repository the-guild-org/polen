var e = `Nginx`,
  t = [`conf.erb`, `conf`, `ngx`, `nginx.conf`, `mime.types`, `fastcgi_params`, `scgi_params`, `uwsgi_params`],
  n = `\\{\\s*$`,
  r = `^\\s*\\}`,
  i = `nginx`,
  a = [
    ...
    {
      begin:
        `\\b((?:content|rewrite|access|init_worker|init|set|log|balancer|ssl_(?:client_hello|session_fetch|certificate))_by_lua(?:_block)?)\\s*\\{`,
      beginCaptures: { 1: { name: `storage.type.directive.context.nginx` } },
    ...
    {
      begin:
        `\\b((?:content|rewrite|access|init_worker|init|set|log|balancer|ssl_(?:client_hello|session_fetch|certificate))_by_lua)\\s*'`,
      beginCaptures: { 1: { name: `storage.type.directive.context.nginx` } },
      contentName: `meta.embedded.block.lua`,
      end: `'`,
      name: `meta.context.lua.nginx`,
    ...
    },
    {
      begin: `\\b(location) +([\\^]?~[\\*]?|=) +(.*?)\\{`,
      beginCaptures: {
        1: { name: `storage.type.directive.context.nginx` },
        2: { name: `keyword.operator.nginx` },
        3: { name: `string.regexp.nginx` },
      },
      end: `\\}`,
    ...
    },
    {
      ...
      beginCaptures: {
        1: { name: `storage.type.directive.context.nginx` },
        2: { name: `punctuation.definition.variable.nginx` },
        3: { name: `variable.parameter.nginx` },
        4: { name: `punctuation.definition.variable.nginx` },
        5: { name: `variable.other.nginx` },
      },
      end: `\\}`,
      name: `meta.context.map.nginx`,
      patterns: [{ include: `#values` }, { match: `;`, name: `punctuation.terminator.nginx` }, {
        match: `\\#.*`,
        name: `comment.line.number-sign`,
      }],
    },
    { begin: `\\{`, end: `\\}`, name: `meta.block.nginx`, patterns: [{ include: `$self` }] },
    {
      begin: `\\b(return)\\b`,
      beginCaptures: { 1: { name: `keyword.control.nginx` } },
      end: `;`,
    ...
    {
      begin: `\\b(rewrite)\\s+`,
      beginCaptures: { 1: { name: `keyword.directive.nginx` } },
      end: `(last|break|redirect|permanent)?(;)`,
      endCaptures: { 1: { name: `keyword.other.nginx` }, 2: { name: `punctuation.terminator.nginx` } },
      patterns: [{ include: `#values` }],
    },
    {
      begin: `\\b(server)\\s+`,
      ...
      endCaptures: { 1: { name: `punctuation.terminator.nginx` } },
      patterns: [{ include: `#server_parameters` }],
    },
    {
      begin:
        `\\b(internal|empty_gif|f4f|flv|hls|mp4|break|status|stub_status|ip_hash|ntlm|least_conn|upstream_conf|least_conn|zone_sync)\\b`,
      beginCaptures: { 1: { name: `keyword.directive.nginx` } },
      end: `(;|$)`,
      endCaptures: { 1: { name: `punctuation.terminator.nginx` } },
    },
    {
      ...
      beginCaptures: {
        1: { name: `keyword.directive.nginx` },
        2: { name: `keyword.directive.nginx` },
        3: { name: `keyword.directive.nginx` },
        4: { name: `keyword.directive.nginx` },
      },
      end: `;`,
      endCaptures: { 0: { name: `punctuation.terminator.nginx` } },
      patterns: [{ include: `#values` }],
    },
    {
    ...
    {
      begin:
        `(["'\\s]|^)(worker_)(aio_requests|connections|cpu_affinity|priority|processes|rlimit_core|rlimit_nofile|shutdown_timeout)(["'\\s]|$)`,
      beginCaptures: {
        1: { name: `keyword.directive.nginx` },
        2: { name: `keyword.directive.nginx` },
        3: { name: `keyword.directive.nginx` },
    ...
    {
      begin:
        `(["'\\s]|^)(auth_)(delay|basic|basic_user_file|jwt|jwt_claim_set|jwt_header_set|jwt_key_cache|jwt_key_file|jwt_key_request|jwt_leeway|jwt_type|jwt_require|request|request_set|http|http_header|http_pass_client_cert|http_timeout)(["'\\s]|$)`,
      beginCaptures: {
        1: { name: `keyword.directive.nginx` },
        2: { name: `keyword.directive.nginx` },
        3: { name: `keyword.directive.nginx` },
    ...
    {
      begin:
        `(["'\\s]|^)(client_)(body_buffer_size|body_in_file_only|body_in_single_buffer|body_temp_path|body_timeout|header_buffer_size|header_timeout|max_body_size)(["'\\s]|$)`,
      beginCaptures: {
        1: { name: `keyword.directive.nginx` },
        2: { name: `keyword.directive.nginx` },
        3: { name: `keyword.directive.nginx` },
    ...
    {
      begin:
        `(["'\\s]|^)(limit_)(rate|rate_after|conn|conn_dry_run|conn_log_level|conn_status|conn_zone|zone|req|req_dry_run|req_log_level|req_status|req_zone)(["'\\s]|$)`,
      beginCaptures: {
        1: { name: `keyword.directive.nginx` },
        2: { name: `keyword.directive.nginx` },
        3: { name: `keyword.directive.nginx` },
    ...
    {
      begin:
        `(["'\\s]|^)(open_)(file_cache|file_cache_errors|file_cache_min_uses|file_cache_valid|log_file_cache)(["'\\s]|$)`,
      beginCaptures: {
        1: { name: `keyword.directive.nginx` },
        2: { name: `keyword.directive.nginx` },
        3: { name: `keyword.directive.nginx` },
    ...
    {
      begin:
        `(["'\\s]|^)(gzip_)(buffers|comp_level|disable|http_version|min_length|proxied|types|vary|static)(["'\\s]|$)`,
      beginCaptures: {
        1: { name: `keyword.directive.nginx` },
        2: { name: `keyword.directive.nginx` },
        3: { name: `keyword.directive.nginx` },
    ...
    {
      begin:
        `(["'\\s]|^)(image_)(filter|filter_buffer|filter_interlace|filter_jpeg_quality|filter_sharpen|filter_transparency|filter_webp_quality)(["'\\s]|$)`,
      beginCaptures: {
        1: { name: `keyword.directive.nginx` },
        2: { name: `keyword.directive.nginx` },
        3: { name: `keyword.directive.nginx` },
    ...
    {
      begin:
        `(["'\\s]|^)(memcached_)(bind|buffer_size|connect_timeout|gzip_flag|next_upstream|next_upstream_timeout|next_upstream_tries|pass|read_timeout|send_timeout|socket_keepalive)(["'\\s]|$)`,
      beginCaptures: {
        1: { name: `keyword.directive.nginx` },
        2: { name: `keyword.directive.nginx` },
        3: { name: `keyword.directive.nginx` },
    ...
    {
      begin:
        `(["'\\s]|^)(http2_)(body_preread_size|chunk_size|idle_timeout|max_concurrent_pushes|max_concurrent_streams|max_field_size|max_header_size|max_requests|push|push_preload|recv_buffer_size|recv_timeout)(["'\\s]|$)`,
      beginCaptures: {
        1: { name: `keyword.directive.nginx` },
        2: { name: `keyword.directive.nginx` },
        3: { name: `keyword.directive.nginx` },
    ...
    {
      begin:
        `(["'\\s]|^)(js_)(body_filter|content|fetch_buffer_size|fetch_ciphers|fetch_max_response_buffer_size|fetch_protocols|fetch_timeout|fetch_trusted_certificate|fetch_verify|fetch_verify_depth|header_filter|import|include|path|periodic|preload_object|set|shared_dict_zone|var|access|filter|preread)(["'\\s]|$)`,
      beginCaptures: {
        1: { name: `keyword.directive.nginx` },
        2: { name: `keyword.directive.nginx` },
        3: { name: `keyword.directive.nginx` },
    ...
    },
    {
      ...
      beginCaptures: { 1: { name: `keyword.directive.unknown.nginx` } },
      end: `(;|$)`,
      endCaptures: { 1: { name: `punctuation.terminator.nginx` } },
      patterns: [{ include: `#values` }],
    },
    {
      ...
      beginCaptures: { 1: { name: `constant.other.mediatype.nginx` } },
      end: `(;)`,
      endCaptures: { 1: { name: `punctuation.terminator.nginx` } },
      patterns: [{ include: `#values` }],
    },
  ...
  o = {
    if_condition: {
      patterns: [
        { include: `#variables` },
        { match: `\\!?\\~\\*?\\s`, name: `keyword.operator.nginx` },
        { match: `\\!?\\-[fdex]\\s`, name: `keyword.operator.nginx` },
        { match: `\\!?=[^=]`, name: `keyword.operator.nginx` },
        { include: `#regexp_and_string` },
      ],
    },
    regexp_and_string: {
      patterns: [{ match: `\\^.*?\\$`, name: `string.regexp.nginx` }, {
        begin: `"`,
        end: `"`,
        name: `string.quoted.double.nginx`,
        patterns: [{ match: `\\\\["'nt\\\\]`, name: `constant.character.escape.nginx` }, { include: `#variables` }],
      }, {
        begin: `'`,
        end: `'`,
    ...
    server_parameters: {
      patterns: [{
        captures: {
          1: { name: `variable.parameter.nginx` },
          2: { name: `keyword.operator.nginx` },
          3: { name: `constant.numeric.nginx` },
        },
        match:
    ...
    values: {
      patterns: [
        ...
        { match: `(?<=\\G|\\s)(on|off|true|false)(?=[\\t ;])`, name: `constant.language.nginx` },
        {
          match:
    ...
    variables: {
      patterns: [{
        captures: { 1: { name: `punctuation.definition.variable.nginx` }, 2: { name: `variable.other.nginx` } },
        match: `(\\$)([A-Za-z0-9\\_]+)\\b`,
      }, {
        captures: {
          1: { name: `punctuation.definition.variable.nginx` },
          2: { name: `variable.other.nginx` },
          3: { name: `punctuation.definition.variable.nginx` },
        },
        match: `(\\$\\{)([A-Za-z0-9\\_]+)(\\})`,
      }],
    },
