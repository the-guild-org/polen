var e = `Templ`,
  t = `templ`,
  n = [{ include: `#script-template` }, { include: `#css-template` }, { include: `#html-template` }, {
    include: `source.go`,
  }],
  r = {
    'block-element': {
    ...
    'call-expression': {
      begin: `({\\!)\\s+`,
      beginCaptures: { 0: { name: `start.call-expression.templ` }, 1: { name: `punctuation.brace.open` } },
      end: `(})`,
      endCaptures: { 0: { name: `end.call-expression.templ` }, 1: { name: `punctuation.brace.close` } },
      name: `call-expression.templ`,
      patterns: [{ include: `source.go` }],
    },
    'case-expression': {
      begin: `^\\s*case .+?:$`,
      captures: { 0: { name: `case.switch.html-template.templ`, patterns: [{ include: `source.go` }] } },
      end: `(^\\s*case .+?:$)|(^\\s*default:$)|(\\s*$)`,
      patterns: [{ include: `#template-node` }],
    },
    'close-element': {
      begin: `(</?)([a-zA-Z0-9:\\-]+)`,
      beginCaptures: {
      ...
      patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{
            ...
            endCaptures: {
              1: { name: `punctuation.definition.end.bracket.curly.go` },
            ...
            captures: {
              1: { name: `support.type.property-value.css` },
              2: { name: `punctuation.terminator.rule.css` },
            },
            match: `(.*)(;)$`,
    ...
    'default-expression': {
      begin: `^\\s*default:$`,
      captures: { 0: { name: `default.switch.html-template.templ`, patterns: [{ include: `source.go` }] } },
      end: `(^\\s*case .+?:$)|(^\\s*default:$)|(\\s*$)`,
      patterns: [{ include: `#template-node` }],
    },
    element: {
    ...
    'else-if-expression': {
      begin: `\\s(else if)\\s`,
      beginCaptures: { 1: { name: `keyword.control.go` } },
      end: `(?<=})`,
      name: `else-if.html-template.templ`,
      patterns: [{
        begin: `(?<=if\\s)`,
        end: `({)$`,
        endCaptures: { 1: { name: `punctuation.definition.begin.bracket.curly.go` } },
    ...
    'for-expression': {
      begin: `^\\s*for .+{`,
      captures: { 0: { name: `meta.embedded.block.go`, patterns: [{ include: `source.go` }] } },
      end: `\\s*}\\s*
`,
    ...
    'html-comment': {
      begin: `<!--`,
      beginCaptures: { 0: { name: `punctuation.definition.comment.html` } },
      end: `-->`,
      endCaptures: { 0: { name: `punctuation.definition.comment.html` } },
    ...
    'html-template': {
      ...
      patterns: [{
        ...
        endCaptures: { 1: { name: `punctuation.definition.end.bracket.square.go` } },
    ...
    'import-expression': {
      patterns: [{
        ...
        patterns: [{
          ...
          begin: `(?<=\\))\\s({)$`,
          beginCaptures: { 1: { name: `punctuation.brace.open` } },
          end: `^\\s*(})$`,
          endCaptures: { 1: { name: `punctuation.brace.close` } },
    ...
    'script-element': {
      ...
      endCaptures: { 0: { patterns: [{ include: `#close-element` }] } },
    ...
    'string-expression': {
      begin: `{\\s+`,
      beginCaptures: { 0: { name: `start.string-expression.templ` } },
      end: `}`,
      endCaptures: { 0: { name: `end.string-expression.templ` } },
    ...
    'switch-expression': {
      ...
      patterns: [{ include: `#template-node` }, { include: `#case-expression` }, { include: `#default-expression` }],
    },
    'tag-else-attribute': {
      begin: `\\s(else)\\s({)$`,
      beginCaptures: { 1: { name: `keyword.control.go` }, 2: { name: `punctuation.brace.open` } },
      end: `^\\s*(})$`,
      endCaptures: { 1: { name: `punctuation.brace.close` } },
    ...
    'tag-else-if-attribute': {
      ...
      patterns: [{
        ...
        endCaptures: { 1: { name: `punctuation.brace.open` } },
    ...
    'tag-generic-attribute': { match: `(?<=[^=])\\b([a-zA-Z0-9:-]+)`, name: `entity.other.attribute-name.html` },
    'tag-id-attribute': {
      begin: `\\b(id)\\b\\s*(=)`,
      captures: {
