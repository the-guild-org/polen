var e = `ASP.NET Razor`,
  ...
  n = {
    'string.quoted.double.html': {
      patterns: [{ include: `#explicit-razor-expression` }, { include: `#implicit-expression` }],
    },
  ...
  r = `razor`,
  i = [{ include: `#razor-control-structures` }, { include: `text.html.basic` }],
  a = {
    ...
    'attribute-directive': {
      ...
      name: `meta.directive`,
      patterns: [{ include: `source.cs#attribute-section` }],
    },
    'await-prefix': { match: `(await)\\s+`, name: `keyword.other.await.cs` },
    ...
    'catch-clause': {
      ...
      patterns: [{ include: `#catch-condition` }, { include: `source.cs#when-clause` }, {
    ...
    'catch-condition': {
      ...
      patterns: [{
        captures: { 1: { patterns: [{ include: `source.cs#type` }] }, 6: { name: `entity.name.variable.local.cs` } },
        match: `(?x)
(?<type-name>
(?:
(?:
...
(?:(\\g<identifier>)\\b)?`,
    ...
    'csharp-code-block': {
      ...
      patterns: [{ include: `#razor-codeblock-body` }],
    },
    'csharp-condition': {
      begin: `(\\()`,
      beginCaptures: { 1: { name: `punctuation.parenthesis.open.cs` } },
      ...
      endCaptures: { 1: { name: `punctuation.parenthesis.close.cs` } },
      patterns: [{ include: `source.cs#local-variable-declaration` }, { include: `source.cs#expression` }, {
    ...
    'directive-codeblock': {
      ...
      patterns: [{ include: `source.cs#class-or-struct-members` }],
    },
    ...
    'do-statement': {
      begin: `(?:(@))(do)\\b\\s`,
      beginCaptures: { 1: { patterns: [{ include: `#transition` }] }, 2: { name: `keyword.control.loop.do.cs` } },
      end: `(?<=})`,
      name: `meta.statement.do.razor`,
      patterns: [{ include: `#csharp-condition` }, { include: `#csharp-code-block` }, {
        include: `#razor-codeblock-body`,
      }],
    },
    ...
    'escaped-transition': { match: `@@`, name: `constant.character.escape.razor.transition` },
    'explicit-razor-expression': {
      begin: `(@)\\(`,
      beginCaptures: { 0: { name: `keyword.control.cshtml` }, 1: { patterns: [{ include: `#transition` }] } },
      end: `\\)`,
      endCaptures: { 0: { name: `keyword.control.cshtml` } },
      name: `meta.expression.explicit.cshtml`,
      patterns: [{ include: `source.cs#expression` }],
    },
    'finally-clause': {
      begin: `(?:^|(?<=}))\\s*(finally)\\b\\s*?(?=[\\n\\{])`,
      ...
      patterns: [{ include: `#csharp-code-block` }, { include: `#razor-codeblock-body` }],
    },
    'for-statement': {
      begin: `(?:(@))(for)\\b\\s*(?=\\()`,
      beginCaptures: { 1: { patterns: [{ include: `#transition` }] }, 2: { name: `keyword.control.loop.for.cs` } },
      end: `(?<=})`,
...
\\b(in)\\b`,
        ...
        captures: {
          1: { name: `keyword.other.var.cs` },
          2: { patterns: [{ include: `source.cs#tuple-declaration-deconstruction-element-list` }] },
...
\\b(in)\\b`,
    ...
    'foreach-statement': {
      ...
      patterns: [{ include: `#foreach-condition` }, { include: `#csharp-code-block` }, {
        include: `#razor-codeblock-body`,
      }],
    },
    ...
    'implicit-expression': {
      begin: `(?<![[:alpha:][:alnum:]])(@)`,
      beginCaptures: { 1: { patterns: [{ include: `#transition` }] } },
      contentName: `source.cs`,
      end: `(?=[\\s<>\\{\\}\\)\\]'"])`,
      name: `meta.expression.implicit.cshtml`,
      patterns: [{ include: `#await-prefix` }, { include: `#implicit-expression-body` }],
    },
    ...
    'implicit-expression-accessor-start': {
      ...
      beginCaptures: { 1: { name: `variable.other.object.cs` } },
      end: `(?=[\\s<>\\{\\}\\)\\]'"])`,
      patterns: [{ include: `#implicit-expression-continuation` }],
    },
    'implicit-expression-body': {
      end: `(?=[\\s<>\\{\\}\\)\\]'"])`,
      patterns: [{ include: `#implicit-expression-invocation-start` }, {
    ...
    'implicit-expression-dot-operator': {
      captures: { 1: { name: `punctuation.accessor.cs` } },
      match: `(\\.)(?=[_[:alpha:]][_[:alnum:]]*)`,
    },
    ...
    'implicit-expression-null-conditional-operator': {
      captures: { 1: { name: `keyword.operator.null-conditional.cs` } },
      match: `(\\?)(?=[.\\[])`,
    },
    'implicit-expression-null-forgiveness-operator': {
      captures: { 1: { name: `keyword.operator.logical.cs` } },
      match: `(\\!)(?=(?:\\.[_[:alpha:]][_[:alnum:]]*)|\\?|[\\[\\(])`,
    },
    'implicit-expression-operator': {
      patterns: [{ include: `#implicit-expression-dot-operator` }, {
    ...
    'lock-statement': {
      begin: `(?:(@))(lock)\\b\\s*(?=\\()`,
      beginCaptures: { 1: { patterns: [{ include: `#transition` }] }, 2: { name: `keyword.other.lock.cs` } },
      end: `(?<=})`,
    ...
    'namespace-directive-argument': {
      captures: { 1: { name: `entity.name.type.namespace.cs` }, 2: { name: `punctuation.accessor.cs` } },
      match: `([_[:alpha:]][_[:alnum:]]*)(\\.)?`,
    },
    'non-void-tag': {
      begin: `(?=<(!)?([^/\\s>]+)(\\s|/?>))`,
      ...
      patterns: [{
        ...
        patterns: [{ include: `#razor-control-structures` }, { include: `text.html.basic#attribute` }],
      }, {
        begin: `>`,
        beginCaptures: { 0: { name: `punctuation.definition.tag.end.html` } },
        end: `(?=</)`,
        patterns: [{ include: `#wellformed-html` }, { include: `$self` }],
      }],
    },
    ...
    'razor-codeblock-body': {
      patterns: [{ include: `#text-tag` }, { include: `#wellformed-html` }, { include: `#razor-single-line-markup` }, {
    ...
    'razor-comment': {
      ...
      endCaptures: { 1: { name: `keyword.control.razor.comment.star` }, 2: { patterns: [{ include: `#transition` }] } },
    ...
    'razor-single-line-markup': {
      captures: {
        ...
        2: { patterns: [{ include: `#razor-control-structures` }, { include: `text.html.basic` }] },
      },
      match: `(\\@\\:)([^$]*)$`,
    },
    ...
    'section-directive': {
      ...
      patterns: [{ include: `#directive-markupblock` }],
    },
    'switch-code-block': {
      begin: `(\\{)`,
      beginCaptures: { 1: { name: `punctuation.curlybrace.open.cs` } },
      ...
      patterns: [{ include: `source.cs#switch-label` }, { include: `#razor-codeblock-body` }],
    },
    'switch-statement': {
      begin: `(?:(@))(switch)\\b\\s*(?=\\()`,
      beginCaptures: { 1: { patterns: [{ include: `#transition` }] }, 2: { name: `keyword.control.switch.cs` } },
      end: `(?<=})`,
      name: `meta.statement.switch.razor`,
      patterns: [{ include: `#csharp-condition` }, { include: `#switch-code-block` }, {
        include: `#razor-codeblock-body`,
      }],
    },
    ...
    'tagHelper-directive-argument': {
      patterns: [{ include: `source.cs#string-literal` }, { include: `#unquoted-string-argument` }],
    },
    ...
    'text-tag': {
      begin: `(<text\\s*>)`,
      beginCaptures: { 1: { name: `keyword.control.cshtml.transition.textTag.open` } },
      end: `(</text>)`,
      endCaptures: { 1: { name: `keyword.control.cshtml.transition.textTag.close` } },
      patterns: [{ include: `#wellformed-html` }, { include: `$self` }],
    },
    transition: { match: `@`, name: `keyword.control.cshtml.transition` },
    ...
    'try-block': {
      begin: `(?:(@))(try)\\b\\s*`,
      beginCaptures: { 1: { patterns: [{ include: `#transition` }] }, 2: { name: `keyword.control.try.cs` } },
      end: `(?<=})`,
    ...
    'try-statement-with-optional-transition': {
      patterns: [{ include: `#try-block-with-optional-transition` }, { include: `#catch-clause` }, {
    ...
    'unquoted-string-argument': { match: `[^$]+`, name: `string.quoted.double.cs` },
    ...
    'using-directive': {
      captures: {
        ...
        3: {
          patterns: [{ include: `#using-static-directive` }, { include: `#using-alias-directive` }, {
    ...
    'using-standard-directive': {
      captures: { 1: { name: `entity.name.type.namespace.cs` } },
      match: `([_[:alpha:]][_[:alnum:]]*)\\s*`,
    },
    'using-statement': {
      begin: `(?:(@))(using)\\b\\s*(?=\\()`,
      beginCaptures: { 1: { patterns: [{ include: `#transition` }] }, 2: { name: `keyword.other.using.cs` } },
      end: `(?<=})`,
    ...
    'using-static-directive': {
      captures: { 1: { name: `keyword.other.static.cs` }, 2: { patterns: [{ include: `source.cs#type` }] } },
      match: `(static)\\b\\s+(.+)`,
    },
    'void-tag': {
      begin:
        `(?i)(<)(!)?(area|base|br|col|command|embed|hr|img|input|keygen|link|meta|param|source|track|wbr)(?=\\s|/?>)`,
      beginCaptures: {
        1: { name: `punctuation.definition.tag.begin.html` },
        2: { name: `constant.character.escape.razor.tagHelperOptOut` },
        3: { name: `entity.name.tag.html` },
    ...
    'wellformed-html': { patterns: [{ include: `#void-tag` }, { include: `#non-void-tag` }] },
    'while-statement': {
      begin: `(?:(@)|^\\s*|(?<=})\\s*)(while)\\b\\s*(?=\\()`,
      beginCaptures: { 1: { patterns: [{ include: `#transition` }] }, 2: { name: `keyword.control.loop.while.cs` } },
      end: `(?<=})|(;)`,
      endCaptures: { 1: { name: `punctuation.terminator.statement.cs` } },
