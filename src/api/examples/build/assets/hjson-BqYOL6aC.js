var e = `Hjson`,
  ...
  r = `(?x:   # turn on extended mode
    ^    # a line beginning with
    \\s*  # some optional space
    [}\\]]  # and the close of an object or array
  )`,
  i = `hjson`,
  a = [{ include: `#comments` }, { include: `#value` }, {
    match: `[^\\s]`,
  ...
  o = {
    ...
    arrayContent: {
      ...
      patterns: [
        ...
        {
          begin: `(?<=\\[)|,`,
          beginCaptures: { 1: { name: `punctuation.separator.dictionary.pair.hjson` } },
          end: `(?=[^\\s,/#])|(?=/[^/*])`,
          patterns: [{ include: `#comments` }, { match: `,`, name: `invalid.illegal.extra-comma.hjson` }],
        },
        { match: `,`, name: `punctuation.separator.array.hjson` },
        { match: `[^\\s\\]]`, name: `invalid.illegal.expected-array-separator.hjson` },
      ],
    },
    arrayJstring: {
      patterns: [{
    ...
    arrayNumber: {
      captures: { 1: { name: `constant.numeric.hjson` }, 2: { name: `punctuation.separator.array.after-num.hjson` } },
      match:
        `(-?(?:0|(?:[1-9]\\d*))(?:\\.\\d+)?(?:[eE][+-]?\\d+)?)(?:[\\t ]*(?=,)|[\\t ]*(?:(,)[\\t ]*)?(?=$|#|/\\*|//|\\]))`,
    },
    arrayObject: {
    ...
    arrayString: { patterns: [{ include: `#arrayMstring` }, { include: `#arrayJstring` }, { include: `#ustring` }] },
    arrayValue: {
      patterns: [{ include: `#arrayNumber` }, { include: `#arrayConstant` }, { include: `#arrayString` }, {
        include: `#arrayObject`,
      }, { include: `#arrayArray` }],
    },
    comments: {
      patterns: [{
        ...
        begin: `^\\s*/\\*`,
        beginCaptures: { 1: { name: `punctuation.definition.comment.hjson` } },
        end: `\\*/(?:\\s*\\n)?`,
        endCaptures: { 1: { name: `punctuation.definition.comment.hjson` } },
    ...
    jstringDoubleContent: {
      patterns: [{ match: `\\\\(?:["'\\\\\\/bfnrt]|u[0-9a-fA-F]{4})`, name: `constant.character.escape.hjson` }, {
        match: `\\\\.`,
        name: `invalid.illegal.unrecognized-string-escape.hjson`,
      }, { match: `[^"]*[^\\n\\r"\\\\]$`, name: `invalid.illegal.string.hjson` }],
    },
...
([,\\{\\}\\[\\]]*)
      ...
      endCaptures: { 1: { name: `punctuation.separator.dictionary.pair.hjson` } },
      patterns: [{ include: `#commentsNewline` }, { include: `#keyValue` }, {
        match: `[^\\s]`,
...
([,\\}\\]]*)
      ...
      patterns: [{ include: `#comments` }, { match: `^\\s+` }, { include: `#objectValue` }, {
        captures: { 1: { name: `invalid.illegal.object-property.closing-bracket.hjson` } },
        match: `^\\s*(\\})`,
    ...
    objectConstant: {
      captures: {
        1: { name: `constant.language.hjson` },
        2: { name: `punctuation.separator.dictionary.pair.after-const.hjson` },
      },
      match: `\\b(true|false|null)(?:[\\t ]*(?=,)|[\\t ]*(?:(,)[\\t ]*)?(?=$|#|/\\*|//|\\}))`,
    },
    objectContent: {
      patterns: [{ include: `#comments` }, { include: `#key` }, {
        match: `:[.|\\s]`,
        name: `invalid.illegal.object-property.hjson`,
      }, {
        begin: `(?<=\\{|,)|,`,
    ...
    objectString: { patterns: [{ include: `#objectMstring` }, { include: `#objectJstring` }, { include: `#ustring` }] },
    objectValue: {
      patterns: [{ include: `#objectNumber` }, { include: `#objectConstant` }, { include: `#objectString` }, {
        include: `#objectObject`,
      }, { include: `#objectArray` }],
    },
    string: { patterns: [{ include: `#mstring` }, { include: `#jstring` }, { include: `#ustring` }] },
    ustring: { match: `([^:,\\{\\[\\}\\]\\s].*)$`, name: `string.quoted.none.hjson` },
    value: {
      patterns: [{ include: `#number` }, { include: `#constant` }, { include: `#string` }, { include: `#object` }, {
        include: `#array`,
      }],
    },
  },
