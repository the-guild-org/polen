var e = `min-dark`,
  ...
  r = [
    ...
    { scope: `emphasis`, settings: { fontStyle: `italic` } },
    {
      ...
      settings: { fontStyle: `bold`, foreground: `#FF7A84` },
    },
    { scope: [`markup.italic.markdown`], settings: { fontStyle: `italic` } },
    { scope: `meta.link.inline.markdown`, settings: { fontStyle: `underline`, foreground: `#1976D2` } },
    { scope: [`string`, `markup.fenced_code`, `markup.inline`], settings: { foreground: `#9db1c5` } },
    { scope: [`comment`, `string.quoted.docstring.multi`], settings: { foreground: `#6b737c` } },
    {
      scope: [
        `constant.language`,
    ...
    { scope: `variable.parameter.function`, settings: { foreground: `#FF9800` } },
    {
      scope: [
        `entity.name.type`,
    ...
    { name: `[Custom] Markdown links`, scope: `markup.underline.link`, settings: { foreground: `#ffab70` } },
    {
      name: `[Custom] Markdown list`,
      scope: [`beginning.punctuation.definition.list.markdown`],
      settings: { foreground: `#FF7A84` },
    },
    {
  ...
  i = !0,
  a = { name: e, type: t, colors: n, tokenColors: r, semanticHighlighting: !0 }
export { a as default, e as name, i as semanticHighlighting, n as colors, r as tokenColors, t as type }
