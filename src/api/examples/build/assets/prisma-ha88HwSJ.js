var e = `Prisma`,
  ...
  i = {
    ...
    assignment: {
      patterns: [{
        begin: `^\\s*(\\w+)\\s*(=)\\s*`,
        beginCaptures: { 1: { name: `variable.other.assignment.prisma` }, 2: { name: `keyword.operator.terraform` } },
        end: `\\n`,
        patterns: [{ include: `#value` }, { include: `#double_comment_inline` }],
      }],
    },
    attribute: {
    ...
    boolean: { match: `\\b(true|false)\\b`, name: `constant.language.boolean.prisma` },
    config_block_definition: {
      ...
      patterns: [{ include: `#triple_comment` }, { include: `#double_comment` }, { include: `#assignment` }],
    },
    double_comment: { begin: `//`, end: `$\\n?`, name: `comment.prisma` },
    ...
    enum_block_definition: {
      ...
      endCaptures: { 0: { name: `punctuation.definition.tag.prisma` } },
      name: `source.prisma.embedded.source`,
      patterns: [{ include: `#triple_comment` }, { include: `#double_comment` }, { include: `#enum_value_definition` }],
    },
    enum_value_definition: {
      patterns: [{ captures: { 1: { name: `variable.other.assignment.prisma` } }, match: `^\\s*(\\w+)\\s*` }, {
      ...
      patterns: [
        {
          captures: {
            ...
            3: { name: `variable.language.relations.prisma` },
            4: { name: `support.type.primitive.prisma` },
            5: { name: `keyword.operator.list_type.prisma` },
            6: { name: `keyword.operator.optional_type.prisma` },
    ...
    identifier: { patterns: [{ match: `\\b(\\w)+\\b`, name: `support.constant.constant.prisma` }] },
    literal: {
      name: `source.prisma.literal`,
      patterns: [{ include: `#boolean` }, { include: `#number` }, { include: `#double_quoted_string` }, {
        include: `#identifier`,
      }],
    },
    map_key: {
    ...
    model_block_definition: {
      ...
      endCaptures: { 0: { name: `punctuation.definition.tag.prisma` } },
      name: `source.prisma.embedded.source`,
      patterns: [{ include: `#triple_comment` }, { include: `#double_comment` }, { include: `#field_definition` }],
    },
    named_argument: {
    ...
    string_interpolation: {
      patterns: [{
        begin: `\\$\\{`,
        beginCaptures: { 0: { name: `keyword.control.interpolation.start.prisma` } },
        end: `\\s*\\}`,
        endCaptures: { 0: { name: `keyword.control.interpolation.end.prisma` } },
    ...
    value: {
      ...
      patterns: [{ include: `#array` }, { include: `#functional` }, { include: `#literal` }],
    },
  },
  a = `source.prisma`,
