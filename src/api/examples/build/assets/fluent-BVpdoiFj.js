var e = `Fluent`,
  t = `fluent`,
  n = [{ include: `#comment` }, { include: `#message` }, { include: `#wrong-line` }],
  r = {
    attributes: {
    ...
    'function-comma': { match: `,`, name: `support.function.function-comma.fluent` },
    ...
    'placeable-function': {
      begin: `([A-Z][A-Z0-9_-]*\\()`,
      beginCaptures: { 1: { name: `support.function.placeable-function.call.begin.fluent` } },
      contentName: `string.placeable-function.fluent`,
      end: `(\\))`,
      endCaptures: { 1: { name: `support.function.placeable-function.call.end.fluent` } },
      patterns: [{ include: `#function-comma` }, { include: `#function-positional-argument` }, {
    ...
    'placeable-string': {
      begin: `(")(?=[^\\n]*")`,
      beginCaptures: { 1: { name: `variable.other.placeable-string-begin.fluent` } },
