var e = `Shell`,
  t = `shellscript`,
  n = [{ include: `#initial_context` }],
  r = {
    alias_statement: {
      begin:
        `(?:(?:[ \\t]*+)(alias)(?:[ \\t]*+)((?:(?:((?<!\\w)-\\w+\\b)(?:[ \\t]*+))*))(?:(?:[ \\t]*+)(?:((?<!\\w)(?:[a-zA-Z_0-9-]+)(?!\\w))(?:(?:(\\[)((?:(?:(?:(?:\\$?)(?:(?<!\\w)(?:[a-zA-Z_0-9-]+)(?!\\w))|@)|\\*)|(-?\\d+)))(\\]))?))(?:(?:(\\=)|(\\+\\=))|(\\-\\=))))`,
      beginCaptures: {
        1: { name: `storage.type.alias.shell` },
        2: {
          patterns: [{ match: `(?<!\\w)-\\w+\\b`, name: `string.unquoted.argument.shell constant.other.option.shell` }],
        },
        3: { name: `string.unquoted.argument.shell constant.other.option.shell` },
    ...
    argument: {
      ...
      patterns: [{ include: `#argument_context` }, { include: `#line_continuation` }],
    },
    argument_context: {
      patterns: [{
        captures: {
          1: {
            ...
            patterns: [{ match: `\\*`, name: `variable.language.special.wildcard.shell` }, { include: `#variable` }, {
    ...
    arithmetic_double: {
      patterns: [{
        begin: `\\(\\(`,
        beginCaptures: { 0: { name: `punctuation.section.arithmetic.double.shell` } },
        end: `\\)(?:\\s*)\\)`,
        endCaptures: { 0: { name: `punctuation.section.arithmetic.double.shell` } },
    ...
    arithmetic_no_dollar: {
      patterns: [{
        begin: `\\(`,
        beginCaptures: { 0: { name: `punctuation.section.arithmetic.single.shell` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.section.arithmetic.single.shell` } },
        name: `meta.arithmetic.shell`,
        patterns: [{ include: `#math` }, { include: `#string` }],
      }],
    },
    array_access_inline: {
      captures: {
        ...
        2: { patterns: [{ include: `#special_expansion` }, { include: `#string` }, { include: `#variable` }] },
    ...
    array_value: {
      begin:
        `(?:[ \\t]*+)(?:((?<!\\w)(?:[a-zA-Z_0-9-]+)(?!\\w))(?:(?:(\\[)((?:(?:(?:(?:\\$?)(?:(?<!\\w)(?:[a-zA-Z_0-9-]+)(?!\\w))|@)|\\*)|(-?\\d+)))(\\]))?))(?:(?:(\\=)|(\\+\\=))|(\\-\\=))(?:[ \\t]*+)(\\()`,
      beginCaptures: {
      ...
      patterns: [
        ...
        {
          captures: {
            1: { name: `variable.other.assignment.array.shell entity.other.attribute-name.shell` },
            2: { name: `keyword.operator.assignment.shell punctuation.definition.assignment.shell` },
          },
        ...
        },
        {
          captures: {
            ...
            2: { name: `string.unquoted.shell entity.other.attribute-name.bracket.shell` },
    ...
    assignment_statement: {
      patterns: [{ include: `#array_value` }, { include: `#modified_assignment_statement` }, {
    ...
    basic_command_name: {
      captures: {
        ...
        2: {
          ...
          patterns: [{ match: `(?<!\\w)(?:continue|return|break)(?!\\w)`, name: `keyword.control.$0.shell` }, {
            match:
              `(?<!\\w)(?:(?:unfunction|continue|autoload|unsetopt|bindkey|builtin|getopts|command|declare|unalias|history|unlimit|typeset|suspend|source|printf|unhash|disown|ulimit|return|which|alias|break|false|print|shift|times|umask|umask|unset|read|type|exec|eval|wait|echo|dirs|jobs|kill|hash|stat|exit|test|trap|true|let|set|pwd|cd|fg|bg|fc|:|\\.)(?!\\/))(?!\\w)(?!-)`,
    ...
    block_comment: {
      begin: `(?:(?:\\s*+)(\\/\\*))`,
      beginCaptures: { 1: { name: `punctuation.definition.comment.begin.shell` } },
      end: `\\*\\/`,
      endCaptures: { 0: { name: `punctuation.definition.comment.end.shell` } },
      name: `comment.block.shell`,
    },
    boolean: { match: `\\b(?:true|false)\\b`, name: `constant.language.$0.shell` },
    case_statement: {
      begin: `(?:(\\bcase\\b)(?:[ \\t]*+)(.+?)(?:[ \\t]*+)(\\bin\\b))`,
      beginCaptures: {
      ...
      patterns: [{ include: `#comment` }, {
        captures: { 1: { name: `keyword.operator.pattern.case.default.shell` } },
        match: `(?:[ \\t]*+)(\\* *\\))`,
      }, {
        begin: `(?<!\\))(?!(?:[ \\t]*+)(?:esac\\b|$))`,
        beginCaptures: {},
        ...
        endCaptures: { 1: { name: `punctuation.terminator.statement.case.shell` } },
        name: `meta.case.entry.body.shell`,
        patterns: [{ include: `#typical_statements` }, { include: `#initial_context` }],
      }],
    },
      ...
      patterns: [
        {
          match: `\\*`,
          name:
            `variable.language.special.quantifier.star.shell keyword.operator.quantifier.star.shell punctuation.definition.arbitrary-repetition.shell punctuation.definition.regex.arbitrary-repetition.shell`,
        },
        {
          match: `\\+`,
          name:
            `variable.language.special.quantifier.plus.shell keyword.operator.quantifier.plus.shell punctuation.definition.arbitrary-repetition.shell punctuation.definition.regex.arbitrary-repetition.shell`,
        },
        {
          match: `\\?`,
          name:
            `variable.language.special.quantifier.question.shell keyword.operator.quantifier.question.shell punctuation.definition.arbitrary-repetition.shell punctuation.definition.regex.arbitrary-repetition.shell`,
        },
        {
          match: `@`,
        ...
        },
        {
          match: `\\|`,
          name:
            `keyword.operator.orvariable.language.special.or.shell keyword.operator.alternation.ruby.shell punctuation.definition.regex.alternation.shell punctuation.separator.regex.alternation.shell`,
        },
        { match: `\\\\.`, name: `constant.character.escape.shell` },
        { match: `(?<=\\tin| in| |\\t|;;)\\(`, name: `keyword.operator.pattern.case.shell` },
        {
          begin: `(?<=\\S)(\\()`,
          beginCaptures: { 1: { name: `punctuation.definition.group.shell punctuation.definition.regex.group.shell` } },
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.definition.group.shell punctuation.definition.regex.group.shell` } },
          name: `meta.parenthese.shell`,
          patterns: [{ include: `#case_statement_context` }],
        },
        {
          begin: `\\[`,
          beginCaptures: { 0: { name: `punctuation.definition.character-class.shell` } },
          end: `\\]`,
          endCaptures: { 0: { name: `punctuation.definition.character-class.shell` } },
          name: `string.regexp.character-class.shell`,
          patterns: [{ match: `\\\\.`, name: `constant.character.escape.shell` }],
        },
        { include: `#string` },
    ...
    command_name_range: {
      ...
      patterns: [
        ...
        { include: `#variable` },
        {
          captures: { 1: { name: `entity.name.function.call.shell entity.name.command.shell` } },
          match: `(?:(?<!\\w)(?<=\\G|'|"|\\}|\\))([^ \\n\\t\\r"'=;&\\|\`\\)\\{<>]+))`,
        },
        {
          begin: `(?:(?:\\G|(?<! |\\t|;|\\||&|\\n|\\{|#))(?:(\\$?)((?:(")|(')))))`,
          beginCaptures: {
            1: {
              name:
                `meta.statement.command.name.quoted.shell punctuation.definition.string.shell entity.name.function.call.shell entity.name.command.shell`,
            },
            2: {},
            3: {
              name:
                `meta.statement.command.name.quoted.shell string.quoted.double.shell punctuation.definition.string.begin.shell entity.name.function.call.shell entity.name.command.shell`,
            },
            4: {
              name:
                `meta.statement.command.name.quoted.shell string.quoted.single.shell punctuation.definition.string.begin.shell entity.name.function.call.shell entity.name.command.shell`,
            },
          },
          end: `(?<!\\G)(?<=(?:\\2))`,
          endCaptures: {},
          patterns: [{ include: `#continuation_of_single_quoted_command_name` }, {
    ...
    comments: { patterns: [{ include: `#block_comment` }, { include: `#line_comment` }] },
    'compound-command': {
      patterns: [{
        begin: `\\[`,
        beginCaptures: { 0: { name: `punctuation.definition.logical-expression.shell` } },
        end: `\\]`,
        endCaptures: { 0: { name: `punctuation.definition.logical-expression.shell` } },
        name: `meta.scope.logical-expression.shell`,
        patterns: [{ include: `#logical-expression` }, { include: `#initial_context` }],
      }, {
        begin: `(?<=\\s|^){(?=\\s|$)`,
    ...
    continuation_of_double_quoted_command_name: {
      ...
      endCaptures: {
        0: {
          name:
            `string.quoted.double.shell punctuation.definition.string.end.shell entity.name.function.call.shell entity.name.command.shell`,
        },
      },
      patterns: [{ match: '\\\\[\\$\\n`"\\\\]', name: `constant.character.escape.shell` }, { include: `#variable` }, {
    ...
    continuation_of_single_quoted_command_name: {
      ...
      endCaptures: {
        0: {
          name:
            `string.quoted.single.shell punctuation.definition.string.end.shell entity.name.function.call.shell entity.name.command.shell`,
        },
      },
    },
    ...
    double_quote_escape_char: { match: '\\\\[\\$`"\\\\\\n]', name: `constant.character.escape.shell` },
    floating_keyword: {
      patterns: [{
    ...
    for_statement: {
      patterns: [{
        ...
        patterns: [{ include: `#string` }, { include: `#simple_unquoted` }, { include: `#normal_context` }],
      }, {
        begin: `(\\bfor\\b)`,
        ...
        endCaptures: {},
        name: `meta.for.shell`,
        patterns: [{ include: `#arithmetic_double` }, { include: `#normal_context` }],
      }],
    },
    function_definition: {
    ...
    heredoc: {
      patterns: [{
        ...
        beginCaptures: {
          ...
          3: { name: `punctuation.definition.string.heredoc.delimiter.shell` },
          4: { name: `punctuation.definition.string.heredoc.quote.shell` },
          5: { patterns: [{ include: `#redirect_fix` }, { include: `#typical_statements` }] },
        },
        contentName: `string.quoted.heredoc.indent.$3`,
        end: `(?:(?:^\\t*)(?:\\3)(?=\\s|;|&|$))`,
        endCaptures: { 0: { name: `punctuation.definition.string.heredoc.$0.shell` } },
        patterns: [],
      }, {
        begin: `(?:((?<!<)(?:<<)(?!<))(?:[ \\t]*+)("|')(?:[ \\t]*+)([^"']+?)(?=\\s|;|&|<|"|')((?:\\2))(.*))`,
        beginCaptures: {
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.heredoc.delimiter.shell` } },
        patterns: [],
      }, {
        begin: `(?:((?<!<)(?:<<-))(?:[ \\t]*+)([^"' \\t]+)(?=\\s|;|&|<|"|')(.*))`,
        beginCaptures: {
          1: { name: `keyword.operator.heredoc.shell` },
          2: { name: `punctuation.definition.string.heredoc.delimiter.shell` },
          3: { patterns: [{ include: `#redirect_fix` }, { include: `#typical_statements` }] },
        },
        contentName: `string.unquoted.heredoc.indent.$2`,
        end: `(?:(?:^\\t*)(?:\\2)(?=\\s|;|&|$))`,
        endCaptures: { 0: { name: `punctuation.definition.string.heredoc.delimiter.shell` } },
        patterns: [{ include: `#double_quote_escape_char` }, { include: `#variable` }, { include: `#interpolation` }],
      }, {
        begin: `(?:((?<!<)(?:<<)(?!<))(?:[ \\t]*+)([^"' \\t]+)(?=\\s|;|&|<|"|')(.*))`,
        beginCaptures: {
          1: { name: `keyword.operator.heredoc.shell` },
    ...
    herestring: {
      patterns: [{
        ...
        captures: {
          1: { name: `keyword.operator.herestring.shell` },
          2: { name: `string.unquoted.herestring.shell`, patterns: [{ include: `#initial_context` }] },
        },
        match: `(<<<)\\s*(([^\\s)\\\\]|\\\\.)+)`,
        name: `meta.herestring.shell`,
      }],
    ...
    inline_comment: {
      captures: {
        1: { name: `comment.block.shell punctuation.definition.comment.begin.shell` },
        2: { name: `comment.block.shell` },
        3: {
          patterns: [{ match: `\\*\\/`, name: `comment.block.shell punctuation.definition.comment.end.shell` }, {
            match: `\\*`,
            name: `comment.block.shell`,
          }],
        },
    ...
    interpolation: {
      patterns: [{ include: `#arithmetic_dollar` }, { include: `#subshell_dollar` }, {
        begin: '`',
        beginCaptures: { 0: { name: `punctuation.definition.evaluation.backticks.shell` } },
        end: '`',
        endCaptures: { 0: { name: `punctuation.definition.evaluation.backticks.shell` } },
        name: `string.interpolated.backtick.shell`,
        patterns: [{ match: '\\\\[`\\\\$]', name: `constant.character.escape.shell` }, {
          begin: `(?<=\\W)(?=#)(?!#{)`,
          beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.shell` } },
          end: `(?!\\G)`,
          patterns: [{
            begin: `#`,
    ...
    'logical-expression': {
      patterns: [{ include: `#arithmetic_no_dollar` }, {
    ...
    loop: {
      patterns: [{
        ...
        beginCaptures: {
          ...
          2: { name: `variable.other.loop.shell`, patterns: [{ include: `#string` }] },
        ...
        beginCaptures: { 1: { name: `keyword.control.shell` }, 2: { name: `variable.other.loop.shell` } },
        end: `(?<=^|;|&|\\s)(done)(?=\\s|;|&|$|\\))`,
    ...
    math: {
      patterns: [
        ...
        { match: `;`, name: `punctuation.separator.semicolon.range` },
        ...
        { match: `(?<!\\w)(?:[a-zA-Z_0-9]+)(?!\\w)`, name: `variable.other.normal.shell` },
      ],
    },
    math_operators: {
      patterns: [
    ...
    misc_ranges: {
      patterns: [{ include: `#logical_expression_single` }, { include: `#logical_expression_double` }, {
        include: `#subshell_dollar`,
      }, {
        begin: `(?<![^ \\t])({)(?!\\w|\\$)`,
        beginCaptures: { 1: { name: `punctuation.definition.group.shell` } },
        end: `}`,
    ...
    modified_assignment_statement: {
      ...
      patterns: [{ match: `(?<!\\w)-\\w+\\b`, name: `string.unquoted.argument.shell constant.other.option.shell` }, {
        ...
        captures: {
          ...
          10: { name: `constant.numeric.shell constant.numeric.octal.shell` },
          11: { name: `constant.numeric.shell constant.numeric.other.shell` },
          12: { name: `constant.numeric.shell constant.numeric.decimal.shell` },
          13: { name: `constant.numeric.shell constant.numeric.version.shell` },
          14: { name: `constant.numeric.shell constant.numeric.integer.shell` },
        },
        match:
          `(?:((?<!\\w)(?:[a-zA-Z_0-9-]+)(?!\\w))(?:(?:(\\[)((?:(?:(?:(?:\\$?)(?:(?<!\\w)(?:[a-zA-Z_0-9-]+)(?!\\w))|@)|\\*)|(-?\\d+)))(\\]))?)(?:(?:(?:(\\=)|(\\+\\=))|(\\-\\=))?)(?:(?:(?<==| |\\t|^|\\{|\\(|\\[)(?:(?:(?:(?:(?:(0[xX][0-9A-Fa-f]+)|(0\\d+))|(\\d{1,2}#[0-9a-zA-Z@_]+))|(-?\\d+(?:\\.\\d+)))|(-?\\d+(?:\\.\\d+)+))|(-?\\d+))(?= |\\t|$|\\}|\\)|;))?))`,
      }, { include: `#normal_context` }],
    },
    modifiers: {
    ...
    normal_assignment_statement: {
      ...
      patterns: [
        ...
        { include: `#normal_assignment_statement` },
        {
          ...
          patterns: [{ include: `#command_name_range` }, { include: `#line_continuation` }, { include: `#option` }, {
            include: `#argument`,
          }, { include: `#string` }],
        },
        { include: `#simple_unquoted` },
    ...
    normal_statement: {
      begin:
        '(?:(?!^[ \\t]*+$)(?:(?<=^until | until |\\tuntil |^while | while |\\twhile |^elif | elif |\\telif |^else | else |\\telse |^then | then |\\tthen |^do | do |\\tdo |^if | if |\\tif )|(?<=(?:^|;|\\||&|!|\\(|\\{|\\`)))(?:[ \\t]*+)(?!nocorrect\\W|nocorrect\\$|function\\W|function\\$|foreach\\W|foreach\\$|repeat\\W|repeat\\$|logout\\W|logout\\$|coproc\\W|coproc\\$|select\\W|select\\$|while\\W|while\\$|pushd\\W|pushd\\$|until\\W|until\\$|case\\W|case\\$|done\\W|done\\$|elif\\W|elif\\$|else\\W|else\\$|esac\\W|esac\\$|popd\\W|popd\\$|then\\W|then\\$|time\\W|time\\$|for\\W|for\\$|end\\W|end\\$|fi\\W|fi\\$|do\\W|do\\$|in\\W|in\\$|if\\W|if\\$))',
      beginCaptures: {},
      end: '(?=;|\\||&|\\n|\\)|\\`|\\{|\\}|[ \\t]*#|\\])(?<!\\\\)',
      endCaptures: {},
    ...
    numeric_literal: {
      ...
      match:
        `(?<==| |\\t|^|\\{|\\(|\\[)(?:(?:(?:(?:(?:(0[xX][0-9A-Fa-f]+)|(0\\d+))|(\\d{1,2}#[0-9a-zA-Z@_]+))|(-?\\d+(?:\\.\\d+)))|(-?\\d+(?:\\.\\d+)+))|(-?\\d+))(?= |\\t|$|\\}|\\)|;)`,
    },
    option: {
      begin: `(?:(?:[ \\t]++)(-)((?!(?:!|&|\\||\\(|\\)|\\{|\\[|<|>|#|\\n|$|;|[ \\t]))))`,
      beginCaptures: {
        1: { name: `string.unquoted.argument.shell constant.other.option.dash.shell` },
        2: { name: `string.unquoted.argument.shell constant.other.option.shell` },
      },
    ...
    parenthese: {
      patterns: [{
        begin: `\\(`,
        beginCaptures: { 0: { name: `punctuation.section.parenthese.shell` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.section.parenthese.shell` } },
        name: `meta.parenthese.group.shell`,
        patterns: [{ include: `#initial_context` }],
      }],
    },
    pathname: {
      patterns: [{ match: `(?<=\\s|:|=|^)~`, name: `keyword.operator.tilde.shell` }, {
        match: `\\*|\\?`,
    ...
    pipeline: {
      patterns: [{ match: `(?<=^|;|&|\\s)(time)(?=\\s|;|&|$)`, name: `keyword.other.shell` }, {
        match: `[|!]`,
        name: `keyword.operator.pipe.shell`,
      }],
    },
    redirect_fix: {
      captures: { 1: { name: `keyword.operator.redirect.shell` }, 2: { name: `string.unquoted.argument.shell` } },
      match: `(?:(>>?)(?:[ \\t]*+)([^ \\t\\n>&;<>\\(\\)\\$\`\\\\"'<\\|]+))`,
    },
    redirect_number: {
      captures: {
    ...
    regex_comparison: { match: `\\=~`, name: `keyword.operator.logical.regex.shell` },
    regexp: { patterns: [{ match: `(?:.+)` }] },
    simple_options: {
      captures: {
        0: {
          patterns: [{
    ...
    special_expansion: { match: `!|:[-=?]?|\\*|@|##|#|%%|%|\\/`, name: `keyword.operator.expansion.shell` },
    start_of_command: {
      match:
        `(?:(?:[ \\t]*+)(?:(?!(?:!|&|\\||\\(|\\)|\\{|\\[|<|>|#|\\n|$|;|[ \\t]))(?!nocorrect |nocorrect	|nocorrect$|readonly |readonly	|readonly$|function |function	|function$|foreach |foreach	|foreach$|coproc |coproc	|coproc$|logout |logout	|logout$|export |export	|export$|select |select	|select$|repeat |repeat	|repeat$|pushd |pushd	|pushd$|until |until	|until$|while |while	|while$|local |local	|local$|case |case	|case$|done |done	|done$|elif |elif	|elif$|else |else	|else$|esac |esac	|esac$|popd |popd	|popd$|then |then	|then$|time |time	|time$|for |for	|for$|end |end	|end$|fi |fi	|fi$|do |do	|do$|in |in	|in$|if |if	|if$)(?!\\\\\\n?$)))`,
    },
    string: {
      patterns: [{ match: `\\\\.`, name: `constant.character.escape.shell` }, {
        ...
        patterns: [
          { match: `\\\\(?:a|b|e|f|n|r|t|v|\\\\|')`, name: `constant.character.escape.ansi-c.shell` },
          { match: `\\\\[0-9]{3}"`, name: `constant.character.escape.octal.shell` },
          { match: `\\\\x[0-9a-fA-F]{2}"`, name: `constant.character.escape.hex.shell` },
          { match: `\\\\c."`, name: `constant.character.escape.control-char.shell` },
        ],
      }],
    },
    subshell_dollar: {
      patterns: [{
        begin: `(?:\\$\\()`,
        beginCaptures: { 0: { name: `punctuation.definition.subshell.single.shell` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.subshell.single.shell` } },
        name: `meta.scope.subshell`,
        patterns: [{ include: `#parenthese` }, { include: `#initial_context` }],
      }],
    },
    support: { patterns: [{ match: `(?<=^|;|&|\\s)(?::|\\.)(?=\\s|;|&|$)`, name: `support.function.builtin.shell` }] },
    typical_statements: {
      patterns: [
        { include: `#assignment_statement` },
        { include: `#case_statement` },
    ...
    variable: {
      patterns: [{
        captures: {
          1: { name: `punctuation.definition.variable.shell variable.parameter.positional.all.shell` },
          2: { name: `variable.parameter.positional.all.shell` },
        },
        match: `(?:(\\$)(\\@(?!\\w)))`,
      }, {
        captures: {
          1: { name: `punctuation.definition.variable.shell variable.parameter.positional.shell` },
          2: { name: `variable.parameter.positional.shell` },
        },
        match: `(?:(\\$)([0-9](?!\\w)))`,
      }, {
        captures: {
          1: { name: `punctuation.definition.variable.shell variable.language.special.shell` },
        ...
        beginCaptures: {
          ...
          2: {
            name:
              `punctuation.section.bracket.curly.variable.begin.shell punctuation.definition.variable.shell variable.parameter.positional.shell`,
          },
        },
        ...
        endCaptures: {
          0: {
            name:
              `punctuation.section.bracket.curly.variable.end.shell punctuation.definition.variable.shell variable.parameter.positional.shell`,
          },
        },
        patterns: [
          { include: `#special_expansion` },
          { include: `#array_access_inline` },
          { match: `[0-9]+`, name: `variable.parameter.positional.shell` },
          { match: `(?<!\\w)(?:[a-zA-Z_0-9-]+)(?!\\w)`, name: `variable.other.normal.shell` },
          { include: `#variable` },
          { include: `#string` },
        ],
        ...
        beginCaptures: {
          ...
          2: { name: `punctuation.section.bracket.curly.variable.begin.shell punctuation.definition.variable.shell` },
        },
        contentName: `meta.parameter-expansion`,
        end: `\\}`,
        endCaptures: {
          0: { name: `punctuation.section.bracket.curly.variable.end.shell punctuation.definition.variable.shell` },
        },
        patterns: [
          { include: `#special_expansion` },
          { include: `#array_access_inline` },
        ...
        captures: {
          1: { name: `punctuation.definition.variable.shell variable.other.normal.shell` },
