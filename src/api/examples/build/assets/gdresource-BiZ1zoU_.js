var e = `GDResource`,
  t = `gdresource`,
  n = [{ include: `#embedded_shader` }, { include: `#embedded_gdscript` }, { include: `#comment` }, {
    include: `#heading`,
  }, { include: `#key_value` }],
  r = {
    comment: {
    ...
    data: {
      patterns: [
        ...
        { match: `"res:\\/\\/[^"\\\\]*(?:\\\\.[^"\\\\]*)*"`, name: `support.function.any-method.gdresource` },
        { match: `(?<=type=)"[^"\\\\]*(?:\\\\.[^"\\\\]*)*"`, name: `support.class.library.gdresource` },
        {
        ...
        { match: `(?<!\\w)(true|false)(?!\\w)`, name: `constant.language.gdresource` },
        {
          match:
        ...
        { match: `(?<!\\w)([\\+\\-]?inf)(?!\\w)`, name: `constant.numeric.inf.gdresource` },
        { match: `(?<!\\w)([\\+\\-]?nan)(?!\\w)`, name: `constant.numeric.nan.gdresource` },
        {
          match: `(?<!\\w)((?:0x(([0-9a-fA-F](([0-9a-fA-F]|_[0-9a-fA-F])+)?))))(?!\\w)`,
          name: `constant.numeric.hex.gdresource`,
        },
        { match: `(?<!\\w)(0o[0-7](_?[0-7])*)(?!\\w)`, name: `constant.numeric.oct.gdresource` },
        { match: `(?<!\\w)(0b[01](_?[01])*)(?!\\w)`, name: `constant.numeric.bin.gdresource` },
        {
          begin:
