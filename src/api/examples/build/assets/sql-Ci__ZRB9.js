var e = `SQL`,
  ...
  n = [
    ...
    {
      captures: { 1: { name: `keyword.other.create.sql` }, 2: { name: `keyword.other.sql` } },
      match:
    ...
    {
      captures: { 1: { name: `keyword.other.create.sql` }, 2: { name: `keyword.other.table.sql` } },
      match:
...
`,
    ...
    {
      match:
        `(?i:\\b((?:primary|foreign)\\s+key|references|on\\sdelete(\\s+cascade)?|nocheck|check|constraint|collate|default)\\b)`,
    ...
    { match: `(?i:\\b(on|off|((is\\s+)?not\\s+)?null)\\b)`, name: `keyword.other.DDL.create.II.sql` },
    ...
    { match: `\\|\\|`, name: `keyword.operator.concatenator.sql` },
    {
      ...
      match:
        `(?i)\\b(approx_count_distinct|approx_percentile_cont|approx_percentile_disc|avg|checksum_agg|count|count_big|group|grouping|grouping_id|max|min|sum|stdev|stdevp|var|varp)\\b\\s*\\(`,
    },
    {
      captures: { 1: { name: `support.function.analytic.sql` } },
      match:
        `(?i)\\b(cume_dist|first_value|lag|last_value|lead|percent_rank|percentile_cont|percentile_disc)\\b\\s*\\(`,
    },
    {
      captures: { 1: { name: `support.function.bitmanipulation.sql` } },
      match: `(?i)\\b(bit_count|get_bit|left_shift|right_shift|set_bit)\\b\\s*\\(`,
    },
    {
      captures: { 1: { name: `support.function.conversion.sql` } },
      match: `(?i)\\b(cast|convert|parse|try_cast|try_convert|try_parse)\\b\\s*\\(`,
    },
    {
      captures: { 1: { name: `support.function.collation.sql` } },
      match: `(?i)\\b(collationproperty|tertiary_weights)\\b\\s*\\(`,
    },
    {
      captures: { 1: { name: `support.function.cryptographic.sql` } },
      match:
    ...
    { captures: { 1: { name: `support.function.cursor.sql` } }, match: `(?i)\\b(cursor_status)\\b\\s*\\(` },
    {
      captures: { 1: { name: `support.function.datetime.sql` } },
      match:
    ...
    {
      captures: { 1: { name: `support.function.datatype.sql` } },
      match: `(?i)\\b(datalength|ident_current|ident_incr|ident_seed|identity|sql_variant_property)\\b\\s*\\(`,
    },
    { captures: { 1: { name: `support.function.expression.sql` } }, match: `(?i)\\b(coalesce|nullif)\\b\\s*\\(` },
    {
    ...
    {
      captures: { 1: { name: `support.function.logical.sql` } },
      match: `(?i)\\b(choose|iif|greatest|least)\\b\\s*\\(`,
    },
    {
      captures: { 1: { name: `support.function.mathematical.sql` } },
      match:
    ...
    {
      captures: { 1: { name: `support.function.metadata.sql` } },
      match:
    ...
    {
      captures: { 1: { name: `support.function.system.sql` } },
      match:
    ...
    {
      captures: { 1: { name: `support.function.textimage.sql` } },
      match: `(?i)\\b(patindex|textptr|textvalid)\\b\\s*\\(`,
    },
    {
      captures: { 1: { name: `constant.other.database-name.sql` }, 2: { name: `constant.other.table-name.sql` } },
      match: `(\\w+?)\\.(\\w+)`,
    },
    { include: `#strings` },
    { include: `#regexps` },
  ...
  i = `source.sql`,
  a = { displayName: `SQL`, name: `sql`, patterns: n, repository: r, scopeName: i }
