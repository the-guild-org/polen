var e = `Fortran (Free Form)`,
  t = [`f90`, `F90`, `f95`, `F95`, `f03`, `F03`, `f08`, `F08`, `f18`, `F18`, `fpp`, `FPP`, `.pf`, `.PF`],
  n = `(?i)-[*]- mode: fortran free -[*]-`,
  r = {
    'source.fortran.free - ( string | comment | meta.preprocessor )': {
      patterns: [{ include: `#line-continuation-operator` }, { include: `#preprocessor` }],
    },
    'string.quoted.double.fortran': { patterns: [{ include: `#string-line-continuation-operator` }] },
    'string.quoted.single.fortran': { patterns: [{ include: `#string-line-continuation-operator` }] },
  },
  i = `fortran-free-form`,
  a = [
  ...
  o = {
    ...
    'IO-keywords': {
      ...
      endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
      patterns: [{
        captures: {
    ...
    'IO-statements': {
      patterns: [{
        ...
        patterns: [{ include: `#parentheses-dummy-variables` }, { include: `#IO-item-list` }],
      }, {
        captures: {
          1: { name: `keyword.control.backspace.fortran` },
        ...
        endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
        patterns: [{ include: `#parentheses-dummy-variables` }],
      }, {
        captures: { 1: { name: `keyword.control.flush.fortran` } },
        comment: `Introduced in the Fortran 2003 standard.`,
        match: `(?i)\\b(flush)\\b`,
      }],
    },
    'abstract-attribute': {
      captures: { 1: { name: `storage.modifier.fortran.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
    ...
    'abstract-interface-block-construct': {
      ...
      endCaptures: { 1: { name: `keyword.control.endinterface.fortran.modern` } },
      name: `meta.interface.abstract.fortran`,
      patterns: [{ include: `$base` }],
    },
    'access-attribute': { patterns: [{ include: `#private-attribute` }, { include: `#public-attribute` }] },
    'allocatable-attribute': {
      captures: { 1: { name: `storage.modifier.allocatable.fortran` } },
    ...
    'array-constructor': {
      ...
      patterns: [{ include: `#brackets` }, {
        begin: `\\s*(\\(\\/)`,
        beginCaptures: { 1: { name: `punctuation.bracket.left.fortran` } },
        end: `(\\/\\))`,
        endCaptures: { 1: { name: `punctuation.bracket.left.fortran` } },
        patterns: [
          { include: `#comments` },
          { include: `#constants` },
          { include: `#operators` },
    ...
    'assign-statement': {
      patterns: [{
        begin: `(?i)\\b(assign)\\b`,
        beginCaptures: { 1: { name: `keyword.control.assign.fortran` } },
        comment: `Introduced in the Fortran 1977 standard.`,
        end: `(?=[;!\\n])`,
        name: `meta.statement.control.assign.fortran`,
        patterns: [{ captures: { 1: { name: `keyword.control.to.fortran` } }, match: `(?i)\\s*\\b(to)\\b` }, {
          include: `$base`,
        }],
      }],
    },
    'assignment-keyword': {
      ...
      endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
      patterns: [{ include: `#assignment-operator` }, { include: `#invalid-word` }],
    },
    'assignment-operator': {
      comment: `Introduced in the Fortran 1977 standard.`,
      match: `(?<!\\/|\\=|\\<|\\>)(\\=)(?!\\=|\\>)`,
    ...
    'associate-construct': {
      ...
      beginCaptures: { 1: { name: `keyword.control.associate.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
      contentName: `meta.block.associate.fortran`,
      end: `(?i)\\b(end\\s*associate)\\b`,
      endCaptures: { 1: { name: `keyword.control.endassociate.fortran` } },
      patterns: [{ include: `$base` }],
    },
    'asynchronous-attribute': {
      captures: { 1: { name: `storage.modifier.asynchronous.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
      match: `(?i)\\G\\s*\\b(asynchronous)\\b`,
    },
    'attribute-specification-statement': {
      begin:
        `(?ix)(?=\\b(?:allocatable|asynchronous|contiguous |external|intrinsic|optional|parameter|pointer|private|protected|public|save|target|value|volatile)\\b |(bind|dimension|intent)\\s*\\( |(codimension)\\s*\\[)`,
      end: `(?=[;!\\n])`,
      ...
      patterns: [
        ...
        { include: `#volatile-attribute` },
        {
          ...
          endCaptures: { 1: { name: `keyword.operator.double-colon.fortran` } },
    ...
    'block-data-definition': {
      ...
      endCaptures: {
        ...
        4: { name: `invalid.error.block-data-definition.fortran` },
      },
    ...
    'call-statement': {
      patterns: [{
        begin: `(?i)\\s*\\b(call)\\b`,
        beginCaptures: { 1: { name: `keyword.control.call.fortran` } },
        comment: `Introduced in the Fortran 1977 standard.`,
        end: `(?=[;!\\n])`,
        ...
        patterns: [
          {
            ...
            beginCaptures: {
              1: { name: `variable.other.fortran` },
              2: { name: `keyword.accessor.fortran` },
              3: { name: `entity.name.function.subroutine.fortran` },
            },
          ...
          {
            captures: { 1: { name: `entity.name.function.subroutine.fortran` } },
            comment: `User defined subroutine.`,
    ...
    'codimension-attribute': {
      ...
      beginCaptures: { 1: { name: `storage.modifier.codimension.fortran` } },
      comment: `Introduced in the Fortran 2008 standard.`,
      end: `(?<!\\G)`,
      patterns: [{ include: `#brackets` }],
    },
    ...
    'common-statement': {
      begin: `(?i)\\b(common)\\b`,
      beginCaptures: { 1: { name: `keyword.control.common.fortran` } },
      end: `(?=[;!\\n])`,
      patterns: [{ include: `$base` }],
    },
    'concurrent-attribute': {
      begin: `(?i)\\G\\s*\\b(concurrent)\\b`,
      beginCaptures: { 1: { name: `keyword.control.while.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
      end: `(?=[;!\\n])`,
      patterns: [{ include: `#parentheses` }, { include: `#invalid-word` }],
    },
    constants: {
      patterns: [{ include: `#logical-constant` }, { include: `#numeric-constant` }, { include: `#string-constant` }],
    },
    'contiguous-attribute': {
      captures: { 1: { name: `storage.modifier.contigous.fortran` } },
      comment: `Introduced in the Fortran 2008 standard.`,
    ...
    'continue-statement': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.control.continue.fortran` } },
        comment: `Introduced in the Fortran 1977 standard.`,
        end: `(?=[;!\\n])`,
        name: `meta.statement.control.continue.fortran`,
        patterns: [{ include: `#invalid-character` }],
      }],
    },
    'control-constructs': {
      patterns: [{ include: `#named-control-constructs` }, { include: `#unnamed-control-constructs` }],
    },
    'control-statements': {
          ...
          patterns: [{
            ...
            patterns: [{
              captures: {
                ...
                11: { name: `keyword.other.unit.suffix.floating-point.cpp` },
    ...
    'cycle-statement': {
      patterns: [{
        begin: `(?i)\\s*\\b(cycle)\\b`,
        beginCaptures: { 1: { name: `keyword.control.cycle.fortran` } },
        comment: `Introduced in the Fortran 1990 standard.`,
        end: `(?=[;!\\n])`,
    ...
    'data-statement': {
      begin: `(?i)\\b(data)\\b`,
      beginCaptures: { 1: { name: `keyword.control.data.fortran` } },
      end: `(?=[;!\\n])`,
      patterns: [{ include: `$base` }],
    },
    ...
    'deferred-attribute': {
      captures: { 1: { name: `storage.modifier.deferred.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
    ...
    'derived-type': {
      ...
      beginCaptures: {
        ...
        3: { name: `punctuation.parentheses.left.fortran` },
        4: { name: `entity.name.type.fortran` },
      },
    ...
    'derived-type-component-attribute-specification': {
      ...
      name: `meta.statement.attribute-specification.fortran`,
      patterns: [{ include: `#access-attribute` }, { include: `#sequence-attribute` }, {
    ...
    'derived-type-component-procedure-specification': {
      ...
      patterns: [{ include: `#procedure-type` }, {
        begin: `(?=\\s*(,|::|\\())`,
        comment: `Attribute list.`,
        ...
        patterns: [{
          begin: `(,)`,
          beginCaptures: { 1: { name: `punctuation.comma.fortran` } },
          end: `(?=::|[,;!\\n])`,
          patterns: [
            { include: `#access-attribute` },
    ...
    'derived-type-component-type-specification': {
      begin:
        `(?ix)(?=\\b(?:character|class|complex|double\\s*precision|double\\s*complex|integer|logical|real|type)\\b(?![^:'";!\\n]*\\bfunction\\b))`,
      comment: `Introduced in the Fortran 1995 standard.`,
      end: `(?=[;!\\n])`,
      name: `meta.specification.derived-type.fortran`,
      patterns: [{ include: `#types` }, { include: `#line-continuation-operator` }, {
        begin: `(?=\\s*(,|::))`,
        comment: `Attribute list.`,
    ...
    'derived-type-contains-attribute-specification': {
      ...
      name: `meta.statement.attribute-specification.fortran`,
      patterns: [{ include: `#access-attribute` }, { include: `#invalid-character` }],
    },
    'derived-type-contains-final-procedure-specification': {
      begin: `(?i)\\b(final)\\b`,
      beginCaptures: { 1: { name: `storage.type.final-procedure.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
      end: `(?=[;!\\n])`,
    ...
    'derived-type-contains-generic-procedure-specification': {
      begin: `(?i)\\b(generic)\\b`,
      beginCaptures: { 1: { name: `storage.type.procedure.generic.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
      end: `(?=[;!\\n])`,
      ...
      patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{ include: `#access-attribute` }, { include: `#invalid-word` }],
        }],
      }, {
        begin: `(?=\\s*[a-z])`,
        comment: `Name list.`,
        ...
        patterns: [{ include: `#IO-keywords` }, { include: `#assignment-keyword` }, { include: `#operator-keyword` }, {
          include: `#procedure-name`,
    ...
    'derived-type-definition': {
      ...
      beginCaptures: { 1: { name: `keyword.control.type.fortran` } },
      end: `(?=[;!\\n])`,
      ...
      patterns: [{
        ...
        begin: `(?i)\\s*\\b([a-z]\\w*)\\b`,
        beginCaptures: { 1: { name: `entity.name.type.fortran` } },
        end: `(?i)(?:^|(?<=;))\\s*(end\\s*type)(?:\\s+(?:(\\1)|(\\w+)))?\\b`,
        endCaptures: {
          1: { name: `keyword.control.endtype.fortran` },
          2: { name: `entity.name.type.fortran` },
          3: { name: `invalid.error.derived-type.fortran` },
        },
        patterns: [{ include: `#dummy-variable-list` }, { include: `#comments` }, {
          ...
          beginCaptures: { 1: { name: `keyword.control.contains.fortran` } },
    ...
    'derived-type-operators': {
      captures: { 1: { name: `keyword.other.selector.fortran` } },
      comment: `Introduced in the Fortran 1995 standard.`,
      match: `\\s*(\\%)`,
    },
    'dimension-attribute': {
      begin: `(?i)\\s*\\b(dimension)(?=\\s*\\()`,
      beginCaptures: { 1: { name: `storage.modifier.dimension.fortran` } },
      comment: `Introduced in the Fortran 1977 standard.`,
      end: `(?<!\\G)`,
      patterns: [{ include: `#parentheses-dummy-variables` }],
    },
    'do-construct': {
      patterns: [{ captures: { 1: { name: `keyword.control.enddo.fortran` } }, match: `(?i)\\b(end\\s*do)\\b` }, {
        begin: `(?i)\\b(do)\\s+(\\d{1,5})`,
        beginCaptures: { 1: { name: `keyword.control.do.fortran` }, 2: { name: `constant.numeric.fortran` } },
        comment: `Introduced in the Fortran 1977 standard.`,
        end: `(?i)(?:^|(?<=;))(?=\\s*\\b\\2\\b)`,
        ...
        patterns: [{
          ...
          patterns: [{ include: `#concurrent-attribute` }, { include: `#while-attribute` }, { include: `$base` }],
        }, { include: `$base` }],
      }, {
        begin: `(?i)\\b(do)\\b`,
        beginCaptures: { 1: { name: `keyword.control.do.fortran` } },
        comment: `Introduced in the Fortran 1995 standard.`,
        end: `(?i)\\b(?:(continue)|(end\\s*do))\\b`,
        endCaptures: { 1: { name: `keyword.control.continue.fortran` }, 2: { name: `keyword.control.enddo.fortran` } },
    ...
    'dummy-variable': {
      captures: { 1: { name: `variable.parameter.fortran` } },
      comment: `dummy variable`,
      match: `(?i)(?:^|(?<=[&,\\(]))\\s*([a-z]\\w*)`,
    },
    'dummy-variable-list': {
      begin: `\\G\\s*(\\()`,
      beginCaptures: { 1: { name: `punctuation.definition.parameters.begin.fortran` } },
      end: `\\)|(?=\\n)`,
      endCaptures: { 0: { name: `punctuation.definition.parameters.end.fortran` } },
      name: `meta.dummy-variable-list`,
      patterns: [{ include: `#dummy-variable` }],
    },
    'elemental-attribute': {
      captures: { 1: { name: `storage.modifier.elemental.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
    ...
    'entry-statement': {
      patterns: [{
        begin: `(?i)\\s*\\b(entry)\\b`,
        beginCaptures: { 1: { name: `keyword.control.entry.fortran` } },
        comment: `Introduced in the Fortran 1977 standard.`,
        end: `(?=[;!\\n])`,
        name: `meta.statement.control.entry.fortran`,
        patterns: [{
          begin: `(?i)\\s*\\b([a-z]\\w*)\\b`,
          beginCaptures: { 1: { name: `entity.name.function.entry.fortran` } },
          end: `(?=[;!\\n])`,
          patterns: [{ include: `#dummy-variable-list` }, { include: `#result-statement` }, {
            include: `#language-binding-attribute`,
          }],
        }],
      }],
    ...
    'enum-block-construct': {
      begin: `(?i)\\b(enum)\\b`,
      beginCaptures: { 1: { name: `keyword.control.enum.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
      end: `(?i)\\b(end\\s*enum)\\b`,
      endCaptures: { 1: { name: `keyword.control.end-enum.fortran` } },
      name: `meta.enum.fortran`,
      patterns: [{
        begin: `\\G\\s*(,)`,
        beginCaptures: { 1: { name: `punctuation.comma.fortran` } },
        end: `(?=[;!\\n])`,
        patterns: [{ include: `#language-binding-attribute` }, { include: `#invalid-word` }],
      }, {
        ...
        patterns: [{ include: `#comments` }, {
          ...
          beginCaptures: { 1: { name: `keyword.other.enumerator.fortran` } },
          end: `(?=[;!\\n])`,
    ...
    'equivalence-statement': {
      ...
      patterns: [{
        begin: `(?:\\G|(,))`,
        beginCaptures: { 1: { name: `puntuation.comma.fortran` } },
        end: `(?=[,;!\\n])`,
        patterns: [{ include: `#parentheses-dummy-variables` }],
      }],
    },
    'error-stop-statement': {
      ...
      beginCaptures: { 1: { name: `keyword.control.errorstop.fortran` } },
      comment: `Introduced in the Fortran 2008 standard.`,
      end: `(?=[;!\\n])`,
      name: `meta.statement.control.errorstop.fortran`,
      patterns: [{ include: `#constants` }, { include: `#string-operators` }, { include: `#variable` }, {
        include: `#invalid-character`,
      }],
    },
    'event-statement': {
      ...
      beginCaptures: {
        1: { name: `keyword.control.event.fortran` },
        2: { name: `punctuation.parentheses.left.fortran` },
      },
    ...
    'execution-statements': {
      patterns: [{ include: `#allocate-statement` }, { include: `#deallocate-statement` }, {
        include: `#IO-statements`,
      }, { include: `#nullify-statement` }],
    },
    'exit-statement': {
      begin: `(?i)\\s*\\b(exit)\\b`,
      beginCaptures: { 1: { name: `keyword.control.exit.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
      end: `(?=[;!\\n])`,
    ...
    'explicit-interface-block-construct': {
      ...
      beginCaptures: { 1: { name: `keyword.control.interface.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
      end: `(?i)\\b(end\\s*interface)\\b`,
      endCaptures: { 1: { name: `keyword.control.endinterface.fortran.modern` } },
    ...
    'extends-attribute': {
      ...
      beginCaptures: { 1: { name: `storage.modifier.extends.fortran` } },
      end: `(?:\\)|(?=\\n))`,
      patterns: [{ match: `(?i)\\s*\\b([a-z]\\w*)\\b`, name: `entity.name.type.fortran` }],
    },
    'external-attribute': {
      captures: { 1: { name: `storage.modifier.external.fortran` } },
      comment: `Introduced in the Fortran 1977 standard.`,
      match: `(?i)\\s*\\b(external)\\b`,
    },
    'fail-image-statement': {
      captures: { 1: { name: `keyword.control.fail-image.fortran` } },
      comment: `Introduced in the Fortran 2018 standard.`,
    ...
    'forall-construct': {
      ...
      begin: `(?i)\\b(forall)\\b`,
      beginCaptures: { 1: { name: `keyword.control.forall.fortran` } },
      comment: `Introduced in the Fortran 1995 standard.`,
      end: `(?<!\\G)`,
      patterns: [{
        begin: `(?i)\\G(?!\\s*[;!\\n])`,
        ...
        endCaptures: { 1: { name: `keyword.control.endforall.fortran` } },
    ...
    'form-team-statement': {
      ...
      beginCaptures: {
        1: { name: `keyword.control.form-team.fortran` },
        2: { name: `punctuation.parentheses.left.fortran` },
      },
      comment: `Introduced in the Fortran 2018 standard.`,
      end: `(?<!\\G)`,
    ...
    'function-definition': {
      ...
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.other.function.fortran` } },
        comment: `Captures the function keyword`,
        end: `(?=[;!\\n])`,
        patterns: [{
          begin: `(?i)\\G\\s*\\b([a-z]\\w*)\\b`,
          beginCaptures: { 1: { name: `entity.name.function.fortran` } },
          ...
          endCaptures: {
            ...
            4: { name: `invalid.error.function.fortran` },
          },
          patterns: [{
            begin: `\\G(?!\\s*[;!\\n])`,
    ...
    'generic-interface-block-construct': {
      ...
      patterns: [{
        ...
        beginCaptures: {
          ...
          4: { name: `invalid.error.generic-interface.fortran` },
        ...
        endCaptures: {
          ...
          5: { name: `invalid.error.generic-interface-end.fortran` },
          6: { name: `punctuation.parentheses.right.fortran` },
        },
        patterns: [{ include: `#interface-procedure-statement` }, { include: `$base` }],
      }, {
        begin:
          `(?ix)\\G\\s*\\b(operator)\\s* (\\()\\s*(?: (\\.[a-z]+\\.|\\=\\=|\\/\\=|\\>\\=|\\>|\\<|\\<\\=|\\-|\\+|\\/|\\/\\/|\\*\\*|\\*) |(\\S.*) )\\s*(\\))`,
        beginCaptures: {
          1: { name: `keyword.other.operator.fortran` },
          2: { name: `punctuation.parentheses.left.fortran` },
          3: { name: `keyword.operator.fortran` },
          4: { name: `invalid.error.generic-interface-block-op.fortran` },
          5: { name: `punctuation.parentheses.right.fortran` },
        },
        ...
        endCaptures: {
          ...
          5: { name: `invalid.error.generic-interface-block-op-end.fortran` },
          6: { name: `punctuation.parentheses.right.fortran` },
        },
        patterns: [{ include: `#interface-procedure-statement` }, { include: `$base` }],
      }, {
        ...
        beginCaptures: {
          ...
          6: { name: `invalid.error.generic-interface-block.fortran` },
          7: { name: `punctuation.parentheses.right.fortran` },
        },
        comment: `Read/Write generic interface.`,
        end:
          `(?ix)\\b(end\\s*interface)\\b(?:\\s*\\b(?:(\\2)|(\\3))\\b\\s* (\\()\\s*(?:(\\4)|(\\5)|(\\S.*))\\s*(\\)))?`,
        endCaptures: {
          1: { name: `keyword.control.endinterface.fortran` },
          ...
          7: { name: `invalid.error.generic-interface-block-end.fortran` },
    ...
    'goto-statement': {
      ...
      beginCaptures: { 1: { name: `keyword.control.goto.fortran` } },
      comment: `Introduced in the Fortran 1977 standard.`,
      end: `(?=[;!\\n])`,
    ...
    'if-construct': {
      patterns: [{
        begin: `(?i)\\b(if)\\b`,
        beginCaptures: { 1: { name: `keyword.control.if.fortran` } },
        end: `(?=[;!\\n])`,
        patterns: [{ include: `#logical-control-expression` }, {
          begin: `(?i)\\s*\\b(then)\\b`,
          beginCaptures: { 1: { name: `keyword.control.then.fortran` } },
          contentName: `meta.block.if.fortran`,
          end: `(?i)\\b(end\\s*if)\\b`,
          endCaptures: { 1: { name: `keyword.control.endif.fortran` } },
          patterns: [{
            begin: `(?i)\\b(else\\s*if)\\b`,
            beginCaptures: { 1: { name: `keyword.control.elseif.fortran` } },
            comment: `else if statement`,
            end: `(?=[;!\\n])`,
            patterns: [{ include: `#parentheses` }, {
              captures: { 1: { name: `keyword.control.then.fortran` }, 2: { name: `meta.label.elseif.fortran` } },
              comment: `capture the label if present`,
              match: `(?i)\\b(then)\\b(\\s*[a-z]\\w*)?`,
            }, { include: `#invalid-word` }],
          }, {
            begin: `(?i)\\b(else)\\b`,
            beginCaptures: { 1: { name: `keyword.control.else.fortran` } },
            comment: `else block`,
            end: `(?i)(?=\\b(end\\s*if)\\b)`,
            patterns: [{
              begin: `(?!(\\s*(;|!|\\n)))`,
              ...
              patterns: [{
                captures: { 1: { name: `meta.label.else.fortran` }, 2: { name: `invalid.error.label.else.fortran` } },
                comment: `capture the label if present`,
    ...
    'image-control-statement': {
      patterns: [{ include: `#sync-all-statement` }, { include: `#sync-statement` }, { include: `#event-statement` }, {
        include: `#form-team-statement`,
      }, { include: `#fail-image-statement` }],
    },
    'implicit-statement': {
      begin: `(?i)\\b(implicit)\\b`,
      beginCaptures: { 1: { name: `keyword.other.implicit.fortran` } },
      end: `(?=[;!\\n])`,
      name: `meta.statement.implicit.fortran`,
      patterns: [{ captures: { 1: { name: `keyword.other.none.fortran` } }, match: `(?i)\\s*\\b(none)\\b` }, {
        include: `$base`,
      }],
    },
    'import-statement': {
      begin: `(?i)\\b(import)\\b`,
      beginCaptures: { 1: { name: `keyword.control.include.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
      end: `(?=[;!\\n])`,
      name: `meta.statement.include.fortran`,
      patterns: [{
        begin: `(?i)\\G\\s*(?:(::)|(?=[a-z]))`,
        beginCaptures: { 1: { name: `keyword.operator.double-colon.fortran` } },
        end: `(?=[;!\\n])`,
        patterns: [{ include: `#name-list` }],
      }, {
        begin: `\\G\\s*(,)`,
        beginCaptures: { 1: { name: `punctuation.comma.fortran` } },
        end: `(?=[;!\\n])`,
        patterns: [{ captures: { 1: { name: `keyword.other.all.fortran` } }, match: `(?i)\\G\\s*\\b(all)\\b` }, {
          captures: { 1: { name: `keyword.other.none.fortran` } },
          match: `(?i)\\G\\s*\\b(none)\\b`,
        }, {
          begin: `(?i)\\G\\s*\\b(only)\\s*(:)`,
          beginCaptures: { 1: { name: `keyword.other.only.fortran` }, 2: { name: `keyword.other.colon.fortran` } },
          end: `(?=[;!\\n])`,
          patterns: [{ include: `#name-list` }],
        }, { include: `#invalid-word` }],
      }],
    ...
    'include-statement': {
      ...
      name: `meta.statement.include.fortran`,
      patterns: [{ include: `#string-constant` }, { include: `#invalid-character` }],
    },
    'intent-attribute': {
      ...
      endCaptures: { 1: { name: `punctuation.parentheses.left.fortran` } },
      patterns: [{
        captures: {
    ...
    'interface-procedure-statement': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#module-attribute` }, { include: `#invalid-word` }],
      }, {
        begin: `(?i)\\s*\\b(procedure)\\b`,
        beginCaptures: { 1: { name: `keyword.other.procedure.fortran` } },
        comment: `Procedure statement.`,
        end: `(?=[;!\\n])`,
        patterns: [{ captures: { 1: { name: `keyword.operator.double-colon.fortran` } }, match: `\\G\\s*(::)` }, {
          include: `#procedure-name-list`,
        }],
      }],
    },
    'intrinsic-attribute': {
      captures: { 1: { name: `storage.modifier.intrinsic.fortran` } },
      comment: `Introduced in the Fortran 1977 standard.`,
    ...
    'intrinsic-functions': {
      patterns: [{
        begin:
          `(?ix)\\b(acosh|asinh|atanh|bge|bgt|ble|blt|dshiftl|dshiftr| findloc|hypot|iall|iany|image_index|iparity|is_contiguous|lcobound| leadz|mask[lr]|merge_bits|norm2|num_images|parity|popcnt|poppar| shift[alr]|storage_size|this_image|trailz|ucobound)\\s*(?=\\()`,
        beginCaptures: {
        ...
        comment:
          `Functions accessable through the intrinsic FORTRAN_SPECIAL_FUNCTIONS module. Introduced in the Fortran 2008 standard.`,
        end: `(?<!\\G)`,
        endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
        patterns: [{ include: `#parentheses-dummy-variables` }],
      }, {
        begin:
          `(?ix)\\b(command_argument_count|extends_type_of|is_iostat_end| is_iostat_eor|new_line|same_type_as|selected_char_kind)\\s*(?=\\()`,
        beginCaptures: {
          1: { name: `support.function.intrinsic.fortran` },
          2: { name: `punctuation.parentheses.left.fortran` },
        },
        ...
        begin:
          `(?ix)\\b(ieee_( class|copy_sign|is_(finite|nan|negative|normal)|logb|next_after|rem| rint|scalb|selected_real_kind| support_(datatype|denormal|divide|inf|io|nan|rounding|sqrt|standard|underflow_control)| unordered|value))\\s*(?=\\()`,
        beginCaptures: {
          1: { name: `support.function.intrinsic.fortran` },
          2: { name: `punctuation.parentheses.left.fortran` },
        },
        comment:
          `Functions accessable through the intrinsic IEEE_ARITHMETIC module. Introduced in the Fortran 2003 standard.`,
        end: `(?<!\\G)`,
        endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
        patterns: [{ include: `#parentheses-dummy-variables` }],
      }, {
        ...
        comment:
          `Functions accessable through the intrinsic IEEE_EXCEPTIONS module. Introduced in the Fortran 2003 standard.`,
        end: `(?<!\\G)`,
        endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
        patterns: [{ include: `#parentheses-dummy-variables` }],
      }, {
        begin: `(?ix)\\b(c_(associated|funloc|loc|sizeof))\\s*(?=\\()`,
        beginCaptures: { 1: { name: `support.function.intrinsic.fortran` } },
        comment:
          `Functions accessable through the intrinsic ISO_C_BINDING module. Introduced in the Fortran 2003 standard.`,
        end: `(?<!\\G)`,
        endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
        patterns: [{ include: `#parentheses-dummy-variables` }],
      }, {
        ...
        comment:
          `Functions accessable through the intrinsic ISO_FORTRAN_ENV module. Introduced in the Fortran 2003 standard.`,
        end: `(?<!\\G)`,
        endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
        patterns: [{ include: `#parentheses-dummy-variables` }],
      }, {
        ...
        begin:
          `(?ix)\\b(achar|adjustl|adjustr|all|allocated|associated|any|bit_size|btest|ceiling|count|cshift|digits|dot_product|eoshift|epsilon|exponent|floor|fraction|huge|iachar|iand|ibclr|ibits|ibset|ieor|ior|ishftc?| kind|lbound|len_trim|logical|matmul|maxexponent|maxloc|maxval|merge|minexponent|minloc|minval|modulo|nearest|not|pack|precision|present|product|radix|range|repeat|reshape|rrspacing|scale|scan|selected_(int|real)_kind|set_exponent|shape|size|spacing|spread|sum|tiny|transfer|transpose|trim|ubound|unpack|verify)\\s*(?=\\()`,
        beginCaptures: {
          1: { name: `support.function.intrinsic.fortran` },
          2: { name: `punctuation.parentheses.left.fortran` },
        },
        ...
        begin:
          `(?ix)\\b([icd]?abs|acos|[ad]int|[ad]nint|aimag|amax[01]| amin[01]|d?asin|d?atan|d?atan2|char|conjg|[cd]?cos|d?cosh|cmplx|dble| i?dim|dmax1|dmin1|dprod|[cd]?exp|float|ichar|idint|ifix|index|int|len| lge|lgt|lle|llt|[acd]?log|[ad]?log10|max[01]?|min[01]?|[ad]?mod| (id)?nint|real|[di]?sign|[cd]?sin|d?sinh|sngl|[cd]?sqrt|d?tan|d?tanh) \\s*(?=\\()`,
        beginCaptures: {
          1: { name: `support.function.intrinsic.fortran` },
          2: { name: `punctuation.parentheses.left.fortran` },
        },
    ...
    'intrinsic-subroutines': {
      patterns: [{
        ...
        comment:
          `Subroutines accessable through the intrinsic IEEE_ARITHMETIC module. Introduced in the Fortran 2003 standard.`,
        end: `(?<!\\G)`,
        endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
        patterns: [{ include: `#parentheses-dummy-variables` }],
      }, {
        ...
        comment:
          `Subroutines accessable through the intrinsic IEEE_EXCEPTIONS module. Introduced in the Fortran 2003 standard.`,
        end: `(?<!\\G)`,
        endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
        patterns: [{ include: `#parentheses-dummy-variables` }],
      }, {
        ...
        comment:
          `Subroutines accessable through the intrinsic ISO_C_BINDING module. Introduced in the Fortran 2003 standard.`,
        end: `(?<!\\G)`,
        endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
        patterns: [{ include: `#parentheses-dummy-variables` }],
      }, {
        begin:
          `(?ix)\\G\\s*\\b(execute_command_line|get_command| get_command_argument|get_environment_variable|move_alloc)\\s*(?=\\()`,
        beginCaptures: {
          1: { name: `entity.name.function.subroutine.fortran` },
          2: { name: `punctuation.parentheses.left.fortran` },
        },
    ...
    'invalid-character': { match: `(?i)[^\\s;!\\n]+`, name: `invalid.error.character.fortran` },
    'invalid-word': { match: `(?i)\\b\\w+\\b`, name: `invalid.error.word.fortran` },
    'language-binding-attribute': {
      begin: `(?i)\\s*\\b(bind)\\s*\\(`,
      beginCaptures: { 1: { name: `storage.modifier.bind.fortran` } },
      comment: `Introduced in Fortran 2003 standard.`,
      end: `(?:\\)|(?=\\n))`,
      patterns: [{ match: `(?i)\\b(c)\\b`, name: `variable.parameter.fortran` }, { include: `#dummy-variable` }, {
        include: `$base`,
      }],
    },
    'line-continuation-operator': {
      ...
      patterns: [{
        captures: { 1: { name: `keyword.operator.line-continuation.fortran` } },
        match: `(?:^|(?<=;))\\s*(&)`,
      }, {
        begin: `\\s*(&)`,
        beginCaptures: { 1: { name: `keyword.operator.line-continuation.fortran` } },
        contentName: `meta.line-continuation.fortran`,
        end: `(?i)^(?:\\s*(&))?`,
        endCaptures: { 1: { name: `keyword.operator.line-continuation.fortran` } },
        patterns: [{ include: `#comments` }, { match: `\\S[^!]*`, name: `invalid.error.line-cont.fortran` }],
      }],
    },
    'logical-constant': {
      captures: {
    ...
    'module-attribute': {
      captures: { 1: { name: `storage.modifier.module.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
    ...
    'module-definition': {
      ...
      patterns: [{ captures: { 1: { name: `keyword.other.program.fortran` } }, match: `(?i)\\G\\s*\\b(module)\\b` }, {
        applyEndPatternLast: 1,
        begin: `(?i)\\s*\\b([a-z]\\w*)\\b`,
        beginCaptures: { 1: { name: `entity.name.class.module.fortran` } },
        comment: `Module body.`,
        end: `(?ix)\\b(?:(end\\s*module)(?:\\s+([a-z_]\\w*))?|(end))\\b \\s*([^;!\\n]+)?(?=[;!\\n])`,
        endCaptures: {
          1: { name: `keyword.other.endmodule.fortran` },
          2: { name: `entity.name.class.module.fortran` },
          3: { name: `keyword.other.endmodule.fortran` },
          4: { name: `invalid.error.module-definition.fortran` },
        },
        patterns: [{
          begin: `\\G`,
    ...
    'named-control-constructs': {
      applyEndPatternLast: 1,
      begin:
        `(?ix)([a-z]\\w*)\\s*(:)(?=\\s*(?:associate|block(?!\\s*data)|critical|do|forall|if|select\\s*case|select\\s*type|select\\s*rank|where)\\b)`,
      comment: `Introduced in the Fortran 1990 standard.`,
      contentName: `meta.named-construct.fortran.modern`,
      end:
        `(?i)(?!\\s*\\b(?:associate|block(?!\\s*data)|critical|do|forall|if|select\\s*case|select\\s*type|select\\s*rank|where)\\b)(?:\\b(\\1)\\b)?([^\\s;!\\n]*?)?(?=\\s*[;!\\n])`,
      endCaptures: {
        1: { name: `meta.label.end.name.fortran` },
        2: { name: `invalid.error.named-control-constructs.fortran.modern` },
      },
      patterns: [{ include: `#unnamed-control-constructs` }],
    },
    'namelist-statement': {
      begin: `(?i)\\b(namelist)\\b`,
      beginCaptures: { 1: { name: `keyword.control.namelist.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
      end: `(?=[;!\\n])`,
      patterns: [{ include: `$base` }],
    },
    'non-intrinsic-attribute': {
      captures: { 1: { name: `storage.modifier.non-intrinsic.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
      match: `(?i)\\s*\\b(non_intrinsic)\\b`,
    },
    'non-overridable-attribute': {
      captures: { 1: { name: `storage.modifier.non-overridable.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
      match: `(?i)\\s*\\b(non_overridable)\\b`,
    },
    'nopass-attribute': {
      captures: { 1: { name: `storage.modifier.nopass.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
    ...
    'numeric-type': {
      ...
      patterns: [{
        ...
        beginCaptures: {
          ...
          3: { name: `storage.type.doublecomplex.fortran` },
          4: { name: `storage.type.integer.fortran` },
          5: { name: `storage.type.real.fortran` },
          6: { name: `punctuation.parentheses.left.fortran` },
        },
        contentName: `meta.type-spec.fortran`,
        end: `(?<!\\G)`,
        endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
        ...
        captures: {
          ...
          4: { name: `storage.type.integer.fortran` },
          5: { name: `storage.type.real.fortran` },
          6: { name: `storage.type.dimension.fortran` },
          7: { name: `keyword.operator.multiplication.fortran` },
          8: { name: `constant.numeric.fortran` },
        },
        match:
          `(?ix)\\b(?:(complex)|(double\\s*precision)|(double\\s*complex)|(integer)|(real)|(dimension))\\b(?:\\s*(\\*)\\s*(\\d*))?`,
      }],
    },
    'operator-keyword': {
      ...
      endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
      patterns: [{ include: `#arithmetic-operators` }, { include: `#logical-operators` }, {
    ...
    'optional-attribute': {
      captures: { 1: { name: `storage.modifier.optional.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
      match: `(?i)\\s*\\b(optional)\\b`,
    },
    'parameter-attribute': {
      captures: { 1: { name: `storage.modifier.parameter.fortran` } },
      comment: `Introduced in the Fortran 1977 standard.`,
      match: `(?i)\\s*\\b(parameter)\\b`,
    },
    parentheses: {
      begin: `\\s*(\\()`,
      beginCaptures: { 1: { name: `punctuation.parentheses.left.fortran` } },
      end: `(\\))`,
      endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
      patterns: [
        { include: `#comments` },
    ...
    'pass-attribute': {
      ...
      patterns: [{
        begin: `(?i)\\s*\\b(pass)\\s*\\(`,
        beginCaptures: { 1: { name: `storage.modifier.pass.fortran` } },
        comment: `Pass attribute with argument.`,
        end: `\\)|(?=\\n)`,
        patterns: [],
      }, {
        captures: { 1: { name: `storage.modifier.pass.fortran` } },
    ...
    'pause-statement': {
      begin: `(?i)\\s*\\b(pause)\\b`,
      beginCaptures: { 1: { name: `keyword.control.pause.fortran` } },
      comment: `Introduced in the Fortran 1977 standard.`,
      end: `(?=[;!\\n])`,
      name: `meta.statement.control.pause.fortran`,
      patterns: [{ include: `#constants` }, { include: `#invalid-character` }],
    },
    'pointer-attribute': {
      captures: { 1: { name: `storage.modifier.pointer.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
    ...
    preprocessor: {
      begin: `^\\s*(#:?)`,
      beginCaptures: { 1: { name: `keyword.control.preprocessor.indicator.fortran` } },
      end: `\\n`,
      name: `meta.preprocessor`,
      patterns: [{ include: `#preprocessor-if-construct` }, { include: `#preprocessor-statements` }],
    },
    'preprocessor-arithmetic-operators': {
      captures: {
        ...
        2: { name: `keyword.operator.addition.fortran` },
        3: { name: `keyword.operator.division.fortran` },
        4: { name: `keyword.operator.multiplication.fortran` },
      },
    ...
    'preprocessor-comments': { begin: `/\\*`, end: `\\*/`, name: `comment.preprocessor` },
    'preprocessor-constants': {
      patterns: [{ include: `#cpp-numeric-constant` }, { include: `#preprocessor-string-constant` }],
    },
    'preprocessor-define-statement': {
      begin: `(?i)\\G\\s*\\b(define)\\b`,
      beginCaptures: { 1: { name: `keyword.control.preprocessor.define.fortran` } },
      end: `(?=\\n)`,
      name: `meta.preprocessor.macro.fortran`,
      patterns: [{ include: `#preprocessor-comments` }, { include: `#preprocessor-constants` }, {
        include: `#preprocessor-line-continuation-operator`,
      }],
    },
    'preprocessor-defined-function': {
      captures: { 1: { name: `keyword.control.preprocessor.defined.fortran` } },
      match: `(?i)\\b(defined)\\b`,
    },
    'preprocessor-error-statement': {
      begin: `(?i)\\G\\s*(error)\\b`,
      beginCaptures: { 1: { name: `keyword.control.preprocessor.error.fortran` } },
      end: `(?=\\n)`,
      name: `meta.preprocessor.macro.fortran`,
      patterns: [{ include: `#preprocessor-comments` }, { include: `#preprocessor-string-constant` }, {
        include: `#preprocessor-line-continuation-operator`,
      }],
    },
    'preprocessor-if-construct': {
      patterns: [{
        begin: `(?i)\\G\\s*\\b(if)\\b`,
        beginCaptures: { 1: { name: `keyword.control.preprocessor.if.fortran` } },
        end: `(?=\\n)`,
        ...
        beginCaptures: { 1: { name: `keyword.control.preprocessor.ifdef.fortran` } },
        end: `(?=\\n)`,
        patterns: [
          { include: `#preprocessor-comments` },
          { include: `#cpp-numeric-constant` },
        ...
        beginCaptures: { 1: { name: `keyword.control.preprocessor.ifndef.fortran` } },
        end: `(?=\\n)`,
        patterns: [
          { include: `#preprocessor-comments` },
          { include: `#cpp-numeric-constant` },
        ...
        beginCaptures: { 1: { name: `keyword.control.preprocessor.else.fortran` } },
        end: `(?=\\n)`,
        patterns: [{ include: `#preprocessor-comments` }, { include: `#cpp-numeric-constant` }],
      }, {
        begin: `(?i)\\G\\s*\\b(elif)\\b`,
        beginCaptures: { 1: { name: `keyword.control.preprocessor.elif.fortran` } },
        end: `(?=\\n)`,
        patterns: [
          { include: `#preprocessor-comments` },
          { include: `#cpp-numeric-constant` },
        ...
        beginCaptures: { 1: { name: `keyword.control.preprocessor.endif.fortran` } },
        end: `(?=\\n)`,
        patterns: [{ include: `#preprocessor-comments` }],
      }],
    },
    'preprocessor-include-statement': {
      begin: `(?i)\\G\\s*(include)\\b`,
      beginCaptures: { 1: { name: `keyword.control.preprocessor.include.fortran` } },
      end: `(?=\\n)`,
      name: `meta.preprocessor.include.fortran`,
      patterns: [{ include: `#preprocessor-comments` }, { include: `#preprocessor-string-constant` }, {
        begin: `<`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.preprocessor.fortran` } },
        end: `>`,
        endCaptures: { 0: { name: `punctuation.definition.string.end.preprocessor.fortran` } },
    ...
    'preprocessor-line-continuation-operator': {
      begin: `\\s*(\\\\)`,
      beginCaptures: { 1: { name: `constant.character.escape.line-continuation.preprocessor.fortran` } },
      end: `(?i)^`,
    },
    'preprocessor-logical-operators': {
      captures: {
        1: { name: `keyword.operator.logical.preprocessor.and.fortran` },
        2: { name: `keyword.operator.logical.preprocessor.equals.fortran` },
        3: { name: `keyword.operator.logical.preprocessor.not_equals.fortran` },
        4: { name: `keyword.operator.logical.preprocessor.or.fortran` },
        5: { name: `keyword.operator.logical.preprocessor.less_eq.fortran` },
        6: { name: `keyword.operator.logical.preprocessor.more_eq.fortran` },
        7: { name: `keyword.operator.logical.preprocessor.less.fortran` },
        8: { name: `keyword.operator.logical.preprocessor.more.fortran` },
        9: { name: `keyword.operator.logical.preprocessor.complementary.fortran` },
        10: { name: `keyword.operator.logical.preprocessor.xor.fortran` },
        11: { name: `keyword.operator.logical.preprocessor.bitand.fortran` },
        12: { name: `keyword.operator.logical.preprocessor.not.fortran` },
        13: { name: `keyword.operator.logical.preprocessor.bitor.fortran` },
      },
    ...
    'preprocessor-operators': {
      patterns: [{ include: `#preprocessor-line-continuation-operator` }, {
        include: `#preprocessor-logical-operators`,
      }, { include: `#preprocessor-arithmetic-operators` }],
    },
    'preprocessor-pragma-statement': {
      begin: `(?i)\\G\\s*\\b(pragma)\\b`,
      beginCaptures: { 1: { name: `keyword.control.preprocessor.pragma.fortran` } },
      end: `(?=\\n)`,
    ...
    'preprocessor-undefine-statement': {
      ...
      beginCaptures: { 1: { name: `keyword.control.preprocessor.undef.fortran` } },
      end: `(?=\\n)`,
      name: `meta.preprocessor.undef.fortran`,
      patterns: [{ include: `#preprocessor-comments` }, { include: `#preprocessor-line-continuation-operator` }],
    },
    'private-attribute': {
      captures: { 1: { name: `storage.modifier.private.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
    ...
    'procedure-definition': {
      ...
      patterns: [{
        ...
        patterns: [{
          begin: `(?i)\\G\\s*\\b([a-z]\\w*)\\b`,
          beginCaptures: { 1: { name: `entity.name.function.procedure.fortran` } },
          ...
          endCaptures: {
            ...
            4: { name: `invalid.error.procedure-definition.fortran` },
          },
          patterns: [{
            begin: `\\G(?!\\s*[;!\\n])`,
    ...
    'procedure-name': {
      captures: { 1: { name: `entity.name.function.procedure.fortran` } },
    ...
    'procedure-name-list': {
      ...
      patterns: [{
        ...
        endCaptures: { 1: { name: `punctuation.comma.fortran` } },
        patterns: [{ include: `#procedure-name` }, { include: `#pointer-operators` }],
      }],
    },
    ...
    'procedure-type': {
      ...
      patterns: [{
        ...
        endCaptures: { 1: { name: `punctuation.parentheses.right.fortran` } },
        patterns: [{ include: `#types` }, { include: `#procedure-name` }],
      }, { captures: { 1: { name: `storage.type.procedure.fortran` } }, match: `(?i)\\b(procedure)\\b` }],
    },
    'program-definition': {
      begin: `(?i)(?=\\b(program)\\b)`,
      comment: `Introduced in the Fortran 1977 standard.`,
      ...
      patterns: [
        { captures: { 1: { name: `keyword.control.program.fortran` } }, match: `(?i)\\G\\s*\\b(program)\\b` },
        {
          applyEndPatternLast: 1,
          begin: `(?i)\\s*\\b([a-z]\\w*)\\b`,
          beginCaptures: { 1: { name: `entity.name.program.fortran` } },
          comment: `Program body.`,
          end: `(?ix)\\b(?:(end\\s*program)(?:\\s+([a-z_]\\w*))?|(end))\\b\\s*([^;!\\n]+)?(?=[;!\\n])`,
          endCaptures: {
            1: { name: `keyword.control.endprogram.fortran` },
            2: { name: `entity.name.program.fortran` },
            3: { name: `keyword.control.endprogram.fortran` },
            4: { name: `invalid.error.program-definition.fortran` },
          },
          patterns: [{
            begin: `\\G`,
    ...
    'protected-attribute': {
      captures: { 1: { name: `storage.modifier.protected.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
      match: `(?i)\\s*\\b(protected)\\b`,
    },
    'public-attribute': {
      captures: { 1: { name: `storage.modifier.public.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
      match: `(?i)\\s*\\b(public)\\b`,
    },
    'pure-attribute': {
      captures: { 1: { name: `storage.modifier.impure.fortran` }, 2: { name: `storage.modifier.pure.fortran` } },
      comment: `Introduced in the Fortran 1995 standard.`,
    ...
    'return-statement': {
      ...
      beginCaptures: { 1: { name: `keyword.control.return.fortran` } },
      comment: `Introduced in the Fortran 1977 standard.`,
      end: `(?=[;!\\n])`,
    ...
    'save-attribute': {
      captures: { 1: { name: `storage.modifier.save.fortran` } },
      comment: `Introduced in the Fortran 1977 standard.`,
      match: `(?i)\\s*\\b(save)\\b`,
    },
    'select-case-construct': {
      begin: `(?i)\\b(select\\s*case)\\b`,
      beginCaptures: { 1: { name: `keyword.control.selectcase.fortran` } },
      comment: `Select case construct. Introduced in the Fortran 1990 standard.`,
      end: `(?i)\\b(end\\s*select)\\b`,
      endCaptures: { 1: { name: `keyword.control.endselect.fortran` } },
      name: `meta.block.select.case.fortran`,
      patterns: [{ include: `#parentheses` }, {
        begin: `(?i)\\b(case)\\b`,
        beginCaptures: { 1: { name: `keyword.control.case.fortran` } },
        end: `(?i)(?=[;!\\n])`,
        patterns: [
          { captures: { 1: { name: `keyword.control.default.fortran` } }, match: `(?i)\\G\\s*\\b(default)\\b` },
          { include: `#parentheses` },
          { include: `#invalid-word` },
        ],
      }, { include: `$base` }],
    ...
    'select-rank-construct': {
      ...
      beginCaptures: { 1: { name: `keyword.control.selectrank.fortran` } },
      ...
      patterns: [{ include: `#parentheses` }, {
        begin: `(?i)\\b(rank)\\b`,
        beginCaptures: { 1: { name: `keyword.control.rank.fortran` } },
        end: `(?i)(?=[;!\\n])`,
        patterns: [
          { captures: { 1: { name: `keyword.control.default.fortran` } }, match: `(?i)\\G\\s*\\b(default)\\b` },
          { include: `#parentheses` },
    ...
    'select-type-construct': {
      ...
      beginCaptures: { 1: { name: `keyword.control.selecttype.fortran` } },
      ...
      patterns: [{ include: `#parentheses` }, {
        ...
        beginCaptures: { 1: { name: `keyword.control.class.fortran` }, 2: { name: `keyword.control.type.fortran` } },
        end: `(?i)(?=[;!\\n])`,
        patterns: [
          { captures: { 1: { name: `keyword.control.default.fortran` } }, match: `(?i)\\G\\s*\\b(default)\\b` },
          { captures: { 1: { name: `keyword.control.is.fortran` } }, match: `(?i)\\G\\s*\\b(is)\\b` },
          { include: `#parentheses` },
          { include: `#invalid-word` },
        ],
      }, { include: `$base` }],
    ...
    'sequence-attribute': {
      captures: { 1: { name: `storage.modifier.sequence.fortran` } },
    ...
    'stop-statement': {
      ...
      beginCaptures: { 1: { name: `keyword.control.stop.fortran` }, 2: { name: `meta.label.stop.stop` } },
      comment: `Introduced in the Fortran 1977 standard.`,
      end: `(?=[;!\\n])`,
      name: `meta.statement.control.stop.fortran`,
      patterns: [{ include: `#constants` }, { include: `#string-operators` }, { include: `#invalid-character` }],
    },
    'string-constant': {
      comment: `Introduced in the Fortran 1977 standard.`,
      patterns: [{
        ...
        patterns: [{ match: `''`, name: `constant.character.escape.apostrophe.fortran` }],
      }, {
        applyEndPatternLast: 1,
        begin: `"`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.fortran` } },
    ...
    'string-line-continuation-operator': {
      ...
      endCaptures: { 1: { name: `keyword.operator.line-continuation.fortran` } },
      patterns: [{ include: `#comments` }, { match: `\\S.*`, name: `invalid.error.string-line-cont.fortran` }],
    },
    'string-operators': {
    ...
    'submodule-definition': {
      ...
      patterns: [{
        ...
        beginCaptures: {
          ...
          2: { name: `punctuation.parentheses.left.fortran` },
          3: { name: `entity.name.class.submodule.fortran` },
        },
        end: `(\\))`,
        endCaptures: { 1: { name: `punctuation.parentheses.left.fortran` } },
        patterns: [],
        ...
        applyEndPatternLast: 1,
        begin: `(?i)\\s*\\b([a-z]\\w*)\\b`,
        beginCaptures: { 1: { name: `entity.name.module.submodule.fortran` } },
        ...
        endCaptures: {
          ...
          4: { name: `invalid.error.submodule.fortran` },
        },
        patterns: [{
          begin: `\\G`,
    ...
    'subroutine-definition': {
      ...
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.other.subroutine.fortran` } },
        end: `(?=[;!\\n])`,
        patterns: [{
          begin: `(?i)\\G\\s*\\b([a-z]\\w*)\\b`,
          beginCaptures: { 1: { name: `entity.name.function.subroutine.fortran` } },
          ...
          endCaptures: {
            ...
            4: { name: `invalid.error.subroutine.fortran` },
          },
          patterns: [{
            begin: `\\G(?!\\s*[;!\\n])`,
            ...
            name: `meta.first-line.fortran`,
            patterns: [{ include: `#dummy-variable-list` }, { include: `#language-binding-attribute` }],
          }, {
            begin: `(?i)(?!\\b(?:end\\s*[;!\\n]|end\\s*subroutine\\b))`,
            comment: `Specification and execution block.`,
            end: `(?i)(?=\\b(?:end\\s*[;!\\n]|end\\s*subroutine\\b))`,
    ...
    'sync-all-statement': {
      ...
      beginCaptures: {
        1: { name: `keyword.control.sync-all-memory.fortran` },
        2: { name: `punctuation.parentheses.left.fortran` },
      },
      comment: `Introduced in the Fortran 2018 standard.`,
      end: `(?<!\\G)`,
    ...
    'sync-statement': {
      ...
      beginCaptures: {
        1: { name: `keyword.control.sync-images-team.fortran` },
        2: { name: `punctuation.parentheses.left.fortran` },
      },
      comment: `Introduced in the Fortran 2018 standard.`,
      end: `(?<!\\G)`,
    ...
    'target-attribute': {
      captures: { 1: { name: `storage.modifier.target.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
      match: `(?i)\\s*\\b(target)\\b`,
    },
    'type-specification-statements': {
      begin:
        `(?ix)(?=\\b(?:character|class|complex|double\\s*precision|double\\s*complex|integer|logical|real|type|dimension)\\b(?![^'";!\\n:]*\\bfunction\\b))`,
      comment:
        `Supported types for function and escape :: if function is used as a variable name (which is bad practice).`,
      end: `(?=[\\);!\\n])`,
    ...
    types: {
      patterns: [{ include: `#character-type` }, { include: `#derived-type` }, { include: `#logical-type` }, {
    ...
    'use-statement': {
      begin: `(?i)\\b(use)\\b`,
      beginCaptures: { 1: { name: `keyword.control.use.fortran` } },
      comment: `Introduced in the Fortran 1990 standard.`,
      end: `(?=[;!\\n])`,
      ...
      patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{ include: `#intrinsic-attribute` }, { include: `#non-intrinsic-attribute` }, {
            include: `#invalid-word`,
          }],
        }],
      }, {
        ...
        patterns: [{
          ...
          patterns: [{
            begin: `(?i)\\s*\\b(only\\s*:)`,
            beginCaptures: { 1: { name: `keyword.control.only.fortran` } },
            end: `(?=[;!\\n])`,
            patterns: [{ include: `#operator-keyword` }, { include: `$base` }],
          }, {
            begin: `(?i)(?=\\s*[a-z])`,
            contentName: `meta.name-list.fortran`,
            end: `(?=[;!\\n])`,
    ...
    'user-defined-operators': {
      captures: { 1: { name: `keyword.operator.user-defined.fortran` } },
      match: `(?i)\\s*(\\.[a-z]+\\.)`,
    },
    'value-attribute': {
      captures: { 1: { name: `storage.modifier.value.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
      match: `(?i)\\s*\\b(value)\\b`,
    },
    variable: {
      ...
      patterns: [{ include: `#brackets` }, { include: `#derived-type-operators` }, {
        include: `#parentheses-dummy-variables`,
      }, { include: `#word` }],
    },
    'volatile-attribute': {
      captures: { 1: { name: `storage.modifier.volatile.fortran` } },
      comment: `Introduced in the Fortran 2003 standard.`,
    ...
    'where-construct': {
      patterns: [{
        applyEndPatternLast: 1,
        begin: `(?i)\\b(where)\\b`,
        beginCaptures: { 1: { name: `keyword.control.where.fortran` } },
        comment: `Introduced in the Fortran 1990 standard.`,
        end: `(?<!\\G)`,
        patterns: [{ include: `#logical-control-expression` }, {
          begin: `(?<=\\))(?=\\s*[;!\\n])`,
          end: `(?i)\\b(end\\s*where)\\b`,
          endCaptures: { 1: { name: `keyword.control.endwhere.fortran` } },
          name: `meta.block.where.fortran`,
          patterns: [{
            begin: `(?i)\\s*\\b(else\\s*where)\\b`,
            beginCaptures: { 1: { name: `keyword.control.elsewhere.fortran` } },
            end: `(?=[;!\\n])`,
            patterns: [{ include: `#parentheses` }, { include: `#invalid-word` }],
          }, { include: `$base` }],
        }, {
    ...
    word: { patterns: [{ match: `(?i)(?:\\G|(?<=\\%))\\s*\\b([a-z]\\w*)\\b` }] },
  },
  s = `source.fortran.free`,
  c = {
    displayName: e,
    fileTypes: t,
    firstLineMatch: n,
