var e = `Makefile`,
  ...
  r = {
    ...
    comma: { match: `,`, name: `punctuation.separator.delimeter.comma.makefile` },
    comment: {
      begin: `(^[ ]+)?((?<!\\\\)(\\\\\\\\)*)(?=#)`,
      beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.makefile` } },
      end: `(?!\\G)`,
      patterns: [{
        begin: `#`,
    ...
    directives: {
      patterns: [{
        ...
        patterns: [{ include: `#comment` }, { include: `#variables` }, {
          match: `%`,
        ...
        patterns: [{ begin: `\\G(?!\\n)`, end: `^`, patterns: [{ include: `#comment` }] }, { include: `#variables` }, {
          include: `#directives`,
        }],
      }, {
        begin: `^[ ]*(export)\\b`,
        ...
        patterns: [{ include: `#comment` }, { match: `[^\\s]+`, name: `variable.other.makefile` }],
      }, {
        ...
        patterns: [{
          ...
          patterns: [{ include: `#comma` }, { include: `#variables` }, { include: `#comment` }],
        }, {
    ...
    'function-variable-braces': {
      patterns: [{
        ...
        name: `meta.scope.function-call.makefile`,
        patterns: [{ include: `#comma` }, { include: `#variables` }, { include: `#interpolation` }, {
          match: `%|\\*`,
          name: `constant.other.placeholder.makefile`,
        }, { match: `\\\\\\n`, name: `constant.character.escape.continuation.makefile` }],
      }],
    ...
    interpolation: { patterns: [{ include: `#parentheses-interpolation` }, { include: `#braces-interpolation` }] },
    ...
    'simple-variable': { patterns: [{ match: `\\$[^(){}]`, name: `variable.language.makefile` }] },
    target: {
      begin: `^(?!\\t)([^:]*)(:)(?!\\=)`,
      beginCaptures: {
        1: {
          patterns: [{
            ...
            patterns: [{ include: `#variables` }, { match: `%`, name: `constant.other.placeholder.makefile` }],
          }],
        },
    ...
    'variable-assignment': {
      begin: `(^[ ]*|\\G\\s*)([^\\s:#=]+)\\s*((?<![?:+!])=|\\?=|:=|\\+=|!=)`,
      beginCaptures: {
        2: { name: `variable.other.makefile`, patterns: [{ include: `#variables` }] },
    ...
    variables: {
      patterns: [{ include: `#simple-variable` }, { include: `#variable-parentheses` }, {
