var e = `vscode://schemas/color-theme`,
  ...
  c = [
    ...
    { scope: [`header`], settings: { foreground: `#BD93F9` } },
    { scope: [`meta.diff`, `meta.diff.header`], settings: { foreground: `#6272A4` } },
    ...
    { scope: [`invalid`], settings: { foreground: `#FF5555`, fontStyle: `underline italic` } },
    { scope: [`invalid.deprecated`], settings: { foreground: `#F8F8F2`, fontStyle: `underline italic` } },
    { scope: [`entity.name.filename`], settings: { foreground: `#F1FA8C` } },
    { scope: [`markup.error`], settings: { foreground: `#FF5555` } },
    ...
    { name: `Markup headings`, scope: [`markup.heading`], settings: { fontStyle: `bold`, foreground: `#BD93F9` } },
    { name: `Markup italic`, scope: [`markup.italic`], settings: { foreground: `#F1FA8C`, fontStyle: `italic` } },
    {
    ...
    },
    {
      ...
      settings: { foreground: `#F1FA8C`, fontStyle: `italic` },
    },
    { name: `Horizontal rule (prose)`, scope: [`meta.separator.markdown`], settings: { foreground: `#6272A4` } },
    {
      name: `Code blocks`,
      scope: [
    ...
    },
    {
      ...
      settings: { foreground: `#8BE9FD`, fontStyle: `normal` },
    },
    {
    ...
    { name: `Constants`, scope: [`constant`, `variable.other.constant`], settings: { foreground: `#BD93F9` } },
    {
    ...
    { name: `Decorator Objects`, scope: [`meta.decorator variable.other.object`], settings: { foreground: `#50FA7B` } },
    { name: `Keywords`, scope: [`keyword`, `punctuation.definition.keyword`], settings: { foreground: `#FF79C6` } },
    { name: `Keyword "new"`, scope: [`keyword.control.new`, `keyword.operator.new`], settings: { fontStyle: `bold` } },
    { name: `Generic selectors (CSS/SCSS/Less/Stylus)`, scope: [`meta.selector`], settings: { foreground: `#FF79C6` } },
    { name: `Language Built-ins`, scope: [`support`], settings: { fontStyle: `italic`, foreground: `#8BE9FD` } },
    {
      name: `Built-in magic functions and constants`,
      scope: [`support.function.magic`, `support.variable`, `variable.other.predefined`],
      settings: { fontStyle: `regular`, foreground: `#BD93F9` },
    },
    {
    ...
    },
    {
      ...
      settings: { fontStyle: `italic underline`, foreground: `#50FA7B` },
    },
    {
      name: `Storage`,
      scope: [
      ...
      settings: { fontStyle: `regular`, foreground: `#FF79C6` },
    },
    {
      name: `Types`,
      scope: [
    ...
    { name: `Modifiers`, scope: [`storage.modifier`], settings: { foreground: `#FF79C6` } },
    {
      name: `RegExp string`,
      scope: [
        `string.regexp`,
    ...
    { name: `Positive lookaheads`, scope: [`meta.assertion.look-ahead.regexp`], settings: { foreground: `#50FA7B` } },
    { name: `Strings`, scope: [`string`], settings: { foreground: `#F1FA8C` } },
    {
      name: `String quotes (temporary vscode fix)`,
      scope: [`punctuation.definition.string.begin`, `punctuation.definition.string.end`],
      settings: { foreground: `#E9F284` },
    },
    {
    ...
    },
    {
      ...
      settings: { fontStyle: `normal`, foreground: `#F8F8F2` },
    },
    { name: `GraphQL keys`, scope: [`meta.selectionset.graphql variable`], settings: { foreground: `#F1FA8C` } },
    {
    ...
    },
    {
      ...
      settings: { fontStyle: `normal`, foreground: `#BD93F9` },
    },
    {
    ...
    { name: `Haskell Pragmas`, scope: [`meta.preprocessor.haskell`], settings: { foreground: `#6272A4` } },
    { name: `Log file error`, scope: [`log.error`], settings: { foreground: `#FF5555`, fontStyle: `bold` } },
    { name: `Log file warning`, scope: [`log.warning`], settings: { foreground: `#F1FA8C`, fontStyle: `bold` } },
  ],
  l = {
    $schema: e,
    name: t,
