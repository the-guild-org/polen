var e = `JSX`,
  t = `jsx`,
  n = [{ include: `#directives` }, { include: `#statements` }, { include: `#shebang` }],
  r = {
    'access-modifier': {
      match:
    ...
    'array-binding-pattern': {
      ...
      endCaptures: { 0: { name: `punctuation.definition.binding-pattern.array.js.jsx` } },
    ...
    'arrow-function': {
      patterns: [{
        captures: { 1: { name: `storage.modifier.async.js.jsx` }, 2: { name: `variable.parameter.js.jsx` } },
        match:
...
\\s*=>
        ...
        name: `meta.arrow.js.jsx`,
        patterns: [{ include: `#comment` }, { include: `#type-parameters` }, { include: `#function-parameters` }, {
          include: `#arrow-return-type`,
        }, { include: `#possibly-arrow-return-type` }],
      }, {
        begin: `=>`,
        beginCaptures: { 0: { name: `storage.type.function.arrow.js.jsx` } },
        end: `((?<=\\}|\\S)(?<!=>)|((?!\\{)(?=\\S)))(?!\\/[\\/\\*])`,
        name: `meta.arrow.js.jsx`,
        patterns: [{ include: `#single-line-comment-consuming-line-ending` }, { include: `#decl-block` }, {
          include: `#expression`,
        }],
      }],
    },
    'arrow-return-type': {
      begin: `(?<=\\))\\s*(:)`,
      beginCaptures: { 1: { name: `keyword.operator.type.annotation.js.jsx` } },
      end:
        `(?==>|\\{|(^\\s*(export|function|class|interface|let|var|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|const|import|enum|namespace|module|type|abstract|declare)\\s+))`,
    ...
    'arrow-return-type-body': {
      patterns: [{ begin: `(?<=[:])(?=\\s*\\{)`, end: `(?<=\\})`, patterns: [{ include: `#type-object` }] }, {
    ...
    brackets: {
      patterns: [{ begin: `{`, end: `}|(?=\\*/)`, patterns: [{ include: `#brackets` }] }, {
        begin: `\\[`,
        end: `\\]|(?=\\*/)`,
    ...
    'class-declaration-or-expression-patterns': {
      patterns: [
        ...
        { captures: { 0: { name: `entity.name.type.class.js.jsx` } }, match: `[_$[:alpha:]][_$[:alnum:]]*` },
    ...
    'class-expression': {
      ...
      beginCaptures: { 1: { name: `storage.modifier.js.jsx` }, 2: { name: `storage.type.class.js.jsx` } },
      end: `(?<=\\})`,
      name: `meta.class.js.jsx`,
      patterns: [{ include: `#class-declaration-or-expression-patterns` }],
    },
    ...
    'class-or-interface-heritage': {
      ...
      patterns: [
        ...
        { captures: { 1: { name: `entity.other.inherited-class.js.jsx` } }, match: `([_$[:alpha:]][_$[:alnum:]]*)` },
    ...
    comment: {
      patterns: [{
        begin: `/\\*\\*(?!/)`,
        beginCaptures: { 0: { name: `punctuation.definition.comment.js.jsx` } },
        end: `\\*/`,
        endCaptures: { 0: { name: `punctuation.definition.comment.js.jsx` } },
    ...
    'control-statement': {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.control.loop.js.jsx` }, 2: { name: `entity.name.label.js.jsx` } },
          match:
    ...
    'destructuring-const': {
      patterns: [{
        ...
        patterns: [{ include: `#object-binding-pattern-const` }, { include: `#type-annotation` }, {
          include: `#comment`,
        }],
      }, {
        begin: `(?<!=|:|^of|[^\\._$[:alnum:]]of|^in|[^\\._$[:alnum:]]in)\\s*(?=\\[)`,
        ...
        patterns: [{ include: `#array-binding-pattern-const` }, { include: `#type-annotation` }, {
          include: `#comment`,
        }],
      }],
    },
    'destructuring-parameter': {
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.binding-pattern.object.js.jsx` } },
    ...
    'destructuring-parameter-rest': {
      captures: { 1: { name: `keyword.operator.rest.js.jsx` }, 2: { name: `variable.parameter.js.jsx` } },
    ...
    'destructuring-variable': {
      patterns: [{
        ...
        name: `meta.object-binding-pattern-variable.js.jsx`,
        patterns: [{ include: `#object-binding-pattern` }, { include: `#type-annotation` }, { include: `#comment` }],
      }, {
        begin: `(?<!=|:|^of|[^\\._$[:alnum:]]of|^in|[^\\._$[:alnum:]]in)\\s*(?=\\[)`,
        end: `(?=$|^|[;,=}]|((?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(of|in)\\s+))`,
        name: `meta.array-binding-pattern-variable.js.jsx`,
        patterns: [{ include: `#array-binding-pattern` }, { include: `#type-annotation` }, { include: `#comment` }],
      }],
    },
    'destructuring-variable-rest': {
      captures: {
        1: { name: `keyword.operator.rest.js.jsx` },
        2: { name: `meta.definition.variable.js.jsx variable.other.readwrite.js.jsx` },
      },
      match: `(?:(\\.\\.\\.)\\s*)?([_$[:alpha:]][_$[:alnum:]]*)`,
    },
    'destructuring-variable-rest-const': {
      captures: {
        1: { name: `keyword.operator.rest.js.jsx` },
        2: { name: `meta.definition.variable.js.jsx variable.other.constant.js.jsx` },
      },
      match: `(?:(\\.\\.\\.)\\s*)?([_$[:alpha:]][_$[:alnum:]]*)`,
    },
    directives: {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.tag.directive.js.jsx` } },
        ...
        patterns: [
          ...
          { match: `=`, name: `keyword.operator.assignment.js.jsx` },
          { include: `#string` },
        ],
      }],
    },
...
((?:[^@\\s*/]|\\*[^/])+)`,
        },
        {
          ...
          }, { captures: { 0: { name: `source.embedded.js.jsx` } }, match: `[^\\s@*](?:[^*]|\\*[^/])*` }],
        },
        {
          captures: {
            1: { name: `storage.type.class.jsdoc` },
...
[\\w$.\\[\\]]*
        ...
        },
        {
          ...
          patterns: [{ include: `#jsdoctype` }, { match: `([A-Za-z_$][\\w$.\\[\\]]*)`, name: `variable.other.jsdoc` }],
        },
        {
          captures: {
            1: { name: `storage.type.class.jsdoc` },
...
[^{}@\\s*] | \\*[^/]
        ...
        },
        {
          ...
          endCaptures: { 0: { name: `variable.other.jsdoc` }, 1: { name: `punctuation.definition.string.end.jsdoc` } },
        },
        {
          captures: {
            1: { name: `storage.type.class.jsdoc` },
        ...
        { include: `#inline-tags` },
        {
          captures: { 1: { name: `storage.type.class.jsdoc` }, 2: { name: `punctuation.definition.block.tag.jsdoc` } },
    ...
    'enum-declaration': {
      ...
      patterns: [{ include: `#comment` }, {
        ...
        patterns: [{ include: `#comment` }, {
          ...
          beginCaptures: { 0: { name: `variable.other.enummember.js.jsx` } },
          end: `(?=,|\\}|$)`,
          ...
          patterns: [{ include: `#string` }, { include: `#array-literal` }, { include: `#comment` }, {
            include: `#variable-initializer`,
          }],
        }, { include: `#punctuation-comma` }],
      }],
    ...
    'export-declaration': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.control.export.js.jsx` }, 2: { name: `keyword.control.type.js.jsx` } },
        end:
          `(?=$|;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b))`,
    ...
    expression: {
      patterns: [{ include: `#expressionWithoutIdentifiers` }, { include: `#identifiers` }, {
        include: `#expressionPunctuations`,
      }],
    },
      ...
      patterns: [
        ...
        },
        {
          captures: {
            ...
            3: { name: `entity.name.function.js.jsx variable.language.this.js.jsx` },
...
\\s*=>
        ...
        },
        {
          captures: {
            1: { name: `storage.modifier.js.jsx` },
            2: { name: `keyword.operator.rest.js.jsx` },
            3: { name: `variable.parameter.js.jsx variable.language.this.js.jsx` },
        ...
        { include: `#type-annotation` },
        { include: `#variable-initializer` },
        { match: `,`, name: `punctuation.separator.parameter.js.jsx` },
        { include: `#identifiers` },
        { include: `#expressionPunctuations` },
      ],
    },
    'expression-operators': {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.control.flow.js.jsx` }, 2: { name: `keyword.generator.asterisk.js.jsx` } },
          match:
        ...
        {
          captures: { 1: { name: `keyword.control.as.js.jsx` }, 2: { name: `storage.modifier.js.jsx` } },
          match: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(as)\\s+(const)(?=\\s*($|[;,:})\\]]))`,
        },
        {
          begin: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:(as)|(satisfies))\\s+`,
          beginCaptures: { 1: { name: `keyword.control.as.js.jsx` }, 2: { name: `keyword.control.satisfies.js.jsx` } },
          end:
            `(?=^|[;),}\\]:?\\-\\+\\>]|\\|\\||\\&\\&|\\!\\=\\=|$|((?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(as|satisfies)\\s+)|(\\s+\\<))`,
          patterns: [{ include: `#type` }],
        },
        { match: `\\.\\.\\.`, name: `keyword.operator.spread.js.jsx` },
        { match: `\\*=|(?<!\\()/=|%=|\\+=|\\-=`, name: `keyword.operator.assignment.compound.js.jsx` },
        { match: `\\&=|\\^=|<<=|>>=|>>>=|\\|=`, name: `keyword.operator.assignment.compound.bitwise.js.jsx` },
        { match: `<<|>>>|>>`, name: `keyword.operator.bitwise.shift.js.jsx` },
        { match: `===|!==|==|!=`, name: `keyword.operator.comparison.js.jsx` },
        { match: `<=|>=|<>|<|>`, name: `keyword.operator.relational.js.jsx` },
        {
          captures: {
        ...
        { match: `\\!|&&|\\|\\||\\?\\?`, name: `keyword.operator.logical.js.jsx` },
        { match: `\\&|~|\\^|\\|`, name: `keyword.operator.bitwise.js.jsx` },
        { match: `\\=`, name: `keyword.operator.assignment.js.jsx` },
        { match: `--`, name: `keyword.operator.decrement.js.jsx` },
        { match: `\\+\\+`, name: `keyword.operator.increment.js.jsx` },
        { match: `%|\\*|/|-|\\+`, name: `keyword.operator.arithmetic.js.jsx` },
        {
          begin: `(?<=[_$[:alnum:])\\]])\\s*(?=(\\/\\*([^\\*]|(\\*[^\\/]))*\\*\\/\\s*)+(?:(/=)|(?:(/)(?![/*]))))`,
          end: `(?:(/=)|(?:(/)(?!\\*([^\\*]|(\\*[^\\/]))*\\*\\/)))`,
          endCaptures: {
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
      ...
      patterns: [
        ...
        {
          captures: {
            1: { name: `meta.definition.property.js.jsx entity.name.function.js.jsx` },
...
\\s*=>
        ...
        { match: `\\?`, name: `keyword.operator.optional.js.jsx` },
        { match: `\\!`, name: `keyword.operator.definiteassignment.js.jsx` },
      ],
    },
    'for-loop': {
      begin:
      ...
      patterns: [{ include: `#comment` }, { match: `await`, name: `keyword.control.loop.js.jsx` }, {
        begin: `\\(`,
        beginCaptures: { 0: { name: `meta.brace.round.js.jsx` } },
        end: `\\)`,
        endCaptures: { 0: { name: `meta.brace.round.js.jsx` } },
        patterns: [{ include: `#var-expr` }, { include: `#expression` }, { include: `#punctuation-semicolon` }],
      }],
    },
    'function-body': {
      patterns: [
        ...
        { include: `#decl-block` },
        { match: `\\*`, name: `keyword.generator.asterisk.js.jsx` },
      ],
    },
    'function-call': {
      patterns: [{
    ...
    'function-call-optionals': {
      patterns: [{ match: `\\?\\.`, name: `meta.function-call.js.jsx punctuation.accessor.optional.js.jsx` }, {
        match: `\\!`,
    ...
    'function-declaration': {
      ...
      beginCaptures: {
        ...
        6: { name: `meta.definition.function.js.jsx entity.name.function.js.jsx` },
      },
      end:
        `(?=;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b))|(?<=\\})`,
    ...
    'function-expression': {
      ...
      beginCaptures: {
        ...
        4: { name: `meta.definition.function.js.jsx entity.name.function.js.jsx` },
      },
      end: `(?=;)|(?<=\\})`,
      name: `meta.function.expression.js.jsx`,
      patterns: [{ include: `#function-name` }, { include: `#single-line-comment-consuming-line-ending` }, {
    ...
    'function-parameters': {
      begin: `\\(`,
      beginCaptures: { 0: { name: `punctuation.definition.parameters.begin.js.jsx` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.parameters.end.js.jsx` } },
...
\\s*=>
        ...
        { match: `([[:upper:]][_$[:digit:][:upper:]]*)(?![_$[:alnum:]])`, name: `variable.other.constant.js.jsx` },
        { match: `[_$[:alpha:]][_$[:alnum:]]*`, name: `variable.other.readwrite.js.jsx` },
      ],
    },
    'if-statement': {
      patterns: [{
        ...
        patterns: [{ include: `#comment` }, {
          begin: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(if)\\s*(\\()`,
          beginCaptures: { 1: { name: `keyword.control.conditional.js.jsx` }, 2: { name: `meta.brace.round.js.jsx` } },
          end: `\\)`,
          endCaptures: { 0: { name: `meta.brace.round.js.jsx` } },
          patterns: [{ include: `#expression` }],
        }, {
          ...
          beginCaptures: { 0: { name: `punctuation.definition.string.begin.js.jsx` } },
          end: `(/)([dgimsuy]*)`,
          endCaptures: { 1: { name: `punctuation.definition.string.end.js.jsx` }, 2: { name: `keyword.other.js.jsx` } },
    ...
    'import-declaration': {
      ...
      patterns: [{ include: `#single-line-comment-consuming-line-ending` }, { include: `#comment` }, {
        include: `#string`,
      }, {
    ...
    'import-export-assert-clause': {
      ...
      }, { match: `:`, name: `punctuation.separator.key-value.js.jsx` }],
    },
    'import-export-block': {
      begin: `\\{`,
      beginCaptures: { 0: { name: `punctuation.definition.block.js.jsx` } },
      ...
      patterns: [
        { include: `#comment` },
        {
          captures: {
            ...
            5: { name: `keyword.control.as.js.jsx` },
            6: { name: `keyword.control.default.js.jsx` },
            7: { name: `variable.other.readwrite.alias.js.jsx` },
          },
          match:
            `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:(?:(\\btype)\\s+)?(?:(\\bdefault)|(\\*)|(\\b[_$[:alpha:]][_$[:alnum:]]*)))\\s+(as)\\s+(?:(default(?![_$[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.)))|([_$[:alpha:]][_$[:alnum:]]*))`,
        },
        { include: `#punctuation-comma` },
        { match: `\\*`, name: `constant.language.import-export-all.js.jsx` },
        { match: `\\b(default)\\b`, name: `keyword.control.default.js.jsx` },
        {
          captures: {
            1: { name: `keyword.control.type.js.jsx` },
    ...
    'import-export-declaration': {
      patterns: [
        ...
        { match: `\\bfrom\\b`, name: `keyword.control.from.js.jsx` },
    ...
    'indexer-declaration': {
      ...
      endCaptures: { 1: { name: `meta.brace.square.js.jsx` }, 2: { name: `keyword.operator.optional.js.jsx` } },
    ...
    'instanceof-expr': {
      ...
      beginCaptures: { 1: { name: `keyword.operator.expression.instanceof.js.jsx` } },
      end:
    ...
    'interface-declaration': {
      ...
      patterns: [
        { include: `#comment` },
        { include: `#class-or-interface-heritage` },
        { captures: { 0: { name: `entity.name.type.interface.js.jsx` } }, match: `[_$[:alpha:]][_$[:alnum:]]*` },
        { include: `#type-parameters` },
        { include: `#class-or-interface-body` },
      ],
    },
    ...
    'jsx-children': {
      patterns: [{ include: `#jsx-tag-without-attributes` }, { include: `#jsx-tag` }, {
    ...
    'jsx-evaluated-code': {
      begin: `\\{`,
      beginCaptures: { 0: { name: `punctuation.section.embedded.begin.js.jsx` } },
    ...
    'jsx-string-double-quoted': {
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.js.jsx` } },
    ...
    'jsx-tag': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#comment` }, { include: `#type-arguments` }, { include: `#jsx-tag-attributes` }],
      }, {
        begin: `(>)`,
...
(?=\\s|=|/?>|/\\*|//)`,
    ...
    'jsx-tag-attributes-illegal': { match: `\\S+`, name: `invalid.illegal.attribute.js.jsx` },
...
(?=(<)\\s*(?:([_$[:alpha:]][-_$[:alnum:].]*)(?<!\\.|-)(:))?((?:[a-z][a-z0-9]*|([_$[:alpha:]][-_$[:alnum:].]*))(?<!\\.|-))(?=((<\\s*)|(\\s+))(?!\\?)|\\/?>))`,
    ...
    label: {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `entity.name.label.js.jsx` }, 2: { name: `punctuation.separator.label.js.jsx` } },
        end: `(?<=\\})`,
        patterns: [{ include: `#decl-block` }],
      }, {
        captures: { 1: { name: `entity.name.label.js.jsx` }, 2: { name: `punctuation.separator.label.js.jsx` } },
        match: `([_$[:alpha:]][_$[:alnum:]]*)\\s*(:)`,
      }],
    },
    literal: {
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
      ...
      patterns: [{ include: `#string` }, { include: `#array-literal` }, { include: `#numeric-literal` }, {
        match: `[_$[:alpha:]][_$[:alnum:]]*`,
    ...
    'namespace-declaration': {
      ...
      patterns: [
        { include: `#comment` },
        { include: `#string` },
        { match: `([_$[:alpha:]][_$[:alnum:]]*)`, name: `entity.name.type.module.js.jsx` },
...
(\\#?[_$[:alpha:]][_$[:alnum:]]*)
        ...
        captures: { 1: { name: `variable.other.constant.object.js.jsx` }, 2: { name: `variable.other.object.js.jsx` } },
        match: `(?x)(?:
([[:upper:]][_$[:digit:][:upper:]]*) |
([_$[:alpha:]][_$[:alnum:]]*)
)(?=\\s*\\??\\.\\s*\\#?[_$[:alpha:]][_$[:alnum:]]*)`,
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
        ...
        {
          captures: { 0: { name: `meta.object-literal.key.js.jsx` }, 1: { name: `constant.numeric.decimal.js.jsx` } },
          match: `(?![_$[:alpha:]])([[:digit:]]+)\\s*(?=(\\/\\*([^\\*]|(\\*[^\\/]))*\\*\\/\\s*)*:)`,
          name: `meta.object.member.js.jsx`,
        },
        {
          captures: { 0: { name: `meta.object-literal.key.js.jsx` }, 1: { name: `entity.name.function.js.jsx` } },
          match:
...
\\s*=>
        ...
        {
          captures: { 0: { name: `meta.object-literal.key.js.jsx` } },
          match: `(?:[_$[:alpha:]][_$[:alnum:]]*)\\s*(?=(\\/\\*([^\\*]|(\\*[^\\/]))*\\*\\/\\s*)*:)`,
          name: `meta.object.member.js.jsx`,
        },
        {
        ...
        {
          begin: `:`,
          beginCaptures: { 0: { name: `meta.object-literal.key.js.jsx punctuation.separator.key-value.js.jsx` } },
          end: `(?=,|\\})`,
          name: `meta.object.member.js.jsx`,
          patterns: [
            {
            ...
            },
            {
              ...
              beginCaptures: { 1: { name: `storage.modifier.async.js.jsx` }, 2: { name: `meta.brace.round.js.jsx` } },
              end: `\\)`,
              endCaptures: { 0: { name: `meta.brace.round.js.jsx` } },
              patterns: [{ include: `#expression-inside-possibly-arrow-parens` }],
            },
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
          ...
          patterns: [{ include: `#object-binding-element-propertyName` }, { include: `#parameter-binding-element` }, {
            include: `#paren-expression`,
          }],
        },
        { include: `#parameter-object-binding-pattern` },
    ...
    'possibly-arrow-return-type': {
      begin:
        `(?<=\\)|^)\\s*(:)(?=\\s*([^<>\\(\\)\\{\\}]|\\<([^<>]|\\<([^<>]|\\<[^<>]+\\>)+\\>)+\\>|\\([^\\(\\)]+\\)|\\{[^\\{\\}]+\\})+\\s*=>)`,
      beginCaptures: {
        1: { name: `meta.arrow.js.jsx meta.return.type.arrow.js.jsx keyword.operator.type.annotation.js.jsx` },
      },
    ...
    'punctuation-accessor': {
      captures: { 1: { name: `punctuation.accessor.js.jsx` }, 2: { name: `punctuation.accessor.optional.js.jsx` } },
      match: `(?:(\\.)|(\\?\\.(?!\\s*[[:digit:]])))`,
    },
    'punctuation-comma': { match: `,`, name: `punctuation.separator.comma.js.jsx` },
    'punctuation-semicolon': { match: `;`, name: `punctuation.terminator.statement.js.jsx` },
    'qstring-double': {
      begin: `"`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.js.jsx` } },
      end: `(")|((?:[^\\\\\\n])$)`,
    ...
    regex: {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `punctuation.definition.string.begin.js.jsx` } },
        end: `(/)([dgimsuy]*)`,
        endCaptures: { 1: { name: `punctuation.definition.string.end.js.jsx` }, 2: { name: `keyword.other.js.jsx` } },
        name: `string.regexp.js.jsx`,
        patterns: [{ include: `#regexp` }],
    ...
    regexp: {
      patterns: [
        ...
        {
          captures: { 0: { name: `keyword.other.back-reference.regexp` }, 1: { name: `variable.other.regexp` } },
    ...
    'return-type-core': {
      patterns: [
        { include: `#comment` },
        { begin: `(?<=[:|&])(?=\\s*\\{)`, end: `(?<=\\})`, patterns: [{ include: `#type-object` }] },
        { include: `#type-predicate-operator` },
        { include: `#type` },
      ],
    },
    ...
    string: { patterns: [{ include: `#qstring-single` }, { include: `#qstring-double` }, { include: `#template` }] },
    ...
    'support-function-call-identifiers': {
      patterns: [{ include: `#literal` }, { include: `#support-objects` }, { include: `#object-identifiers` }, {
        include: `#punctuation-accessor`,
      }, {
...
(?:(EPSILON|MAX_SAFE_INTEGER|MAX_VALUE|MIN_SAFE_INTEGER|MIN_VALUE|NEGATIVE_INFINITY|POSITIVE_INFINITY)\\b(?!\\$)))`,
    ...
    'switch-statement': {
      ...
      patterns: [{ include: `#comment` }, {
        ...
        beginCaptures: { 1: { name: `keyword.control.switch.js.jsx` }, 2: { name: `meta.brace.round.js.jsx` } },
        end: `\\)`,
        endCaptures: { 0: { name: `meta.brace.round.js.jsx` } },
        ...
        patterns: [{
          ...
          begin: `(:)\\s*(\\{)`,
          beginCaptures: {
            1: { name: `case-clause.expr.js.jsx punctuation.definition.section.case-statement.js.jsx` },
            2: { name: `meta.block.js.jsx punctuation.definition.block.js.jsx` },
          },
          contentName: `meta.block.js.jsx`,
          end: `\\}`,
          endCaptures: { 0: { name: `meta.block.js.jsx punctuation.definition.block.js.jsx` } },
          patterns: [{ include: `#statements` }],
        }, {
          captures: { 0: { name: `case-clause.expr.js.jsx punctuation.definition.section.case-statement.js.jsx` } },
          match: `(:)`,
        }, { include: `#statements` }],
      }],
    },
    template: {
      patterns: [{ include: `#template-call` }, {
        begin: '([_$[:alpha:]][_$[:alnum:]]*)?(`)',
        beginCaptures: {
          1: { name: `entity.name.function.tagged-template.js.jsx` },
          2: { name: `string.template.js.jsx punctuation.definition.string.template.begin.js.jsx` },
        },
        contentName: `string.template.js.jsx`,
        end: '`',
        endCaptures: { 0: { name: `string.template.js.jsx punctuation.definition.string.template.end.js.jsx` } },
    ...
    'template-call': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `entity.name.function.tagged-template.js.jsx` } },
        end: '(?=`)',
    ...
    'template-substitution-element': {
      begin: `\\$\\{`,
      beginCaptures: { 0: { name: `punctuation.definition.template-expression.begin.js.jsx` } },
      contentName: `meta.embedded.line.js.jsx`,
      end: `\\}`,
      endCaptures: { 0: { name: `punctuation.definition.template-expression.end.js.jsx` } },
    ...
    'type-alias-declaration': {
      ...
      patterns: [{ include: `#comment` }, { include: `#type-parameters` }, {
        ...
        begin: `(=)\\s*`,
        beginCaptures: { 1: { name: `keyword.operator.assignment.js.jsx` } },
        end:
          `(?=\\}|;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b))`,
        patterns: [{ include: `#type` }],
      }],
    ...
    'type-arguments': {
      begin: `\\<`,
      beginCaptures: { 0: { name: `punctuation.definition.typeparameters.begin.js.jsx` } },
      end: `\\>`,
      endCaptures: { 0: { name: `punctuation.definition.typeparameters.end.js.jsx` } },
    ...
    'type-conditional': {
      patterns: [{
        ...
        patterns: [{
          begin: `\\?`,
          beginCaptures: { 0: { name: `keyword.operator.ternary.js.jsx` } },
          end: `:`,
    ...
    'type-fn-type-parameters': {
      patterns: [{
        ...
        beginCaptures: {
          1: { name: `meta.type.constructor.js.jsx storage.modifier.js.jsx` },
          2: { name: `meta.type.constructor.js.jsx keyword.control.new.js.jsx` },
        },
        end: `(?<=>)`,
        patterns: [{ include: `#comment` }, { include: `#type-parameters` }],
      }, {
        begin: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:(abstract)\\s+)?(new)\\b\\s*(?=\\()`,
        beginCaptures: { 1: { name: `storage.modifier.js.jsx` }, 2: { name: `keyword.control.new.js.jsx` } },
        end: `(?<=\\))`,
...
([)]\\s*=>)
    ...
    'type-function-return-type': {
      patterns: [{
        begin: `(=>)(?=\\s*\\S)`,
        beginCaptures: { 1: { name: `storage.type.function.arrow.js.jsx` } },
        end: `(?<!=>)(?<![|&])(?=[,\\]\\)\\{\\}=;>:\\?]|//|$)`,
    ...
    'type-name': {
      patterns: [{
        ...
        captures: {
          ...
          2: { name: `punctuation.accessor.js.jsx` },
          3: { name: `punctuation.accessor.optional.js.jsx` },
          4: { name: `meta.type.parameters.js.jsx punctuation.definition.typeparameters.begin.js.jsx` },
        },
        contentName: `meta.type.parameters.js.jsx`,
        end: `(>)`,
        endCaptures: { 1: { name: `meta.type.parameters.js.jsx punctuation.definition.typeparameters.end.js.jsx` } },
        patterns: [{ include: `#type-arguments-body` }],
      }, {
        begin: `([_$[:alpha:]][_$[:alnum:]]*)\\s*(<)`,
        beginCaptures: {
          1: { name: `entity.name.type.js.jsx` },
          2: { name: `meta.type.parameters.js.jsx punctuation.definition.typeparameters.begin.js.jsx` },
        },
        contentName: `meta.type.parameters.js.jsx`,
        end: `(>)`,
        endCaptures: { 1: { name: `meta.type.parameters.js.jsx punctuation.definition.typeparameters.end.js.jsx` } },
        ...
        match: `([_$[:alpha:]][_$[:alnum:]]*)\\s*(?:(\\.)|(\\?\\.(?!\\s*[[:digit:]])))`,
      }, { match: `[_$[:alpha:]][_$[:alnum:]]*`, name: `entity.name.type.js.jsx` }],
    },
    'type-object': {
      begin: `\\{`,
      beginCaptures: { 0: { name: `punctuation.definition.block.js.jsx` } },
    ...
    'type-operators': {
      patterns: [
        ...
        { begin: `[&|]`, beginCaptures: { 0: { name: `keyword.operator.type.js.jsx` } }, end: `(?=\\S)` },
        {
          match: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))keyof(?![_$[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))`,
          name: `keyword.operator.expression.keyof.js.jsx`,
        },
        { match: `(\\?|\\:)`, name: `keyword.operator.ternary.js.jsx` },
        {
    ...
    'type-parameters': {
      begin: `(<)`,
      beginCaptures: { 1: { name: `punctuation.definition.typeparameters.begin.js.jsx` } },
      end: `(>)`,
      endCaptures: { 1: { name: `punctuation.definition.typeparameters.end.js.jsx` } },
      name: `meta.type.parameters.js.jsx`,
      patterns: [
        { include: `#comment` },
        {
...
(:\\s*((<\\s*$)|([\\(]\\s*((([\\{\\[]\\s*)?$)|((\\{([^\\{\\}]|(\\{([^\\{\\}]|\\{[^\\{\\}]*\\})*\\}))*\\})\\s*((:\\s*\\{?$)|((\\s*([^<>\\(\\)\\{\\}]|\\<([^<>]|\\<([^<>]|\\<[^<>]+\\>)+\\>)+\\>|\\([^\\(\\)]+\\)|\\{[^\\{\\}]+\\})+\\s*)?=\\s*)))|((\\[([^\\[\\]]|(\\[([^\\[\\]]|\\[[^\\[\\]]*\\])*\\]))*\\])\\s*((:\\s*\\[?$)|((\\s*([^<>\\(\\)\\{\\}]|\\<([^<>]|\\<([^<>]|\\<[^<>]+\\>)+\\>)+\\>|\\([^\\(\\)]+\\)|\\{[^\\{\\}]+\\})+\\s*)?=\\s*))))))))`,
    ...
    'type-predicate-operator': {
      patterns: [{
        captures: {
          ...
          2: { name: `variable.parameter.js.jsx variable.language.this.js.jsx` },
          3: { name: `variable.parameter.js.jsx` },
    ...
    'type-tuple': {
      ...
      patterns: [
        { match: `\\.\\.\\.`, name: `keyword.operator.rest.js.jsx` },
        {
          captures: {
    ...
    'typeof-operator': {
      ...
      beginCaptures: { 0: { name: `keyword.operator.expression.typeof.js.jsx` } },
      end:
    ...
    'var-expr': {
      patterns: [{
        ...
        patterns: [
          ...
          {
            begin: `(,)\\s*(?=$|\\/\\/)`,
            beginCaptures: { 1: { name: `punctuation.separator.comma.js.jsx` } },
            end:
...
\\s*=>
        ...
        beginCaptures: {
          1: { name: `meta.definition.variable.js.jsx variable.other.constant.js.jsx entity.name.function.js.jsx` },
        },
        end:
        ...
        begin: `([_$[:alpha:]][_$[:alnum:]]*)`,
        beginCaptures: { 1: { name: `meta.definition.variable.js.jsx variable.other.constant.js.jsx` } },
        end:
          `(?=$|^|[;,=}]|((?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(of|in)\\s+)|(;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b)))`,
        name: `meta.var-single-variable.expr.js.jsx`,
        patterns: [{ include: `#var-single-variable-type-annotation` }],
...
\\s*=>
        ...
        beginCaptures: {
          1: { name: `meta.definition.variable.js.jsx entity.name.function.js.jsx` },
        ...
        beginCaptures: {
          1: { name: `meta.definition.variable.js.jsx variable.other.constant.js.jsx` },
          2: { name: `keyword.operator.definiteassignment.js.jsx` },
        },
        end:
          `(?=$|^|[;,=}]|((?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(of|in)\\s+)|(;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b)))`,
        ...
        begin: `([_$[:alpha:]][_$[:alnum:]]*)(\\!)?`,
        beginCaptures: {
          1: { name: `meta.definition.variable.js.jsx variable.other.readwrite.js.jsx` },
          2: { name: `keyword.operator.definiteassignment.js.jsx` },
        },
        end:
          `(?=$|^|[;,=}]|((?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(of|in)\\s+)|(;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b)))`,
  ...
  i = `source.js.jsx`,
  a = { displayName: `JSX`, name: `jsx`, patterns: n, repository: r, scopeName: i }
