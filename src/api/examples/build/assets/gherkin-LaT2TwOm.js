var e = `Gherkin`,
  ...
  s = {
    comments: { captures: { 0: { name: `comment.line.number-sign` } }, match: `^\\s*(#.*)` },
    ...
    strings_triple_quote: { begin: `""".*`, end: `"""`, name: `string.quoted.single` },
    table: {
      begin: `^\\s*\\|`,
      end: `\\|\\s*$`,
    ...
    tags: { captures: { 0: { name: `entity.name.type.class.tsx` } }, match: `(@[^@\\r\\n\\t ]+)` },
  },
  c = `text.gherkin.feature`,
  l = {
    displayName: e,
    fileTypes: t,
    firstLineMatch: n,
