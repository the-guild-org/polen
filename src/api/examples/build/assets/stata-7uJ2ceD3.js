var e = `Stata`,
  ...
  a = [
    ...
    },
    {
      ...
      beginCaptures: {
        ...
        3: { patterns: [{ include: `#constants` }, { match: `m|n`, name: `` }] },
        4: { name: `punctuation.separator.key-value` },
        5: { patterns: [{ include: `#constants` }, { match: `m|n`, name: `` }] },
      },
      end: `using`,
      patterns: [{ include: `#builtin_variables` }, { include: `#macro-local` }, { include: `#macro-global` }, {
        include: `#comments`,
      }],
    },
    {
      captures: {
        1: { name: `keyword.control.flow.stata` },
        2: {
          patterns: [{ include: `#macro-local-identifiers` }, { include: `#macro-local` }, {
            include: `#macro-global`,
          }],
        },
      ...
      match:
        `\\b(foreach)\\s+((?!in|of).+)\\s+(in|of var(list|lis|li|l)?|of new(list|lis|li|l)?|of num(list|lis|li|l)?)\\b`,
    },
    {
      ...
      patterns: [{ include: `#macro-local-identifiers` }, { include: `#macro-local` }, { include: `#macro-global` }],
    },
    {
      begin: `\\b(forvalues|forvalue|forvalu|forval|forva|forv)\\s*`,
      beginCaptures: { 1: { name: `keyword.control.flow.stata` } },
      end: `\\s*(=)\\s*([^\\{]+)\\s*|(?=\\n)`,
      endCaptures: {
        1: { name: `keyword.operator.assignment.stata` },
        2: {
          patterns: [{ include: `#constants` }, { include: `#operators` }, { include: `#macro-local` }, {
            include: `#macro-global`,
          }],
        },
      },
    ...
    { comment: `keywords that delimit loops`, match: `\\b(while|continue)\\b`, name: `keyword.control.flow.stata` },
    {
      captures: { 1: { name: `keyword.other.stata` } },
    ...
    },
    {
      ...
      match:
        `\\b(by(sort|sor|so|s)?|statsby|rolling|bootstrap|jackknife|permute|simulate|svy|mi est(imate|imat|ima|im|i)?|nestreg|stepwise|xi|fp|mfp|vers(ion|io|i)?)\\b`,
    ...
    },
    {
      captures: {
        ...
        7: { name: `entity.name.function.stata` },
      },
      match: `\\s*(pr(ogram|ogra|ogr|og|o)?)\\s+((di(r)?|drop|l(ist|is|i)?)\\s+)([\\w&&[^0-9]]\\w{0,31})`,
    },
    {
      begin: `^\\s*(pr(ogram|ogra|ogr|og|o)?)\\s+(de(fine|fin|fi|f)?\\s+)?`,
      beginCaptures: { 1: { name: `storage.type.function.stata` }, 3: { name: `storage.type.function.stata` } },
      end: `(?=,|\\n|/)`,
      patterns: [{ include: `#macro-local` }, { include: `#macro-global` }, {
        match: `[\\w&&[^0-9]]\\w{0,31}`,
        name: `entity.name.function.stata`,
      }, { match: `[^A-za-z_0-9,\\n/ ]+`, name: `invalid.illegal.name.stata` }],
    },
    {
      captures: { 1: `keyword.functions.data.stata.test` },
    ...
    { include: `#braces-with-error` },
    {
      ...
      patterns: [{
        begin: `syntax`,
        beginCaptures: { 0: { name: `keyword.functions.program.stata` } },
        comment: `color before the comma`,
        end: `(?=,|\\n)`,
        patterns: [
          { begin: `///`, end: `\\n`, name: `comment.block.stata` },
          { match: `\\[`, name: `punctuation.definition.parameters.begin.stata` },
          { match: `\\]`, name: `punctuation.definition.parameters.end.stata` },
          {
            match: `\\b(varlist|varname|newvarlist|newvarname|namelist|name|anything)\\b`,
            name: `entity.name.type.class.stata`,
          },
          {
            captures: { 2: { name: `entity.name.type.class.stata` }, 3: { name: `keyword.operator.arithmetic.stata` } },
            match: `\\b((if|in|using|fweight|aweight|pweight|iweight))\\b(/)?`,
          },
          {
            captures: { 1: { name: `keyword.operator.arithmetic.stata` }, 2: { name: `entity.name.type.class.stata` } },
            match: `(/)?(exp)`,
          },
          { include: `#constants` },
          { include: `#operators` },
        ...
        begin: `,`,
        beginCaptures: { 0: { name: `punctuation.definition.variable.begin.stata` } },
        ...
        patterns: [
          { begin: `///`, end: `\\n`, name: `comment.block.stata` },
          {
            ...
            beginCaptures: {
              ...
              2: { name: `keyword.operator.parentheses.stata` },
            },
            comment: `color options with parentheses`,
            end: `\\)`,
            endCaptures: { 0: { name: `keyword.operator.parentheses.stata` } },
            patterns: [
              {
                captures: { 0: { name: `support.type.stata` } },
    ...
    {
      captures: { 1: { name: `keyword.functions.data.stata` } },
      comment: `one-word commands`,
      match: `\\b(sa(v|ve)|saveold|destring|tostring|u(se|s)?|note(s)?|form(at|a)?)\\b`,
    },
    { comment: `programming commands`, match: `\\b(exit|end)\\b`, name: `keyword.functions.data.stata` },
    {
      captures: {
        1: { name: `keyword.functions.data.stata` },
        2: { patterns: [{ include: `#macro-local` }] },
    ...
    },
    {
      captures: {
        ...
        5: { patterns: [{ include: `#reserved-names` }, { include: `#macro-local` }] },
    ...
    {
      captures: { 1: { name: `keyword.functions.data.stata` }, 3: { name: `support.type.stata` } },
      match: `\\b(set ty(pe|p)?)\\s+((byte|int|long|float|double|str[1-9]?[0-9]?[0-9]?[0-9]?|strL)?\\s+)\\b`,
    },
    {
      captures: {
        1: { name: `keyword.functions.data.stata` },
        3: { name: `keyword.functions.data.stata` },
        6: { name: `punctuation.definition.string.begin.stata` },
        7: {
          patterns: [
            { include: `#string-compound` },
            ...
            { include: `#macro-local` },
            { include: `#macro-global` },
            { match: '[^`\\$]{81,}', name: `invalid.illegal.name.stata` },
            { match: `.`, name: `string.quoted.double.compound.stata` },
          ],
        },
        8: { name: `punctuation.definition.string.begin.stata` },
      },
      ...
      captures: {
        ...
        7: {
          patterns: [
            ...
            { include: `#macro-global` },
            { match: '[^`\\$]{81,}', name: `invalid.illegal.name.stata` },
            { match: `.`, name: `string.quoted.double.stata` },
          ],
        },
        8: { name: `punctuation.definition.string.begin.stata` },
      },
    ...
    {
      captures: { 1: { name: `keyword.functions.data.stata` }, 3: { name: `keyword.functions.data.stata` } },
      match:
        `\\b(la(bel|be|b)?)\\s+(da(ta|t)?|var(iable|iabl|iab|ia|i)?|de(f|fi|fin|fine)?|val(ues|ue|u)?|di(r)?|l(ist|is|i)?|copy|drop|save|lang(uage|uag|ua|u)?)\\b`,
    },
    {
      begin: `\\b(drop|keep)\\b(?!\\s+(if|in)\\b)`,
      beginCaptures: { 1: { name: `keyword.functions.data.stata` } },
      end: `\\n`,
      patterns: [
        { match: `\\b(if|in)\\b`, name: `invalid.illegal.name.stata` },
        { include: `#comments` },
        { include: `#macro-local` },
        { include: `#macro-global` },
        { include: `#operators` },
    ...
    {
      captures: { 1: { name: `keyword.functions.data.stata` }, 2: { name: `keyword.functions.data.stata` } },
    ...
    },
    {
      ...
      patterns: [
        ...
        {
          captures: { 1: { name: `storage.type.eltype.mata` }, 4: { name: `storage.type.orgtype.mata` } },
          match:
        ...
        { match: `\\b(matrix|vector|rowvector|colvector|scalar)\\b`, name: `storage.type.orgtype.mata` },
        {
          match:
            `\\!|\\+\\+|\\-\\-|\\&|\\'|\\?|\\\\|\\:\\:|\\,|\\.\\.|\\||\\=|\\=\\=|\\>\\=|\\<\\=|\\<|\\>|\\!\\=|\\#|\\+|\\-|\\*|\\^|\\/`,
    ...
    {
      begin: `\\b(odbc)\\b`,
      beginCaptures: { 0: { name: `keyword.control.flow.stata` } },
      end: `\\n`,
      patterns: [{ begin: `///`, end: `\\n`, name: `comment.block.stata` }, {
        begin: `(exec?)(\\(")`,
        beginCaptures: {
        ...
        endCaptures: { 0: { name: `punctuation.definition.parameters.end.stata` } },
  ...
  o = {
    'ascii-regex-character-class': {
      patterns: [
        { match: `\\\\[\\*\\+\\?\\-\\.\\^\\$\\|\\[\\]\\(\\)\\\\]`, name: `constant.character.escape.backslash.stata` },
        { match: `\\.`, name: `constant.character.character-class.stata` },
        { match: `\\\\.`, name: `illegal.invalid.character-class.stata` },
        {
          begin: `(\\[)(\\^)?`,
          beginCaptures: {
            1: { name: `punctuation.definition.character-class.stata` },
            2: { name: `keyword.operator.negation.stata` },
          },
          end: `(\\])`,
          endCaptures: { 1: { name: `punctuation.definition.character-class.stata` } },
          name: `constant.other.character-class.set.stata`,
          patterns: [{ include: `#ascii-regex-character-class` }, {
            captures: {
              2: { name: `constant.character.escape.backslash.stata` },
    ...
    'ascii-regex-functions': {
      patterns: [{
        captures: {
          ...
          3: {
            patterns: [
              ...
              { include: `#macro-global` },
              { include: `#functions` },
              { match: `[\\w&&[^0-9]]\\w{0,31}`, name: `variable.parameter.function.stata` },
              { include: `#comments-triple-slash` },
            ],
          },
          4: { name: `punctuation.definition.variable.begin.stata` },
          5: { name: `punctuation.definition.string.begin.stata` },
          6: { patterns: [{ include: `#ascii-regex-internals` }] },
          7: { name: `punctuation.definition.string.end.stata` },
          8: { name: `invalid.illegal.punctuation.stata` },
          9: { name: `punctuation.definition.parameters.end.stata` },
        },
        ...
        captures: {
          ...
          6: { patterns: [{ include: `#ascii-regex-internals` }] },
          7: { name: `punctuation.definition.string.end.stata` },
          8: { name: `punctuation.definition.parameters.end.stata` },
        },
        ...
        captures: {
          ...
          9: {
            patterns: [
              { match: `,`, name: `punctuation.definition.variable.begin.stata` },
              { include: `#string-compound` },
              { include: `#string-regular` },
              { include: `#macro-local` },
              { include: `#macro-global` },
          ...
          10: { name: `punctuation.definition.parameters.end.stata` },
        },
    ...
    'ascii-regex-internals': {
      patterns: [
        { match: `\\^`, name: `keyword.control.anchor.stata` },
        {
          comment: `matched when not a global, but must be ascii`,
          match: `\\$(?![a-zA-Z_\\{])`,
          name: `keyword.control.anchor.stata`,
        },
        { match: `[\\?\\+\\*]`, name: `keyword.control.quantifier.stata` },
        { match: `\\|`, name: `keyword.control.or.stata` },
        {
          begin: `(\\()(?=\\?|\\*|\\+)`,
          beginCaptures: { 1: { name: `keyword.operator.group.stata` } },
          contentName: `invalid.illegal.regexm.stata`,
          end: `\\)`,
          endCaptures: { 0: { name: `keyword.operator.group.stata` } },
        },
        {
          begin: `(\\()`,
          beginCaptures: { 1: { name: `keyword.operator.group.stata` } },
          end: `(\\))`,
          endCaptures: { 1: { name: `keyword.operator.group.stata` } },
          patterns: [{ include: `#ascii-regex-internals` }],
        },
    ...
    'braces-with-error': {
      patterns: [{
        begin: `(\\{)\\s*([^\\n]*)(?=\\n)`,
        beginCaptures: {
          1: { name: `keyword.control.block.begin.stata` },
          2: { patterns: [{ include: `#comments` }, { match: `[^\\n]+`, name: `illegal.invalid.name.stata` }] },
        },
        comment: `correct with nothing else on the line but whitespace; before and after; before; after; correct`,
        end:
          `^\\s*(\\})\\s*$|^\\s*([^\\*"\\}]+)\\s+(\\})\\s*([^\\*"\\}/\\n]+)|^\\s*([^"\\*\\}]+)\\s+(\\})|\\s*(\\})\\s*([^"\\*\\}/\\n]+)|(\\})$`,
        endCaptures: {
          1: { name: `keyword.control.block.end.stata` },
          2: { name: `invalid.illegal.name.stata` },
          3: { name: `keyword.control.block.end.stata` },
          4: { name: `invalid.illegal.name.stata` },
          5: { name: `invalid.illegal.name.stata` },
          6: { name: `keyword.control.block.end.stata` },
          7: { name: `keyword.control.block.end.stata` },
          8: { name: `invalid.illegal.name.stata` },
          9: { name: `keyword.control.block.end.stata` },
        },
    ...
    'braces-without-error': {
      patterns: [{
        begin: `\\{`,
        beginCaptures: { 0: { name: `keyword.control.block.begin.stata` } },
        end: `\\}`,
        endCaptures: { 0: { name: `keyword.control.block.end.stata` } },
      }],
    },
    builtin_types: {
      patterns: [{
    ...
    builtin_variables: { patterns: [{ match: `\\b(_b|_coef|_cons|_n|_N|_rc|_se)\\b`, name: `variable.object.stata` }] },
    'commands-other': {
      patterns: [{
    ...
    comments: {
      patterns: [{ include: `#comments-double-slash` }, { include: `#comments-star` }, { include: `#comments-block` }, {
        include: `#comments-triple-slash`,
      }],
    },
    'comments-block': {
      patterns: [{
        ...
        patterns: [
          {
            comment:
              `this ends and restarts a comment block. but need to catch this so that it doesn't start _another_ level of comment blocks`,
            match: `\\*/\\*`,
          },
    ...
    'comments-double-slash': {
      patterns: [{
        ...
        patterns: [{ include: `#docblockr-comment` }],
      }],
    },
    'comments-star': {
      patterns: [{
        ...
        captures: { 0: { name: `punctuation.definition.comment.stata` } },
        comment:
          `TODO! need to except out the occasion that a * comes after a /// on the previous line. May be easiest to join with the comment.line.triple-slash.stata below`,
        end: `(?=\\n)`,
    ...
    constants: {
      patterns: [
        ...
        { match: `\\b(?i:(\\d+\\.\\d*(e[\\-\\+]?\\d+)?))(?=[^a-zA-Z_])`, name: `constant.numeric.float.stata` },
        { match: `(?<=[^0-9a-zA-Z_])(?i:(\\.\\d+(e[\\-\\+]?\\d+)?))`, name: `constant.numeric.float.stata` },
        { match: `\\b(?i:(\\d+e[\\-\\+]?\\d+))`, name: `constant.numeric.float.stata` },
        { match: `\\b(\\d+)\\b`, name: `constant.numeric.integer.decimal.stata` },
        { match: `(?<![\\w])(\\.(?![\\./]))(?![\\w])`, name: `constant.language.missing.stata` },
        { match: `\\b_all\\b`, name: `constant.language.allvars.stata` },
      ],
    },
    'docblockr-comment': {
      patterns: [{
        captures: { 1: { name: `invalid.illegal.name.stata` } },
        match: `(?<!\\w)(@(error|ERROR|Error))\\b`,
      }, { captures: { 1: { name: `keyword.docblockr.stata` } }, match: `(?<!\\w)(@\\w+)\\b` }],
    },
    docstring: {
      patterns: [{
        begin: `'''`,
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.begin.stata` } },
    ...
    factorvariables: {
      patterns: [{
        ...
        captures: { 0: { name: `constant.language.factorvars.stata` }, 3: { patterns: [{ include: `#constants` }] } },
        match: `\\b(i?b)((\\d+)|n)\\.(?=[\\w&&[^0-9]]|\\([\\w&&[^0-9]])`,
      }, {
        captures: {
          0: { name: `constant.language.factorvars.stata` },
          2: { name: `keyword.operator.parentheses.stata` },
          3: { patterns: [{ include: `#constants` }, { include: `#operators` }] },
          4: { name: `keyword.operator.parentheses.stata` },
        },
        match: `\\b(i?b)(\\()(#\\d+|first|last|freq)(\\))\\.(?=[\\w&&[^0-9]]|\\([\\w&&[^0-9]])`,
      }, {
        captures: { 0: { name: `constant.language.factorvars.stata` }, 2: { patterns: [{ include: `#constants` }] } },
        match: `\\b(i?o?)(\\d+)\\.(?=[\\w&&[^0-9]]|\\([\\w&&[^0-9]])`,
      }, {
        captures: {
          1: { name: `constant.language.factorvars.stata` },
          2: { name: `keyword.operator.parentheses.stata` },
          3: { patterns: [{ include: `$self` }] },
          4: { name: `keyword.operator.parentheses.stata` },
          5: { name: `constant.language.factorvars.stata` },
        },
    ...
    functions: {
      patterns: [{
        ...
        beginCaptures: {
          2: { name: `support.function.builtin.stata` },
          3: { name: `support.function.custom.stata` },
          4: { name: `punctuation.definition.parameters.begin.stata` },
        },
        end: `(\\))`,
        endCaptures: { 1: { name: `punctuation.definition.parameters.end.stata` } },
        patterns: [
          { match: `[\\w&&[^0-9]]\\w{0,31}`, name: `variable.parameter.function.stata` },
          {
            begin: `\\(`,
            beginCaptures: { 0: { name: `keyword.operator.parentheses.stata` } },
            end: `\\)`,
            endCaptures: { 0: { name: `keyword.operator.parentheses.stata` } },
            patterns: [
              { include: `#ascii-regex-functions` },
    ...
    'macro-commands': {
      patterns: [{
        ...
        patterns: [{
          begin: `=`,
          beginCaptures: { 0: { name: `keyword.operator.arithmetic.stata` } },
          end: `(?=\\n)`,
          patterns: [{ include: `$self` }],
        }, {
          begin: `:`,
          ...
          patterns: [{ include: `#macro-extended-functions` }],
        }],
      }, {
        begin: '\\b(gl(obal|oba|ob|o)?)\\s+(?=[\\w`\\$])',
        beginCaptures: { 1: { name: `keyword.macro.stata` } },
        end: `(\\})|(?=\\"|\\s|\\n|/|,|=)`,
        patterns: [
          { include: `#reserved-names` },
          { match: `[\\w&&[^0-9_]]\\w{0,31}`, name: `entity.name.type.class.stata` },
          { include: `#macro-local` },
          { include: `#macro-global` },
        ],
      }, {
        begin: '\\b(loc(al|a)?)\\s+(\\+\\+|\\-\\-)?(?=[\\w`\\$])',
        beginCaptures: { 1: { name: `keyword.macro.stata` }, 3: { name: `keyword.operator.arithmetic.stata` } },
        end: `(?=\\"|\\s|\\n|/|,|=)`,
        patterns: [{ include: `#macro-local-identifiers` }, { include: `#macro-local` }, { include: `#macro-global` }],
      }, {
        ...
        patterns: [{ begin: `///`, end: `\\n`, name: `comment.block.stata` }, { include: `#macro-local-identifiers` }, {
          include: `#macro-local`,
        }, { include: `#macro-global` }],
      }, {
        begin: `\\b(ma(cro|cr|c)?)\\s+(drop|l(ist|is|i)?)\\s*(?=\\s)`,
        beginCaptures: { 0: { name: `keyword.macro.stata` } },
        end: `\\n`,
        patterns: [
          { begin: `///`, end: `\\n`, name: `comment.block.stata` },
          ...
          { include: `#macro-local` },
          { include: `#comments` },
          { match: `\\w{1,31}`, name: `entity.name.type.class.stata` },
        ],
      }],
    },
    'macro-extended-functions': {
      patterns: [
        { match: `\\b(properties)\\b`, name: `keyword.macro.extendedfcn.stata` },
        {
          match:
            `\\b(t(ype|yp|y)?|f(ormat|orma|orm|or|o)?|val(ue|u)?\\s+l(able|abl|ab|a)?|var(iable|iabl|iab|ia|i)?\\s+l(abel|abe|ab|a)?|data\\s+l(able|abl|ab|a)?|sort(edby|edb|ed|e)?|lab(el|e)?|maxlength|constraint|char)\\b`,
          name: `keyword.macro.extendedfcn.stata`,
        },
        { match: `\\b(permname)\\b`, name: `keyword.macro.extendedfcn.stata` },
        { match: `\\b(adosubdir|dir|files?|dirs?|other|sysdir)\\b`, name: `keyword.macro.extendedfcn.stata` },
        { match: `\\b(env(ironment|ironmen|ironme|ironm|iron|iro|ir|i)?)\\b`, name: `keyword.macro.extendedfcn.stata` },
        {
        ...
        {
          captures: {
            1: { name: `keyword.macro.extendedfcn.stata` },
            2: { name: `keyword.macro.extendedfcn.stata` },
            3: { name: `entity.name.type.class.stata` },
          },
        ...
        },
        {
          captures: {
            1: { name: `keyword.macro.extendedfcn.stata` },
            2: { name: `entity.name.type.class.stata` },
            3: { name: `keyword.operator.list.stata` },
            4: { name: `entity.name.type.class.stata` },
          },
        ...
        },
        {
          captures: {
            1: { name: `keyword.macro.extendedfcn.stata` },
            2: { name: `punctuation.definition.string.begin.stata` },
            3: { name: `string.quoted.double.stata` },
            4: { name: `punctuation.definition.string.end.stata` },
            5: { name: `keyword.macro.extendedfcn.stata` },
            6: { name: `entity.name.type.class.stata` },
          },
          match: `\\b(list\\s+posof)\\s+(")(\\w+)(")\\s+(in)\\s+(\\w{1,32})`,
        },
        {
          match:
            `\\b(rown(ames|ame|am|a)?|coln(ames|ame|am|a)?|rowf(ullnames|ullname|ullnam|ullna|ulln|ull|ul|u)?|colf(ullnames|ullname|ullnam|ullna|ulln|ull|ul|u)?|roweq?|coleq?|rownumb|colnumb|roweqnumb|coleqnumb|rownfreeparms|colnfreeparms|rownlfs|colnlfs|rowsof|colsof|rowvarlist|colvarlist|rowlfnames|collfnames)\\b`,
          name: `keyword.macro.extendedfcn.stata`,
        },
        { match: `\\b(tsnorm)\\b`, name: `keyword.macro.extendedfcn.stata` },
        {
          captures: {
            1: { name: `keyword.macro.extendedfcn.stata` },
            7: { patterns: [{ include: `#macro-local` }, { include: `#macro-global` }] },
          },
          match: `\\b((copy|(ud|u)?strlen)\\s+(loc(al|a)?|gl(obal|oba|ob|o)?))\\s+([^']+)`,
        },
        { captures: { 1: { name: `keyword.macro.extendedfcn.stata` } }, match: `\\b(word\\s+count)` },
        {
          captures: {
            1: { name: `keyword.macro.extendedfcn.stata` },
            2: { patterns: [{ include: `#macro-local` }, { include: `#constants` }] },
            3: { name: `keyword.macro.extendedfcn.stata` },
          },
        ...
        },
        {
          ...
          beginCaptures: {
            1: { name: `keyword.macro.extendedfcn.stata` },
            5: { name: `entity.name.type.class.stata` },
          },
          end: `(?=//|\\n)`,
          patterns: [{ include: `#macro-local` }, { include: `#macro-global` }, { include: `#string-compound` }, {
            include: `#string-regular`,
          }, {
            captures: {
              1: { name: `support.function.builtin.stata` },
              ...
              3: { name: `keyword.macro.extendedfcn.stata` },
              4: { name: `entity.name.type.class.stata` },
              5: { name: `punctuation.definition.parameters.end.stata` },
            },
    ...
    'macro-global': {
      patterns: [{
        ...
        patterns: [{ include: `#macro-local` }, { include: `#macro-global` }, { include: `#comments-block` }, {
          begin: `[^\\w]`,
          end: `\\n|(?=})`,
          name: `comment.line.stata`,
        }, { match: `\\w{1,32}`, name: `entity.name.type.class.stata` }],
      }, {
        begin: `\\$`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.stata` } },
        end: `(?!\\w)`,
        endCaptures: { 1: { name: `punctuation.definition.string.end.stata` } },
        patterns: [{ include: `#macro-local` }, { include: `#macro-global` }, {
    ...
    'macro-local': {
      patterns: [{
        begin: '(`)(=)',
        beginCaptures: {
          1: { name: `punctuation.definition.string.begin.stata` },
          2: { name: `keyword.operator.comparison.stata` },
        },
        end: `'`,
        endCaptures: { 0: { name: `punctuation.definition.string.end.stata` } },
        patterns: [{ include: `$self` }],
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.stata` } },
        patterns: [{ include: `#macro-local` }, { include: `#macro-extended-functions` }, { include: `#constants` }, {
          include: `#string-compound`,
        }, { include: `#string-regular` }],
      }, {
        begin: '(`)(macval)(\\()',
        beginCaptures: {
          1: { name: `punctuation.definition.string.begin.stata` },
          2: { name: `support.function.builtin.stata` },
          3: { name: `punctuation.definition.parameters.begin.stata` },
        },
        contentName: `meta.macro-extended-function.stata`,
        end: `(\\))(')`,
        endCaptures: {
          1: { name: `punctuation.definition.parameters.begin.stata` },
          2: { name: `punctuation.definition.string.end.stata` },
        },
        patterns: [{ include: `#macro-local` }, { include: `#macro-global` }, {
          match: `\\w{1,31}`,
          name: `entity.name.type.class.stata`,
    ...
    'macro-local-identifiers': {
      patterns: [{ match: "[^\\w'`\\$\\(\\)\\s]", name: `invalid.illegal.name.stata` }, {
        match: `\\w{32,}`,
        name: `invalid.illegal.name.stata`,
      }, { match: `\\w{1,31}`, name: `entity.name.type.class.stata` }],
    },
    operators: {
      patterns: [
        ...
        { match: `\\|\\|`, name: `keyword.operator.graphcombine.stata` },
        { match: `\\&|\\|`, name: `keyword.operator.logical.stata` },
        { match: `(?:<=|>=|:=|==|!=|~=|<|>|=|!!|!)`, name: `keyword.operator.comparison.stata` },
        { match: `\\(|\\)`, name: `keyword.operator.parentheses.stata` },
        { match: `(##|#)`, name: `keyword.operator.factor-variables.stata` },
        { match: `%`, name: `keyword.operator.format.stata` },
        { match: `:`, name: `punctuation.separator.key-value` },
        { match: `\\[`, name: `punctuation.definition.parameters.begin.stata` },
        { match: `\\]`, name: `punctuation.definition.parameters.end.stata` },
        { match: `,`, name: `punctuation.definition.variable.begin.stata` },
        { match: `;`, name: `keyword.operator.delimiter.stata` },
      ],
    },
    'reserved-names': {
      patterns: [
        {
          match:
            `\\b(_all|_b|byte|_coef|_cons|double|float|if|in|int|long|_n|_N|_pi|_pred|_rc|_skip|str[0-9]+|strL|using|with)\\b`,
          name: `invalid.illegal.name.stata`,
        },
        { match: "[^\\w'`\\$\\(\\)\\s]", name: `invalid.illegal.name.stata` },
        { match: `[0-9][\\w]{31,}`, name: `invalid.illegal.name.stata` },
        { match: `\\w{33,}`, name: `invalid.illegal.name.stata` },
      ],
    },
    'string-compound': {
      patterns: [{
    ...
    'string-regular': {
      patterns: [{
        ...
        endCaptures: {
          1: { name: `punctuation.definition.string.end.stata` },
          2: { name: `invalid.illegal.punctuation.stata` },
        },
    ...
    subscripts: {
      patterns: [{
        begin: `(?<=[\\w'])(\\[)`,
        beginCaptures: { 1: { name: `punctuation.definition.parameters.begin.stata` } },
    ...
    'unicode-regex-character-class': {
      patterns: [{ match: `\\\\[wWsSdD]|\\.`, name: `constant.character.character-class.stata` }, {
        match: `\\\\.`,
        ...
        endCaptures: { 1: { name: `punctuation.definition.character-class.stata` } },
        name: `constant.other.character-class.set.stata`,
        patterns: [{ include: `#unicode-regex-character-class` }, {
          captures: {
            2: { name: `constant.character.escape.backslash.stata` },
            4: { name: `constant.character.escape.backslash.stata` },
          },
    ...
    'unicode-regex-functions': {
      patterns: [{
        captures: {
          ...
          4: { name: `punctuation.definition.variable.begin.stata` },
          5: { name: `punctuation.definition.string.begin.stata` },
          6: { patterns: [{ include: `#unicode-regex-internals` }] },
          7: { name: `punctuation.definition.string.end.stata` },
          8: { name: `invalid.illegal.punctuation.stata` },
          9: {
            patterns: [{ include: `#constants` }, { match: `,`, name: `punctuation.definition.variable.begin.stata` }],
          },
          10: { name: `punctuation.definition.parameters.end.stata` },
        },
        comment: `color regexm with regular quotes i.e. " `,
    ...
    'unicode-regex-internals': {
      patterns: [
        { match: `\\\\[bBAZzG]|\\^`, name: `keyword.control.anchor.stata` },
        {
          comment: `matched when not a global`,
          match: `\\$(?![[\\w&&[^0-9_]][\\w]{0,31}|_[\\w]{1,31}\\{])`,
          name: `keyword.control.anchor.stata`,
        },
        { match: `\\\\[1-9][0-9]?`, name: `keyword.other.back-reference.stata` },
        { match: `[?+*][?+]?|\\{(\\d+,\\d+|\\d+,|,\\d+|\\d+)\\}\\??`, name: `keyword.operator.quantifier.stata` },
        { match: `\\|`, name: `keyword.operator.or.stata` },
        {
          begin: `\\((?!\\?\\#|\\?=|\\?!|\\?<=|\\?<!)`,
          end: `\\)`,
          name: `keyword.operator.group.stata`,
          patterns: [{ include: `#unicode-regex-internals` }],
        },
        ...
        { match: `\\(\\?[iLmsux]+\\)`, name: `keyword.other.option-toggle.stata` },
        {
          begin: `(\\()((\\?=)|(\\?!)|(\\?<=)|(\\?<!))`,
          beginCaptures: {
            1: { name: `keyword.operator.group.stata` },
            2: { name: `punctuation.definition.group.assertion.stata` },
            3: { name: `keyword.assertion.look-ahead.stata` },
            4: { name: `keyword.assertion.negative-look-ahead.stata` },
            5: { name: `keyword.assertion.look-behind.stata` },
            6: { name: `keyword.assertion.negative-look-behind.stata` },
          },
          end: `(\\))`,
          endCaptures: { 1: { name: `keyword.operator.group.stata` } },
        ...
        },
        {
          ...
          beginCaptures: {
            1: { name: `punctuation.definition.group.stata` },
            2: { name: `punctuation.definition.group.assertion.conditional.stata` },
            3: { name: `entity.name.section.back-reference.stata` },
          },
          comment:
