var e = `Tcl`,
  ...
  a = [
    ...
    { captures: { 1: { name: `keyword.control.tcl` } }, match: `(?<=^|})\\s*(then|elseif|else)\\b` },
    {
  ...
  o = {
    ...
    numeric: { match: `(?<![a-zA-Z])([+-]?([0-9]*[.])?[0-9]+f?)(?![\\.a-zA-Z])`, name: `constant.numeric.tcl` },
    operator: {
    ...
    regexp: {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#braces` }, { include: `#bare-string` }, { include: `#escape` }, {
          include: `#variable`,
        }],
      }, {
        begin: `[ \\t]`,
        ...
        patterns: [{ include: `#variable` }, { include: `#embedded` }, { include: `#escape` }, { include: `#braces` }, {
          include: `#string`,
        }],
      }],
    },
