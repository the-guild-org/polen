var e = `github-dark`,
  ...
  n = !0,
  r = [
    { scope: [`comment`, `punctuation.definition.comment`, `string.comment`], settings: { foreground: `#8b949e` } },
    {
      scope: [
        `constant`,
    ...
    { scope: [`entity.name`, `meta.export.default`, `meta.definition.variable`], settings: { foreground: `#ffa657` } },
    {
      scope: [
    ...
    { scope: [`string`, `string punctuation.section.embedded source`], settings: { foreground: `#a5d6ff` } },
    ...
    { scope: `support.type.property-name.json`, settings: { foreground: `#7ee787` } },
    ...
    { scope: [`markup.heading`, `markup.heading entity.name`], settings: { fontStyle: `bold`, foreground: `#79c0ff` } },
    ...
    { scope: `markup.inline.raw`, settings: { foreground: `#79c0ff` } },
    {
