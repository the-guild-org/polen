var e = `VHDL`,
  t = [`vhd`, `vhdl`, `vho`, `vht`],
  n = `vhdl`,
  r = [{ include: `#block_processing` }, { include: `#cleanup` }],
  i = {
...
`,
        endCaptures: {
          1: { name: `keyword.language.vhdl` },
          2: { name: `meta.block.block.end` },
          5: { name: `invalid.illegal.mismatched.identifier.vhdl` },
        },
...
`,
    ...
    cleanup: {
      patterns: [{ include: `#comments` }, { include: `#constants_numeric` }, { include: `#strings` }, {
        include: `#attribute_list`,
      }, { include: `#syntax_highlighting` }],
    },
    comments: { patterns: [{ match: `--.*$\\n?`, name: `comment.line.double-dash.vhdl` }] },
...
`,
        ...
        patterns: [{ include: `#generic_list_pattern` }, { include: `#port_list_pattern` }, { include: `#comments` }],
      }],
    },
    constants_numeric: {
      patterns: [
        ...
        { match: `\\b\\d+#[\\h_]+#\\b`, name: `constant.numeric.base_pound_number_pound.vhdl` },
        { match: `\\b[\\d_]+([eE][\\d_]+)?\\b`, name: `constant.numeric.integer.vhdl` },
        { match: `[xX]"[0-9a-fA-F_uUxXzZwWlLhH\\-]+"`, name: `constant.numeric.quoted.double.string.hex.vhdl` },
        { match: `[oO]"[0-7_uUxXzZwWlLhH\\-]+"`, name: `constant.numeric.quoted.double.string.octal.vhdl` },
        { match: `[bB]?"[01_uUxXzZwWlLhH\\-]+"`, name: `constant.numeric.quoted.double.string.binary.vhdl` },
        {
          captures: { 1: { name: `invalid.illegal.quoted.double.string.vhdl` } },
          match: `([bBoOxX]".+?")`,
          name: `constant.numeric.quoted.double.string.illegal.vhdl`,
        },
        { match: `'[01uUxXzZwWlLhH\\-]'`, name: `constant.numeric.quoted.single.std_logic` },
      ],
    },
    control_patterns: {
      patterns: [{ include: `#case_pattern` }, { include: `#if_pattern` }, { include: `#for_pattern` }, {
...
`,
        ...
        patterns: [{ include: `#control_patterns` }, { include: `#parenthetical_list` }, { include: `#type_pattern` }, {
          include: `#record_pattern`,
        }, { include: `#cleanup` }],
      }],
    },
        ...
        patterns: [
          {
            ...
            endCaptures: { 0: { name: `punctuation.terminator.function_prototype.vhdl` } },
            patterns: [{ include: `#parenthetical_list` }, { include: `#cleanup` }],
          },
...
`,
    ...
    keywords: {
      patterns: [{
        match:
          `'(?i:active|ascending|base|delayed|driving|driving_value|event|high|image|instance|instance_name|last|last_value|left|leftof|length|low|path|path_name|pos|pred|quiet|range|reverse|reverse_range|right|rightof|simple|simple_name|stable|succ|transaction|val|value)\\b`,
        ...
        match:
          `\\b(?i:std|ieee|work|standard|textio|std_logic_1164|std_logic_arith|std_logic_misc|std_logic_signed|std_logic_textio|std_logic_unsigned|numeric_bit|numeric_std|math_complex|math_real|vital_primitives|vital_timing)\\b`,
        name: `standard.library.language.vhdl`,
      }, { match: `(\\+|\\-|<=|=|=>|:=|>=|>|<|/|\\||&|(\\*{1,2}))`, name: `keyword.operator.vhdl` }],
    },
        ...
        patterns: [
          {
            ...
            endCaptures: { 0: { name: `punctuation.vhdl` } },
            name: `source.vhdl`,
            patterns: [{ include: `#comments` }, { include: `#parenthetical_pair` }, { include: `#cleanup` }],
          },
...
`,
        ...
        patterns: [{ include: `#parenthetical_list` }, { include: `#control_patterns` }, { include: `#type_pattern` }, {
          include: `#record_pattern`,
        }, { include: `#cleanup` }],
      }],
    },
...
`,
        beginCaptures: {
          1: { name: `keyword.language.vhdl` },
          3: { name: `entity.name.section.protected_body.begin.vhdl` },
          4: { name: `invalid.illegal.invalid.identifier.vhdl` },
          5: { name: `keyword.language.vhdl` },
        },
        end: `(?x)
...
`,
        endCaptures: {
          1: { name: `keyword.language.vhdl` },
          4: { name: `entity.name.section.protected_body.end.vhdl` },
          5: { name: `invalid.illegal.mismatched.identifier.vhdl` },
        },
        patterns: [
          { include: `#function_definition_pattern` },
...
`,
        beginCaptures: {
          1: { name: `keyword.language.vhdls` },
          3: { name: `entity.name.section.protected.begin.vhdl` },
          4: { name: `invalid.illegal.invalid.identifier.vhdl` },
          5: { name: `keyword.language.vhdl` },
        },
        end: `(?x)
...
`,
        endCaptures: {
          1: { name: `keyword.language.vhdl` },
          4: { name: `entity.name.section.protected.end.vhdl` },
          5: { name: `invalid.illegal.mismatched.identifier.vhdl` },
        },
        patterns: [
          { include: `#function_prototype_pattern` },
    ...
    punctuation: { patterns: [{ match: `(\\.|,|:|;|\\(|\\))`, name: `punctuation.vhdl` }] },
    record_pattern: {
      patterns: [{
        begin: `\\b(?i:record)\\b`,
        beginCaptures: { 0: { name: `keyword.language.vhdl` } },
...
`,
    ...
    strings: {
      patterns: [{ match: `'.'`, name: `string.quoted.single.vhdl` }, {
        begin: `"`,
        end: `"`,
...
`,
    ...
    support_constants: {
      ...
      }, { match: `\\b(?i:true|false)\\b`, name: `support.constant.std.standard.vhdl` }],
    },
    support_functions: {
      patterns: [{ match: `\\b(?i:finish|stop|resolution_limit)\\b`, name: `support.function.std.env.vhdl` }, {
    ...
    support_types: {
      patterns: [
        ...
        { match: `\\b(?i:line|text|side|width|input|output)\\b`, name: `support.type.std.textio.vhdl` },
        {
          match: `\\b(?i:std_logic|std_ulogic|std_logic_vector|std_ulogic_vector)\\b`,
          name: `support.type.ieee.std_logic_1164.vhdl`,
        },
        { match: `\\b(?i:signed|unsigned)\\b`, name: `support.type.ieee.numeric_std.vhdl` },
        { match: `\\b(?i:complex|complex_polar)\\b`, name: `support.type.ieee.math_complex.vhdl` },
      ],
    },
    syntax_highlighting: {
      patterns: [{ include: `#keywords` }, { include: `#punctuation` }, { include: `#support_constants` }, {
...
\\b((?i:while))\\b
`,
        beginCaptures: { 2: { name: `` }, 3: { name: `punctuation.vhdl` }, 4: { name: `keyword.language.vhdl` } },
        end: `(?x)
