var e = `Visual Basic`,
  ...
  n = [
    ...
    { include: `#round-brackets` },
    {
      ...
      patterns: [{
        captures: { 1: { name: `meta.odd-tab.tabs` }, 2: { name: `meta.even-tab.tabs` } },
        match: `(\\t)(\\t)?`,
      }],
    },
    {
      ...
      name: `meta.leading-space`,
      patterns: [{
        captures: { 1: { name: `meta.odd-tab.spaces` }, 2: { name: `meta.even-tab.spaces` } },
        match: `(  )(  )?`,
      }],
    },
    {
    ...
    { match: `(?i:\\b(Mod|And|Not|Or|Xor|as)\\b)`, name: `keyword.operator.asp` },
    {
      captures: {
    ...
    {
      match:
        `(?i:\\s*\\b(Call|Class|Const|Dim|Redim|Function|Sub|Private Sub|Public Sub|End Sub|End Function|End Class|End Property|Public Property|Private Property|Set|Let|Get|New|Randomize|Option Explicit|On Error Resume Next|On Error GoTo)\\b\\s*)`,
      name: `storage.type.asp`,
    },
    { match: `(?i:\\b(Private|Public|Default)\\b)`, name: `storage.modifier.asp` },
    { match: `(?i:\\s*\\b(Empty|False|Nothing|Null|True)\\b)`, name: `constant.language.asp` },
    {
      begin: `"`,
      ...
      patterns: [{ match: `""`, name: `constant.character.escape.apostrophe.asp` }],
    },
    {
    ...
    { match: `(?i:\\b(Application|ObjectContext|Request|Response|Server|Session)\\b)`, name: `support.class.asp` },
    {
    ...
    { match: `(?i:(?<=as )(\\b[a-zA-Z_x7f-xff][a-zA-Z0-9_x7f-xff]*?\\b))`, name: `support.type.vb.asp` },
    {
      match:
  ...
  r = {
    'round-brackets': {
      begin: `\\(`,
      beginCaptures: { 0: { name: `punctuation.section.round-brackets.begin.asp` } },
      end: `\\)`,
  ...
  i = `source.asp.vb.net`,
  a = { displayName: e, name: `vb`, patterns: n, repository: r, scopeName: i }
