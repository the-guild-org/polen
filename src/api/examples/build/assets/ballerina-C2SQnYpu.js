var e = `Ballerina`,
  ...
  i = {
    ...
    booleans: { patterns: [{ match: `\\b(true|false)\\b`, name: `constant.language.boolean.ballerina` }] },
    butClause: {
      patterns: [{
        begin: `=>`,
        beginCaptures: { 0: { name: `meta.arrow.ballerina storage.type.function.arrow.ballerina` } },
        end: `,|(?=\\})`,
        patterns: [{ include: `#code` }],
      }],
    },
    butExp: {
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.block.ballerina.documentation` } },
    ...
    butExpBody: {
      patterns: [{
        begin: `\\{`,
        beginCaptures: { 0: { name: `punctuation.definition.block.ballerina.documentation` } },
        end: `(?=\\})`,
        endCaptures: { 0: { name: `punctuation.definition.block.ballerina.documentation` } },
        patterns: [{ include: `#parameter` }, { include: `#butClause` }, { include: `#comment` }],
      }],
    },
    call: {
      patterns: [{ match: `(?:\\')?([_$[:alpha:]][_$[:alnum:]]*)\\s*(?=\\()`, name: `entity.name.function.ballerina` }],
    },
    callableUnitBody: {
      patterns: [{
        begin: `\\{`,
      ...
      patterns: [
        ...
        { include: `#keywords` },
        {
          begin: `(?<=:)\\s*`,
            ...
            `(?=\\s|[;),}\\]:\\-\\+]|;|^\\s*$|(?:^\\s*(?:abstract|async|class|const|declare|enum|export|function|import|interface|let|module|namespace|return|service|type|var)\\b))`,
        },
        { include: `#decl-block` },
        { include: `#expression` },
    ...
    'class-defn': {
      ...
      beginCaptures: { 0: { name: `storage.type.class.ballerina keyword.other.ballerina` } },
      end: `(?<=\\})`,
    ...
    constrainType: {
      patterns: [{
        begin: `<`,
        beginCaptures: { 0: { name: `punctuation.definition.parameters.begin.ballerina` } },
        end: `>`,
        endCaptures: { 0: { name: `punctuation.definition.parameters.end.ballerina` } },
        patterns: [{ include: `#comment` }, { include: `#constrainType` }, {
      ...
      patterns: [
        {
          ...
          beginCaptures: { 0: { name: `keyword.control.flow.ballerina` } },
            ...
            `(?=[;}]|$|;|^\\s*$|(?:^\\s*(?:abstract|async|class|const|declare|enum|export|function|import|interface|let|module|namespace|return|service|type|var)\\b))`,
    ...
    documentationBody: {
      patterns: [{
        ...
        patterns: [
          ...
          { begin: '\\```', end: '\\```', name: `comment.block.code.ballerina.documentation` },
          { begin: '\\``', end: '\\``', name: `comment.block.code.ballerina.documentation` },
          { begin: '\\`', end: '\\`', name: `comment.block.code.ballerina.documentation` },
    ...
    'enum-decl': {
      ...
      patterns: [{ include: `#comment` }, { include: `#mdDocumentation` }, {
        begin: `\\{`,
        beginCaptures: { 0: { name: `punctuation.definition.block.ballerina` } },
        end: `\\}`,
        endCaptures: { 0: { name: `punctuation.definition.block.ballerina` } },
    ...
    expression: {
      patterns: [{ include: `#keywords` }, { include: `#expressionWithoutIdentifiers` }, { include: `#identifiers` }, {
        include: `#regex`,
      }],
    },
    'expression-operators': {
      patterns: [
        { match: `\\*=|(?<!\\()/=|%=|\\+=|\\-=`, name: `keyword.operator.assignment.compound.ballerina` },
        { match: `\\&=|\\^=|<<=|>>=|>>>=|\\|=`, name: `keyword.operator.assignment.compound.bitwise.ballerina` },
        ...
        { match: `\\!|&&|\\|\\||\\?\\?`, name: `keyword.operator.logical.ballerina` },
    ...
    'flags-on-off': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#regexp` }, { include: `#template-substitution-element` }],
      }],
    },
    'for-loop': {
      begin: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))foreach\\s*`,
      beginCaptures: { 0: { name: `keyword.control.loop.ballerina` }, 1: { name: `support.type.primitive.ballerina` } },
      end: `(?=\\{)`,
      patterns: [
    ...
    'function-body': {
      patterns: [{ include: `#comment` }, { include: `#functionParameters` }, { include: `#decl-block` }, {
        begin: `\\=>`,
        beginCaptures: { 0: { name: `meta.arrow.ballerina storage.type.function.arrow.ballerina` } },
        end: `(?=\\;)|(?=\\,)|(?=)(?=\\);)`,
        name: `meta.block.ballerina`,
    ...
    'function-defn': {
      ...
      beginCaptures: { 1: { name: `keyword.other.ballerina` }, 2: { name: `keyword.other.ballerina` } },
      end: `(?<=\\;)|(?<=\\})|(?<=\\,)|(?=)(?=\\);)`,
    ...
    functionReturns: {
      ...
      patterns: [
        ...
        { include: `#keywords` },
        { include: `#type-primitive` },
        { captures: { 1: { name: `support.type.primitive.ballerina` } }, match: `\\s*\\b(var)(?=\\s+|\\[|\\?)` },
        { match: `\\|`, name: `keyword.operator.ballerina` },
        { match: `\\?`, name: `keyword.operator.optional.ballerina` },
        { include: `#type-annotation` },
        { include: `#type-tuple` },
        { include: `#keywords` },
        { match: `[_$[:alpha:]][_$[:alnum:]]*`, name: `variable.other.readwrite.ballerina` },
      ],
    },
    functionType: {
      patterns: [{
        ...
        patterns: [{ include: `#comment` }, { include: `#functionTypeParamList` }, { include: `#functionTypeReturns` }],
      }],
    },
    ...
    functionTypeReturns: {
      patterns: [{
        ...
        patterns: [{ include: `#functionTypeReturnsParameter` }, { include: `#comment` }],
      }],
    },
    functionTypeReturnsParameter: {
      patterns: [{
        ...
        patterns: [
          ...
          { include: `#comment` },
          { include: `#parameterTuple` },
          { match: `[_$[:alpha:]][_$[:alnum:]]*`, name: `default.variable.parameter.ballerina` },
        ],
      }],
    },
    functionTypeType: {
...
\\s*=>
        ...
        { include: `#type-primitive` },
        { include: `#self-literal` },
        { match: `\\b(check|foreach|if|checkpanic)\\b`, name: `keyword.control.ballerina` },
        { include: `#call` },
        ...
        { match: `(\\')([_$[:alpha:]][_$[:alnum:]]*)`, name: `variable.other.property.ballerina` },
        { include: `#type-annotation` },
      ],
    },
    'if-statement': {
    ...
    'import-clause': {
      ...
      }, { match: `([_$[:alpha:]][_$[:alnum:]]*)`, name: `variable.other.readwrite.alias.ballerina` }],
    },
    'import-declaration': {
      begin: `\\bimport\\b`,
    ...
    keywords: {
      patterns: [
        ...
        { match: `(=>)`, name: `meta.arrow.ballerina storage.type.function.arrow.ballerina` },
        {
          match: `(!|%|\\+|\\-|~=|===|==|=|!=|!==|<|>|&|\\||\\?:|\\.\\.\\.|<=|>=|&&|\\|\\||~|>>|>>>)`,
    ...
    literal: {
      patterns: [{ include: `#booleans` }, { include: `#numbers` }, { include: `#strings` }, { include: `#maps` }, {
        include: `#self-literal`,
      }, { include: `#array-literal` }],
    },
    maps: { patterns: [{ begin: `\\{`, end: `\\}`, patterns: [{ include: `#code` }] }] },
    matchBindingPattern: {
      patterns: [{
        begin: `var`,
        beginCaptures: { 0: { name: `storage.type.ballerina` } },
        end: `(?==>)|,`,
        patterns: [{ include: `#errorDestructure` }, { include: `#code` }, {
          match: `[_$[:alpha:]][_$[:alnum:]]*`,
    ...
    matchStatement: {
      patterns: [{
        ...
        patterns: [{ include: `#matchStatementBody` }, { include: `#comment` }, { include: `#code` }],
      }],
    },
    matchStatementBody: {
      patterns: [{
    ...
    mdDocumentation: {
      ...
      patterns: [{ include: `#mdDocumentationReturnParamDescription` }, {
    ...
    mdDocumentationReturnParamDescription: {
      patterns: [{
        ...
        patterns: [{ match: `#.*`, name: `comment.mddocs.returnparamdesc.ballerina` }],
      }],
    },
    multiType: {
      patterns: [{
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
        ...
        {
          captures: { 0: { name: `meta.object-literal.key.ballerina` }, 1: { name: `entity.name.function.ballerina` } },
          match:
...
\\s*=>
        ...
        {
          captures: { 1: { name: `keyword.control.as.ballerina` }, 2: { name: `storage.modifier.ballerina` } },
    ...
    objectMemberFunctionDec: {
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.block.ballerina` } },
        patterns: [{ include: `#functionParameters` }, { match: `\\breturns\\b`, name: `keyword.ballerina` }, {
          include: `#code`,
        }],
      }],
    },
    ...
    'parameter-name': {
      patterns: [{ captures: { 1: { name: `support.type.primitive.ballerina` } }, match: `\\s*\\b(var)\\s+` }, {
        captures: {
    ...
    parameterTuple: {
      patterns: [{
        ...
        patterns: [{ include: `#record` }, { include: `#objectDec` }, { include: `#parameterTupleType` }, {
    ...
    parameterTupleEnd: {
      patterns: [{
        ...
        patterns: [{ include: `#defaultWithParentheses` }, {
          match: `[_$[:alpha:]][_$[:alnum:]]*`,
    ...
    paranthesisedBracket: {
      patterns: [{ begin: `\\[`, end: `\\]`, patterns: [{ include: `#comment` }, { include: `#code` }] }],
    },
    ...
    'punctuation-comma': { patterns: [{ match: `,`, name: `punctuation.separator.comma.ballerina` }] },
    'punctuation-semicolon': { patterns: [{ match: `;`, name: `punctuation.terminator.statement.ballerina` }] },
    record: {
      begin: `\\brecord\\b`,
      beginCaptures: { 0: { name: `keyword.other.ballerina` } },
      end: `(?<=\\})`,
    ...
    regex: {
      patterns: [{
        ...
        endCaptures: { 1: { name: `punctuation.definition.regexp.template.end.ballerina` } },
        name: `regexp.template.ballerina`,
        patterns: [{ include: `#template-substitution-element` }, { include: `#regexp` }],
      }],
    },
    'regex-character-class': {
      patterns: [{ match: `\\\\[wWsSdDtrn]|\\.`, name: `keyword.other.character-class.regexp.ballerina` }, {
        match: `\\\\[^pPu]`,
    ...
    'regex-unicode-property-key': {
      patterns: [{
        begin: `(sc=|gc=)`,
        beginCaptures: { 1: { name: `keyword.other.unicode-property-key.regexp.ballerina` } },
        end: `()`,
        endCaptures: { 1: { name: `punctuation.other.unicode-property.end.regexp.ballerina` } },
    ...
    regexp: {
      patterns: [
        ...
        { match: `[?+*]|\\{(\\d+,\\d+|\\d+,|,\\d+|\\d+)\\}\\??`, name: `keyword.operator.quantifier.regexp.ballerina` },
        { match: `\\|`, name: `keyword.operator.or.regexp.ballerina` },
        {
          begin: `(\\()`,
          beginCaptures: { 1: { name: `punctuation.definition.group.regexp.ballerina` } },
          end: `(\\))`,
          endCaptures: { 1: { name: `punctuation.definition.group.regexp.ballerina` } },
        ...
        },
        {
          ...
          endCaptures: { 1: { name: `punctuation.definition.character-class.end.regexp.ballerina` } },
    ...
    'service-decl': {
      ...
      patterns: [{ include: `#class-defn` }, { include: `#serviceName` }, { include: `#serviceOn` }, {
        include: `#serviceBody`,
      }, { include: `#objectDec` }],
    },
    serviceBody: {
      patterns: [{ include: `#comment` }, { include: `#mdDocumentation` }, { include: `#documentationDef` }, {
        include: `#decl-block`,
      }],
    },
    serviceName: {
    ...
    source: {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.other.ballerina` }, 2: { name: `variable.other.readwrite.ballerina` } },
        end: `(?=\\,)|(?=\\;)`,
      }],
    },
    statements: {
    ...
    string: {
      patterns: [{
        begin: `"`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.ballerina` } },
        end: `(")|((?:[^\\\\\\n])$)`,
        endCaptures: {
    ...
    stringTemplate: {
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.template.end.ballerina` } },
    ...
    strings: {
      patterns: [{
        ...
        patterns: [{ match: `\\\\.`, name: `constant.character.escape.ballerina` }, { match: `.`, name: `string` }],
      }],
    },
    'template-substitution-element': {
      patterns: [{
        begin: `\\$\\{`,
        beginCaptures: { 0: { name: `punctuation.definition.template-expression.begin.ballerina` } },
        contentName: `meta.embedded.line.ballerina`,
        end: `\\}`,
        endCaptures: { 0: { name: `punctuation.definition.template-expression.end.ballerina` } },
    ...
    tupleType: {
      patterns: [{
        ...
        patterns: [{ include: `#comment` }, { include: `#constrainType` }, { include: `#paranthesisedBracket` }, {
          match: `\\b([_$[:alpha:]][_$[:alnum:]]*)\\b`,
          name: `storage.type.ballerina`,
        }],
      }],
    ...
    type: {
      patterns: [{ include: `#comment` }, { include: `#string` }, { include: `#numbers` }, {
        include: `#type-primitive`,
      }, { include: `#type-tuple` }],
    },
    'type-annotation': {
      patterns: [{
        begin: `(\\:)`,
        beginCaptures: { 1: { name: `keyword.operator.type.annotation.ballerina` } },
        end:
          `(?<![:|&])((?=$|^|[,);\\}\\]\\?\\>\\=>]|//)|(?==[^>])|((?<=[\\}>\\]\\)]|[_$[:alpha:]])\\s*(?=\\{)))(\\?)?`,
    ...
    typeDefinition: {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.other.ballerina` }, 2: { name: `entity.name.type.ballerina` } },
        end: `\\;`,
        endCaptures: { 0: { name: `punctuation.terminator.statement.ballerina` } },
        patterns: [
          { include: `#functionParameters` },
    ...
    typeDescription: {
      patterns: [{
        ...
        patterns: [{ include: `#numbers` }, { include: `#decl-block` }, { include: `#type-primitive` }, {
          match: `[_$[:alpha:]][_$[:alnum:]]*`,
          name: `storage.type.ballerina`,
        }],
      }],
    ...
    types: {
      patterns: [
        { match: `\\b(handle|any|future|typedesc)\\b`, name: `storage.type.ballerina` },
        {
          match: `\\b(boolean|int|string|float|decimal|byte|json|xml|anydata)\\b`,
          name: `support.type.primitive.ballerina`,
        },
        { match: `\\b(map|error|never|readonly|distinct)\\b`, name: `storage.type.ballerina` },
    ...
    'unicode-values': {
      patterns: [{
        ...
        endCaptures: { 1: { name: `punctuation.other.unicode-value.end.regexp.ballerina` } },
        name: `keyword.other.unicode-value.ballerina`,
        patterns: [{ match: `([0-9A-Fa-f]{1,6})`, name: `constant.other.unicode-value.regexp.ballerina` }],
      }],
    },
    'var-expr': {
      patterns: [
        {
          begin: `(?=\\b(var))`,
          beginCaptures: { 0: { name: `storage.modifier.ballerina support.type.primitive.ballerina` } },
          end:
            `(?!\\b(var))((?=;|}|;|^\\s*$|(?:^\\s*(?:abstract|async|class|const|declare|enum|export|function|import|interface|let|module|namespace|return|service|type|var)\\b))|((?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(?=(if)\\s+))|((?<!^string|[^\\._$[:alnum:]]string|^int|[^\\._$[:alnum:]]int)(?=\\s*$)))`,
        ...
        { include: `#punctuation-comma` },
        {
          begin: `(?=\\b(const(?!\\s+enum\\b)))`,
            ...
            `(?!\\b(const(?!\\s+enum\\b)))((?=\\bannotation\\b|;|}|;|^\\s*$|(?:^\\s*(?:abstract|async|class|const|declare|enum|export|function|import|interface|let|module|namespace|return|service|type|var)\\b))|((?<!^string|[^\\._$[:alnum:]]string|^int|[^\\._$[:alnum:]]int)(?=\\s*$)))`,
          name: `meta.var.expr.ballerina`,
          patterns: [
            {
        ...
        { include: `#punctuation-comma` },
        {
          ...
          beginCaptures: { 0: { name: `support.type.primitive.ballerina` } },
            ...
            `(?!\\b(var))((?=;|}|;|^\\s*$|(?:^\\s*(?:abstract|async|class|const|declare|enum|export|function|import|interface|let|module|namespace|return|service|type|var)\\b))|((?<!^string|[^\\._$[:alnum:]]string|^int|[^\\._$[:alnum:]]int)(?=\\s*$)))`,
          name: `meta.var.expr.ballerina`,
          patterns: [
            { include: `#xml` },
            {
    ...
    'var-single-const': {
      patterns: [
        ...
        { begin: `\\b(var)\\s*`, beginCaptures: { 0: { name: `support.type.primitive.ballerina` } }, end: `(?=\\S)` },
        { include: `#types` },
        {
          begin: `([_$[:alpha:]][_$[:alnum:]]*)`,
          beginCaptures: { 1: { name: `meta.definition.variable.ballerina variable.other.constant.ballerina` } },
          end: `(?=$|^|[;,=}]|((?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))\\s+))`,
        },
      ],
    },
    ...
    variableDef: {
      patterns: [{
        ...
        patterns: [{ include: `#tupleType` }, { include: `#constrainType` }, { include: `#comment` }],
      }],
    },
    variableDefInline: {
      patterns: [{
    ...
    workerBody: { patterns: [{ begin: `\\{`, end: `(?=\\})`, patterns: [{ include: `#code` }] }] },
    workerDef: {
      patterns: [{
        begin: `\\bworker\\b`,
        beginCaptures: { 0: { name: `keyword.ballerina` } },
    ...
    xml: {
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.template.end.ballerina` } },
        name: `string.template.ballerina`,
        patterns: [{ include: `#xmlTag` }, { include: `#xmlComment` }, { include: `#templateVariable` }, {
          match: `.`,
          name: `string`,
        }],
      }],
    ...
    xmlTag: {
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.tag.end.xml.ballerina` } },
        patterns: [{ include: `#xmlSingleQuotedString` }, { include: `#xmlDoubleQuotedString` }, {
          match: `xmlns`,
          name: `keyword.other.ballerina`,
        }, { match: `([a-zA-Z0-9-]+)`, name: `entity.other.attribute-name.xml.ballerina` }],
      }],
    },
  },
  a = `source.ballerina`,
