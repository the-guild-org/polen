var e = `Apex`,
  t = [`apex`, `cls`, `trigger`],
  n = `apex`,
  r = [{ include: `#javadoc-comment` }, { include: `#comment` }, { include: `#directives` }, {
  ...
  i = {
    ...
    'argument-list': {
      ...
      endCaptures: { 0: { name: `punctuation.parenthesis.close.apex` } },
      patterns: [{ include: `#named-argument` }, { include: `#expression` }, { include: `#punctuation-comma` }],
    },
...
(?=\\[)`,
    ...
    'boolean-literal': {
      patterns: [{ match: `(?<!\\.)\\btrue\\b`, name: `constant.language.boolean.true.apex` }, {
        match: `(?<!\\.)\\bfalse\\b`,
    ...
    'bracketed-argument-list': {
      ...
      patterns: [{ include: `#soql-query-expression` }, { include: `#named-argument` }, { include: `#expression` }, {
        include: `#punctuation-comma`,
      }],
    },
    'break-or-continue-statement': {
      captures: { 1: { name: `keyword.control.flow.break.apex` }, 2: { name: `keyword.control.flow.continue.apex` } },
...
\\b(class)\\b\\s+
(@?[_[:alpha:]][_[:alnum:]]*)\\s*`,
          beginCaptures: { 1: { name: `keyword.other.class.apex` }, 2: { name: `entity.name.type.class.apex` } },
          end: `(?=\\{)`,
          patterns: [{ include: `#javadoc-comment` }, { include: `#comment` }, { include: `#type-parameter-list` }, {
    ...
    'colon-expression': { match: `:`, name: `keyword.operator.conditional.colon.apex` },
    comment: {
      patterns: [{
        begin: `/\\*(\\*)?`,
        ...
        begin: `(^\\s+)?(?=//)`,
        beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.apex` } },
        end: `(?=$)`,
        patterns: [{
          begin: `(?<!/)///(?!/)`,
          beginCaptures: { 0: { name: `punctuation.definition.comment.apex` } },
    ...
    'conditional-operator': {
      begin: `(?<!\\?)\\?(?!\\?|\\.|\\[)`,
      beginCaptures: { 0: { name: `keyword.operator.conditional.question-mark.apex` } },
      end: `:`,
    ...
    'constructor-declaration': {
      ...
      patterns: [
        { captures: { 1: { name: `entity.name.function.apex` } }, match: `(@?[_[:alpha:]][_[:alnum:]]*)\\b` },
        {
          begin: `(:)`,
    ...
    declarations: { patterns: [{ include: `#type-declarations` }, { include: `#punctuation-semicolon` }] },
...
(?=\\[)`,
      beginCaptures: {
        1: { patterns: [{ include: `#punctuation-accessor` }, { include: `#operator-safe-navigation` }] },
      ...
      patterns: [
        {
          ...
          patterns: [{ include: `#javadoc-comment` }, { include: `#comment` }, {
            captures: { 1: { name: `keyword.other.enum.apex` }, 2: { name: `entity.name.type.enum.apex` } },
        ...
        },
        {
          ...
          endCaptures: { 0: { name: `punctuation.curlybrace.close.apex` } },
          patterns: [{ include: `#javadoc-comment` }, { include: `#comment` }, { include: `#punctuation-comma` }, {
            begin: `@?[_[:alpha:]][_[:alnum:]]*`,
            beginCaptures: { 0: { name: `entity.name.variable.enum-member.apex` } },
            end: `(?=(,|\\}))`,
            patterns: [{ include: `#javadoc-comment` }, { include: `#comment` }, { include: `#variable-initializer` }],
          }],
        },
        { include: `#javadoc-comment` },
        { include: `#comment` },
    ...
    'expression-operators': {
      patterns: [
        { match: `\\*=|/=|%=|\\+=|-=`, name: `keyword.operator.assignment.compound.apex` },
        { match: `\\&=|\\^=|<<=|>>=|\\|=`, name: `keyword.operator.assignment.compound.bitwise.apex` },
    ...
    'extends-class': {
      ...
      beginCaptures: { 1: { name: `keyword.other.extends.apex` }, 2: { name: `entity.name.type.extends.apex` } },
      end: `(?={|implements)`,
    },
    'field-declaration': {
      begin: `(?x)
...
(?!=>|==)(?=,|;|=|$)`,
      ...
      patterns: [
        { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `entity.name.variable.field.apex` },
        { include: `#punctuation-comma` },
        { include: `#comment` },
        { include: `#variable-initializer` },
    ...
    'from-clause': {
      captures: { 1: { name: `keyword.operator.query.from.apex` }, 2: { name: `storage.type.apex` } },
    ...
    'goto-statement': {
      ...
      patterns: [
        ...
        { captures: { 1: { name: `keyword.control.default.apex` } }, match: `\\b(default)\\b` },
        { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `entity.name.label.apex` },
      ],
    },
    identifier: { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `variable.other.readwrite.apex` },
    'if-statement': {
      begin: `(?<!\\.)\\b(if)\\b\\s*(?=\\()`,
    ...
    'implements-class': {
      ...
      beginCaptures: { 1: { name: `keyword.other.implements.apex` }, 2: { name: `entity.name.type.implements.apex` } },
      end: `(?={|extends)`,
    },
    'indexer-declaration': {
      begin: `(?x)
...
(?=\\[)`,
      ...
      patterns: [{ include: `#comment` }, { include: `#property-accessors` }, { include: `#expression-body` }, {
        include: `#variable-initializer`,
      }],
    },
...
(?=\\()`,
    ...
    'javadoc-comment': {
      patterns: [{
        ...
        }, { captures: { 1: { name: `string.quoted.single.apex` } }, match: '(`([^`]+?)`)' }],
      }],
    },
    literal: {
      patterns: [{ include: `#boolean-literal` }, { include: `#null-literal` }, { include: `#numeric-literal` }, {
...
(?=,|;|=)`,
      ...
      patterns: [
        { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `entity.name.variable.local.apex` },
        { include: `#punctuation-comma` },
        { include: `#comment` },
        { include: `#variable-initializer` },
      ],
...
\\s*\\.\\s*@?[_[:alpha:]][_[:alnum:]]*
    ...
    'merge-expression': {
      ...
      patterns: [{ include: `#object-creation-expression` }, { include: `#merge-type-statement` }, {
        include: `#expression`,
      }, { include: `#punctuation-semicolon` }],
    },
...
(?=\\()`,
      beginCaptures: {
        1: { patterns: [{ include: `#support-type` }, { include: `#type` }] },
        6: { patterns: [{ include: `#type` }, { include: `#punctuation-accessor` }] },
        7: { patterns: [{ include: `#support-type` }, { include: `#method-name-custom` }] },
    ...
    'method-name-custom': { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `entity.name.function.apex` },
    'named-argument': {
      begin: `(@?[_[:alpha:]][_[:alnum:]]*)\\s*(:)`,
      beginCaptures: {
    ...
    'null-literal': { match: `(?<!\\.)\\bnull\\b`, name: `constant.language.null.apex` },
    'numeric-literal': {
      patterns: [
        {
        ...
        { match: `\\b(\\d{4}\\-\\d{2}\\-\\d{2})\\b`, name: `constant.numeric.date.apex` },
        { match: `\\b0(x|X)[0-9a-fA-F_]+(U|u|L|l|UL|Ul|uL|ul|LU|Lu|lU|lu)?\\b`, name: `constant.numeric.hex.apex` },
        { match: `\\b0(b|B)[01_]+(U|u|L|l|UL|Ul|uL|ul|LU|Lu|lU|lu)?\\b`, name: `constant.numeric.binary.apex` },
        { match: `\\b([0-9_]+)?\\.[0-9_]+((e|E)[0-9]+)?(F|f|D|d|M|m)?\\b`, name: `constant.numeric.decimal.apex` },
        { match: `\\b[0-9_]+(e|E)[0-9_]+(F|f|D|d|M|m)?\\b`, name: `constant.numeric.decimal.apex` },
        { match: `\\b[0-9_]+(F|f|D|d|M|m)\\b`, name: `constant.numeric.decimal.apex` },
        { match: `\\b[0-9_]+(U|u|L|l|UL|Ul|uL|ul|LU|Lu|lU|lu)?\\b`, name: `constant.numeric.decimal.apex` },
      ],
    },
...
(?=\\()`,
    ...
    'operator-assignment': { match: `(?<!=|!)(=)(?!=)`, name: `keyword.operator.assignment.apex` },
    'operator-safe-navigation': { match: `\\?\\.`, name: `keyword.operator.safe-navigation.apex` },
    'orderby-clause': {
...
(\\g<identifier>)`,
    ...
    'parenthesized-parameter-list': {
      ...
      endCaptures: { 0: { name: `punctuation.parenthesis.close.apex` } },
      patterns: [{ include: `#comment` }, { include: `#parameter` }, { include: `#punctuation-comma` }, {
        include: `#variable-initializer`,
      }],
    },
    'property-accessors': {
...
(?=\\{|=>|$)`,
    ...
    'punctuation-semicolon': { match: `;`, name: `punctuation.terminator.statement.apex` },
    'query-operators': {
    ...
    'script-top-level': {
      patterns: [{ include: `#method-declaration` }, { include: `#statement` }, { include: `#punctuation-semicolon` }],
    },
    'sharing-modifier': {
    ...
    'soql-colon-method-statement': {
      begin: `(:?\\.)?([_[:alpha:]][_[:alnum:]]*)(?=\\()`,
      beginCaptures: { 1: { name: `punctuation.accessor.apex` }, 2: { name: `entity.name.function.apex` } },
      end: `(?<=\\))`,
      patterns: [{
        begin: `\\(`,
        beginCaptures: { 0: { name: `punctuation.parenthesis.open.apex` } },
      ...
      patterns: [
        { include: `#trigger-context-declaration` },
        {
          captures: {
            ...
            2: { patterns: [{ include: `#punctuation-accessor` }, { include: `#operator-safe-navigation` }] },
          },
    ...
    'soql-functions': {
      ...
      beginCaptures: { 1: { name: `support.function.query.apex` }, 2: { name: `punctuation.parenthesis.open.apex` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.parenthesis.close.apex` } },
      patterns: [{ include: `#literal` }, { include: `#punctuation-comma` }, { include: `#soql-functions` }, {
        match: `[_.[:alpha:]][_.[:alnum:]]*`,
    ...
    'soql-query-expression': {
      ...
      patterns: [
        ...
        { include: `#literal` },
        {
          captures: { 1: { name: `keyword.query.field.apex` }, 2: { name: `punctuation.separator.comma.apex` } },
    ...
    'string-character-escape': { match: `\\\\.`, name: `constant.character.escape.apex` },
    'string-literal': {
      begin: `'`,
    ...
    'support-arguments': {
      begin: `<`,
      beginCaptures: { 0: { name: `punctuation.definition.typeparameters.begin.apex` } },
      end: `>`,
      endCaptures: { 0: { name: `punctuation.definition.typeparameters.end.apex` } },
      patterns: [{ include: `#comment` }, { include: `#support-type` }, { include: `#punctuation-comma` }],
    },
    'support-class': {
...
(ApexPages|Database|DMLException|Exception|PageReference|Savepoint|SchedulableContext|Schema|SObject|System|Test)(?=\\.|\\s)`,
      ...
      patterns: [
        ...
        {
          captures: { 1: { name: `punctuation.accessor.apex` }, 2: { name: `support.function.apex` } },
          match: `(?:(\\.))([[:alpha:]]*)(?=\\()`,
        },
        {
          captures: { 1: { name: `punctuation.accessor.apex` }, 2: { name: `support.type.apex` } },
          match: `(?:(\\.))([[:alpha:]]+)`,
        },
        {
          begin: `\\(`,
    ...
    'support-type': {
      name: `support.apex`,
      patterns: [{ include: `#comment` }, { include: `#support-class` }, { include: `#support-functions` }, {
...
(\\{)`,
      beginCaptures: {
        ...
        3: { patterns: [{ include: `#statement` }, { include: `#parenthesized-expression` }] },
    ...
    'this-expression': { captures: { 1: { name: `keyword.other.this.apex` } }, match: `\\b(?:(this))\\b` },
    'throw-expression': {
    ...
    'trigger-context-declaration': {
      begin: `\\b(?:(Trigger))\\b(\\.)\\b`,
      beginCaptures: { 1: { name: `support.class.trigger.apex` }, 2: { name: `punctuation.accessor.apex` } },
      end: `(?=\\})|(?=;)|(?=\\)|(?=\\]))`,
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.parenthesis.close.apex` } },
        patterns: [{ include: `#trigger-type-statement` }, { include: `#javadoc-comment` }, { include: `#comment` }, {
          include: `#expression`,
        }],
      }, { include: `#expression` }],
    },
...
([_[:alpha:]][_[:alnum:]]*)\\s*`,
          ...
          patterns: [
            {
              ...
              endCaptures: { 0: { name: `punctuation.parenthesis.close.apex` } },
              patterns: [{ include: `#trigger-type-statement` }, { include: `#trigger-operator-statement` }, {
                include: `#punctuation-comma`,
              }, { include: `#expression` }],
            },
            { include: `#javadoc-comment` },
        ...
        },
        {
          ...
          endCaptures: { 0: { name: `punctuation.curlybrace.close.apex` } },
          patterns: [{ include: `#statement` }, { include: `#class-or-trigger-members` }],
        },
        { include: `#javadoc-comment` },
        { include: `#comment` },
      ],
    ...
    'type-arguments': {
      ...
      endCaptures: { 0: { name: `punctuation.definition.typeparameters.end.apex` } },
      patterns: [{ include: `#comment` }, { include: `#support-type` }, { include: `#type` }, {
        include: `#punctuation-comma`,
      }],
    },
    'type-array-suffix': {
    ...
    'type-name': {
      patterns: [{
        captures: { 1: { name: `storage.type.apex` }, 2: { name: `punctuation.accessor.apex` } },
        match: `(@?[_[:alpha:]][_[:alnum:]]*)\\s*(\\.)`,
      }, {
        captures: { 1: { name: `punctuation.accessor.apex` }, 2: { name: `storage.type.apex` } },
        match: `(\\.)\\s*(@?[_[:alpha:]][_[:alnum:]]*)`,
      }, { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `storage.type.apex` }],
    },
    'type-nullable-suffix': { captures: { 0: { name: `punctuation.separator.question-mark.apex` } }, match: `\\?` },
    'type-parameter-list': {
      begin: `\\<`,
      beginCaptures: { 0: { name: `punctuation.definition.typeparameters.begin.apex` } },
      end: `\\>`,
    ...
    'when-statement': {
      ...
      beginCaptures: { 1: { name: `keyword.control.switch.when.apex` }, 2: { patterns: [{ include: `#expression` }] } },
      end: `(?<=\\})`,
      patterns: [{ include: `#block` }, { include: `#expression` }],
    },
    'when-string': {
      ...
      beginCaptures: {
        ...
        3: { patterns: [{ include: `#when-string-statement` }, { include: `#punctuation-comma` }] },
      },
      end: `(?<=\\})`,
      patterns: [{ include: `#block` }, { include: `#expression` }],
    },
    ...
    'where-clause': { captures: { 1: { name: `keyword.operator.query.where.apex` } }, match: `\\b(WHERE)\\b\\s*` },
    'while-statement': {
      begin: `(?<!\\.)\\b(while)\\b\\s*(?=\\()`,
...
(;)`,
    ...
    'xml-string': {
      patterns: [{
        ...
        begin: `\\"`,
        beginCaptures: { 0: { name: `punctuation.definition.stringdoublequote.begin.apex` } },
        end: `\\"`,
        endCaptures: { 0: { name: `punctuation.definition.stringdoublequote.end.apex` } },
