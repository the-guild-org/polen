var e = `AsciiDoc`,
  t = [`ad`, `asc`, `adoc`, `asciidoc`, `adoc.txt`],
  n = `asciidoc`,
  r = [
    { include: `#comment` },
  ...
  i = {
    'admonition-paragraph': {
      patterns: [{
        ...
        patterns: [
          {
            captures: { 0: { patterns: [{ include: `#block-attribute-inner` }] } },
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#inlines` }, { include: `#list` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        captures: { 1: { name: `entity.name.function.asciidoc` } },
        end: `^\\p{Blank}*$`,
        name: `markup.admonition.asciidoc`,
      ...
      patterns: [{
        ...
        beginCaptures: {
          ...
          4: {
            ...
            patterns: [{ include: `#inlines` }, { include: `#hard-break-backslash` }, { include: `#line-break` }, {
        ...
        endCaptures: { 0: { name: `string.unquoted.attribute-value.asciidoc` } },
        ...
        captures: {
          ...
          4: {
            name: `string.unquoted.attribute-value.asciidoc`,
            patterns: [{ include: `#inlines` }, { include: `#line-break` }],
          },
        },
        match: `^(:)(!?\\w.*?)(:)(\\p{Blank}+(.*))?$`,
        name: `meta.definition.attribute-entry.asciidoc`,
    ...
    'block-attribute-inner': {
      patterns: [{ comment: `separators`, match: `([,.#%])`, name: `punctuation.separator.asciidoc` }, {
        captures: { 0: { name: `markup.meta.attribute-list.asciidoc`, patterns: [{ include: `#keywords` }] } },
        comment: `blockname`,
        match: `(?<=\\[)([^\\[\\],.#%=]+)`,
      }, {
        captures: { 0: { patterns: [{ include: `#attribute-reference` }] } },
        comment: `attributes`,
        match: `(?<=\\{|,|.|#|"|'|%)([^\\],.#%]+)`,
    ...
    'block-title': {
      patterns: [{
        begin: `^\\.([^\\p{Blank}.].*)`,
        captures: { 1: { name: `markup.heading.blocktitle.asciidoc` } },
        end: `$`,
      }],
    },
    blocks: {
    ...
    characters: {
      patterns: [{
        captures: { 1: { name: `constant.character.asciidoc` }, 3: { name: `constant.character.asciidoc` } },
        match: `(?<!\\\\)(&)(\\S+?)(;)`,
    ...
    comment: {
      patterns: [{
        ...
        patterns: [{ include: `#inlines` }],
      }, { match: `^/{2}([^/].*)?$`, name: `comment.inline.asciidoc` }],
    },
    'comment-paragraph': {
      patterns: [{
        begin: `(?=(?>(?:^\\[(comment)((?:,|#|\\.|%)[^\\]]+)*\\]$)))`,
    ...
    'example-paragraph': {
      patterns: [{
        ...
        patterns: [
          ...
          { include: `#block-title` },
          { begin: `^(={4,})$`, comment: `example block`, end: `^(\\1)$`, patterns: [{ include: `$self` }] },
          { begin: `^(-{2})$`, comment: `open block`, end: `^(\\1)$`, patterns: [{ include: `$self` }] },
          { include: `#inlines` },
        ],
      }, {
        begin: `^(={4,})$`,
    ...
    'general-block-macro': {
      patterns: [{
        captures: {
          ...
          3: { name: `markup.link.asciidoc`, patterns: [{ include: `#attribute-reference` }] },
          4: { name: `punctuation.separator.asciidoc` },
          5: { name: `string.unquoted.asciidoc`, patterns: [{ include: `#attribute-reference` }] },
          6: { name: `punctuation.separator.asciidoc` },
        },
        match: `^(\\p{Word}+)(::)(\\S*?)(\\[)((?:\\\\\\]|[^\\]])*?)(\\])$`,
    ...
    'hard-break-backslash': {
      patterns: [{
        captures: { 1: { name: `constant.other.symbol.hard-break.asciidoc` } },
        match: `(?<=\\S)\\p{Blank}+(\\+ \\\\)$`,
      }],
    },
    'horizontal-rule': {
    ...
    'kbd-macro': {
      patterns: [{
        captures: { 1: { name: `entity.name.function.asciidoc` }, 3: { name: `string.unquoted.asciidoc` } },
        match: `(?<!\\\\)(kbd|btn):(\\[)((?:\\\\\\]|[^\\]])+?)(\\])`,
    ...
    keywords: {
      patterns: [{
        ...
        comment: `Diagram`,
        match:
          `(actdiag|blockdiag|ditaa|graphviz|meme|mermaid|nwdiag|packetdiag|pikchr|plantuml|rackdiag|seqdiag|shaape|wavedrom)`,
        name: `entity.name.function.asciidoc`,
      }, {
        comment: `Others`,
        match:
    ...
    'line-break': {
      patterns: [{ captures: { 1: { name: `variable.line-break.asciidoc` } }, match: `(?<=\\S)\\p{Blank}+(\\+)$` }],
    },
    ...
    'link-macro': {
      patterns: [{
        captures: {
          1: { name: `markup.link.asciidoc`, patterns: [{ include: `#attribute-reference` }] },
          2: { name: `string.unquoted.asciidoc` },
        },
        match:
          `(?:^|<|[\\s>\\(\\)\\[\\];])((?<!\\\\)(?:https?|file|ftp|irc)://[^\\s\\[\\]<]*[^\\s.,\\[\\]<\\)])(?:\\[((?:\\\\\\]|[^\\]])*?)\\])?`,
        ...
        captures: {
          1: { name: `entity.name.function.asciidoc` },
          2: { name: `markup.link.asciidoc`, patterns: [{ include: `#attribute-reference` }] },
          3: { name: `string.unquoted.asciidoc` },
        },
        match: `(?<!\\\\)(link|mailto):([^\\s\\[]+)(?:\\[((?:\\\\\\]|[^\\]])*?)\\])`,
        name: `markup.other.url.asciidoc`,
    ...
    list: {
      patterns: [{
        captures: { 1: { name: `markup.list.bullet.asciidoc` }, 2: { name: `markup.todo.box.asciidoc` } },
        match: `^\\s*(-)\\p{Blank}(\\[[\\p{Blank}\\*x]\\])(?=\\p{Blank})`,
        name: `markup.todo.asciidoc`,
      }, {
        captures: { 1: { name: `markup.list.bullet.asciidoc` } },
        ...
        captures: {
          1: { patterns: [{ include: `#link-macro` }, { include: `#attribute-reference` }] },
    ...
    'listing-paragraph': {
      patterns: [{
        ...
        patterns: [
          ...
          { include: `#block-title` },
          { begin: `^(-{4,})\\s*$`, comment: `listing block`, end: `^(\\1)$` },
          { begin: `^(-{2})\\s*$`, comment: `open block`, end: `^(\\1)$` },
          { include: `#inlines` },
        ],
      }],
    },
    'literal-paragraph': {
      patterns: [{
        ...
        patterns: [
          ...
          { include: `#block-title` },
          { begin: `^(\\.{4,})$`, comment: `literal block`, end: `^(\\1)$` },
          { begin: `^(-{2})\\s*$`, comment: `open block`, end: `^(\\1)$` },
          { include: `#inlines` },
        ],
      }, { begin: `^(\\.{4,})$`, end: `^(\\1)$`, name: `markup.block.literal.asciidoc` }],
    },
    mark: {
      patterns: [{
        captures: {
    ...
    'open-block': {
      patterns: [{
        begin: `^(-{2})$`,
        beginCaptures: { 1: { name: `constant.other.symbol.asciidoc` } },
        end: `^(\\1)$`,
        endCaptures: { 1: { name: `constant.other.symbol.asciidoc` } },
    ...
    'passthrough-macro': {
      patterns: [{
        captures: {
          1: { name: `markup.meta.attribute-list.asciidoc` },
          3: { name: `support.constant.asciidoc` },
          4: { name: `string.unquoted.asciidoc`, patterns: [{ include: `text.html.basic` }] },
    ...
    'passthrough-paragraph': {
      patterns: [{
        ...
        patterns: [
          {
            captures: { 0: { name: `markup.heading.asciidoc`, patterns: [{ include: `#block-attribute-inner` }] } },
            match: `^\\[(pass)((?:,|#|\\.|%)([^,\\]]+))*\\]$`,
          },
          { include: `#block-title` },
          {
          ...
          { begin: `^(-{2})\\s*$`, comment: `open block`, end: `(?<=\\1)`, patterns: [{ include: `text.html.basic` }] },
        ],
      }, {
        begin: `(^\\+{4,}$)`,
        end: `\\1`,
    ...
    'sidebar-paragraph': {
      patterns: [{
        ...
        patterns: [
          ...
          { include: `#block-title` },
          { begin: `^(\\*{4,})$`, comment: `sidebar block`, end: `^(\\1)$`, patterns: [{ include: `$self` }] },
          { begin: `^(-{2})$`, comment: `open block`, end: `^(\\1)$`, patterns: [{ include: `$self` }] },
          { include: `#inlines` },
        ],
      }, {
      ...
      patterns: [{
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.c` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.clojure` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.coffee` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.cpp` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.css` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.cs` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.diff` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, {
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.elixir` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.elm` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.erlang` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.go` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.groovy` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.haskell` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.java` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.js` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.json` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.js.jsx` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.julia` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.kotlin` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.gfm` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.objc` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.ocaml` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.perl` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.perl6` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `text.html.php` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.python` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.r` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.ruby` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.rust` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.sass` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.scala` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.shell` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.sql` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.swift` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.toml` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.ts` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `text.xml` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        patterns: [
          ...
          { include: `#block-title` },
          {
            ...
            patterns: [{ include: `#block-callout` }, { include: `#include-directive` }, { include: `source.yaml` }],
          },
          {
            begin: `^(-{2})\\s*$`,
            comment: `open block`,
        ...
        begin: `^(-{4,})\\s*$`,
        beginCaptures: { 0: { name: `support.asciidoc` } },
        end: `^(\\1)$`,
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.raw.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `#include-directive` }],
      }],
    },
    'source-markdown': {
      patterns: [{
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.c.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.c` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.clojure.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.clojure` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.coffee.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.coffee` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.cpp.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.cpp` }],
      }, {
        begin: '^\\s*(`{3,})\\s*(?i:(css))\\s*$',
        beginCaptures: { 0: { name: `support.asciidoc` } },
        contentName: `source.embedded.css`,
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.css.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.css` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.cs.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.cs` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.diff.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.diff` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.dockerfile.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.dockerfile` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.elixir.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.elixir` }],
      }, {
        begin: '^\\s*(`{3,})\\s*(?i:(elm))\\s*$',
        beginCaptures: { 0: { name: `support.asciidoc` } },
        contentName: `source.embedded.elm`,
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.elm.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.elm` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.erlang.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.erlang` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.go.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.go` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.groovy.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.groovy` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.haskell.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.haskell` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.html.basic.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `text.html.basic` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.java.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.java` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.js.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.js` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.json.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.json` }],
      }, {
        begin: '^\\s*(`{3,})\\s*(?i:(jsx))\\s*$',
        beginCaptures: { 0: { name: `support.asciidoc` } },
        contentName: `source.embedded.js.jsx`,
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.js.jsx.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.js.jsx` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.julia.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.julia` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.kotlin.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.kotlin` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.css.less.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.css.less` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.makefile.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.makefile` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.gfm.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.gfm` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.html.mustache.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `text.html.mustache` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.objc.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.objc` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.ocaml.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.ocaml` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.perl.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.perl` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.perl6.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.perl6` }],
      }, {
        begin: '^\\s*(`{3,})\\s*(?i:(php))\\s*$',
        beginCaptures: { 0: { name: `support.asciidoc` } },
        contentName: `text.embedded.html.php`,
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.html.php.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `text.html.php` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.asciidoc.properties.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.asciidoc.properties` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.python.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.python` }],
      }, {
        begin: '^\\s*(`{3,})\\s*(?i:(r))\\s*$',
        beginCaptures: { 0: { name: `support.asciidoc` } },
        contentName: `source.embedded.r`,
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.r.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.r` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.ruby.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.ruby` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.rust.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.rust` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.sass.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.sass` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.scala.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.scala` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.css.scss.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.css.scss` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.shell.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.shell` }],
      }, {
        begin: '^\\s*(`{3,})\\s*(?i:(sql))\\s*$',
        beginCaptures: { 0: { name: `support.asciidoc` } },
        contentName: `source.embedded.sql`,
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.sql.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.sql` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.swift.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.swift` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.toml.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.toml` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.ts.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.ts` }],
      }, {
        begin: '^\\s*(`{3,})\\s*(?i:(xml))\\s*$',
        beginCaptures: { 0: { name: `support.asciidoc` } },
        contentName: `text.embedded.xml`,
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.xml.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `text.xml` }],
      }, {
        ...
        endCaptures: { 0: { name: `support.asciidoc` } },
        name: `markup.code.yaml.asciidoc`,
        patterns: [{ include: `#block-callout` }, { include: `source.yaml` }],
      }, {
        begin: '^\\s*(`{3,}).*$',
        beginCaptures: { 0: { name: `support.asciidoc` } },
        end: `^\\s*\\1\\s*$`,
    ...
    'source-paragraphs': { patterns: [{ include: `#source-asciidoctor` }, { include: `#source-markdown` }] },
    'stem-macro': {
      patterns: [{
    ...
    'table-csv': {
      patterns: [{
        begin: `^(,===)$`,
        beginCaptures: { 0: { name: `markup.table.delimiter.asciidoc` } },
        contentName: `string.unquoted.asciidoc`,
        end: `^(\\1)$`,
        endCaptures: { 0: { name: `markup.table.delimiter.asciidoc` } },
        name: `markup.table.csv.asciidoc`,
        patterns: [{ include: `text.csv` }, {
          captures: { 0: { name: `markup.table.cell.delimiter.asciidoc` } },
    ...
    tables: {
      patterns: [{ include: `#table-psv` }, { include: `#table-nested` }, { include: `#table-csv` }, {
        include: `#table-dsv`,
      }],
    },
    'tables-includes': {
    ...
    titles: {
      patterns: [{
        begin: `^((?:=|#){6})([\\p{Blank}]+)(?=\\S+)`,
        beginCaptures: { 1: { name: `markup.heading.marker.asciidoc` }, 2: { name: `markup.heading.space.asciidoc` } },
        end: `$`,
