var e = `YAML`,
  t = [`yaml`, `yml`, `rviz`, `reek`, `clang-format`, `yaml-tmlanguage`, `syntax`, `sublime-syntax`],
  n = `^%YAML( ?1.\\d+)?`,
  r = `yaml`,
  i = [
    { include: `#comment` },
  ...
  a = {
    'block-collection': { patterns: [{ include: `#block-sequence` }, { include: `#block-mapping` }] },
    'block-mapping': { patterns: [{ include: `#block-pair` }] },
    'block-node': {
      patterns: [{ include: `#prototype` }, { include: `#block-scalar` }, { include: `#block-collection` }, {
    ...
    'block-pair': {
      patterns: [{
        begin: `\\?`,
        beginCaptures: { 1: { name: `punctuation.definition.key-value.begin.yaml` } },
        end: `(?=\\?)|^ *(:)|(:)`,
        endCaptures: {
...
`,
        patterns: [{ include: `#flow-scalar-plain-out-implicit-type` }, {
          begin: `(?x)
[^\\s[-?:,\\[\\]{}#&*!|>'"%@\`]]
| [?:-] \\S
`,
...
`,
      ...
      }, { match: `:(?=\\s|$)`, name: `punctuation.separator.key-value.mapping.yaml` }],
    },
    'block-scalar': {
      begin: `(?:(\\|)|(>))([1-9])?([-+])?(.*\\n?)`,
      beginCaptures: {
      ...
      patterns: [{ begin: `^([ ]+)(?! )`, end: `^(?!\\1|\\s*$)`, name: `string.unquoted.block.yaml` }],
    },
    'block-sequence': { match: `(-)(?!\\S)`, name: `punctuation.definition.block.sequence.item.yaml` },
    comment: {
      begin: `(?:(^[ \\t]*)|[ \\t]+)(?=#\\p{Print}*$)`,
    ...
    directive: {
      begin: `^%`,
      beginCaptures: { 0: { name: `punctuation.definition.directive.begin.yaml` } },
      end: `(?=$|[ \\t]+($|#))`,
...
`,
        ...
        match: `(?x) \\G (\\w+) (?:[ \\t]+ (\\w+) (?:[ \\t]+ (\\w+))? )?`,
      }, { match: `\\S+`, name: `invalid.illegal.unrecognized.yaml` }],
    },
    'flow-alias': {
      captures: {
    ...
    'flow-collection': { patterns: [{ include: `#flow-sequence` }, { include: `#flow-mapping` }] },
    'flow-mapping': {
      begin: `\\{`,
      ...
      patterns: [{ include: `#prototype` }, { match: `,`, name: `punctuation.separator.mapping.yaml` }, {
        include: `#flow-pair`,
      }],
    },
    'flow-node': {
      patterns: [{ include: `#prototype` }, { include: `#flow-alias` }, { include: `#flow-collection` }, {
        include: `#flow-scalar`,
      }],
    },
    'flow-pair': {
      patterns: [
        {
          ...
          patterns: [{ include: `#prototype` }, { include: `#flow-pair` }, { include: `#flow-node` }, {
            begin: `:(?=\\s|$|[\\[\\]{},])`,
...
`,
          ...
          patterns: [{ include: `#flow-scalar-plain-in-implicit-type` }, {
            begin: `(?x)
[^\\s[-?:,\\[\\]{}#&*!|>'"%@\`]]
| [?:-] [^\\s[\\[\\]{},]]
`,
...
`,
        ...
        {
          begin: `:(?=\\s|$|[\\[\\]{},])`,
          captures: { 0: { name: `punctuation.separator.key-value.mapping.yaml` } },
          end: `(?=[},\\]])`,
    ...
    'flow-scalar': {
      patterns: [{ include: `#flow-scalar-double-quoted` }, { include: `#flow-scalar-single-quoted` }, {
...
`,
    ...
    'flow-scalar-single-quoted': {
      ...
      patterns: [{ match: `''`, name: `constant.character.escape.single-quoted.yaml` }],
    },
    'flow-sequence': {
      begin: `\\[`,
      ...
      patterns: [{ include: `#prototype` }, { match: `,`, name: `punctuation.separator.sequence.yaml` }, {
        include: `#flow-pair`,
      }, { include: `#flow-node` }],
    },
    'flow-value': {
...
`,
      ...
      }, { match: `\\S+`, name: `invalid.illegal.tag-handle.yaml` }],
    },
    prototype: { patterns: [{ include: `#comment` }, { include: `#property` }] },
  },
  o = `source.yaml`,
