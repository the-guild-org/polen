var e = `GDShader`,
  ...
  i = {
    ...
    arraySize: {
      ...
      patterns: [{ include: `#comment` }, { include: `#keyword` }, { include: `#element` }, { include: `#separator` }],
    },
    classifier: {
      begin: `(?=\\b(?:shader_type|render_mode)\\b)`,
      end: `(?<=;)`,
      name: `meta.classifier.gdshader`,
      patterns: [{ include: `#comment` }, { include: `#keyword` }, { include: `#identifierClassification` }, {
        include: `#separator`,
      }],
    },
    classifierKeyword: { match: `\\b(?:shader_type|render_mode)\\b`, name: `keyword.language.classifier.gdshader` },
    comment: { patterns: [{ include: `#commentLine` }, { include: `#commentBlock` }] },
    commentBlock: { begin: `/\\*`, end: `\\*/`, name: `comment.block.gdshader` },
    commentLine: { begin: `//`, end: `$`, name: `comment.line.double-slash.gdshader` },
    constantFloat: { match: `\\b(?:E|PI|TAU)\\b`, name: `constant.language.float.gdshader` },
    constructor: {
    ...
    definition: { patterns: [{ include: `#structDefinition` }] },
    element: {
      patterns: [
    ...
    fieldDefinition: {
      begin: `\\b[a-zA-Z_]\\w*\\b`,
      beginCaptures: {
        0: { patterns: [{ include: `#typeKeyword` }, { match: `.+`, name: `entity.name.type.gdshader` }] },
      },
      end: `(?<=;)`,
    ...
    fieldName: { match: `\\b[a-zA-Z_]\\w*\\b`, name: `entity.name.variable.field.gdshader` },
    hintKeyword: {
      match:
    ...
    identifierClassification: { match: `\\b[a-z_]+\\b`, name: `entity.other.inherited-class.gdshader` },
    identifierField: {
      captures: { 1: { name: `punctuation.accessor.gdshader` }, 2: { name: `entity.name.variable.field.gdshader` } },
    ...
    identifierVariable: { match: `\\b[a-zA-Z_]\\w*\\b`, name: `variable.name.gdshader` },
    keyword: {
      patterns: [
    ...
    languageVariable: { match: `\\b(?:[A-Z][A-Z_0-9]*)\\b`, name: `variable.language.gdshader` },
    literalBool: { match: `\\b(?:false|true)\\b`, name: `constant.language.boolean.gdshader` },
    literalFloat: {
      match: `\\b(?:\\d+[eE][-+]?\\d+|(?:\\d*[.]\\d+|\\d+[.])(?:[eE][-+]?\\d+)?)[fF]?`,
      name: `constant.numeric.float.gdshader`,
    },
    literalInt: { match: `\\b(?:0[xX][0-9A-Fa-f]+|\\d+[uU]?)\\b`, name: `constant.numeric.integer.gdshader` },
    modifierKeyword: {
    ...
    separator: {
      patterns: [{ match: `[.]`, name: `punctuation.accessor.gdshader` }, { include: `#separatorComma` }, {
        match: `[;]`,
        name: `punctuation.terminator.statement.gdshader`,
      }, { match: `[:]`, name: `keyword.operator.type.annotation.gdshader` }],
    },
    separatorComma: { match: `[,]`, name: `punctuation.separator.comma.gdshader` },
    structDefinition: {
      begin: `(?=\\b(?:struct)\\b)`,
      end: `(?<=;)`,
      patterns: [{ include: `#comment` }, { include: `#keyword` }, { include: `#structName` }, {
    ...
    structDefinitionBlock: {
      ...
      patterns: [{ include: `#comment` }, { include: `#precisionKeyword` }, { include: `#fieldDefinition` }, {
        include: `#keyword`,
      }, { include: `#any` }],
    },
    structKeyword: { match: `\\b(?:struct)\\b`, name: `keyword.other.struct.gdshader` },
    structName: { match: `\\b[a-zA-Z_]\\w*\\b`, name: `entity.name.type.struct.gdshader` },
    swizzling: {
      captures: { 1: { name: `punctuation.accessor.gdshader` }, 2: { name: `variable.other.property.gdshader` } },
