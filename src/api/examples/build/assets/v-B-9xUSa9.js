var e = `V`,
  ...
  i = {
    ...
    brackets: {
      patterns: [{
        begin: `{`,
        beginCaptures: { 0: { name: `punctuation.definition.bracket.curly.begin.v` } },
        end: `}`,
        endCaptures: { 0: { name: `punctuation.definition.bracket.curly.end.v` } },
        patterns: [{ include: `$self` }],
      }, {
        begin: `\\(`,
        beginCaptures: { 0: { name: `punctuation.definition.bracket.round.begin.v` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.definition.bracket.round.end.v` } },
        patterns: [{ include: `$self` }],
      }, {
        begin: `\\[`,
        beginCaptures: { 0: { name: `punctuation.definition.bracket.square.begin.v` } },
        end: `\\]`,
        endCaptures: { 0: { name: `punctuation.definition.bracket.square.end.v` } },
        patterns: [{ include: `$self` }],
      }],
    },
    'builtin-fix': {
      patterns: [{
        patterns: [{ match: `(const)(?=\\s*\\()`, name: `storage.modifier.v` }, {
          match: `\\b(fn|type|enum|struct|union|interface|map|assert|sizeof|typeof|__offsetof)\\b(?=\\s*\\()`,
          name: `keyword.$1.v`,
        }],
      }, {
        patterns: [{ match: `(\\$if|\\$else)(?=\\s*\\()`, name: `keyword.control.v` }, {
          match:
    ...
    'function-exist': {
      captures: {
        ...
        1: { patterns: [{ include: `#illegal-name` }, { match: `\\w+`, name: `entity.name.function.v` }] },
    ...
    'function-extend-decl': {
      captures: {
        ...
        6: { patterns: [{ include: `#illegal-name` }, { match: `\\w+`, name: `entity.name.function.v` }] },
    ...
    'function-limited-overload-decl': {
      captures: {
        ...
        10: { patterns: [{ include: `#illegal-name` }, { match: `\\w+`, name: `entity.name.function.v` }] },
      },
      match:
    ...
    generic: {
      patterns: [{
        captures: {
          ...
          2: { patterns: [{ include: `#illegal-name` }, { match: `\\w+`, name: `entity.name.generic.v` }] },
    ...
    interface: {
      captures: {
        ...
        3: { patterns: [{ include: `#illegal-name` }, { match: `\\w+`, name: `entity.name.interface.v` }] },
      },
      match: `^\\s*(?:(pub)?\\s+)?(interface)\\s+(\\w*)`,
      name: `meta.definition.interface.v`,
    },
    keywords: {
      patterns: [{ match: `(\\$if|\\$else)`, name: `keyword.control.v` }, {
        match:
    ...
    numbers: {
      patterns: [
        { match: `([0-9]+(_?))+(\\.)([0-9]+[eE][-+]?[0-9]+)`, name: `constant.numeric.exponential.v` },
        { match: `([0-9]+(_?))+(\\.)([0-9]+)`, name: `constant.numeric.float.v` },
        { match: `(?:0b)(?:(?:[0-1]+)(?:_?))+`, name: `constant.numeric.binary.v` },
        { match: `(?:0o)(?:(?:[0-7]+)(?:_?))+`, name: `constant.numeric.octal.v` },
        { match: `(?:0x)(?:(?:[0-9a-fA-F]+)(?:_?))+`, name: `constant.numeric.hex.v` },
        { match: `(?:(?:[0-9]+)(?:[_]?))+`, name: `constant.numeric.integer.v` },
      ],
    },
    operators: {
      patterns: [
        { match: `(\\+|\\-|\\*|\\/|\\%|\\+\\+|\\-\\-|\\>\\>|\\<\\<)`, name: `keyword.operator.arithmetic.v` },
        { match: `(\\=\\=|\\!\\=|\\>|\\<|\\>\\=|\\<\\=)`, name: `keyword.operator.relation.v` },
        {
          match:
            `(\\:\\=|\\=|\\+\\=|\\-\\=|\\*\\=|\\/\\=|\\%\\=|\\&\\=|\\|\\=|\\^\\=|\\~\\=|\\&\\&\\=|\\|\\|\\=|\\>\\>\\=|\\<\\<\\=)`,
    ...
    punctuations: {
      patterns: [{ match: `(?:\\.)`, name: `punctuation.accessor.v` }, {
        match: `(?:,)`,
    ...
    'string-escaped-char': {
      ...
      }, { match: `\\\\[^0-7\\$xuUabfnrtv\\'"]`, name: `invalid.illegal.unknown-escape.v` }],
    },
    'string-interpolation': {
      captures: {
        1: {
          patterns: [{ match: `\\$\\d[\\.\\w]+`, name: `invalid.illegal.v` }, {
            match: `\\$([\\.\\w]+|\\{.*?\\})`,
    ...
    strings: {
      patterns: [{
        ...
        patterns: [{ include: `#string-escaped-char` }, { include: `#string-interpolation` }, {
        ...
        patterns: [{ include: `#string-interpolation` }, { include: `#string-placeholder` }],
      }, {
        begin: `(r)"`,
        beginCaptures: { 1: { name: `storage.type.string.v` } },
        end: `"`,
    ...
    struct: {
      patterns: [{
        ...
        endCaptures: { 1: { name: `punctuation.definition.bracket.curly.end.v` } },
        ...
        patterns: [
          { include: `#struct-access-modifier` },
          {
            captures: {
              ...
              2: {
                patterns: [{ include: `#numbers` }, { include: `#brackets` }, { include: `#types` }, {
                  match: `\\w+`,
    ...
    'struct-access-modifier': {
      captures: { 1: { name: `storage.modifier.$1.v` }, 2: { name: `punctuation.separator.struct.key-value.v` } },
    ...
    type: {
      captures: {
        ...
        3: {
          patterns: [{ include: `#illegal-name` }, { include: `#types` }, {
            match: `\\w+`,
    ...
    types: {
      ...
      }, { match: `(?<!\\.)\\b(bool|byte|byteptr|charptr|voidptr|string|ustring|rune)\\b`, name: `storage.type.$1.v` }],
    },
    'variable-assign': {
      captures: {
        0: { patterns: [{ match: `[a-zA-Z_]\\w*`, name: `variable.other.assignment.v` }, { include: `#punctuation` }] },
      },
      match: `[a-zA-Z_]\\w*(?:,\\s*[a-zA-Z_]\\w*)*(?=\\s*(?:=|:=))`,
    },
  },
  a = `source.v`,
  o = { displayName: `V`, fileTypes: t, name: `v`, patterns: r, repository: i, scopeName: a }
