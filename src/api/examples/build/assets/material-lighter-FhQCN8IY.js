var e = `material-lighter`,
  t = !0,
  n = [
    { name: `Global settings`, settings: { background: `#FAFAFA`, foreground: `#90A4AE` } },
    { name: `String`, scope: `string`, settings: { foreground: `#91B859` } },
    { name: `Punctuation`, scope: `punctuation, constant.other.symbol`, settings: { foreground: `#39ADB5` } },
    {
      name: `String Escape`,
      scope: `constant.character.escape, text.html constant.character.entity.named`,
      settings: { foreground: `#90A4AE` },
    },
    { name: `Boolean`, scope: `constant.language.boolean`, settings: { foreground: `#FF5370` } },
    { name: `Number`, scope: `constant.numeric`, settings: { foreground: `#F76D47` } },
    {
      name: `Variable`,
      scope:
    ...
    { name: `Other Keyword`, scope: `keyword.other`, settings: { foreground: `#F76D47` } },
    {
      name: `Keyword`,
      scope: `keyword, modifier, variable.language.this, support.type.object, constant.language`,
      settings: { foreground: `#39ADB5` },
    },
    { name: `Function call`, scope: `entity.name.function, support.function`, settings: { foreground: `#6182B8` } },
    { name: `Storage`, scope: `storage.type, storage.modifier, storage.control`, settings: { foreground: `#9C3EDA` } },
    {
      name: `Modules`,
      scope: `support.module, support.node`,
      settings: { foreground: `#E53935`, fontStyle: `italic` },
    },
    { name: `Type`, scope: `support.type, constant.other.key`, settings: { foreground: `#E2931D` } },
    {
      name: `Type`,
      scope: `entity.name.type, entity.other.inherited-class, entity.other`,
      settings: { foreground: `#E2931D` },
    },
    { name: `Comment`, scope: `comment`, settings: { foreground: `#90A4AE`, fontStyle: `italic` } },
    {
      name: `Comment`,
      scope: `comment punctuation.definition.comment, string.quoted.docstring`,
      settings: { foreground: `#90A4AE`, fontStyle: `italic` },
    },
    { name: `Punctuation`, scope: `punctuation`, settings: { foreground: `#39ADB5` } },
    {
      name: `Class`,
    ...
    { name: `Class method`, scope: `meta.definition.method entity.name.function`, settings: { foreground: `#E53935` } },
    { name: `Function definition`, scope: `meta.function entity.name.function`, settings: { foreground: `#6182B8` } },
    {
    ...
    { name: `YAML key`, scope: `entity.name.tag.yaml`, settings: { foreground: `#E53935` } },
    {
      name: `JSON key`,
      scope: `meta.object-literal.key, meta.object-literal.key string, support.type.property-name.json`,
      settings: { foreground: `#E53935` },
    },
    { name: `JSON constant`, scope: `constant.language.json`, settings: { foreground: `#39ADB5` } },
    { name: `CSS class`, scope: `entity.other.attribute-name.class`, settings: { foreground: `#E2931D` } },
    { name: `CSS ID`, scope: `entity.other.attribute-name.id`, settings: { foreground: `#F76D47` } },
    { name: `CSS tag`, scope: `source.css entity.name.tag`, settings: { foreground: `#E2931D` } },
    { name: `CSS properties`, scope: `support.type.property-name.css`, settings: { foreground: `#8796B0` } },
    { name: `HTML tag outer`, scope: `meta.tag, punctuation.definition.tag`, settings: { foreground: `#39ADB5` } },
    { name: `HTML tag inner`, scope: `entity.name.tag`, settings: { foreground: `#E53935` } },
    { name: `HTML tag attribute`, scope: `entity.other.attribute-name`, settings: { foreground: `#9C3EDA` } },
    { name: `HTML entities`, scope: `punctuation.definition.entity.html`, settings: { foreground: `#90A4AE` } },
    { name: `Markdown heading`, scope: `markup.heading`, settings: { foreground: `#39ADB5` } },
    {
    ...
    { name: `Markdown italic`, scope: `markup.italic`, settings: { foreground: `#E53935`, fontStyle: `italic` } },
    { name: `Markdown bold`, scope: `markup.bold`, settings: { foreground: `#E53935`, fontStyle: `bold` } },
    {
      name: `Markdown bold italic`,
      scope: `markup.bold markup.italic, markup.italic markup.bold`,
      settings: { foreground: `#E53935`, fontStyle: `italic bold` },
    },
    {
      name: `Markdown code block`,
      scope: `markup.fenced_code.block.markdown punctuation.definition.markdown`,
      settings: { foreground: `#91B859` },
    },
    { name: `Markdown inline code`, scope: `markup.inline.raw.string.markdown`, settings: { foreground: `#91B859` } },
    { name: `INI property name`, scope: `keyword.other.definition.ini`, settings: { foreground: `#E53935` } },
    { name: `INI section title`, scope: `entity.name.section.group-title.ini`, settings: { foreground: `#39ADB5` } },
    { name: `C# class`, scope: `source.cs meta.class.identifier storage.type`, settings: { foreground: `#E2931D` } },
    {
      name: `C# class method`,
    ...
    },
    {
      ...
      settings: { foreground: `#6182B8` },
    },
    { name: `C# type`, scope: `source.cs storage.type`, settings: { foreground: `#E2931D` } },
    { name: `C# return type`, scope: `source.cs meta.method.return-type`, settings: { foreground: `#E2931D` } },
    { name: `C# preprocessor`, scope: `source.cs meta.preprocessor`, settings: { foreground: `#90A4AE` } },
    { name: `C# namespace`, scope: `source.cs entity.name.type.namespace`, settings: { foreground: `#90A4AE` } },
    { name: `JSX Text`, scope: `meta.jsx.children, SXNested`, settings: { foreground: `#90A4AE` } },
    { name: `JSX Components name`, scope: `support.class.component`, settings: { foreground: `#E2931D` } },
    {
    ...
    { name: `Blocks`, scope: `meta.block`, settings: { foreground: `#E53935` } },
    { name: `Function Call`, scope: `entity.name.function.call`, settings: { foreground: `#6182B8` } },
    {
      name: `Namespaces`,
      scope: `source.php support.other.namespace, source.php meta.use support.class`,
      settings: { foreground: `#90A4AE` },
    },
    { name: `Constant keywords`, scope: `constant.keyword`, settings: { foreground: `#39ADB5`, fontStyle: `italic` } },
    { name: `Entity name`, scope: `entity.name.function`, settings: { foreground: `#6182B8` } },
    { name: `Global settings`, settings: { background: `#FAFAFA`, foreground: `#90A4AE` } },
    { name: `Markup Deleted`, scope: [`markup.deleted`], settings: { foreground: `#E53935` } },
    { name: `Markup Inserted`, scope: [`markup.inserted`], settings: { foreground: `#91B859` } },
    { name: `Markup Underline`, scope: [`markup.underline`], settings: { fontStyle: `underline` } },
    { name: `Keyword Control`, scope: [`keyword.control`], settings: { foreground: `#39ADB5`, fontStyle: `italic` } },
    ...
    },
    {
      ...
      settings: { foreground: `#F76D47` },
    },
    {
      name: `Markdown - Blockquote`,
      scope: [`markup.quote`],
      settings: { fontStyle: `italic`, foreground: `#39ADB5` },
    },
    { name: `Markdown - Fenced Language`, scope: [`markup.fenced_code.block`], settings: { foreground: `#90A4AE90` } },
    {
  ...
  i = { name: e, semanticHighlighting: !0, tokenColors: n, colors: r }
export { e as name, i as default, n as tokenColors, r as colors, t as semanticHighlighting }
