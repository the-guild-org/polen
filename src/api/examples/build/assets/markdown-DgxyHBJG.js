var e = `Markdown`,
  t = `markdown`,
  n = [{ include: `#frontMatter` }, { include: `#block` }],
  r = {
    ampersand: {
      comment:
...
`,
    ...
    fenced_code_block_unknown: {
      begin: '(^|\\G)(\\s*)(`{3,}|~{3,})\\s*(?=([^`]*)?$)',
      beginCaptures: { 3: { name: `punctuation.definition.markdown` }, 4: { name: `fenced_code.block.language` } },
      end: `(^|\\G)(\\2|\\s{0,3})(\\3)\\s*$`,
      endCaptures: { 3: { name: `punctuation.definition.markdown` } },
      name: `markup.fenced_code.block.markdown`,
    },
    ...
    frontMatter: {
      ...
      patterns: [{
        begin: `\\A(-{3,})(.*)$`,
        beginCaptures: { 1: { name: `punctuation.definition.begin.frontmatter` }, 2: { name: `comment.frontmatter` } },
    ...
    'link-inline': {
      captures: {
        ...
        2: {
          ...
          patterns: [{ include: `#raw` }, { include: `#bold` }, { include: `#italic` }, { include: `#strikethrough` }, {
            include: `#image-inline`,
          }],
        },
...
`,
    ...
    list_paragraph: {
      ...
      patterns: [{ include: `#inline` }, { include: `text.html.derivative` }, { include: `#heading-setext` }],
      while: `(^|\\G)(?!\\s*$|#|[ ]{0,3}([-*_>][ ]{2,}){3,}[ \\t]*$\\n?|[ ]{0,3}[*+->]|[ ]{0,3}[0-9]+\\.)`,
    },
    lists: {
      patterns: [{
    ...
    raw_block: { begin: `(^|\\G)([ ]{4}|\\t)`, name: `markup.raw.block.markdown`, while: `(^|\\G)([ ]{4}|\\t)` },
    ...
    table: {
      ...
      patterns: [{ match: `\\|`, name: `punctuation.definition.table.markdown` }, {
