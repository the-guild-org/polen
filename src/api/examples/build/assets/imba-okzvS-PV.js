...
(?![\\w-])`,
      ...
      }, { match: `(?i)(?<![\\w-])currentColor(?![\\w-])`, name: `support.constant.color.current.css` }],
    },
    'css-combinators': {
      patterns: [{ match: `>>>|>>|>|\\+|~`, name: `punctuation.separator.combinator.css` }, {
        match: `&`,
    ...
    'css-escapes': {
      patterns: [{ match: `\\\\[0-9a-fA-F]{1,6}`, name: `constant.character.escape.codepoint.css` }, {
        begin: `\\\\$\\s*`,
        end: `^(?<!\\G)`,
    ...
    'css-functions': {
      patterns: [{
        ...
        patterns: [{ match: `[*/]|(?<=\\s|^)[-+](?=\\s|$)`, name: `keyword.operator.arithmetic.css` }, {
...
(\\()`,
        ...
        patterns: [{ match: `(?i)(?<![\\w-])(from|to|at)(?![\\w-])`, name: `keyword.operator.gradient.css` }, {
          include: `#css-property-values`,
        }],
      }, {
...
(\\()`,
        ...
        patterns: [
          { match: `(?i)(?<=[,\\s"]|\\*/|^)\\d+x(?=[\\s,"')]|/\\*|$)`, name: `constant.numeric.other.density.css` },
          { include: `#css-property-values` },
        ...
        patterns: [{ match: `(?i)(?<=\\s|^|\\*/)(at|round)(?=\\s|/\\*|$)`, name: `keyword.operator.shape.css` }, {
          include: `#css-property-values`,
        }],
      }, {
        ...
        patterns: [{ match: `(?i)(?<![\\w-])(start|end)(?=\\s*\\)|$)`, name: `support.constant.step-direction.css` }, {
          include: `#css-property-values`,
        }],
      }, {
        begin: `(?xi) (?<![\\w-])
...
\\b
    ...
    'css-pseudo-classes': {
      captures: { 1: { name: `punctuation.definition.entity.css` }, 2: { name: `invalid.illegal.colon.css` } },
      match: `(?xi)
(:)(:*)
...
| valid|visited
    ...
    'css-pseudo-elements': {
      captures: { 1: { name: `punctuation.definition.entity.css` }, 2: { name: `punctuation.definition.entity.css` } },
      match: `(?xi)
(?:
(::?)
(?: after
...
(?![\\w-]|\\s*[;}])`,
    ...
    'css-selector-innards': {
      patterns: [
        ...
        { match: `(\\%[\\w\\-]+)`, name: `entity.other.attribute-name.mixin.css` },
        { match: `\\*`, name: `entity.name.tag.wildcard.css` },
        {
          begin: `\\[`,
          beginCaptures: { 0: { name: `punctuation.definition.entity.begin.bracket.square.css` } },
          end: `\\]`,
          endCaptures: { 0: { name: `punctuation.definition.entity.end.bracket.square.css` } },
...
(?=[~|^\\]$*=]|/\\*)`,
    ...
    directives: {
      ...
      patterns: [{
        ...
        name: `meta.tag.imba`,
        patterns: [
          { match: `path|types|no-default-lib|lib|name`, name: `entity.other.attribute-name.directive.imba` },
...
((?:[^@\\s*/]|\\*[^/])+)`,
        },
        {
          ...
          }, { captures: { 0: { name: `source.embedded.imba` } }, match: `[^\\s@*](?:[^*]|\\*[^/])*` }],
        },
        {
          captures: {
            1: { name: `storage.type.class.jsdoc` },
...
[^{}@\\s*] | \\*[^/]
    ...
    'generics-literal': {
      begin: `(?<=[\\w\\]\\)])\\<`,
      beginCaptures: { 1: { name: `meta.generics.annotation.open.imba` } },
      end: `\\>`,
      endCaptures: { 0: { name: `meta.generics.annotation.close.imba` } },
    ...
    'inline-styles': {
      patterns: [{ include: `#style-property` }, { include: `#css-property-values` }, { include: `#style-expr` }],
    },
    'inline-tags': {
      patterns: [{
        captures: {
    ...
    'invalid-indentation': {
      patterns: [{ match: `^[\\ ]+`, name: `invalid.whitespace` }, { match: `^\\t+\\s+`, name: `invalid.whitespace` }],
    },
    jsdoctype: {
      patterns: [{ match: `\\G{(?:[^}*]|\\*[^/}])+$`, name: `invalid.illegal.type.jsdoc` }, {
        begin: `\\G({)`,
        beginCaptures: {
    ...
    keywords: {
      patterns: [
        {
          match:
            `(if|elif|else|unless|switch|when|then|do|import|export|for own|for|while|until|return|yield|try|catch|await|rescue|finally|throw|as|continue|break|extend|augment)(?![\\?_\\-$[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))`,
        ...
        { match: `(?<=import)\\s+(type)(?=\\s+[\\w\\{\\$\\_])`, name: `keyword.control.imba` },
        { match: `(extend|global|abstract)\\s+(?=class|tag|abstract|mixin|interface)`, name: `keyword.control.imba` },
        { match: `(?<=[\\*\\}\\w\\$])\\s+(from)(?=\\s+[\\"\\'])`, name: `keyword.control.imba` },
        { match: `(def|get|set)(?![\\?_\\-$[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))`, name: `storage.type.function.imba` },
        { match: `(protected|private)\\s+(?=def|get|set)`, name: `keyword.control.imba` },
        {
          match: `(tag|class|struct|mixin|interface)(?![\\?_\\-$[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))`,
          name: `storage.type.class.imba`,
        },
        { match: `(let|const|constructor)(?![\\?_\\-$[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))`, name: `storage.type.imba` },
        { match: `(prop|attr)(?![\\?_\\-$[:alnum:]])(?:(?=\\.\\.\\.)|(?!\\.))`, name: `storage.type.imba` },
    ...
    'mixin-css-selector': {
      begin: `(\\%[\\w\\-]+)`,
      beginCaptures: { 1: { name: `entity.other.attribute-name.mixin.css` } },
      end: `(\\s*(?=(?:[\\^\\@\\.\\%\\w\\$\\!\\-]+)(?:\\s*[\\:\\=])[^\\:])|\\s*$|(?=\\s+\\#\\s))`,
      endCaptures: { 0: { name: `punctuation.separator.sel-properties.css` } },
      name: `meta.selector.css`,
      patterns: [{ include: `#css-selector-innards` }],
    ...
    'mixin-declaration': {
      begin: `^(\\t*)(\\%[\\w\\-]+)`,
      beginCaptures: { 2: { name: `entity.other.attribute-name.mixin.css` } },
      end: `^(?!(\\1\\t|\\s*$))`,
      name: `meta.style.imba`,
      patterns: [{ include: `#mixin-css-selector-after` }, { include: `#css-comment` }, {
    ...
    'number-with-unit-literal': {
      patterns: [{
        captures: { 1: { name: `constant.numeric.imba` }, 2: { name: `keyword.other.unit.imba` } },
        match: `([0-9]+)([a-z]+|\\%)`,
      }, {
        captures: { 1: { name: `constant.numeric.decimal.imba` }, 2: { name: `keyword.other.unit.imba` } },
...
(?:\\b[0-9][0-9_]*(n)?\\b)
    ...
    ops: {
      patterns: [
        ...
        { match: `\\*=|(?<!\\()/=|%=|\\+=|\\-=|\\?=|\\?\\?=|=\\?`, name: `keyword.operator.assignment.compound.imba` },
        {
          match: `\\^=\\?|\\|=\\?|\\~=\\?|\\&=|\\^=|<<=|>>=|>>>=|\\|=`,
        ...
        {
          captures: { 1: { name: `keyword.operator.logical.imba` }, 2: { name: `keyword.operator.arithmetic.imba` } },
          match: `(\\!)\\s*(/)(?![/*])`,
        },
        {
        ...
        { match: `\\?(?=\\s|$)`, name: `keyword.operator.bitwise.imba` },
        { match: `\\&|~|\\^|\\|`, name: `keyword.operator.ternary.imba` },
        { match: `\\=`, name: `keyword.operator.assignment.imba` },
    ...
    pairs: { patterns: [{ include: `#curly-braces` }, { include: `#square-braces` }, { include: `#round-braces` }] },
    'plain-accessors': {
      patterns: [{
        captures: { 1: { name: `punctuation.accessor.imba` }, 2: { name: `variable.other.property.imba` } },
        match: `(\\.\\.?)([_$[:alpha:]][_$[:alnum:]]*(?:\\-[_$[:alnum:]]+)*[\\?\\!]?)`,
      }],
    },
    'plain-identifiers': {
      patterns: [
        { match: `([[:upper:]][_$[:digit:][:upper:]]*)(?![_$[:alnum:]])`, name: `variable.other.constant.imba` },
        { match: `[[:upper:]][_$[:alnum:]]*(?:\\-[_$[:alnum:]]+)*[\\!]?`, name: `variable.other.class.imba` },
        ...
        { match: `[_$[:alpha:]][_$[:alnum:]]*(?:\\-[_$[:alnum:]]+)*[\\?\\!]?`, name: `variable.other.readwrite.imba` },
        {
          match: `\\@[_$[:alpha:]][_$[:alnum:]]*(?:\\-[_$[:alnum:]]+)*[\\?\\!]?`,
        ...
        { match: `\\:[_$[:alpha:]][_$[:alnum:]]*(?:\\-[_$[:alnum:]]+)*[\\?\\!]?`, name: `string.symbol.imba` },
      ],
    },
    'punctuation-accessor': {
      captures: { 1: { name: `punctuation.accessor.imba` }, 2: { name: `punctuation.accessor.optional.imba` } },
      match: `(?:(\\.)|(\\.\\.(?!\\s*[[:digit:]]|\\s+)))`,
    },
    'punctuation-comma': { match: `,`, name: `punctuation.separator.comma.imba` },
    'punctuation-semicolon': { match: `;`, name: `punctuation.terminator.statement.imba` },
    'qstring-double': {
      begin: `"`,
    ...
    regex: {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `punctuation.definition.string.begin.imba` } },
        end: `(/)([gimsuy]*)`,
        endCaptures: { 1: { name: `punctuation.definition.string.end.imba` }, 2: { name: `keyword.other.imba` } },
    ...
    'style-declaration': {
      ...
      name: `meta.style.imba`,
      patterns: [{ include: `#css-selector` }, { include: `#css-comment` }, { include: `#nested-css-selector` }, {
        include: `#inline-styles`,
      }],
    },
    'style-expr': {
      patterns: [
        {
          captures: { 1: { name: `constant.numeric.integer.decimal.css` }, 2: { name: `keyword.other.unit.css` } },
          match: `(\\b[0-9][0-9_]*)(\\w+|%)?`,
        },
        {
          match: `--[_$[:alpha:]][_$[:alnum:]]*(?:\\-[_$[:alnum:]]+)*[\\?\\!]?`,
        ...
        { match: `(x+s|sm-|md-|lg-|sm|md|lg|x+l|hg|x+h)(?![\\w-])`, name: `support.constant.property-value.size.css` },
        {
          match: `[_$[:alpha:]][_$[:alnum:]]*(?:\\-[_$[:alnum:]]+)*[\\?\\!]?`,
        ...
        {
          begin: `(\\()`,
          beginCaptures: { 1: { name: `punctuation.section.function.begin.bracket.round.css` } },
          end: `\\)`,
    ...
    'style-property': {
      patterns: [{
        ...
        patterns: [
          { match: `(?:--|\\$)[\\w\\-\\$]+`, name: `support.type.property-name.variable.css` },
          { match: `\\@[\\!\\<\\>]?[0-9]+`, name: `support.type.property-name.modifier.breakpoint.css` },
          { match: `\\^?\\@+[\\w\\-\\$]+`, name: `support.type.property-name.modifier.css` },
          { match: `\\^?\\.+[\\w\\-\\$]+`, name: `support.type.property-name.modifier.flag.css` },
          { match: `\\^?\\%+[\\w\\-\\$]+`, name: `support.type.property-name.modifier.state.css` },
          {
            match: `\\.\\.[\\w\\-\\$]+|\\^+[\\.\\@\\%][\\w\\-\\$]+`,
            name: `support.type.property-name.modifier.up.css`,
          },
          { match: `\\.[\\w\\-\\$]+`, name: `support.type.property-name.modifier.is.css` },
    ...
    'tag-event-handler': {
      ...
      patterns: [{ include: `#tag-interpolated-content` }, { include: `#tag-interpolated-parens` }, {
        begin: `\\.`,
        beginCaptures: { 0: { name: `punctuation.section.tag` } },
        end: `(?=[\\.\\[\\>\\s\\=]|$)`,
        name: `entity.other.event-modifier.imba`,
        patterns: [{ include: `#tag-interpolated-parens` }, { include: `#tag-interpolated-content` }],
      }],
    },
    'tag-expr-name': {
      begin: `(?<=<)(?=[\\w\\{])`,
    ...
    'tag-mixin-name': { match: `(\\%[\\w\\-]+)`, name: `entity.other.tag-mixin.imba` },
    'tag-name': {
      patterns: [{ match: `(?<=<)(self|global|slot)(?=[\\.\\[\\>\\s\\(])`, name: `entity.name.tag.special.imba` }],
    },
    'tag-ref': { match: `(\\$[\\w\\-]+)`, name: `entity.other.tag-ref.imba` },
    template: {
      patterns: [{
        begin:
        ...
        beginCaptures: { 1: { name: `entity.name.function.tagged-template.imba` } },
        end: '(?=`)',
        name: `string.template.imba`,
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.template.end.imba` } },
        name: `string.template.imba`,
        patterns: [{ include: `#template-substitution-element` }, { include: `#string-character-escape` }],
      }],
    },
    'template-substitution-element': {
      begin: `(?<!\\\\)\\{`,
      beginCaptures: { 0: { name: `punctuation.definition.template-expression.begin.imba` } },
      contentName: `meta.embedded.line.imba`,
      end: `\\}`,
      endCaptures: { 0: { name: `punctuation.definition.template-expression.end.imba` } },
