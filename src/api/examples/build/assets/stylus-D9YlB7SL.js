var e = `Stylus`,
  t = [`styl`, `stylus`, `css.styl`, `css.stylus`],
  n = `stylus`,
  r = [
    { include: `#comment` },
    { include: `#at_rule` },
  ...
  i = {
    at_rule: {
      patterns: [{
        ...
        beginCaptures: {
          1: { name: `keyword.control.at-rule.import.stylus` },
          2: { name: `punctuation.definition.keyword.stylus` },
        },
        end: `\\s*((?=;|$|\\n))`,
        ...
        beginCaptures: {
          1: { name: `keyword.control.at-rule.extend.stylus` },
          2: { name: `punctuation.definition.keyword.stylus` },
        },
        end: `\\s*((?=;|$|\\n))`,
        endCaptures: { 1: { name: `punctuation.terminator.rule.css` } },
        ...
        captures: {
          1: { name: `keyword.control.at-rule.fontface.stylus` },
          2: { name: `punctuation.definition.keyword.stylus` },
        },
        match: `^\\s*((@)font-face)\\b`,
        ...
        captures: {
          1: { name: `keyword.control.at-rule.css.stylus` },
          2: { name: `punctuation.definition.keyword.stylus` },
        },
        match: `^\\s*((@)css)\\b`,
        ...
        begin: `\\s*((@)charset)\\b\\s*`,
        beginCaptures: {
          1: { name: `keyword.control.at-rule.charset.stylus` },
          2: { name: `punctuation.definition.keyword.stylus` },
        },
        end: `\\s*((?=;|$|\\n))`,
        ...
        beginCaptures: {
          1: { name: `keyword.control.at-rule.keyframes.stylus` },
          2: { name: `punctuation.definition.keyword.stylus` },
        ...
        name: `meta.at-rule.keyframes.stylus`,
        patterns: [{ match: `(\\b(\\d+%|from\\b|to\\b))`, name: `entity.other.attribute-name.stylus` }],
      }, {
        captures: {
    ...
    char_escape: { match: `\\\\(.)`, name: `constant.character.escape.stylus` },
    color: {
      patterns: [{
        begin: `\\b(rgb|rgba|hsl|hsla)(\\()`,
        beginCaptures: { 1: { name: `support.function.color.css` }, 2: { name: `punctuation.section.function.css` } },
        end: `(\\))`,
        endCaptures: { 1: { name: `punctuation.section.function.css` } },
        name: `meta.function.color.css`,
        patterns: [{ match: `\\s*(,)\\s*`, name: `punctuation.separator.parameter.css` }, { include: `#numeric` }, {
    ...
    comment: { patterns: [{ include: `#comment_block` }, { include: `#comment_line` }] },
    comment_block: {
      begin: `/\\*`,
    ...
    comment_line: {
      begin: `(^[ \\t]+)?(?=//)`,
      beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.stylus` } },
      end: `(?!\\G)`,
      patterns: [{
        begin: `//`,
        beginCaptures: { 0: { name: `punctuation.definition.comment.stylus` } },
        end: `(?=\\n)`,
    ...
    declaration: {
      ...
      endCaptures: { 2: { name: `punctuation.terminator.rule.css` } },
...
|\\\\(?:[0-9a-fA-F]{1,6}|.)
        ...
        },
        {
          ...
          patterns: [{ include: `#function` }, { include: `#property_values` }],
        },
        { include: `#property` },
    ...
    font_name: {
      match:
        `(\\b(?i:arial|century|comic|courier|cursive|fantasy|futura|garamond|georgia|helvetica|impact|lucida|monospace|symbol|system|tahoma|times|trebuchet|utopia|verdana|webdings|sans-serif|serif)\\b)`,
      ...
      patterns: [
        {
          ...
          beginCaptures: { 1: { name: `support.function.misc.css` }, 2: { name: `punctuation.section.function.css` } },
          end: `(?=\\))`,
          name: `meta.function.misc.css`,
          patterns: [
            { match: `(?<=\\()[^\\)\\s]*(?=\\))`, name: `string.css` },
            { include: `#string` },
            { include: `#variable` },
            { include: `#operator` },
            { match: `\\s*` },
        ...
        },
        {
          ...
          patterns: [
            { match: `\\G[a-zA-Z_-][a-zA-Z0-9_-]*`, name: `variable.section.css` },
            { match: `\\s*(,)\\s*`, name: `punctuation.separator.parameter.css` },
            { include: `#string` },
            { include: `#interpolation` },
          ],
        },
        {
          ...
          patterns: [
            { match: `\\G[a-zA-Z_-][a-zA-Z0-9_-]*`, name: `entity.other.attribute-name.attribute.css` },
            {
              match:
                `(?<=[a-zA-Z0-9_-])\\s*\\b(string|color|url|integer|number|length|em|ex|px|rem|vw|vh|vmin|vmax|mm|cm|in|pt|pc|angle|deg|grad|rad|time|s|ms|frequency|Hz|kHz|%)\\b`,
        ...
        },
        {
          ...
          patterns: [{ include: `#property_values` }],
        },
        {
          begin: `(cubic-bezier)(\\()`,
          beginCaptures: {
        ...
        },
        {
          ...
          patterns: [{ match: `\\s*(,)\\s*`, name: `punctuation.separator.parameter.css` }, { include: `#numeric` }, {
            ...
            match:
              `\\b(to|bottom|right|left|top|circle|ellipse|center|closest-side|closest-corner|farthest-side|farthest-corner|at)\\b`,
        ...
        },
        {
          ...
          patterns: [{ include: `#numeric` }, { include: `#property_variable` }, { include: `#interpolation` }],
        },
        {
          begin: `(drop-shadow)(\\()`,
          beginCaptures: {
          ...
          patterns: [{ include: `#numeric` }, { include: `#color` }, { include: `#property_variable` }, {
            include: `#interpolation`,
          }],
        },
        {
          begin:
            `(matrix|matrix3d|perspective|rotate|rotate3d|rotate[Xx]|rotate[yY]|rotate[zZ]|scale|scale3d|scale[xX]|scale[yY]|scale[zZ]|skew|skew[xX]|skew[yY]|translate|translate3d|translate[xX]|translate[yY]|translate[zZ])(\\()`,
          beginCaptures: {
        ...
        { match: `(url|local|format|counter|counters|attr|calc)(?=\\()`, name: `support.function.misc.css` },
        { match: `(cubic-bezier|steps)(?=\\()`, name: `support.function.timing.css` },
        {
...
|\\\\(?:[0-9a-fA-F]{1,6}|.)
        ...
        { match: `\\(`, name: `punctuation.section.function.css` },
      ],
    },
    interpolation: {
      begin: `(?:(\\{)[^\\S\\n]*)(?=[^;=]*[^\\S\\n]*\\})`,
      beginCaptures: { 1: { name: `meta.brace.curly` } },
      end: `(?:[^\\S\\n]*(\\}))|\\n|$`,
      endCaptures: { 1: { name: `meta.brace.curly` } },
      name: `meta.interpolation.stylus`,
      patterns: [{ include: `#variable` }, { include: `#numeric` }, { include: `#string` }, { include: `#operator` }],
    },
    language_constants: { match: `\\b(true|false|null)\\b`, name: `constant.language.stylus` },
    language_keywords: {
      patterns: [{ match: `(\\b|\\s)(return|else|for|unless|if|else)\\b`, name: `keyword.control.stylus` }, {
    ...
    numeric: {
      patterns: [{
        ...
        match:
          `(?x) (?<!\\w|-)(?:(?:-|\\+)?(?:[0-9]+(?:\\.[0-9]+)?)|(?:\\.[0-9]+)) ((?:px|pt|ch|cm|mm|in|r?em|ex|pc|deg|g?rad|dpi|dpcm|dppx|fr|ms|s|turn|vh|vmax|vmin|vw)\\b|%)?`,
...
([a-zA-Z_-][a-zA-Z0-9_-]*)
      ...
      endCaptures: { 1: { name: `punctuation.terminator.rule.css` } },
      patterns: [{ include: `#property_value` }],
    },
    property_value: {
      begin: `\\G(?:(:)|(\\s))(\\s*)(?!&)`,
      beginCaptures: {
      ...
      patterns: [{ include: `#property_values` }, { match: `[^\\n]+?` }],
    },
    property_values: {
      patterns: [
        { include: `#function` },
        ...
        {
          match:
            `(?:(?=\\w)(?<![\\w-]))(start|sRGB|square|round|optimizeSpeed|optimizeQuality|nonzero|miter|middle|linearRGB|geometricPrecision |evenodd |end |crispEdges|butt|bevel)(?:(?<=\\w)(?![\\w-]))`,
    ...
    selector: {
      patterns: [
        ...
        { match: `\\s*(\\,)\\s*`, name: `meta.selector.stylus` },
        { match: `\\*`, name: `meta.selector.stylus` },
        {
          captures: { 2: { name: `entity.other.attribute-name.parent-selector-suffix.stylus` } },
    ...
    string: {
      patterns: [{
        ...
        patterns: [{ match: `\\\\([a-fA-F0-9]{1,6}|.)`, name: `constant.character.escape.css` }],
      }, {
        begin: `'`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.css` } },
        end: `'`,
    ...
    variable: { match: `(\\$[a-zA-Z_-][a-zA-Z0-9_-]*)`, name: `variable.stylus` },
    variable_declaration: {
      begin: `^[^\\S\\n]*(\\$?[a-zA-Z_-][a-zA-Z0-9_-]*)[^\\S\\n]*(\\=|\\?\\=|\\:\\=)`,
      beginCaptures: { 1: { name: `variable.stylus` }, 2: { name: `keyword.operator.stylus` } },
      end: `(\\n)|(;)|(?=\\})`,
      endCaptures: { 2: { name: `punctuation.terminator.rule.css` } },
      patterns: [{ include: `#property_values` }],
    },
