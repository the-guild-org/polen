var e = `Jison`,
  ...
  n = {
    'L:(meta.action.jison - (comment | string)), source.js.embedded.jison - (comment | string), source.js.embedded.source - (comment | string.quoted.double | string.quoted.single)':
      {
        patterns: [
          { match: '\\${2}', name: `variable.language.semantic-value.jison` },
          { match: `@\\$`, name: `variable.language.result-location.jison` },
          { match: `##\\$|\\byysp\\b`, name: `variable.language.stack-index-0.jison` },
          { match: `#\\S+#`, name: `support.variable.token-reference.jison` },
          { match: `#\\$`, name: `variable.language.result-id.jison` },
          { match: `\\$(?:-?\\d+|[[:alpha:]_](?:[\\w-]*\\w)?)`, name: `support.variable.token-value.jison` },
          { match: `@(?:-?\\d+|[[:alpha:]_](?:[\\w-]*\\w)?)`, name: `support.variable.token-location.jison` },
          { match: `##(?:-?\\d+|[[:alpha:]_](?:[\\w-]*\\w)?)`, name: `support.variable.stack-index.jison` },
          { match: `#(?:-?\\d+|[[:alpha:]_](?:[\\w-]*\\w)?)`, name: `support.variable.token-id.jison` },
          {
            match: `\\byy(?:l(?:eng|ineno|oc|stack)|rulelength|s(?:tate|s?tack)|text|vstack)\\b`,
            name: `variable.language.jison`,
          },
          { match: `\\byy(?:clearin|erro[kr])\\b`, name: `keyword.other.jison` },
        ],
      },
  },
  r = `jison`,
  i = [{
    ...
    }, { begin: `\\G`, end: `(?=%%)`, name: `meta.section.rules.jison`, patterns: [{ include: `#rules_section` }] }],
  }, {
    begin: `^`,
    end: `(?=%%)`,
  ...
  a = {
    ...
    declarations_section: {
      patterns: [
        ...
        { match: `%(ebnf|left|nonassoc|parse-param|right|start)\\b`, name: `keyword.other.declaration.$1.jison` },
        { include: `#include_declarations` },
        {
          ...
          patterns: [
            ...
            { match: `(init|required)`, name: `keyword.other.code-qualifier.$1.jison` },
            { include: `#quoted_strings` },
            { match: `\\b[[:alpha:]_](?:[\\w-]*\\w)?\\b`, name: `string.unquoted.jison` },
          ],
        },
        {
          begin: `%(parser-type)\\b`,
          ...
          patterns: [{ include: `#comments` }, { include: `#quoted_strings` }, {
        ...
        },
        {
          ...
          patterns: [{ include: `#comments` }, { include: `#numbers` }, { include: `#quoted_strings` }, {
            match: `<[[:alpha:]_](?:[\\w-]*\\w)?>`,
            name: `invalid.unimplemented.jison`,
          }, { match: `\\S+`, name: `entity.other.token.jison` }],
        },
        { match: `%(debug|import)\\b`, name: `keyword.other.declaration.$1.jison` },
        { match: `%prec\\b`, name: `invalid.illegal.jison` },
        { match: `%[[:alpha:]_](?:[\\w-]*\\w)?\\b`, name: `invalid.unimplemented.jison` },
        { include: `#numbers` },
        { include: `#quoted_strings` },
      ],
    },
    epilogue_section: { patterns: [{ include: `#user_code_include_declarations` }, { include: `source.js` }] },
    ...
    include_paths: {
      patterns: [{ include: `#quoted_strings` }, {
        begin: `(?=\\S)`,
        end: `(?=\\s)`,
        name: `string.unquoted.jison`,
    ...
    numbers: {
      ...
      }, { match: `\\d+`, name: `constant.numeric.integer.decimal.jison` }],
    },
    options_declarations: {
      patterns: [{
        ...
        patterns: [{ include: `#comments` }, {
          ...
          patterns: [
            { include: `#comments` },
            { match: `\\b(true|false)\\b`, name: `constant.language.boolean.$1.jison` },
            { include: `#numbers` },
            { include: `#quoted_strings` },
            { match: `\\S+`, name: `string.unquoted.jison` },
          ],
        }, { include: `#quoted_strings` }],
      }],
    },
    ...
    rules_section: {
      patterns: [{ include: `#comments` }, { include: `#actions` }, { include: `#include_declarations` }, {
        ...
        patterns: [{ include: `#comments` }, {
          ...
          patterns: [
            ...
            { match: `\\|`, name: `keyword.operator.rule-components.separator.jison` },
            { match: `\\b(?:EOF|error)\\b`, name: `keyword.other.$0.jison` },
            { match: `(?:%(?:e(?:mpty|psilon))|\\b[Ɛɛεϵ])\\b`, name: `keyword.other.empty.jison` },
            { include: `#rule_actions` },
          ],
        }],
      }],
