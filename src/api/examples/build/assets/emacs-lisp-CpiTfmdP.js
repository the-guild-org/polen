...
(?:
  ...
  i = [{
    begin: `\\A(#!)`,
    beginCaptures: { 1: { name: `punctuation.definition.comment.hashbang.emacs.lisp` } },
    end: `$`,
    name: `comment.line.hashbang.emacs.lisp`,
  }, { include: `#main` }],
  a = {
    'archive-sources': {
      captures: { 1: { name: `support.language.constant.archive-source.emacs.lisp` } },
      match: `(?x)\\b(?<=[\\s()\\[]|^)
(SC|gnu|marmalade|melpa-stable|melpa|org)
(?=[\\s()]|$) \\b`,
    },
    'arg-values': {
      patterns: [{ match: `&(optional|rest)(?=\\s|\\))`, name: `constant.language.$1.arguments.emacs.lisp` }],
    },
    autoload: {
      begin: `^(;;;###)(autoload)`,
      beginCaptures: {
    ...
    binding: { match: `\\b(?<=[\\s()\\[]|^)(let\\*?|set[fq]?)(?=[\\s()]|$)`, name: `storage.binding.emacs.lisp` },
    boolean: {
      patterns: [{ match: `\\b(?<=[\\s()\\[]|^)t(?=[\\s()]|$)\\b`, name: `constant.boolean.true.emacs.lisp` }, {
        match: `\\b(?<=[\\s()\\[]|^)(nil)(?=[\\s()]|$)\\b`,
    ...
    cask: {
      match:
        `\\b(?<=[\\s()\\[]|^)(?:files|source|development|depends-on|package-file|package-descriptor|package)(?=[\\s()]|$)\\b`,
    ...
    definition: {
      patterns: [
        {
          begin:
            `(\\()(?:(cl-(defun|defmacro|defsubst))|(defun|defmacro|defsubst))(?!-)\\b(?:\\s*(?![-+\\d])([-+=*/\\w~!@$%^&:<>{}?]+))?`,
          beginCaptures: {
        ...
        { match: `\\b(?<=[\\s()\\[]|^)defun(?=[\\s()]|$)`, name: `storage.type.function.emacs.lisp` },
        {
          begin: `(?x) (?<=\\s|^) (\\()
...
(?=[\\s()]|$)`,
    ...
    docesc: {
      patterns: [{ match: `\\x5C{2}=`, name: `constant.escape.character.key-sequence.emacs.lisp` }, {
        match: `\\x5C{2}+`,
    ...
    eldoc: {
      patterns: [{ include: `#docesc` }, { include: `#docvar` }, { include: `#dockey` }, { include: `#docmap` }],
    },
    escapes: {
      patterns: [{
        captures: {
        ...
        captures: { 1: { name: `punctuation.definition.codepoint.emacs.lisp` } },
        match: `(\\?)\\\\x[A-Fa-f0-9]+`,
        name: `constant.character.escape.hex.emacs.lisp`,
      }, {
        captures: { 1: { name: `punctuation.definition.codepoint.emacs.lisp` } },
        ...
        captures: { 1: { name: `punctuation.definition.backslash.emacs.lisp` } },
        match: `(\\\\).`,
    ...
    expression: {
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.section.quoted.expression.end.emacs.lisp` } },
        ...
        endCaptures: { 0: { name: `punctuation.section.backquoted.expression.end.emacs.lisp` } },
        ...
        endCaptures: { 0: { name: `punctuation.section.interpolated.expression.end.emacs.lisp` } },
...
(?=[\\s()]|$)\\b`,
    ...
    formatting: {
      ...
      patterns: [{
        ...
        patterns: [{ match: `^\\s*$\\n?` }, {
          captures: { 1: { name: `punctuation.definition.string.begin.emacs.lisp` } },
          match: `(?:^|\\G)\\s*(")`,
        }, {
          begin: `(?<=")`,
          end: `"`,
...
(?=[\\s()]|$)\\b`,
    ...
    'key-notation': {
      patterns: [{ match: `\\b(DEL|ESC|LFD|NUL|RET|SPC|TAB)\\b`, name: `constant.control-character.key.emacs.lisp` }, {
        captures: { 1: { name: `punctuation.definition.escape.backslash.emacs.lisp` } },
        match: `(\\\\)[0-7]{1,6}`,
        name: `constant.character.escape.octal.codepoint.key.emacs.lisp`,
      }, {
        captures: { 1: { name: `punctuation.definition.escape.caret.emacs.lisp` } },
        match: `(\\^)\\S`,
...
|   ([!-_a-z])
        ...
        captures: {
          1: {
            patterns: [{ match: `<`, name: `punctuation.definition.angle.bracket.begin.emacs.lisp` }, {
      ...
      }, { match: `(?<=\\s)(?![MCSAHs<>])[!-_a-z](?=\\s)`, name: `constant.character.key.emacs.lisp` }],
    },
    'key-notation-prefix': {
      captures: {
    ...
    keyword: {
      captures: { 1: { name: `punctuation.definition.keyword.emacs.lisp` } },
      match: `(?<=[\\s()\\[]|^)(:)[-+=*/\\w~!@$%^&:<>{}?]+`,
...
s?
    ...
    'modeline-innards': {
      patterns: [
        ...
        { match: `;`, name: `punctuation.terminator.statement.emacs.lisp` },
        { match: `:`, name: `punctuation.separator.key-value.emacs.lisp` },
        { match: `\\S+`, name: `string.other.modeline.emacs.lisp` },
      ],
    },
    number: {
      patterns: [{
...
(?=[\\s()]|$)`,
        ...
        { match: `(?<=\\(|\\s|^)[-*+/%](?=\\s|\\)|$)`, name: `keyword.operator.numeric.emacs.lisp` },
        { match: `(?<=\\(|\\s|^)[/<>]=|[=<>](?=\\s|\\)|$)`, name: `keyword.operator.comparison.emacs.lisp` },
        { match: `(?<=\\s)\\.(?=\\s|$)`, name: `keyword.operator.pair-separator.emacs.lisp` },
      ],
    },
    quote: {
      patterns: [{
        captures: { 1: { name: `punctuation.definition.quote.emacs.lisp` }, 2: { patterns: [{ include: `$self` }] } },
        match: `(')([-+=*/\\w~!@$%^&:<>{}?]+)`,
...
|zone-shift-left|zone-shift-right|zone-shift-up|zone-when-idle|zone|zrgrep
    ...
    symbols: {
      patterns: [{
        captures: { 0: { name: `punctuation.definition.symbol.emacs.lisp` } },
        match: `(?<=[\\s()\\[]|^)##`,
        name: `constant.other.interned.blank.symbol.emacs.lisp`,
      }, {
        captures: { 1: { name: `punctuation.definition.symbol.emacs.lisp` }, 2: { patterns: [{ include: `$self` }] } },
        match: `(?<=[\\s()\\[]|^)(#)((?:[-'+=*/\\w~!@$%^&:<>{}?]|\\\\.)+)`,
        name: `constant.other.symbol.emacs.lisp`,
      }, {
        captures: { 1: { name: `punctuation.definition.spliced.symbol.emacs.lisp` } },
        match: `(,@)([-+=*/\\w~!@$%^&:<>{}?]+)`,
        name: `constant.other.spliced.symbol.emacs.lisp`,
      }, {
        captures: { 1: { name: `punctuation.definition.inserted.symbol.emacs.lisp` } },
        match: `(,)([-+=*/\\w~!@$%^&:<>{}?]+)`,
        name: `constant.other.inserted.symbol.emacs.lisp`,
      }],
    },
    vectors: {
      patterns: [{ match: `\\[`, name: `punctuation.section.vector.begin.emacs.lisp` }, {
        match: `\\]`,
