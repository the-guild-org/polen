var e = `Ruby`,
  ...
  n = [
    ...
    { comment: `contextual smart pair support`, match: `(?<=\\{)(\\s+)`, name: `meta.syntax.ruby.start-block` },
    {
      match:
    ...
    { match: `\\b(__(dir|FILE|LINE)__)\\b(?![?!])`, name: `variable.language.ruby` },
    {
      begin: `^__END__\\n`,
    ...
    { match: `\\b(self)\\b(?![?!])`, name: `variable.language.self.ruby` },
    {
...
`,
      ...
      repository: {
        braces: {
          ...
          patterns: [{ include: `#parens` }, { include: `#braces` }, { include: `$self` }],
        },
        parens: {
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.section.function.begin.ruby` } },
...
(?=[ \\t]*[^\\s#;])
`,
      beginCaptures: { 1: { name: `keyword.control.def.ruby` }, 2: { name: `entity.name.function.ruby` } },
    ...
    {
      captures: { 1: { name: `keyword.control.def.ruby` }, 3: { name: `entity.name.function.ruby` } },
...
`,
    ...
    { match: `\\b(0|(0[dD]\\d|[1-9])(?>_?\\d)*)r?i?\\b`, name: `constant.numeric.integer.ruby` },
    { match: `\\b0[xX]\\h(?>_?\\h)*r?i?\\b`, name: `constant.numeric.hex.ruby` },
    { match: `\\b0[bB][01](?>_?[01])*r?i?\\b`, name: `constant.numeric.binary.ruby` },
    { match: `\\b0([oO]?[0-7](?>_?[0-7])*)?r?i?\\b`, name: `constant.numeric.octal.ruby` },
    {
      begin: `:'`,
...
\\s*((/))(?![*+{}?])
`,
      captures: { 1: { name: `string.regexp.classic.ruby` }, 2: { name: `punctuation.definition.string.ruby` } },
    ...
    },
    {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#heredoc` }, { include: `#interpolated_ruby` }, { include: `text.html.basic` }, {
    ...
    },
    {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.ruby` } },
        name: `string.unquoted.heredoc.ruby`,
        patterns: [{ include: `#heredoc` }, { include: `#interpolated_ruby` }, { include: `text.xml` }, {
          include: `#escaped_char`,
        }],
      }],
    },
    {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.ruby` } },
        name: `string.unquoted.heredoc.ruby`,
        patterns: [{ include: `#heredoc` }, { include: `#interpolated_ruby` }, { include: `source.sql` }, {
          include: `#escaped_char`,
        }],
      }],
    },
    {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.ruby` } },
        name: `string.unquoted.heredoc.ruby`,
        patterns: [{ include: `#heredoc` }, { include: `#interpolated_ruby` }, { include: `source.css` }, {
          include: `#escaped_char`,
        }],
      }],
    },
    {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.ruby` } },
        name: `string.unquoted.heredoc.ruby`,
        patterns: [{ include: `#heredoc` }, { include: `#interpolated_ruby` }, { include: `source.c++` }, {
          include: `#escaped_char`,
        }],
      }],
    },
    ...
    },
    {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.ruby` } },
        name: `string.unquoted.heredoc.ruby`,
        patterns: [{ include: `#heredoc` }, { include: `#interpolated_ruby` }, { include: `source.js` }, {
          include: `#escaped_char`,
        }],
      }],
    },
    {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.ruby` } },
        name: `string.unquoted.heredoc.ruby`,
        patterns: [{ include: `#heredoc` }, { include: `#interpolated_ruby` }, { include: `source.js.jquery` }, {
          include: `#escaped_char`,
        }],
      }],
    },
    {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.ruby` } },
        name: `string.unquoted.heredoc.ruby`,
        patterns: [{ include: `#heredoc` }, { include: `#interpolated_ruby` }, { include: `source.shell` }, {
          include: `#escaped_char`,
        }],
      }],
    },
    {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.ruby` } },
        name: `string.unquoted.heredoc.ruby`,
        patterns: [{ include: `#heredoc` }, { include: `#interpolated_ruby` }, { include: `source.lua` }, {
          include: `#escaped_char`,
        }],
      }],
    },
    {
      ...
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.definition.string.end.ruby` } },
        name: `string.unquoted.heredoc.ruby`,
        patterns: [{ include: `#heredoc` }, { include: `#interpolated_ruby` }, { include: `source.ruby` }, {
          include: `#escaped_char`,
        }],
      }],
    },
    {
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.ruby` } },
      name: `string.unquoted.heredoc.ruby`,
      patterns: [{ include: `#heredoc` }, { include: `#interpolated_ruby` }, { include: `#escaped_char` }],
    },
    {
      begin: `(?><<[-~](\\w+))`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.ruby` } },
    ...
    },
    {
      ...
      patterns: [{ include: `$self` }, { match: `[_a-zA-Z][_a-zA-Z0-9]*`, name: `variable.other.block.ruby` }, {
        match: `,`,
        name: `punctuation.separator.variable.ruby`,
      }],
    },
    { match: `=>`, name: `punctuation.separator.key-value` },
    { match: `->`, name: `support.function.kernel.lambda.ruby` },
    {
      match: `<<=|%=|&{1,2}=|\\*=|\\*\\*=|\\+=|-=|\\^=|\\|{1,2}=|<<`,
      name: `keyword.operator.assignment.augmented.ruby`,
    },
    { match: `<=>|<(?!<|=)|>(?!<|=|>)|<=|>=|===|==|=~|!=|!~|(?<=[ \\t])\\?`, name: `keyword.operator.comparison.ruby` },
    { match: `(?<!\\.)\\b(and|not|or)\\b(?![?!])`, name: `keyword.operator.logical.ruby` },
    {
  ...
  r = {
    escaped_char: { match: `\\\\(?:[0-7]{1,3}|x[\\da-fA-F]{1,2}|.)`, name: `constant.character.escape.ruby` },
    ...
    interpolated_ruby: {
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.section.embedded.end.ruby` }, 1: { name: `source.ruby` } },
    ...
    percent_literals: {
      patterns: [{
        ...
        patterns: [
          { begin: `\\G(?<=\\()(?!\\))`, end: `(?=\\))`, patterns: [{ include: `#parens` }, { include: `#symbol` }] },
          { begin: `\\G(?<=\\[)(?!\\])`, end: `(?=\\])`, patterns: [{ include: `#brackets` }, { include: `#symbol` }] },
          { begin: `\\G(?<=\\{)(?!\\})`, end: `(?=\\})`, patterns: [{ include: `#braces` }, { include: `#symbol` }] },
          { begin: `\\G(?<=<)(?!>)`, end: `(?=>)`, patterns: [{ include: `#angles` }, { include: `#symbol` }] },
          { include: `#symbol` },
        ],
        repository: {
          angles: {
            patterns: [{
              ...
              patterns: [{ include: `#angles` }, { include: `#symbol` }],
            }],
          },
          braces: {
            patterns: [{
              ...
              patterns: [{ include: `#braces` }, { include: `#symbol` }],
            }],
          },
          brackets: {
            patterns: [{
              ...
              patterns: [{ include: `#brackets` }, { include: `#symbol` }],
            }],
          },
          parens: {
            patterns: [{
              ...
              patterns: [{ include: `#parens` }, { include: `#symbol` }],
            }],
          },
          symbol: {
            patterns: [{
              ...
              match: `\\\\\\\\|\\\\[ ]`,
              name: `constant.other.symbol.ruby`,
            }, { match: `\\S\\w*`, name: `constant.other.symbol.ruby` }],
          },
        },
      }, {
        begin: `%I(?:([(\\[{<])|([^\\w\\s]|_))`,
        ...
        repository: {
          ...
          symbol: {
            patterns: [{
              ...
              name: `constant.other.symbol.ruby`,
              patterns: [{ include: `#escaped_char` }, { include: `#interpolated_ruby` }],
            }, { match: `\\S\\w*`, name: `constant.other.symbol.ruby` }],
          },
        },
      }, {
        ...
        patterns: [
          { begin: `\\G(?<=\\()(?!\\))`, end: `(?=\\))`, patterns: [{ include: `#parens` }] },
          { begin: `\\G(?<=\\[)(?!\\])`, end: `(?=\\])`, patterns: [{ include: `#brackets` }] },
          { begin: `\\G(?<=\\{)(?!\\})`, end: `(?=\\})`, patterns: [{ include: `#braces` }] },
          { begin: `\\G(?<=<)(?!>)`, end: `(?=>)`, patterns: [{ include: `#angles` }] },
        ],
        repository: {
          angles: {
            patterns: [{ match: `\\\\<|\\\\>|\\\\\\\\`, name: `constant.character.escape.ruby` }, {
        ...
        repository: {
          angles: {
            patterns: [{ include: `#regex_sub` }, { begin: `<`, end: `>`, patterns: [{ include: `#angles` }] }],
          },
          braces: {
            patterns: [{ include: `#regex_sub` }, { begin: `\\{`, end: `\\}`, patterns: [{ include: `#braces` }] }],
          },
          brackets: {
            patterns: [{ include: `#regex_sub` }, { begin: `\\[`, end: `\\]`, patterns: [{ include: `#brackets` }] }],
          },
          parens: {
            patterns: [{ include: `#regex_sub` }, { begin: `\\(`, end: `\\)`, patterns: [{ include: `#parens` }] }],
          },
        },
      }, {
        begin: `%s(?:([(\\[{<])|([^\\w\\s]|_))`,
        ...
        patterns: [
          { begin: `\\G(?<=\\()(?!\\))`, end: `(?=\\))`, patterns: [{ include: `#parens` }, { include: `#string` }] },
          { begin: `\\G(?<=\\[)(?!\\])`, end: `(?=\\])`, patterns: [{ include: `#brackets` }, { include: `#string` }] },
          { begin: `\\G(?<=\\{)(?!\\})`, end: `(?=\\})`, patterns: [{ include: `#braces` }, { include: `#string` }] },
          { begin: `\\G(?<=<)(?!>)`, end: `(?=>)`, patterns: [{ include: `#angles` }, { include: `#string` }] },
          { include: `#string` },
        ],
        repository: {
          angles: {
            patterns: [{
              ...
              patterns: [{ include: `#angles` }, { include: `#string` }],
            }],
          },
          braces: {
            patterns: [{
              ...
              patterns: [{ include: `#braces` }, { include: `#string` }],
            }],
          },
          brackets: {
            patterns: [{
              ...
              patterns: [{ include: `#brackets` }, { include: `#string` }],
            }],
          },
          parens: {
            patterns: [{
              ...
              patterns: [{ include: `#parens` }, { include: `#string` }],
            }],
          },
          string: {
            patterns: [{
              ...
              match: `\\\\\\\\|\\\\[ ]`,
              name: `string.other.ruby`,
            }, { match: `\\S\\w*`, name: `string.other.ruby` }],
          },
        },
      }, {
        begin: `%W(?:([(\\[{<])|([^\\w\\s]|_))`,
