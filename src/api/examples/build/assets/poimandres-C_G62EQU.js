var e = `poimandres`,
  ...
  r = [
    ...
    { scope: `meta.parameters comment.block`, settings: { foreground: `#a6accd`, fontStyle: `italic` } },
    {
      scope: [
    ...
    { scope: [`variable.other`, `support.type.object`], settings: { foreground: `#e4f0fb` } },
    {
    ...
    { scope: [`keyword.control.flow`], settings: { foreground: `#5DE4c7c0` } },
    { scope: [`keyword.operator.new`, `keyword.control.new`], settings: { foreground: `#5DE4c7` } },
    {
      scope: [`variable.language.this`, `storage.modifier.async`, `storage.modifier`, `variable.language.super`],
      settings: { foreground: `#5DE4c7` },
    },
    {
      scope: [
        `support.class.error`,
    ...
    { scope: [`invalid`, `invalid.illegal`], settings: { foreground: `#d0679d` } },
    { scope: [`invalid.deprecated`], settings: { foreground: `#d0679d` } },
    { scope: [`keyword.control`, `keyword`], settings: { foreground: `#a6accd` } },
    { scope: [`keyword.operator`, `storage.type`], settings: { foreground: `#91B4D5` } },
    {
      scope: [
    ...
    { scope: [`meta.brace`, `punctuation`, `keyword.operator.existential`], settings: { foreground: `#a6accd` } },
    {
      scope: [
    ...
    { scope: [`support.class.component`], settings: { foreground: `#5DE4c7` } },
    {
    ...
    { scope: [`source.cpp meta.block variable.other`], settings: { foreground: `#ADD7FF` } },
    { scope: [`support.other.variable`, `string.other.link`], settings: { foreground: `#5DE4c7` } },
    {
      scope: [
        `constant.numeric`,
        `support.constant`,
    ...
    { scope: [`entity.other.inherited-class`], settings: { foreground: `#ADD7FF` } },
    { scope: [`meta.type.declaration`], settings: { foreground: `#ADD7FF` } },
    { scope: [`entity.name.type.alias`], settings: { foreground: `#a6accd` } },
    { scope: [`keyword.control.as`, `entity.name.type`, `support.type`], settings: { foreground: `#a6accdC0` } },
    {
      scope: [
        `entity.name`,
    ...
    { scope: [`variable.language`], settings: { foreground: `#ADD7FF`, fontStyle: `italic` } },
    { scope: [`entity.name.method.js`], settings: { foreground: `#91B4D5`, fontStyle: `italic` } },
    {
      scope: [`meta.class-method.js entity.name.function.js`, `variable.function.constructor`],
      settings: { foreground: `#91B4D5` },
    },
    { scope: [`entity.other.attribute-name`], settings: { foreground: `#91B4D5`, fontStyle: `italic` } },
    {
    ...
    { scope: [`entity.other.attribute-name.class`], settings: { foreground: `#5fb3a1` } },
    { scope: [`source.sass keyword.control`], settings: { foreground: `#42675A` } },
    ...
    { scope: [`constant.character.escape`], settings: { foreground: `#5fb3a1` } },
    { scope: [`*url*`, `*link*`, `*uri*`], settings: { foreground: `#ADD7FF`, fontStyle: `underline` } },
    {
    ...
    { scope: [`text.html.markdown`, `punctuation.definition.list_item.markdown`], settings: { foreground: `#e4f0fb` } },
    { scope: [`text.html.markdown markup.inline.raw.markdown`], settings: { foreground: `#ADD7FF` } },
    {
    ...
    { scope: [`markup.italic`], settings: { foreground: `#7390AA`, fontStyle: `italic` } },
    { scope: [`markup.bold`, `markup.bold string`], settings: { foreground: `#7390AA`, fontStyle: `bold` } },
    {
      scope: [
    ...
    { scope: [`markup.underline`], settings: { foreground: `#7390AA`, fontStyle: `underline` } },
    { scope: [`markup.strike`], settings: { fontStyle: `italic` } },
    { scope: [`markup.quote punctuation.definition.blockquote.markdown`], settings: { foreground: `#5DE4c7` } },
    { scope: [`markup.quote`], settings: { fontStyle: `italic` } },
    { scope: [`string.other.link.title.markdown`], settings: { foreground: `#ADD7FF` } },
    { scope: [`string.other.link.description.title.markdown`], settings: { foreground: `#ADD7FF` } },
    { scope: [`constant.other.reference.link.markdown`], settings: { foreground: `#ADD7FF` } },
    { scope: [`markup.raw.block`], settings: { foreground: `#ADD7FF` } },
    { scope: [`markup.raw.block.fenced.markdown`], settings: { foreground: `#50647750` } },
    { scope: [`punctuation.definition.fenced.markdown`], settings: { foreground: `#50647750` } },
    {
      scope: [`markup.raw.block.fenced.markdown`, `variable.language.fenced.markdown`, `punctuation.section.class.end`],
      settings: { foreground: `#91B4D5` },
    },
    { scope: [`variable.language.fenced.markdown`], settings: { foreground: `#91B4D5` } },
    { scope: [`meta.separator`], settings: { foreground: `#7390AA`, fontStyle: `bold` } },
    ...
    { scope: `markup.inline.raw.string.markdown`, settings: { foreground: `#7390AA` } },
    ...
    { scope: [`fenced_code.block.language`, `markup.inline.raw.markdown`], settings: { foreground: `#ADD7FF` } },
    {
      scope: [
    ...
    { scope: [`source.ignore`, `log.error`, `log.exception`], settings: { foreground: `#d0679d` } },
    { scope: [`log.verbose`], settings: { foreground: `#a6accd` } },
  ],
  i = { name: e, type: t, colors: n, tokenColors: r }
export { e as name, i as default, n as colors, r as tokenColors, t as type }
