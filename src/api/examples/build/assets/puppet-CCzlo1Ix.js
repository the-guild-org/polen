var e = `Puppet`,
  ...
  a = [
    ...
    {
      begin: `\\b(node)\\b`,
      captures: { 1: { name: `storage.type.puppet` }, 2: { name: `entity.name.type.class.puppet` } },
      end: `(?={)`,
      name: `meta.definition.class.puppet`,
      patterns: [{ match: `\\bdefault\\b`, name: `keyword.puppet` }, { include: `#strings` }, {
        include: `#regex-literal`,
      }],
    },
    {
      begin:
        `\\b(class)\\s+((?#Qualified Resource Name)(?:[a-z][a-z0-9_]*)?(?:::[a-z][a-z0-9_]*)+|(?#Bareword Resource Name)[a-z][a-z0-9_]*)\\s*`,
      captures: { 1: { name: `storage.type.puppet` }, 2: { name: `entity.name.type.class.puppet` } },
      end: `(?={)`,
      name: `meta.definition.class.puppet`,
      patterns: [
        {
          ...
          patterns: [{ match: `\\b((?:[-_A-Za-z0-9".]+::)*[-_A-Za-z0-9".]+)\\b`, name: `support.type.puppet` }],
        },
        { include: `#line_comment` },
    ...
    {
      begin:
        `^\\s*(plan)\\s+((?#Qualified Resource Name)(?:[a-z][a-z0-9_]*)?(?:::[a-z][a-z0-9_]*)+|(?#Bareword Resource Name)[a-z][a-z0-9_]*)\\s*`,
      captures: { 1: { name: `storage.type.puppet` }, 2: { name: `entity.name.type.plan.puppet` } },
      end: `(?={)`,
      name: `meta.definition.plan.puppet`,
      patterns: [{ include: `#line_comment` }, { include: `#resource-parameters` }, {
        include: `#parameter-default-types`,
      }],
    },
    {
      begin:
        `^\\s*(define|function)\\s+((?#Bareword Resource Name)[a-z][a-z0-9_]*|(?#Qualified Resource Name)(?:[a-z][a-z0-9_]*)?(?:::[a-z][a-z0-9_]*)+)\\s*(\\()`,
      captures: { 1: { name: `storage.type.function.puppet` }, 2: { name: `entity.name.function.puppet` } },
      end: `(?={)`,
    ...
    { captures: { 1: { name: `keyword.control.puppet` } }, match: `\\b(case|else|elsif|if|unless)(?!::)\\b` },
    { include: `#keywords` },
    ...
    {
      match:
        `\\b(alert|crit|debug|defined|emerg|err|escape|fail|failed|file|generate|gsub|info|notice|package|realize|search|tag|tagged|template|warning)\\b(?!.*{)`,
      name: `support.function.puppet`,
    },
    { match: `=>`, name: `punctuation.separator.key-value.puppet` },
    { match: `->`, name: `keyword.control.orderarrow.puppet` },
    { match: `~>`, name: `keyword.control.notifyarrow.puppet` },
    { include: `#regex-literal` },
  ],
  o = {
    array: {
      ...
      patterns: [{ match: `\\s*,\\s*` }, { include: `#parameter-default-types` }, { include: `#line_comment` }],
    },
    constants: {
      patterns: [{
    ...
    'double-quoted-string': {
      ...
      patterns: [{ include: `#escaped_char` }, { include: `#interpolated_puppet` }],
    },
    ...
    hash: {
      begin: `\\{`,
      beginCaptures: { 0: { name: `punctuation.definition.hash.begin.puppet` } },
      end: `\\}`,
      endCaptures: { 0: { name: `punctuation.definition.hash.end.puppet` } },
      name: `meta.hash.puppet`,
      patterns: [{ match: `\\b\\w+\\s*(?==>)\\s*`, name: `constant.other.key.puppet` }, {
        include: `#parameter-default-types`,
      }, { include: `#line_comment` }],
    },
    heredoc: {
      patterns: [{
        begin:
          `@\\([[:blank:]]*"([^:\\/) \\t]+)"[[:blank:]]*(:[[:blank:]]*[a-z][a-zA-Z0-9_+]*[[:blank:]]*)?(\\/[[:blank:]]*[tsrnL$]*)?[[:blank:]]*\\)`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.puppet` } },
    ...
    interpolated_puppet: {
      patterns: [{
        begin: '(\\${)(\\d+)',
        beginCaptures: {
          1: { name: `punctuation.section.embedded.begin.puppet` },
          2: { name: `source.puppet variable.other.readwrite.global.pre-defined.puppet` },
        },
        contentName: `source.puppet`,
        end: `}`,
        endCaptures: { 0: { name: `punctuation.section.embedded.end.puppet` } },
        ...
        beginCaptures: {
          1: { name: `punctuation.section.embedded.begin.puppet` },
          2: { name: `source.puppet variable.other.readwrite.global.puppet` },
        },
        contentName: `source.puppet`,
        end: `}`,
        endCaptures: { 0: { name: `punctuation.section.embedded.end.puppet` } },
        ...
        begin: '\\${',
        beginCaptures: { 0: { name: `punctuation.section.embedded.begin.puppet` } },
        contentName: `source.puppet`,
        end: `}`,
        endCaptures: { 0: { name: `punctuation.section.embedded.end.puppet` } },
        name: `meta.embedded.line.puppet`,
    ...
    keywords: { captures: { 1: { name: `keyword.puppet` } }, match: `\\b(undef)\\b` },
    line_comment: {
      patterns: [{
        captures: {
    ...
    nested_braces_interpolated: {
      ...
      patterns: [{ include: `#escaped_char` }, { include: `#variable` }, { include: `#nested_braces_interpolated` }],
    },
    nested_brackets: {
      begin: `\\[`,
      captures: { 1: { name: `punctuation.section.scope.puppet` } },
    ...
    nested_brackets_interpolated: {
      ...
      patterns: [{ include: `#escaped_char` }, { include: `#variable` }, { include: `#nested_brackets_interpolated` }],
    },
    nested_parens: {
      begin: `\\(`,
      captures: { 1: { name: `punctuation.section.scope.puppet` } },
    ...
    nested_parens_interpolated: {
      ...
      patterns: [{ include: `#escaped_char` }, { include: `#variable` }, { include: `#nested_parens_interpolated` }],
    },
    numbers: {
      patterns: [{
        comment: `HEX 0x 0-f`,
    ...
    'resource-definition': {
      begin:
        `(?:^|\\b)((?#Toplevel Bareword)::[a-z][a-z0-9_]*|(?#Bareword Resource Name)[a-z][a-z0-9_]*|(?#Qualified Resource Name)(?:[a-z][a-z0-9_]*)?(?:::[a-z][a-z0-9_]*)+)\\s*({)\\s*`,
      beginCaptures: { 1: { name: `meta.definition.resource.puppet storage.type.puppet` } },
      contentName: `entity.name.section.puppet`,
      end: `:`,
      patterns: [{ include: `#strings` }, { include: `#variable` }, { include: `#array` }],
    },
    'resource-parameters': {
      patterns: [{
        captures: { 1: { name: `variable.other.puppet` }, 2: { name: `punctuation.definition.variable.puppet` } },
    ...
    strings: { patterns: [{ include: `#double-quoted-string` }, { include: `#single-quoted-string` }] },
    variable: {
      patterns: [{
