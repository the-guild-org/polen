var e = `JavaScript`,
  ...
  r = {
    ...
    'arrow-function': {
      patterns: [{
        captures: { 1: { name: `storage.modifier.async.js` }, 2: { name: `variable.parameter.js` } },
        match:
...
\\s*=>
    ...
    'class-declaration-or-expression-patterns': {
      patterns: [
        ...
        { captures: { 0: { name: `entity.name.type.class.js` } }, match: `[_$[:alpha:]][_$[:alnum:]]*` },
    ...
    'class-or-interface-heritage': {
      ...
      patterns: [
        ...
        { captures: { 1: { name: `entity.other.inherited-class.js` } }, match: `([_$[:alpha:]][_$[:alnum:]]*)` },
    ...
    'control-statement': {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.control.loop.js` }, 2: { name: `entity.name.label.js` } },
          match:
...
((?:[^@\\s*/]|\\*[^/])+)`,
        },
        {
          ...
          }, { captures: { 0: { name: `source.embedded.js` } }, match: `[^\\s@*](?:[^*]|\\*[^/])*` }],
        },
        {
          captures: {
            1: { name: `storage.type.class.jsdoc` },
...
[^{}@\\s*] | \\*[^/]
    ...
    'export-declaration': {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.control.export.js` }, 2: { name: `keyword.control.type.js` } },
        end:
          `(?=$|;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b))`,
        name: `meta.export.js`,
...
\\s*=>
    ...
    'expression-operators': {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.control.flow.js` }, 2: { name: `keyword.generator.asterisk.js` } },
          match:
        ...
        },
        {
          ...
          beginCaptures: { 1: { name: `keyword.control.as.js` }, 2: { name: `keyword.control.satisfies.js` } },
          end:
...
\\s*=>
    ...
    'for-loop': {
      ...
      patterns: [{ include: `#comment` }, { match: `await`, name: `keyword.control.loop.js` }, {
        begin: `\\(`,
    ...
    'function-call-optionals': {
      patterns: [{ match: `\\?\\.`, name: `meta.function-call.js punctuation.accessor.optional.js` }, {
        match: `\\!`,
...
\\s*=>
    ...
    'if-statement': {
      patterns: [{
        ...
        patterns: [{ include: `#comment` }, {
          begin: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(if)\\s*(\\()`,
          beginCaptures: { 1: { name: `keyword.control.conditional.js` }, 2: { name: `meta.brace.round.js` } },
          end: `\\)`,
          endCaptures: { 0: { name: `meta.brace.round.js` } },
          patterns: [{ include: `#expression` }],
        }, {
          ...
          endCaptures: { 1: { name: `punctuation.definition.string.end.js` }, 2: { name: `keyword.other.js` } },
    ...
    'import-export-clause': {
      patterns: [
        ...
        {
          captures: { 1: { name: `keyword.control.type.js` }, 2: { name: `variable.other.readwrite.alias.js` } },
    ...
    'indexer-declaration': {
      ...
      endCaptures: { 1: { name: `meta.brace.square.js` }, 2: { name: `keyword.operator.optional.js` } },
    ...
    'interface-declaration': {
      ...
      patterns: [
        { include: `#comment` },
        { include: `#class-or-interface-heritage` },
        { captures: { 0: { name: `entity.name.type.interface.js` } }, match: `[_$[:alpha:]][_$[:alnum:]]*` },
        { include: `#type-parameters` },
        { include: `#class-or-interface-body` },
      ],
    },
    ...
    'jsx-entities': {
      patterns: [{
        captures: { 1: { name: `punctuation.definition.entity.js` }, 3: { name: `punctuation.definition.entity.js` } },
...
(?=(<)\\s*(?:([_$[:alpha:]][-_$[:alnum:].]*)(?<!\\.|-)(:))?((?:[a-z][a-z0-9]*|([_$[:alpha:]][-_$[:alnum:].]*))(?<!\\.|-))(?=((<\\s*)|(\\s+))(?!\\?)|\\/?>))`,
    ...
    label: {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `entity.name.label.js` }, 2: { name: `punctuation.separator.label.js` } },
        end: `(?<=\\})`,
        patterns: [{ include: `#decl-block` }],
      }, {
        captures: { 1: { name: `entity.name.label.js` }, 2: { name: `punctuation.separator.label.js` } },
        match: `([_$[:alpha:]][_$[:alnum:]]*)\\s*(:)`,
      }],
    },
    literal: {
...
(\\#?[_$[:alpha:]][_$[:alnum:]]*)
        ...
        captures: { 1: { name: `variable.other.constant.object.js` }, 2: { name: `variable.other.object.js` } },
        match: `(?x)(?:
([[:upper:]][_$[:digit:][:upper:]]*) |
([_$[:alpha:]][_$[:alnum:]]*)
)(?=\\s*\\??\\.\\s*\\#?[_$[:alpha:]][_$[:alnum:]]*)`,
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
        ...
        {
          captures: { 0: { name: `meta.object-literal.key.js` }, 1: { name: `constant.numeric.decimal.js` } },
          match: `(?![_$[:alpha:]])([[:digit:]]+)\\s*(?=(\\/\\*([^\\*]|(\\*[^\\/]))*\\*\\/\\s*)*:)`,
          name: `meta.object.member.js`,
        },
        {
          captures: { 0: { name: `meta.object-literal.key.js` }, 1: { name: `entity.name.function.js` } },
          match:
...
\\s*=>
        ...
        {
          begin: `:`,
          beginCaptures: { 0: { name: `meta.object-literal.key.js punctuation.separator.key-value.js` } },
          end: `(?=,|\\})`,
          name: `meta.object.member.js`,
          patterns: [
            {
            ...
            },
            {
              ...
              beginCaptures: { 1: { name: `storage.modifier.async.js` }, 2: { name: `meta.brace.round.js` } },
              end: `\\)`,
              endCaptures: { 0: { name: `meta.brace.round.js` } },
              patterns: [{ include: `#expression-inside-possibly-arrow-parens` }],
            },
...
(?:\\b[0-9][0-9_]*(n)?\\b(?!\\.))
    ...
    'possibly-arrow-return-type': {
      begin:
        `(?<=\\)|^)\\s*(:)(?=\\s*([^<>\\(\\)\\{\\}]|\\<([^<>]|\\<([^<>]|\\<[^<>]+\\>)+\\>)+\\>|\\([^\\(\\)]+\\)|\\{[^\\{\\}]+\\})+\\s*=>)`,
      beginCaptures: { 1: { name: `meta.arrow.js meta.return.type.arrow.js keyword.operator.type.annotation.js` } },
    ...
    'punctuation-accessor': {
      captures: { 1: { name: `punctuation.accessor.js` }, 2: { name: `punctuation.accessor.optional.js` } },
      match: `(?:(\\.)|(\\?\\.(?!\\s*[[:digit:]])))`,
    },
    ...
    'qstring-double': {
      ...
      endCaptures: { 1: { name: `punctuation.definition.string.end.js` }, 2: { name: `invalid.illegal.newline.js` } },
      name: `string.quoted.double.js`,
...
(?:(EPSILON|MAX_SAFE_INTEGER|MAX_VALUE|MIN_SAFE_INTEGER|MIN_VALUE|NEGATIVE_INFINITY|POSITIVE_INFINITY)\\b(?!\\$)))`,
    ...
    'switch-statement': {
      ...
      patterns: [{ include: `#comment` }, {
        ...
        beginCaptures: { 1: { name: `keyword.control.switch.js` }, 2: { name: `meta.brace.round.js` } },
        end: `\\)`,
        endCaptures: { 0: { name: `meta.brace.round.js` } },
        ...
        patterns: [{
          ...
          begin: `(:)\\s*(\\{)`,
          beginCaptures: {
            1: { name: `case-clause.expr.js punctuation.definition.section.case-statement.js` },
          ...
          captures: { 0: { name: `case-clause.expr.js punctuation.definition.section.case-statement.js` } },
          match: `(:)`,
        }, { include: `#statements` }],
      }],
    },
    template: {
      patterns: [{ include: `#template-call` }, {
        ...
        endCaptures: { 0: { name: `string.template.js punctuation.definition.string.template.end.js` } },
    ...
    'type-alias-declaration': {
      ...
      patterns: [{ include: `#comment` }, { include: `#type-parameters` }, {
        ...
        beginCaptures: { 1: { name: `keyword.operator.assignment.js` }, 2: { name: `keyword.control.intrinsic.js` } },
        end:
          `(?=\\}|;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b))`,
        patterns: [{ include: `#type` }],
      }, {
    ...
    'type-fn-type-parameters': {
      patterns: [{
        ...
        begin: `(?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(?:(abstract)\\s+)?(new)\\b\\s*(?=\\()`,
        beginCaptures: { 1: { name: `storage.modifier.js` }, 2: { name: `keyword.control.new.js` } },
        end: `(?<=\\))`,
...
([)]\\s*=>)
    ...
    'type-name': {
      patterns: [{
        ...
        endCaptures: { 1: { name: `meta.type.parameters.js punctuation.definition.typeparameters.end.js` } },
        patterns: [{ include: `#type-arguments-body` }],
      }, {
        begin: `([_$[:alpha:]][_$[:alnum:]]*)\\s*(<)`,
        beginCaptures: {
    ...
    'type-operators': {
      patterns: [
        ...
        { begin: `[&|]`, beginCaptures: { 0: { name: `keyword.operator.type.js` } }, end: `(?=\\S)` },
        {
...
\\s*=>
        ...
        beginCaptures: {
          1: { name: `meta.definition.variable.js variable.other.constant.js entity.name.function.js` },
        },
        end:
        ...
        begin: `([_$[:alpha:]][_$[:alnum:]]*)`,
        beginCaptures: { 1: { name: `meta.definition.variable.js variable.other.constant.js` } },
        end:
          `(?=$|^|[;,=}]|((?<![_$[:alnum:]])(?:(?<=\\.\\.\\.)|(?<!\\.))(of|in)\\s+)|(;|^\\s*$|(?:^\\s*(?:abstract|async|(?:\\bawait\\s+(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)\\b)|break|case|catch|class|const|continue|declare|do|else|enum|export|finally|function|for|goto|if|import|interface|let|module|namespace|switch|return|throw|try|type|(?:\\busing(?=\\s+(?!in\\b|of\\b(?!\\s*(?:of\\b|=)))[_$[:alpha:]])\\b)|var|while)\\b)))`,
        name: `meta.var-single-variable.expr.js`,
        patterns: [{ include: `#var-single-variable-type-annotation` }],
