var e = `Svelte`,
  ...
  a = {
    attributes: {
      patterns: [{ include: `#attributes-directives` }, { include: `#attributes-keyvalue` }, {
    ...
    'attributes-directives': {
      ...
      beginCaptures: {
        ...
        5: {
          patterns: [{ match: `\\w+`, name: `support.function.svelte` }, {
            match: `\\|`,
    ...
    'attributes-generics': {
      ...
      endCaptures: { 1: { name: `punctuation.definition.string.end.svelte` } },
    ...
    'attributes-keyvalue': {
      ...
      beginCaptures: {
        0: {
          patterns: [{ match: `--.*`, name: `support.type.property-name.svelte` }, {
            match: `.*`,
    ...
    comments: {
      ...
      patterns: [{
        ...
        patterns: [{ captures: { 0: { patterns: [{ include: `text.html.markdown` }] } }, match: `.*?(?=-->)` }, {
    ...
    interpolation: {
      patterns: [{
        ...
        patterns: [{ begin: `\\G\\s*(?={)`, end: `(?<=})`, patterns: [{ include: `source.ts#object-literal` }] }, {
          include: `source.ts`,
        }],
      }],
    },
    scope: {
      patterns: [{ include: `#comments` }, { include: `#special-tags` }, { include: `#tags` }, {
        include: `#interpolation`,
      }, { begin: `(?<=>|})`, end: `(?=<|{)`, name: `text.svelte` }],
    },
    'special-tags': {
      patterns: [{ include: `#special-tags-void` }, { include: `#special-tags-block-begin` }, {
    ...
    'special-tags-modes': {
      patterns: [{
        ...
        patterns: [{ include: `#destructuring-const` }, {
        ...
        patterns: [{
          ...
          patterns: [{ include: `#destructuring` }, {
            ...
            captures: {
              1: { name: `meta.embedded.expression.svelte source.ts`, patterns: [{ include: `source.ts` }] },
            },
    ...
    tags: {
      patterns: [{ include: `#tags-lang` }, { include: `#tags-void` }, { include: `#tags-general-end` }, {
    ...
    'tags-general-end': {
      ...
      endCaptures: { 1: { name: `meta.tag.end.svelte punctuation.definition.tag.end.svelte` } },
    ...
    'tags-general-start': {
      ...
      endCaptures: { 1: { name: `meta.tag.start.svelte punctuation.definition.tag.end.svelte` } },
      name: `meta.scope.tag.$2.svelte`,
    ...
    'tags-lang-start-attributes': {
      ...
      patterns: [{ include: `#attributes-generics` }, { include: `#attributes` }],
    },
    'tags-name': {
      patterns: [
        {
    ...
    'tags-void': {
      ...
      beginCaptures: { 1: { name: `punctuation.definition.tag.begin.svelte` }, 2: { name: `entity.name.tag.svelte` } },
      end: `/?>`,
