var e = `Objective-C`,
  ...
  r = {
    ...
    anonymous_pattern_11: { match: `\\bid\\b`, name: `storage.type.id.objc` },
    ...
    anonymous_pattern_16: { match: `\\b(YES|NO|Nil|nil)\\b`, name: `constant.language.objc` },
    anonymous_pattern_17: { match: `\\bNSApp\\b`, name: `support.variable.foundation.objc` },
    anonymous_pattern_18: {
      captures: {
        1: { name: `punctuation.whitespace.support.function.cocoa.leopard.objc` },
        2: { name: `support.function.cocoa.leopard.objc` },
      },
      match:
...
`,
    ...
    anonymous_pattern_5: { match: `\\b(NS_DURING|NS_HANDLER|NS_ENDHANDLER)\\b`, name: `keyword.control.macro.objc` },
    anonymous_pattern_7: {
      captures: { 1: { name: `punctuation.definition.keyword.objc` } },
    ...
    apple_foundation_functional_macros: {
      ...
      beginCaptures: {
        1: { name: `entity.name.function.preprocessor.apple-foundation.objc` },
        2: { name: `punctuation.section.macro.arguments.begin.bracket.round.apple-foundation.objc` },
      },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.macro.arguments.end.bracket.round.apple-foundation.objc` } },
      ...
      patterns: [
        {
          ...
          patterns: [
            ...
            },
            {
              ...
              name: `string.quoted.double.objc`,
              patterns: [
                { match: `\\b(AND|OR|NOT|IN)\\b`, name: `keyword.operator.logical.predicate.cocoa.objc` },
                { match: `\\b(ALL|ANY|SOME|NONE)\\b`, name: `constant.language.predicate.cocoa.objc` },
                {
                ...
                { match: `\\bC(ASEINSENSITIVE|I)\\b`, name: `keyword.other.modifier.predicate.cocoa.objc` },
                {
    ...
    c_functions: {
      patterns: [{
        captures: {
          1: { name: `punctuation.whitespace.support.function.leading.objc` },
          2: { name: `support.function.C99.objc` },
        },
        match:
        ...
        captures: {
          1: { name: `punctuation.whitespace.function-call.leading.objc` },
          2: { name: `support.function.any-method.objc` },
          3: { name: `punctuation.definition.parameters.objc` },
        },
...
\\s*(\\()`,
    ...
    c_lang: {
      patterns: [
        ...
        { match: `\\b(break|continue|do|else|for|goto|if|_Pragma|return|while)\\b`, name: `keyword.control.objc` },
        { include: `#storage_types` },
        { match: `typedef`, name: `keyword.other.typedef.objc` },
        { match: `\\bin\\b`, name: `keyword.other.in.objc` },
        {
          match: `\\b(const|extern|register|restrict|static|volatile|inline|__block)\\b`,
          name: `storage.modifier.objc`,
        },
        { match: `\\bk[A-Z]\\w*\\b`, name: `constant.other.variable.mac-classic.objc` },
        { match: `\\bg[A-Z]\\w*\\b`, name: `variable.other.readwrite.global.mac-classic.objc` },
        { match: `\\bs[A-Z]\\w*\\b`, name: `variable.other.readwrite.static.mac-classic.objc` },
        { match: `\\b(NULL|true|false|TRUE|FALSE)\\b`, name: `constant.language.objc` },
        { include: `#operators` },
        { include: `#numbers` },
        { include: `#strings` },
        { include: `#special_variables` },
...
(\\))
          ...
          beginCaptures: {
            1: { name: `keyword.control.directive.define.objc` },
            2: { name: `punctuation.definition.directive.objc` },
            3: { name: `entity.name.function.preprocessor.objc` },
            5: { name: `punctuation.definition.parameters.begin.objc` },
            6: { name: `variable.parameter.preprocessor.objc` },
            8: { name: `punctuation.separator.parameters.objc` },
            9: { name: `punctuation.definition.parameters.end.objc` },
          },
          end: `(?=(?://|/\\*))|(?<!\\\\)(?=\\n)`,
        ...
        },
        {
          ...
          beginCaptures: {
            1: { name: `keyword.control.directive.diagnostic.$3.objc` },
            2: { name: `punctuation.definition.directive.objc` },
          },
          end: `(?<!\\\\)(?=\\n)`,
        ...
        },
        {
          ...
          beginCaptures: {
            1: { name: `keyword.control.directive.$3.objc` },
            2: { name: `punctuation.definition.directive.objc` },
          },
          end: `(?=(?://|/\\*))|(?<!\\\\)(?=\\n)`,
        ...
        { include: `#pragma-mark` },
        {
          begin: `^\\s*((#)\\s*line)\\b`,
          beginCaptures: {
            1: { name: `keyword.control.directive.line.objc` },
            2: { name: `punctuation.definition.directive.objc` },
          },
          end: `(?=(?://|/\\*))|(?<!\\\\)(?=\\n)`,
        ...
        },
        {
          begin: `^\\s*(?:((#)\\s*undef))\\b`,
          beginCaptures: {
            1: { name: `keyword.control.directive.undef.objc` },
            2: { name: `punctuation.definition.directive.objc` },
          },
          end: `(?=(?://|/\\*))|(?<!\\\\)(?=\\n)`,
          name: `meta.preprocessor.objc`,
          patterns: [{ match: `[a-zA-Z_$][\\w$]*`, name: `entity.name.function.preprocessor.objc` }, {
        ...
        },
        {
          begin: `^\\s*(?:((#)\\s*pragma))\\b`,
          beginCaptures: {
            1: { name: `keyword.control.directive.pragma.objc` },
            2: { name: `punctuation.definition.directive.objc` },
          },
          end: `(?=(?://|/\\*))|(?<!\\\\)(?=\\n)`,
          ...
          patterns: [
            { include: `#strings` },
            { match: `[a-zA-Z_$][\\w\\-$]*`, name: `entity.other.attribute-name.pragma.preprocessor.objc` },
            { include: `#numbers` },
            { include: `#line_continuation_character` },
          ],
        },
...
\\b`,
        ...
        { match: `\\b([A-Za-z0-9_]+_t)\\b`, name: `support.type.posix-reserved.objc` },
        { include: `#block` },
        { include: `#parens` },
        {
          begin:
        ...
        { include: `#line_continuation_character` },
        {
          ...
          beginCaptures: {
            1: { name: `variable.object.objc` },
            2: { name: `punctuation.definition.begin.bracket.square.objc` },
          },
          end: `\\]`,
          endCaptures: { 0: { name: `punctuation.definition.end.bracket.square.objc` } },
          name: `meta.bracket.square.access.objc`,
          patterns: [{ include: `#function-call-innards` }],
        },
        { match: `\\[\\s*\\]`, name: `storage.modifier.array.bracket.square.objc` },
        { match: `;`, name: `punctuation.terminator.statement.objc` },
        { match: `,`, name: `punctuation.separator.delimiter.objc` },
      ],
      repository: {
        'access-method': {
          begin:
          ...
          beginCaptures: {
            1: { name: `variable.object.objc` },
            2: { name: `punctuation.separator.dot-access.objc` },
            3: { name: `punctuation.separator.pointer-access.objc` },
            4: {
              patterns: [
                { match: `\\.`, name: `punctuation.separator.dot-access.objc` },
                { match: `->`, name: `punctuation.separator.pointer-access.objc` },
                { match: `[a-zA-Z_][a-zA-Z_0-9]*`, name: `variable.object.objc` },
                { match: `.+`, name: `everything.else.objc` },
              ],
            },
            5: { name: `entity.name.function.member.objc` },
            6: { name: `punctuation.section.arguments.begin.bracket.round.function.member.objc` },
          },
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.function.member.objc` } },
        ...
        block: {
          patterns: [{
            begin: `{`,
            beginCaptures: { 0: { name: `punctuation.section.block.begin.bracket.curly.objc` } },
            end: `}|(?=\\s*#\\s*(?:elif|else|endif)\\b)`,
            endCaptures: { 0: { name: `punctuation.section.block.end.bracket.curly.objc` } },
...
\\s*(\\() # opening bracket`,
              beginCaptures: {
                1: { name: `variable.other.objc` },
                2: { name: `punctuation.section.parens.begin.bracket.round.initialization.objc` },
              },
              end: `\\)`,
              endCaptures: { 0: { name: `punctuation.section.parens.end.bracket.round.initialization.objc` } },
...
(?:(?<=operator)(?:[-*&<>=+!]+|\\(\\)|\\[\\]))\\s*\\(
        ...
        case_statement: {
          begin: `((?<!\\w)case(?!\\w))`,
          beginCaptures: { 1: { name: `keyword.control.case.objc` } },
          end: `(:)`,
          endCaptures: { 1: { name: `punctuation.separator.case.objc` } },
          name: `meta.conditional.case.objc`,
          patterns: [{ include: `#conditional_context` }],
        },
        comments: {
          patterns: [{
            captures: { 1: { name: `meta.toc-list.banner.block.objc` } },
            match: `^/\\* =(\\s*.*?)\\s*= \\*/$\\n?`,
            name: `comment.block.objc`,
          }, {
            begin: `/\\*`,
            beginCaptures: { 0: { name: `punctuation.definition.comment.begin.objc` } },
            end: `\\*/`,
            endCaptures: { 0: { name: `punctuation.definition.comment.end.objc` } },
            name: `comment.block.objc`,
          }, {
            captures: { 1: { name: `meta.toc-list.banner.line.objc` } },
            match: `^// =(\\s*.*?)\\s*=\\s*$\\n?`,
            name: `comment.line.banner.objc`,
          }, {
            begin: `(^[ \\t]+)?(?=//)`,
            beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.objc` } },
            end: `(?!\\G)`,
            patterns: [{
              begin: `//`,
        ...
        default_statement: {
          begin: `((?<!\\w)default(?!\\w))`,
          beginCaptures: { 1: { name: `keyword.control.default.objc` } },
          end: `(:)`,
          endCaptures: { 1: { name: `punctuation.separator.case.default.objc` } },
          name: `meta.conditional.case.objc`,
          patterns: [{ include: `#conditional_context` }],
        },
        disabled: {
...
\\s*(\\()`,
              beginCaptures: {
                1: { name: `entity.name.function.objc` },
                2: { name: `punctuation.section.arguments.begin.bracket.round.objc` },
              },
              end: `\\)`,
              endCaptures: { 0: { name: `punctuation.section.arguments.end.bracket.round.objc` } },
              patterns: [{ include: `#function-call-innards` }],
            },
            {
              begin: `\\(`,
              beginCaptures: { 0: { name: `punctuation.section.parens.begin.bracket.round.objc` } },
              end: `\\)`,
              endCaptures: { 0: { name: `punctuation.section.parens.end.bracket.round.objc` } },
              patterns: [{ include: `#function-call-innards` }],
            },
...
\\s*(\\()`,
            beginCaptures: {
              1: { name: `entity.name.function.objc` },
              2: { name: `punctuation.section.parameters.begin.bracket.round.objc` },
            },
            end: `\\)`,
            endCaptures: { 0: { name: `punctuation.section.parameters.end.bracket.round.objc` } },
        ...
        line_continuation_character: {
          patterns: [{
            captures: { 1: { name: `constant.character.escape.line-continuation.objc` } },
            match: `(\\\\)\\n`,
          }],
        },
        member_access: {
          captures: {
            ...
            5: { name: `variable.other.member.objc` },
          },
          match:
        ...
        method_access: {
          ...
          endCaptures: { 1: { name: `punctuation.section.arguments.end.bracket.round.function.member.objc` } },
          patterns: [{ include: `#function-call-innards` }],
        },
        numbers: {
          begin: `(?<!\\w)(?=\\d|\\.\\d)`,
          ...
          patterns: [{
            captures: {
              1: { name: `keyword.other.unit.hexadecimal.objc` },
              2: {
              ...
              3: { name: `punctuation.separator.constant.numeric.objc` },
              4: { name: `constant.numeric.hexadecimal.objc` },
              5: {
                name: `constant.numeric.hexadecimal.objc`,
                patterns: [{
                  match: `(?<=[0-9a-fA-F])'(?=[0-9a-fA-F])`,
              ...
              6: { name: `punctuation.separator.constant.numeric.objc` },
              8: { name: `keyword.other.unit.exponent.hexadecimal.objc` },
              9: { name: `keyword.operator.plus.exponent.hexadecimal.objc` },
              10: { name: `keyword.operator.minus.exponent.hexadecimal.objc` },
              11: {
              ...
              12: { name: `keyword.other.unit.suffix.floating-point.objc` },
            },
            match:
            ...
            captures: {
              ...
              3: { name: `punctuation.separator.constant.numeric.objc` },
              4: { name: `constant.numeric.decimal.point.objc` },
              5: {
                name: `constant.numeric.decimal.objc`,
                patterns: [{
                  match: `(?<=[0-9a-fA-F])'(?=[0-9a-fA-F])`,
              ...
              6: { name: `punctuation.separator.constant.numeric.objc` },
              8: { name: `keyword.other.unit.exponent.decimal.objc` },
              9: { name: `keyword.operator.plus.exponent.decimal.objc` },
              10: { name: `keyword.operator.minus.exponent.decimal.objc` },
              11: {
            ...
            captures: {
              1: { name: `keyword.other.unit.binary.objc` },
              2: {
              ...
              3: { name: `punctuation.separator.constant.numeric.objc` },
              4: { name: `keyword.other.unit.suffix.integer.objc` },
            },
            match:
              `(\\G0[bB])([01](?:(?:[01]|((?<=[0-9a-fA-F])'(?=[0-9a-fA-F]))))*)(?:((?:(?:(?:(?:(?:[uU]|[uU]ll?)|[uU]LL?)|ll?[uU]?)|LL?[uU]?)|[fF])(?!\\w)))?(?!(?:['0-9a-zA-Z_\\.']|(?<=[eEpP])[+-]))`,
          }, {
            captures: {
              1: { name: `keyword.other.unit.octal.objc` },
              2: {
            ...
            captures: {
              ...
              3: { name: `punctuation.separator.constant.numeric.objc` },
              5: { name: `keyword.other.unit.exponent.hexadecimal.objc` },
              6: { name: `keyword.operator.plus.exponent.hexadecimal.objc` },
              7: { name: `keyword.operator.minus.exponent.hexadecimal.objc` },
              8: {
                name: `constant.numeric.exponent.hexadecimal.objc`,
                patterns: [{
                  match: `(?<=[0-9a-fA-F])'(?=[0-9a-fA-F])`,
              ...
              9: { name: `keyword.other.unit.suffix.integer.objc` },
            },
            match:
            ...
            captures: {
              ...
              3: { name: `punctuation.separator.constant.numeric.objc` },
              5: { name: `keyword.other.unit.exponent.decimal.objc` },
              6: { name: `keyword.operator.plus.exponent.decimal.objc` },
              7: { name: `keyword.operator.minus.exponent.decimal.objc` },
              8: {
                name: `constant.numeric.exponent.decimal.objc`,
                patterns: [{
                  match: `(?<=[0-9a-fA-F])'(?=[0-9a-fA-F])`,
          ...
          }, { match: `(?:(?:['0-9a-zA-Z_\\.']|(?<=[eEpP])[+-]))+`, name: `invalid.illegal.constant.numeric.objc` }],
        },
        operators: {
          patterns: [
            { match: `(?<![\\w$])(sizeof)(?![\\w$])`, name: `keyword.operator.sizeof.objc` },
            { match: `--`, name: `keyword.operator.decrement.objc` },
            { match: `\\+\\+`, name: `keyword.operator.increment.objc` },
            { match: `%=|\\+=|-=|\\*=|(?<!\\()/=`, name: `keyword.operator.assignment.compound.objc` },
            { match: `&=|\\^=|<<=|>>=|\\|=`, name: `keyword.operator.assignment.compound.bitwise.objc` },
            { match: `<<|>>`, name: `keyword.operator.bitwise.shift.objc` },
            { match: `!=|<=|>=|==|<|>`, name: `keyword.operator.comparison.objc` },
            { match: `&&|!|\\|\\|`, name: `keyword.operator.logical.objc` },
            { match: `&|\\||\\^|~`, name: `keyword.operator.objc` },
            { match: `=`, name: `keyword.operator.assignment.objc` },
            { match: `%|\\*|/|-|\\+`, name: `keyword.operator.objc` },
            {
              begin: `(\\?)`,
              beginCaptures: { 1: { name: `keyword.operator.ternary.objc` } },
              end: `(:)`,
              endCaptures: { 1: { name: `keyword.operator.ternary.objc` } },
        ...
        'pragma-mark': {
          captures: {
            1: { name: `meta.preprocessor.pragma.objc` },
            2: { name: `keyword.control.directive.pragma.pragma-mark.objc` },
            3: { name: `punctuation.definition.directive.objc` },
            4: { name: `entity.name.tag.pragma-mark.objc` },
          },
        ...
        'preprocessor-rule-conditional': {
          patterns: [{
            begin: `^\\s*((#)\\s*if(?:n?def)?\\b)`,
            beginCaptures: {
              0: { name: `meta.preprocessor.objc` },
              1: { name: `keyword.control.directive.conditional.objc` },
              2: { name: `punctuation.definition.directive.objc` },
            },
            end: `^\\s*((#)\\s*endif\\b)`,
            endCaptures: {
          ...
          }, { captures: { 0: { name: `invalid.illegal.stray-$1.objc` } }, match: `^\\s*#\\s*(else|elif|endif)\\b` }],
        },
        ...
        'preprocessor-rule-conditional-line': {
          patterns: [
            ...
            { match: `\\bdefined\\b`, name: `invalid.illegal.macro-name.objc` },
            { include: `#comments` },
            { include: `#strings` },
            { include: `#numbers` },
            {
              begin: `\\?`,
              beginCaptures: { 0: { name: `keyword.operator.ternary.objc` } },
              end: `:`,
              endCaptures: { 0: { name: `keyword.operator.ternary.objc` } },
              patterns: [{ include: `#preprocessor-rule-conditional-line` }],
            },
            { include: `#operators` },
            { match: `\\b(NULL|true|false|TRUE|FALSE)\\b`, name: `constant.language.objc` },
            { match: `[a-zA-Z_$][\\w$]*`, name: `entity.name.function.preprocessor.objc` },
            { include: `#line_continuation_character` },
            {
              begin: `\\(`,
              beginCaptures: { 0: { name: `punctuation.section.parens.begin.bracket.round.objc` } },
        ...
        'preprocessor-rule-define-line-contents': {
          patterns: [
            ...
            { match: `\\(`, name: `punctuation.section.parens.begin.bracket.round.objc` },
            { match: `\\)`, name: `punctuation.section.parens.end.bracket.round.objc` },
            {
              begin: `(?x)
...
\\s*(\\()`,
              ...
              endCaptures: { 1: { name: `punctuation.section.arguments.end.bracket.round.objc` } },
              patterns: [{ include: `#preprocessor-rule-define-line-functions` }],
            },
            {
              begin: `\\(`,
              ...
              endCaptures: { 1: { name: `punctuation.section.parens.end.bracket.round.objc` } },
              patterns: [{ include: `#preprocessor-rule-define-line-functions` }],
            },
            { include: `#preprocessor-rule-define-line-contents` },
          ],
        ...
        'preprocessor-rule-enabled': {
          patterns: [{
            ...
            beginCaptures: {
              ...
              1: { name: `keyword.control.directive.conditional.objc` },
              2: { name: `punctuation.definition.directive.objc` },
              3: { name: `constant.numeric.preprocessor.objc` },
            },
            end: `^\\s*((#)\\s*endif\\b)`,
            endCaptures: {
              0: { name: `meta.preprocessor.objc` },
        ...
        probably_a_parameter: {
          captures: { 1: { name: `variable.parameter.probably.objc` } },
          match: `(?<=(?:[a-zA-Z_0-9] |[&*>\\]\\)]))\\s*([a-zA-Z_]\\w*)\\s*(?=(?:\\[\\]\\s*)?(?:,|\\)))`,
        },
        static_assert: {
          begin: `(static_assert|_Static_assert)\\s*(\\()`,
          beginCaptures: {
            1: { name: `keyword.other.static_assert.objc` },
            2: { name: `punctuation.section.arguments.begin.bracket.round.objc` },
          },
          end: `(\\))`,
          endCaptures: { 1: { name: `punctuation.section.arguments.end.bracket.round.objc` } },
          patterns: [{
            begin: `(,)\\s*(?=(?:L|u8|u|U\\s*\\")?)`,
            beginCaptures: { 1: { name: `punctuation.separator.delimiter.objc` } },
            end: `(?=\\))`,
        ...
        storage_types: {
          ...
          }, { match: `(?-mix:\\b(asm|__asm__|enum|struct|union)\\b)`, name: `storage.type.$1.objc` }],
        },
        string_escaped_char: {
          patterns: [{
            match: `(?x)\\\\ (
...
[diouxXDOUeEfFgGaACcSspn%]		   # conversion type`,
            name: `constant.other.placeholder.objc`,
          }, { captures: { 1: { name: `invalid.illegal.placeholder.objc` } }, match: `(%)(?!"\\s*(PRI|SCN))` }],
        },
        strings: {
          patterns: [{
            begin: `"`,
        ...
        switch_conditional_parentheses: {
          begin: `(\\()`,
          beginCaptures: { 1: { name: `punctuation.section.parens.begin.bracket.round.conditional.switch.objc` } },
          end: `(\\))`,
          endCaptures: { 1: { name: `punctuation.section.parens.end.bracket.round.conditional.switch.objc` } },
          name: `meta.conditional.switch.objc`,
          patterns: [{ include: `#conditional_context` }],
        },
        switch_statement: {
          begin: `(((?<!\\w)switch(?!\\w)))`,
          beginCaptures: { 1: { name: `meta.head.switch.objc` }, 2: { name: `keyword.control.switch.objc` } },
          end: `(?:(?<=\\})|(?=[;>\\[\\]=]))`,
          name: `meta.block.switch.objc`,
          patterns: [{
            begin: `\\G ?`,
            end: `((?:\\{|(?=;)))`,
            endCaptures: { 1: { name: `punctuation.section.block.begin.bracket.curly.switch.objc` } },
            name: `meta.head.switch.objc`,
            patterns: [{ include: `#switch_conditional_parentheses` }, { include: `$base` }],
          }, {
            begin: `(?<=\\{)`,
            end: `(\\})`,
            endCaptures: { 1: { name: `punctuation.section.block.end.bracket.curly.switch.objc` } },
        ...
        vararg_ellipses: { match: `(?<!\\.)\\.\\.\\.(?!\\.)`, name: `punctuation.vararg-ellipses.objc` },
      },
    },
    comment: {
      patterns: [{
    ...
    method: {
      ...
      patterns: [
        ...
        { match: `\\b\\w+(?=:)`, name: `entity.name.function.name-of-parameter.objc` },
        {
          begin: `((:))\\s*(\\()`,
          beginCaptures: {
    ...
    'pragma-mark': {
      captures: {
        1: { name: `meta.preprocessor.objc` },
        2: { name: `keyword.control.import.pragma.objc` },
        3: { name: `meta.toc-list.pragma-mark.objc` },
      },
      match: `^\\s*(#\\s*(pragma\\s+mark)\\s+(.*))`,
      name: `meta.section.objc`,
    },
    'preprocessor-rule-disabled-implementation': {
      ...
      captures: {
        1: { name: `meta.preprocessor.objc` },
        2: { name: `keyword.control.import.if.objc` },
        3: { name: `constant.numeric.preprocessor.objc` },
      },
      end: `^\\s*(#\\s*(endif)\\b.*?(?:(?=(?://|/\\*))|$))`,
      patterns: [{
        begin: `^\\s*(#\\s*(else)\\b)`,
        captures: { 1: { name: `meta.preprocessor.objc` }, 2: { name: `keyword.control.import.else.objc` } },
        end: `(?=^\\s*#\\s*endif\\b.*?(?:(?=(?://|/\\*))|$))`,
        patterns: [{ include: `#interface_innards` }],
      }, {
        begin: ``,
    ...
    'preprocessor-rule-other-implementation': {
      begin: `^\\s*(#\\s*(if(n?def)?)\\b.*?(?:(?=(?://|/\\*))|$))`,
      captures: { 1: { name: `meta.preprocessor.objc` }, 2: { name: `keyword.control.import.objc` } },
      end: `^\\s*(#\\s*(endif)\\b).*?(?:(?=(?://|/\\*))|$)`,
      patterns: [{ include: `#implementation_innards` }],
    },
    ...
    properties: {
      patterns: [{
        ...
        captures: { 1: { name: `keyword.other.property.objc` }, 2: { name: `punctuation.definition.keyword.objc` } },
        match: `((@)property)\\b`,
    ...
    special_variables: {
      patterns: [{ match: `\\b_cmd\\b`, name: `variable.other.selector.objc` }, {
