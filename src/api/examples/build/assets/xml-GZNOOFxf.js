var e = `XML`,
  ...
  n = [
    {
      begin: `(<\\?)\\s*([-_a-zA-Z0-9]+)`,
      captures: { 1: { name: `punctuation.definition.tag.xml` }, 2: { name: `entity.name.tag.xml` } },
      end: `(\\?>)`,
      name: `meta.tag.preprocessor.xml`,
      patterns: [{ match: ` ([a-zA-Z-]+)`, name: `entity.other.attribute-name.xml` }, {
    ...
    },
    {
      ...
      captures: {
        ...
        3: { name: `variable.language.documentroot.xml` },
      },
      end: `\\s*(>)`,
    ...
    { include: `#bare-ampersand` },
    {
      ...
      patterns: [{ match: `page|include|taglib`, name: `keyword.other.page-props.xml` }],
    },
    {
      begin: `<%[!=]?(?!--)`,
      beginCaptures: { 0: { name: `punctuation.section.embedded.begin.xml` } },
  ...
  r = {
    EntityDecl: {
      ...
      patterns: [{ include: `#doublequotedString` }, { include: `#singlequotedString` }],
    },
    'bare-ampersand': { match: `&`, name: `invalid.illegal.bad-ampersand.xml` },
    comments: {
      patterns: [{
        begin: `<%--`,
        captures: { 0: { name: `punctuation.definition.comment.xml` }, end: `--%>`, name: `comment.block.xml` },
      }, {
        begin: `<!--`,
        captures: { 0: { name: `punctuation.definition.comment.xml` } },
        end: `-->`,
        name: `comment.block.xml`,
        patterns: [{ begin: `--(?!>)`, captures: { 0: { name: `invalid.illegal.bad-comments-or-CDATA.xml` } } }],
      }],
    },
    doublequotedString: {
      begin: `"`,
    ...
    internalSubset: {
      ...
      patterns: [{ include: `#EntityDecl` }, { include: `#parameterEntity` }, { include: `#comments` }],
    },
    parameterEntity: {
      captures: {
        1: { name: `punctuation.definition.constant.xml` },
  ...
  i = `text.xml`,
  a = { displayName: `XML`, name: `xml`, patterns: n, repository: r, scopeName: i }
