  ...
  r = {
    ...
    attributes: {
      patterns: [{
        ...
        patterns: [{
          captures: { 1: { name: `keyword.other.platform.os.swift` }, 2: { name: `constant.numeric.swift` } },
          match:
          ...
          beginCaptures: { 1: { name: `keyword.other.swift` }, 2: { name: `punctuation.separator.key-value.swift` } },
          end: `(?!\\G)`,
          patterns: [{ match: `\\b[0-9]+(?:\\.[0-9]+)*\\b`, name: `constant.numeric.swift` }],
        }, {
        ...
        patterns: [{
          captures: { 1: { name: `invalid.illegal.missing-colon-after-selector-piece.swift` } },
          match: `\\w*(?::(?:\\w*:)*(\\w*))?`,
        ...
        patterns: [{
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.definition.arguments.begin.swift` } },
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.definition.arguments.end.swift` } },
    ...
    comments: {
      patterns: [
        ...
        { match: `\\*/`, name: `invalid.illegal.unexpected-end-of-block-comment.swift` },
        {
          begin: `(^[ \\t]+)?(?=//)`,
    ...
    'comments-nested': { begin: `/\\*`, end: `\\*/`, patterns: [{ include: `#comments-nested` }] },
    'compiler-control': {
      patterns: [{
        ...
        patterns: [{ match: `(&&|\\|\\|)`, name: `keyword.operator.logical.swift` }, {
          ...
          endCaptures: { 1: { name: `punctuation.definition.parameters.end.swift` } },
          patterns: [{ match: `\\b(simulator|UIKitForMac)\\b`, name: `support.constant.platform.environment.swift` }],
        }, {
          ...
          endCaptures: { 1: { name: `punctuation.definition.parameters.end.swift` } },
          patterns: [{ match: `>=|<`, name: `keyword.operator.comparison.swift` }, {
            match: `\\b[0-9]+(?:\\.[0-9]+)*\\b`,
        ...
        captures: {
          1: { name: `punctuation.definition.preprocessor.swift` },
          2: { name: `keyword.control.import.preprocessor.conditional.swift` },
          3: { patterns: [{ match: `\\S+`, name: `invalid.illegal.character-not-allowed-here.swift` }] },
        },
        match: `^\\s*(#)(else|endif)(.*?)(?=$|//|/\\*)`,
        name: `meta.preprocessor.conditional.swift`,
      }, {
        captures: {
          1: { name: `punctuation.definition.preprocessor.swift` },
          2: { name: `keyword.control.import.preprocessor.sourcelocation.swift` },
          ...
          5: {
            patterns: [
              ...
              { match: `\\S+`, name: `invalid.illegal.character-not-allowed-here.swift` },
            ],
          },
          6: { name: `punctuation.definition.parameters.begin.swift` },
          7: { patterns: [{ match: `\\S+`, name: `invalid.illegal.character-not-allowed-here.swift` }] },
        },
    ...
    'declarations-available-types': {
      patterns: [
        ...
        { match: `\\b(?:throws|rethrows)\\b`, name: `storage.modifier.exception.swift` },
        { match: `\\bsome\\b`, name: `keyword.other.operator.type.opaque.swift` },
        { match: `\\bany\\b`, name: `keyword.other.operator.type.existential.swift` },
        { match: `\\b(?:repeat|each)\\b`, name: `keyword.control.loop.swift` },
        { match: `\\b(?:inout|isolated|borrowing|consuming)\\b`, name: `storage.modifier.swift` },
        ...
        { match: `\\.\\.\\.`, name: `keyword.operator.function.variadic-parameter.swift` },
        { comment: `Swift 2: protocol<A, B>`, match: `\\bprotocol\\b`, name: `keyword.other.type.composition.swift` },
        { match: `(?<=\\.)(?:Protocol|Type)\\b`, name: `keyword.other.type.metatype.swift` },
    ...
    'declarations-available-types-collection-type': {
      begin: `\\[`,
      beginCaptures: { 0: { name: `punctuation.section.collection-type.begin.swift` } },
      ...
      patterns: [{ include: `#declarations-available-types` }, {
        ...
        patterns: [{ match: `:`, name: `invalid.illegal.extra-colon-in-dictionary-type.swift` }, {
    ...
    'declarations-extension': {
      ...
      beginCaptures: {
        ...
        2: { name: `entity.name.type.swift`, patterns: [{ include: `#declarations-available-types` }] },
        3: { name: `punctuation.definition.identifier.swift` },
      ...
      patterns: [
        { include: `#comments` },
        { comment: `SE-0143: Conditional Conformances`, include: `#declarations-generic-where-clause` },
...
(?=\\(|<)`,
      ...
      patterns: [
        ...
        {
          begin: `(\\{)`,
          beginCaptures: { 1: { name: `punctuation.section.function.begin.swift` } },
          end: `(\\})`,
    ...
    'declarations-function-initializer': {
      ...
      beginCaptures: {
        1: {
          ...
          patterns: [{ match: `(?<=[?!])[?!]+`, name: `invalid.illegal.character-not-allowed-here.swift` }],
        },
      },
      end: `(?<=\\})|$`,
    ...
    'declarations-generic-argument-clause': {
      begin: `<`,
      beginCaptures: { 0: { name: `punctuation.separator.generic-argument-clause.begin.swift` } },
      end: `>|(?=[)\\]{}])`,
      endCaptures: { 0: { name: `punctuation.separator.generic-argument-clause.end.swift` } },
      name: `meta.generic-argument-clause.swift`,
      patterns: [{ include: `#declarations-available-types` }],
    },
    'declarations-generic-parameter-clause': {
      begin: `<`,
      beginCaptures: { 0: { name: `punctuation.separator.generic-parameter-clause.begin.swift` } },
      end:
        ">|(?=[^\\w\\d:<>\\s,=&`])(?# characters besides these are never valid in a generic param list -- even if it's not really a valid clause, we should stop trying to parse it if we see one of them.)",
      endCaptures: { 0: { name: `punctuation.separator.generic-parameter-clause.end.swift` } },
      ...
      patterns: [
        ...
        {
          begin: `(:)\\s*`,
          beginCaptures: { 1: { name: `punctuation.separator.generic-parameter-constraint.swift` } },
          end: `(?=[,>]|(?!\\G)\\bwhere\\b)`,
          ...
          patterns: [{
            ...
            patterns: [{ include: `#declarations-type-identifier` }, { include: `#declarations-type-operators` }],
          }],
        },
      ],
    },
    'declarations-generic-where-clause': {
      begin: `\\b(where)\\b\\s*`,
      beginCaptures: { 1: { name: `keyword.other.generic-constraint-introducer.swift` } },
      end: `(?!\\G)$|(?=[>{};\\n]|//|/\\*)`,
      name: `meta.generic-where-clause.swift`,
      patterns: [{ include: `#comments` }, { include: `#declarations-generic-where-clause-requirement-list` }],
    },
    'declarations-generic-where-clause-requirement-list': {
      begin: `\\G|,\\s*`,
      end: `(?=[,>{};\\n]|//|/\\*)`,
      patterns: [{ include: `#comments` }, { include: `#constraint` }, { include: `#declarations-available-types` }, {
        begin: `(?<![/=\\-+!*%<>&|\\^~.])(==)(?![/=\\-+!*%<>&|\\^~.])`,
        beginCaptures: { 1: { name: `keyword.operator.generic-constraint.same-type.swift` } },
        end: `(?=\\s*[,>{};\\n]|//|/\\*)`,
        name: `meta.generic-where-clause.same-type-requirement.swift`,
        patterns: [{ include: `#declarations-available-types` }],
      }, {
        begin: `(?<![/=\\-+!*%<>&|\\^~.])(:)(?![/=\\-+!*%<>&|\\^~.])`,
        beginCaptures: { 1: { name: `keyword.operator.generic-constraint.conforms-to.swift` } },
        end: `(?=\\s*[,>{};\\n]|//|/\\*)`,
...
\\$[0-9]+`,
          ...
          {
            captures: { 1: { patterns: [{ match: `\\.`, name: `invalid.illegal.dot-not-allowed-here.swift` }] } },
            match: `(?x)
(?<=\\G|\\.)
(?:
(
...
(?=\\.|;|$|//|/\\*|\\s)`,
    ...
    'declarations-inheritance-clause': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#comments` }, { include: `#declarations-inheritance-clause-more-types` }],
      }, {
        begin: `\\G`,
        end: `(?!\\G)$|(?=[={}]|(?!\\G)\\bwhere\\b)`,
        patterns: [{ include: `#comments` }, { include: `#declarations-inheritance-clause-inherited-type` }, {
...
\\s*`,
      beginCaptures: {
        ...
        4: {
          ...
          patterns: [{ match: `\\.`, name: `invalid.illegal.dot-not-allowed-here.swift` }],
        },
      },
      end: `(;)|$\\n?|(?=//|/\\*)`,
      endCaptures: { 1: { name: `punctuation.terminator.statement.swift` } },
      name: `meta.definition.operator.swift`,
      patterns: [{ include: `#declarations-operator-swift2` }, { include: `#declarations-operator-swift3` }, {
        match: `((?!$|;|//|/\\*)\\S)+`,
        name: `invalid.illegal.character-not-allowed-here.swift`,
      }],
    },
    'declarations-operator-swift2': {
      ...
      patterns: [{ include: `#comments` }, {
        captures: { 1: { name: `storage.modifier.swift` }, 2: { name: `keyword.other.operator.associativity.swift` } },
        match: `\\b(associativity)\\s+(left|right)\\b`,
      }, {
        captures: { 1: { name: `storage.modifier.swift` }, 2: { name: `constant.numeric.integer.swift` } },
        match: `\\b(precedence)\\s+([0-9]+)\\b`,
      }, { captures: { 1: { name: `storage.modifier.swift` } }, match: `\\b(assignment)\\b` }],
    },
    ...
    'declarations-parameter-clause': {
      begin: `(\\()`,
      beginCaptures: { 1: { name: `punctuation.definition.parameters.begin.swift` } },
      end: `(\\))(?:\\s*(async)\\b)?`,
      endCaptures: {
    ...
    'declarations-precedencegroup': {
      ...
      patterns: [{
        begin: `\\{`,
        beginCaptures: { 0: { name: `punctuation.definition.precedencegroup.begin.swift` } },
        end: `\\}`,
        endCaptures: { 0: { name: `punctuation.definition.precedencegroup.end.swift` } },
        patterns: [{ include: `#comments` }, {
          captures: {
            1: { name: `storage.modifier.swift` },
            2: {
          ...
          captures: { 1: { name: `storage.modifier.swift` }, 2: { name: `constant.language.boolean.swift` } },
    ...
    'declarations-protocol': {
      ...
      patterns: [{ include: `#comments` }, { include: `#declarations-inheritance-clause` }, {
    ...
    'declarations-protocol-associated-type': {
      ...
      patterns: [{ include: `#declarations-inheritance-clause` }, {
        comment: `SE-0142: Permit where clauses to constrain associated types`,
        include: `#declarations-generic-where-clause`,
    ...
    'declarations-protocol-protocol-initializer': {
      ...
      patterns: [
        ...
        {
          begin: `\\{`,
          beginCaptures: { 0: { name: `punctuation.section.function.begin.swift` } },
          end: `\\}`,
    ...
    'declarations-type-enum': {
      ...
      patterns: [
        ...
        { include: `#declarations-inheritance-clause` },
        {
          ...
          endCaptures: { 0: { name: `punctuation.definition.type.end.swift` } },
          name: `meta.definition.type.body.swift`,
          patterns: [{ include: `#declarations-type-enum-enum-case-clause` }, { include: `$self` }],
        },
      ],
    },
    'declarations-type-enum-associated-values': {
      begin: `\\G\\(`,
      beginCaptures: { 0: { name: `punctuation.definition.parameters.begin.swift` } },
      end: `\\)`,
...
\\s*(:)`,
    ...
    'declarations-type-enum-enum-case': {
      ...
      patterns: [{ include: `#comments` }, { include: `#declarations-type-enum-associated-values` }, {
    ...
    'declarations-type-enum-enum-case-clause': {
      ...
      patterns: [{ include: `#comments` }, { include: `#declarations-type-enum-enum-case` }, {
    ...
    'declarations-type-identifier': {
      begin: '((?<q>`?)[\\p{L}_][\\p{L}_\\p{N}\\p{M}]*(\\k<q>))\\s*',
      beginCaptures: {
        1: { name: `meta.type-name.swift`, patterns: [{ include: `#builtin-types` }] },
        2: { name: `punctuation.definition.identifier.swift` },
        3: { name: `punctuation.definition.identifier.swift` },
      },
      end: `(?!<)`,
      patterns: [{ begin: `(?=<)`, end: `(?!\\G)`, patterns: [{ include: `#declarations-generic-argument-clause` }] }],
    },
    'declarations-type-operators': {
      patterns: [{
        ...
        captures: { 1: { name: `keyword.operator.type.requirement-suppression.swift` } },
...
:`,
    ...
    expressions: {
      ...
      patterns: [{ include: `#expressions-without-trailing-closures-or-member-references` }, {
    ...
    'expressions-trailing-closure': {
      patterns: [{
        ...
        captures: {
          1: { name: `support.function.any-method.trailing-closure-label.swift` },
          2: { name: `punctuation.definition.identifier.swift` },
          3: { name: `punctuation.definition.identifier.swift` },
          4: { name: `punctuation.separator.argument-label.swift` },
        },
...
\\)`,
    ...
    'expressions-without-trailing-closures-or-member-references-function-or-macro-call-expression': {
      patterns: [{
        ...
        patterns: [{ include: `#expressions-without-trailing-closures-or-member-references-expression-element-list` }],
      }, {
        begin: '(?<=[`\\])}>\\p{L}_\\p{N}\\p{M}])\\s*(\\()',
        beginCaptures: { 1: { name: `punctuation.definition.arguments.begin.swift` } },
    ...
    keywords: {
      patterns: [
        ...
        { match: `(?<!\\.)\\b(?:continue|break|fallthrough|return)\\b`, name: `keyword.control.transfer.swift` },
        { match: `(?<!\\.)\\b(?:while|for|in|each)\\b`, name: `keyword.control.loop.swift` },
        { match: '\\bany\\b(?=\\s*`?[\\p{L}_])', name: `keyword.other.operator.type.existential.swift` },
        {
          captures: {
        ...
        { match: `(?<!\\.)\\b(?:catch|throw|try)\\b|\\btry[?!]\\B`, name: `keyword.control.exception.swift` },
        { match: `(?<!\\.)\\b(?:throws|rethrows)\\b`, name: `storage.modifier.exception.swift` },
        {
          captures: {
        ...
        {
          captures: { 1: { name: `keyword.other.type.swift` }, 2: { name: `keyword.other.type.metatype.swift` } },
          match: `(?<=\\.)(?:(dynamicType|self)|(Protocol|Type))\\b`,
        },
        { match: `(?<!\\.)\\b(?:super|self|Self)\\b`, name: `variable.language.swift` },
        {
          match:
        ...
        {
          comment:
            `SE-0366: "consume behaves as a contextual keyword. In order to avoid interfering with existing code that calls functions named consume, the operand to consume must begin with another identifier, and must consist of an identifier or postfix expression"`,
          match: '(?<!\\.)\\bconsume(?=\\s+`?[\\p{L}_])',
          name: `keyword.control.consume.swift`,
        },
        {
          comment:
            `SE-0377: "copy is a contextual keyword, parsed as an operator if it is immediately followed by an identifier on the same line, like the consume x operator before it"`,
          match: '(?<!\\.)\\bcopy(?=\\s+`?[\\p{L}_])',
    ...
    literals: {
      patterns: [
        ...
        { match: `\\B#externalMacro\\b`, name: `support.function.builtin-macro.swift` },
    ...
    'literals-boolean': { match: `\\b(true|false)\\b`, name: `constant.language.boolean.swift` },
    'literals-numeric': {
      patterns: [{
      ...
      }, { match: `(\\B\\-|\\b)[0-9][\\w.]*`, name: `invalid.illegal.numeric.other.swift` }],
    },
    'literals-regular-expression-literal': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#literals-regular-expression-literal-regex-guts` }, {
...
| (\\[:) ([\\s\\w-]+(?:=[\\s\\w-]+)?) (:\\])`,
    ...
    'literals-regular-expression-literal-custom-char-class': {
      patterns: [{
        ...
        name: `constant.other.character-class.set.regexp`,
        patterns: [{ include: `#literals-regular-expression-literal-custom-char-class-members` }],
      }],
    },
    ...
    'literals-regular-expression-literal-group-option-toggle': {
      comment:
        `A matching option sequence may be part of an "isolated group" which has an implicit scope that wraps the remaining elements of the current group`,
      match: `(?x)
\\(\\?
(?:
...
|asr|atomic_script_run
    ...
    'literals-regular-expression-literal-regex-guts': {
      patterns: [
        ...
        {
          begin: `\\(\\?\\#`,
          beginCaptures: { 0: { name: `punctuation.definition.comment.begin.regexp` } },
          end: `\\)`,
        ...
        {
          begin: `<\\{`,
          beginCaptures: { 0: { name: `punctuation.section.embedded.begin.regexp` } },
          end: `\\}>`,
        ...
        { include: `#literals-regular-expression-literal-unicode-scalars` },
        { include: `#literals-regular-expression-literal-character-properties` },
        { match: `[$^]|\\\\[AbBGyYzZ]|\\\\K`, name: `keyword.control.anchor.regexp` },
        ...
        { match: `\\.|\\\\[CdDhHNORsSvVwWX]`, name: `constant.character.character-class.regexp` },
        { match: `\\\\c.`, name: `constant.character.entity.control-character.regexp` },
    ...
    'literals-regular-expression-literal-set-operators': {
      patterns: [{ match: `&&`, name: `keyword.operator.intersection.regexp.swift` }, {
        match: `--`,
        name: `keyword.operator.subtraction.regexp.swift`,
      }, { match: `\\~\\~`, name: `keyword.operator.symmetric-difference.regexp.swift` }],
    },
...
| \\\\N\\{(?:U\\+[0-9a-fA-F]{1,8} | [\\s\\w-]+)\\}`,
    ...
    'literals-string': {
      patterns: [{
        begin: `"""`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.swift` } },
        ...
        patterns: [
          { match: `\\G.+(?=""")|\\G.+`, name: `invalid.illegal.content-after-opening-delimiter.swift` },
        ...
        name: `string.quoted.double.block.raw.swift`,
        patterns: [{ match: `\\G.+(?=""")|\\G.+`, name: `invalid.illegal.content-after-opening-delimiter.swift` }],
      }, {
        begin: `"`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.swift` } },
        end: `"(#*)`,
    ...
    'literals-string-raw-string-guts': {
      ...
      patterns: [{ match: `\\\\#[0\\\\tnr"']`, name: `constant.character.escape.swift` }, {
        ...
        endCaptures: { 0: { name: `punctuation.section.embedded.end.swift` }, 1: { name: `source.swift` } },
        name: `meta.embedded.line.swift`,
        patterns: [{ include: `$self` }, { begin: `\\(`, comment: `Nested parens`, end: `\\)` }],
...
| [\\x{E0100}-\\x{E01EF}]
        ...
        patterns: [{
          captures: {
            0: {
              patterns: [
                { match: `\\G(\\+\\+|\\-\\-)$`, name: `keyword.operator.increment-or-decrement.swift` },
                { match: `\\G(\\+|\\-)$`, name: `keyword.operator.arithmetic.unary.swift` },
                { match: `\\G!$`, name: `keyword.operator.logical.not.swift` },
                { match: `\\G~$`, name: `keyword.operator.bitwise.not.swift` },
...
(?![\\s)\\]},;:]|\\z)`,
          ...
          captures: {
            0: {
              patterns: [{ match: `\\G(\\+\\+|\\-\\-)$`, name: `keyword.operator.increment-or-decrement.swift` }, {
                match: `\\G!$`,
          ...
          captures: {
            0: {
              patterns: [
                ...
                { match: `\\G(\\+|\\-|\\*|/)$`, name: `keyword.operator.arithmetic.swift` },
                { match: `\\G&(\\+|\\-|\\*)$`, name: `keyword.operator.arithmetic.overflow.swift` },
                { match: `\\G%$`, name: `keyword.operator.arithmetic.remainder.swift` },
                { match: `\\G(==|!=|>|<|>=|<=|~=)$`, name: `keyword.operator.comparison.swift` },
                { match: `\\G\\?\\?$`, name: `keyword.operator.coalescing.swift` },
                { match: `\\G(&&|\\|\\|)$`, name: `keyword.operator.logical.swift` },
                { match: `\\G(&|\\||\\^|<<|>>)$`, name: `keyword.operator.bitwise.swift` },
                { match: `\\G(===|!==)$`, name: `keyword.operator.bitwise.swift` },
...
| [\\x{E0100}-\\x{E01EF}]
          ...
          captures: { 0: { patterns: [{ match: `.+`, name: `keyword.operator.custom.prefix.dot.swift` }] } },
...
(?![\\s)\\]},;:]|\\z)`,
          ...
          captures: { 0: { patterns: [{ match: `.+`, name: `keyword.operator.custom.postfix.dot.swift` }] } },
...
(?=[\\s)\\]},;:]|\\z)`,
          ...
          captures: {
            0: {
              patterns: [{ match: `\\G\\.\\.[.<]$`, name: `keyword.operator.range.swift` }, {
                match: `.+`,
...
| [\\x{E0100}-\\x{E01EF}]
    ...
    root: { patterns: [{ include: `#compiler-control` }, { include: `#declarations` }, { include: `#expressions` }] },
  },
  i = `source.swift`,
