var e = `COBOL`,
  ...
  n = `cobol`,
  r = [
    { match: `(^[ \\*][ \\*][ \\*][ \\*][ \\*][ \\*])([dD]\\s.*$)`, name: `token.info-token.cobol` },
    {
      captures: { 1: { name: `constant.numeric.cobol` }, 2: { name: `comment.line.cobol.newpage` } },
      match: `(^[ \\*][ \\*][ \\*][ \\*][ \\*][ \\*])(\\/.*$)`,
    },
    {
    ...
    { match: `^[0-9\\s][0-9\\s][0-9\\s][0-9\\s][0-9\\s][0-9\\s]$`, name: `constant.numeric.cobol` },
    {
      captures: { 1: { name: `constant.numeric.cobol` }, 2: { name: `comment.line.cobol.fixed` } },
      match: `(^[0-9\\s][0-9\\s][0-9\\s][0-9\\s][0-9\\s][0-9\\s])(\\*.*$)`,
    },
    {
      captures: { 1: { name: `constant.cobol` }, 2: { name: `comment.line.cobol.fixed` } },
      match:
        `(^[0-9a-zA-Z\\s\\$#%\\.@\\- ][0-9a-zA-Z\\s\\$#%\\.@\\- ][0-9a-zA-Z\\s\\$#%\\.@\\- ][0-9a-zA-Z\\s\\$#%\\.@\\- ][0-9a-zA-Z\\s\\$#%\\.@\\- ][0-9a-zA-Z\\s\\$#%\\.@\\- ])(\\*.*$)`,
    },
    {
      captures: { 1: { name: `constant.numeric.cobol` }, 2: { name: `variable.other.constant` } },
    ...
    {
      captures: { 1: { name: `constant.cobol` }, 2: { name: `comment.line.cobol.newpage` } },
      match:
        `(^[0-9a-zA-Z\\s\\$#%\\.@][0-9a-zA-Z\\s\\$#%\\.@][0-9a-zA-Z\\s\\$#%\\.@][0-9a-zA-Z\\s\\$#%\\.@][0-9a-zA-Z\\s\\$#%\\.@][0-9a-zA-Z\\s\\$#%\\.@])(\\/.*$)`,
    },
    ...
    { begin: `\\$(?i:doc)(.*$)`, end: `\\$(?i:end-doc)(.*$)`, name: `invalid.illegal.iscobol` },
    { match: `>>\\s*(?i:turn|page|listing|leap-seconds|d)\\s+.*$`, name: `invalid.illegal.meta.preprocessor.cobolit` },
    { match: `(?i:substitute-case|substitute)\\s+`, name: `invalid.illegal.functions.cobolit` },
    {
      captures: {
        1: { name: `invalid.illegal.keyword.control.directive.conditional.cobol` },
    ...
    { match: `([nNuU][xX]|[hHxX])'\\h*'`, name: `constant.numeric.integer.hexadecimal.cobol` },
    { match: `([nNuU][xX]|[hHxX])'.*'`, name: `invalid.illegal.hexadecimal.cobol` },
    { match: `([nNuU][xX]|[hHxX])"\\h*"`, name: `constant.numeric.integer.hexadecimal.cobol` },
    { match: `([nNuU][xX]|[hHxX])".*"`, name: `invalid.illegal.hexadecimal.cobol` },
    ...
    { match: `(#)([0-9a-zA-Z][a-zA-Z\\-0-9]+)`, name: `meta.symbol.cobol.forced` },
    {
      begin:
      ...
      beginCaptures: { 0: { name: `keyword.identifiers.cobol` } },
        ...
        `(?=((?<![-_])(?i:remarks|author|date-written|source-computer|object-computer|installation|date-compiled|special-names|security|environment\\s+division|data\\s+division|working-storage\\s+section|input-output\\s+section|linkage\\s+section|procedure\\s+division|local-storage\\s+section)|^[ \\*][ \\*][ \\*][ \\*][ \\*][ \\*]\\*.*$|^\\+$))`,
      name: `comment.block.cobol.remark`,
      patterns: [{ match: `(^[0-9 ][0-9 ][0-9 ][0-9 ][0-9 ][0-9 ])`, name: `constant.numeric.cobol` }, {
    ...
    { match: `(?<![-_])(?i:true|false|null|nulls)(?![0-9A-Za-z_-])`, name: `constant.language.cobol` },
    {
      match:
    ...
    },
    {
      ...
      patterns: [
        ...
        { include: `#number-complex-constant` },
        { include: `#number-simple-constant` },
        { match: `([a-zA-Z-0-9_]*[a-zA-Z0-9]|([#]?[0-9a-zA-Z]+[a-zA-Z-0-9_]*[a-zA-Z0-9]))`, name: `variable.cobol` },
      ],
    },
    {
      begin: `(?i:exec\\s+dli)`,
    ...
    },
    {
      ...
      name: `keyword.verb.cobol`,
      patterns: [{ match: `(\\*>.*$)`, name: `comment.line.modern` }, {
        match: `(\\:([a-zA-Z\\-])*)`,
        name: `variable.cobol`,
      }, { include: `source.sql` }],
    },
    {
      ...
      name: `keyword.verb.cobol`,
      patterns: [{ match: `(--.*$)`, name: `comment.line.sql` }, { match: `(\\*>.*$)`, name: `comment.line.modern` }, {
        match: `(\\:([a-zA-Z\\-])*)`,
        name: `variable.cobol`,
      }, { include: `source.sql` }],
    },
    ...
    {
      captures: { 1: { name: `keyword.verb.cobol` }, 2: { name: `entity.name.function.cobol` } },
      match:
    ...
    { match: `(?<![-_])(?i:implements|inherits|constraints|constrain)(?=\\s|\\.)`, name: `keyword.verb.cobol` },
    {
      match:
    ...
    { match: `\\s+(?i:sync\\s+(?i:on))(?=\\s|\\.)`, name: `keyword.other.sync.cobol` },
    { match: `\\s+(?i:try|finally|catch|end-try|throw)(?=\\s|\\.|$)`, name: `keyword.control.catch-exception.cobol` },
    {
      match:
    ...
    { match: `(?i:dynamic)\\s+(?i:length)(?=\\s|\\.)`, name: `storage.type.dynamiclength.cobol` },
    {
      match:
    ...
    {
      captures: { 0: { name: `keyword.verb.cobol` }, 1: { name: `storage.type.cobol` } },
      comment: `type ssss `,
      match: `(?<![-_])(?i:type|new)\\s+([a-zA-Z][a-zA-Z0-9\\$\\-\\._]*|[a-zA-Z])(?=\\.$)`,
    },
    { match: `(?<![-_])(?i:string)(?=\\s+value|\\.)`, name: `storage.type.cobol` },
    {
      match:
    ...
    {
      captures: { 1: { name: `keyword.other.verb.cobol` }, 2: { name: `meta.symbol.cobol` } },
      comment: `operator-id ssss `,
      match: `(operator-id\\s+[+\\-\\*\\/])`,
      name: `keyword.operator-id.cobol`,
    },
    {
      captures: { 1: { name: `punctuation.accessor.cobol.b3` }, 2: { name: `entity.name.function.b3` } },
      comment: ` ::.. `,
      match: `(?i:self)(\\:\\:)([0-9a-zA-Z_\\-\\.]*)(?=\\.$)`,
    },
    {
      captures: { 1: { name: `punctuation.accessor.cobol` }, 2: { name: `entity.name.function.cobol` } },
      comment: ` ::.. `,
      match: `(\\:\\:)([0-9a-zA-Z_\\-\\.]*)`,
    },
    {
      captures: { 0: { name: `keyword.verb.cobol.aa` }, 1: { name: `storage.type.cobol.bb` } },
    ...
    {
      captures: { 1: { name: `storage.type.picture5.cobol` }, 2: { name: `constant.numeric.cobol` } },
      match:
    ...
    { match: `(?<![-_])(?i:thread-local)(?![0-9A-Za-z_-])`, name: `keyword.verb.cobol` },
    {
      match:
    ...
    { match: `(?i:not\\s+at\\s+end)(?![0-9A-Za-z_-])`, name: `keyword.verb.cobol` },
    { match: `(?<![-_])(?i:not)(?![0-9A-Za-z_-])`, name: `keyword.operator.cobol` },
    {
      match:
    ...
    { match: `(?<![-_])(?i:json\\s+generate|json|end-json|name\\sof)(?![0-9A-Za-z_-])`, name: `keyword.json.cobol` },
    {
      match:
    ...
    { match: `(?<![-_])(?i:System-Info|Terminal-Info)(?![0-9A-Za-z_-])`, name: `support.type.cobol.acu strong` },
    ...
    { match: `(^[0-9][0-9][0-9][0-9][0-9][0-9])`, name: `constant.numeric.cobol` },
    {
      captures: {
    ...
    { match: `([a-zA-Z-0-9_]*[a-zA-Z0-9]|([#]?[0-9a-zA-Z]+[a-zA-Z-0-9_]*[a-zA-Z0-9]))`, name: `meta.symbol.cobol` },
  ],
  i = {
    'cics-keywords': {
      match:
    ...
    'number-simple-constant': { match: `(\\-|\\+)?([0-9]+)(?=\\s|\\.$|,|\\))`, name: `constant.numeric.cobol` },
