var e = `GraphQL`,
  t = [`graphql`, `graphqls`, `gql`, `graphcool`],
  n = `graphql`,
  r = [{ include: `#graphql` }],
  i = {
    graphql: {
    ...
    'graphql-ampersand': { captures: { 1: { name: `keyword.operator.logical.graphql` } }, match: `\\s*(&)` },
    'graphql-arguments': {
      begin: `\\s*(\\()`,
      ...
      patterns: [{ include: `#graphql-comment` }, { include: `#graphql-description-docstring` }, {
        include: `#graphql-description-singleline`,
      }, {
        begin: `\\s*([_A-Za-z][_0-9A-Za-z]*)(?:\\s*(:))`,
        beginCaptures: { 1: { name: `variable.parameter.graphql` }, 2: { name: `punctuation.colon.graphql` } },
    ...
    'graphql-colon': { captures: { 1: { name: `punctuation.colon.graphql` } }, match: `\\s*(:)` },
    'graphql-comma': { captures: { 1: { name: `punctuation.comma.graphql` } }, match: `\\s*(,)` },
    'graphql-comment': {
      patterns: [{
        ...
        begin: `(""")`,
        beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.graphql` } },
        end: `(""")`,
        name: `comment.line.graphql.js`,
      }, {
        begin: `(")`,
    ...
    'graphql-description-docstring': { begin: `"""`, end: `"""`, name: `comment.block.graphql` },
    ...
    'graphql-directive-definition': {
      ...
      patterns: [
        { include: `#graphql-variable-definitions` },
        {
          ...
          beginCaptures: { 1: { name: `keyword.on.graphql` }, 2: { name: `support.type.location.graphql` } },
          end: `(?=.)`,
          patterns: [{ include: `#graphql-skip-newlines` }, { include: `#graphql-comment` }, {
            include: `#literal-quasi-embedded`,
          }, { captures: { 2: { name: `support.type.location.graphql` } }, match: `\\s*(\\|)\\s*([_A-Za-z]*)` }],
        },
        { include: `#graphql-skip-newlines` },
        { include: `#graphql-comment` },
        { include: `#literal-quasi-embedded` },
    ...
    'graphql-enum': {
      ...
      beginCaptures: { 1: { name: `keyword.enum.graphql` }, 2: { name: `support.type.enum.graphql` } },
      end: `(?<=})`,
    ...
    'graphql-field': {
      patterns: [
        {
          captures: { 1: { name: `string.unquoted.alias.graphql` }, 2: { name: `punctuation.colon.graphql` } },
          match: `\\s*([_A-Za-z][_0-9A-Za-z]*)\\s*(:)`,
        },
        { captures: { 1: { name: `variable.graphql` } }, match: `\\s*([_A-Za-z][_0-9A-Za-z]*)` },
        { include: `#graphql-arguments` },
        { include: `#graphql-directive` },
    ...
    'graphql-fragment-spread': {
      ...
      captures: { 1: { name: `keyword.operator.spread.graphql` }, 2: { name: `variable.fragment.graphql` } },
      end: `(?=.)`,
      patterns: [
        { include: `#graphql-comment` },
        { include: `#graphql-description-docstring` },
    ...
    'graphql-input-types': {
      patterns: [{ include: `#graphql-scalar-type` }, {
        captures: { 1: { name: `support.type.graphql` }, 2: { name: `keyword.operator.nulltype.graphql` } },
        match: `\\s*([_A-Za-z][_0-9A-Za-z]*)(?:\\s*(!))?`,
      }, {
        begin: `\\s*(\\[)`,
        captures: { 1: { name: `meta.brace.square.graphql` }, 2: { name: `keyword.operator.nulltype.graphql` } },
        end: `\\s*(\\])(?:\\s*(!))?`,
    ...
    'graphql-null-value': { captures: { 1: { name: `constant.language.null.graphql` } }, match: `\\s*\\b(null)\\b` },
    ...
    'graphql-object-value': {
      patterns: [{
        ...
        patterns: [{ include: `#graphql-object-field` }, { include: `#graphql-value` }],
      }],
    },
    ...
    'graphql-scalar': {
      captures: { 1: { name: `keyword.scalar.graphql` }, 2: { name: `entity.scalar.graphql` } },
      match: `\\s*\\b(scalar)\\b\\s*([_A-Za-z][_0-9A-Za-z]*)`,
    },
    'graphql-scalar-type': {
      captures: { 1: { name: `support.type.builtin.graphql` }, 2: { name: `keyword.operator.nulltype.graphql` } },
          ...
          patterns: [
            {
              ...
              patterns: [
                { captures: { 1: { name: `support.type.graphql` } }, match: `\\s*([_A-Za-z][_0-9A-Za-z]*)` },
                { include: `#graphql-comment` },
                { include: `#graphql-description-docstring` },
                { include: `#graphql-description-singleline` },
...
`,
    ...
    'graphql-string-content': {
      patterns: [{ match: `\\\\[/'"\\\\nrtbf]`, name: `constant.character.escape.graphql` }, {
        match: `\\\\u([0-9a-fA-F]{4})`,
    ...
    'graphql-string-value': {
      ...
      patterns: [{ include: `#graphql-string-content` }, { include: `#literal-quasi-embedded` }],
    },
    ...
    'graphql-union': {
      ...
      captures: { 1: { name: `keyword.union.graphql` }, 2: { name: `support.type.graphql` } },
      end: `(?=.)`,
      patterns: [
        {
          applyEndPatternLast: 1,
          begin: `\\s*(=)\\s*([_A-Za-z][_0-9A-Za-z]*)`,
          captures: { 1: { name: `punctuation.assignment.graphql` }, 2: { name: `support.type.graphql` } },
          end: `(?=.)`,
          patterns: [
            { include: `#graphql-comment` },
            { include: `#graphql-description-docstring` },
            ...
            { include: `#literal-quasi-embedded` },
            {
              captures: { 1: { name: `punctuation.or.graphql` }, 2: { name: `support.type.graphql` } },
    ...
    'graphql-union-mark': { captures: { 1: { name: `punctuation.union.graphql` } }, match: `\\s*(\\|)` },
    'graphql-value': {
      patterns: [
        { include: `#graphql-comment` },
        { include: `#graphql-description-docstring` },
...
,)])`,
    ...
    'native-interpolation': {
      ...
      patterns: [{ include: `source.js` }, { include: `source.ts` }, { include: `source.js.jsx` }, {
        include: `source.tsx`,
      }],
    },
  },
