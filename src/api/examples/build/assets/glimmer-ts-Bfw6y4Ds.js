var e = `Glimmer TS`,
  t = { 'L:source.gts -comment -(string -meta.embedded)': { patterns: [{ include: `#main` }] } },
  n = `glimmer-ts`,
  r = [{ include: `#main` }, { include: `source.ts` }],
  i = {
    'as-keyword': { match: `\\s\\b(as)\\b(?=\\s\\|)`, name: `keyword.control`, patterns: [] },
    'as-params': {
      begin: `(?<!\\|)(\\|)`,
      beginCaptures: { 1: { name: `constant.other.symbol.begin.ember-handlebars` } },
      end: `(\\|)(?!\\|)`,
    ...
    boolean: {
      captures: { 0: { name: `string.regexp` }, 1: { name: `string.regexp` }, 2: { name: `string.regexp` } },
    ...
    'component-tag': {
      ...
      beginCaptures: {
        ...
        2: {
          ...
          patterns: [{ match: `(@|this)`, name: `variable.language` }, {
            match: `(\\.)+`,
        ...
        3: {
          ...
          patterns: [{ include: `#glimmer-component-path` }, { match: `(@|:|\\$)`, name: `markup.bold` }],
        },
      },
      end: `(\\/?)(>)`,
      endCaptures: { 1: { name: `punctuation.definition.tag` }, 2: { name: `punctuation.definition.tag` } },
      name: `meta.tag.any.ember-handlebars`,
      patterns: [{ include: `#tag-like-content` }],
    },
    digit: {
      captures: { 0: { name: `constant.numeric` }, 1: { name: `constant.numeric` }, 2: { name: `constant.numeric` } },
      match: `\\d*(\\.)?\\d+`,
      patterns: [],
    },
    entities: {
      ...
      }, { match: `&`, name: `invalid.illegal.bad-ampersand.html.ember-handlebars` }],
    },
    'glimmer-argument': {
      captures: {
        1: {
    ...
    'glimmer-as-stuff': { patterns: [{ include: `#as-keyword` }, { include: `#as-params` }] },
    'glimmer-block': {
      begin: `({{~?)(#|/)(([@\\$a-zA-Z0-9_/.-]+))`,
      captures: {
        1: { name: `punctuation.definition.tag` },
        ...
        3: {
          ...
          patterns: [{ include: `#glimmer-component-path` }, { match: `(\\/)+`, name: `punctuation.definition.tag` }, {
            match: `(\\.)+`,
            name: `punctuation.definition.tag`,
          }],
        },
      ...
      patterns: [{ include: `#glimmer-as-stuff` }, { include: `#glimmer-supexp-content` }],
    },
    'glimmer-bools': {
      captures: {
    ...
    'glimmer-component-path': { captures: { 1: { name: `punctuation.definition.tag` } }, match: `(::|_|\\$|\\.)` },
    'glimmer-control-expression': {
      begin: `({{~?)(([-a-zA-Z_0-9/]+)\\s)`,
      captures: { 1: { name: `keyword.operator` }, 2: { name: `keyword.operator` }, 3: { name: `keyword.control` } },
      end: `(~?}})`,
      name: `entity.expression.ember-handlebars`,
    ...
    'glimmer-expression': {
      ...
      captures: {
        ...
        3: {
          name: `support.function`,
          patterns: [{ match: `[(]+`, name: `string.regexp` }, { match: `[)]+`, name: `string.regexp` }, {
            match: `(\\.)+`,
            name: `punctuation.definition.tag`,
    ...
    'glimmer-expression-property': {
      ...
      captures: {
        ...
        4: { name: `support.function`, patterns: [{ match: `(\\.)+`, name: `punctuation.definition.tag` }] },
      },
      end: `(~?}})`,
      name: `entity.expression.ember-handlebars`,
      patterns: [{ include: `#glimmer-supexp-content` }],
    ...
    'glimmer-parameter-value': {
      captures: {
        1: { name: `support.function`, patterns: [{ match: `(\\.)+`, name: `punctuation.definition.tag` }] },
      },
    ...
    'glimmer-unescaped-expression': {
      ...
      patterns: [{ include: `#string-single-quoted-handlebars` }, { include: `#string-double-quoted-handlebars` }, {
        include: `#glimmer-subexp`,
      }, { include: `#param` }],
    },
    'html-attribute': {
    ...
    'html-comment': {
      begin: `<!--`,
      captures: { 0: { name: `punctuation.definition.comment.html.ember-handlebars` } },
      end: `--\\s*>`,
      name: `comment.block.html.ember-handlebars`,
      patterns: [{ include: `#attention` }, {
        match: `--`,
    ...
    main: {
      patterns: [{
        ...
        begin: `(<)(template)`,
        beginCaptures: { 1: { name: `punctuation.definition.tag.html` }, 2: { name: `entity.name.tag.other.html` } },
        end: `(</)(template)(>)`,
        endCaptures: {
          1: { name: `punctuation.definition.tag.html` },
          2: { name: `entity.name.tag.other.html` },
        ...
        patterns: [{ begin: `(?<=\\<template)`, end: `(?=\\>)`, patterns: [{ include: `#tag-like-content` }] }, {
          begin: `(>)`,
        ...
        endCaptures: { 0: { name: `string.js` }, 1: { name: `punctuation.definition.string.template.end.js` } },
        patterns: [
...
[\\s"'>]
    ...
    'string-double-quoted-handlebars': {
      begin: `"`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.ember-handlebars` } },
      end: `"`,
      endCaptures: { 0: { name: `punctuation.definition.string.end.ember-handlebars` } },
      name: `string.quoted.double.ember-handlebars`,
      patterns: [{ match: `\\\\"`, name: `constant.character.escape.ember-handlebars` }],
    },
    ...
    style: {
      ...
      patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{ include: `#glimmer-argument` }, { include: `#html-attribute` }],
        }, { begin: `(?!\\G)`, end: `(?=</(?i:style))`, name: `source.css`, patterns: [{ include: `source.css` }] }],
      }],
    },
    'tag-like-content': {
      patterns: [
    ...
    variable: { match: `\\b([a-zA-Z0-9-_]+)\\b`, name: `support.function`, patterns: [] },
  },
  a = `source.gts`,
