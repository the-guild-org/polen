var e = `Move`,
  ...
  n = [
    ...
    { include: `#script` },
    { include: `#annotation` },
    { begin: `\\b(while)\\b`, comment: `While experiment`, name: `keyword.control.while.whaaat.move`, while: `[a-z]` },
    { include: `#comments` },
    { include: `#annotation` },
    { include: `#entry` },
  ...
  r = {
    '=== DEPRECATED_BELOW ===': {},
    abilities: { comment: `Ability`, match: `\\b(store|key|drop|copy)\\b`, name: `support.type.ability.move` },
    address: {
      begin: `\\b(address)\\b`,
    ...
    annotation: {
      ...
      patterns: [{ comment: `Annotation name`, match: `\\b(\\w+)\\s*(?=\\=)`, name: `meta.annotation.name.move` }, {
        begin: `=`,
    ...
    as: { comment: `Keyword as (highlighted)`, match: `\\b(as)\\b`, name: `keyword.control.as.move` },
    'as-import': {
    ...
    'block-comments': {
      ...
      }, { begin: `/\\*`, comment: `Block comment`, end: `\\*/`, name: `comment.block.move` }],
    },
    capitalized: {
    ...
    comments: {
      ...
      patterns: [{ include: `#doc-comments` }, { include: `#line-comments` }, { include: `#block-comments` }],
    },
    const: {
      begin: `\\b(const)\\b`,
      ...
      patterns: [{ include: `#comments` }, { include: `#primitives` }, { include: `#literals` }, {
        match: `\\b([\\w_]+)\\b`,
    ...
    'doc-comments': {
      ...
      name: `comment.block.documentation.move`,
      patterns: [{
        captures: { 1: { name: `markup.underline.link.move` } },
        comment: `Escaped member / link`,
        match: '`(\\w+)`',
      }],
    },
    entry: { comment: `entry`, match: `\\b(entry)\\b`, name: `storage.modifier.visibility.entry.move` },
    enum: {
      begin: `\\b(enum)\\b`,
      ...
      patterns: [
        ...
        { include: `#type_param` },
        { comment: `Enum name (ident)`, match: `\\b[A-Z][a-zA-Z_0-9]*\\b`, name: `entity.name.type.enum.move` },
        { include: `#has` },
        { include: `#abilities` },
        {
          begin: `{`,
          ...
          patterns: [{ include: `#comments` }, {
            ...
            patterns: [{ include: `#comments` }, { include: `#escaped_identifier` }, { include: `#types` }],
          }],
        },
      ],
    },
    error_const: { match: `\\b(E[A-Z][A-Za-z_]*)\\b`, name: `variable.language.error.move` },
    escaped_identifier: { begin: '`', comment: `Escaped variable`, end: '`', name: `variable.language.escaped.move` },
    expr: {
      ...
      patterns: [
        ...
        { comment: `ALL_CONST_CAPS`, match: `\\b([A-Z][A-Z_]+)\\b`, name: `constant.other.move` },
        { comment: `CustomType`, match: `\\b([A-Z][a-zA-Z_0-9]*)\\b`, name: `entity.name.type.move` },
        { include: `#paren` },
        { include: `#block` },
      ],
    },
    expr_generic: {
      ...
      patterns: [{ include: `#comments` }, { include: `#types` }, { include: `#capitalized` }, {
        include: `#expr_generic`,
      }],
    },
    friend: {
    ...
    fun_signature: {
      ...
      patterns: [
        ...
        { include: `#mut` },
        {
          ...
          patterns: [{ include: `#comments` }, { include: `#escaped_identifier` }, {
            match: `\\b(\\w+)\\b`,
        ...
        { comment: `Keyword acquires`, match: `\\b(acquires)\\b`, name: `storage.modifier` },
      ],
    },
    has: { comment: `Has Abilities`, match: `\\b(has)\\b`, name: `keyword.control.ability.has.move` },
    has_ability: {
      begin: `(?<=[})])\\s+(has)\\b`,
      beginCaptures: { 1: { name: `storage.modifier.type.move` } },
      end: `;`,
    ...
    ident: { match: `\\b([a-zA-Z][A-Z_a-z0-9]*)\\b`, name: `meta.identifier.move` },
    import: {
      begin: `\\b(use)\\b`,
      beginCaptures: { 1: { name: `storage.modifier.type.move` } },
      end: `;`,
      ...
      patterns: [
        ...
        { include: `#as-import` },
        { comment: `Uppercase entities`, match: `\\b([A-Z]\\w*)\\b`, name: `entity.name.type.move` },
        {
          begin: `{`,
          comment: `Module members`,
          end: `}`,
          patterns: [{ include: `#comments` }, { include: `#as-import` }, {
            comment: `Uppercase entities`,
            match: `\\b([A-Z]\\w*)\\b`,
            name: `entity.name.type.move`,
          }],
        },
        { comment: `Name of the imported module`, match: `\\b(\\w+)\\b`, name: `meta.entity.name.type.module.move` },
      ],
    },
    label: { comment: `Label`, match: `'[a-z][a-z_0-9]*`, name: `string.quoted.single.label.move` },
    let: { comment: `Keyword let`, match: `\\b(let)\\b`, name: `keyword.control.move` },
    'line-comments': { begin: `//`, comment: `Single-line comment`, end: `$`, name: `comment.line.double-slash.move` },
    literals: {
      comment: `Literals supported in Move`,
      name: `meta.literal.move`,
      patterns: [
        { comment: `base16 address literal`, match: `@0x[A-F0-9a-f]+`, name: `support.constant.address.base16.move` },
        {
        ...
        },
        {
          ...
          patterns: [{ comment: `character escape`, match: `\\\\.`, name: `constant.character.escape.move` }, {
          ...
          }, { comment: `ASCII Character`, match: `[\\x00-\\x7F]`, name: `string.quoted.double.raw.move` }],
        },
        {
          begin: `x"`,
          ...
          patterns: [{ comment: `vector hex literal`, match: `[A-Fa-f0-9]+`, name: `constant.character.move` }],
        },
        { comment: `bool literal`, match: `\\b(?:true|false)\\b`, name: `constant.language.boolean.move` },
        {
          begin: `vector\\[`,
    ...
    match_expression: {
      begin: `\\b(match)\\b`,
      beginCaptures: { 1: { name: `keyword.control.match.move` } },
      ...
      patterns: [{ include: `#comments` }, { include: `#escaped_identifier` }, { include: `#types` }, {
        ...
        patterns: [{ comment: `arrow operator`, match: `\\b(=>)\\b`, name: `operator.match.move` }, {
          include: `#expr`,
        }],
      }, { include: `#expr` }],
    },
    ...
    module_label: {
      ...
      patterns: [{ include: `#comments` }, { include: `#escaped_identifier` }, {
        ...
        name: `constant.other.move`,
      }, { begin: `(?<=::)`, comment: `Module name`, end: `(?=[\\s{])`, name: `entity.name.type.move` }],
    },
    move_copy: { comment: `Keywords move and copy`, match: `\\b(move|copy)\\b`, name: `variable.language.move` },
    mut: { comment: `Mutable reference and let mut`, match: `\\b(mut)\\b`, name: `storage.modifier.mut.move` },
    native: { comment: `native`, match: `\\b(native)\\b`, name: `storage.modifier.visibility.native.move` },
    packed_field: { comment: `[ident]: `, match: `[a-z][a-z0-9_]+\\s*:\\s*(?=\\s)`, name: `meta.struct.field.move` },
    paren: { begin: `\\(`, end: `\\)`, name: `meta.paren.move`, patterns: [{ include: `#expr` }] },
    path_access: { comment: `<expr>.[ident] access`, match: `\\.[a-z][_a-z0-9]*\\b`, name: `meta.path.access.move` },
    phantom: {
    ...
    public: { comment: `public`, match: `\\b(public)\\b`, name: `storage.modifier.visibility.public.move` },
    'public-scope': {
      begin: `(?<=\\b(public))\\s*\\(`,
    ...
    script: {
      ...
      patterns: [{ include: `#comments` }, {
        ...
        patterns: [{ include: `#const` }, { include: `#comments` }, { include: `#import` }, { include: `#fun` }],
      }],
    },
    self_access: {
      captures: { 1: { name: `variable.language.self.move` }, 2: { name: `entity.name.function.call.move` } },
      comment: `Use of Self`,
      match: `\\b(Self)::(\\w+)\\b`,
    ...
    spec: {
      ...
      name: `meta.spec.move`,
      patterns: [
        { comment: `Spec target`, match: `\\b(module|schema|struct|fun)`, name: `storage.modifier.spec.target.move` },
        { comment: `Spec define inline`, match: `\\b(define)`, name: `storage.modifier.spec.define.move` },
        { comment: `Target name`, match: `\\b(\\w+)\\b`, name: `entity.name.function.move` },
        {
          begin: `{`,
          comment: `Spec block`,
          end: `}`,
    ...
    spec_define: {
      ...
      patterns: [{ include: `#comments` }, { include: `#spec_types` }, { include: `#types` }, {
        begin: `(?<=\\bdefine)`,
        comment: `Function name`,
        end: `(?=[(])`,
        patterns: [{ include: `#comments` }, { match: `\\b(\\w+)\\b`, name: `entity.name.function.move` }],
      }],
    },
    spec_keywords: {
    ...
    struct: {
      ...
      patterns: [
        ...
        { include: `#has` },
        { include: `#abilities` },
        { comment: `Struct name (ident)`, match: `\\b[A-Z][a-zA-Z_0-9]*\\b`, name: `entity.name.type.struct.move` },
        {
          begin: `\\(`,
          comment: `Positional fields`,
          end: `\\)`,
          name: `meta.struct.paren.move`,
          patterns: [{ include: `#comments` }, { include: `#capitalized` }, { include: `#types` }],
        },
        { include: `#type_param` },
        {
          begin: `\\(`,
    ...
    type_param: {
      ...
      patterns: [{ include: `#comments` }, { include: `#phantom` }, { include: `#capitalized` }, {
        include: `#module_access`,
      }, { include: `#abilities` }],
    },
    types: {
    ...
    use_fun: {
      ...
      patterns: [
        { include: `#comments` },
        { comment: `as keyword`, match: `\\b(as)\\b`, name: `keyword.control.as.move` },
        { comment: `Self keyword`, match: `\\b(Self)\\b`, name: `variable.language.self.use.fun.move` },
        { comment: `Function name`, match: `\\b(_______[a-z][a-z_0-9]+)\\b`, name: `entity.name.function.use.move` },
        { include: `#types` },
        { include: `#escaped_identifier` },
        { include: `#capitalized` },
      ],
    },
    vector: { comment: `vector type`, match: `\\b(vector)\\b`, name: `support.type.vector.move` },
  },
  i = `source.move`,
