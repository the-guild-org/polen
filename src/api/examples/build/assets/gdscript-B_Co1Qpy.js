var e = `GDScript`,
  t = [`gd`],
  n = `gdscript`,
  r = [{ include: `#statement` }, { include: `#expression` }],
  i = {
    annotated_parameter: {
      begin: `(?x)
...
`,
      ...
      patterns: [{ include: `#base_expression` }, { match: `=(?!=)`, name: `keyword.operator.assignment.gdscript` }],
    },
    annotations: {
      captures: {
    ...
    any_method: { match: `\\b([A-Za-z_]\\w*)\\b(?=\\s*(?:[(]))`, name: `entity.name.function.other.gdscript` },
    any_property: {
      captures: {
    ...
    any_variable: { match: `\\b(?<![@\\$#%])([A-Za-z_]\\w*)\\b(?![(])`, name: `variable.other.gdscript` },
    arithmetic_operator: {
      match: `->|\\+=|-=|\\*=|\\^=|/=|%=|&=|~=|\\|=|\\*\\*|\\*|/|%|\\+|-`,
      name: `keyword.operator.arithmetic.gdscript`,
    },
    assignment_operator: { match: `=`, name: `keyword.operator.assignment.gdscript` },
    base_expression: {
      patterns: [
    ...
    bitwise_operator: { match: `&|\\||<<=|>>=|<<|>>|\\^|~`, name: `keyword.operator.bitwise.gdscript` },
    boolean_operator: { match: `(&&|\\|\\|)`, name: `keyword.operator.boolean.gdscript` },
    builtin_classes: {
      match:
    ...
    builtin_get_node_shorthand: {
      patterns: [{ include: `#builtin_get_node_shorthand_quoted` }, { include: `#builtin_get_node_shorthand_bare` }, {
    ...
    class_declaration: {
      captures: { 1: { name: `entity.name.type.class.gdscript` }, 2: { name: `class.other.gdscript` } },
      match: `(?<=^class)\\s+([a-zA-Z_]\\w*)\\s*(?=:)`,
    },
    class_enum: {
      captures: { 1: { name: `entity.name.type.class.gdscript` }, 2: { name: `constant.language.gdscript` } },
      match: `\\b([A-Z][a-zA-Z_0-9]*)\\.([A-Z_0-9]+)`,
    },
    class_is: {
      captures: { 1: { name: `storage.type.is.gdscript` }, 2: { name: `entity.name.type.class.gdscript` } },
    ...
    compare_operator: { match: `<=|>=|==|<|>|!=|!`, name: `keyword.operator.comparison.gdscript` },
    const_vars: { match: `\\b([A-Z_][A-Z_0-9]*)\\b`, name: `constant.language.gdscript` },
    control_flow: {
    ...
    extends_statement: {
      captures: { 1: { name: `keyword.language.gdscript` }, 2: { name: `entity.other.inherited-class.gdscript` } },
...
(?=\\()`,
      ...
      patterns: [{ include: `#parameters` }, { include: `#line_continuation` }, { include: `#base_expression` }],
    },
    function_name: {
      patterns: [{ include: `#builtin_classes` }, { match: `\\b(preload)\\b`, name: `keyword.language.gdscript` }, {
    ...
    getter_setter_godot4: {
      patterns: [{ captures: { 1: { name: `entity.name.function.gdscript` } }, match: `\\b(get):` }, {
        begin: `(?x) \\s+
(set) \\s*
(?=\\()`,
    ...
    in_keyword: {
      patterns: [{
        ...
        patterns: [{ match: `\\bin\\b`, name: `keyword.control.gdscript` }, { include: `#base_expression` }, {
          include: `#any_variable`,
        }, { include: `#any_property` }],
    ...
    keywords: {
      match:
        `\\b(?:class|class_name|is|onready|tool|static|export|as|void|enum|assert|breakpoint|sync|remote|master|puppet|slave|remotesync|mastersync|puppetsync|trait|namespace)\\b`,
    ...
    letter: { match: `\\b(?:true|false|null)\\b`, name: `constant.language.gdscript` },
    line_continuation: {
      patterns: [{
        captures: {
...
\\s*(match)`,
    ...
    numbers: {
      patterns: [
        { match: `0b[01_]+`, name: `constant.numeric.integer.binary.gdscript` },
        { match: `0x[0-9A-Fa-f_]+`, name: `constant.numeric.integer.hexadecimal.gdscript` },
        { match: `[-]?([0-9][0-9_]+\\.[0-9_]*(e[\\-\\+]?[0-9_]+)?)`, name: `constant.numeric.float.gdscript` },
        { match: `[-]?(\\.[0-9][0-9_]*(e[\\-\\+]?[0-9_]+)?)`, name: `constant.numeric.float.gdscript` },
        { match: `[-]?([0-9][0-9_]*e[\\-\\+]?\\[0-9_])`, name: `constant.numeric.float.gdscript` },
...
`,
    ...
    strings: {
      ...
      patterns: [{ match: `\\\\.`, name: `constant.character.escape.gdscript` }, {
    ...
    wordlike_operator: { match: `\\b(and|or|not)\\b`, name: `keyword.operator.wordlike.gdscript` },
  },
  a = `source.gdscript`,
