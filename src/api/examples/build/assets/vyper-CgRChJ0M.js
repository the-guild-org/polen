var e = `Vyper`,
  t = `vyper`,
  n = [{ include: `#statement` }, { include: `#expression` }, { include: `#reserved-names-vyper` }],
  r = {
    'annotated-parameter': {
      begin: `(?x)
\\b
...
`,
      ...
      patterns: [{ include: `#expression` }, { match: `=(?!=)`, name: `keyword.operator.assignment.python` }],
    },
    'assignment-operator': {
      match: `(?x)
<<= | >>= | //= | \\*\\*=
...
`,
    ...
    'builtin-possible-callables': { patterns: [{ include: `#builtin-callables` }, { include: `#magic-names` }] },
    'builtin-types': {
      patterns: [{
        match: `(?x)
(?<!\\.) \\b(
...
`,
      ...
      patterns: [{ include: `#inheritance-name` }, { include: `#function-arguments` }],
    },
    'class-declaration': {
      patterns: [{
        begin: `(?x)
...
`,
    ...
    'class-inheritance': {
      ...
      patterns: [
        { match: `(\\*\\*|\\*)`, name: `keyword.operator.unpacking.arguments.python` },
    ...
    'class-kwarg': {
      captures: {
        1: { name: `entity.other.inherited-class.python variable.parameter.class.python` },
...
`,
    ...
    'class-name': {
      patterns: [{ include: `#illegal-object-name` }, { include: `#builtin-possible-callables` }, {
        match: `(?x)
\\b ([[:alpha:]_]\\w*) \\b
`,
...
`,
          ...
          { match: `([\\[\\]\\(\\),\\.\\=\\*]|(->))`, name: `comment.typehint.punctuation.notation.python` },
          { match: `([[:alpha:]_]\\w*)`, name: `comment.typehint.variable.notation.python` },
        ],
    ...
    'curly-braces': {
      ...
      patterns: [{ match: `:`, name: `punctuation.separator.dict.python` }, { include: `#expression` }],
    },
    decorator: {
      begin: `(?x)
^\\s*
...
`,
    ...
    docstring: {
      patterns: [{
        ...
        patterns: [{ include: `#docstring-prompt` }, { include: `#codetags` }, { include: `#docstring-guts-unicode` }],
      }, {
        begin: `([rR])(\\'\\'\\'|\\"\\"\\")`,
        beginCaptures: {
        ...
        patterns: [{ include: `#string-consume-escape` }, { include: `#docstring-prompt` }, { include: `#codetags` }],
      }, {
        begin: `(\\'|\\")`,
        beginCaptures: { 1: { name: `punctuation.definition.string.begin.python` } },
        end: `(\\1)|(\\n)`,
        ...
        patterns: [{ include: `#codetags` }, { include: `#docstring-guts-unicode` }],
      }, {
        begin: `([rR])(\\'|\\")`,
        beginCaptures: {
          1: { name: `storage.type.string.python` },
        ...
        patterns: [{ include: `#string-consume-escape` }, { include: `#codetags` }],
      }],
    },
    'docstring-guts-unicode': {
      patterns: [{ include: `#escape-sequence-unicode` }, { include: `#escape-sequence` }, {
...
`,
        ...
        patterns: [{ include: `#regexp-charecter-set-escapes` }, {
          match: `[^\\n]`,
    ...
    'double-one-regexp-comments': {
      ...
      endCaptures: { 1: { name: `punctuation.comment.end.regexp` }, 2: { name: `invalid.illegal.newline.python` } },
      name: `comment.regexp`,
      patterns: [{ include: `#codetags` }],
    },
...
`,
    ...
    'double-one-regexp-parentheses-non-capturing': {
      begin: `\\(\\?:`,
      beginCaptures: {
        0: { name: `support.other.parenthesis.regexp punctuation.parenthesis.non-capturing.begin.regexp` },
      },
      end: `(\\)|(?="))|((?=(?<!\\\\)\\n))`,
      endCaptures: {
...
`,
    ...
    'double-three-regexp-conditional': {
      ...
      patterns: [{ include: `#double-three-regexp-expression` }, { include: `#comments-string-double-three` }],
    },
...
`,
    ...
    expression: {
      ...
      patterns: [{ include: `#expression-base` }, { include: `#member-access` }, {
    ...
    'expression-base': {
      ...
      patterns: [{ include: `#comments` }, { include: `#expression-bare` }, { include: `#line-continuation` }],
    },
    'f-expression': {
      comment: `All valid Python expressions, except comments and line continuation`,
      patterns: [{ include: `#expression-bare` }, { include: `#member-access` }, {
        comment: `Tokenize identifiers to help linters`,
        match: `(?x) \\b ([[:alpha:]_]\\w*) \\b`,
      }],
    },
...
`,
    ...
    'fstring-fnorm-quoted-multi-line': {
      ...
      patterns: [{ include: `#fstring-guts` }, { include: `#fstring-illegal-multi-brace` }, {
    ...
    'fstring-fnorm-quoted-single-line': {
      ...
      name: `meta.fstring.python`,
      patterns: [{ include: `#fstring-guts` }, { include: `#fstring-illegal-single-brace` }, {
        include: `#fstring-single-brace`,
      }, { include: `#fstring-single-core` }],
    },
    'fstring-formatting': {
      patterns: [{ include: `#fstring-formatting-braces` }, { include: `#fstring-formatting-singe-brace` }],
    },
    ...
    'fstring-formatting-singe-brace': { match: `(}(?!}))`, name: `invalid.illegal.brace.python` },
    'fstring-guts': {
      patterns: [{ include: `#escape-sequence-unicode` }, { include: `#escape-sequence` }, {
        include: `#string-line-continuation`,
    ...
    'fstring-illegal-single-brace': {
      ...
      patterns: [{ include: `#fstring-terminator-single` }, { include: `#f-expression` }],
    },
    'fstring-multi-brace': {
      begin: `(\\{)`,
      beginCaptures: { 1: { name: `constant.character.format.placeholder.other.python` } },
...
`,
      endCaptures: { 1: { name: `constant.character.format.placeholder.other.python` } },
      patterns: [{ include: `#fstring-terminator-multi` }, { include: `#f-expression` }],
    },
    'fstring-multi-core': {
      match: `(?x)
(.+?)
...
`,
    ...
    'fstring-raw-guts': { patterns: [{ include: `#string-consume-escape` }, { include: `#fstring-formatting` }] },
...
`,
    ...
    'fstring-raw-quoted-multi-line': {
      ...
      name: `meta.fstring.python`,
      patterns: [{ include: `#fstring-raw-guts` }, { include: `#fstring-illegal-multi-brace` }, {
        include: `#fstring-multi-brace`,
    ...
    'fstring-raw-quoted-single-line': {
      ...
      name: `meta.fstring.python`,
      patterns: [{ include: `#fstring-raw-guts` }, { include: `#fstring-illegal-single-brace` }, {
        include: `#fstring-single-brace`,
...
`,
    ...
    'fstring-terminator-multi': {
      patterns: [{ match: `(=(![rsa])?)(?=})`, name: `storage.type.format.python` }, {
        match: `(=?![rsa])(?=})`,
        name: `storage.type.format.python`,
      }, {
        captures: { 1: { name: `storage.type.format.python` }, 2: { name: `storage.type.format.python` } },
        match: `(?x)
( (?: =?) (?: ![rsa])? )
( : \\w? [<>=^]? [-+ ]? \\#?
\\d* ,? (\\.\\d+)? [bcdeEfFgGnosxX%]? )(?=})
`,
    ...
    'fstring-terminator-multi-tail': {
      begin: `((?:=?)(?:![rsa])?)(:)(?=.*?{)`,
      beginCaptures: { 1: { name: `storage.type.format.python` }, 2: { name: `storage.type.format.python` } },
      end: `(?=})`,
      patterns: [
...
`,
      ...
      endCaptures: { 1: { name: `punctuation.definition.arguments.end.python` } },
      name: `meta.function-call.python`,
      patterns: [{ include: `#special-variables` }, { include: `#function-name` }, { include: `#function-arguments` }],
    },
...
`,
      beginCaptures: { 1: { name: `storage.type.function.async.python` }, 2: { name: `storage.type.function.python` } },
      end: `(:|(?=[#'"\\n]))`,
      endCaptures: { 1: { name: `punctuation.section.function.begin.python` } },
      name: `meta.function.python`,
      patterns: [{ include: `#function-def-name` }, { include: `#parameters` }, { include: `#line-continuation` }, {
...
`,
    ...
    'function-name': {
      patterns: [{ include: `#builtin-possible-callables` }, {
...
`,
    ...
    'illegal-names': {
      captures: { 1: { name: `keyword.control.flow.python` }, 2: { name: `keyword.control.import.python` } },
      match: `(?x)
\\b(?:
(
...
`,
    ...
    'illegal-operator': {
      patterns: [{ match: `&&|\\|\\||--|\\+\\+`, name: `invalid.illegal.operator.python` }, {
        match: `[?$]`,
    ...
    import: {
      ...
      patterns: [{
        ...
        patterns: [{ match: `\\.+`, name: `punctuation.separator.period.python` }, { include: `#expression` }],
      }, {
        begin: `\\b(?<!\\.)(import)\\b`,
        beginCaptures: { 1: { name: `keyword.control.import.python` } },
        end: `$`,
        patterns: [{ match: `\\b(?<!\\.)as\\b`, name: `keyword.control.import.python` }, { include: `#expression` }],
      }],
    },
    impossible: {
      comment:
...
`,
    ...
    'inheritance-name': {
      patterns: [{ include: `#lambda-incomplete` }, { include: `#builtin-possible-callables` }, {
        include: `#inheritance-identifier`,
      }],
    },
    'item-access': {
...
`,
        ...
        patterns: [{ include: `#item-name` }, { include: `#item-index` }, { include: `#expression` }],
      }],
    },
    'item-index': {
      begin: `(\\[)`,
      ...
      patterns: [{ match: `:`, name: `punctuation.separator.slice.python` }, { include: `#expression` }],
    },
    'item-name': {
      patterns: [{ include: `#special-variables` }, { include: `#builtin-functions` }, { include: `#special-names` }, {
        match: `(?x)
\\b ([[:alpha:]_]\\w*) \\b
`,
    ...
    lambda: {
      patterns: [
        { captures: { 1: { name: `keyword.control.flow.python` } }, match: `((?<=\\.)lambda|lambda(?=\\s*[\\.=]))` },
        { captures: { 1: { name: `storage.type.function.lambda.python` } }, match: `\\b(lambda)\\s*?(?=[,\\n]|$)` },
        {
          begin: `(?x)
\\b (lambda) \\b
`,
          ...
          patterns: [
            ...
            { match: `(\\*\\*|\\*)`, name: `keyword.operator.unpacking.parameter.python` },
    ...
    'lambda-incomplete': { match: `\\blambda(?=\\s*[,)])`, name: `storage.type.function.lambda.python` },
    'lambda-nested-incomplete': { match: `\\blambda(?=\\s*[:,)])`, name: `storage.type.function.lambda.python` },
...
`,
    ...
    literal: {
      patterns: [{ match: `\\b(True|False|None|NotImplemented|Ellipsis)\\b`, name: `constant.language.python` }, {
        include: `#number`,
      }],
    },
    'loose-default': {
...
`,
    ...
    'magic-names': { patterns: [{ include: `#magic-function-names` }, { include: `#magic-variable-names` }] },
...
`,
    ...
    'member-access-class': {
      ...
      name: `meta.member.access.python`,
      patterns: [{ include: `#call-wrapper-inheritance` }, { include: `#member-access-base` }, {
        include: `#inheritance-identifier`,
      }],
    },
    number: {
...
`,
    ...
    'number-dec': {
      captures: { 1: { name: `storage.type.imaginary.number.python` }, 2: { name: `invalid.illegal.dec.python` } },
      match: `(?x)
(?<![\\w\\.])(?:
[1-9](?: _?[0-9] )*
|
...
`,
    ...
    punctuation: {
      patterns: [{ match: `:`, name: `punctuation.separator.colon.python` }, {
        match: `,`,
        name: `punctuation.separator.element.python`,
      }],
    },
    regexp: {
      patterns: [{ include: `#regexp-single-three-line` }, { include: `#regexp-double-three-line` }, {
...
`,
    ...
    'regexp-base-expression': { patterns: [{ include: `#regexp-quantifier` }, { include: `#regexp-base-common` }] },
...
`,
    ...
    'regexp-escape-special': { match: `\\\\([AbBdDsSwWZ])`, name: `support.other.escape.special.regexp` },
...
`,
    ...
    'regexp-flags': { match: `\\(\\?[aiLmsux]+\\)`, name: `storage.modifier.flag.regexp` },
    'regexp-quantifier': {
      match: `(?x)
\\{(
\\d+ | \\d+,(\\d+)? | ,\\d+
...
`,
    ...
    'return-annotation': {
      begin: `(->)`,
      beginCaptures: { 1: { name: `punctuation.separator.annotation.result.python` } },
      end: `(?=:)`,
      patterns: [{ include: `#expression` }],
    },
    'round-braces': {
    ...
    semicolon: { patterns: [{ match: `\\;$`, name: `invalid.deprecated.semicolon.python` }] },
...
`,
    ...
    'single-three-regexp-conditional': {
      ...
      patterns: [{ include: `#single-three-regexp-expression` }, { include: `#comments-string-single-three` }],
    },
...
`,
    ...
    'statement-keyword': {
      patterns: [
        { match: `\\b((async\\s+)?\\s*def)\\b`, name: `storage.type.function.python` },
        {
...
`,
    ...
    'string-entity': {
      patterns: [{ include: `#escape-sequence` }, { include: `#string-line-continuation` }, {
...
`,
    ...
    'string-line-continuation': { match: `\\\\$`, name: `constant.language.python` },
...
`,
      ...
      patterns: [{ include: `#string-consume-escape` }, { include: `#string-formatting` }],
    },
...
`,
      ...
      patterns: [{ include: `#escape-sequence-unicode` }, { include: `#string-entity` }],
    },
    'string-quoted-multi-line': {
      ...
      patterns: [{ include: `#string-multi-bad-brace1-formatting-unicode` }, {
    ...
    'string-quoted-single-line': {
      ...
      patterns: [{ include: `#string-single-bad-brace1-formatting-unicode` }, {
        include: `#string-single-bad-brace2-formatting-unicode`,
      }, { include: `#string-unicode-guts` }],
    },
    'string-raw-bin-guts': { patterns: [{ include: `#string-consume-escape` }, { include: `#string-formatting` }] },
    ...
    'string-raw-quoted-multi-line': {
      ...
      patterns: [{ include: `#string-multi-bad-brace1-formatting-raw` }, {
    ...
    'string-raw-quoted-single-line': {
      ...
      patterns: [{ include: `#string-single-bad-brace1-formatting-raw` }, {
