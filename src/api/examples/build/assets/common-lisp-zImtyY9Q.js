var e = `Common Lisp`,
  ...
  o = {
    'block-comment': {
      ...
      name: `comment`,
      patterns: [{ include: `#block-comment`, name: `comment` }],
    },
    class: {
      match: `(?xi)
(?<=^|\\s|\\()
...
(?=(\\s|\\(|\\)))`,
    ...
    comment: {
      begin: `(^[ \\t]+)?(?=;)`,
      beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.commonlisp` } },
      end: `(?!\\G)`,
      patterns: [{
        begin: `;`,
        beginCaptures: { 0: { name: `punctuation.definition.comment.commonlisp` } },
        end: `\\n`,
...
(?=(\\s|\\(|\\)))`,
    ...
    'def-name': {
      patterns: [{
        captures: {
          1: { name: `storage.type.function.defname.commonlisp` },
          3: { name: `storage.type.function.defname.commonlisp` },
          4: { name: `variable.other.constant.defname.commonlisp` },
          6: { patterns: [{ include: `#package` }, { match: `\\S+?`, name: `entity.name.function.commonlisp` }] },
          7: { name: `variable.other.constant.defname.commonlisp` },
          9: { patterns: [{ include: `#package` }, { match: `\\S+?`, name: `entity.name.function.commonlisp` }] },
        },
        match: `(?xi)
(?<=^|\\s|\\()
...
(?=(\\s|\\(|\\)))`,
        ...
        captures: {
          1: { name: `storage.type.function.defname.commonlisp` },
          2: { name: `entity.name.type.commonlisp` },
        },
        match: `(?xi)
(?<=^|\\s|\\()
...
(?=(\\s|\\(|\\)))`,
        ...
        captures: {
          1: { name: `storage.type.function.defname.commonlisp` },
          2: {
            patterns: [{ include: `#package` }, { match: `\\S+?`, name: `variable.other.constant.defname.commonlisp` }],
          },
        },
        match: `(?xi)
(?<=^|\\s|\\()
...
(?=(\\s|\\(|\\)))`,
        ...
        captures: { 1: { name: `storage.type.function.defname.commonlisp` } },
        match: `(?xi)
(?<=^|\\s|\\()
(defvar|defparameter)
\\s+
...
(?=(\\s|\\(|\\)))`,
        ...
        captures: {
          1: { name: `keyword.control.commonlisp` },
          2: { patterns: [{ include: `#package` }, { match: `\\S+?`, name: `entity.name.function.commonlisp` }] },
        },
        match: `(?xi)
(?<=^|\\s|\\()
...
(?=(\\s|\\(|\\)))`,
    ...
    package: {
      patterns: [{
        captures: { 2: { name: `support.type.package.commonlisp` }, 3: { name: `support.type.package.commonlisp` } },
        match: `(?xi)
(?<=^|\\s|\\(|,@|,\\.|,)
(
([A-Za-z0-9\\+\\-\\*\\/\\@\\$\\%\\^\\&\\_\\=\\<\\>\\~\\!\\?\\[\\]\\{\\}\\.]+?)
...
(?=(\\s|\\(|\\)))`,
        ...
        captures: {
          1: { name: `variable.other.constant.sharpsign.commonlisp` },
          2: { name: `constant.numeric.commonlisp` },
        },
        match: `(?xi)
(?<=^|\\s|\\(|,@|,\\.|,)
(\\#)([0-9]*)
(?=\\()`,
        ...
        captures: {
          1: { name: `variable.other.constant.sharpsign.commonlisp` },
          2: { name: `constant.numeric.commonlisp` },
          3: { name: `variable.other.constant.sharpsign.commonlisp` },
        },
        match: `(?xi)
(?<=^|\\s|\\(|,@|,\\.|,)
(\\#)
...
(?=\\S)`,
        ...
        captures: { 1: { name: `support.type.package.commonlisp` } },
        match: `(?xi)
(?<=^|\\s|\\(|,@|,\\.|,)
(\\#)
(:)
(?=\\S)`,
        ...
        captures: {
          2: { name: `variable.other.constant.backquote.commonlisp` },
          3: { name: `variable.other.constant.backquote.commonlisp` },
          4: { name: `variable.other.constant.backquote.commonlisp` },
          5: { name: `variable.other.constant.backquote.commonlisp` },
        },
        match: `(?xi)
(?<=^|\\s|\\()
(
...
(?=\\S)`,
    ...
    'special-operator': {
      captures: { 2: { name: `keyword.control.commonlisp` } },
      match: `(?xi)
(\\(\\s*)
...
(?=(\\s|\\(|\\)))`,
    ...
    string: {
      begin: `(")`,
      beginCaptures: { 1: { name: `punctuation.definition.string.begin.commonlisp` } },
      end: `(")`,
      endCaptures: { 1: { name: `punctuation.definition.string.end.commonlisp` } },
      name: `string.quoted.double.commonlisp`,
      patterns: [{ match: `\\\\.`, name: `constant.character.escape.commonlisp` }, {
        captures: {
          1: { name: `storage.type.function.formattedstring.commonlisp` },
          2: { name: `variable.other.constant.formattedstring.commonlisp` },
          8: { name: `storage.type.function.formattedstring.commonlisp` },
          10: { name: `storage.type.function.formattedstring.commonlisp` },
        },
        match: `(?xi)
...
(\\(|\\)|\\[|\\]|;|{|}|<|>|\\^)`,
        ...
        captures: {
          1: { name: `entity.name.variable.commonlisp` },
          2: { name: `variable.other.constant.formattedstring.commonlisp` },
          8: { name: `entity.name.variable.commonlisp` },
...
(\\/)`,
    ...
    'style-guide': {
      patterns: [{
        captures: { 3: { name: `source.commonlisp` } },
        match: `(?xi)
(?<=^'|\\s'|\\('|,@'|,\\.'|,')
(\\S+?)
(\\:\\:|\\:)
