var e = `rose-pine`,
  ...
  r = [
    ...
    { scope: [`constant`], settings: { foreground: `#31748f` } },
    {
      scope: [`constant.numeric`, `constant.language`, `constant.charcter.escape`],
      settings: { foreground: `#ebbcba` },
    },
    { scope: [`entity.name`], settings: { foreground: `#ebbcba` } },
    {
    ...
    { scope: [`keyword`], settings: { foreground: `#31748f` } },
    ...
    { scope: [`meta.import`, `meta.export`], settings: { foreground: `#31748f` } },
    ...
    { scope: [`punctuation.accessor`], settings: { foreground: `#31748f` } },
    ...
    { scope: [`storage.type`, `storage.modifier`], settings: { foreground: `#31748f` } },
    ...
    { scope: [`variable`], settings: { foreground: `#ebbcba`, fontStyle: `italic` } },
    {
