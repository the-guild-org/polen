  ...
  i = {
    ...
    blocks: {
      patterns: [{
        ...
        endCaptures: { 1: { name: `keyword.control.end.if.matlab` }, 2: { patterns: [{ include: `$self` }] } },
        name: `meta.if.matlab`,
        patterns: [{
          captures: { 2: { name: `keyword.control.elseif.matlab` }, 3: { patterns: [{ include: `$self` }] } },
          end: `^`,
          match: `(\\s*)(?:^|[\\s,;])(elseif)\\b(.*)$\\n?`,
          name: `meta.elseif.matlab`,
        }, {
          captures: { 2: { name: `keyword.control.else.matlab` }, 3: { patterns: [{ include: `$self` }] } },
          end: `^`,
          match: `(\\s*)(?:^|[\\s,;])(else)\\b(.*)?$\\n?`,
        ...
        begin: `\\s*(?:^|[\\s,;])(spmd)\\b`,
        beginCaptures: { 1: { name: `keyword.control.spmd.matlab` } },
        end: `\\s*(?:^|[\\s,;])(end)\\b`,
        endCaptures: { 1: { name: `keyword.control.end.spmd.matlab` } },
        ...
        patterns: [{
          captures: { 2: { name: `keyword.control.case.matlab` }, 3: { patterns: [{ include: `$self` }] } },
          end: `^`,
          match: `(\\s*)(?:^|[\\s,;])(case)\\b(.*)$\\n?`,
          name: `meta.case.matlab`,
        }, {
          captures: { 2: { name: `keyword.control.otherwise.matlab` }, 3: { patterns: [{ include: `$self` }] } },
          end: `^`,
        ...
        patterns: [{
          captures: { 2: { name: `keyword.control.catch.matlab` }, 3: { patterns: [{ include: `$self` }] } },
          end: `^`,
          match: `(\\s*)(?:^|[\\s,;])(catch)\\b(.*)?$\\n?`,
    ...
    braced_validator_list: {
      begin: `\\s*({)\\s*`,
      beginCaptures: { 1: { name: `storage.type.matlab` } },
      comment: `Validator functions. Treated as a recursive group to permit nested brackets, quotes, etc.`,
      end: `(})`,
      endCaptures: { 1: { name: `storage.type.matlab` } },
      patterns: [
        { include: `#braced_validator_list` },
        { include: `#validator_strings` },
        { include: `#line_continuation` },
        { captures: { 1: { name: `storage.type.matlab` } }, match: `([^{}}'"\\.]+)` },
        { match: `\\.`, name: `storage.type.matlab` },
      ],
    },
    classdef: {
      patterns: [{
...
`,
        beginCaptures: {
          2: { name: `storage.type.class.matlab` },
          3: {
            patterns: [{
              captures: {
                1: {
                  patterns: [{ match: `[a-zA-Z][a-zA-Z0-9_]*`, name: `variable.parameter.class.matlab` }, {
                    begin: `=\\s*`,
                    end: `,|(?=\\))`,
                    patterns: [{ match: `true|false`, name: `constant.language.boolean.matlab` }, {
                      include: `#string`,
                    }],
                  }],
                },
                2: { name: `meta.class-declaration.matlab` },
                3: { name: `entity.name.section.class.matlab` },
                4: { name: `keyword.operator.other.matlab` },
                5: {
                  patterns: [{
                    match: `[a-zA-Z][a-zA-Z0-9_]*(\\.[a-zA-Z][a-zA-Z0-9_]*)*`,
                    name: `entity.other.inherited-class.matlab`,
                  }, { match: `&`, name: `keyword.operator.other.matlab` }],
                },
                6: { patterns: [{ include: `$self` }] },
              },
              match: `(?x)
										(									# Optional attributes
											 \\( [^)]* \\)
        ...
        endCaptures: { 1: { name: `keyword.control.end.class.matlab` } },
...
`,
          beginCaptures: {
            ...
            3: {
              patterns: [{ match: `[a-zA-Z][a-zA-Z0-9_]*`, name: `variable.parameter.properties.matlab` }, {
                begin: `=\\s*`,
                end: `,|(?=\\))`,
                patterns: [{ match: `true|false`, name: `constant.language.boolean.matlab` }, {
...
`,
          beginCaptures: {
            ...
            3: {
              patterns: [{ match: `[a-zA-Z][a-zA-Z0-9_]*`, name: `variable.parameter.methods.matlab` }, {
                begin: `=\\s*`,
                end: `,|(?=\\))`,
                patterns: [{ match: `true|false`, name: `constant.language.boolean.matlab` }, {
                  match: `public|protected|private`,
...
`,
          beginCaptures: {
            ...
            3: {
              patterns: [{ match: `[a-zA-Z][a-zA-Z0-9_]*`, name: `variable.parameter.events.matlab` }, {
                begin: `=\\s*`,
                end: `,|(?=\\))`,
                patterns: [{ match: `true|false`, name: `constant.language.boolean.matlab` }, {
                  match: `public|protected|private`,
...
\\s*($|(?=%))
`,
          beginCaptures: { 2: { name: `keyword.control.enumeration.matlab` } },
          end: `\\s*(?:^|[\\s,;])(end)\\b`,
          endCaptures: { 1: { name: `keyword.control.end.enumeration.matlab` } },
    ...
    comments: {
      patterns: [
        {
          begin: `(^[ \\t]+)?(?=%%\\s)`,
          beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.matlab` } },
          end: `(?!\\G)`,
          patterns: [{
            begin: `%%`,
            beginCaptures: { 0: { name: `punctuation.definition.comment.matlab` } },
            end: `\\n`,
    ...
    control_statements: {
      captures: { 1: { name: `keyword.control.matlab` } },
    ...
    end_in_parens: { comment: `end as operator symbol`, match: `\\bend\\b`, name: `keyword.operator.symbols.matlab` },
    function: {
      patterns: [{
        begin: `(?x)
(^\\s*)
...
`,
        beginCaptures: {
          ...
          3: { name: `punctuation.definition.arguments.begin.matlab` },
          4: { patterns: [{ match: `\\w+`, name: `variable.parameter.output.matlab` }] },
          5: { name: `punctuation.definition.arguments.end.matlab` },
          6: { name: `variable.parameter.output.function.matlab` },
          7: { name: `entity.name.function.matlab` },
        },
        end: `\\s*(?:^|[\\s,;])(end)\\b(\\s*\\n)?`,
        endCaptures: { 1: { name: `keyword.control.end.function.matlab` } },
        name: `meta.function.matlab`,
        patterns: [{
          begin: `\\G\\(`,
          end: `\\)`,
          name: `meta.arguments.function.matlab`,
          patterns: [{ include: `#line_continuation` }, { match: `\\w+`, name: `variable.parameter.input.matlab` }],
        }, {
          begin: `(?x)
(^\\s*)
(arguments)\\b([^%]*)
...
`,
          beginCaptures: {
            ...
            3: { patterns: [{ match: `[a-zA-Z][a-zA-Z0-9_]*`, name: `variable.parameter.arguments.matlab` }] },
          },
          end: `\\s*(?:^|[\\s,;])(end)\\b`,
    ...
    global_persistent: {
      captures: { 1: { name: `keyword.control.globalpersistent.matlab` } },
    ...
    line_continuation: {
      captures: { 1: { name: `keyword.operator.symbols.matlab` }, 2: { name: `comment.line.continuation.matlab` } },
    ...
    parens: {
      ...
      patterns: [{ include: `#end_in_parens` }, { include: `#all_before_command_dual` }, {
        include: `#all_after_command_dual`,
      }, {
        comment:
          `These block keywords pick up any such missed keywords when the block matching for things like (), if-end, etc. don't work. Useful for when someone has partially written`,
    ...
    square_brackets: {
      ...
      patterns: [{ include: `#all_before_command_dual` }, { include: `#all_after_command_dual` }, {
        comment:
          `These block keywords pick up any such missed keywords when the block matching for things like (), if-end, etc. don't work. Useful for when someone has partially written`,
        include: `#block_keywords`,
      }],
    ...
    validators: {
      ...
      patterns: [
        { include: `#line_continuation` },
        { comment: `Size declaration`, match: `\\s*(\\([^\\)]*\\))`, name: `storage.type.matlab` },
        { comment: `Type declaration`, match: `([a-zA-Z][a-zA-Z0-9_\\.]*)`, name: `storage.type.matlab` },
        { include: `#braced_validator_list` },
      ],
    },
    variables: {
