var e = `Berry`,
  ...
  r = {
    'comment-block': { begin: `\\#\\-`, end: `\\-#`, name: `comment.berry`, patterns: [{}] },
    comments: { begin: `\\#`, end: `\\n`, name: `comment.line.berry`, patterns: [{}] },
    controls: {
      patterns: [{
    ...
    function: { patterns: [{ match: `\\b([a-zA-Z_][a-zA-Z0-9_]*(?=\\s*\\())`, name: `entity.name.function.berry` }] },
    identifier: { patterns: [{ match: `\\b[_A-Za-z]\\w+\\b`, name: `identifier.berry` }] },
    keywords: {
      patterns: [{
    ...
    strings: {
      patterns: [{
        ...
        patterns: [
          ...
          { match: `\\{\\{[^\\}]*\\}\\}`, name: `string.quoted.other.berry` },
          {
            begin: `\\{`,
            end: `\\}`,
