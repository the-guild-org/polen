var e = `Prolog`,
  ...
  r = [{ include: `#comments` }, {
    ...
    patterns: [{ include: `#atom` }, { include: `#variable` }, { include: `#constants` }],
  }, {
    begin: `^\\s*([a-z][a-zA-Z0-9_]*)(\\(?)(?=.*-->.*)`,
    beginCaptures: {
    ...
    patterns: [{ include: `#comments` }, { include: `#atom` }, { include: `#variable` }, { include: `#constants` }],
  }],
  i = {
    atom: {
      patterns: [
    ...
    constants: {
      patterns: [{ match: `(?<![a-zA-Z]|/)(\\d+|(\\d+\\.\\d+))`, name: `constant.numeric.integer.prolog` }, {
        match: `".*?"`,
      ...
      patterns: [
        {
          ...
          name: `meta.if.prolog`,
          patterns: [{ include: `$self` }, { include: `#builtin` }, { include: `#comments` }, { include: `#atom` }, {
            include: `#variable`,
    ...
    variable: {
      patterns: [{ match: `(?<![a-zA-Z0-9_])[A-Z][a-zA-Z0-9_]*`, name: `variable.parameter.uppercase.prolog` }, {
        match: `(?<!\\w)_`,
