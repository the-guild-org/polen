var e = `Raku`,
  t = `raku`,
  n = [
    { begin: `^=begin`, end: `^=end`, name: `comment.block.perl` },
    {
      begin: `(^[ \\t]+)?(?=#)`,
      beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.perl` } },
      end: `(?!\\G)`,
      patterns: [{
        begin: `#`,
    ...
    {
      captures: { 1: { name: `storage.type.class.perl.6` }, 3: { name: `entity.name.type.class.perl.6` } },
      match:
    ...
    },
    {
      ...
      patterns: [{ match: `\\\\[abtnfre"\\\\]`, name: `constant.character.escape.perl` }],
    },
    { begin: `q(q|to|heredoc)*\\s*:?(q|to|heredoc)*\\s*/(.+)/`, end: `\\3`, name: `string.quoted.single.heredoc.perl` },
    {
      begin:
        `(q|Q)(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*:?(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*{{`,
      end: `}}`,
      name: `string.quoted.double.heredoc.brace.perl`,
      patterns: [{ include: `#qq_brace_string_content` }],
    },
    {
      begin:
        `(q|Q)(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*:?(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*\\(\\(`,
      ...
      patterns: [{ include: `#qq_paren_string_content` }],
    },
    {
      begin:
        `(q|Q)(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*:?(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*\\[\\[`,
      ...
      patterns: [{ include: `#qq_bracket_string_content` }],
    },
    {
      begin:
        `(q|Q)(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*:?(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*{`,
    ...
    },
    {
      ...
      patterns: [{ include: `#qq_slash_string_content` }],
    },
    {
      begin:
        `(q|Q)(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*:?(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*\\(`,
    ...
    },
    {
      ...
      patterns: [{ include: `#qq_single_string_content` }],
    },
    {
      begin:
        `(q|Q)(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*:?(x|exec|w|words|ww|quotewords|v|val|q|single|qq|double|s|scalar|a|array|h|hash|f|function|c|closure|b|blackslash|regexp|substr|trans|codes|p|path)*\\s*"`,
      ...
      patterns: [{ include: `#qq_double_string_content` }],
    },
    { match: `\\b\\$\\w+\\b`, name: `variable.other.perl` },
    {
      match: `\\b(macro|sub|submethod|method|multi|proto|only|rule|token|regex|category)\\b`,
      name: `storage.type.declare.routine.perl`,
    },
    { match: `\\b(self)\\b`, name: `variable.language.perl` },
    { match: `\\b(use|require)\\b`, name: `keyword.other.include.perl` },
    { match: `\\b(if|else|elsif|unless)\\b`, name: `keyword.control.conditional.perl` },
    { match: `\\b(let|my|our|state|temp|has|constant)\\b`, name: `storage.type.variable.perl` },
    { match: `\\b(for|loop|repeat|while|until|gather|given)\\b`, name: `keyword.control.repeat.perl` },
    {
      match:
        `\\b(take|do|when|next|last|redo|return|contend|maybe|defer|default|exit|make|continue|break|goto|leave|async|lift)\\b`,
    ...
    { match: `\\b(die|fail|try|warn)\\b`, name: `keyword.control.control-handlers.perl` },
    {
      match:
        `\\b(prec|irs|ofs|ors|export|deep|binary|unary|reparsed|rw|parsed|cached|readonly|defequiv|will|ref|copy|inline|tighter|looser|equiv|assoc|required)\\b`,
      name: `storage.modifier.perl`,
    },
    { match: `\\b(NaN|Inf)\\b`, name: `constant.numeric.perl` },
    { match: `\\b(oo|fatal)\\b`, name: `keyword.other.pragma.perl` },
    {
      match:
