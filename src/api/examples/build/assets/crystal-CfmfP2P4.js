var e = `Crystal`,
  ...
  n = `^#!/.*\\bcrystal`,
  r =
    `(?x)^(\\s*+(annotation|module|class|struct|union|enum|def(?!.*\\bend\\s*$)|unless|if|case|begin|for|while|until|^=begin|("(\\\\.|[^"])*+"|'(\\\\.|[^'])*+'|[^#"'])*(\\s(do|begin|case)|(?<!\\$)[-+=&|*/~%^<>~]\\s*+(if|unless)))\\b(?![^;]*+;.*?\\bend\\b)|("(\\\\.|[^"])*+"|'(\\\\.|[^'])*+'|[^#"'])*(\\{(?![^}]*+\\})|\\[(?![^\\]]*+\\]))).*$|[#].*?\\(fold\\)\\s*+$`,
  i = `(?x)((^|;)\\s*+end\\s*+([#].*)?$|(^|;)\\s*+end\\..*$|^\\s*+[}\\]] ,?\\s*+([#].*)?$|[#].*?\\(end\\)\\s*+$|^=end)`,
  a = `crystal`,
  o = [
    {
      captures: {
      ...
      match:
        `(?x)^\\s*(abstract)?\\s*(class|struct|union|annotation|enum)\\s+(([.A-Z_:\\x{80}-\\x{10FFFF}][.\\w:\\x{80}-\\x{10FFFF}]*(\\(([,\\s.a-zA-Z0-9_:\\x{80}-\\x{10FFFF}]+)\\))?(\\s*(<)\\s*[.:A-Z\\x{80}-\\x{10FFFF}][.:\\w\\x{80}-\\x{10FFFF}]*(\\(([.a-zA-Z0-9_:]+\\s,)\\))?)?)|((<<)\\s*[.A-Z0-9_:\\x{80}-\\x{10FFFF}]+))`,
    ...
    },
    {
      ...
      match:
        `^\\s*(module)\\s+(([A-Z\\x{80}-\\x{10FFFF}][\\w\\x{80}-\\x{10FFFF}]*(::))?([A-Z\\x{80}-\\x{10FFFF}][\\w\\x{80}-\\x{10FFFF}]*(::))?([A-Z\\x{80}-\\x{10FFFF}][\\w\\x{80}-\\x{10FFFF}]*(::))*[A-Z\\x{80}-\\x{10FFFF}][\\w\\x{80}-\\x{10FFFF}]*)`,
    ...
    {
      captures: {
        1: { name: `keyword.control.lib.type.crystal` },
        2: { name: `entity.name.lib.type.crystal` },
        3: { name: `keyword.control.lib.crystal` },
        4: { name: `entity.name.lib.type.value.crystal` },
      },
      comment: `type in lib`,
    ...
    },
    {
      ...
      match:
        `(?<!\\.)\\b(fun|begin|case|class|else|elsif|end|ensure|enum|for|if|macro|module|rescue|struct|then|union|unless|until|when|while)\\b(?![?!:])`,
      name: `keyword.control.crystal`,
    },
    {
      comment: `everything being a reserved word, not a value, and not needing a 'end' is a..`,
      match:
        `(?<!\\.)\\b(abstract|alias|asm|break|extend|in|include|next|of|private|protected|struct|return|select|super|with|yield)\\b(?![?!:])`,
    ...
    { comment: `contextual smart pair support`, match: `(?<=\\{)(\\s+)`, name: `meta.syntax.crystal.start-block` },
    {
      ...
      match:
        `(?<!\\.)\\b(pointerof|typeof|sizeof|instance_sizeof|offsetof|previous_def|forall|out|uninitialized)\\b(?![?!:])|\\.(is_a\\?|nil\\?|responds_to\\?|as\\?|as\b)`,
      name: `keyword.control.pseudo-method.crystal`,
    },
    { match: `\\bnil\\b(?![?!:])`, name: `constant.language.nil.crystal` },
    { match: `\\b(true|false)\\b(?![?!:])`, name: `constant.language.boolean.crystal` },
    { match: `\\b(__(DIR|FILE|LINE|END_LINE)__)\\b(?![?!:])`, name: `variable.language.crystal` },
    { match: `\\b(self)\\b(?![?!:])`, name: `variable.language.self.crystal` },
    {
      comment: `https://crystal-lang.org/api/0.36.1/Object.html#macro-summary`,
      match:
        `(?<!\\.)\\b(((class_)?((getter|property)\\b[!?]?|setter\\b))|(def_(clone|equals|equals_and_hash|hash)|delegate|forward_missing_to)\\b)(?![?!:])`,
    ...
    },
    {
      ...
      match:
        `(?<!\\.)\\b(abort|at_exit|caller|exit|gets|loop|main|p|pp|print|printf|puts|raise|rand|read_line|sleep|spawn|sprintf|system|debugger|record|spawn)\\b(?![?!:])`,
      name: `support.function.kernel.crystal`,
    },
    { comment: `Constant name in any where`, match: `\\b[_A-Z]+\\b`, name: `variable.other.constant.crystal` },
    {
      begin: `(?x)
(?=def\\b)
(?<=^|\\s)(def)\\s+
...
\\s*(\\()`,
      ...
      patterns: [{
        ...
        patterns: [{
          captures: {
            ...
            2: { name: `constant.other.symbol.hashkey.parameter.function.crystal` },
            3: { name: `punctuation.definition.constant.hashkey.crystal` },
            4: { name: `variable.parameter.function.crystal` },
          },
    ...
    {
      captures: { 1: { name: `keyword.control.def.crystal` }, 3: { name: `entity.name.function.crystal` } },
...
\\^|===?|!=|>[>=]?|<=>|<[<=]?|[%&\`/\\|]|\\*\\*?|=?~|[-+]@?|\\[][?=]?|\\[]=?
    ...
    },
    {
      ...
      patterns: [{ match: `\\\\['\\\\]`, name: `constant.character.escape.crystal` }],
    },
    {
      begin: `:"`,
    ...
    },
    {
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.crystal` } },
      name: `string.interpolated.crystal`,
      patterns: [{ include: `#interpolated_crystal` }, { include: `#escaped_char` }, { include: `#nest_curly_i` }],
    },
    {
      begin: `%x\\[`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.crystal` } },
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.crystal` } },
      name: `string.interpolated.crystal`,
      patterns: [{ include: `#interpolated_crystal` }, { include: `#escaped_char` }, { include: `#nest_brackets_i` }],
    },
    {
      begin: `%x\\<`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.crystal` } },
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.crystal` } },
      name: `string.interpolated.crystal`,
      patterns: [{ include: `#interpolated_crystal` }, { include: `#escaped_char` }, { include: `#nest_ltgt_i` }],
    },
    {
      begin: `%x\\(`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.crystal` } },
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.crystal` } },
      name: `string.interpolated.crystal`,
      patterns: [{ include: `#interpolated_crystal` }, { include: `#escaped_char` }, { include: `#nest_parens_i` }],
    },
    {
      begin: `%x\\|`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.crystal` } },
    ...
    {
      begin:
        `(?x) (?: ^| (?<=[=>~(?:\\[,|&;] | [\\s;]if\\s| [\\s;]elsif\\s | [\\s;]while\\s | [\\s;]unless\\s | [\\s;]when\\s | [\\s;]assert_match\\s | [\\s;]or\\s| [\\s;]and\\s | [\\s;]not\\s | [\\s.]index\\s| [\\s.]scan\\s | [\\s.]sub\\s | [\\s.]sub!\\s | [\\s.]gsub\\s | [\\s.]gsub!\\s | [\\s.]match\\s ) | (?<=^when\\s| ^if\\s | ^elsif\\s | ^while\\s | ^unless\\s ) ) \\s*((/))(?![*+{}?])`,
      captures: { 1: { name: `string.regexp.classic.crystal` }, 2: { name: `punctuation.definition.string.crystal` } },
      comment:
        `regular expressions (normal) we only start a regexp if the character before it (excluding whitespace) is what we think is before a regexp`,
    ...
    },
    {
      ...
      patterns: [{ match: `\\\\\\)|\\\\\\\\`, name: `constant.character.escape.crystal` }, { include: `#nest_parens` }],
    },
    {
      begin: `%[qwi]\\<`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.crystal` } },
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.crystal` } },
      name: `string.quoted.other.literal.lower.crystal`,
      patterns: [{ match: `\\\\\\>|\\\\\\\\`, name: `constant.character.escape.crystal` }, { include: `#nest_ltgt` }],
    },
    {
      begin: `%[qwi]\\[`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.crystal` } },
    ...
    },
    {
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.crystal` } },
      name: `string.quoted.other.literal.lower.crystal`,
      patterns: [{ match: `\\\\\\}|\\\\\\\\`, name: `constant.character.escape.crystal` }, { include: `#nest_curly` }],
    },
    {
      begin: `%[qwi]\\|`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.crystal` } },
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.crystal` } },
      name: `string.quoted.other.literal.lower.crystal`,
      patterns: [{ comment: `Cant be named because its not necessarily an escape.`, match: `\\\\.` }],
    },
    {
      captures: { 1: { name: `punctuation.definition.constant.crystal` } },
      comment: `symbols`,
      match:
        '(?<!:)(:)(?>[a-zA-Z_\\x{80}-\\x{10FFFF}][\\w\\x{80}-\\x{10FFFF}]*(?>[?!]|=(?![>=]))?|===?|>[>=]?|<[<=]?|<=>|[%&`/\\|]|\\*\\*?|=?~|[-+]@?|\\[\\][?=]?|@@?[a-zA-Z_\\x{80}-\\x{10FFFF}][\\w\\x{80}-\\x{10FFFF}]*)',
      name: `constant.other.symbol.crystal`,
    },
    {
      captures: { 1: { name: `punctuation.definition.constant.crystal` } },
    ...
    { match: `(?<!}})\\b_([\\w]+[?!]?)\\b(?!\\()`, name: `comment.unused.crystal` },
    {
      ...
      patterns: [{ include: `#heredoc` }, { include: `text.html.basic` }, { include: `#interpolated_crystal` }, {
    ...
    },
    {
      ...
      patterns: [{ include: `#heredoc` }, { include: `source.sql` }, { include: `#interpolated_crystal` }, {
        include: `#escaped_char`,
      }],
    },
    {
      ...
      patterns: [{ include: `#heredoc` }, { include: `source.css` }, { include: `#interpolated_crystal` }, {
        include: `#escaped_char`,
      }],
    },
    {
      ...
      patterns: [{ include: `#heredoc` }, { include: `source.c++` }, { include: `#interpolated_crystal` }, {
        include: `#escaped_char`,
      }],
    },
    {
    ...
    },
    {
      ...
      patterns: [{ include: `#heredoc` }, { include: `source.js` }, { include: `#interpolated_crystal` }, {
        include: `#escaped_char`,
      }],
    },
    {
      ...
      patterns: [{ include: `#heredoc` }, { include: `source.js.jquery` }, { include: `#interpolated_crystal` }, {
        include: `#escaped_char`,
      }],
    },
    {
      ...
      patterns: [{ include: `#heredoc` }, { include: `source.shell` }, { include: `#interpolated_crystal` }, {
        include: `#escaped_char`,
      }],
    },
    {
      ...
      patterns: [{ include: `#heredoc` }, { include: `source.crystal` }, { include: `#interpolated_crystal` }, {
        include: `#escaped_char`,
      }],
    },
    {
      ...
      patterns: [{ include: `#heredoc` }, { include: `#escaped_char` }],
    },
    {
      begin: `(?><<-(\\w+)\\b)`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.crystal` } },
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.crystal` } },
      name: `string.unquoted.heredoc.crystal`,
      patterns: [{ include: `#heredoc` }, { include: `#interpolated_crystal` }, { include: `#escaped_char` }],
    },
    {
    ...
    { match: `->`, name: `support.function.kernel.crystal` },
    {
      match: `<<=|%=|&{1,2}=|\\*=|\\*\\*=|\\+=|-=|\\^=|\\|{1,2}=|<<`,
      name: `keyword.operator.assignment.augmented.crystal`,
    },
    ...
    { match: `(?<=^|[ \\t])!|&&|\\|\\||\\^`, name: `keyword.operator.logical.crystal` },
    ...
    { match: `\\(|\\)`, name: `punctuation.section.function.crystal` },
    {
      ...
      patterns: [{ match: `([a-zA-Z0-9_!?]+)(?=\\()`, name: `entity.name.function.crystal` }, { include: `$self` }],
    },
    {
      comment:
  ...
  s = {
    ...
    interpolated_crystal: {
      patterns: [{
        begin: `#\\{`,
        beginCaptures: { 0: { name: `punctuation.section.embedded.begin.crystal` } },
        contentName: `source.crystal`,
        end: `(\\})`,
        endCaptures: { 0: { name: `punctuation.section.embedded.end.crystal` }, 1: { name: `source.crystal` } },
    ...
    regex_sub: {
      patterns: [{ include: `#interpolated_crystal` }, { include: `#escaped_char` }, {
        ...
        begin: `\\[(?:\\^?])?`,
        captures: { 0: { name: `punctuation.definition.character-class.crystal` } },
        end: `]`,
