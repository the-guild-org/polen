var e = `Vue`,
  t = `vue`,
  n = [{ include: `text.html.basic#comment` }, { include: `#self-closing-tag` }, {
    begin: `(<)`,
    beginCaptures: { 1: { name: `punctuation.definition.tag.begin.html.vue` } },
    end: `(>)`,
    endCaptures: { 1: { name: `punctuation.definition.tag.end.html.vue` } },
    patterns: [{
      begin: `([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*(['"]?)md\\b\\2)`,
      beginCaptures: { 1: { name: `entity.name.tag.$1.html.vue` } },
      end: `(</)(\\1)\\s*(?=>)`,
      endCaptures: {
        1: { name: `punctuation.definition.tag.begin.html.vue` },
        2: { name: `entity.name.tag.$2.html.vue` },
      },
      ...
      patterns: [{ include: `#tag-stuff` }, { begin: `(?<=>)`, end: `(?=<\\/)`, name: `text` }],
    }],
  }],
  r = {
    'html-stuff': {
      patterns: [{ include: `#template-tag` }, { include: `text.html.derivative` }, { include: `text.html.basic` }],
    },
    'self-closing-tag': {
      begin: `(<)([a-zA-Z0-9:-]+)(?=([^>]+/>))`,
      beginCaptures: {
    ...
    'tag-stuff': {
      ...
      endCaptures: { 1: { name: `punctuation.definition.tag.end.html.vue` } },
      name: `meta.tag-stuff`,
      patterns: [{ include: `#vue-directives` }, { include: `text.html.basic#attribute` }],
    },
    'template-tag': { patterns: [{ include: `#template-tag-1` }, { include: `#template-tag-2` }] },
    'template-tag-1': {
      begin: `(<)(template)\\b(>)`,
      beginCaptures: {
        1: { name: `punctuation.definition.tag.begin.html.vue` },
      ...
      patterns: [{
        ...
        endCaptures: {
          2: { name: `punctuation.definition.tag.begin.html.vue` },
          3: { name: `entity.name.tag.$3.html.vue` },
        },
    ...
    'vue-directives': {
      patterns: [{ include: `#vue-directives-control` }, { include: `#vue-directives-style-attr` }, {
    ...
    'vue-directives-control': {
      ...
      captures: { 1: { name: `keyword.control.loop.vue` }, 2: { name: `keyword.control.conditional.vue` } },
      end: `(?=\\s*+[^=\\s])`,
    ...
    'vue-directives-expression': {
      patterns: [{
        begin: `(=)\\s*('|"|\`)`,
        beginCaptures: {
          1: { name: `punctuation.separator.key-value.html.vue` },
        ...
        begin: `(=)\\s*(?=[^'"\`])`,
        beginCaptures: { 1: { name: `punctuation.separator.key-value.html.vue` } },
        end: `(?=(\\s|>|\\/>))`,
        patterns: [{
          begin: `(?=[^'"\`])`,
          end: `(?=(\\s|>|\\/>))`,
    ...
    'vue-directives-generic-attr': {
      ...
      patterns: [{
        begin: `('|")`,
        beginCaptures: { 1: { name: `punctuation.definition.string.begin.html.vue` } },
        comment:
          `https://github.com/microsoft/vscode/blob/fd4346210f59135fad81a8b8c4cea7bf5a9ca6b4/extensions/typescript-basics/syntaxes/TypeScript.tmLanguage.json#L4002-L4020`,
        end: `(\\1)`,
        endCaptures: { 1: { name: `punctuation.definition.string.end.html.vue` } },
    ...
    'vue-directives-original': {
      ...
      beginCaptures: {
        1: { name: `entity.other.attribute-name.html.vue` },
        2: { name: `punctuation.separator.key-value.html.vue` },
        3: { name: `punctuation.attribute-shorthand.bind.html.vue` },
        4: { name: `punctuation.attribute-shorthand.event.html.vue` },
        5: { name: `punctuation.attribute-shorthand.slot.html.vue` },
        6: { name: `punctuation.separator.key-value.html.vue` },
        7: { name: `source.ts.embedded.html.vue`, patterns: [{ include: `source.ts#expression` }] },
        8: { name: `punctuation.separator.key-value.html.vue` },
      ...
      patterns: [{
        1: { name: `punctuation.separator.key-value.html.vue` },
        2: { name: `entity.other.attribute-name.html.vue` },
        match: `(\\.)([\\w-]*)`,
    ...
    'vue-directives-style-attr': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `source.css#comment-block` }, { include: `source.css#escapes` }, {
...
|\\\\(?:[0-9a-fA-F]{1,6}|.)
          ...
          patterns: [{ include: `source.css#comment-block` }, { include: `source.css#property-values` }],
    ...
    'vue-interpolations': {
      patterns: [{
        begin: `(\\{\\{)`,
        beginCaptures: { 1: { name: `punctuation.definition.interpolation.begin.html.vue` } },
        end: `(\\}\\})`,
        endCaptures: { 1: { name: `punctuation.definition.interpolation.end.html.vue` } },
  ...
  i = `source.vue`,
  a = { displayName: `Vue`, name: `vue`, patterns: n, repository: r, scopeName: i }
