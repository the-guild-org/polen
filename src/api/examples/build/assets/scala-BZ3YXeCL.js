var e = `Scala`,
  ...
  s = {
    ...
    'block-comments': {
      patterns: [{
        ...
        patterns: [{
          ...
          captures: { 1: { name: `keyword.other.documentation.scaladoc.scala` }, 2: { name: `entity.name.class` } },
    ...
    'char-literal': {
      patterns: [{
        captures: {
          1: { name: `punctuation.definition.character.begin.scala` },
          2: { name: `punctuation.definition.character.end.scala` },
        },
        match: `(')'(')`,
        ...
        name: `string.quoted.other constant.character.literal.scala`,
        patterns: [
          { match: `\\\\(?:[btnfr\\\\"']|[0-7]{1,3}|u[0-9A-Fa-f]{4})`, name: `constant.character.escape.scala` },
          { match: `\\\\.`, name: `invalid.illegal.unrecognized-character-escape.scala` },
          { match: `[^']{2,}`, name: `invalid.illegal.character-literal-too-long` },
          { match: `(?<!')[^']`, name: `invalid.illegal.character-literal-too-long` },
        ],
      }],
    },
    code: {
    ...
    comments: {
      patterns: [{ include: `#block-comments` }, {
        begin: `(^[ \\t]+)?(?=//)`,
        beginCaptures: { 1: { name: `punctuation.whitespace.comment.leading.scala` } },
        end: `(?!\\G)`,
        patterns: [{
          begin: `//`,
          beginCaptures: { 0: { name: `punctuation.definition.comment.scala` } },
          end: `\\n`,
    ...
    constants: {
      patterns: [
        ...
        { match: `(\\.[0-9][0-9_]*)([eE](\\+|-)?[0-9][0-9_]*)?[LlFfDd]?\\b`, name: `constant.numeric.scala` },
        { match: `\\b0[bB][01]([01_]*[01])?[Ll]?\\b`, name: `constant.numeric.scala` },
    ...
    declarations: {
      patterns: [{
        captures: { 1: { name: `keyword.declaration.scala` }, 2: { name: `entity.name.function.declaration` } },
        match:
          '\\b(def)\\b\\s*(?!//|/\\*)((?:(?:[A-Z\\p{Lt}\\p{Lu}_a-z\\$\\p{Lo}\\p{Nl}\\p{Ll}][A-Z\\p{Lt}\\p{Lu}_a-z\\$\\p{Lo}\\p{Nl}\\p{Ll}0-9]*(?:(?<=_)[!#%&*+\\-\\/:<>=?@^|~\\p{Sm}\\p{So}]+)?|[!#%&*+\\-\\/:<>=?@^|~\\p{Sm}\\p{So}]+)|`[^`]+`))?',
      }, {
        captures: { 1: { name: `keyword.declaration.scala` }, 2: { name: `entity.name.class.declaration` } },
        match:
        ...
        captures: { 1: { name: `keyword.declaration.scala` }, 2: { name: `entity.name.type.declaration` } },
        match:
        ...
        captures: { 1: { name: `keyword.declaration.stable.scala` }, 2: { name: `variable.stable.declaration.scala` } },
        match:
        ...
        captures: {
          1: { name: `keyword.other.package.scala` },
          2: { name: `keyword.declaration.scala` },
          3: { name: `entity.name.class.declaration` },
        },
        match:
        ...
        begin: `\\b(package)\\s+`,
        beginCaptures: { 1: { name: `keyword.other.package.scala` } },
        end: `(?<=[\\n;])`,
        ...
        captures: { 1: { name: `keyword.declaration.scala` }, 2: { name: `entity.name.given.declaration` } },
        match:
    ...
    extension: {
      patterns: [{ captures: { 1: { name: `keyword.declaration.scala` } }, match: `^\\s*(extension)\\s+(?=[\\[\\(])` }],
    },
    imports: {
      begin: `\\b(import)\\s+`,
      ...
      patterns: [
        ...
        { match: `\\s(as)\\s`, name: `keyword.other.import.as.scala` },
        {
          match:
            `[A-Z\\p{Lt}\\p{Lu}][A-Z\\p{Lt}\\p{Lu}_a-z\\$\\p{Lo}\\p{Nl}\\p{Ll}0-9]*(?:(?<=_)[!#%&*+\\-\\/:<>=?@^|~\\p{Sm}\\p{So}]+)?`,
    ...
    inheritance: {
      patterns: [{
        captures: { 1: { name: `keyword.declaration.scala` }, 2: { name: `entity.name.class` } },
        match:
    ...
    initialization: { captures: { 1: { name: `keyword.declaration.scala` } }, match: `\\b(new)\\b` },
    inline: {
      patterns: [{
        match:
    ...
    keywords: {
      patterns: [
        { match: `\\b(return|throw)\\b`, name: `keyword.control.flow.jump.scala` },
        { match: `\\b(classOf|isInstanceOf|asInstanceOf)\\b`, name: `support.function.type-of.scala` },
        { match: `\\b(else|if|then|do|while|for|yield|match|case)\\b`, name: `keyword.control.flow.scala` },
        {
        ...
        { match: `\\b(catch|finally|try)\\b`, name: `keyword.control.exception.scala` },
        {
          match: `^\\s*(end)\\s+(try)(?=\\s*(//.*|/\\*(?!.*\\*/\\s*\\S.*).*)?$)`,
          name: `keyword.control.exception.end.scala`,
        },
        {
          captures: { 1: { name: `keyword.declaration.end.scala` }, 2: { name: `entity.name.declaration` } },
          match:
        ...
        { match: `(\\-|\\+|\\*|/(?![/*])|%|~)`, name: `keyword.operator.arithmetic.scala` },
        {
    ...
    'parameter-list': {
      patterns: [{
        captures: { 1: { name: `variable.parameter.scala` }, 2: { name: `meta.colon.scala` } },
        match:
    ...
    'scala-quoted-or-symbol': {
      patterns: [
        {
          captures: {
            1: { name: `keyword.control.flow.staging.scala constant.other.symbol.scala` },
    ...
    'string-interpolation': {
      patterns: [{ match: `\\$\\$`, name: `constant.character.escape.interpolation.scala` }, {
        captures: { 1: { name: `punctuation.definition.template-expression.begin.scala` } },
    ...
    strings: {
      patterns: [{
        ...
        patterns: [{ match: `\\\\\\\\|\\\\u[0-9A-Fa-f]{4}`, name: `constant.character.escape.scala` }],
      }, {
        begin: `\\b(raw)(""")`,
        beginCaptures: {
          1: { name: `keyword.interpolation.scala` },
          2: { name: `string.quoted.triple.interpolated.scala punctuation.definition.string.begin.scala` },
        },
        end: `(""")(?!")|\\$
|(\\$[^\\$"_{A-Z\\p{Lt}\\p{Lu}_a-z\\$\\p{Lo}\\p{Nl}\\p{Ll}])`,
        endCaptures: {
          1: { name: `string.quoted.triple.interpolated.scala punctuation.definition.string.end.scala` },
...
|(\\$[^\\$"_{A-Z\\p{Lt}\\p{Lu}_a-z\\$\\p{Lo}\\p{Nl}\\p{Ll}])`,
        ...
        patterns: [{
          ...
          name: `constant.character.escape.scala`,
        }, { match: `\\\\.`, name: `invalid.illegal.unrecognized-string-escape.scala` }],
      }, {
        begin: `\\b(raw)(")`,
        beginCaptures: {
          1: { name: `keyword.interpolation.scala` },
          2: { name: `string.quoted.double.interpolated.scala punctuation.definition.string.begin.scala` },
        },
        end: `(")|\\$
|(\\$[^\\$"_{A-Z\\p{Lt}\\p{Lu}_a-z\\$\\p{Lo}\\p{Nl}\\p{Ll}])`,
        endCaptures: {
          1: { name: `string.quoted.double.interpolated.scala punctuation.definition.string.end.scala` },
          2: { name: `invalid.illegal.unrecognized-string-escape.scala` },
        },
        patterns: [{ match: `\\$[\\$"]`, name: `constant.character.escape.scala` }, {
          include: `#string-interpolation`,
...
|(\\$[^\\$"_{A-Z\\p{Lt}\\p{Lu}_a-z\\$\\p{Lo}\\p{Nl}\\p{Ll}])`,
    ...
    using: { patterns: [{ captures: { 1: { name: `keyword.declaration.scala` } }, match: `(?<=\\()\\s*(using)\\s` }] },
    'using-directive': {
      begin: `^\\s*(//>)\\s*(using)[^\\S\\n]+(?:(\\S+))?`,
      beginCaptures: {
      ...
      patterns: [{ include: `#constants` }, { include: `#strings` }, {
        match: `[^\\s,]+`,
        name: `string.quoted.double.scala`,
      }],
    },
    ...
    'xml-literal': {
      patterns: [{
        ...
        comment:
          `We do not allow a tag name to start with a - since this would likely conflict with the <- operator. This is not very common for tag names anyway.  Also code such as -- if (val <val2 || val> val3) will falsly be recognized as an xml tag.  The solution is to put a space on either side of the comparison operator`,
...
export {
  ...
  c as scopeName,
  e as displayName,
  i as foldingStopMarker,
  l as default,
  n as firstLineMatch,
  o as patterns,
  r as foldingStartMarker,
  s as repository,
  t as fileTypes,
}
