var e = `APL`,
  t = [`apl`, `apla`, `aplc`, `aplf`, `apli`, `apln`, `aplo`, `dyalog`, `dyapp`, `mipage`],
  n = `(?x)
# APL symbols
[⌶-⍺]
|
...
(?i:
  ...
  i = `}`,
  a = `apl`,
  o = [{ match: `\\A#!.*$`, name: `comment.line.shebang.apl` }, { include: `#heredocs` }, { include: `#main` }, {
    ...
    begin: `^\\s*((\\))\\S+)`,
    beginCaptures: { 1: { name: `entity.name.command.apl` }, 2: { name: `punctuation.definition.command.apl` } },
    end: `$`,
    name: `meta.system.command.apl`,
    patterns: [{ include: `#command-arguments` }, { include: `#command-switches` }, { include: `#main` }],
  }, {
    begin: `^\\s*((\\])\\S+)`,
    beginCaptures: { 1: { name: `entity.name.command.apl` }, 2: { name: `punctuation.definition.command.apl` } },
    end: `$`,
...
(.*?)$`,
        beginCaptures: {
          ...
          3: { name: `entity.name.type.class.apl`, patterns: [{ include: `#strings` }] },
          4: { name: `entity.other.inherited-class.apl` },
          5: { name: `punctuation.separator.inheritance.apl` },
          6: { patterns: [{ include: `#strings` }] },
          7: { name: `entity.other.class.interfaces.apl`, patterns: [{ include: `#csv` }] },
        },
        end: `(?<=\\s|^)((:)EndClass)(?=\\b)`,
        endCaptures: { 1: { name: `keyword.control.class.apl` }, 2: { name: `punctuation.definition.class.apl` } },
        patterns: [{
          begin: `(?<=\\s|^)(:)Field(?=\\s)`,
          beginCaptures: { 0: { name: `keyword.control.field.apl` }, 1: { name: `punctuation.definition.field.apl` } },
          end: `\\s*(←.*)?(?:$|(?=⍝))`,
          endCaptures: { 0: { name: `entity.other.initial-value.apl` }, 1: { patterns: [{ include: `#main` }] } },
          name: `meta.field.apl`,
          patterns: [
            { match: `(?<=\\s|^)Public(?=\\s|$)`, name: `storage.modifier.access.public.apl` },
            { match: `(?<=\\s|^)Private(?=\\s|$)`, name: `storage.modifier.access.private.apl` },
            { match: `(?<=\\s|^)Shared(?=\\s|$)`, name: `storage.modifier.shared.apl` },
            { match: `(?<=\\s|^)Instance(?=\\s|$)`, name: `storage.modifier.instance.apl` },
            { match: `(?<=\\s|^)ReadOnly(?=\\s|$)`, name: `storage.modifier.readonly.apl` },
            {
              captures: { 1: { patterns: [{ include: `#strings` }] } },
              match: `(?x)
(
'[^']*'?
|
...
(=)`,
        ...
        captures: { 1: { name: `punctuation.delimiter.switch.apl` }, 2: { name: `entity.name.switch.apl` } },
        match: `(?x)
(?<=\\s)(-)
(
[A-Z_a-zÀ-ÖØ-Ýßà-öø-üþ∆⍙Ⓐ-Ⓩ]
...
(?!=)`,
    ...
    csv: { patterns: [{ match: `,`, name: `punctuation.separator.apl` }, { include: `$self` }] },
    definition: {
      patterns: [{
        begin:
        ...
        beginCaptures: {
          ...
          30: { name: `entity.function.name.apl`, patterns: [{ include: `#embolden` }] },
          ...
          39: { name: `entity.function.name.apl`, patterns: [{ include: `#embolden` }] },
...
\\s*
    ...
    embolden: { patterns: [{ match: `.+`, name: `markup.bold.identifier.apl` }] },
    heredocs: {
      patterns: [{
    ...
    label: {
      patterns: [{
        captures: { 1: { name: `entity.label.name.apl` }, 2: { name: `punctuation.definition.label.end.apl` } },
        match: `(?x)
^\\s*
(
[A-Z_a-zÀ-ÖØ-Ýßà-öø-üþ∆⍙Ⓐ-Ⓩ]
...
(:)`,
    ...
    'lambda-variables': {
      patterns: [
        ...
        { match: `∇∇`, name: `constant.language.lambda.operands.self.operator.apl` },
        { match: `∇`, name: `constant.language.lambda.operands.self.function.apl` },
...
[A-Z_a-zÀ-ÖØ-Ýßà-öø-üþ∆⍙Ⓐ-Ⓩ¯0-9]*`,
    ...
    symbols: {
      patterns: [
        { match: `(?<=\\s)←(?=\\s|$)`, name: `keyword.spaced.operator.assignment.apl` },
        { match: `(?<=\\s)→(?=\\s|$)`, name: `keyword.spaced.control.goto.apl` },
        { match: `(?<=\\s)≡(?=\\s|$)`, name: `keyword.spaced.operator.identical.apl` },
        { match: `(?<=\\s)≢(?=\\s|$)`, name: `keyword.spaced.operator.not-identical.apl` },
