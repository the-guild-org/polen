var e = `material-darker`,
  t = !0,
  n = [
    { name: `Global settings`, settings: { background: `#212121`, foreground: `#EEFFFF` } },
    { name: `String`, scope: `string`, settings: { foreground: `#C3E88D` } },
    { name: `Punctuation`, scope: `punctuation, constant.other.symbol`, settings: { foreground: `#89DDFF` } },
    {
      name: `String Escape`,
      scope: `constant.character.escape, text.html constant.character.entity.named`,
      settings: { foreground: `#EEFFFF` },
    },
    { name: `Boolean`, scope: `constant.language.boolean`, settings: { foreground: `#ff9cac` } },
    { name: `Number`, scope: `constant.numeric`, settings: { foreground: `#F78C6C` } },
    {
      name: `Variable`,
      scope:
    ...
    { name: `Other Keyword`, scope: `keyword.other`, settings: { foreground: `#F78C6C` } },
    {
      name: `Keyword`,
      scope: `keyword, modifier, variable.language.this, support.type.object, constant.language`,
      settings: { foreground: `#89DDFF` },
    },
    { name: `Function call`, scope: `entity.name.function, support.function`, settings: { foreground: `#82AAFF` } },
    { name: `Storage`, scope: `storage.type, storage.modifier, storage.control`, settings: { foreground: `#C792EA` } },
    {
      name: `Modules`,
      scope: `support.module, support.node`,
      settings: { foreground: `#f07178`, fontStyle: `italic` },
    },
    { name: `Type`, scope: `support.type, constant.other.key`, settings: { foreground: `#FFCB6B` } },
    {
      name: `Type`,
      scope: `entity.name.type, entity.other.inherited-class, entity.other`,
      settings: { foreground: `#FFCB6B` },
    },
    { name: `Comment`, scope: `comment`, settings: { foreground: `#545454`, fontStyle: `italic` } },
    {
      name: `Comment`,
      scope: `comment punctuation.definition.comment, string.quoted.docstring`,
      settings: { foreground: `#545454`, fontStyle: `italic` },
    },
    { name: `Punctuation`, scope: `punctuation`, settings: { foreground: `#89DDFF` } },
    {
      name: `Class`,
    ...
    { name: `Class method`, scope: `meta.definition.method entity.name.function`, settings: { foreground: `#f07178` } },
    { name: `Function definition`, scope: `meta.function entity.name.function`, settings: { foreground: `#82AAFF` } },
    {
    ...
    { name: `YAML key`, scope: `entity.name.tag.yaml`, settings: { foreground: `#f07178` } },
    {
      name: `JSON key`,
      scope: `meta.object-literal.key, meta.object-literal.key string, support.type.property-name.json`,
      settings: { foreground: `#f07178` },
    },
    { name: `JSON constant`, scope: `constant.language.json`, settings: { foreground: `#89DDFF` } },
    { name: `CSS class`, scope: `entity.other.attribute-name.class`, settings: { foreground: `#FFCB6B` } },
    { name: `CSS ID`, scope: `entity.other.attribute-name.id`, settings: { foreground: `#F78C6C` } },
    { name: `CSS tag`, scope: `source.css entity.name.tag`, settings: { foreground: `#FFCB6B` } },
    { name: `CSS properties`, scope: `support.type.property-name.css`, settings: { foreground: `#B2CCD6` } },
    { name: `HTML tag outer`, scope: `meta.tag, punctuation.definition.tag`, settings: { foreground: `#89DDFF` } },
    { name: `HTML tag inner`, scope: `entity.name.tag`, settings: { foreground: `#f07178` } },
    { name: `HTML tag attribute`, scope: `entity.other.attribute-name`, settings: { foreground: `#C792EA` } },
    { name: `HTML entities`, scope: `punctuation.definition.entity.html`, settings: { foreground: `#EEFFFF` } },
    { name: `Markdown heading`, scope: `markup.heading`, settings: { foreground: `#89DDFF` } },
    {
    ...
    { name: `Markdown italic`, scope: `markup.italic`, settings: { foreground: `#f07178`, fontStyle: `italic` } },
    { name: `Markdown bold`, scope: `markup.bold`, settings: { foreground: `#f07178`, fontStyle: `bold` } },
    {
      name: `Markdown bold italic`,
      scope: `markup.bold markup.italic, markup.italic markup.bold`,
      settings: { foreground: `#f07178`, fontStyle: `italic bold` },
    },
    {
    ...
    { name: `Markdown inline code`, scope: `markup.inline.raw.string.markdown`, settings: { foreground: `#C3E88D` } },
    { name: `INI property name`, scope: `keyword.other.definition.ini`, settings: { foreground: `#f07178` } },
    { name: `INI section title`, scope: `entity.name.section.group-title.ini`, settings: { foreground: `#89DDFF` } },
    { name: `C# class`, scope: `source.cs meta.class.identifier storage.type`, settings: { foreground: `#FFCB6B` } },
    {
      name: `C# class method`,
    ...
    { name: `C# type`, scope: `source.cs storage.type`, settings: { foreground: `#FFCB6B` } },
    { name: `C# return type`, scope: `source.cs meta.method.return-type`, settings: { foreground: `#FFCB6B` } },
    { name: `C# preprocessor`, scope: `source.cs meta.preprocessor`, settings: { foreground: `#545454` } },
    { name: `C# namespace`, scope: `source.cs entity.name.type.namespace`, settings: { foreground: `#EEFFFF` } },
    { name: `JSX Text`, scope: `meta.jsx.children, SXNested`, settings: { foreground: `#EEFFFF` } },
    { name: `JSX Components name`, scope: `support.class.component`, settings: { foreground: `#FFCB6B` } },
    {
    ...
    { name: `Blocks`, scope: `meta.block`, settings: { foreground: `#f07178` } },
    { name: `Function Call`, scope: `entity.name.function.call`, settings: { foreground: `#82AAFF` } },
    {
      name: `Namespaces`,
      scope: `source.php support.other.namespace, source.php meta.use support.class`,
      settings: { foreground: `#EEFFFF` },
    },
    { name: `Constant keywords`, scope: `constant.keyword`, settings: { foreground: `#89DDFF`, fontStyle: `italic` } },
    { name: `Entity name`, scope: `entity.name.function`, settings: { foreground: `#82AAFF` } },
    { name: `Global settings`, settings: { background: `#212121`, foreground: `#EEFFFF` } },
    { name: `Markup Deleted`, scope: [`markup.deleted`], settings: { foreground: `#f07178` } },
    { name: `Markup Inserted`, scope: [`markup.inserted`], settings: { foreground: `#C3E88D` } },
    { name: `Markup Underline`, scope: [`markup.underline`], settings: { fontStyle: `underline` } },
    { name: `Keyword Control`, scope: [`keyword.control`], settings: { foreground: `#89DDFF`, fontStyle: `italic` } },
    ...
    },
    {
      ...
      scope: [`markup.quote`],
      settings: { fontStyle: `italic`, foreground: `#89DDFF` },
    },
    { name: `Markdown - Fenced Language`, scope: [`markup.fenced_code.block`], settings: { foreground: `#EEFFFF90` } },
    {
      name: `Markdown - Blockquote Punctuation`,
      scope: [`punctuation.definition.quote`],
      settings: { foreground: `#ff9cac` },
    },
    {
