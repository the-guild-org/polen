var e = `Git Commit Message`,
  ...
  n = [{
    ...
    patterns: [
      { captures: { 1: { name: `markup.changed.git-commit` } }, match: `^#\\t((modified|renamed):.*)$` },
      { captures: { 1: { name: `markup.inserted.git-commit` } }, match: `^#\\t(new file:.*)$` },
      { captures: { 1: { name: `markup.deleted.git-commit` } }, match: `^#\\t(deleted.*)$` },
      {
        captures: {
