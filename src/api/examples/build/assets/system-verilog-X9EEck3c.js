var e = `SystemVerilog`,
  ...
  i = {
    'all-types': { patterns: [{ include: `#built-ins` }, { include: `#modifiers` }] },
    assertion: {
      captures: {
        1: { name: `entity.name.goto-label.php` },
    ...
    attributes: {
      begin: `(?<!@[ \\t\\r\\n]?)\\(\\*`,
      beginCaptures: { 0: { name: `punctuation.attribute.rounds.begin` } },
      end: `\\*\\)`,
      endCaptures: { 0: { name: `punctuation.attribute.rounds.end` } },
      name: `meta.attribute.systemverilog`,
      patterns: [
        {
          captures: {
            1: { name: `keyword.control.systemverilog` },
            2: { name: `keyword.operator.assignment.systemverilog` },
          },
    ...
    'base-grammar': {
      patterns: [
        ...
        { include: `#strings` },
        {
          captures: { 1: { name: `storage.type.interface.systemverilog` } },
    ...
    'bind-directive': {
      captures: { 1: { name: `keyword.control.systemverilog` }, 2: { name: `entity.name.type.module.systemverilog` } },
      match: `[ \\t\\r\\n]*\\b(bind)[ \\t\\r\\n]+([a-zA-Z_][a-zA-Z0-9_$\\.]*)\\b`,
      name: `meta.definition.systemverilog`,
    },
    'built-ins': {
      patterns: [
        { match: `[ \\t\\r\\n]*\\b(bit|logic|reg)\\b`, name: `storage.type.vector.systemverilog` },
        {
          match: `[ \\t\\r\\n]*\\b(byte|shortint|int|longint|integer|time|genvar)\\b`,
          name: `storage.type.atom.systemverilog`,
        },
        { match: `[ \\t\\r\\n]*\\b(shortreal|real|realtime)\\b`, name: `storage.type.notint.systemverilog` },
        {
    ...
    'cast-operator': {
      captures: {
        1: {
          patterns: [{ include: `#built-ins` }, { include: `#constants` }, {
            match: `[a-zA-Z_][a-zA-Z0-9_$]*`,
    ...
    'class-declaration': {
      ...
      beginCaptures: {
        ...
        3: { name: `storage.modifier.systemverilog` },
        4: { name: `entity.name.type.class.systemverilog` },
        5: { name: `keyword.control.systemverilog` },
        6: { name: `entity.name.type.class.systemverilog` },
      },
      end: `;`,
      endCaptures: { 0: { name: `punctuation.definition.class.end.systemverilog` } },
    ...
    'compiler-directives': {
      ...
      patterns: [{
        captures: {
          ...
          2: { name: `string.regexp.systemverilog` },
        },
        match:
        ...
        captures: {
          1: { name: `punctuation.definition.directive.systemverilog` },
          2: { name: `string.regexp.systemverilog` },
          3: { name: `variable.other.constant.preprocessor.systemverilog` },
        },
        ...
        captures: {
          1: { name: `punctuation.definition.directive.systemverilog` },
          2: { name: `variable.other.constant.preprocessor.systemverilog` },
        },
    ...
    constants: {
      patterns: [
        ...
        { match: `\\b(?:\\d[\\d_\\.]*(?<!\\.)(?:e|E)(?:\\+|-)?[0-9]+)\\b`, name: `constant.numeric.exp.systemverilog` },
        {
        ...
        { match: `\\b(?:this|super|null)\\b`, name: `constant.language.systemverilog` },
        { match: `\\b([A-Z][A-Z0-9_]*)\\b`, name: `constant.other.net.systemverilog` },
        { match: `\\b(?<!\\.)([A-Z0-9_]+)(?!\\.)\\b`, name: `constant.numeric.parameter.uppercase.systemverilog` },
    ...
    'enum-struct-union': {
      ...
      beginCaptures: {
        1: { name: `keyword.control.systemverilog` },
        2: { patterns: [{ include: `#built-ins` }] },
        3: { patterns: [{ include: `#selects` }] },
        4: { name: `storage.modifier.systemverilog` },
        5: { name: `storage.modifier.systemverilog` },
      },
      end:
        "(?<=})[ \\t\\r\\n]*([a-zA-Z_][a-zA-Z0-9_$]*|(?<=^|[ \\t\\r\\n])\\\\[!-~]+(?=$|[ \\t\\r\\n]))(?:[ \\t\\r\\n]*(\\[[a-zA-Z0-9_:$\\.\\-\\+\\*/%`' \\t\\r\\n\\[\\]\\(\\)]*\\])?)[ \\t\\r\\n]*[,;]",
      endCaptures: { 1: { patterns: [{ include: `#identifiers` }] }, 2: { patterns: [{ include: `#selects` }] } },
      name: `meta.enum-struct-union.systemverilog`,
      patterns: [{ include: `#keywords` }, { include: `#base-grammar` }, { include: `#identifiers` }],
    },
    'fixme-todo': {
      patterns: [{ match: `(?i:fixme)`, name: `invalid.broken.fixme.systemverilog` }, {
        match: `(?i:todo)`,
    ...
    'function-task': {
      ...
      endCaptures: { 0: { name: `punctuation.definition.function.end.systemverilog` } },
      ...
      patterns: [
        {
          captures: {
            ...
            3: {
              patterns: [{ include: `#built-ins` }, {
                match: `[a-zA-Z_][a-zA-Z0-9_$]*`,
                name: `storage.type.user-defined.systemverilog`,
              }],
            },
            4: { patterns: [{ include: `#modifiers` }] },
            5: { patterns: [{ include: `#selects` }] },
            6: { name: `entity.name.function.systemverilog` },
          },
          match:
    ...
    identifiers: {
      patterns: [{ match: `\\b[a-zA-Z_][a-zA-Z0-9_$]*\\b`, name: `variable.other.identifier.systemverilog` }, {
        match: `(?<=^|[ \\t\\r\\n])\\\\[!-~]+(?=$|[ \\t\\r\\n])`,
    ...
    imports: {
      captures: {
        1: { name: `keyword.control.systemverilog` },
        2: { name: `support.type.scope.systemverilog` },
        3: { name: `keyword.operator.scope.systemverilog` },
        4: { patterns: [{ include: `#operators` }, { include: `#identifiers` }] },
      },
      match:
        `[ \\t\\r\\n]*\\b(import|export)[ \\t\\r\\n]+([a-zA-Z_][a-zA-Z0-9_$]*|\\*)[ \\t\\r\\n]*(::)[ \\t\\r\\n]*([a-zA-Z_][a-zA-Z0-9_$]*|\\*)[ \\t\\r\\n]*(,|;)`,
    ...
    'module-binding': {
      ...
      beginCaptures: { 1: { name: `support.function.port.systemverilog` } },
      end: `\\),?`,
      ...
      patterns: [
        ...
        { include: `#cast-operator` },
        { include: `#system-tf` },
        { match: `\\bvirtual\\b`, name: `storage.modifier.systemverilog` },
        { include: `#identifiers` },
      ],
    },
    'module-declaration': {
      ...
      beginCaptures: {
        ...
        3: { name: `entity.name.type.module.systemverilog` },
      },
      end: `;`,
      endCaptures: { 0: { name: `punctuation.definition.module.end.systemverilog` } },
    ...
    'module-no-parameters': {
      ...
      beginCaptures: {
        ...
        3: { name: `entity.name.type.module.systemverilog` },
        4: { name: `variable.other.module.systemverilog` },
        5: { patterns: [{ include: `#selects` }] },
      },
      end: `\\)(?:[ \\t\\r\\n]*(;))?`,
      endCaptures: { 1: { name: `punctuation.module.instantiation.end.systemverilog` } },
    ...
    operators: {
      patterns: [
        ...
        { match: `\\+\\+`, name: `keyword.operator.increment.systemverilog` },
        { match: `--`, name: `keyword.operator.decrement.systemverilog` },
        { match: `\\+|-|\\*\\*|\\*|/|%`, name: `keyword.operator.arithmetic.systemverilog` },
        { match: `!|&&|\\|\\|`, name: `keyword.operator.logical.systemverilog` },
        { match: `<<<|<<|>>>|>>`, name: `keyword.operator.bitwise.shift.systemverilog` },
        { match: `~&|~\\||~|\\^~|~\\^|&|\\||\\^|{|'{|}|:|\\?`, name: `keyword.operator.bitwise.systemverilog` },
        { match: `<=|<|>=|>|==\\?|!=\\?|===|!==|==|!=`, name: `keyword.operator.comparison.systemverilog` },
        { match: `@|##|#|->|<->`, name: `keyword.operator.channel.systemverilog` },
        {
          match:
            `\\b(?:dist|inside|with|intersect|and|or|throughout|within|first_match)\\b|:=|:/|\\|->|\\|=>|->>|\\*>|#-#|#=#|&&&`,
    ...
    parameters: {
      begin: `[ \\t\\r\\n]*(#)[ \\t\\r\\n]*(\\()`,
      beginCaptures: {
        1: { name: `keyword.operator.channel.systemverilog` },
        2: { name: `punctuation.section.parameters.begin` },
      },
      end: `(\\))[ \\t\\r\\n]*(?=;|\\(|[a-zA-Z_]|\\\\|$)`,
    ...
    'port-net-parameter': {
      patterns: [{
        captures: {
          1: { name: `support.type.direction.systemverilog` },
          2: { name: `storage.type.net.systemverilog` },
          ...
          6: { patterns: [{ include: `#modifiers` }] },
          7: { patterns: [{ include: `#selects` }] },
          8: { patterns: [{ include: `#constants` }, { include: `#identifiers` }] },
          9: { patterns: [{ include: `#selects` }] },
        },
        match:
    ...
    selects: {
      begin: `\\[`,
      beginCaptures: { 0: { name: `punctuation.slice.brackets.begin` } },
      end: `\\]`,
      endCaptures: { 0: { name: `punctuation.slice.brackets.end` } },
      name: `meta.brackets.select.systemverilog`,
      patterns: [
        { match: `\\$(?![a-z])`, name: `constant.language.systemverilog` },
        { include: `#system-tf` },
        { include: `#constants` },
        { include: `#operators` },
        { include: `#cast-operator` },
        { include: `#storage-scope` },
        { match: `[a-zA-Z_][a-zA-Z0-9_$]*`, name: `variable.other.identifier.systemverilog` },
      ],
    },
    sequence: {
      captures: { 1: { name: `keyword.control.systemverilog` }, 2: { name: `entity.name.function.systemverilog` } },
      match: `[ \\t\\r\\n]*\\b(sequence)[ \\t\\r\\n]+([a-zA-Z_][a-zA-Z0-9_$]*)\\b`,
    ...
    strings: {
      patterns: [{
        begin: '`?"',
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.systemverilog` } },
        end: '"`?',
        endCaptures: { 0: { name: `punctuation.definition.string.end.systemverilog` } },
        name: `string.quoted.double.systemverilog`,
        patterns: [
          { match: `\\\\(?:[nt\\\\"vfa]|[0-7]{3}|x[0-9a-fA-F]{2})`, name: `constant.character.escape.systemverilog` },
          {
            match: `(?x)%
(\\d+\\$)?
['\\-+0
...
[xXhHdDoObBcClLvVmMpPsStTuUzZeEfFgG%]`,
        ...
        begin: `(?<=include)[ \\t\\r\\n]*(<)`,
        beginCaptures: { 1: { name: `punctuation.definition.string.begin.systemverilog` } },
        end: `>`,
        endCaptures: { 0: { name: `punctuation.definition.string.end.systemverilog` } },
    ...
    'sv-control-begin': {
      captures: {
        ...
        3: { name: `entity.name.section.systemverilog` },
      },
      match: `[ \\t\\r\\n]*\\b(begin|fork)\\b(?:[ \\t\\r\\n]*(:)[ \\t\\r\\n]*([a-zA-Z_][a-zA-Z0-9_$]*))?`,
    ...
    'sv-definition': {
      captures: { 1: { name: `keyword.control.systemverilog` }, 2: { name: `entity.name.type.class.systemverilog` } },
      match:
    ...
    'sv-option': { captures: { 1: { name: `keyword.cover.systemverilog` } }, match: `[ \\t\\r\\n]*\\b(option)\\.` },
    'sv-rand': { match: `[ \\t\\r\\n]*\\b(?:rand|randc)\\b`, name: `storage.type.rand.systemverilog` },
    'sv-std': { match: `\\b(std)\\b::`, name: `support.class.systemverilog` },
    'system-tf': { match: `\\$[a-zA-Z0-9_$][a-zA-Z0-9_$]*\\b`, name: `support.function.systemverilog` },
    tables: {
      begin: `[ \\t\\r\\n]*\\b(table)\\b`,
      beginCaptures: { 1: { name: `keyword.table.systemverilog.begin` } },
      end: `[ \\t\\r\\n]*\\b(endtable)\\b`,
      endCaptures: { 1: { name: `keyword.table.systemverilog.end` } },
      name: `meta.table.systemverilog`,
      patterns: [
        { include: `#comments` },
        { match: `\\b[01xXbBrRfFpPnN]\\b`, name: `constant.language.systemverilog` },
        { match: `[-*?]`, name: `constant.language.systemverilog` },
        { captures: { 1: { name: `constant.language.systemverilog` } }, match: `\\(([01xX?]{2})\\)` },
        { match: `:`, name: `punctuation.definition.label.systemverilog` },
        { include: `#operators` },
        { include: `#constants` },
        { include: `#strings` },
        { include: `#identifiers` },
    ...
    typedef: {
      ...
      beginCaptures: {
        1: { name: `keyword.control.systemverilog` },
        2: {
          patterns: [{ include: `#built-ins` }, { match: `\\bvirtual\\b`, name: `storage.modifier.systemverilog` }],
        },
        3: { patterns: [{ include: `#modifiers` }] },
        4: { patterns: [{ include: `#selects` }] },
      },
      end: `;`,
      endCaptures: { 0: { name: `punctuation.definition.typedef.end.systemverilog` } },
      name: `meta.typedef.systemverilog`,
      patterns: [{ include: `#identifiers` }, { include: `#selects` }],
    },
    'typedef-enum-struct-union': {
      ...
      beginCaptures: {
        ...
        3: { patterns: [{ include: `#built-ins` }] },
        4: { patterns: [{ include: `#selects` }] },
        5: { name: `storage.modifier.systemverilog` },
        6: { name: `storage.modifier.systemverilog` },
      },
      end:
        "(?<=})[ \\t\\r\\n]*([a-zA-Z_][a-zA-Z0-9_$]*|(?<=^|[ \\t\\r\\n])\\\\[!-~]+(?=$|[ \\t\\r\\n]))(?:[ \\t\\r\\n]*(\\[[a-zA-Z0-9_:$\\.\\-\\+\\*/%`' \\t\\r\\n\\[\\]\\(\\)]*\\])?)[ \\t\\r\\n]*[,;]",
      endCaptures: { 1: { name: `storage.type.systemverilog` }, 2: { patterns: [{ include: `#selects` }] } },
      name: `meta.typedef-enum-struct-union.systemverilog`,
      patterns: [{ include: `#port-net-parameter` }, { include: `#keywords` }, { include: `#base-grammar` }, {
        include: `#identifiers`,
      }],
    },
  },
  a = `source.systemverilog`,
