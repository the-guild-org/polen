var e = `Vue HTML`,
  ...
  i = {
    ...
    'string-double-quoted': {
      ...
      patterns: [{ include: `source.vue#vue-interpolations` }, { include: `#entities` }],
    },
    ...
    'tag-generic-attribute': { match: `(?<=[^=])\\b([a-zA-Z0-9:\\-_]+)`, name: `entity.other.attribute-name.html` },
    'tag-id-attribute': {
      begin: `\\b(id)\\b\\s*(=)`,
      captures: {
    ...
    'unquoted-attribute': { match: `(?<==)(?:[^\\s<>/'"]|/(?!>))+`, name: `string.unquoted.html` },
    'vue-directives': {
