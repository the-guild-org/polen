var e = `Apache Conf`,
  ...
  r = [
    ...
    {
      captures: { 3: { name: `string.regexp.apacheconf` }, 4: { name: `string.replacement.apacheconf` } },
    ...
    {
      captures: { 1: { name: `string.regexp.apacheconf` }, 3: { name: `string.path.apacheconf` } },
      match: `(?<=ScriptAliasMatch|AliasMatch)\\s+(.+?)\\s+((.+?)\\s)?`,
    },
    {
      captures: { 1: { name: `string.path.apacheconf` }, 3: { name: `string.path.apacheconf` } },
    ...
    { captures: { 1: { name: `keyword.access.apacheconf` } }, match: `\\b(Allow|Deny|Order)\\b` },
    { captures: { 1: { name: `keyword.actions.apacheconf` } }, match: `\\b(Action|Script)\\b` },
    {
    ...
    },
    {
      ...
      match:
        `\\b(AddAlt|AddAltByEncoding|AddAltByType|AddDescription|AddIcon|AddIconByEncoding|AddIconByType|DefaultIcon|HeaderName|IndexIgnore|IndexOptions|IndexOrderDefault|IndexStyleSheet|IndexHeadInsert|ReadmeName)\\b`,
    },
    {
    ...
    { captures: { 1: { name: `keyword.cern_meta.apacheconf` } }, match: `\\b(MetaDir|MetaFiles|MetaSuffix)\\b` },
    { captures: { 1: { name: `keyword.cgi.apacheconf` } }, match: `\\b(ScriptLog|ScriptLogBuffer|ScriptLogLength)\\b` },
    {
    ...
    { captures: { 1: { name: `keyword.dumpio.apacheconf` } }, match: `\\b(DumpIOInput|DumpIOOutput)\\b` },
    { captures: { 1: { name: `keyword.env.apacheconf` } }, match: `\\b(PassEnv|SetEnv|UnsetEnv)\\b` },
    {
      captures: { 1: { name: `keyword.expires.apacheconf` } },
      match: `\\b(ExpiresActive|ExpiresByType|ExpiresDefault)\\b`,
    },
    { captures: { 1: { name: `keyword.ext_filter.apacheconf` } }, match: `\\b(ExtFilterDefine|ExtFilterOptions)\\b` },
    { captures: { 1: { name: `keyword.file_cache.apacheconf` } }, match: `\\b(CacheFile|MMapFile)\\b` },
    {
      captures: { 1: { name: `keyword.filter.apacheconf` } },
      match: `\\b(AddOutputFilterByType|FilterChain|FilterDeclare|FilterProtocol|FilterProvider|FilterTrace)\\b`,
    },
    { captures: { 1: { name: `keyword.headers.apacheconf` } }, match: `\\b(Header|RequestHeader)\\b` },
    { captures: { 1: { name: `keyword.imap.apacheconf` } }, match: `\\b(ImapBase|ImapDefault|ImapMenu)\\b` },
    {
    ...
    { captures: { 1: { name: `keyword.so.apacheconf` } }, match: `\\b(LoadFile|LoadModule)\\b` },
    {
    ...
    { captures: { 1: { name: `entity.helper.apacheconf` } }, match: `\\b(?i)(export|from|unset|set|on|off)\\b` },
    { captures: { 1: { name: `constant.numeric.integer.decimal.apacheconf` } }, match: `\\b(\\d+)\\b` },
    {
      captures: {
