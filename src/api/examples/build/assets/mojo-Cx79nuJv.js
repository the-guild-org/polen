...
`,
    ...
    'function-modifier': { match: `(raises|capturing)`, name: `storage.modifier` },
    'function-name': {
...
`,
    ...
    'statement-keyword': {
      patterns: [
        { match: `\\b((async\\s+)?\\s*(def|fn))\\b`, name: `storage.type.function.python` },
        {
...
`,
        ...
        { match: `\\b(?<!\\.)(class|struct|trait)\\b`, name: `storage.type.class.python` },
        {
...
`,
        ...
        {
          captures: { 1: { name: `storage.modifier.declaration.python` }, 2: { name: `variable.other.python` } },
...
`,
    ...
    'string-mojo-code-block': {
      begin: '^(\\s*\\`{3,})(mojo)$',
      beginCaptures: { 1: { name: `string.quoted.single.python` }, 2: { name: `string.quoted.single.python` } },
...
`,
    ...
    'string-unicode-guts': {
      patterns: [{ include: `#string-mojo-code-block` }, { include: `#escape-sequence-unicode` }, {
