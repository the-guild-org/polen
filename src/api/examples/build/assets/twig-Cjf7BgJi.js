var e = `Twig`,
  ...
  o = [
    {
      begin: `(<)([a-zA-Z0-9:]++)(?=[^>]*></\\2>)`,
      beginCaptures: { 1: { name: `punctuation.definition.tag.html` }, 2: { name: `entity.name.tag.html` } },
      end: `(>(<)/)(\\2)(>)`,
      endCaptures: {
    ...
    {
      begin: `(<\\?)(xml)`,
      captures: { 1: { name: `punctuation.definition.tag.html` }, 2: { name: `entity.name.tag.xml.html` } },
      end: `(\\?>)`,
      name: `meta.tag.preprocessor.xml.html`,
      patterns: [{ include: `#tag-generic-attribute` }, { include: `#string-double-quoted` }, {
    ...
    },
    {
      ...
      patterns: [{ match: `--`, name: `invalid.illegal.bad-comments-or-CDATA.html` }, { include: `#embedded-code` }],
    },
    {
      begin: `<!`,
      ...
      patterns: [
        {
          ...
          patterns: [{ match: `"[^">]*"`, name: `string.quoted.double.doctype.identifiers-and-DTDs.html` }],
        },
    ...
    {
      begin: `(?:^\\s+)?(<)((?i:script))\\b(?![^>]*/>)`,
      beginCaptures: { 1: { name: `punctuation.definition.tag.html` }, 2: { name: `entity.name.tag.script.html` } },
      end: `(?<=</(script|SCRIPT))(>)(?:\\s*\\n)?`,
      endCaptures: { 2: { name: `punctuation.definition.tag.html` } },
      name: `source.js.embedded.html`,
      patterns: [{ include: `#tag-stuff` }, {
        begin: `(?<!</(?:script|SCRIPT))(>)`,
        captures: { 1: { name: `punctuation.definition.tag.html` }, 2: { name: `entity.name.tag.script.html` } },
        end: `(</)((?i:script))`,
        patterns: [
          {
...
`,
    ...
    },
    {
      ...
      captures: { 1: { name: `punctuation.definition.tag.html` }, 2: { name: `entity.name.tag.structure.any.html` } },
      end: `(>)`,
  ...
  s = {
    ...
    php: { begin: `(?=(^\\s*)?<\\?)`, end: `(?!(^\\s*)?<\\?)`, patterns: [{ include: `source.php` }] },
    python: {
      begin: `(?:^\\s*)<\\?python(?!.*\\?>)`,
      end: `\\?>(?:\\s*$\\n)?`,
...
`,
    ...
    'twig-operators': {
      patterns: [
        ...
        { captures: { 1: { name: `keyword.operator.assignment.twig` } }, match: `(?<=\\s)(=|~)(?=\\s)` },
        { captures: { 1: { name: `keyword.operator.bitwise.twig` } }, match: `(?<=\\s)(b-(?:and|or|xor))(?=\\s)` },
        {
    ...
    'twig-properties': {
      patterns: [{
        captures: { 1: { name: `punctuation.separator.property.twig` }, 2: { name: `variable.other.property.twig` } },
        match: `(?x)
...
`,
    ...
    'twig-strings': {
      patterns: [{
        begin: `(?:(?<!\\\\)|(?<=\\\\\\\\))'`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.twig` } },
        end: `(?:(?<!\\\\)|(?<=\\\\\\\\))'`,
