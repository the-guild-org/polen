var e = `INI`,
  ...
  n = [{
    ...
    captures: { 1: { name: `keyword.other.definition.ini` }, 2: { name: `punctuation.separator.key-value.ini` } },
    match: `\\b([a-zA-Z0-9_.-]+)\\b\\s*(=)`,
  }, {
    captures: { 1: { name: `punctuation.definition.entity.ini` }, 3: { name: `punctuation.definition.entity.ini` } },
    match: `^(\\[)(.*?)(\\])`,
  ...
  r = `source.ini`,
  i = { displayName: `INI`, name: `ini`, patterns: n, scopeName: r }
