var e = `CSS`,
  t = `css`,
  n = [{ include: `#comment-block` }, { include: `#escapes` }, { include: `#combinators` }, { include: `#selector` }, {
    include: `#at-rules`,
  }, { include: `#rule-list` }],
  r = {
    'at-rules': {
...
([^;]+)`,
            ...
            patterns: [{ begin: `(?:\\G|^)(?=(?:[^"])+$)`, end: `$`, name: `invalid.illegal.unclosed.string.css` }],
          }],
        },
        {
          begin: `(?i)((@)import)(?:\\s+|$|(?=['"]|/\\*))`,
          ...
          patterns: [
            { begin: `\\G\\s*(?=/\\*)`, end: `(?<=\\*/)\\s*`, patterns: [{ include: `#comment-block` }] },
            { include: `#string` },
            { include: `#url` },
        ...
        },
        {
          ...
          patterns: [{
            ...
            begin: `{`,
            beginCaptures: { 0: { name: `punctuation.section.media.begin.bracket.curly.css` } },
            end: `}`,
            endCaptures: { 0: { name: `punctuation.section.media.end.bracket.curly.css` } },
...
|\\\\(?:[0-9a-fA-F]{1,6}|.)
            ...
            begin: `{`,
            beginCaptures: { 0: { name: `punctuation.section.property-list.begin.bracket.curly.css` } },
            end: `}`,
            endCaptures: { 0: { name: `punctuation.section.property-list.end.bracket.curly.css` } },
            name: `meta.at-rule.counter-style.body.css`,
            patterns: [{ include: `#comment-block` }, { include: `#escapes` }, { include: `#rule-list-innards` }],
          }],
        },
        {
          begin: `(?i)(?=@document([\\s'"{;]|/\\*|$))`,
            ...
            patterns: [
              {
                ...
                patterns: [{ include: `#string` }, { include: `#comment-block` }, { include: `#escapes` }, {
                  match: `[^'")\\s]+`,
...
|\\\\(?:[0-9a-fA-F]{1,6}|.)
            ...
            begin: `{`,
            beginCaptures: { 0: { name: `punctuation.section.keyframes.begin.bracket.curly.css` } },
            end: `}`,
            endCaptures: { 0: { name: `punctuation.section.keyframes.end.bracket.curly.css` } },
...
([-+]?(?:\\d+(?:\\.\\d+)?|\\.\\d+)%)`,
        ...
        },
        {
          ...
          patterns: [{
            ...
            patterns: [{ include: `#feature-query-operators` }, { include: `#feature-query` }, {
              include: `#comment-block`,
            }, { include: `#escapes` }],
          }, {
            begin: `{`,
            beginCaptures: { 0: { name: `punctuation.section.supports.begin.bracket.curly.css` } },
            end: `}`,
            endCaptures: { 0: { name: `punctuation.section.supports.end.bracket.curly.css` } },
          ...
          patterns: [
            { include: `#url` },
            {
              captures: {
                ...
                2: { name: `entity.name.function.namespace-prefix.css`, patterns: [{ include: `#escapes` }] },
              },
              match: `(?xi)
(?:\\G|^|(?<=\\s))
(?=
...
|\\\\(?:[0-9a-fA-F]{1,6}|.)
        ...
        },
        {
          ...
          patterns: [{
            ...
            begin: `{`,
            beginCaptures: { 0: { name: `punctuation.section.begin.bracket.curly.css` } },
            end: `}`,
            endCaptures: { 0: { name: `punctuation.section.end.bracket.curly.css` } },
...
(?![\\w-])`,
    ...
    combinators: {
      patterns: [{ match: `/deep/|>>>`, name: `invalid.deprecated.combinator.css` }, {
        match: `>>|>|\\+|~`,
    ...
    'feature-query': {
      begin: `\\(`,
      beginCaptures: { 0: { name: `punctuation.definition.condition.begin.bracket.round.css` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.condition.end.bracket.round.css` } },
...
| \\\\(?:[0-9a-fA-F]{1,6}|.)
    ...
    'functional-pseudo-classes': {
      patterns: [{
        ...
        endCaptures: { 0: { name: `punctuation.section.function.end.bracket.round.css` } },
        patterns: [{ match: `(?i)[+-]?(\\d+n?|n)(\\s*[+-]\\s*\\d+)?`, name: `constant.numeric.css` }, {
          match: `(?i)even|odd`,
...
(\\()`,
          ...
          patterns: [{ match: `(?i)(?<![\\w-])(from|to|at|in|hue)(?![\\w-])`, name: `keyword.operator.gradient.css` }, {
            include: `#property-values`,
          }],
        },
        {
...
(\\()`,
        ...
        },
        {
          ...
          patterns: [
            { match: `(?i)(?<![\\w-])(start|end)(?=\\s*\\)|$)`, name: `support.constant.step-direction.css` },
            { include: `#property-values` },
          ],
        },
        {
...
(?=\\s|$|[><:=]|\\)|/\\*)`,
    ...
    'media-query': {
      ...
      patterns: [
        ...
        { include: `#escapes` },
        { include: `#media-types` },
        { match: `(?i)(?<=\\s|^|,|\\*/)(only|not)(?=\\s|{|/\\*|$)`, name: `keyword.operator.logical.$1.media.css` },
        { match: `(?i)(?<=\\s|^|\\*/|\\))and(?=\\s|/\\*|$)`, name: `keyword.operator.logical.and.media.css` },
        { match: `,(?:(?:\\s*,)+|(?=\\s*[;){]))`, name: `invalid.illegal.comma.css` },
        { include: `#commas` },
        {
          begin: `\\(`,
          beginCaptures: { 0: { name: `punctuation.definition.parameters.begin.bracket.round.css` } },
          end: `\\)`,
          endCaptures: { 0: { name: `punctuation.definition.parameters.end.bracket.round.css` } },
          patterns: [
    ...
    'media-types': {
      captures: { 1: { name: `support.constant.media.css` }, 2: { name: `invalid.deprecated.constant.media.css` } },
      match: `(?xi)
(?<=^|\\s|,|\\*/)
(?:
...
(?![\\w-])`,
        ...
        match:
          `(?<![\\w-])(?i:arial|century|comic|courier|garamond|georgia|helvetica|impact|lucida|symbol|system-ui|system|tahoma|times|trebuchet|ui-monospace|ui-rounded|ui-sans-serif|ui-serif|utopia|verdana|webdings|sans-serif|serif|monospace)(?![\\w-])`,
...
(?![\\w-]|\\s*[;}])`,
    ...
    'rule-list-innards': {
      patterns: [{ include: `#comment-block` }, { include: `#escapes` }, { include: `#font-features` }, {
        match: `(?x) (?<![\\w-])
--
(?:[-a-zA-Z_]    | [^\\x00-\\x7F])
(?:[-a-zA-Z0-9_] | [^\\x00-\\x7F]
...
(?:[0-9a-fA-F]{1,6}|.)
    ...
    'selector-innards': {
      patterns: [
        ...
        { include: `#combinators` },
        {
          captures: { 1: { name: `entity.other.namespace-prefix.css` }, 2: { name: `punctuation.separator.css` } },
          match: `(?x)
(?:^|(?<=[\\s,(};]))
(?!
[-\\w*]+
...
(\\|)`,
        ...
        {
          captures: { 1: { name: `punctuation.definition.entity.css` }, 2: { patterns: [{ include: `#escapes` }] } },
          match: `(?x) (?<![@\\w-])
([.\\#])
# Invalid identifier
(
...
(?=$|[\\s,.\\#)\\[:{>+~|]|/\\*)`,
        ...
        },
        {
          ...
          patterns: [
            ...
            {
              captures: { 1: { name: `string.unquoted.attribute-value.css`, patterns: [{ include: `#escapes` }] } },
              match: `(?x)(?<==)\\s*((?!/\\*)(?:[^\\\\"'\\s\\]]|\\\\.)+)`,
            },
            { include: `#escapes` },
            ...
            {
              captures: { 1: { name: `entity.other.namespace-prefix.css`, patterns: [{ include: `#escapes` }] } },
              match: `(?x)
...
|   [^\\x00-\\x7F]
            ...
            {
              captures: { 1: { name: `entity.other.attribute-name.css`, patterns: [{ include: `#escapes` }] } },
              match: `(?x)
(-?(?!\\d)(?>[\\w-]|[^\\x00-\\x7F]|\\\\(?:[0-9a-fA-F]{1,6}|.))+)
\\s*
(?=[~|^\\]$*=]|/\\*)`,
...
(?=[+~>\\s,.\\#|){:\\[]|/\\*|$)`,
    ...
    url: {
      ...
      patterns: [{ match: `[^'")\\s]+`, name: `variable.parameter.url.css` }, { include: `#string` }, {
        include: `#comment-block`,
      }, { include: `#escapes` }],
    },
  },
  i = `source.css`,
  a = { displayName: `CSS`, name: `css`, patterns: n, repository: r, scopeName: i }
