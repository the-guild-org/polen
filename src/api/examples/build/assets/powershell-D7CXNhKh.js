var e = `PowerShell`,
  ...
  n = [
    {
      begin: `<#`,
      beginCaptures: { 0: { name: `punctuation.definition.comment.block.begin.powershell` } },
      end: `#>`,
      endCaptures: { 0: { name: `punctuation.definition.comment.block.end.powershell` } },
      name: `comment.block.powershell`,
      patterns: [{ include: `#commentEmbeddedDocs` }],
    },
    { match: `[2-6]>&1|>>|>|<<|<|>|>\\||[1-6]>|[1-6]>>`, name: `keyword.operator.redirection.powershell` },
    { include: `#commands` },
    { include: `#commentLine` },
    { include: `#variable` },
    ...
    },
    {
      ...
      begin: `['\\x{2018}-\\x{201B}]`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.powershell` } },
      end: `['\\x{2018}-\\x{201B}]`,
      endCaptures: { 0: { name: `punctuation.definition.string.end.powershell` } },
      name: `string.quoted.single.powershell`,
      patterns: [{ match: `['\\x{2018}-\\x{201B}]{2}`, name: `constant.character.escape.powershell` }],
    },
    {
      begin: `(@["\\x{201C}-\\x{201E}])\\s*$`,
      beginCaptures: { 1: { name: `punctuation.definition.string.begin.powershell` } },
      end: `^["\\x{201C}-\\x{201E}]@`,
      endCaptures: { 0: { name: `punctuation.definition.string.end.powershell` } },
      name: `string.quoted.double.heredoc.powershell`,
      patterns: [{ include: `#variableNoProperty` }, { include: `#doubleQuotedStringEscapes` }, {
    ...
    { include: `#numericConstant` },
    {
      begin: `(@)(\\()`,
      beginCaptures: {
        1: { name: `keyword.other.array.begin.powershell` },
        2: { name: `punctuation.section.group.begin.powershell` },
      },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.section.group.end.powershell` } },
    ...
    },
    {
      ...
      beginCaptures: {
        ...
        2: { name: `punctuation.definition.subexpression.powershell` },
        3: { name: `punctuation.section.group.begin.powershell` },
      },
    ...
    { match: `(\\b(([A-Za-z0-9\\-_\\.]+)\\.(?i:exe|com|cmd|bat))\\b)`, name: `support.function.powershell` },
    {
      match:
    ...
    { match: `(?<!\\w|-|[^\\)]\\.)((?i:(foreach|where)(?!-object))|%|\\?)(?!\\w)`, name: `keyword.control.powershell` },
    {
      begin: `(?<!\\w)(--%)(?!\\w)`,
      beginCaptures: { 1: { name: `keyword.control.powershell` } },
      comment: `This should be moved to the repository at some point.`,
      end: `$`,
      patterns: [{ match: `.+`, name: `string.unquoted.powershell` }],
    },
    {
      comment:
    ...
    {
      captures: { 1: { name: `storage.type.powershell` }, 2: { name: `entity.name.function` } },
    ...
    { match: `(?<!\\w)-(?i:is(?:not)?|as)\\b`, name: `keyword.operator.comparison.powershell` },
    {
      match: `(?<!\\w)-(?i:[ic]?(?:eq|ne|[gl][te]|(?:not)?(?:like|match|contains|in)|replace))(?!\\p{L})`,
      name: `keyword.operator.comparison.powershell`,
    },
    { match: `(?<!\\w)-(?i:join|split)(?!\\p{L})|!`, name: `keyword.operator.unary.powershell` },
    { match: `(?<!\\w)-(?i:and|or|not|xor)(?!\\p{L})|!`, name: `keyword.operator.logical.powershell` },
    { match: `(?<!\\w)-(?i:band|bor|bnot|bxor|shl|shr)(?!\\p{L})`, name: `keyword.operator.bitwise.powershell` },
    { match: `(?<!\\w)-(?i:f)(?!\\p{L})`, name: `keyword.operator.string-format.powershell` },
    { match: `[+%*/-]?=|[+/*%-]`, name: `keyword.operator.assignment.powershell` },
    { match: `\\|{2}|&{2}|;`, name: `punctuation.terminator.statement.powershell` },
    { match: '&|(?<!\\w)\\.(?= )|`|,|\\|', name: `keyword.operator.other.powershell` },
    {
  ...
  r = {
    RequiresDirective: {
      begin: `(?<=#)(?i:(requires))\\s`,
      beginCaptures: { 0: { name: `keyword.control.requires.powershell` } },
      end: `$`,
      ...
      patterns: [
        ...
        { match: `(?<!-)\\b\\p{L}+|\\d+(?:\\.\\d+)*`, name: `variable.parameter.powershell` },
        { include: `#hashtable` },
      ],
    },
    UsingDirective: {
      captures: {
        1: { name: `keyword.control.using.powershell` },
        2: { name: `keyword.other.powershell` },
        3: { name: `variable.parameter.powershell` },
      },
    ...
    attribute: {
      ...
      beginCaptures: {
        1: { name: `punctuation.section.bracket.begin.powershell` },
        2: { name: `support.function.attribute.powershell` },
      },
      end: `(\\])`,
      endCaptures: { 1: { name: `punctuation.section.bracket.end.powershell` } },
      name: `meta.attribute.powershell`,
      patterns: [{
        begin: `\\(`,
        beginCaptures: { 0: { name: `punctuation.section.group.begin.powershell` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.section.group.end.powershell` } },
        patterns: [{ include: `$self` }, {
          captures: {
            1: { name: `variable.parameter.attribute.powershell` },
            2: { name: `keyword.operator.assignment.powershell` },
          },
          match:
    ...
    commentLine: {
      begin: '(?<![`\\\\-])(#)#*',
      captures: { 1: { name: `punctuation.definition.comment.powershell` } },
      end: `$\\n?`,
      name: `comment.line.powershell`,
      patterns: [{ include: `#commentEmbeddedDocs` }, { include: `#RequiresDirective` }],
    },
    doubleQuotedString: {
      applyEndPatternLast: !0,
      begin: `["\\x{201C}-\\x{201E}]`,
      ...
      patterns: [
        ...
        { include: `#doubleQuotedStringEscapes` },
        { match: `["\\x{201C}-\\x{201E}]{2}`, name: `constant.character.escape.powershell` },
        { include: `#interpolation` },
        { match: '`\\s*$', name: `keyword.other.powershell` },
      ],
    },
    doubleQuotedStringEscapes: {
      patterns: [{ match: '`[`0abefnrtv\'"\\x{2018}-\\x{201E}$]', name: `constant.character.escape.powershell` }, {
    ...
    function: {
      ...
      beginCaptures: {
        0: { name: `meta.function.powershell` },
        1: { name: `storage.type.powershell` },
        2: { name: `storage.modifier.scope.powershell` },
        3: { name: `entity.name.function.powershell` },
      },
      end: `(?=\\{|\\()`,
      patterns: [{ include: `#commentLine` }],
    },
    hashtable: {
      begin: `(@)(\\{)`,
      beginCaptures: {
        1: { name: `keyword.other.hashtable.begin.powershell` },
        2: { name: `punctuation.section.braces.begin.powershell` },
      },
      end: `(\\})`,
      endCaptures: { 1: { name: `punctuation.section.braces.end.powershell` } },
      name: `meta.hashtable.powershell`,
      patterns: [
        {
          captures: {
            1: { name: `punctuation.definition.string.begin.powershell` },
            2: { name: `variable.other.readwrite.powershell` },
            3: { name: `punctuation.definition.string.end.powershell` },
            4: { name: `keyword.operator.assignment.powershell` },
          },
          match: `\\b((?:\\'|\\")?)(\\w+)((?:\\'|\\")?)(?:\\s+)?(=)(?:\\s+)?`,
    ...
    interpolation: {
      ...
      beginCaptures: {
        ...
        3: { name: `punctuation.section.embedded.substatement.begin.powershell` },
        4: { name: `punctuation.section.group.begin.powershell` },
        5: { name: `punctuation.section.embedded.substatement.begin.powershell` },
      },
      contentName: `interpolated.complex.source.powershell`,
      end: `(\\))`,
      endCaptures: {
        0: { name: `punctuation.section.group.end.powershell` },
        1: { name: `punctuation.section.embedded.substatement.end.powershell` },
      },
    ...
    numericConstant: {
      patterns: [{
        captures: { 1: { name: `constant.numeric.hex.powershell` }, 2: { name: `keyword.other.powershell` } },
        match: `(?<!\\w)([-+]?0(?:x|X)[0-9a-fA-F_]+(?:U|u|L|l|UL|Ul|uL|ul|LU|Lu|lU|lu)?)((?i:[kmgtp]b)?)\\b`,
      }, {
        captures: { 1: { name: `constant.numeric.integer.powershell` }, 2: { name: `keyword.other.powershell` } },
        match: `(?<!\\w)([-+]?(?:[0-9_]+)?\\.[0-9_]+(?:(?:e|E)[0-9]+)?(?:F|f|D|d|M|m)?)((?i:[kmgtp]b)?)\\b`,
      }, {
        captures: { 1: { name: `constant.numeric.octal.powershell` }, 2: { name: `keyword.other.powershell` } },
    ...
    scriptblock: {
      begin: `\\{`,
      beginCaptures: { 0: { name: `punctuation.section.braces.begin.powershell` } },
      end: `\\}`,
      endCaptures: { 0: { name: `punctuation.section.braces.end.powershell` } },
    ...
    type: {
      begin: `\\[`,
      beginCaptures: { 0: { name: `punctuation.section.bracket.begin.powershell` } },
      end: `\\]`,
      endCaptures: { 0: { name: `punctuation.section.bracket.end.powershell` } },
      patterns: [{ match: `(?!\\d+|\\.)(?:\\p{L}|\\p{N}|\\.)+`, name: `storage.type.powershell` }, {
        include: `$self`,
      }],
    },
    unicodeEscape: {
    ...
    variable: {
      patterns: [{
        captures: {
          0: { name: `constant.language.powershell` },
        ...
        captures: {
          0: { name: `support.variable.automatic.powershell` },
          1: { name: `punctuation.definition.variable.powershell` },
          3: { name: `variable.other.member.powershell` },
        },
        comment:
        ...
        captures: {
          0: { name: `variable.language.powershell` },
          1: { name: `punctuation.definition.variable.powershell` },
          3: { name: `variable.other.member.powershell` },
        },
        ...
        captures: {
          0: { name: `variable.other.readwrite.powershell` },
          1: { name: `punctuation.definition.variable.powershell` },
          2: { name: `storage.modifier.scope.powershell` },
          4: { name: `variable.other.member.powershell` },
        },
        match:
        ...
        captures: {
          ...
          5: { name: `punctuation.section.braces.end.powershell` },
          6: { name: `variable.other.member.powershell` },
        },
        match:
        ...
        captures: {
          ...
          1: { name: `punctuation.definition.variable.powershell` },
          2: { name: `punctuation.section.braces.begin.powershell` },
          3: { name: `support.variable.drive.powershell` },
          5: { name: `punctuation.section.braces.end.powershell` },
          6: { name: `variable.other.member.powershell` },
        },
    ...
    variableNoProperty: {
      patterns: [{
        ...
        captures: {
          ...
          5: { name: `variable.other.member.powershell` },
        },
        ...
        captures: {
          ...
          3: { name: `support.variable.drive.powershell` },
          5: { name: `punctuation.section.braces.end` },
        },
        match: '(?i:(\\$)(\\{)((?:\\p{L}|\\d|_)+:)?([^}]*[^}`])(\\}))',
      }],
    },
