var e = `Haxe`,
  ...
  i = {
    abstract: {
      ...
      patterns: [{ include: `#abstract-name` }, { include: `#abstract-name-post` }, { include: `#abstract-block` }],
    },
    'abstract-block': {
      begin: `(?<=\\{)`,
      end: `(\\})`,
      ...
      name: `meta.block.hx`,
      patterns: [{ include: `#method` }, { include: `#modifiers` }, { include: `#variable` }, { include: `#block` }, {
    ...
    'abstract-name-post': {
      ...
      patterns: [{ include: `#global` }, { match: `\\b(from|to)\\b`, name: `keyword.other.hx` }, { include: `#type` }, {
        match: `[\\(\\)]`,
        name: `punctuation.definition.other.hx`,
      }],
    },
    'accessor-method': { patterns: [{ match: `\\b(get|set)_[_A-Za-z]\\w*\\b`, name: `entity.name.function.hx` }] },
    all: {
      patterns: [
        { include: `#global` },
        { include: `#package` },
        { include: `#import` },
        { include: `#using` },
        { match: `\\b(final)\\b(?=\\s+(class|interface|extern|private)\\b)`, name: `storage.modifier.hx` },
        { include: `#abstract` },
        { include: `#class` },
        { include: `#enum` },
        { include: `#interface` },
    ...
    array: {
      begin: `\\[`,
      beginCaptures: { 0: { name: `punctuation.definition.array.begin.hx` } },
      end: `\\]`,
    ...
    'arrow-function': {
      begin: `(\\()(?=[^(]*?\\)\\s*->)`,
      beginCaptures: { 1: { name: `punctuation.definition.parameters.begin.hx` } },
      end: `(\\))\\s*(->)`,
      endCaptures: {
    ...
    'arrow-function-parameter-type-hint': {
      begin: `:`,
      beginCaptures: { 0: { name: `keyword.operator.type.annotation.hx` } },
      end: `(?=\\)|,|=)`,
      patterns: [{ include: `#type` }],
    },
    block: {
      begin: `\\{`,
      beginCaptures: { 0: { name: `punctuation.definition.block.begin.hx` } },
      end: `\\}`,
    ...
    class: {
      ...
      endCaptures: { 1: { name: `punctuation.terminator.hx` } },
      name: `meta.class.hx`,
      patterns: [{ include: `#class-name` }, { include: `#class-name-post` }, { include: `#class-block` }],
    },
    'class-block': {
      begin: `(?<=\\{)`,
      end: `(\\})`,
    ...
    'class-name-post': {
      ...
      endCaptures: { 1: { name: `punctuation.definition.block.begin.hx` } },
      patterns: [{ include: `#modifiers-inheritance` }, { include: `#type` }],
    },
    comments: {
      patterns: [{
        begin: `/\\*\\*(?!/)`,
        beginCaptures: { 0: { name: `punctuation.definition.comment.hx` } },
        end: `\\*/`,
        endCaptures: { 0: { name: `punctuation.definition.comment.hx` } },
    ...
    'conditional-compilation': {
      patterns: [
        ...
        { match: `(#(end|else|error|line))`, name: `punctuation.definition.tag` },
        { match: `(#([a-zA-Z0-9_]*))\\s`, name: `punctuation.definition.tag` },
      ],
    },
    ...
    'constant-name': { match: `\\b([_A-Z][_A-Z0-9]*)\\b`, name: `variable.other.hx` },
    constants: {
      patterns: [{ match: `\\b(true|false|null)\\b`, name: `constant.language.hx` }, {
        captures: { 0: { name: `constant.numeric.hex.hx` }, 1: { name: `constant.numeric.suffix.hx` } },
        match: `\\b(?:0[xX][0-9a-fA-F][_0-9a-fA-F]*([iu][0-9][0-9_]*)?)\\b`,
      }, {
        captures: { 0: { name: `constant.numeric.bin.hx` }, 1: { name: `constant.numeric.suffix.hx` } },
...
(?:\\b[0-9][0-9_]*([fiu][0-9][0-9_]*)?\\b)
    ...
    enum: {
      ...
      endCaptures: { 1: { name: `punctuation.terminator.hx` } },
      name: `meta.enum.hx`,
      patterns: [{ include: `#enum-name` }, { include: `#enum-name-post` }, { include: `#enum-block` }],
    },
    'enum-block': {
      begin: `(?<=\\{)`,
      end: `(\\})`,
      endCaptures: { 1: { name: `punctuation.definition.block.end.hx` } },
      name: `meta.block.hx`,
      patterns: [{ include: `#global` }, { include: `#metadata` }, { include: `#parameters` }, {
        include: `#identifiers`,
      }],
    },
    ...
    'for-loop': {
      begin: `\\b(for)\\b\\s*(\\()`,
      beginCaptures: { 1: { name: `keyword.control.flow-control.hx` }, 2: { name: `meta.brace.round.hx` } },
      end: `(\\))`,
      endCaptures: { 1: { name: `meta.brace.round.hx` } },
      patterns: [{ match: `\\b(in)\\b`, name: `keyword.other.in.hx` }, { include: `#block` }, {
        include: `#block-contents`,
      }],
    },
    'function-type': {
      begin: `\\(`,
      beginCaptures: { 0: { name: `punctuation.definition.parameters.begin.hx` } },
      end: `\\)`,
      endCaptures: { 0: { name: `punctuation.definition.parameters.end.hx` } },
    ...
    global: { patterns: [{ include: `#comments` }, { include: `#conditional-compilation` }] },
    'identifier-name': { match: `\\b([_A-Za-z]\\w*)\\b`, name: `variable.other.hx` },
    identifiers: {
      patterns: [{ include: `#constant-name` }, { include: `#type-name` }, { include: `#identifier-name` }],
    },
    import: {
      begin: `import\\b`,
      ...
      patterns: [
        ...
        { match: `\\b([_A-Za-z]\\w*)\\b(?=\\s*(as|in|$|(;)))`, name: `variable.other.hxt` },
    ...
    interface: {
      ...
      patterns: [{ include: `#interface-name` }, { include: `#interface-name-post` }, { include: `#interface-block` }],
    },
    'interface-block': {
      begin: `(?<=\\{)`,
      end: `(\\})`,
      endCaptures: { 1: { name: `punctuation.definition.block.end.hx` } },
      name: `meta.block.hx`,
      patterns: [{ include: `#method` }, { include: `#variable` }, { include: `#block` }, {
        include: `#block-contents`,
      }],
    },
    'interface-name': {
    ...
    'interface-name-post': {
      ...
      endCaptures: { 1: { name: `punctuation.definition.block.begin.hx` } },
      patterns: [{ include: `#global` }, { include: `#modifiers-inheritance` }, { include: `#type` }],
    },
    'javadoc-tags': {
      patterns: [{
        captures: { 1: { name: `storage.type.class.javadoc` }, 2: { name: `variable.other.javadoc` } },
        match: `(@(?:param|exception|throws|event))\\s+([_A-Za-z]\\w*)\\s+`,
      }, {
        captures: { 1: { name: `storage.type.class.javadoc` }, 2: { name: `constant.numeric.javadoc` } },
        match: `(@since)\\s+([\\w\\.-]+)\\s+`,
      }, {
    ...
    keywords: {
      patterns: [
        ...
        },
        {
          ...
          endCaptures: { 0: { name: `meta.brace.round.hx` } },
          patterns: [{ begin: `(?=,)`, end: `(?=\\))`, patterns: [{ include: `#type` }] }, {
            include: `#block-contents`,
          }],
        },
        { match: `\\b(try|catch|throw)\\b`, name: `keyword.control.catch-exception.hx` },
        {
          begin: `\\b(case|default)\\b`,
          beginCaptures: { 1: { name: `keyword.control.flow-control.hx` } },
          end: `:|(?=if)|$`,
          patterns: [
            { include: `#global` },
            { include: `#metadata` },
            {
              captures: { 1: { name: `storage.type.variable.hx` }, 2: { name: `variable.other.hx` } },
        ...
        { match: `\\__(global|this)__\\b`, name: `keyword.other.untyped-property.hx` },
        { match: `\\b(this|super)\\b`, name: `variable.language.hx` },
        { match: `\\bnew\\b`, name: `keyword.operator.new.hx` },
        { match: `\\b(abstract|class|enum|interface|typedef)\\b`, name: `storage.type.hx` },
        { match: `->`, name: `storage.type.function.arrow.hx` },
        { include: `#modifiers` },
        { include: `#modifiers-inheritance` },
      ],
    },
    'keywords-accessor': { match: `\\b(default|get|set|dynamic|never|null)\\b`, name: `storage.type.property.hx` },
    'macro-reification': {
      patterns: [{
        captures: { 1: { name: `punctuation.definition.reification.hx` }, 2: { name: `keyword.reification.hx` } },
        match: `(\\$)([eabipv])\\{`,
      }, {
        captures: { 2: { name: `punctuation.definition.reification.hx` }, 3: { name: `variable.reification.hx` } },
        match: `((\\$)([a-zA-Z]*))`,
      }],
    },
    metadata: {
      patterns: [{
        ...
        captures: { 2: { name: `punctuation.metadata.hx` }, 3: { name: `storage.modifier.metadata.hx` } },
        match:
    ...
    method: {
      ...
      name: `meta.method.hx`,
      patterns: [{ include: `#macro-reification` }, { include: `#method-name` }, { include: `#method-name-post` }, {
        include: `#method-block`,
      }],
    },
    'method-block': {
      begin: `(?<=\\{)`,
      beginCaptures: { 1: { name: `punctuation.definition.block.begin.hx` } },
      end: `(\\})`,
      endCaptures: { 1: { name: `punctuation.definition.block.end.hx` } },
    ...
    'method-name-post': {
      ...
      endCaptures: { 1: { name: `punctuation.definition.block.begin.hx` }, 2: { name: `punctuation.terminator.hx` } },
      patterns: [{ include: `#parameters` }, { include: `#method-return-type-hint` }, { include: `#block` }, {
        include: `#block-contents`,
      }],
    },
    ...
    modifiers: {
      patterns: [{ match: `\\b(enum)\\b`, name: `storage.type.class` }, {
        match: `\\b(public|private|static|dynamic|inline|macro|extern|override|overload|abstract)\\b`,
        name: `storage.modifier.hx`,
      }, {
        match:
          `\\b(final)\\b(?=\\s+(public|private|static|dynamic|inline|macro|extern|override|overload|abstract|function))`,
        name: `storage.modifier.hx`,
      }],
    },
    'modifiers-inheritance': { match: `\\b(implements|extends)\\b`, name: `storage.modifier.hx` },
    'new-expr': {
      begin: `(?<!\\.)\\b(new)\\b`,
    ...
    'operator-assignment': { match: `(=)`, name: `keyword.operator.assignment.hx` },
    'operator-optional': { match: `(\\?)(?!\\s)`, name: `keyword.operator.optional.hx` },
    'operator-type-hint': { match: `(:)`, name: `keyword.operator.type.annotation.hx` },
    operators: {
      patterns: [
        { match: `(&&|\\|\\|)`, name: `keyword.operator.logical.hx` },
        { match: `(~|&|\\||\\^|>>>|<<|>>)`, name: `keyword.operator.bitwise.hx` },
        { match: `(==|!=|<=|>=|<|>)`, name: `keyword.operator.comparison.hx` },
        { match: `(!)`, name: `keyword.operator.logical.hx` },
        { match: `(\\-\\-|\\+\\+)`, name: `keyword.operator.increment-decrement.hx` },
    ...
    package: {
      ...
      endCaptures: { 1: { name: `punctuation.terminator.hx` } },
      patterns: [{ include: `#type-path` }, { include: `#type-path-package-name` }],
    },
    parameter: {
      begin: `(?<=\\(|,)`,
      end: `(?=\\)(?!\\s*->)|,)`,
    ...
    'parameter-name': {
      ...
      patterns: [{ include: `#global` }, { include: `#metadata` }, { include: `#operator-optional` }],
    },
    'parameter-type-hint': {
      begin: `:`,
      beginCaptures: { 0: { name: `keyword.operator.type.annotation.hx` } },
    ...
    'punctuation-braces': {
      ...
      endCaptures: { 0: { name: `meta.brace.round.hx` } },
      patterns: [{ include: `#keywords` }, { include: `#block` }, { include: `#block-contents` }, {
        include: `#type-check`,
      }],
    },
    'punctuation-comma': { match: `,`, name: `punctuation.separator.comma.hx` },
    'punctuation-terminator': { match: `;`, name: `punctuation.terminator.hx` },
    regex: {
      begin: `(~/)`,
      beginCaptures: { 1: { name: `punctuation.definition.string.begin.hx` } },
      end: `(/)([gimsu]*)`,
      endCaptures: { 1: { name: `punctuation.definition.string.end.hx` }, 2: { name: `keyword.other.hx` } },
    ...
    'string-escape-sequences': {
      patterns: [
        { match: `\\\\[0-3][0-9]{2}`, name: `constant.character.escape.hx` },
        { match: `\\\\x[0-9A-Fa-f]{2}`, name: `constant.character.escape.hx` },
        { match: `\\\\u[0-9]{4}`, name: `constant.character.escape.hx` },
        { match: `\\\\u\\{[0-9A-Fa-f]{1,}\\}`, name: `constant.character.escape.hx` },
    ...
    strings: {
      patterns: [{
        begin: `"`,
        beginCaptures: { 0: { name: `punctuation.definition.string.begin.hx` } },
        end: `"`,
        endCaptures: { 0: { name: `punctuation.definition.string.end.hx` } },
        ...
        endCaptures: { 0: { name: `string.quoted.single.hx` }, 1: { name: `punctuation.definition.string.end.hx` } },
        patterns: [
          {
            begin: `\\$(?=\\$)`,
            beginCaptures: { 0: { name: `constant.character.escape.hx` } },
            end: `\\$`,
            endCaptures: { 0: { name: `constant.character.escape.hx` } },
          ...
          {
            captures: { 1: { name: `punctuation.definition.block.begin.hx` }, 2: { name: `variable.other.hx` } },
            match: `(\\$)([_a-zA-Z]\\w*)`,
          },
    ...
    'type-parameter-constraint-new': { match: `:`, name: `keyword.operator.type.annotation.hxt` },
    'type-parameter-constraint-old': {
      ...
      endCaptures: { 0: { name: `punctuation.definition.constraint.end.hx` } },
      patterns: [{ include: `#type` }, { include: `#punctuation-comma` }],
    },
    'type-parameters': {
      begin: `(<)`,
      beginCaptures: { 1: { name: `punctuation.definition.typeparameters.begin.hx` } },
      end: `(?=$)|(>)`,
      endCaptures: { 1: { name: `punctuation.definition.typeparameters.end.hx` } },
    ...
    'type-path': {
      patterns: [{ include: `#global` }, { include: `#punctuation-accessor` }, { include: `#type-path-type-name` }],
    },
    'type-path-package-name': { match: `\\b([_A-Za-z]\\w*)\\b`, name: `support.package.hx` },
    'type-path-type-name': { match: `\\b(_*[A-Z]\\w*)\\b`, name: `entity.name.type.hx` },
    typedef: {
      begin: `(?=typedef)`,
      end: `(?<=\\})|(;)`,
      endCaptures: { 1: { name: `punctuation.terminator.hx` } },
      name: `meta.typedef.hx`,
      patterns: [{ include: `#typedef-name` }, { include: `#typedef-name-post` }, { include: `#typedef-block` }],
    },
    'typedef-block': {
      begin: `(?<=\\{)`,
      end: `(\\})`,
    ...
    'typedef-extension': { begin: `>`, end: `,|$`, patterns: [{ include: `#type` }] },
    'typedef-name': {
      begin: `\\b(typedef)\\b`,
      beginCaptures: { 1: { name: `storage.type.class.hx` } },
      end: `([_A-Za-z]\\w*)`,
    ...
    'typedef-name-post': {
      ...
      endCaptures: { 1: { name: `punctuation.definition.block.begin.hx` } },
      patterns: [{ include: `#global` }, { include: `#punctuation-brackets` }, { include: `#punctuation-separator` }, {
        include: `#operator-assignment`,
      }, { include: `#type` }],
    },
    ...
    variable: {
      ...
      endCaptures: { 1: { name: `punctuation.terminator.hx` } },
      patterns: [{ include: `#variable-name` }, { include: `#variable-name-next` }, { include: `#variable-assign` }, {
    ...
    'variable-accessors': {
      ...
      endCaptures: { 0: { name: `punctuation.definition.parameters.end.hx` } },
      name: `meta.parameters.hx`,
      patterns: [{ include: `#global` }, { include: `#keywords-accessor` }, { include: `#accessor-method` }, {
        include: `#punctuation-comma`,
      }],
    },
    'variable-assign': {
    ...
    'variable-name-post': {
      ...
      patterns: [{ include: `#variable-accessors` }, { include: `#variable-type-hint` }, {
        include: `#block-contents`,
      }],
    },
    'variable-type-hint': {
