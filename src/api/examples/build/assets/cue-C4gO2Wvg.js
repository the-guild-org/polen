var e = `CUE`,
  ...
  r = [
    ...
    { include: `#comment` },
    {
      captures: { 1: { name: `keyword.other.package` }, 2: { name: `entity.name.namespace` } },
      match:
    ...
    },
    {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `keyword.other.import` }, 2: { name: `punctuation.section.parens.begin` } },
        end: `\\)`,
  ...
  i = {
    attribute_element: {
      patterns: [{
        ...
        beginCaptures: { 1: { name: `variable.other` }, 2: { name: `punctuation.bind` } },
        end: `(?=[,\\)])`,
        patterns: [{ include: `#attribute_string` }],
      }, {
        begin: `([\\p{L}\\$\\#][\\p{L}\\p{Nd}_\\$\\#]*|_[\\p{L}\\p{Nd}_\\$\\#]+)(\\()`,
        beginCaptures: { 1: { name: `variable.other` }, 2: { name: `punctuation.attribute-elements.begin` } },
        end: `\\)`,
        endCaptures: { 0: { name: `punctuation.attribute-elements.end` } },
        patterns: [{ include: `#punctuation_comma` }, { include: `#attribute_element` }],
      }, { include: `#attribute_string` }],
    },
    attribute_string: {
      patterns: [{ include: `#string` }, { match: `[^\\n,"'#=\\(\\)]+`, name: `string.unquoted` }, {
        match: `[^,\\)]+`,
        name: `invalid`,
      }],
    },
    ...
    expression: {
      patterns: [{
        patterns: [
          ...
          { match: `(?<![\\p{L}\\p{Nd}_\\$\\#])if(?![\\p{L}\\p{Nd}_\\$\\#])`, name: `keyword.control.conditional` },
          {
            captures: {
        ...
        captures: { 1: { name: `punctuation.accessor` }, 2: { name: `variable.other.member` } },
        match:
          `(?<!\\.)(\\.)([\\p{L}\\$\\#][\\p{L}\\p{Nd}_\\$\\#]*|_[\\p{L}\\p{Nd}_\\$\\#]+)(?![\\p{L}\\p{Nd}_\\$\\#])`,
      }, {
        patterns: [
          { match: `(?<![\\p{L}\\p{Nd}_\\$\\#])_(?!\\|)(?![\\p{L}\\p{Nd}_\\$\\#])`, name: `constant.language.top` },
          { match: `(?<![\\p{L}\\p{Nd}_\\$\\#])_\\|_(?![\\p{L}\\p{Nd}_\\$\\#])`, name: `constant.language.bottom` },
          { match: `(?<![\\p{L}\\p{Nd}_\\$\\#])null(?![\\p{L}\\p{Nd}_\\$\\#])`, name: `constant.language.null` },
          {
          ...
          },
          {
            patterns: [{
              ...
              beginCaptures: { 1: { name: `support.function` }, 2: { name: `punctuation.section.parens.begin` } },
              end: `\\)`,
              endCaptures: { 0: { name: `punctuation.section.parens.end` } },
              name: `meta.function-call`,
              patterns: [{ include: `#whitespace` }, { include: `#comment` }, { include: `#punctuation_comma` }, {
                include: `#expression`,
              }, { include: `#invalid_in_parens` }],
            }, {
              begin:
          ...
          },
          {
            ...
            patterns: [
              ...
              { include: `#punctuation_ellipsis` },
              {
                captures: { 1: { name: `variable.other` }, 2: { name: `punctuation.alias` } },
    ...
    punctuation_ellipsis: { match: `(?<!\\.)\\.{3}(?!\\.)`, name: `punctuation.ellipsis` },
    string: {
      patterns: [{
        begin: `#"""`,
        ...
        name: `meta.string`,
        patterns: [
          { match: `\\\\#(?:"""|/|\\\\|[abfnrtv]|u[0-9A-Fa-f]{4}|U[0-9A-Fa-f]{8})`, name: `constant.character.escape` },
          { match: `\\\\#(?:[0-7]{3}|x[0-9A-Fa-f]{2})`, name: `invalid.illegal` },
          {
            begin: `\\\\#\\(`,
            ...
            patterns: [{ include: `#whitespace` }, { include: `#expression` }, { include: `#invalid_in_parens` }],
          },
        ...
        patterns: [
          { match: `\\\\#(?:'''|/|\\\\|[abfnrtv]|u[0-9A-Fa-f]{4}|U[0-9A-Fa-f]{8})`, name: `constant.character.escape` },
          { match: `\\\\#(?:[0-7]{3}|x[0-9A-Fa-f]{2})`, name: `constant.character.escape` },
          {
            begin: `\\\\#\\(`,
            beginCaptures: { 0: { name: `punctuation.section.interpolation.begin` } },
            contentName: `source.cue.embedded`,
  ...
  a = `source.cue`,
  o = { displayName: `CUE`, fileTypes: t, name: `cue`, patterns: r, repository: i, scopeName: a }
