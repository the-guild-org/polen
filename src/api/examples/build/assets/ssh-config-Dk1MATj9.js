var e = `SSH Config`,
  ...
  r = [
    ...
    { match: `\\b(yes|no)\\b`, name: `constant.language.ssh-config` },
    { match: `\\b[A-Z_]+\\b`, name: `constant.language.ssh-config` },
  ],
  i = `source.ssh-config`,
