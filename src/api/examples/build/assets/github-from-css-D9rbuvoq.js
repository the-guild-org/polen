var e = `github-from-css`,
  t = `from-css`,
  n = [
    { scope: [`comment`, `punctuation.definition.comment`, `string.comment`], settings: { foreground: `var(--ch-1)` } },
    {
      scope: [
        `constant`,
    ...
    { scope: [`entity.name.tag`, `support.class.component`], settings: { foreground: `var(--ch-6)` } },
    { scope: `keyword`, settings: { foreground: `var(--ch-7)` } },
    { scope: [`storage`, `storage.type`], settings: { foreground: `var(--ch-7)` } },
    {
      scope: [`storage.modifier.package`, `storage.modifier.import`, `storage.type.java`],
      settings: { foreground: `var(--ch-4)` },
    },
    { scope: [`string`, `string punctuation.section.embedded source`], settings: { foreground: `var(--ch-8)` } },
    ...
    { scope: `invalid.broken`, settings: { foreground: `var(--ch-9)`, fontStyle: `italic` } },
    { scope: `invalid.deprecated`, settings: { foreground: `var(--ch-9)`, fontStyle: `italic` } },
    { scope: `invalid.illegal`, settings: { foreground: `var(--ch-9)`, fontStyle: `italic` } },
    { scope: `invalid.unimplemented`, settings: { foreground: `var(--ch-9)`, fontStyle: `italic` } },
    {
      scope: `carriage-return`,
      settings: { background: `var(--ch-7)`, foreground: `var(--ch-10)`, fontStyle: `italic underline` },
    },
    { scope: `message.error`, settings: { foreground: `var(--ch-9)` } },
    { scope: `string variable`, settings: { foreground: `var(--ch-2)` } },
    { scope: [`source.regexp`, `string.regexp`], settings: { foreground: `var(--ch-8)` } },
    {
      scope: [
    ...
    { scope: `string.regexp constant.character.escape`, settings: { foreground: `var(--ch-6)`, fontStyle: `bold` } },
    { scope: `support.constant`, settings: { foreground: `var(--ch-2)` } },
    { scope: `support.variable`, settings: { foreground: `var(--ch-2)` } },
    { scope: `support.type.property-name.json`, settings: { foreground: `var(--ch-6)` } },
    { scope: `meta.module-reference`, settings: { foreground: `var(--ch-2)` } },
    { scope: `punctuation.definition.list.begin.markdown`, settings: { foreground: `var(--ch-3)` } },
    {
      scope: [`markup.heading`, `markup.heading entity.name`],
      settings: { foreground: `var(--ch-2)`, fontStyle: `bold` },
    },
    { scope: `markup.quote`, settings: { foreground: `var(--ch-6)` } },
    { scope: `markup.italic`, settings: { foreground: `var(--ch-4)`, fontStyle: `italic` } },
    { scope: `markup.bold`, settings: { foreground: `var(--ch-4)`, fontStyle: `bold` } },
    ...
    { scope: [`punctuation.section.embedded`], settings: { foreground: `var(--ch-7)` } },
    {
    ...
    { scope: `meta.diff.range`, settings: { foreground: `var(--ch-5)`, fontStyle: `bold` } },
    { scope: `meta.diff.header`, settings: { foreground: `var(--ch-2)` } },
    { scope: `meta.separator`, settings: { foreground: `var(--ch-2)`, fontStyle: `bold` } },
    ...
    { scope: `brackethighlighter.unmatched`, settings: { foreground: `var(--ch-9)` } },
    {
