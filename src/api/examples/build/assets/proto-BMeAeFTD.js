var e = `Protocol Buffer 3`,
  ...
  i = {
    comments: {
      patterns: [{ begin: `/\\*`, end: `\\*/`, name: `comment.block.proto` }, {
        begin: `//`,
        end: `$\\n?`,
        name: `comment.line.double-slash.proto`,
      }],
    },
    constants: { match: `\\b(true|false|max|[A-Z_]+)\\b`, name: `constant.language.proto` },
    enum: {
      begin: `(enum)(\\s+)([A-Za-z][A-Za-z0-9_]*)(\\s*)(\\{)?`,
      beginCaptures: { 1: { name: `keyword.other.proto` }, 3: { name: `entity.name.class.proto` } },
      end: `\\}`,
      patterns: [{ include: `#reserved` }, { include: `#optionStmt` }, { include: `#comments` }, {
        ...
        endCaptures: { 1: { name: `punctuation.terminator.proto` } },
    ...
    fieldOptions: {
      ...
      patterns: [{ include: `#constants` }, { include: `#number` }, { include: `#string` }, {
    ...
    kv: {
      begin: `(\\w+)\\s*(:)`,
      beginCaptures: { 1: { name: `keyword.other.proto` }, 2: { name: `punctuation.separator.key-value.proto` } },
      end: `(;)|,|(?=[}/_a-zA-Z])`,
      endCaptures: { 1: { name: `punctuation.terminator.proto` } },
      patterns: [{ include: `#constants` }, { include: `#number` }, { include: `#string` }, {
        include: `#subMsgOption`,
    ...
    message: {
      ...
      beginCaptures: { 1: { name: `keyword.other.proto` }, 3: { name: `entity.name.class.message.proto` } },
      end: `\\}`,
      patterns: [
        { include: `#reserved` },
        { include: `$self` },
    ...
    method: {
      ...
      beginCaptures: { 1: { name: `keyword.other.proto` }, 2: { name: `entity.name.function` } },
      end: `\\}|(;)`,
      endCaptures: { 1: { name: `punctuation.terminator.proto` } },
      patterns: [{ include: `#comments` }, { include: `#optionStmt` }, { include: `#rpcKeywords` }, {
        include: `#ident`,
      }],
    },
    number: {
    ...
    oneof: {
      ...
      beginCaptures: { 1: { name: `keyword.other.proto` }, 2: { name: `variable.other.proto` } },
      end: `\\}`,
      patterns: [{ include: `#optionStmt` }, { include: `#comments` }, { include: `#field` }],
    },
    optionName: {
      captures: {
    ...
    reserved: {
      begin: `(reserved)\\s+`,
      beginCaptures: { 1: { name: `keyword.other.proto` } },
      end: `(;)`,
      endCaptures: { 1: { name: `punctuation.terminator.proto` } },
      patterns: [{
        captures: {
    ...
    rpcKeywords: { match: `\\b(stream|returns)\\b`, name: `keyword.other.proto` },
    service: {
      begin: `(service)\\s+([A-Za-z][A-Za-z0-9_.]*)\\s*\\{?`,
      beginCaptures: { 1: { name: `keyword.other.proto` }, 2: { name: `entity.name.class.message.proto` } },
      end: `\\}`,
    ...
    string: { match: `('([^']|\\')*')|("([^"]|\\")*")`, name: `string.quoted.double.proto` },
    subMsgOption: { begin: `\\{`, end: `\\}`, patterns: [{ include: `#kv` }, { include: `#comments` }] },
    syntax: {
      captures: {
        1: { name: `keyword.other.proto` },
        2: { name: `keyword.operator.assignment.proto` },
