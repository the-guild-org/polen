...
(=>)`,
        beginCaptures: {
          1: { patterns: [{ match: `async|static`, name: `storage.modifier.$0.cs` }] },
...
\\b(delegate)\\b\\s*`,
        ...
        patterns: [{ include: `#intrusive` }, {
          ...
          patterns: [{ include: `#intrusive` }, { include: `#explicit-anonymous-function-parameter` }, {
            include: `#punctuation-comma`,
          }],
        }, { include: `#block` }],
      }],
    ...
    argument: {
      patterns: [{ match: `\\b(ref|in)\\b`, name: `storage.modifier.$1.cs` }, {
        begin: `\\b(out)\\b`,
        beginCaptures: { 1: { name: `storage.modifier.out.cs` } },
        end: `(?=,|\\)|\\])`,
        patterns: [{ include: `#declaration-expression-local` }, { include: `#expression` }],
      }, { include: `#expression` }],
    },
    'argument-list': {
      begin: `\\(`,
      ...
      endCaptures: { 0: { name: `punctuation.parenthesis.close.cs` } },
      patterns: [{ include: `#named-argument` }, { include: `#argument` }, { include: `#punctuation-comma` }],
    },
...
(?=\\[)`,
      beginCaptures: { 1: { name: `keyword.operator.expression.$1.cs` }, 2: { patterns: [{ include: `#type` }] } },
      end: `(?<=\\])`,
      patterns: [{ include: `#bracketed-argument-list` }],
    },
    'as-expression': {
      captures: { 1: { name: `keyword.operator.expression.as.cs` }, 2: { patterns: [{ include: `#type` }] } },
      match: `(?x)
(?<!\\.)\\b(as)\\b\\s*
(?<type_name>
(?:
...
(?:\\s*\\?(?!\\?))?
    ...
    'assignment-operators': {
      patterns: [{ match: `\\*=|/=|%=|\\+=|-=|\\?\\?=`, name: `keyword.operator.assignment.compound.cs` }, {
        match: `\\&=|\\^=|<<=|>>>?=|\\|=`,
        name: `keyword.operator.assignment.compound.bitwise.cs`,
      }, { match: `\\=`, name: `keyword.operator.assignment.cs` }],
    },
    attribute: {
      patterns: [{ include: `#type-name` }, { include: `#type-arguments` }, { include: `#attribute-arguments` }],
    },
    'attribute-arguments': {
      begin: `(\\()`,
      ...
      patterns: [{ include: `#attribute-named-argument` }, { include: `#expression` }, {
        include: `#punctuation-comma`,
      }],
    },
    ...
    'attribute-section': {
      ...
      patterns: [{ include: `#comment` }, { include: `#attribute` }, { include: `#punctuation-comma` }],
    },
    'await-expression': { match: `(?<!\\.\\s*)\\b(await)\\b`, name: `keyword.operator.expression.await.cs` },
    'await-statement': {
      begin: `(?<!\\.\\s*)\\b(await)\\b`,
      beginCaptures: { 1: { name: `keyword.operator.expression.await.cs` } },
      end: `(?<=})|(?=;|})`,
      patterns: [{ include: `#foreach-statement` }, { include: `#using-statement` }, { include: `#expression` }],
    },
    'base-types': {
      begin: `:`,
      beginCaptures: { 0: { name: `punctuation.separator.colon.cs` } },
      end: `(?=\\{|where|;)`,
      patterns: [{ include: `#type` }, { include: `#punctuation-comma` }, { include: `#preprocessor` }],
    },
    block: {
      begin: `\\{`,
      beginCaptures: { 0: { name: `punctuation.curlybrace.open.cs` } },
    ...
    'boolean-literal': {
      patterns: [{ match: `(?<!\\.)\\btrue\\b`, name: `constant.language.boolean.true.cs` }, {
        match: `(?<!\\.)\\bfalse\\b`,
    ...
    'bracketed-parameter-list': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#comment` }, { include: `#attribute-section` }, { include: `#parameter` }, {
          include: `#punctuation-comma`,
        }, { include: `#variable-initializer` }],
      }],
    },
    'break-or-continue-statement': { match: `(?<!\\.)\\b(break|continue)\\b`, name: `keyword.control.flow.$1.cs` },
    'case-guard': { patterns: [{ include: `#parenthesized-expression` }, { include: `#expression` }] },
    'cast-expression': {
      captures: {
...
(?=[\\s+\\-!~]*@?[_[:alnum:]('"]+)`,
      ...
      patterns: [
        ...
        {
          captures: { 1: { name: `entity.name.type.alias.cs` }, 2: { name: `punctuation.separator.coloncolon.cs` } },
          match: `(@?[_[:alpha:]][_[:alnum:]]*)\\s*(\\:\\:)`,
        },
        {
          captures: { 1: { name: `entity.name.type.cs` }, 2: { name: `punctuation.accessor.cs` } },
          match: `(@?[_[:alpha:]][_[:alnum:]]*)\\s*(\\.)`,
        },
        { match: `\\@?[_[:alpha:]][_[:alnum:]]*`, name: `variable.other.constant.cs` },
      ],
    },
    'catch-clause': {
      begin: `(?<!\\.)\\b(catch)\\b`,
      ...
      patterns: [
        {
          ...
          endCaptures: { 0: { name: `punctuation.parenthesis.close.cs` } },
          patterns: [{
            captures: { 1: { patterns: [{ include: `#type` }] }, 6: { name: `entity.name.variable.local.cs` } },
            match: `(?x)
(?<type_name>
(?:
(?:
...
(?:(\\g<identifier>)\\b)?`,
    ...
    'char-literal': {
      ...
      endCaptures: { 1: { name: `punctuation.definition.char.end.cs` }, 2: { name: `invalid.illegal.newline.cs` } },
...
(@?[_[:alpha:]][_[:alnum:]]*)\\s*`,
    ...
    'combinator-pattern': { match: `\\b(and|or|not)\\b`, name: `keyword.operator.expression.pattern.combinator.$1.cs` },
    comment: {
      patterns: [{
        begin: `(^\\s+)?(///)(?!/)`,
        captures: {
    ...
    'conditional-operator': {
      patterns: [{ match: `\\?(?!\\?|\\s*[.\\[])`, name: `keyword.operator.conditional.question-mark.cs` }, {
        match: `:`,
    ...
    'constructor-declaration': {
      ...
      patterns: [
        { captures: { 1: { name: `entity.name.function.cs` } }, match: `(@?[_[:alpha:]][_[:alnum:]]*)\\b` },
        {
          begin: `(:)`,
    ...
    'context-control-paren-statement': {
      patterns: [{ include: `#fixed-statement` }, { include: `#lock-statement` }, { include: `#using-statement` }],
    },
...
(?=\\()`,
      beginCaptures: {
        1: {
          patterns: [{ captures: { 1: { name: `storage.modifier.explicit.cs` } }, match: `\\b(explicit)\\b` }, {
...
(?=[,)])`,
    ...
    declarations: {
      patterns: [{ include: `#namespace-declaration` }, { include: `#type-declarations` }, {
        include: `#punctuation-semicolon`,
      }],
    },
    'default-argument': {
...
(?=\\()`,
      ...
      patterns: [{ include: `#comment` }, { include: `#parenthesized-parameter-list` }, {
        include: `#generic-constraints`,
      }],
    },
    'designation-pattern': {
      patterns: [{ include: `#intrusive` }, {
        ...
        endCaptures: { 0: { name: `punctuation.parenthesis.close.cs` } },
        patterns: [{ include: `#punctuation-comma` }, { include: `#designation-pattern` }],
      }, { include: `#simple-designation-pattern` }],
    },
    'destructor-declaration': {
      begin: `(~)(@?[_[:alpha:]][_[:alnum:]]*)\\s*(?=\\()`,
      beginCaptures: { 1: { name: `punctuation.tilde.cs` }, 2: { name: `entity.name.function.cs` } },
      end: `(?<=\\})|(?=;)`,
      patterns: [
        { include: `#comment` },
        { include: `#parenthesized-parameter-list` },
    ...
    directives: {
      patterns: [{ include: `#extern-alias-directive` }, { include: `#using-directive` }, {
        include: `#attribute-section`,
      }, { include: `#punctuation-semicolon` }],
    },
    'discard-pattern': { match: `_(?![_[:alnum:]])`, name: `variable.language.discard.cs` },
    'do-statement': {
      begin: `(?<!\\.)\\b(do)\\b`,
...
(?=\\[)`,
      ...
      patterns: [
        {
          ...
          patterns: [{ include: `#comment` }, {
            captures: { 1: { name: `storage.type.enum.cs` }, 2: { name: `entity.name.type.enum.cs` } },
        ...
        },
        {
          ...
          endCaptures: { 0: { name: `punctuation.curlybrace.close.cs` } },
          patterns: [{ include: `#preprocessor` }, { include: `#comment` }, { include: `#attribute-section` }, {
            include: `#punctuation-comma`,
          }, {
    ...
    'event-accessors': {
      ...
      endCaptures: { 0: { name: `punctuation.curlybrace.close.cs` } },
      patterns: [{ include: `#comment` }, { include: `#attribute-section` }, {
...
(?=\\{|;|,|=|//|/\\*|$)`,
      ...
      patterns: [
        ...
        { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `entity.name.variable.event.cs` },
        { include: `#punctuation-comma` },
        {
          begin: `=`,
          beginCaptures: { 0: { name: `keyword.operator.assignment.cs` } },
...
\\b(\\g<identifier>)\\b`,
    ...
    'extern-alias-directive': {
      ...
      patterns: [{ match: `\\@?[_[:alpha:]][_[:alnum:]]*`, name: `variable.other.alias.cs` }],
    },
    'field-declaration': {
      begin: `(?x)
(?<type_name>
...
(\\g<identifier>)\\s*
(?!=>|==)(?=,|;|=|$)`,
      beginCaptures: { 1: { patterns: [{ include: `#type` }] }, 6: { name: `entity.name.variable.field.cs` } },
      end: `(?=;)`,
      patterns: [
        { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `entity.name.variable.field.cs` },
        { include: `#punctuation-comma` },
        { include: `#comment` },
        { include: `#variable-initializer` },
    ...
    'fixed-statement': {
      ...
      patterns: [{ include: `#intrusive` }, {
        ...
        endCaptures: { 0: { name: `punctuation.parenthesis.close.cs` } },
        patterns: [{ include: `#intrusive` }, { include: `#local-variable-declaration` }],
      }],
    },
    'for-statement': {
      begin: `\\b(for)\\b`,
      ...
      patterns: [{
        ...
        patterns: [{
          ...
          patterns: [{ include: `#intrusive` }, { include: `#expression` }, { include: `#punctuation-comma` }, {
            include: `#punctuation-semicolon`,
          }],
        }],
      }],
...
\\b(in)\\b`,
          ...
          captures: {
            1: { name: `storage.type.var.cs` },
            2: { patterns: [{ include: `#tuple-declaration-deconstruction-element-list` }] },
...
\\b(in)\\b`,
    ...
    'generic-constraints': {
      ...
      patterns: [
        ...
        { match: `\\bunmanaged\\b`, name: `keyword.other.constraint.unmanaged.cs` },
        {
          captures: {
    ...
    'goto-statement': {
      ...
      patterns: [
        ...
        { captures: { 1: { name: `keyword.control.conditional.default.cs` } }, match: `\\b(default)\\b` },
        { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `entity.name.label.cs` },
      ],
    },
    'group-by': { captures: { 1: { name: `keyword.operator.expression.query.by.cs` } }, match: `\\b(by)\\b\\s*` },
    'group-clause': {
      begin: `\\b(group)\\b\\s*`,
      beginCaptures: { 1: { name: `keyword.operator.expression.query.group.cs` } },
      end: `(?=;|\\))`,
      patterns: [{ include: `#group-by` }, { include: `#group-into` }, { include: `#query-body` }, {
        include: `#expression`,
      }],
    },
    'group-into': {
...
(@?[_[:alpha:]][_[:alnum:]]*)\\b\\s*`,
    ...
    identifier: { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `variable.other.readwrite.cs` },
    'if-statement': {
      begin: `(?<!\\.)\\b(if)\\b\\s*(?=\\()`,
...
(interface)\\b\\s+
(@?[_[:alpha:]][_[:alnum:]]*)`,
          beginCaptures: { 1: { name: `storage.type.interface.cs` }, 2: { name: `entity.name.type.interface.cs` } },
          end: `(?=\\{)`,
          patterns: [{ include: `#comment` }, { include: `#type-parameter-list` }, { include: `#base-types` }, {
            include: `#generic-constraints`,
          }],
        },
        {
    ...
    'interpolated-string': {
      ...
      endCaptures: { 1: { name: `punctuation.definition.string.end.cs` }, 2: { name: `invalid.illegal.newline.cs` } },
      name: `string.quoted.double.cs`,
      patterns: [{ include: `#string-character-escape` }, { include: `#interpolation` }],
    },
    interpolation: {
      begin: `(?<=[^\\{]|^)((?:\\{\\{)*)(\\{)(?=[^\\{])`,
      beginCaptures: {
...
\\b(in)\\b\\s*`,
      ...
      patterns: [{ include: `#join-on` }, { include: `#join-equals` }, { include: `#join-into` }, {
        include: `#query-body`,
      }, { include: `#expression` }],
    },
    'join-equals': {
...
(@?[_[:alpha:]][_[:alnum:]]*)\\b\\s*`,
    ...
    'join-on': { captures: { 1: { name: `keyword.operator.expression.query.on.cs` } }, match: `\\b(on)\\b\\s*` },
    'labeled-statement': {
      captures: { 1: { name: `entity.name.label.cs` }, 2: { name: `punctuation.separator.colon.cs` } },
      match: `(@?[_[:alpha:]][_[:alnum:]]*)\\s*(:)`,
    },
    'language-variable': {
      patterns: [{ match: `\\b(base|this)\\b`, name: `variable.language.$1.cs` }, {
        match: `\\b(value)\\b`,
...
(=)\\s*`,
    ...
    'list-pattern': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#intrusive` }, { include: `#simple-designation-pattern` }],
      }],
    },
    literal: {
      patterns: [
...
(?=,|;|=)`,
      ...
      patterns: [
        { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `entity.name.variable.local.cs` },
        { include: `#punctuation-comma` },
        { include: `#comment` },
        { include: `#variable-initializer` },
      ],
    ...
    'local-declaration': {
      patterns: [{ include: `#local-constant-declaration` }, { include: `#local-variable-declaration` }, {
...
(?=\\()`,
    ...
    'namespace-declaration': {
      ...
      patterns: [
        ...
        { include: `#punctuation-accessor` },
        {
          ...
          endCaptures: { 0: { name: `punctuation.curlybrace.close.cs` } },
          patterns: [{ include: `#declarations` }, { include: `#using-directive` }, {
            include: `#punctuation-semicolon`,
          }],
        },
      ],
    },
    'null-literal': { match: `(?<!\\.)\\bnull\\b`, name: `constant.language.null.cs` },
    'numeric-literal': {
      captures: {
        0: {
          patterns: [{
            ...
            }, { match: `(?:(?:[0-9a-zA-Z_]|_)|(?<=[eE])[+-]|\\.\\d)+`, name: `invalid.illegal.constant.numeric.cs` }],
          }],
        },
      },
    ...
    'object-creation-expression': {
      patterns: [{ include: `#object-creation-expression-with-parameters` }, {
        include: `#object-creation-expression-with-no-parameters`,
      }],
    },
    'object-creation-expression-with-no-parameters': {
      captures: { 1: { name: `keyword.operator.expression.new.cs` }, 2: { patterns: [{ include: `#type` }] } },
      match: `(?x)
(new)\\s+
(?<type_name>
(?:
...
(?=\\()`,
      beginCaptures: { 1: { name: `keyword.operator.expression.new.cs` }, 2: { patterns: [{ include: `#type` }] } },
      end: `(?<=\\))`,
      patterns: [{ include: `#argument-list` }],
    },
    'operator-assignment': { match: `(?<!=|!)(=)(?!=)`, name: `keyword.operator.assignment.cs` },
...
(?=\\()`,
    ...
    'orderby-clause': {
      begin: `\\b(orderby)\\b\\s*`,
      beginCaptures: { 1: { name: `keyword.operator.expression.query.orderby.cs` } },
      end: `(?=;|\\))`,
      patterns: [{ include: `#ordering-direction` }, { include: `#query-body` }, { include: `#expression` }, {
        include: `#punctuation-comma`,
      }],
    },
    'ordering-direction': {
...
(\\g<identifier>)`,
    ...
    'positional-pattern': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#intrusive` }, { include: `#property-pattern` }, {
          include: `#simple-designation-pattern`,
        }],
      }],
    },
    ...
    'preprocessor-else-or-endif': {
      captures: { 1: { name: `keyword.preprocessor.else.cs` }, 2: { name: `keyword.preprocessor.endif.cs` } },
    ...
    'preprocessor-expression': {
      patterns: [{
        ...
        captures: { 1: { name: `keyword.operator.comparison.cs` }, 2: { name: `keyword.operator.logical.cs` } },
        match: `(==|!=)|(\\!|&&|\\|\\|)`,
      }],
    },
    'preprocessor-if-or-elif': {
      begin: `\\b(?:(if)|(elif))\\b`,
      beginCaptures: { 1: { name: `keyword.preprocessor.if.cs` }, 2: { name: `keyword.preprocessor.elif.cs` } },
      end: `(?=$)`,
    ...
    'preprocessor-line': {
      ...
      patterns: [
        {
          captures: { 1: { name: `keyword.preprocessor.default.cs` }, 2: { name: `keyword.preprocessor.hidden.cs` } },
    ...
    'preprocessor-load': {
      ...
      patterns: [{ captures: { 0: { name: `string.quoted.double.cs` } }, match: `\\"[^"]*\\"` }],
    },
    ...
    'preprocessor-pragma-warning': {
      captures: {
        ...
        5: {
          patterns: [{ captures: { 0: { name: `constant.numeric.decimal.cs` } }, match: `[0-9]+` }, {
            include: `#punctuation-comma`,
          }],
        },
      },
...
(?=\\{|=>|//|/\\*|$)`,
    ...
    'punctuation-semicolon': { match: `;`, name: `punctuation.terminator.statement.cs` },
    'query-body': {
      patterns: [
        { include: `#let-clause` },
...
\\b(in)\\b\\s*`,
    ...
    'raw-string-literal': {
      patterns: [{ include: `#raw-string-literal-more` }, { include: `#raw-string-literal-quadruple` }, {
    ...
    'readonly-modifier': { match: `\\breadonly\\b`, name: `storage.modifier.readonly.cs` },
    'record-declaration': {
      begin: `(?=\\brecord\\b)`,
      end: `(?<=\\})|(?=;)`,
      patterns: [
...
(record)\\b\\s+
(@?[_[:alpha:]][_[:alnum:]]*)`,
          beginCaptures: { 1: { name: `storage.type.record.cs` }, 2: { name: `entity.name.type.class.cs` } },
          end: `(?=\\{)|(?=;)`,
          patterns: [
            { include: `#comment` },
            { include: `#type-parameter-list` },
    ...
    'script-top-level': {
      patterns: [{ include: `#statement` }, { include: `#method-declaration` }, { include: `#punctuation-semicolon` }],
    },
    'select-clause': {
      begin: `\\b(select)\\b\\s*`,
    ...
    'simple-designation-pattern': {
      patterns: [{ include: `#discard-pattern` }, {
...
(@?[_[:alpha:]][_[:alnum:]]*)`,
    ...
    subpattern: {
      patterns: [{
        captures: {
          1: {
            patterns: [{ match: `\\@?[_[:alpha:]][_[:alnum:]]*`, name: `variable.other.object.property.cs` }, {
              include: `#punctuation-accessor`,
            }],
          },
          2: { name: `punctuation.separator.colon.cs` },
    ...
    'switch-expression': {
      ...
      }, { begin: `(?!\\s)`, end: `(?=\\bwhen\\b|=>|,|})`, patterns: [{ include: `#pattern` }] }],
    },
    'switch-label': {
    ...
    'switch-statement-or-expression': {
      ...
      }, { begin: `(?=\\{)`, end: `(?<=\\})|(?=\\})`, patterns: [{ include: `#switch-expression` }] }],
    },
    'throw-expression': { captures: { 1: { name: `keyword.control.flow.throw.cs` } }, match: `\\b(throw)\\b` },
    'throw-statement': {
      begin: `(?<!\\.)\\b(throw)\\b`,
    ...
    'try-statement': {
      patterns: [{ include: `#try-block` }, { include: `#catch-clause` }, { include: `#finally-clause` }],
    },
...
(?=[,)])`,
    ...
    'tuple-deconstruction-assignment': {
      captures: { 1: { patterns: [{ include: `#tuple-deconstruction-element-list` }] } },
      match: `(?x)
(?<tuple>\\s*\\((?:[^\\(\\)]|\\g<tuple>)+\\))\\s*
(?!=>|==)(?==)`,
    },
...
(?=[,)])`,
    ...
    'tuple-element': {
      captures: { 1: { patterns: [{ include: `#type` }] }, 6: { name: `entity.name.variable.tuple-element.cs` } },
      match: `(?x)
(?<type_name>
(?:
(?:
...
(?:(?<tuple_name>\\g<identifier>)\\b)?`,
    ...
    'tuple-literal': {
      ...
      endCaptures: { 0: { name: `punctuation.parenthesis.close.cs` } },
      patterns: [{ include: `#comment` }, { include: `#tuple-literal-element` }, { include: `#expression` }, {
        include: `#punctuation-comma`,
      }],
    },
...
(?=:)`,
    ...
    'type-arguments': {
      begin: `<`,
      beginCaptures: { 0: { name: `punctuation.definition.typeparameters.begin.cs` } },
      end: `>`,
    ...
    'type-name': {
      patterns: [{
        ...
        captures: { 1: { name: `punctuation.accessor.cs` }, 2: { name: `entity.name.type.cs` } },
        match: `(\\.)\\s*(@?[_[:alpha:]][_[:alnum:]]*)`,
      }, { match: `@?[_[:alpha:]][_[:alnum:]]*`, name: `entity.name.type.cs` }],
    },
    'type-nullable-suffix': { match: `\\?`, name: `punctuation.separator.question-mark.cs` },
    ...
    'type-parameter-list': {
      ...
      patterns: [
        ...
        { match: `(@?[_[:alpha:]][_[:alnum:]]*)\\b`, name: `entity.name.type.type-parameter.cs` },
        { include: `#comment` },
        { include: `#punctuation-comma` },
        { include: `#attribute-section` },
      ],
    ...
    'type-pattern': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#intrusive` }, { include: `#positional-pattern` }, { include: `#property-pattern` }, {
          include: `#simple-designation-pattern`,
        }],
      }],
    },
    'type-pointer-suffix': { match: `\\*`, name: `punctuation.separator.asterisk.cs` },
    'type-subpattern': {
      patterns: [
        { include: `#type-builtin` },
        {
    ...
    'using-statement': {
      ...
      patterns: [{ include: `#intrusive` }, {
        ...
        endCaptures: { 0: { name: `punctuation.parenthesis.close.cs` } },
        patterns: [{ include: `#intrusive` }, { include: `#await-expression` }, {
    ...
    'verbatim-interpolated-string': {
      ...
      endCaptures: { 0: { name: `punctuation.definition.string.end.cs` } },
      name: `string.quoted.double.cs`,
      patterns: [{ include: `#verbatim-string-character-escape` }, { include: `#interpolation` }],
    },
    'verbatim-string-character-escape': { match: `""`, name: `constant.character.escape.cs` },
...
(;)`,
    ...
    'xml-doc-comment': {
      patterns: [{ include: `#xml-comment` }, { include: `#xml-character-entity` }, { include: `#xml-cdata` }, {
        include: `#xml-tag`,
      }],
    },
    'xml-string': {
...
([-_[:alnum:]]+)
    ...
    'yield-break-statement': {
      captures: { 1: { name: `keyword.control.flow.yield.cs` }, 2: { name: `keyword.control.flow.break.cs` } },
      match: `(?<!\\.)\\b(yield)\\b\\s*\\b(break)\\b`,
    },
    'yield-return-statement': {
      begin: `(?<!\\.)\\b(yield)\\b\\s*\\b(return)\\b`,
      beginCaptures: { 1: { name: `keyword.control.flow.yield.cs` }, 2: { name: `keyword.control.flow.return.cs` } },
      end: `(?=[;}])`,
      patterns: [{ include: `#expression` }],
    },
    'yield-statement': { patterns: [{ include: `#yield-return-statement` }, { include: `#yield-break-statement` }] },
  },
  i = `source.cs`,
  a = { displayName: `C#`, name: t, patterns: n, repository: r, scopeName: i }
