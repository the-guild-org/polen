var e = `Qt Style Sheets`,
  t = `qss`,
  n = [{ include: `#comment-block` }, { include: `#rule-list` }, { include: `#selector` }],
  r = {
    color: {
      patterns: [{
        begin: `\\b(rgb|rgba|hsv|hsva|hsl|hsla)\\s*\\(`,
        beginCaptures: { 1: { name: `entity.name.function.qss` } },
        description: `Color Type`,
        end: `\\)`,
        patterns: [{ include: `#comment-block` }, { include: `#number` }],
      }, {
        match:
          `\\b(white|black|red|darkred|green|darkgreen|blue|darkblue|cyan|darkcyan|magenta|darkmagenta|yellow|darkyellow|gray|darkgray|lightgray|transparent|color0|color1)\\b`,
    ...
    'property-selector': {
      patterns: [{
        ...
        patterns: [{ include: `#comment-block` }, { include: `#string` }, {
          match: `\\b[_a-zA-Z]\\w*\\b`,
      ...
      patterns: [{
        ...
        patterns: [
          ...
          { include: `#color` },
          {
            ...
            patterns: [
              { include: `#comment-block` },
              { match: `\\b(x1|y1|x2|y2|stop|angle|radius|cx|cy|fx|fy)\\b`, name: `variable.parameter.qss` },
              { include: `#color` },
              { include: `#number` },
            ],
          },
    ...
    'rule-list': {
      patterns: [{
        ...
        patterns: [{ include: `#comment-block` }, { include: `#properties` }, { include: `#icon-properties` }],
      }],
    },
    selector: {
      patterns: [{ include: `#stylable-widgets` }, { include: `#sub-controls` }, { include: `#pseudo-states` }, {
        include: `#property-selector`,
      }, { include: `#id-selector` }],
    },
    string: {
      description: `String literal with double or signle quote.`,
      patterns: [{ begin: `'`, end: `'`, name: `string.quoted.single.qml` }, {
        begin: `"`,
        end: `"`,
  ...
  i = `source.qss`,
  a = { displayName: e, name: `qss`, patterns: n, repository: r, scopeName: i }
