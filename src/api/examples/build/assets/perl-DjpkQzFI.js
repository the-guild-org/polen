var e = `Perl`,
  ...
  n = [
    ...
    { include: `#variable` },
    {
      ...
      patterns: [{
        begin: `(qr)\\s*\\{`,
        captures: { 0: { name: `punctuation.definition.string.perl` }, 1: { name: `support.function.perl` } },
        end: `\\}`,
        ...
        patterns: [{ include: `#escaped_char` }, { include: `#variable` }, { include: `#nested_ltgt_interpolated` }],
      }, {
        begin: `(qr)\\s*\\(`,
        captures: { 0: { name: `punctuation.definition.string.perl` }, 1: { name: `support.function.perl` } },
        end: `\\)`,
    ...
    },
    {
      ...
      patterns: [{
        ...
        patterns: [
          ...
          {
            begin: `\\[`,
            beginCaptures: { 1: { name: `punctuation.definition.character-class.begin.perl` } },
            end: `\\]`,
            endCaptures: { 1: { name: `punctuation.definition.character-class.end.perl` } },
    ...
    },
    {
      ...
      patterns: [{
        ...
        patterns: [{ match: `\\\\['\\\\]`, name: `constant.character.escape.perl.perl` }],
      }, {
        begin: `([^\\sa-zA-Z0-9\\[({<])`,
        captures: { 0: { name: `punctuation.definition.string.perl` } },
        end: `\\1`,
    ...
    {
      begin: `(?<=\\(|\\{|~|&|\\||if|unless|^)\\s*((\\/))`,
      beginCaptures: { 1: { name: `string.regexp.find.perl` }, 2: { name: `punctuation.definition.string.perl` } },
    ...
    { captures: { 1: { name: `constant.other.key.perl` } }, match: `\\b(\\w+)\\s*(?==>)` },
    { match: `(?<={)\\s*\\w+\\s*(?=})`, name: `constant.other.bareword.perl` },
    {
      captures: { 1: { name: `keyword.control.perl` }, 2: { name: `entity.name.type.class.perl` } },
      match: `^\\s*(package)\\s+([^\\s;]+)`,
    ...
    { match: `\\b(__FILE__|__LINE__|__PACKAGE__|__SUB__)\\b`, name: `constant.language.perl` },
    {
    ...
    {
      match:
        `(?<!->)\\b(continue|default|die|do|else|elsif|exit|for|foreach|given|goto|if|last|next|redo|return|select|unless|until|wait|when|while|switch|case|require|use|eval)\\b`,
      name: `keyword.control.perl`,
    },
    { match: `\\b(my|our|local)\\b`, name: `storage.modifier.perl` },
    { match: `(?<!\\w)\\-[rwxoRWXOezsfdlpSbctugkTBMAC]\\b`, name: `keyword.operator.filetest.perl` },
    ...
    },
    {
      ...
      patterns: [{ include: `#escaped_char` }, { include: `#nested_parens_interpolated` }, { include: `#variable` }],
    },
    {
      begin: `\\bqq\\s*\\{`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.perl` } },
      ...
      patterns: [{ include: `#escaped_char` }, { include: `#nested_braces_interpolated` }, { include: `#variable` }],
    },
    {
      begin: `\\bqq\\s*\\[`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.perl` } },
      ...
      patterns: [{ include: `#escaped_char` }, { include: `#nested_brackets_interpolated` }, { include: `#variable` }],
    },
    {
      begin: `\\bqq\\s*\\<`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.perl` } },
      ...
      patterns: [{ include: `#escaped_char` }, { include: `#nested_ltgt_interpolated` }, { include: `#variable` }],
    },
    {
      begin: `(?<!->)\\bqx\\s*\\(`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.perl` } },
    ...
    },
    {
      ...
      beginCaptures: { 1: { name: `support.function.perl` }, 2: { name: `entity.name.function.format.perl` } },
      end: `^\\.\\s*$`,
      name: `meta.format.perl`,
      patterns: [{ include: `#line_comment` }, { include: `#variable` }],
    },
    {
      captures: { 1: { name: `support.function.perl` }, 2: { name: `entity.name.function.perl` } },
      match: `\\b(x)\\s*(\\d+)\\b`,
    },
    {
      match:
  ...
  r = {
    escaped_char: {
      patterns: [
        ...
        { match: `\\\\g(?:\\{(?:\\w*|-\\d+)\\}|\\d+)`, name: `constant.character.escape.perl` },
        { match: `\\\\k(?:\\{\\w*\\}|<\\w*>|'\\w*')`, name: `constant.character.escape.perl` },
        { match: `\\\\N\\{[^\\}]*\\}`, name: `constant.character.escape.perl` },
        { match: `\\\\o\\{\\d*\\}`, name: `constant.character.escape.perl` },
        { match: `\\\\(?:p|P)(?:\\{\\w*\\}|P)`, name: `constant.character.escape.perl` },
        { match: `\\\\x(?:[0-9a-zA-Z]{2}|\\{\\w*\\})?`, name: `constant.character.escape.perl` },
    ...
    heredoc: {
      patterns: [{
        ...
        patterns: [{ begin: `^`, end: `\\n`, name: `text.html.basic`, patterns: [{ include: `text.html.basic` }] }],
      }, {
        begin: `((((<<(~)?) *')(XML)(')))(.*)\\n?`,
        beginCaptures: {
          1: { name: `string.unquoted.heredoc.raw.perl` },
        ...
        patterns: [{ begin: `^`, end: `\\n`, name: `text.xml`, patterns: [{ include: `text.xml` }] }],
      }, {
        begin: `((((<<(~)?) *')(CSS)(')))(.*)\\n?`,
        beginCaptures: {
          1: { name: `string.unquoted.heredoc.raw.perl` },
        ...
        patterns: [{ begin: `^`, end: `\\n`, name: `source.css`, patterns: [{ include: `source.css` }] }],
      }, {
        begin: `((((<<(~)?) *')(JAVASCRIPT)(')))(.*)\\n?`,
        beginCaptures: {
          1: { name: `string.unquoted.heredoc.raw.perl` },
        ...
        patterns: [{ begin: `^`, end: `\\n`, name: `source.js`, patterns: [{ include: `source.js` }] }],
      }, {
        begin: `((((<<(~)?) *')(SQL)(')))(.*)\\n?`,
        beginCaptures: {
          1: { name: `string.unquoted.heredoc.raw.perl` },
        ...
        patterns: [{ begin: `^`, end: `\\n`, name: `source.sql`, patterns: [{ include: `source.sql` }] }],
      }, {
        begin: `((((<<(~)?) *')(POSTSCRIPT)(')))(.*)\\n?`,
        beginCaptures: {
          1: { name: `string.unquoted.heredoc.raw.perl` },
        ...
        patterns: [{ begin: `^`, end: `\\n`, name: `source.postscript`, patterns: [{ include: `source.postscript` }] }],
      }, {
        begin: `((((<<(~)?) *')([^']*)(')))(.*)\\n?`,
        beginCaptures: {
          1: { name: `string.unquoted.heredoc.raw.perl` },
        ...
        patterns: [{
          ...
          patterns: [{ include: `#escaped_char` }, { include: `#variable` }, { include: `text.html.basic` }],
        }],
      }, {
        begin: `((((<<(~)?) *")(XML)(")))(.*)\\n?`,
        beginCaptures: {
        ...
        patterns: [{
          ...
          name: `text.xml`,
          patterns: [{ include: `#escaped_char` }, { include: `#variable` }, { include: `text.xml` }],
        }],
      }, {
        begin: `((((<<(~)?) *")(CSS)(")))(.*)\\n?`,
        beginCaptures: {
        ...
        patterns: [{
          ...
          name: `source.css`,
          patterns: [{ include: `#escaped_char` }, { include: `#variable` }, { include: `source.css` }],
        }],
      }, {
        begin: `((((<<(~)?) *")(JAVASCRIPT)(")))(.*)\\n?`,
        beginCaptures: {
        ...
        patterns: [{
          ...
          name: `source.js`,
          patterns: [{ include: `#escaped_char` }, { include: `#variable` }, { include: `source.js` }],
        }],
      }, {
        begin: `((((<<(~)?) *")(SQL)(")))(.*)\\n?`,
        beginCaptures: {
        ...
        patterns: [{
          ...
          name: `source.sql`,
          patterns: [{ include: `#escaped_char` }, { include: `#variable` }, { include: `source.sql` }],
        }],
      }, {
        begin: `((((<<(~)?) *")(POSTSCRIPT)(")))(.*)\\n?`,
        beginCaptures: {
    ...
    pod: {
      patterns: [{ match: `^=(pod|back|cut)\\b`, name: `storage.type.class.pod.perl` }, {
        begin: `^(=begin)\\s+(html)\\s*$`,
        beginCaptures: { 1: { name: `storage.type.class.pod.perl` }, 2: { name: `variable.other.pod.perl` } },
        contentName: `text.embedded.html.basic`,
        end: `^(=end)\\s+(html)|^(?==cut)`,
        endCaptures: { 1: { name: `storage.type.class.pod.perl` }, 2: { name: `variable.other.pod.perl` } },
        name: `meta.embedded.pod.perl`,
        patterns: [{ include: `text.html.basic` }],
      }, {
        captures: {
          1: { name: `storage.type.class.pod.perl` },
          2: { name: `variable.other.pod.perl`, patterns: [{ include: `#pod-formatting` }] },
        },
    ...
    'pod-formatting': {
      patterns: [{
        captures: { 1: { name: `markup.italic.pod.perl` }, 2: { name: `markup.italic.pod.perl` } },
        match: `I(?:<([^<>]+)>|<+(\\s+(?:(?<!\\s)>|[^>])+\\s+)>+)`,
        name: `entity.name.type.instance.pod.perl`,
      }, {
        captures: { 1: { name: `markup.bold.pod.perl` }, 2: { name: `markup.bold.pod.perl` } },
        match: `B(?:<([^<>]+)>|<+(\\s+(?:(?<!\\s)>|[^>])+\\s+)>+)`,
        name: `entity.name.type.instance.pod.perl`,
      }, {
        captures: { 1: { name: `markup.raw.pod.perl` }, 2: { name: `markup.raw.pod.perl` } },
        match: `C(?:<([^<>]+)>|<+(\\\\s+(?:(?<!\\\\s)>|[^>])+\\\\s+)>+)`,
        name: `entity.name.type.instance.pod.perl`,
      }, {
