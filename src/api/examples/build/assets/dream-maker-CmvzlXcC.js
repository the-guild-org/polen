...
([A-Za-z0-9_$]*)\\b`,
    ...
    { match: `\\b(sleep|spawn|break|continue|do|else|for|goto|if|return|switch|while)\\b`, name: `keyword.control.dm` },
    ...
    { match: `\\b(as|const|global|set|static|tmp)\\b`, name: `storage.modifier.dm` },
    ...
    { match: `\\bnull\\b`, name: `constant.language.dm` },
    {
      ...
      patterns: [{ include: `#string_escaped_char` }, { include: `#string_embedded_expression` }],
    },
    {
      begin: `"`,
      beginCaptures: { 0: { name: `punctuation.definition.string.begin.dm` } },
...
\\s*(?=\\()`,
  ...
  o = {
    access: { match: `\\.[a-zA-Z_][a-zA-Z_0-9]*\\b(?!\\s*\\()`, name: `variable.other.dot-access.dm` },
    block: { begin: `\\{`, end: `\\}`, name: `meta.block.dm`, patterns: [{ include: `#block_innards` }] },
    block_innards: {
      patterns: [
...
\\s*(\\()`,
    ...
    parens: { begin: `\\(`, end: `\\)`, name: `meta.parens.dm`, patterns: [{ include: `$base` }] },
    'preprocessor-rule-disabled': {
      ...
      patterns: [{
        begin: `^\\s*(#\\s*(else)\\b)`,
        captures: { 1: { name: `meta.preprocessor.dm` }, 2: { name: `keyword.control.import.else.dm` } },
        end: `(?=^\\s*#\\s*endif\\b.*$)`,
        patterns: [{ include: `$base` }],
      }, {
        begin: ``,
    ...
    'preprocessor-rule-enabled': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#disabled` }],
      }, { begin: ``, end: `(?=^\\s*#\\s*(else|endif)\\b.*$)`, patterns: [{ include: `$base` }] }],
    },
    'preprocessor-rule-enabled-block': {
      ...
      patterns: [{
        ...
        patterns: [{ include: `#disabled` }],
      }, { begin: ``, end: `(?=^\\s*#\\s*(else|endif)\\b.*$)`, patterns: [{ include: `#block_innards` }] }],
    },
    'preprocessor-rule-other': {
      begin: `^\\s*((#\\s*(if(n?def)?))\\b.*?(?:(?=(?://|/\\*))|$))`,
      captures: { 1: { name: `meta.preprocessor.dm` }, 2: { name: `keyword.control.import.dm` } },
      end: `^\\s*((#\\s*(endif))\\b).*$`,
      patterns: [{ include: `$base` }],
    },
