var e = `material-palenight`,
  t = !0,
  n = [
    { name: `Global settings`, settings: { background: `#292D3E`, foreground: `#A6ACCD` } },
    ...
    { name: `Comment`, scope: `comment`, settings: { foreground: `#676E95`, fontStyle: `italic` } },
    {
      name: `Comment`,
    ...
    { name: `HTML entities`, scope: `punctuation.definition.entity.html`, settings: { foreground: `#A6ACCD` } },
    ...
    { name: `C# preprocessor`, scope: `source.cs meta.preprocessor`, settings: { foreground: `#676E95` } },
    { name: `C# namespace`, scope: `source.cs entity.name.type.namespace`, settings: { foreground: `#A6ACCD` } },
    { name: `JSX Text`, scope: `meta.jsx.children, SXNested`, settings: { foreground: `#A6ACCD` } },
    ...
    { name: `Markdown - Fenced Language`, scope: [`markup.fenced_code.block`], settings: { foreground: `#A6ACCD90` } },
    {
