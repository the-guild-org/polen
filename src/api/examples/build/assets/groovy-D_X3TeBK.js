var e = `Groovy`,
  ...
  n = [{
    ...
    beginCaptures: { 1: { name: `keyword.other.import.static.groovy` } },
    captures: {
    ...
    endCaptures: { 1: { name: `punctuation.terminator.groovy` } },
    name: `meta.import.groovy`,
    patterns: [{ match: `\\.`, name: `punctuation.separator.groovy` }, {
      match: `\\s`,
      name: `invalid.illegal.character_not_allowed_here.groovy`,
    }],
  }, {
    begin: `(import)\\b\\s*`,
    beginCaptures: { 1: { name: `keyword.other.import.groovy` } },
    captures: {
      1: { name: `keyword.other.import.groovy` },
      2: { name: `storage.modifier.import.groovy` },
      3: { name: `punctuation.terminator.groovy` },
  ...
  r = {
    annotations: {
      patterns: [{
        ...
        beginCaptures: {
          ...
          2: { name: `punctuation.definition.annotation-arguments.begin.groovy` },
        },
        end: `(\\))`,
        endCaptures: { 1: { name: `punctuation.definition.annotation-arguments.end.groovy` } },
        name: `meta.declaration.annotation.groovy`,
        patterns: [
          {
            captures: { 1: { name: `constant.other.key.groovy` }, 2: { name: `keyword.operator.assignment.groovy` } },
            match: `(\\w*)\\s*(=)`,
          },
          { include: `#values` },
    ...
    'anonymous-classes-and-new': {
      begin: `\\bnew\\b`,
      beginCaptures: { 0: { name: `keyword.control.new.groovy` } },
      end: `(?<=\\)|\\])(?!\\s*{)|(?<=})|(?=[;])|$`,
      patterns: [{
        begin: `(\\w+)\\s*(?=\\[)`,
        beginCaptures: { 1: { name: `storage.type.groovy` } },
        end: `}|(?=\\s*(?:,|;|\\)))|$`,
        patterns: [{ begin: `\\[`, end: `\\]`, patterns: [{ include: `#groovy` }] }, {
          begin: `{`,
          end: `(?=})`,
      ...
      }, { begin: `{`, end: `}`, name: `meta.inner-class.groovy`, patterns: [{ include: `#class-body` }] }],
    },
    ...
    class: {
      ...
      patterns: [{ include: `#storage-modifiers` }, { include: `#comments` }, {
        captures: { 1: { name: `storage.modifier.groovy` }, 2: { name: `entity.name.type.class.groovy` } },
        ...
        patterns: [{ include: `#object-types-inherited` }, { include: `#comments` }],
      }, { begin: `{`, end: `(?=})`, name: `meta.class.body.groovy`, patterns: [{ include: `#class-body` }] }],
    },
    'class-body': { patterns: [{ include: `#enum-values` }, { include: `#constructors` }, { include: `#groovy` }] },
    closures: {
      begin: `\\{(?=.*?->)`,
      end: `\\}`,
      patterns: [{
        ...
        endCaptures: { 0: { name: `keyword.operator.groovy` } },
        patterns: [{
          begin: `(?!->)`,
          end: `(?=->)`,
      ...
      }, { begin: `(?=[^}])`, end: `(?=\\})`, patterns: [{ include: `#groovy-code` }] }],
    },
    'comment-block': {
      begin: `/\\*`,
    ...
    constants: {
      patterns: [{ match: `\\b([A-Z][A-Z0-9_]+)\\b`, name: `constant.other.groovy` }, {
    ...
    constructors: {
      ...
      patterns: [{ include: `#method-content` }],
    },
    'enum-values': {
      patterns: [{
        begin: `(?<=;|^)\\s*\\b([A-Z0-9_]+)(?=\\s*(?:,|;|}|\\(|$))`,
        beginCaptures: { 1: { name: `constant.enum.name.groovy` } },
        end: `,|;|(?=})|^(?!\\s*\\w+\\s*(?:,|$))`,
        patterns: [{
          begin: `\\(`,
          end: `\\)`,
          name: `meta.enum.value.groovy`,
          patterns: [{ match: `,`, name: `punctuation.definition.seperator.parameter.groovy` }, {
            include: `#groovy-code`,
          }],
        }],
      }],
    ...
    groovy: {
      patterns: [{ include: `#comments` }, { include: `#class` }, { include: `#variables` }, { include: `#methods` }, {
        include: `#annotations`,
      }, { include: `#groovy-code` }],
    },
    'groovy-code': { patterns: [{ include: `#groovy-code-minus-map-keys` }, { include: `#map-keys` }] },
    ...
    keyword: { patterns: [{ include: `#keyword-operator` }, { include: `#keyword-language` }] },
    'keyword-language': {
      patterns: [{ match: `\\b(try|catch|finally|throw)\\b`, name: `keyword.control.exception.groovy` }, {
        ...
        endCaptures: { 0: { name: `punctuation.definition.case-terminator.groovy` } },
        ...
        patterns: [{ match: `:`, name: `keyword.operator.assert.expression-seperator.groovy` }, {
          include: `#groovy-code-minus-map-keys`,
        }],
      }, { match: `\\b(throws)\\b`, name: `keyword.other.throws.groovy` }],
    },
    'keyword-operator': {
      patterns: [
        { match: `\\b(as)\\b`, name: `keyword.operator.as.groovy` },
        { match: `\\b(in)\\b`, name: `keyword.operator.in.groovy` },
        { match: `\\?\\:`, name: `keyword.operator.elvis.groovy` },
        { match: `\\*\\:`, name: `keyword.operator.spreadmap.groovy` },
        ...
        { match: `(?<=\\S)\\?\\.(?=\\S)`, name: `keyword.operator.safe-navigation.groovy` },
        {
          begin: `\\?`,
          beginCaptures: { 0: { name: `keyword.operator.ternary.groovy` } },
          end: `(?=$|\\)|}|])`,
          name: `meta.evaluation.ternary.groovy`,
          patterns: [{ match: `:`, name: `keyword.operator.ternary.expression-seperator.groovy` }, {
            include: `#groovy-code-minus-map-keys`,
          }],
        },
        { match: `==~`, name: `keyword.operator.match.groovy` },
        { match: `=~`, name: `keyword.operator.find.groovy` },
        { match: `\\b(instanceof)\\b`, name: `keyword.operator.instanceof.groovy` },
        { match: `(===|==|!=|<=|>=|<=>|<>|<|>|<<)`, name: `keyword.operator.comparison.groovy` },
        { match: `=`, name: `keyword.operator.assignment.groovy` },
        { match: `(\\-\\-|\\+\\+)`, name: `keyword.operator.increment-decrement.groovy` },
        { match: `(\\-|\\+|\\*|\\/|%)`, name: `keyword.operator.arithmetic.groovy` },
        { match: `(!|&&|\\|\\|)`, name: `keyword.operator.logical.groovy` },
      ],
    },
    'language-variables': { patterns: [{ match: `\\b(this|super)\\b`, name: `variable.language.groovy` }] },
    'map-keys': {
      patterns: [{
        captures: {
    ...
    'method-call': {
      ...
      endCaptures: { 0: { name: `punctuation.definition.method-parameters.end.groovy` } },
    ...
    'method-content': {
      patterns: [{ match: `\\s` }, { include: `#annotations` }, {
        begin: `(?=(?:\\w|<)[^\\(]*\\s+(?:[\\w$]|<)+\\s*\\()`,
        end: `(?=[\\w$]+\\s*\\()`,
        name: `meta.method.return-type.java`,
        patterns: [{ include: `#storage-modifiers` }, { include: `#types` }],
      }, {
        begin: `([\\w$]+)\\s*\\(`,
        ...
        patterns: [{
          ...
          patterns: [{
            ...
            patterns: [{ match: `,`, name: `punctuation.definition.separator.groovy` }, {
              begin: `=`,
              beginCaptures: { 0: { name: `keyword.operator.assignment.groovy` } },
              end: `(?=,|\\))`,
              name: `meta.parameter.default.groovy`,
        ...
        patterns: [{
          ...
          patterns: [{ include: `#types` }, { match: `,`, name: `punctuation.definition.seperator.groovy` }],
        }],
      }, {
        begin: `throws`,
        ...
        patterns: [{ include: `#object-types` }],
      }, { begin: `{`, end: `(?=})`, name: `meta.method.body.java`, patterns: [{ include: `#groovy-code` }] }],
    },
    methods: {
      applyEndPatternLast: 1,
      begin: `(?x:(?<=;|^|{)(?=\\s*
...
([^=]+\\s+)?\\w+\\s*\\(
    ...
    'object-types': {
      patterns: [{
        ...
        patterns: [{ begin: `\\[`, end: `\\]`, patterns: [{ include: `#groovy` }] }],
      }, { match: `\\b(?:[a-zA-Z]\\w*\\.)*(?:[A-Z]+\\w*[a-z]+\\w*|UR[LI])\\b`, name: `storage.type.groovy` }],
    },
    'object-types-inherited': {
      patterns: [{
        ...
        patterns: [{ include: `#object-types-inherited` }, {
          begin: `<`,
          comment: `This is just to support <>'s with no actual type prefix`,
          end: `>|[^\\w\\s,\\[\\]<]`,
          name: `storage.type.generic.groovy`,
    ...
    parameters: {
      patterns: [{ include: `#annotations` }, { include: `#storage-modifiers` }, { include: `#types` }, {
        match: `\\w+`,
    ...
    regexp: {
      patterns: [{
        begin: `/(?=[^/]+/([^>]|$))`,
        beginCaptures: { 0: { name: `punctuation.definition.string.regexp.begin.groovy` } },
        end: `/`,
        endCaptures: { 0: { name: `punctuation.definition.string.regexp.end.groovy` } },
    ...
    'storage-modifiers': {
      patterns: [
        { match: `\\b(private|protected|public)\\b`, name: `storage.modifier.access-control.groovy` },
        { match: `\\b(static)\\b`, name: `storage.modifier.static.groovy` },
        { match: `\\b(final)\\b`, name: `storage.modifier.final.groovy` },
        { match: `\\b(native|synchronized|abstract|threadsafe|transient)\\b`, name: `storage.modifier.other.groovy` },
      ],
    },
    ...
    'string-quoted-double-contents': {
      patterns: [{ match: `\\\\.`, name: `constant.character.escape.groovy` }, {
        ...
        patterns: [{ match: `\\w`, name: `variable.other.interpolated.groovy` }, {
          match: `\\.`,
    ...
    'string-quoted-single-contents': { patterns: [{ match: `\\\\.`, name: `constant.character.escape.groovy` }] },
    ...
    structures: {
      begin: `\\[`,
      beginCaptures: { 0: { name: `punctuation.definition.structure.begin.groovy` } },
      end: `\\]`,
      endCaptures: { 0: { name: `punctuation.definition.structure.end.groovy` } },
      name: `meta.structure.groovy`,
      patterns: [{ include: `#groovy-code` }, { match: `,`, name: `punctuation.definition.separator.groovy` }],
    },
    'support-functions': {
      patterns: [{ match: `(?x)\\b(?:sprintf|print(?:f|ln)?)\\b`, name: `support.function.print.groovy` }, {
...
ArrayEquals)))\\b`,
    ...
    types: {
      patterns: [{ match: `\\b(def)\\b`, name: `storage.type.def.groovy` }, { include: `#primitive-types` }, {
...
(?:=|$)
        ...
        patterns: [
          { match: `\\s` },
          { captures: { 1: { name: `constant.variable.groovy` } }, match: `([A-Z_0-9]+)\\s+(?=\\=)` },
          { captures: { 1: { name: `meta.definition.variable.name.groovy` } }, match: `(\\w[^\\s,]*)\\s+(?=\\=)` },
          {
            begin: `=`,
            beginCaptures: { 0: { name: `keyword.operator.assignment.groovy` } },
            end: `$`,
